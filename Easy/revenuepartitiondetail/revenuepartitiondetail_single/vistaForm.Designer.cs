...
Relations.Add(new DataRelation("sorting1_revenuepartitiondetail",CPar,CChild));

TPar= Tables["sorting2"];
TChild= Tables["revenuepartitiondetail"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor2"]};
Relations.Add(new DataRelation("sorting2_revenuepartitiondetail",CPar,CChild));

TPar= Tables["sorting3"];
TChild= Tables["revenuepartitiondetail"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor3"]};
Relations.Add(new DataRelation("sorting3_revenuepartitiondetail",CPar,CChild));
