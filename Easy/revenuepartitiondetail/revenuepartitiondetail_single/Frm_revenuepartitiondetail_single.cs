...
namespace revenuepartitiondetail_single {
	/// <summary>
	/// Summary description for Frm_revenuepartitiondetail_single.
	/// </summary>
	public class Frm_revenuepartitiondetail_single : System.Windows.Forms.Form {
		MetaData Meta;
		private DataAccess Conn;
		
        public revenuepartitiondetail_single.vistaForm DS;
        ...
        CQueryHelper QHC;
		public Frm_revenuepartitiondetail_single() {
			InitializeComponent();
		}
		...
		private void InitializeComponent() {
            this.DS = new revenuepartitiondetail_single.vistaForm();
            ...
            this.gboxclass1.Controls.Add(this.textBox1);
            ...
            this.textBox1.Tag = "sorting1.sortcode?x";
            // 
            // grpImporto
            // 
            ...
            this.txtAmount.Tag = "revenuepartitiondetail.amount";
            ...
            this.txtRate.Tag = "revenuepartitiondetail.rate.fixed.6..%.100";
            ...
            // 
            // Frm_revenuepartitiondetail_single
            // 
            ...
            this.Name = "Frm_revenuepartitiondetail_single";
            this.Text = "Frm_revenuepartitiondetail_single";
        ...
        public void MetaData_AfterFill() {
            DataRow rrevenuepartitiondetail = Meta.SourceRow;
            DataRow rrevenuePartition = rrevenuepartitiondetail.GetParentRow("revenuepartition_revenuepartitiondetail");

            object kind = rrevenuePartition["kind"];
