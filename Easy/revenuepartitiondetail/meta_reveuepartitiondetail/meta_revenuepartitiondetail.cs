...
namespace meta_revenuepartitiondetail {
	/// <summary>
	/// Summary description for Meta_revenuepartitiondetail.
	/// </summary>
	public class Meta_revenuepartitiondetail : Meta_easydata {
		public Meta_revenuepartitiondetail(DataAccess Conn, MetaDataDispatcher Dispatcher):
			base(Conn, Dispatcher, "revenuepartitiondetail") {
		...
		protected override Form GetForm(string FormName){
			if (FormName=="single") {
                Name = "Dettaglio  Ricavi Ripartizione";
				return MetaData.GetFormByDllName("revenuepartitiondetail_single");
			}
			return null;
		}

        public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
            RowChange.SetSelector(T, "idrevenuepartition");
		...
		public override bool IsValid(DataRow R, out string errmess, out string errfield){
            ...
            DataRow rParent = R.GetParentRow("revenuepartition_revenuepartitiondetail");
            if (rParent != null)
            {
