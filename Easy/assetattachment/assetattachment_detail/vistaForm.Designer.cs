...
private void initClass() {
	...
	C.AllowDBNull=false;
	tassetattachment.Columns.Add(C);
	tassetattachment.Columns.Add( new DataColumn("idfilestorage", typeof(string)));
	...
	var cChild = new []{assetattachment.Columns["idattachmentkind"]};
	Relations.Add(new DataRelation("attachmentkind_assetattachment",cPar,cChild,false));
