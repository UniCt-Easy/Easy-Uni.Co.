...
namespace assetattachment_detail
{
	partial class Frm_assetattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new assetattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "assetattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "assetattachment.idattachmentkind";
			...
			this.Name = "Frm_assetattachment_detail";
			this.Text = "Frm_assetattachment_detail";
