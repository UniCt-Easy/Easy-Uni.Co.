    ...
    public class Meta_listview : Meta_easydata{
        ...
        public override void DescribeColumns(DataTable T, string ListingType)
        {
            ...
            if (ListingType == "default")
            {
                ...
                DescribeAColumn(T, "unit", "Unit‡ di misura", nPos++);
                DescribeAColumn(T, "package", "Unit‡ di misura per l'acquisto", nPos++);
                DescribeAColumn(T, "unitsforpackage", "Coeff. di Conversione", nPos++);
                DescribeAColumn(T, "validitystop", "Fine Validit‡", nPos++);
