...
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
public DataTable foreigngroup1{get { return Tables["foreigngroup1"];}}
...
DataColumn []CPar;
DataColumn []CChild;
TPar= Tables["foreigngroup1"];
TChild= Tables["foreignallowanceruledetail"];
CPar = new DataColumn[1]{TPar.Columns["foreigngroupnumber"]};
CChild = new DataColumn[1]{TChild.Columns["maxforeigngroupnumber"]};
Relations.Add(new DataRelation("foreigngroup1_foreignallowanceruledetail",CPar,CChild));

TPar= Tables["foreigngroup"];
TChild= Tables["foreignallowanceruledetail"];
CPar = new DataColumn[1]{TPar.Columns["foreigngroupnumber"]};
CChild = new DataColumn[1]{TChild.Columns["minforeigngroupnumber"]};
Relations.Add(new DataRelation("foreigngroup_foreignallowanceruledetail",CPar,CChild));
