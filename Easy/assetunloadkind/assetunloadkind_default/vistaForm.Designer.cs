...
namespace assetunloadkind_default {
using System;
using System.Data;
...
//Primary Key
	...
	T.Columns.Add(new DataColumn("codeassetunloadkind", typeof(System.String), ""));
...
Relations.Add(new DataRelation("inventoryassetunloadkind",CPar,CChild));

TPar= Tables["sorting05"];
TChild= Tables["assetunloadkind"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor05"]};
Relations.Add(new DataRelation("FK_sorting05_assetunloadkind",CPar,CChild));

TPar= Tables["sorting04"];
TChild= Tables["assetunloadkind"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor04"]};
Relations.Add(new DataRelation("FK_sorting04_assetunloadkind",CPar,CChild));

TPar= Tables["sorting03"];
TChild= Tables["assetunloadkind"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor03"]};
Relations.Add(new DataRelation("FK_sorting03_assetunloadkind",CPar,CChild));

TPar= Tables["sorting02"];
TChild= Tables["assetunloadkind"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor02"]};
Relations.Add(new DataRelation("FK_sorting02_assetunloadkind",CPar,CChild));

TPar= Tables["sorting01"];
TChild= Tables["assetunloadkind"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor01"]};
Relations.Add(new DataRelation("FK_sorting01_assetunloadkind",CPar,CChild));
