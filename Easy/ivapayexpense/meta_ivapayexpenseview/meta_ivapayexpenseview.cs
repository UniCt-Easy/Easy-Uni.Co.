...
namespace meta_ivapayexpenseview{//meta_liquidazioneivaspesaview//
	/// <summary>
	/// Summary description for meta_liquidazioneivaspesaview
	/// </summary>
	public class Meta_ivapayexpenseview : Meta_easydata {
		public Meta_ivapayexpenseview(DataAccess Conn, MetaDataDispatcher Dispatcher):
			base(Conn, Dispatcher, "ivapayexpenseview") {		
