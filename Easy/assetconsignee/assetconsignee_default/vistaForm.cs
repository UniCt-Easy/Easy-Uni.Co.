...
namespace assetconsignee_default {
using System;
using System.Data;
...
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
public DataTable assetconsigneeview{get { return this.Tables["assetconsigneeview"];}}
...
//Primary Key
	...
	T.Columns["idinventoryagency"], 	T.Columns["start"]};
	T.PrimaryKey = key;
...
//Primary Key
	...
	T= new DataTable("assetconsigneeview");
	C= new DataColumn("idinventoryagency", typeof(System.Int32), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);

	C= new DataColumn("agency", typeof(System.String), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);
...
Relations.Add(new DataRelation("inventoryagencyassetconsignee",CPar,CChild));
