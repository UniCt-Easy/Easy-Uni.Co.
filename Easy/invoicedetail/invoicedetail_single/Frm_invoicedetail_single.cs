...
namespace invoicedetail_single //dettdocumentoivasingle//
{
    ...
    public class Frm_invoicedetail_single : System.Windows.Forms.Form {
        ...
        private void InitializeComponent() {
            ...
            this.grpRipartizioneCosti.Location = new System.Drawing.Point(467, 121);
            this.grpRipartizioneCosti.Name = "grpRipartizioneCosti";
            this.grpRipartizioneCosti.Size = new System.Drawing.Size(463, 89);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
            this.textBox3.Location = new System.Drawing.Point(150, 8);
            this.textBox3.Multiline = true;
            this.textBox3.Name = "textBox3";
            this.textBox3.ReadOnly = true;
            this.textBox3.Size = new System.Drawing.Size(305, 52);
            ...
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this.txtDenom2.Location = new System.Drawing.Point(125, 11);
            this.txtDenom2.Multiline = true;
            this.txtDenom2.Name = "txtDenom2";
            this.txtDenom2.ReadOnly = true;
            this.txtDenom2.Size = new System.Drawing.Size(294, 56);
            ...
            this.txtDenom1.Size = new System.Drawing.Size(294, 60);
    ...
    "casistiche indicate.";
            ...
            this.txtCoeffConversione.Location = new System.Drawing.Point(829, 37);
            ...
            this.label26.Location = new System.Drawing.Point(712, 40);
            ...
            this.cmbUnitaMisuraAcquisto.Location = new System.Drawing.Point(828, 11);
            ...
            this.lblIcmbdpackage.Location = new System.Drawing.Point(718, 14);
            ...
            this.label27.Location = new System.Drawing.Point(751, 64);
            ...
            this.cmbUnitaMisuraCS.Location = new System.Drawing.Point(828, 60);
            ...
            this.txtDescrizioneListino.Size = new System.Drawing.Size(433, 67);
        ...
        private void EnableDisableQuantita(DataRow Curr) {
            ...
            if ((Curr["idlist"] == DBNull.Value) || (rInvoice["flag_ddt"].ToString() == "N" && Meta.InsertMode)) {
        ...
        public void MetaData_AfterRowSelect(DataTable T, DataRow R) {
            ...
            if ((T.TableName == "accmotive" || T.TableName == "accmotiveapplied") && Meta.DrawStateIsDone) {
       ...
       private void ImpostaNaturadiSpesa(object expensekind) {
        ...
        void VisualizzaControlliContabilizzazioneImpAccBudget() {
            if (Meta.IsEmpty || Meta.destroyed || Meta.inchiusura) return;
            if (DS.invoicedetail.Rows.Count == 0) return;
            DataRow Curr = DS.invoicedetail.Rows[0];
        ...
        private void abilita_gruppi(string intrastatoperationkind) {
            ...
            if (CfgFn.GetNoNullInt32(Meta.GetSys("esercizio")) != CfgFn.GetNoNullInt32(rPadre["yinv"])) {
                grpBeni.Enabled = false;
                grpServizi.Enabled = false;
        ...
        void AggiornaListino(DataRow Choosen) {
            ...
            if (grpCausale.Enabled) {
                ...
                if (idaccmotive != null && idaccmotive != DBNull.Value) {
                    ...
                    Meta.Conn.RUN_SELECT_INTO_TABLE(DS.accmotiveapplied, null,
        ...
        private void setCoord(int num, object idsor) {
            ...
            Meta.Conn.RUN_SELECT_INTO_TABLE(DS.Tables["sorting" + num.ToString()], null, QHS.CmpEq("idsor", idsor), null,
                false);
        ...
        private void txtNinv_Main_Leave(object sender, EventArgs e) {
            ...
            if ((idinvkind_main != DBNull.Value) && (yinv_main != "") && (ninv_main != "")) {
                ...
                if (Meta.Conn.RUN_SELECT_COUNT("invoice", filter, true) == 0) {
        ...
        public void MetaData_AfterLink() {
            ...
            flagva3 = Conn.DO_READ_VALUE("config", QHS.CmpEq("ayear", Meta.GetSys("esercizio")), "flagva3");
            ...
            */
            ...
            if (filterivakind != "") {
                GetData.SetStaticFilter(DS.ivakind, filterivakind);
            }
...
//del documento considera il registro associato e non il tipo documento
            ...
            GetData.SetStaticFilter(DS.intrastatcode, filterEsercInvoice);
            GetData.SetStaticFilter(DS.intrastatservice, filterEsercInvoice);
            ...
            tExpSetup = Conn.RUN_SELECT("config", "*", null,
            ...
            string filter = QHC.CmpEq("idgroup", rPadre["idgroup"]);
            DataRow[] Selected = DetailsInvoice.Select(filter);
            decimal detailsGroup = Selected.Length;
            //Diamo la possibilità di modificare anche un dettaglio splittato
            //if (detailsGroup > 1) {
            //    DisableEditGroup();
            //}
            DataTable Invoice = rPadre.Table.DataSet.Tables["invoice"];
            string flagdeferred = Invoice.Rows[0]["flagdeferred"].ToString();
            txtPaymentCompetency.ReadOnly = true; //(flagdeferred == "N");
        ...
        public void MetaData_AfterFill() {
            ...
            if (Meta.FirstFillForThisRow && flagintracom == "S" && Curr["usedmodesospesometro"] == DBNull.Value) {
            ...
            if (Meta.FirstFillForThisRow && Curr["idmankind"] != DBNull.Value) {
                string filtermandate = QHS.AppAnd(
                    QHS.CmpMulti(Curr, "idmankind", "yman", "nman"),
                    QHS.CmpEq("rownum", Curr["manrownum"]));
            ...
            if (Curr["idpccdebitmotive"] != DBNull.Value) {
                txtCausale.Text =
                    DS.pccdebitmotive.Select(QHC.CmpEq("idpccdebitmotive", Curr["idpccdebitmotive"]))[0]["description"]
                        .ToString();
            }
            else {
                txtCausale.Text = "";
        ...
        public string GetFilterForMandateDetail(DataRow Curr) {
            ...
            DataTable Reg = Conn.RUN_SELECT("invoicekindregisterkind", "*", null,
                idinvkindfilter, null, null, true);
            if ((Reg != null)&& (Reg.Rows.Count>0)) {
                foreach (DataRow RREg in Reg.Rows) {
                    ...
                    DataTable RegKind = Conn.RUN_SELECT("ivaregisterkind", "*", null,
                        filterregkind, null, null, true);
                    if (RegKind==null || (RegKind.Rows.Count == 0))
                        continue;
                ...
                if (Curr["idexp_taxable"] != DBNull.Value) {
                    object idExpFaseImpegno_taxable = Conn.DO_READ_VALUE("expenselink",
                        QHS.AppAnd(QHS.CmpEq("idchild", Curr["idexp_taxable"]),
                            QHS.CmpEq("nlevel", Conn.GetSys("mandatephase"))), "idparent");
        ...
        public string GetFilterForEpexp(DataRow Curr,int nphase) {
            ...
            if (Curr["idmankind"] != DBNull.Value && CfgFn.GetNoNullInt32(Curr["yman"]) >= minimoAnnoImpegniDiBudget) {
                ...
                DataTable MandateDetail = Meta.Conn.RUN_SELECT("mandatedetail", "idepexp", null, filterManDet, null, true);
                if (MandateDetail != null && MandateDetail.Rows.Count > 0) {
            ...
            //if (Curr["ycon"] != DBNull.Value && CfgFn.GetNoNullInt32(Curr["ycon"]) >= minimoAnnoImpegniDiBudget) {
                ...
                DataTable ProfService = Meta.Conn.RUN_SELECT("profservice", "*", null, filterInv, null, true);
           ...
           // }
            ...
            if (NotaVariazione == false && !Vendita) {
                ...
                string filterCausale = QHS.AppAnd(QHS.CmpEq("ayear", Meta.GetSys("esercizio")),
                    QHS.CmpEq("idaccmotive", Curr["idaccmotive"]));
                // seleziona i conti associati alla casuale del dettaglio fattura
                DataTable Accmotivedetail = Meta.Conn.RUN_SELECT("accmotivedetail", "idacc", null, filterCausale, null,
                    true);
        ...
        public string GetFilterForEpacc(DataRow Curr) {
            ...
            if (Curr["idestimkind"] != DBNull.Value && CfgFn.GetNoNullInt32(Curr["yestim"]) >= minimoAnnoImpegniDiBudget) {
                ...
                DataTable estimatedetail = Meta.Conn.RUN_SELECT("estimatedetail", "idepacc", null, filterEstimDet, null,
                    true);
            ...
            if ((Curr["idinc_taxable"] != DBNull.Value) || (Curr["idinc_iva"] != DBNull.Value)) {
                object idExpFaseAccertamento_taxable = Conn.DO_READ_VALUE("incomelink",
                    QHS.AppAnd(QHS.CmpEq("idchild", Curr["idinc_taxable"]),
                        QHS.CmpEq("nlevel", Conn.GetSys("estimatephase"))), "idparent");
        ...
        private void btnCollegaRiga_Click(object sender, EventArgs e) {
            ...
            MetaData MetaMandateDetail = Meta.Dispatcher.Get(VistaScelta);
        ...
        private void btnCollegaRigaContratto_Click(object sender, EventArgs e) {
            ...
            MetaData MetaEstimateDetail = Meta.Dispatcher.Get(VistaScelta);
        ...
        private void btnCollegaContrProf_Click(object sender, EventArgs e) {
            ...
            MetaData MetaProfService = Meta.Dispatcher.Get("profservice");
