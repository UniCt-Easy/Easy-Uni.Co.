...
public partial class dsmeta: DataSet {
	...
	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public MetaTable apiendpoint 		=> (MetaTable)Tables["apiendpoint"];

	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public MetaTable app_config 		=> (MetaTable)Tables["app_config"];
...
private void initClass() {
	...
	//////////////////// APIENDPOINT /////////////////////////////////
	var tapiendpoint= new MetaTable("apiendpoint");
	tapiendpoint.defineColumn("apicode", typeof(string),false);
	tapiendpoint.defineColumn("description", typeof(string));
	tapiendpoint.defineColumn("url", typeof(string),false);
	tapiendpoint.defineColumn("param", typeof(string));
	tapiendpoint.defineColumn("ct", typeof(DateTime),false);
	tapiendpoint.defineColumn("cu", typeof(string),false);
	tapiendpoint.defineColumn("lt", typeof(DateTime),false);
	tapiendpoint.defineColumn("lu", typeof(string),false);
	tapiendpoint.defineColumn("flagapiendpoint", typeof(int));
	Tables.Add(tapiendpoint);
	tapiendpoint.defineKey("apicode");

	//////////////////// APP_CONFIG /////////////////////////////////
	var tapp_config= new MetaTable("app_config");
	tapp_config.defineColumn("code", typeof(string),false);
	tapp_config.defineColumn("description", typeof(string),false);
	tapp_config.defineColumn("param", typeof(string),false);
	tapp_config.defineColumn("ct", typeof(DateTime),false);
	tapp_config.defineColumn("cu", typeof(string),false);
	tapp_config.defineColumn("lt", typeof(DateTime),false);
	tapp_config.defineColumn("lu", typeof(string),false);
	tapp_config.defineColumn("flag", typeof(int));
	Tables.Add(tapp_config);
	tapp_config.defineKey("code");
