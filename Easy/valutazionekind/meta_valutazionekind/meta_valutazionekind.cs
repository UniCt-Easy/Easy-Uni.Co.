...
{
    public class Meta_valutazionekind : Meta_easydata 
	{
        public Meta_valutazionekind(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "valutazionekind") {
				Name = "Tipologia di valutazione di una attività didattica";
		...
		public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
			...
			RowChange.MarkAsAutoincrement(T.Columns["idvalutazionekind"], null, null, 0);
			RowChange.setMinimumTempValue(T.Columns["idvalutazionekind"], 9990000);
			//$Get_New_Row$
		...
		public override bool IsValid(DataRow R, out string errmess, out string errfield) {
			...
			switch (edit_type) {
				case "default": {
						...
						if (R["active"].ToString().Trim().Length > 19) {
							errmess = "Attenzione! Il campo 'Attivo' può essere al massimo di 19 caratteri";
							errfield = "active";
							return false;
						}
