...
namespace taxsetup_default//automatismiritenute//
{
	...
	/// </summary>
	public class Frm_taxsetup_default : System.Windows.Forms.Form
	{
...
//		int bilancio;
		...
		private void InitializeComponent()
		{
            ...
            this.grpVersamento.Text = "Periodicit‡ della liquidazione periodica";
            // 
            // cmbTipoScadenza
            // 
...
//					txtBilancioSpesa, txtDescrBilancioSpesa);
		...
		private DialogResult HasRowsMsg(string tipo) {
			...
			msg+=". Confermi?";
			return MessageBox.Show(msg,"Attenzione",
