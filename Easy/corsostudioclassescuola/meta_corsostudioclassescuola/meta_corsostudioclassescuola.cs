...
{
    public class Meta_corsostudioclassescuola : Meta_easydata 
	{
        public Meta_corsostudioclassescuola(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "corsostudioclassescuola") {
				Name = "Scuole o classi di laurea del corso";
