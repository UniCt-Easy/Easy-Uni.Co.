...
namespace meta_upbepexpyearview
{
    /// <summary>
    /// Summary description for Meta_upbepexpyearview.
    /// </summary>
    public class Meta_upbepexpyearview : Meta_easydata
    {
        public Meta_upbepexpyearview(DataAccess Conn, MetaDataDispatcher Dispatcher):
            base(Conn, Dispatcher, "upbepexpyearview")
        {
            ListingTypes.Add("epexp");
        }
        public override string GetNoRowFoundMessage(string listingtype) {
            return "Non Ë stato trovato alcun UPB con disponibilit‡ sufficiente.";
        }
        ...
        public override void DescribeColumns(DataTable T, string ListingType)
        {
            ...
            if (ListingType == "epexp") {
                ...
                DescribeAColumn(T, "activity", "Tipo Attivit‡", nPos++);
