...
private void initClass() {
	...
	var cChild = new []{expensetaxcorrige.Columns["idfiscaltaxregion"]};
	Relations.Add(new DataRelation("fiscaltaxregionexpensetaxcorrige",cPar,cChild,false));

	cPar = new []{geo_cityview.Columns["idcity"]};
	cChild = new []{expensetaxcorrige.Columns["idcity"]};
	Relations.Add(new DataRelation("geo_cityviewexpensetaxcorrige",cPar,cChild,false));
	...
	cChild = new []{expensetaxcorrige.Columns["linkedidinc"]};
	Relations.Add(new DataRelation("incomeviewexpensetaxcorrige",cPar,cChild,false));

	cPar = new []{expenseview.Columns["idexp"]};
	cChild = new []{expensetaxcorrige.Columns["linkedidexp"]};
	Relations.Add(new DataRelation("expenseviewexpensetaxcorrige",cPar,cChild,false));
