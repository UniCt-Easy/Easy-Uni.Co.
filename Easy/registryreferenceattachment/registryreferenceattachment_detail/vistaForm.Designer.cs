...
private void initClass() {
	...
	var cChild = new []{registryreferenceattachment.Columns["idattachmentkind"]};
	Relations.Add(new DataRelation("attachmentkind_registryreferenceattachment",cPar,cChild,false));
