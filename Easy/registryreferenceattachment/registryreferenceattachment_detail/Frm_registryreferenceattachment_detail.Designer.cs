...
namespace registryreferenceattachment_detail
{
	partial class Frm_registryreferenceattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new registryreferenceattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "registryreferenceattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "registryreferenceattachment.idattachmentkind";
			...
			// 
			// Frm_registryreferenceattachment_detail
			// 
			...
			this.Name = "Frm_registryreferenceattachment_detail";
			this.Text = "Frm_registryreferenceattachment_detail";
