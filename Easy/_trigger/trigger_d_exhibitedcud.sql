...
if exists (select * from dbo.sysobjects where id = object_id(N'[trigger_d_exhibitedcud]') and OBJECTPROPERTY(id, N'IsTrigger') = 1)
drop trigger [trigger_d_exhibitedcud]
GO

CREATE   TRIGGER [trigger_d_exhibitedcud] ON [exhibitedcud] FOR DELETE
AS BEGIN
	CREATE TABLE #cud
	(
