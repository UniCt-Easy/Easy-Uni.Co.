		...
		public override void DescribeColumns(DataTable T, string ListingType) {
			...
			switch (ListingType) {
				case "seg": {
						...
						DescribeAColumn(T, "protocollodockind_description", "Descrizione", nPos++);
						DescribeAColumn(T, "protocollodockind_sortcode", "Ordinamento", nPos++);
						DescribeAColumn(T, "protocollodockind_active", "Attivo", nPos++);
						DescribeAColumn(T, "protocollodockind_kind", "Kind", nPos++);
						break;
					}
					//$DescribeAColumn$
			}
