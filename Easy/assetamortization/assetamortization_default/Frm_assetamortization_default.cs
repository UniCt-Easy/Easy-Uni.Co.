...
namespace assetamortization_default//rivalutazionebene//
{
	...
	public class Frm_assetamortization_default : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.textBox2.Text = "Imponibile *(1-sconto)*(1-IVA). L\'IVA Ë calcolata a seconda della configurazione " +
    "del tipo di Rivalutazione/Svalutazione. Lo sconto non Ë calcolato per i libri ca" +
