...
namespace meta_budgetvarattachment {
    public class Meta_budgetvarattachment : Meta_easydata {
        public Meta_budgetvarattachment(DataAccess Conn, MetaDataDispatcher Dispatcher)
            :
            base(Conn, Dispatcher, "budgetvarattachment") {
            EditTypes.Add("default");
            ListingTypes.Add("default");
        }
        protected override Form GetForm(string EditType) {
            if (EditType == "default") return GetFormByDllName("budgetvarattachment_default");
            return null;
        }
