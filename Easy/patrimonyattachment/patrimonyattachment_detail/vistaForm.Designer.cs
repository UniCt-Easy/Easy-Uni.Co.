...
private void initClass() {
	...
	C.AllowDBNull=false;
	tpatrimonyattachment.Columns.Add(C);
	tpatrimonyattachment.Columns.Add( new DataColumn("idfilestorage", typeof(string)));
	...
	var cChild = new []{patrimonyattachment.Columns["idattachmentkind"]};
	Relations.Add(new DataRelation("attachmentkind_patrimonyattachment",cPar,cChild,false));
