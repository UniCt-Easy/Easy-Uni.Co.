...
namespace patrimonyattachment_detail
{
	partial class Frm_patrimonyattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new patrimonyattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "patrimonyattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "patrimonyattachment.idattachmentkind";
			...
			// 
			// Frm_patrimonyattachment_detail
			// 
			...
			this.Name = "Frm_patrimonyattachment_detail";
			this.Text = "Frm_patrimonyattachment_detail";
