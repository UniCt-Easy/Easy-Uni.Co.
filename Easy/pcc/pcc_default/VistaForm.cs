...
public partial class VistaForm: DataSet {
	...
	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public DataTable pccdocamountvarview 		=> Tables["pccdocamountvarview"];

	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public DataTable pccsplitpaymentview 		=> Tables["pccsplitpaymentview"];
...
private void initClass() {
	...
	tpcc.Columns.Add( new DataColumn("idfilestorage", typeof(string)));
	Tables.Add(tpcc);
	...
	C= new DataColumn("paytransmissiondate", typeof(DateTime));
	C.ReadOnly=true;
	tpccpaymentview.Columns.Add(C);
	...
	tpccpaymentview.Columns.Add( new DataColumn("IDENTIFICATIVO_1", typeof(string)));
	tpccpaymentview.Columns.Add( new DataColumn("IDENTIFICATIVO_2_a", typeof(string)));
	tpccpaymentview.Columns.Add( new DataColumn("IDENTIFICATIVO_2_b", typeof(string)));
	tpccpaymentview.Columns.Add( new DataColumn("IDENTIFICATIVO_3_a", typeof(string)));
	tpccpaymentview.Columns.Add( new DataColumn("IDENTIFICATIVO_3_b", typeof(string)));
	tpccpaymentview.Columns.Add( new DataColumn("IDENTIFICATIVO_3_c", typeof(string)));
	...
	tpccexpiringview.Columns.Add( new DataColumn("IDENTIFICATIVO_2_a", typeof(string)));
	tpccexpiringview.Columns.Add( new DataColumn("IDENTIFICATIVO_2_b", typeof(string)));
	tpccexpiringview.Columns.Add( new DataColumn("IDENTIFICATIVO_3_a", typeof(string)));
	tpccexpiringview.Columns.Add( new DataColumn("IDENTIFICATIVO_3_b", typeof(string)));
	tpccexpiringview.Columns.Add( new DataColumn("IDENTIFICATIVO_3_c", typeof(string)));
	...
	tpccexpiringview.Columns.Add( new DataColumn("IDENTIFICATIVO_1", typeof(string)));
	...
	//////////////////// PCCDOCAMOUNTVARVIEW /////////////////////////////////
	var tpccdocamountvarview= new DataTable("pccdocamountvarview");
	C= new DataColumn("idpcc", typeof(int));
	C.AllowDBNull=false;
	tpccdocamountvarview.Columns.Add(C);
	C= new DataColumn("idpccdocamountvar", typeof(int));
	C.AllowDBNull=false;
	tpccdocamountvarview.Columns.Add(C);
	tpccdocamountvarview.Columns.Add( new DataColumn("idpccdebitstatusdetail", typeof(int)));
	C= new DataColumn("invoicekind", typeof(string));
	C.AllowDBNull=false;
	tpccdocamountvarview.Columns.Add(C);
	tpccdocamountvarview.Columns.Add( new DataColumn("yinv", typeof(short)));
	tpccdocamountvarview.Columns.Add( new DataColumn("ninv", typeof(int)));
	tpccdocamountvarview.Columns.Add( new DataColumn("IDENTIFICATIVO_2_a", typeof(long)));
	tpccdocamountvarview.Columns.Add( new DataColumn("IDENTIFICATIVO_2_b", typeof(string)));
	tpccdocamountvarview.Columns.Add( new DataColumn("IDENTIFICATIVO_3_a", typeof(string)));
	tpccdocamountvarview.Columns.Add( new DataColumn("IDENTIFICATIVO_3_b", typeof(string)));
	tpccdocamountvarview.Columns.Add( new DataColumn("IDENTIFICATIVO_3_c", typeof(string)));
	...
	C.ReadOnly=true;
	tpccdocamountvarview.Columns.Add(C);
	tpccdocamountvarview.Columns.Add( new DataColumn("CFfornitore", typeof(string)));
	tpccdocamountvarview.Columns.Add( new DataColumn("importononcommerciale", typeof(decimal)));
	tpccdocamountvarview.Columns.Add( new DataColumn("imp_sosp_contenzioso", typeof(decimal)));
	tpccdocamountvarview.Columns.Add( new DataColumn("iva_sosp_contenzioso", typeof(decimal)));
	tpccdocamountvarview.Columns.Add( new DataColumn("start_sosp_contenzioso", typeof(DateTime)));
	tpccdocamountvarview.Columns.Add( new DataColumn("imp_sosp_contestazione", typeof(decimal)));
	tpccdocamountvarview.Columns.Add( new DataColumn("iva_sosp_contestazione", typeof(decimal)));
	tpccdocamountvarview.Columns.Add( new DataColumn("start_sosp_contestazione", typeof(DateTime)));
	tpccdocamountvarview.Columns.Add( new DataColumn("imp_sosp_regolareverifica", typeof(decimal)));
	tpccdocamountvarview.Columns.Add( new DataColumn("iva_sosp_regolareverifica", typeof(decimal)));
	tpccdocamountvarview.Columns.Add( new DataColumn("start_sosp_regolareverifica", typeof(DateTime)));
	tpccdocamountvarview.Columns.Add( new DataColumn("imp_nonliquidabile", typeof(decimal)));
	tpccdocamountvarview.Columns.Add( new DataColumn("iva_nonliquidabile", typeof(decimal)));
	tpccdocamountvarview.Columns.Add( new DataColumn("importo_nonliquidabile", typeof(decimal)));
	tpccdocamountvarview.Columns.Add( new DataColumn("idinvkind", typeof(int)));
	C= new DataColumn("ct", typeof(DateTime));
	C.AllowDBNull=false;
	tpccdocamountvarview.Columns.Add(C);
	C= new DataColumn("cu", typeof(string));
	...
	C.AllowDBNull=false;
	tpccdocamountvarview.Columns.Add(C);
	tpccdocamountvarview.Columns.Add( new DataColumn("IDENTIFICATIVO_1", typeof(string)));
	Tables.Add(tpccdocamountvarview);
	tpccdocamountvarview.PrimaryKey =  new DataColumn[]{tpccdocamountvarview.Columns["idpcc"], tpccdocamountvarview.Columns["idpccdocamountvar"]};


	//////////////////// PCCSPLITPAYMENTVIEW /////////////////////////////////
	var tpccsplitpaymentview= new DataTable("pccsplitpaymentview");
	C= new DataColumn("idpcc", typeof(int));
	C.AllowDBNull=false;
	tpccsplitpaymentview.Columns.Add(C);
	...
	C.AllowDBNull=false;
	tpccsplitpaymentview.Columns.Add(C);
	tpccsplitpaymentview.Columns.Add( new DataColumn("yinv", typeof(short)));
	tpccsplitpaymentview.Columns.Add( new DataColumn("ninv", typeof(int)));
	tpccsplitpaymentview.Columns.Add( new DataColumn("IDENTIFICATIVO_2_a", typeof(string)));
	tpccsplitpaymentview.Columns.Add( new DataColumn("IDENTIFICATIVO_2_b", typeof(string)));
	tpccsplitpaymentview.Columns.Add( new DataColumn("IDENTIFICATIVO_3_a", typeof(string)));
	tpccsplitpaymentview.Columns.Add( new DataColumn("IDENTIFICATIVO_3_b", typeof(string)));
	tpccsplitpaymentview.Columns.Add( new DataColumn("IDENTIFICATIVO_3_c", typeof(string)));
	tpccsplitpaymentview.Columns.Add( new DataColumn("registry", typeof(string)));
	C= new DataColumn("IdFiscaleIvaFornitore", typeof(string));
	C.ReadOnly=true;
	tpccsplitpaymentview.Columns.Add(C);
	tpccsplitpaymentview.Columns.Add( new DataColumn("CFfornitore", typeof(string)));
	C= new DataColumn("numerodocumento", typeof(string));
	C.ReadOnly=true;
	tpccsplitpaymentview.Columns.Add(C);
	tpccsplitpaymentview.Columns.Add( new DataColumn("dataemissione", typeof(DateTime)));
	C= new DataColumn("ImportoTotaleDocumento", typeof(decimal));
	C.ReadOnly=true;
	tpccsplitpaymentview.Columns.Add(C);
	tpccsplitpaymentview.Columns.Add( new DataColumn("flag_enable_split_payment", typeof(string)));
	tpccsplitpaymentview.Columns.Add( new DataColumn("idinvkind", typeof(int)));
	C= new DataColumn("ct", typeof(DateTime));
	C.AllowDBNull=false;
	tpccsplitpaymentview.Columns.Add(C);
	C= new DataColumn("cu", typeof(string));
	...
	C.AllowDBNull=false;
	tpccsplitpaymentview.Columns.Add(C);
	tpccsplitpaymentview.Columns.Add( new DataColumn("idreg", typeof(int)));
	tpccsplitpaymentview.Columns.Add( new DataColumn("IDENTIFICATIVO_1", typeof(string)));
	Tables.Add(tpccsplitpaymentview);
	tpccsplitpaymentview.PrimaryKey =  new DataColumn[]{tpccsplitpaymentview.Columns["idpcc"], tpccsplitpaymentview.Columns["idpccsplitpayment"]};
	...
	cPar = new []{pcc.Columns["idpcc"]};
	cChild = new []{pccdocamountvarview.Columns["idpcc"]};
	Relations.Add(new DataRelation("pcc_pccdocamountvarview",cPar,cChild,false));

	cPar = new []{pcc.Columns["idpcc"]};
	cChild = new []{pccsplitpaymentview.Columns["idpcc"]};
	Relations.Add(new DataRelation("pcc_pccsplitpaymentview",cPar,cChild,false));
