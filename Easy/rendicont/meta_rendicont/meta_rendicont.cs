...
namespace meta_rendicont
{
    public class Meta_rendicont : Meta_easydata 
	{
		...
		public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
			...
			RowChange.MarkAsAutoincrement(T.Columns["idrendicont"], null, null, 0);
			RowChange.setMinimumTempValue(T.Columns["idrendicont"], 9990000);
			//$Get_New_Row$
			...
			switch (edit_type) {
				case "default": {
						if (R["aa"].ToString().Trim() == "") {
							errmess = "Attenzione! Il campo 'Anno accademico' è obbligatorio";
							errfield = "aa";
							return false;
						}
