...
namespace meta_rendicont {
public class rendicontRow: MetaRow  {
	public rendicontRow(DataRowBuilder rb) : base(rb) {} 
...
///<summary>
///2.4.31 Scheda di rendicontazione / registro elettronico
///</summary>
public class rendicontTable : MetaTableBase<rendicontRow> {
	public rendicontTable() : base("rendicont"){
