...
public class rendicontaltrokindRow: MetaRow  {
	public rendicontaltrokindRow(DataRowBuilder rb) : base(rb) {} 
...
///<summary>
///Tipologia delle attività oltre le lezioni della 2.4.31 Scheda di rendicontazione / registro elettronico
///</summary>
public class rendicontaltrokindTable : MetaTableBase<rendicontaltrokindRow> {
	public rendicontaltrokindTable() : base("rendicontaltrokind"){
