...
public class instmseztematichekindRow: MetaRow  {
	public instmseztematichekindRow(DataRowBuilder rb) : base(rb) {} 
...
public class instmseztematichekindTable : MetaTableBase<instmseztematichekindRow> {
	public instmseztematichekindTable() : base("instmseztematichekind"){
