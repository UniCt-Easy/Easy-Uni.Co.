...
namespace serviceprovider_default//FornitoreServizio//
{
	/// <summary>
	/// Summary description for frmfornitoreservizio.
	/// </summary>
	public class Frm_serviceprovider_default : System.Windows.Forms.Form
	{
		...
		public Frm_serviceprovider_default()
		{
			//
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Frm_serviceprovider_default));
			...
			this.MetaDataDetail.Location = new System.Drawing.Point(264, 57);
			this.MetaDataDetail.Name = "MetaDataDetail";
			this.MetaDataDetail.Size = new System.Drawing.Size(232, 144);
			...
			this.textBox1.Tag = "serviceprovider.idserviceprovider";
			this.textBox1.Text = "";
			// 
			// textBox2
			// 
			...
			this.textBox2.Tag = "serviceprovider.description";
			this.textBox2.Text = "";
			// 
			// label1
			// 
			...
			this.dataGrid1.Tag = "serviceprovider.default";
			// 
			// DS
			// 
			...
			this.Name = "frmfornitoreservizio";
			this.Text = "frmfornitoreservizio";
