...
namespace meta_csa_agencyview
{
	/// <summary>
	/// </summary>
	public class Meta_csa_agencyview : Meta_easydata {
		public Meta_csa_agencyview(DataAccess Conn, MetaDataDispatcher Dispatcher):
			base(Conn, Dispatcher, "csa_agencyview") {		
