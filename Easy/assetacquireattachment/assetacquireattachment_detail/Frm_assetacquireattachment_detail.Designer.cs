...
namespace assetacquireattachment_detail
{
	partial class Frm_assetacquireattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new assetacquireattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "assetacquireattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "assetacquireattachment.idattachmentkind";
			...
			// 
			// Frm_assetacquireattachment_detail
			// 
			...
			this.Name = "Frm_assetacquireattachment_detail";
			this.Text = "Frm_assetacquireattachment_detail";
