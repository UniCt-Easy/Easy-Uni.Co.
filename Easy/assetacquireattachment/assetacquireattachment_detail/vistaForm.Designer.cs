...
private void initClass() {
	...
	C.AllowDBNull=false;
	tassetacquireattachment.Columns.Add(C);
	tassetacquireattachment.Columns.Add( new DataColumn("idfilestorage", typeof(string)));
	...
	var cChild = new []{assetacquireattachment.Columns["idattachmentkind"]};
	Relations.Add(new DataRelation("attachmentkind_assetacquireattachment",cPar,cChild,false));
