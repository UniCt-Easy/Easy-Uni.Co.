...
namespace accountingyear_patrimonio//esercizio_patrimonio//
{
	...
	/// </summary>
	public class frmesercizio_patrimonio : System.Windows.Forms.Form
	{
		public vistaForm DS;
    ...
    "io in corso come iniziale dell\'esercizio successivo per ogni ente inventariale";
            ...
            this.label5.Text = "Generazione Risconti";
            ...
            this.textBox5.Text = "Genera i risconti per i contributi conto impianti relativamente agli ammortamenti" +
    " effettuati.";
            // 
		...
		private void btnFase1_Click(object sender, System.EventArgs e)
		{
            ...
            if (Nvar > 0) {
                MetaFactory.factory.getSingleton<IMessageShower>().Show("Esiste già una variazione iniziale nell'anno successivo. Operazione vietata.");
                return;
            }
        ...
        private void btnFase2_Click(object sender, System.EventArgs e) {
            ...
            if (t.Rows.Count == 0) {
                MetaFactory.factory.getSingleton<IMessageShower>().Show(this, "Per tutti gli enti è già stata eseguita la chiusura del patrimonio!");
                return;
            }
