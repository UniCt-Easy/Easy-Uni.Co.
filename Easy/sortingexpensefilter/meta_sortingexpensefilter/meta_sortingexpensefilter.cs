...
namespace meta_sortingexpensefilter//meta_filtraclassspese//
{
	/// <summary>
	/// Summary description for Class1.
	/// </summary>
	public class Meta_sortingexpensefilter : Meta_easydata 
	{
		public Meta_sortingexpensefilter(DataAccess Conn, MetaDataDispatcher Dispatcher):
			base(Conn, Dispatcher, "sortingexpensefilter") 
		{
		...
		protected override Form GetForm(string FormName) 
		{
			if (FormName=="default") 
			{
				...
				Name = "Configurazione filtro classificazione spese";
				Form F = GetFormByDllName("sortingexpensefilter_default");
				return F;
			}
            if (FormName == "single")
            {
                Name = "Configurazione filtro classificazione spese - U.P.B.";
                DefaultListType = "upb";
                return GetFormByDllName("sortingexpensefilter_single");
            }
            return null;
		}		
		...
		public override DataRow SelectOne(string ListingType, string filter, string searchtable, DataTable Exclude) 
		{
			if (ListingType=="default")
				return base.SelectOne(ListingType, filter, "sortingexpensefilterview", Exclude);
			return base.SelectOne(ListingType, filter, "sortingexpensefilter", Exclude);
		}
