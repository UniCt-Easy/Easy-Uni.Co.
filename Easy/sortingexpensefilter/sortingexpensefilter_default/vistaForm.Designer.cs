...
namespace sortingexpensefilter_default {
...
public class vistaForm: DataSet {
	...
	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public DataTable sortingexpensefilterview 		=> Tables["sortingexpensefilterview"];
...
private void initClass() {
	...
	tsortingexpensefilter.PrimaryKey =  new DataColumn[]{tsortingexpensefilter.Columns["ayear"], tsortingexpensefilter.Columns["idautosort"]};
	...
	//////////////////// SORTINGEXPENSEFILTERVIEW /////////////////////////////////
	var tsortingexpensefilterview= new DataTable("sortingexpensefilterview");
	tsortingexpensefilterview.Columns.Add( new DataColumn("codefin", typeof(string)));
	tsortingexpensefilterview.Columns.Add( new DataColumn("finance", typeof(string)));
	tsortingexpensefilterview.Columns.Add( new DataColumn("codeupb", typeof(string)));
	tsortingexpensefilterview.Columns.Add( new DataColumn("upb", typeof(string)));
	tsortingexpensefilterview.Columns.Add( new DataColumn("regsortingkind", typeof(string)));
	tsortingexpensefilterview.Columns.Add( new DataColumn("registrysortcode", typeof(string)));
	tsortingexpensefilterview.Columns.Add( new DataColumn("registrykind", typeof(string)));
	tsortingexpensefilterview.Columns.Add( new DataColumn("manager", typeof(string)));
	C= new DataColumn("sortingkind", typeof(string));
	C.AllowDBNull=false;
	tsortingexpensefilterview.Columns.Add(C);
	tsortingexpensefilterview.Columns.Add( new DataColumn("sortingcode", typeof(string)));
	tsortingexpensefilterview.Columns.Add( new DataColumn("sorting", typeof(string)));
	C= new DataColumn("ayear", typeof(int));
	C.AllowDBNull=false;
	tsortingexpensefilterview.Columns.Add(C);
	C= new DataColumn("idautosort", typeof(int));
	C.AllowDBNull=false;
	tsortingexpensefilterview.Columns.Add(C);
	tsortingexpensefilterview.Columns.Add( new DataColumn("idsorkind", typeof(int)));
	tsortingexpensefilterview.Columns.Add( new DataColumn("idsorkindreg", typeof(int)));
	tsortingexpensefilterview.Columns.Add( new DataColumn("ct", typeof(DateTime)));
	tsortingexpensefilterview.Columns.Add( new DataColumn("cu", typeof(string)));
	C= new DataColumn("jointolessspecifics", typeof(string));
	C.AllowDBNull=false;
	tsortingexpensefilterview.Columns.Add(C);
	tsortingexpensefilterview.Columns.Add( new DataColumn("idfin", typeof(int)));
	tsortingexpensefilterview.Columns.Add( new DataColumn("idupb", typeof(string)));
	C= new DataColumn("idsor", typeof(int));
	C.AllowDBNull=false;
	tsortingexpensefilterview.Columns.Add(C);
	tsortingexpensefilterview.Columns.Add( new DataColumn("idsorreg", typeof(int)));
	tsortingexpensefilterview.Columns.Add( new DataColumn("lt", typeof(DateTime)));
	tsortingexpensefilterview.Columns.Add( new DataColumn("lu", typeof(string)));
	tsortingexpensefilterview.Columns.Add( new DataColumn("idman", typeof(int)));
	Tables.Add(tsortingexpensefilterview);
	tsortingexpensefilterview.PrimaryKey =  new DataColumn[]{tsortingexpensefilterview.Columns["ayear"], tsortingexpensefilterview.Columns["idautosort"]};
	...
	cChild = new []{sortingexpensefilter.Columns["idsorreg"]};
	Relations.Add(new DataRelation("classmovimenti1sortingexpensefilter",cPar,cChild,false));

	cPar = new []{sortingapplicabilityview.Columns["idsorkind"]};
	cChild = new []{sortingexpensefilter.Columns["idsorkind"]};
	Relations.Add(new DataRelation("sortingapplicabilityviewsortingexpensefilter",cPar,cChild,false));

	cPar = new []{manager.Columns["idman"]};
	cChild = new []{sortingexpensefilter.Columns["idman"]};
	Relations.Add(new DataRelation("managersortingexpensefilter",cPar,cChild,false));

	cPar = new []{sorting.Columns["idsor"]};
	cChild = new []{sortingexpensefilter.Columns["idsor"]};
	Relations.Add(new DataRelation("sortingsortingexpensefilter",cPar,cChild,false));

	cPar = new []{sortingkind.Columns["idsorkind"]};
	cChild = new []{sortingexpensefilter.Columns["idsorkind"]};
	Relations.Add(new DataRelation("sortingkindsortingexpensefilter",cPar,cChild,false));

	cPar = new []{fin.Columns["idfin"]};
	cChild = new []{sortingexpensefilter.Columns["idfin"]};
	Relations.Add(new DataRelation("finsortingexpensefilter",cPar,cChild,false));

	cPar = new []{upb.Columns["idupb"]};
	cChild = new []{sortingexpensefilter.Columns["idupb"]};
	Relations.Add(new DataRelation("upbsortingexpensefilter",cPar,cChild,false));
