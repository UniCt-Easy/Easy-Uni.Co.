...
public DataTable supplierinvoice{get { return this.Tables["supplierinvoice"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
...
this.EnforceConstraints = false;
	...
	DataColumn C;
	DataColumn [] key;
	T= new DataTable("supplierinvoice");
...
//Primary Key
	...
	T.Columns["iddbdepartment"], 	T.Columns["idinvkind"], 	T.Columns["yinv"], 	T.Columns["ninv"]};
	T.PrimaryKey = key;
...
TChild= Tables["supplierinvoice"];
CPar = new DataColumn[1]{TPar.Columns["idreg"]};
CChild = new DataColumn[1]{TChild.Columns["idreg"]};
Relations.Add(new DataRelation("registrysupplierinvoice",CPar,CChild));
...
Relations.Add(new DataRelation("dbdepartmentsupplierinvoice",CPar,CChild));

TPar= Tables["invoicekind"];
TChild= Tables["supplierinvoice"];
CPar = new DataColumn[1]{TPar.Columns["idinvkind"]};
CChild = new DataColumn[1]{TChild.Columns["idinvkind"]};
Relations.Add(new DataRelation("invoicekindsupplierinvoice",CPar,CChild));
