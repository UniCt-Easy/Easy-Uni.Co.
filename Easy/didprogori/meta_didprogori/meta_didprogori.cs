...
namespace meta_didprogori
{
    public class Meta_didprogori : Meta_easydata 
	{
        public Meta_didprogori(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "didprogori") {
				Name = "Orientamenti";
		...
		public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
			...
			RowChange.MarkAsAutoincrement(T.Columns["iddidprogori"], null, null, 0);
			RowChange.setMinimumTempValue(T.Columns["iddidprogori"], 9990000);
			//$Get_New_Row$
