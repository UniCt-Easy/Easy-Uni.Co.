...
public class didprogoriRow: MetaRow  {
	public didprogoriRow(DataRowBuilder rb) : base(rb) {} 
...
///2.4.13 orientamento
///</summary>
public class didprogoriTable : MetaTableBase<didprogoriRow> {
	public didprogoriTable() : base("didprogori"){
