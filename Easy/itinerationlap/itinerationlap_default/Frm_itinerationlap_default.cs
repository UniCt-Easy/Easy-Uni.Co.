...
namespace itinerationlap_default{//missionetappa//
	...
	public class Frm_itinerationlap_default : System.Windows.Forms.Form {
		...
		private void InitializeComponent() {
            ...
            this.btnLocalita.Text = "Localit‡ Estera:";
            ...
            this.label12.Text = "Indennit‡ totale Euro:";
            ...
            this.txtHelpIndennitaTotale.Text = "L\'indennit‡ totale Ë data dal prodotto dell\'indennit‡ giornaliera corrisposta * (" +
            ...
            this.txtHelpAnticipo.Text = "L\'anticipo Ë calcolato come il prodotto dell\'indennit‡ corrisposta *(1-percentual" +
            ...
            this.label3.Text = "Massima indennit‡ giornaliera Concedibile: ";
            ...
            this.txtHelpIndennLorda.Text = "Se l\' Indennit‡ totale Ë maggiore di Quota esente, allora l\'Indennit‡ lorda Ë ugu" +
                "ale a Quota imponibile+Quota esente, altrimenti l\'Indennit‡ lorda Ë uguale a Ind" +
                "ennit‡ Totale ";
            // 
            // txtIndennLorda
            // 
            ...
            this.label19.Text = "Indennit‡ lorda";
            ...
            this.label8.Text = "Attenzione: per assicurare un corretto calcolo dell\'indennit‡ da corrispondere, Ë" +
...
//			if (filter==null){
//				MessageBox.Show("I dati inseriti nella scheda Generalit‡ sono incompleti o mancanti");
...
//			}	
		...
		public void MetaData_AfterActivation(){
			...
			if (ParentMissione.RowState!=DataRowState.Added){
				...
				if (N>0) MessageBox.Show(
							 "Avendo gi‡ contabilizzato l'anticipo di questa missione, le modifiche alla tappa "+
		...
		#region Gestione Calcolo Indennit‡ di trasferta
		...
		/// <summary>
		/// Rilegge dal DB Indennit‡ Euro, Indennit‡ Corrisp. Euro, Percentuale Anticipo  per l'italia
		/// L'indennit‡ corrisposta Ë inizializzata all'indennit‡
		/// Chiamato quando:
