...
{
    public class Meta_itinerationlap_instm : Meta_easydata 
	{
        public Meta_itinerationlap_instm(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "itinerationlap_instm") {
				Name = "Tratta";
