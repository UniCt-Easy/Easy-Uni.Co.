...
namespace meta_pccsplitpaymentview {
    /// <summary>
    /// Summary description for Class1.
    /// </summary>
    public class Meta_pccsplitpaymentview : Meta_easydata {
        public Meta_pccsplitpaymentview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "pccsplitpaymentview") {
        ...
        public override void DescribeColumns(DataTable T, string ListingType) {
            ...
            if (ListingType == "default") {
                ...
                DescribeAColumn(T, "flag_enable_split_payment", "Split Payment", nPos++);
            }
        }
