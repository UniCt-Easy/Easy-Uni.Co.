...
namespace estimatekindattachment_detail
{
	partial class Frm_estimatekindattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new estimatekindattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "estimatekindattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "estimatekindattachment.idattachmentkind";
			...
			// 
			// Frm_estimatekindattachment_detail
			// 
			...
			this.Name = "Frm_estimatekindattachment_detail";
			this.Text = "Frm_estimatekindattachment_detail";
