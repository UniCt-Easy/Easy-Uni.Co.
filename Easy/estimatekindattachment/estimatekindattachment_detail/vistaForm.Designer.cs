...
public partial class vistaForm: DataSet {
	...
	public DataTable estimatekindattachment 		=> Tables["estimatekindattachment"];
...
private void initClass() {
	...
	var cChild = new []{estimatekindattachment.Columns["idattachmentkind"]};
	Relations.Add(new DataRelation("attachmentkind_estimatekindattachment",cPar,cChild,false));
