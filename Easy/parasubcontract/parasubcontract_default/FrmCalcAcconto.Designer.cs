...
namespace parasubcontract_default {
    partial class FrmCalcAcconto {
        ...
        private void InitializeComponent() {
            ...
            this.lblRedditoComplessivo.Text = "Abbiamo stimato che il reddito complessivo per l\'esercizio XXX sia pari a Ä yyy. " +
                "Il calcolo Ë stato fatto tenendo sommando gli imponibili fiscali delle prestazio" +
