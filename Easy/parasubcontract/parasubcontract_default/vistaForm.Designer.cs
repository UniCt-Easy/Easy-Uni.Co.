...
public partial class dsmeta: DataSet {
	...
	///<summary>
	///Attività Previdenziale INPS (per l'E-Mens)
	///</summary>
	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
...
private void initClass() {
	...
	texpensepayrollview.defineColumn("ypay", typeof(short));
	texpensepayrollview.defineColumn("npay", typeof(int));
	...
	texpensepayrollview.defineColumn("idpaymethod", typeof(int));
	texpensepayrollview.defineColumn("cin", typeof(string));
	texpensepayrollview.defineColumn("idbank", typeof(string));
	texpensepayrollview.defineColumn("idcab", typeof(string));
	texpensepayrollview.defineColumn("cc", typeof(string));
	texpensepayrollview.defineColumn("paymentdescr", typeof(string));
	texpensepayrollview.defineColumn("idser", typeof(int));
	texpensepayrollview.defineColumn("service", typeof(string));
	texpensepayrollview.defineColumn("servicestart", typeof(DateTime));
	texpensepayrollview.defineColumn("servicestop", typeof(DateTime));
	texpensepayrollview.defineColumn("ivaamount", typeof(decimal));
