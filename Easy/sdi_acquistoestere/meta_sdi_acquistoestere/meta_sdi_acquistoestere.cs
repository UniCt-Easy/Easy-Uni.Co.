...
namespace meta_sdi_acquistoestere {
    /// <summary>
    /// Summary description for Class1.
    /// </summary>
    public class Meta_sdi_acquistoestere : Meta_easydata {
        public Meta_sdi_acquistoestere(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "sdi_acquistoestere") {
        ...
        protected override Form GetForm(string FormName) {
            if (FormName == "default") {
                ...
                Name = "Fatture Elettroniche di Acquisto estere";
                return GetFormByDllName("sdi_acquistoestere_default");
            }
            return null;
        }
        ...
        public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
            RowChange.MarkAsAutoincrement(T.Columns["idsdi_acquistoestere"], null, null, 7);
            RowChange.MarkAsCustomAutoincrement(T.Columns["idsdi_acquistoestere"], new RowChange.CustomCalcAutoID(CalcIDacquistoestere));
        ...
        public override DataRow SelectOne(string ListingType, string filter, string searchtable, DataTable Exclude) {
            if (ListingType == "default")
                return base.SelectOne(ListingType, filter, "sdi_acquistoestereview", Exclude);
            return base.SelectOne(ListingType, filter, "sdi_acquistoestere", Exclude);
        }
