...
public partial class vistaForm: DataSet {
	...
	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public DataTable sdi_acquistoestere 		=> Tables["sdi_acquistoestere"];
...
private void initClass() {
	...
	tinvoice.Columns.Add( new DataColumn("idsdi_acquistoestere", typeof(int)));
	...
	//////////////////// SDI_ACQUISTOESTERE /////////////////////////////////
	var tsdi_acquistoestere= new DataTable("sdi_acquistoestere");
	C= new DataColumn("idsdi_acquistoestere", typeof(int));
	C.AllowDBNull=false;
	tsdi_acquistoestere.Columns.Add(C);
	tsdi_acquistoestere.Columns.Add( new DataColumn("adate", typeof(DateTime)));
	tsdi_acquistoestere.Columns.Add( new DataColumn("arrivalprotocolnum", typeof(string)));
	...
	C.AllowDBNull=false;
	tsdi_acquistoestere.Columns.Add(C);
	tsdi_acquistoestere.Columns.Add( new DataColumn("flag_unseen", typeof(int)));
	tsdi_acquistoestere.Columns.Add( new DataColumn("identificativo_sdi", typeof(long)));
	tsdi_acquistoestere.Columns.Add( new DataColumn("idsdi_deliverystatus", typeof(short)));
	tsdi_acquistoestere.Columns.Add( new DataColumn("idsdi_rifamm", typeof(string)));
	tsdi_acquistoestere.Columns.Add( new DataColumn("idsdi_status", typeof(short)));
	tsdi_acquistoestere.Columns.Add( new DataColumn("ipa_fe", typeof(string)));
	tsdi_acquistoestere.Columns.Add( new DataColumn("issigned", typeof(string)));
	C= new DataColumn("lt", typeof(DateTime));
	C.AllowDBNull=false;
	tsdi_acquistoestere.Columns.Add(C);
	C= new DataColumn("lu", typeof(string));
	C.AllowDBNull=false;
	tsdi_acquistoestere.Columns.Add(C);
	tsdi_acquistoestere.Columns.Add( new DataColumn("mc", typeof(string)));
	tsdi_acquistoestere.Columns.Add( new DataColumn("mc_prot", typeof(string)));
	tsdi_acquistoestere.Columns.Add( new DataColumn("ns", typeof(string)));
	tsdi_acquistoestere.Columns.Add( new DataColumn("ns_prot", typeof(string)));
	tsdi_acquistoestere.Columns.Add( new DataColumn("position", typeof(int)));
	tsdi_acquistoestere.Columns.Add( new DataColumn("protocol_error", typeof(string)));
	tsdi_acquistoestere.Columns.Add( new DataColumn("rc", typeof(string)));
	tsdi_acquistoestere.Columns.Add( new DataColumn("rc_prot", typeof(string)));
	tsdi_acquistoestere.Columns.Add( new DataColumn("signedxml", typeof(string)));
	tsdi_acquistoestere.Columns.Add( new DataColumn("signedxmlfilename", typeof(string)));
	C= new DataColumn("xml", typeof(string));
	C.AllowDBNull=false;
	tsdi_acquistoestere.Columns.Add(C);
	tsdi_acquistoestere.Columns.Add( new DataColumn("zipfilename", typeof(string)));
	Tables.Add(tsdi_acquistoestere);
	tsdi_acquistoestere.PrimaryKey =  new DataColumn[]{tsdi_acquistoestere.Columns["idsdi_acquistoestere"]};
	...
	var cChild = new []{sdi_acquistoestere.Columns["idsdi_status"]};
	Relations.Add(new DataRelation("sdi_status_sdi_acquistoestere",cPar,cChild,false));

	cPar = new []{sdi_acquistoestere.Columns["idsdi_acquistoestere"]};
	cChild = new []{invoice.Columns["idsdi_acquistoestere"]};
	Relations.Add(new DataRelation("sdi_acquistoestere_invoice",cPar,cChild,false));
	...
	cChild = new []{sdi_acquistoestere.Columns["idsdi_deliverystatus"]};
	Relations.Add(new DataRelation("sdi_deliverystatus_sdi_acquistoestere",cPar,cChild,false));

	cPar = new []{ipa.Columns["ipa_fe"]};
	cChild = new []{sdi_acquistoestere.Columns["ipa_fe"]};
	Relations.Add(new DataRelation("ipa_sdi_acquistoestere",cPar,cChild,false));

	cPar = new []{sdi_rifamm.Columns["idsdi_rifamm"]};
	cChild = new []{sdi_acquistoestere.Columns["idsdi_rifamm"]};
	Relations.Add(new DataRelation("sdi_rifamm_sdi_acquistoestere",cPar,cChild,false));
