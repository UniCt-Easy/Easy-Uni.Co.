...
namespace treasurer_default {//istitutocassiere//
    ...
    "ncassi:";
            ...
            this.checkBox6.Text = "Abilita Numerazione dei Documenti per Conto Corrente";
    ...
    "il BBAN come da regolamento bancario";
		...
		public void metaData_AfterFill() {
            ...
            if (isBlazor())
            {
                if (string.IsNullOrEmpty(txtDir.Text) && (insertMode || editMode))
                {
                    btnChooseDir.PerformClick();
                }
            }
        }
