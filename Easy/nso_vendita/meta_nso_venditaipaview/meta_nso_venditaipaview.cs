...
namespace meta_nso_venditaipaview
{
    public class Meta_nso_venditaipaview : Meta_easydata {
        public Meta_nso_venditaipaview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "nso_venditaipaview") {
