...
namespace nso_vendita_default {
    partial class Frm_nso_vendita_default {
        /// <summary>
        ...
        private void InitializeComponent() {
			this.DS = new nso_vendita_default.VistaForm();
			this.tabControl1 = new System.Windows.Forms.TabControl();
			this.tabPrincipale = new System.Windows.Forms.TabPage();
			this.label34 = new System.Windows.Forms.Label();
			this.txtEmailAvvisoRicezione = new System.Windows.Forms.TextBox();
			...
			this.grpOperazionisuOV = new System.Windows.Forms.GroupBox();
			...
			this.txtDataScadenzaOrdine = new System.Windows.Forms.TextBox();
			this.label26 = new System.Windows.Forms.Label();
			this.grpDatiFattura = new System.Windows.Forms.GroupBox();
			this.label6 = new System.Windows.Forms.Label();
			this.txtClienteTaxId = new System.Windows.Forms.TextBox();
			this.groupBox2 = new System.Windows.Forms.GroupBox();
			this.txtIdEmittenteOrdine = new System.Windows.Forms.TextBox();
			this.label24 = new System.Windows.Forms.Label();
			this.label32 = new System.Windows.Forms.Label();
			this.txtDataEmissioneOrdine = new System.Windows.Forms.TextBox();
			this.txtIdOrdine = new System.Windows.Forms.TextBox();
			...
			this.txtOrderTaxTotal = new System.Windows.Forms.TextBox();
			this.txtClienteId = new System.Windows.Forms.TextBox();
			this.label27 = new System.Windows.Forms.Label();
			this.label14 = new System.Windows.Forms.Label();
			this.txtNumProtocolloEntrata = new System.Windows.Forms.TextBox();
			...
			this.txtCodiceIpa = new System.Windows.Forms.TextBox();
			...
			this.grpOperazionisuOV.SuspendLayout();
			...
			// tabPrincipale
			// 
			this.tabPrincipale.Controls.Add(this.label34);
			this.tabPrincipale.Controls.Add(this.txtEmailAvvisoRicezione);
			...
			this.tabPrincipale.Controls.Add(this.grpOperazionisuOV);
			...
			this.grpOperazionisuOV.Controls.Add(this.txtRifiuto);
			this.grpOperazionisuOV.Controls.Add(this.btnRifiuta);
			this.grpOperazionisuOV.Controls.Add(this.txtDataRicezioneSdI);
			...
			this.grpDatiFattura.Controls.Add(this.label33);
			this.grpDatiFattura.Controls.Add(this.txtIpa);
			this.grpDatiFattura.Controls.Add(this.label30);
			this.grpDatiFattura.Controls.Add(this.txtCliente);
			this.grpDatiFattura.Controls.Add(this.label5);
			this.grpDatiFattura.Controls.Add(this.txtOrderTaxTotal);
			this.grpDatiFattura.Controls.Add(this.txtClienteId);
			this.grpDatiFattura.Controls.Add(this.label27);
			this.grpDatiFattura.Controls.Add(this.label14);
			this.grpDatiFattura.Controls.Add(this.txtNumProtocolloEntrata);
			this.grpDatiFattura.Controls.Add(this.txtProtocolDate);
			this.grpDatiFattura.Controls.Add(this.label12);
			this.grpDatiFattura.Controls.Add(this.txtOrderTotal);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.groupBox2.Controls.Add(this.txtIdEmittenteOrdine);
			...
			this.grpOperazionisuOV.ResumeLayout(false);
			this.grpOperazionisuOV.PerformLayout();
        ...
        private System.Windows.Forms.TextBox txtCodiceIpa;
        ...
        private System.Windows.Forms.TextBox txtProtocolDate;
        private System.Windows.Forms.Label label14;
        private System.Windows.Forms.TextBox txtNumProtocolloEntrata;
        ...
        private System.Windows.Forms.TextBox txtDataScadenzaOrdine;
        private System.Windows.Forms.TextBox txtDataEmissioneOrdine;
        private System.Windows.Forms.Label label30;
        private System.Windows.Forms.TextBox txtOrderTaxTotal;
        private System.Windows.Forms.Label label13;
        private System.Windows.Forms.TextBox txtIpa;
        private System.Windows.Forms.Label label32;
        private System.Windows.Forms.Label label31;
        private System.Windows.Forms.TextBox txtIdEmittenteOrdine;
        private System.Windows.Forms.TextBox txtIdOrdine;
        private System.Windows.Forms.Label label33;
        private System.Windows.Forms.Label label5;
        private System.Windows.Forms.TextBox txtClienteId;
        private System.Windows.Forms.TextBox txtClienteTaxId;
