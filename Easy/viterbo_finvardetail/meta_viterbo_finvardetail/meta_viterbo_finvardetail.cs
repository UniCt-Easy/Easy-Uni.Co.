...
namespace meta_viterbo_finvardetail
{
    public class Meta_viterbo_finvardetail : Meta_easydata {
        public Meta_viterbo_finvardetail(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "viterbo_finvardetail") {
        ...
        public override bool FilterRow(DataRow R, string list_type) {
            if ((list_type == "bilancio") || (list_type == "upb")) {
                if (R.Table.DataSet.Tables["viterbo_finvar"] != null) {
                    DataTable tFinVar = R.Table.DataSet.Tables["viterbo_finvar"];
        ...
        public override void DescribeColumns(DataTable T, string listtype) {
            ...
            if (listtype == "bilancio") {
                ...
                DescribeAColumn(T, "nvar", "Num. Prot.", nPos++);
                DescribeAColumn(T, "!nofficial", "Num. Var. Uff.", "viterbo_finvar.nofficial", nPos++);
                DescribeAColumn(T, "!upb", "U.P.B.", "upb.codeupb", nPos++);
                DescribeAColumn(T, "!finanziamento", "Finanziamento", "underwriting.title", nPos++);
                DescribeAColumn(T, "description", "Descrizione", nPos++);
            ...
            if (listtype == "upb") {
                ...
                DescribeAColumn(T, "!codicebilancio", "Voce di bilancio", "fin.codefin", nPos++);
                DescribeAColumn(T, "!codiceconto", "Conto", "account.codeacc", nPos++);
                DescribeAColumn(T, "!finanziamento", "Finanziamento", "underwriting.title", nPos++);
                DescribeAColumn(T, "description", "Descrizione", nPos++);
                if (CfgFn.NomePrevisionePrincipale(Conn) != null)
                    DescribeAColumn(T, "!prev_competenza", "Prev. " + CfgFn.NomePrevisionePrincipale(Conn), nPos++);
        ...
        public override bool IsValid(DataRow R, out string errmess, out string errfield) {
            ...
            foreach (DataRelation Rp in PrimaryDataTable.ParentRelations) {
                if (Rp.ParentTable.TableName != "viterbo_finvar") continue;
                Rfound = Rp;
                break;
            }
        ...
        public override DataRow SelectOne(string ListingType, string filter, string searchtable, DataTable Exclude) {
            if (ListingType == "listaestesa")
                return base.SelectOne(ListingType, filter, "viterbo_finvardetailview", Exclude);
            else
                return base.SelectOne(ListingType, filter, "viterbo_finvardetail", Exclude);
        }
