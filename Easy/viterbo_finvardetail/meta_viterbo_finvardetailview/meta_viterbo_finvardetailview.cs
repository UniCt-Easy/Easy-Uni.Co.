...
namespace meta_viterbo_finvardetailview
{
    public class Meta_viterbo_finvardetailview :Meta_easydata {
        public Meta_viterbo_finvardetailview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "viterbo_finvardetailview") {
