...
namespace proceedsattachment_detail
{
	partial class Frm_proceedsattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new proceedsattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "proceedsattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "proceedsattachment.idattachmentkind";
			...
			this.Name = "Frm_proceedsattachment_detail";
			this.Text = "Frm_proceedsattachment_detail";
