...
namespace meta_iscrizioneseganagstuview
{
    public class Meta_iscrizioneseganagstuview : Meta_easydata 
	{
        public Meta_iscrizioneseganagstuview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "iscrizioneseganagstuview") {
				Name = "Iscrizioni a corsi di studio";
