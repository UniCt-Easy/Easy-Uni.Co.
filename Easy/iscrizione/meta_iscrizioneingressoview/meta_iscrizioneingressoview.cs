...
namespace meta_iscrizioneingressoview
{
    public class Meta_iscrizioneingressoview : Meta_easydata 
	{
        public Meta_iscrizioneingressoview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "iscrizioneingressoview") {
				Name = "Iscrizioni";
