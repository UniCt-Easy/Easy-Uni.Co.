...
namespace meta_iscrizionestatoview
{
    public class Meta_iscrizionestatoview : Meta_easydata 
	{
        public Meta_iscrizionestatoview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "iscrizionestatoview") {
				Name = "Iscrizioni";
			EditTypes.Add("stato");
