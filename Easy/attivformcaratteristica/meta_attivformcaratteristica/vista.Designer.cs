...
public class attivformcaratteristicaRow: MetaRow  {
	public attivformcaratteristicaRow(DataRowBuilder rb) : base(rb) {} 
...
///</summary>
public class attivformcaratteristicaTable : MetaTableBase<attivformcaratteristicaRow> {
	public attivformcaratteristicaTable() : base("attivformcaratteristica"){
