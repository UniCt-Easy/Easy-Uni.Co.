...
namespace meta_attivformcaratteristica
{
    public class Meta_attivformcaratteristica : Meta_easydata 
	{
        public Meta_attivformcaratteristica(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "attivformcaratteristica") {
				Name = "Caratteristiche dell'attività formativa";
		...
		public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
			...
			RowChange.MarkAsAutoincrement(T.Columns["idattivformcaratteristica"], null, null, 0);
			RowChange.setMinimumTempValue(T.Columns["idattivformcaratteristica"], 9990000);
			//$Get_New_Row$
