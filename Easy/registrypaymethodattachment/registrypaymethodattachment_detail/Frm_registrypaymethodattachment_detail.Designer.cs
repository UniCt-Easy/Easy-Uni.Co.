...
namespace registrypaymethodattachment_detail
{
	partial class Frm_registrypaymethodattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new registrypaymethodattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "registrypaymethodattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "registrypaymethodattachment.idattachmentkind";
			...
			// 
			// Frm_registrypaymethodattachment_detail
			// 
			...
			this.Name = "Frm_registrypaymethodattachment_detail";
			this.Text = "Frm_registrypaymethodattachment_detail";
