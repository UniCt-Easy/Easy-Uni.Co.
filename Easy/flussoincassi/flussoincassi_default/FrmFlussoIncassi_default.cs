        ...
        private void btnImportaFileEsito_Click(object sender, EventArgs e) {
            ...
            switch (partner) {
                ...
                case "ubibanca":
                    ...
                    string err = Unicredit.FlussoIncassi.Elabora(fileName,false, out tFlussoBanca, partner);
                    if (err!=null) {
                ...
                case "bsondrio":
                    ...
                    foreach (var disposizione in flussoIncassi.Disposizioni.Values) {
                        ...
                        rFlussoIncassi["dataincasso"] = disposizione.DataQuietanza;//era DataPagamento ma è la scadenza
