...
namespace flussoincassi_default {
    ...
    /// </summary>
    public class Frmflussoincassi_default : MetaDataForm {
        ...
        public Frmflussoincassi_default() {
            InitializeComponent();
			HelpForm.SetDenyNull(DS.flussoincassi.Columns["elaborato"], true);
		}
        ...
        private void InitializeComponent() {
			...
			this.tabPage1.Size = new System.Drawing.Size(843, 673);
			...
			this.txtNomeFileRisposta.Size = new System.Drawing.Size(695, 20);
        ...
        public void MetaData_AfterLink() {
			...
			GetData.SetStaticFilter(DS.flussoincassiview, filterFlussoIncassi);
        ...
        /// Il collegamento con il credito è effettuato sempre e solo con lo IUV del credito
        /// </summary>
        ...
        private void btnImportaFileEsito_Click(object sender, EventArgs e) {
			...
			switch (partner) {
                ...
                // o il n. di sospeso (che è l'ideale) oppure la causale che troveremo nel bollettino , che sarebbe
                //  "/PUR/LGPE-RIVERSAMENTO/URI/" + codiceFlusso  (che non è il TRN);
                ...
                case "ubibanca":
                    ...
                    foreach (DataRow R in tFlussoBanca.Rows) {
						...
						//r["CESE"] //len:	4	NUMERICO 	int:	4	 dec:	0		Esercizio di riferimento del provvisorio di Tesoreria associato all’incasso
                        ...
                        if (idflusso != null) {
							...
							//L'upb del dettaglio credito è usato per ottenere gli attributi di sicurezza
                            ...
                            //per comodità dell'utente valorizziamo il n. bollettino nel dettaglio incasso
                ...
                case "bsondrio":
                    ...
                    foreach (var disposizione in flussoIncassi.Disposizioni.Values) {
                        ...
                        rFlussoIncassi["dataincasso"] = disposizione.DataAccredito;//era DataPagamento ma è la scadenza
                    ...
                    break;
				case "intesasp":
					RendicontaPlus FlussoRendicontazione;
					string err3 = IntesaSanPaolo.import_RicevutaTelematica.ImportaFile_RT(fileName, out FlussoRendicontazione);
					if (err3 != null) {
						show(this, err3);
						return;
					}
