...
{
    public class Meta_insegncaratteristica : Meta_easydata 
	{
        public Meta_insegncaratteristica(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "insegncaratteristica") {
				Name = "Caratteristiche dell'insegnamento";
		...
		public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
			...
			RowChange.MarkAsAutoincrement(T.Columns["idinsegncaratteristica"], null, null, 0);
			RowChange.setMinimumTempValue(T.Columns["idinsegncaratteristica"], 9990000);
			//$Get_New_Row$
		...
		public override bool IsValid(DataRow R, out string errmess, out string errfield) {
			...
			switch (edit_type) {
				case "default": {
						...
						if (R["idinsegncaratteristica"].ToString().Trim() == "") {
							errmess = "Attenzione! Il campo 'Identificativo' è obbligatorio";
							errfield = "idinsegncaratteristica";
							return false;
						}
