...
namespace meta_epexpview
{
	/// <summary>
	/// Summary description for Class1.
	/// </summary>
	public class Meta_epexpview : Meta_easydata {
		public Meta_epexpview(DataAccess Conn, MetaDataDispatcher Dispatcher):
			base(Conn, Dispatcher, "epexpview") {
        ...
        private string[] mykey = new string[] { "idepexp", "ayear" };
        ...
        public override string GetSorting(string ListingType) {
            ...
            if (ListingType == "elencofaseprec" || ListingType == "default") {
                sorting = "yliv1 desc, nliv1 desc, yepexp desc,nepexp desc";
                return sorting;
            }
        ...
        public void CompletaCaption(DataTable T) {
            ...
            foreach (DataColumn C in T.Columns) {
                ...
                if ((C.ColumnName == "yepexp") && ((C.Caption == "") || (C.Caption == C.ColumnName))) {
                    DescribeAColumn(T, C.ColumnName, ".esercizio mov");
                    continue;
                }
                if ((C.ColumnName == "nepexp") && ((C.Caption == "") || (C.Caption == C.ColumnName))) {
                    DescribeAColumn(T, C.ColumnName, ".Numero mov");
                    continue;
                }
                if ((C.ColumnName == "parentyepexp") && ((C.Caption == "") || (C.Caption == C.ColumnName))) {
                    DescribeAColumn(T, C.ColumnName, ".Esercizio padre");
                    continue;
                }
                if ((C.ColumnName == "parentnepexp") && ((C.Caption == "") || (C.Caption == C.ColumnName))) {
		...
		public override void DescribeColumns(DataTable T, string listtype) {
			...
			if (listtype=="default") {
                ...
                DescribeAColumn(T, "yepexp", "Esercizio", nPos++);
                DescribeAColumn(T, "nepexp", "Numero", nPos++);
                ...
                DescribeAColumn(T, "costavailable", "Disp.per Costi", nPos++);
                ...
                DescribeAColumn(T, "flagvariation", "Nota di variazione", nPos++);
                DescribeAColumn(T, "totalcost", "Costi totali", nPos++);
                DescribeAColumn(T, "totaldebit", "Debiti totali", nPos++);
            ...
            if (listtype== "elencofaseprec") {
                ...
                int nPos = 1;
                DescribeAColumn(T, "yepexp", "Eserc. mov.", nPos++);
                DescribeAColumn(T, "nepexp", "Num. mov.", nPos++);
             ...
             if(listtype== "autogenerati") {
                ...
                int nPos = 1;
                DescribeAColumn(T, "idepexp", ".idepexp", nPos++);
                ...
                DescribeAColumn(T, "idrelated", "#documento", nPos++);
                CompletaCaption(T);                    
			}
		}  
