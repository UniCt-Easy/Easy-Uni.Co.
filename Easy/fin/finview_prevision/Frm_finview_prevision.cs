...
namespace finview_prevision {
	...
	/// </summary>
	public class Frm_finview_prevision : MetaDataForm {
		MetaData Meta;
...
//		public MetaData meta;
		...
		private Button btnAccertamenti;
		private TextBox txtAccertamenti;
		private Label lblTotAccertamenti;
		private Label label14;
		private TextBox TxtPrevDisponibileFase_E;
		private Label lblPrevDisponibileAccertamenti;
		private Button btnImpegniCassa;
		private TextBox txtImpegni;
		private Label lblTotaleImpegni;
		private Label label12;
		private TextBox txtPrevDisponibileFase_S;
		private Label lblPrevDisponibileImpegni;
		private Button btnPiccoleSpeseImpegni;
		private Label lblPSpeseImpegni;
		private TextBox txtPiccoleSpeseImpegni;
		private string nomeFaseImpegno;
		private string nomeFaseAccertamento;
		private string nomeFasePagamento;
		private string nomeFaseIncasso;
		DataAccess Conn;
		...
		private static readonly char[] Vocali = new[] { 'a', 'e', 'i', 'o', 'u', 'A', 'E', 'I', 'O', 'U' };
		// Se vuoi includere accentate: 'à','è','é','ì','ò','ó','ù','À','È','É','Ì','Ò','Ó','Ù'

		private string Pluralize(string parola) {
			if (string.IsNullOrWhiteSpace(parola))
				return parola;

			for (int i = parola.Length - 1; i >= 0; i--) {

				if (Array.IndexOf(Vocali, parola[i]) >= 0) {
					// Niente slicing: usa Substring
					var prefix = parola.Substring(0, i);
					var suffix = (i + 1 < parola.Length) ? parola.Substring(i + 1) : string.Empty;
					return prefix + "i" + suffix; // "i" è string, evita l'errore char→string
				}
			}

			return parola; // nessuna vocale trovata
		}

		private void cambiaEtichette() 
		{
			...
			object appropriationPhase = Meta.GetSys("appropriationphase");
			nomeFaseImpegno = Conn.DO_READ_VALUE("expensephase", QHS.CmpEq("nphase", appropriationPhase), "description").ToString();
			object assessmentPhase = Meta.GetSys("assessmentphase");
			nomeFaseAccertamento = Conn.DO_READ_VALUE("incomephase", QHS.CmpEq("nphase", assessmentPhase), "description").ToString();

			object maxExpensePhase = Meta.GetSys("maxexpensephase");
			nomeFasePagamento = Conn.DO_READ_VALUE("expensephase", QHS.CmpEq("nphase", maxExpensePhase), "description").ToString();
			object maxIncomePhase =  Meta.GetSys("maxincomephase");
			nomeFaseIncasso = Conn.DO_READ_VALUE("incomephase", QHS.CmpEq("nphase", maxIncomePhase), "description").ToString();


			// Cambio Label
			lblTotAccertamenti.Text = "Totale fase (" + nomeFaseAccertamento + ")";
			lblTotaleImpegni.Text = "Totale fase (" + nomeFaseImpegno + ")";

			lblPSpeseImpegni.Text = "Piccole Spese non reintegrate (" + nomeFaseImpegno + ")";
			lblPiccoleSpeseImp.Text = "Piccole Spese non reintegrate (" + nomeFaseImpegno + ")";
			lblPiccoleSpesePagamenti.Text = "Piccole Spese non reintegrate (" + nomeFasePagamento + ")";
			lblPiccoleSpesePagamenti1.Text = "Piccole Spese non reintegrate (" + nomeFasePagamento + ")";
			lblPrevDisponibileImpegni.Text = "Previsione Disponibile (" + nomeFaseImpegno + ")";
			lblPrevDisponibileAccertamenti.Text = "Previsione Disponibile (" + nomeFaseAccertamento + ")";
 
			lblImpegni.Text = Pluralize(nomeFaseImpegno) + " di Competenza)";
			lblAccertamentiCompetenza.Text = Pluralize(nomeFaseAccertamento) + " di Competenza)";
			lblPagamenti.Text = Pluralize(nomeFasePagamento);
			lblIncassi.Text = Pluralize(nomeFaseIncasso);
		}
		...
		private void InitializeComponent() {
			...
			this.lblTotAccertamenti = new System.Windows.Forms.Label();
			this.label14 = new System.Windows.Forms.Label();
			this.TxtPrevDisponibileFase_E = new System.Windows.Forms.TextBox();
			this.lblPrevDisponibileAccertamenti = new System.Windows.Forms.Label();
			...
			this.btnPiccoleSpeseImpegni = new System.Windows.Forms.Button();
			this.lblPSpeseImpegni = new System.Windows.Forms.Label();
			this.txtPiccoleSpeseImpegni = new System.Windows.Forms.TextBox();
			this.btnImpegniCassa = new System.Windows.Forms.Button();
			this.txtImpegni = new System.Windows.Forms.TextBox();
			this.lblTotaleImpegni = new System.Windows.Forms.Label();
			this.label12 = new System.Windows.Forms.Label();
			this.txtPrevDisponibileFase_S = new System.Windows.Forms.TextBox();
			this.lblPrevDisponibileImpegni = new System.Windows.Forms.Label();
			...
			this.chkUpbChilds.Location = new System.Drawing.Point(6, 8);
			...
			this.tabCtrl.Location = new System.Drawing.Point(6, 31);
			this.tabCtrl.Name = "tabCtrl";
			this.tabCtrl.SelectedIndex = 0;
			this.tabCtrl.Size = new System.Drawing.Size(594, 456);
			...
			this.tabPage2.Size = new System.Drawing.Size(586, 430);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.grpPrevCassa_E.Controls.Add(this.btnAccertamenti);
			this.grpPrevCassa_E.Controls.Add(this.txtAccertamenti);
			this.grpPrevCassa_E.Controls.Add(this.lblTotAccertamenti);
			this.grpPrevCassa_E.Controls.Add(this.label14);
			this.grpPrevCassa_E.Controls.Add(this.TxtPrevDisponibileFase_E);
			this.grpPrevCassa_E.Controls.Add(this.lblPrevDisponibileAccertamenti);
			...
			this.grpPrevCassa_E.Location = new System.Drawing.Point(6, 194);
			this.grpPrevCassa_E.Name = "grpPrevCassa_E";
			this.grpPrevCassa_E.Size = new System.Drawing.Size(571, 222);
			this.grpPrevCassa_E.TabIndex = 63;
			this.grpPrevCassa_E.TabStop = false;
			// 
			// btnAccertamenti
			// 
			this.btnAccertamenti.Location = new System.Drawing.Point(418, 94);
			this.btnAccertamenti.Name = "btnAccertamenti";
			this.btnAccertamenti.Size = new System.Drawing.Size(75, 20);
			this.btnAccertamenti.TabIndex = 35;
			this.btnAccertamenti.Text = "G";
			...
			// txtAccertamenti
			// 
			this.txtAccertamenti.Location = new System.Drawing.Point(273, 94);
			this.txtAccertamenti.Name = "txtAccertamenti";
			this.txtAccertamenti.ReadOnly = true;
			this.txtAccertamenti.Size = new System.Drawing.Size(135, 20);
			this.txtAccertamenti.TabIndex = 34;
			this.txtAccertamenti.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// lblTotAccertamenti
			// 
			this.lblTotAccertamenti.Location = new System.Drawing.Point(6, 94);
			this.lblTotAccertamenti.Name = "lblTotAccertamenti";
			this.lblTotAccertamenti.Size = new System.Drawing.Size(254, 13);
			this.lblTotAccertamenti.TabIndex = 33;
			this.lblTotAccertamenti.Text = "Totale Accertamenti";
			this.lblTotAccertamenti.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// label14
			// 
			this.label14.AutoSize = true;
			this.label14.Location = new System.Drawing.Point(421, 126);
			this.label14.Name = "label14";
			this.label14.Size = new System.Drawing.Size(58, 13);
			this.label14.TabIndex = 32;
			this.label14.Text = "= E + F - G";
			// 
			// TxtPrevDisponibileFase_E
			// 
			this.TxtPrevDisponibileFase_E.Location = new System.Drawing.Point(271, 126);
			this.TxtPrevDisponibileFase_E.Name = "TxtPrevDisponibileFase_E";
			this.TxtPrevDisponibileFase_E.ReadOnly = true;
			this.TxtPrevDisponibileFase_E.Size = new System.Drawing.Size(137, 20);
			this.TxtPrevDisponibileFase_E.TabIndex = 31;
			this.TxtPrevDisponibileFase_E.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// lblPrevDisponibileAccertamenti
			// 
			this.lblPrevDisponibileAccertamenti.Location = new System.Drawing.Point(9, 116);
			this.lblPrevDisponibileAccertamenti.Name = "lblPrevDisponibileAccertamenti";
			this.lblPrevDisponibileAccertamenti.Size = new System.Drawing.Size(247, 30);
			this.lblPrevDisponibileAccertamenti.TabIndex = 30;
			this.lblPrevDisponibileAccertamenti.Text = "Previsione Disponibile Per Accertamenti";
			this.lblPrevDisponibileAccertamenti.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// label25
			// 
			this.label25.AutoSize = true;
			this.label25.Location = new System.Drawing.Point(421, 69);
			...
			// label26
			// 
			this.label26.Location = new System.Drawing.Point(64, 66);
			...
			// 
			this.txtPrevAttualeCassaE.Location = new System.Drawing.Point(271, 66);
			...
			this.label10.Location = new System.Drawing.Point(421, 192);
			this.label10.Name = "label10";
			this.label10.Size = new System.Drawing.Size(64, 13);
			this.label10.TabIndex = 9;
			this.label10.Text = "I = E + F - H";
			// 
			// btnVarPrevCassa_E
			// 
			this.btnVarPrevCassa_E.Location = new System.Drawing.Point(418, 35);
			...
			// lblVarPrevCassa_E
			// 
			this.lblVarPrevCassa_E.Location = new System.Drawing.Point(70, 40);
			...
			// txtVarPrevCassa_E
			// 
			this.txtVarPrevCassa_E.Location = new System.Drawing.Point(271, 35);
			...
			// lblPrevDispCassa_E
			// 
			this.lblPrevDispCassa_E.Location = new System.Drawing.Point(54, 191);
			...
			// txtPrevDispCassa_E
			// 
			this.txtPrevDispCassa_E.Location = new System.Drawing.Point(271, 186);
			...
			// btnIncassi
			// 
			this.btnIncassi.Location = new System.Drawing.Point(418, 159);
			...
			// lblIncassi
			// 
			this.lblIncassi.Location = new System.Drawing.Point(56, 165);
			...
			// txtIncassi
			// 
			this.txtIncassi.Location = new System.Drawing.Point(271, 160);
			...
			// 
			this.btnPrevInizialeCassa_E.Location = new System.Drawing.Point(418, 9);
			...
			// 
			this.lblPrevInizialeCassa_E.Location = new System.Drawing.Point(70, 14);
			...
			// 
			this.txtPrevInizialeCassa_E.Location = new System.Drawing.Point(271, 9);
			...
			// 
			this.txtPrevAttualeCompetenzaE.Location = new System.Drawing.Point(277, 72);
			...
			// 
			this.btnAccertamentiCompetenza.Location = new System.Drawing.Point(421, 111);
			...
			// 
			this.lblAccertamentiCompetenza.Location = new System.Drawing.Point(13, 109);
			this.lblAccertamentiCompetenza.Name = "lblAccertamentiCompetenza";
			this.lblAccertamentiCompetenza.Size = new System.Drawing.Size(243, 13);
			...
			// 
			this.txtAccertamentiCompetenza.Location = new System.Drawing.Point(277, 109);
			...
			this.label9.Location = new System.Drawing.Point(426, 142);
			...
			// 
			this.btnVarPrevCompetenza_E.Location = new System.Drawing.Point(421, 37);
			...
			this.lblVarPrevCompetenza_E.Location = new System.Drawing.Point(62, 35);
			...
			// 
			this.txtVarPrevCompetenza_E.Location = new System.Drawing.Point(277, 35);
			...
			// 
			this.lblPrevDispCompetenza_E.Location = new System.Drawing.Point(59, 134);
			...
			// 
			this.txtPrevDispCompetenza_E.Location = new System.Drawing.Point(277, 134);
			...
			// 
			this.btnPrevInizialeCompetenza_E.Location = new System.Drawing.Point(421, 8);
			...
			this.lblPrevInizialeCompetenza_E.Location = new System.Drawing.Point(65, 9);
			...
			// 
			this.txtPrevInizialeCompetenza_E.Location = new System.Drawing.Point(277, 9);
			...
			this.tabPage3.Size = new System.Drawing.Size(586, 430);
			...
			this.grpPrevCompetenza_S.Size = new System.Drawing.Size(578, 186);
			...
			this.label27.Location = new System.Drawing.Point(411, 72);
			...
			// 
			this.txtPrevAttualeCompetenzaS.Location = new System.Drawing.Point(270, 69);
			...
			// btnPiccoleSpeseImp
			// 
			this.btnPiccoleSpeseImp.Location = new System.Drawing.Point(413, 129);
			...
			// lblPiccoleSpeseImp
			// 
			this.lblPiccoleSpeseImp.Location = new System.Drawing.Point(9, 119);
			this.lblPiccoleSpeseImp.Name = "lblPiccoleSpeseImp";
			this.lblPiccoleSpeseImp.Size = new System.Drawing.Size(256, 35);
			...
			// txtPiccoleSpeseImp
			// 
			this.txtPiccoleSpeseImp.Location = new System.Drawing.Point(271, 129);
			...
			this.label11.Location = new System.Drawing.Point(414, 162);
			...
			// 
			this.btnVarPrevCompetenza_S.Location = new System.Drawing.Point(413, 36);
			...
			// 
			this.lblVarPrevCompetenza_S.Location = new System.Drawing.Point(58, 38);
			...
			// 
			this.txtVarPrevCompetenza_S.Location = new System.Drawing.Point(271, 35);
			...
			// 
			this.lblPrevDispCompetenza_S.Location = new System.Drawing.Point(58, 160);
			...
			// 
			this.txtPrevDispCompetenza_S.Location = new System.Drawing.Point(271, 157);
			...
			// btnImpegni
			// 
			this.btnImpegni.Location = new System.Drawing.Point(413, 104);
			...
			// lblImpegni
			// 
			this.lblImpegni.Location = new System.Drawing.Point(58, 106);
			...
			// 
			this.txtImpegniCompetenza.Location = new System.Drawing.Point(271, 103);
			...
			// 
			this.btnPrevInizialeCompetenza_S.Location = new System.Drawing.Point(413, 8);
			...
			// 
			this.lblPrevInizialeCompetenza_S.Location = new System.Drawing.Point(58, 12);
			...
			// 
			this.txtPrevInizialeCompetenza_S.Location = new System.Drawing.Point(271, 9);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.grpPrevCassa_S.Controls.Add(this.btnPiccoleSpeseImpegni);
			this.grpPrevCassa_S.Controls.Add(this.lblPSpeseImpegni);
			this.grpPrevCassa_S.Controls.Add(this.txtPiccoleSpeseImpegni);
			this.grpPrevCassa_S.Controls.Add(this.btnImpegniCassa);
			this.grpPrevCassa_S.Controls.Add(this.txtImpegni);
			this.grpPrevCassa_S.Controls.Add(this.lblTotaleImpegni);
			this.grpPrevCassa_S.Controls.Add(this.label12);
			this.grpPrevCassa_S.Controls.Add(this.txtPrevDisponibileFase_S);
			this.grpPrevCassa_S.Controls.Add(this.lblPrevDisponibileImpegni);
			...
			this.grpPrevCassa_S.Location = new System.Drawing.Point(6, 186);
			this.grpPrevCassa_S.Name = "grpPrevCassa_S";
			this.grpPrevCassa_S.Size = new System.Drawing.Size(578, 238);
			this.grpPrevCassa_S.TabIndex = 62;
			this.grpPrevCassa_S.TabStop = false;
			// 
			// btnPiccoleSpeseImpegni
			// 
			this.btnPiccoleSpeseImpegni.Location = new System.Drawing.Point(415, 111);
			this.btnPiccoleSpeseImpegni.Name = "btnPiccoleSpeseImpegni";
			this.btnPiccoleSpeseImpegni.Size = new System.Drawing.Size(75, 23);
			this.btnPiccoleSpeseImpegni.TabIndex = 44;
			this.btnPiccoleSpeseImpegni.Text = "I";
			this.btnPiccoleSpeseImpegni.UseVisualStyleBackColor = true;
			this.btnPiccoleSpeseImpegni.Click += new System.EventHandler(this.btnPiccoleSpeseImpegni_Click);
			// 
			// lblPSpeseImpegni
			// 
			this.lblPSpeseImpegni.Location = new System.Drawing.Point(10, 103);
			this.lblPSpeseImpegni.Name = "lblPSpeseImpegni";
			this.lblPSpeseImpegni.Size = new System.Drawing.Size(254, 31);
			this.lblPSpeseImpegni.TabIndex = 42;
			this.lblPSpeseImpegni.Text = "Piccole spese non reintegrate (Impegni)";
			this.lblPSpeseImpegni.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// txtPiccoleSpeseImpegni
			// 
			this.txtPiccoleSpeseImpegni.Location = new System.Drawing.Point(269, 111);
			this.txtPiccoleSpeseImpegni.Name = "txtPiccoleSpeseImpegni";
			this.txtPiccoleSpeseImpegni.ReadOnly = true;
			this.txtPiccoleSpeseImpegni.Size = new System.Drawing.Size(136, 20);
			this.txtPiccoleSpeseImpegni.TabIndex = 43;
			this.txtPiccoleSpeseImpegni.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// btnImpegniCassa
			// 
			this.btnImpegniCassa.Location = new System.Drawing.Point(415, 85);
			this.btnImpegniCassa.Name = "btnImpegniCassa";
			this.btnImpegniCassa.Size = new System.Drawing.Size(75, 20);
			this.btnImpegniCassa.TabIndex = 41;
			this.btnImpegniCassa.Text = "H";
			this.btnImpegniCassa.UseVisualStyleBackColor = true;
			this.btnImpegniCassa.Click += new System.EventHandler(this.btnImpegniCassa_Click);
			// 
			// txtImpegni
			// 
			this.txtImpegni.Location = new System.Drawing.Point(269, 85);
			this.txtImpegni.Name = "txtImpegni";
			this.txtImpegni.ReadOnly = true;
			this.txtImpegni.Size = new System.Drawing.Size(135, 20);
			this.txtImpegni.TabIndex = 40;
			this.txtImpegni.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// lblTotaleImpegni
			// 
			this.lblTotaleImpegni.Location = new System.Drawing.Point(77, 87);
			this.lblTotaleImpegni.Name = "lblTotaleImpegni";
			this.lblTotaleImpegni.Size = new System.Drawing.Size(182, 13);
			this.lblTotaleImpegni.TabIndex = 39;
			this.lblTotaleImpegni.Text = "Totale Impegni";
			this.lblTotaleImpegni.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// label12
			// 
			this.label12.AutoSize = true;
			this.label12.Location = new System.Drawing.Point(418, 143);
			this.label12.Name = "label12";
			this.label12.Size = new System.Drawing.Size(71, 13);
			this.label12.TabIndex = 38;
			this.label12.Text = "= F + G - H - I";
			// 
			// txtPrevDisponibileFase_S
			// 
			this.txtPrevDisponibileFase_S.Location = new System.Drawing.Point(268, 139);
			this.txtPrevDisponibileFase_S.Name = "txtPrevDisponibileFase_S";
			this.txtPrevDisponibileFase_S.ReadOnly = true;
			this.txtPrevDisponibileFase_S.Size = new System.Drawing.Size(135, 20);
			this.txtPrevDisponibileFase_S.TabIndex = 37;
			this.txtPrevDisponibileFase_S.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// lblPrevDisponibileImpegni
			// 
			this.lblPrevDisponibileImpegni.Location = new System.Drawing.Point(74, 131);
			this.lblPrevDisponibileImpegni.Name = "lblPrevDisponibileImpegni";
			this.lblPrevDisponibileImpegni.Size = new System.Drawing.Size(182, 30);
			this.lblPrevDisponibileImpegni.TabIndex = 36;
			this.lblPrevDisponibileImpegni.Text = "Previsione Disponibile Per Impegni";
			this.lblPrevDisponibileImpegni.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// label29
			// 
			this.label29.AutoSize = true;
			this.label29.Location = new System.Drawing.Point(419, 63);
			...
			// label30
			// 
			this.label30.Location = new System.Drawing.Point(75, 62);
			...
			// 
			this.txtPrevAttualeCassaS.Location = new System.Drawing.Point(269, 60);
			...
			// 
			this.btnPiccoleSpesePagamenti.Location = new System.Drawing.Point(415, 189);
			...
			this.btnPiccoleSpesePagamenti.Text = "M";
			...
			// 
			this.lblPiccoleSpesePagamenti.Location = new System.Drawing.Point(6, 183);
			this.lblPiccoleSpesePagamenti.Name = "lblPiccoleSpesePagamenti";
			this.lblPiccoleSpesePagamenti.Size = new System.Drawing.Size(256, 29);
			this.lblPiccoleSpesePagamenti.TabIndex = 16;
			this.lblPiccoleSpesePagamenti.Text = "Piccole spese non reintegrate(Pagamenti)";
			this.lblPiccoleSpesePagamenti.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// txtPiccoleSpesePagamenti
			// 
			this.txtPiccoleSpesePagamenti.Location = new System.Drawing.Point(267, 188);
			...
			this.label8.Location = new System.Drawing.Point(413, 219);
			this.label8.Name = "label8";
			this.label8.Size = new System.Drawing.Size(92, 13);
			this.label8.TabIndex = 9;
			this.label8.Text = " N = F + G -  L - M";
			// 
			// btnVarPrevisioneCassa_S
			// 
			this.btnVarPrevisioneCassa_S.Location = new System.Drawing.Point(414, 35);
			...
			// 
			this.lblVarPrevisioneCassa_S.Location = new System.Drawing.Point(62, 40);
			...
			// 
			this.txtVarPrevisioneCassa_S.Location = new System.Drawing.Point(268, 35);
			...
			// lblPrevDispCassa_S
			// 
			this.lblPrevDispCassa_S.Location = new System.Drawing.Point(62, 217);
			...
			// txtPrevDispCassa_S
			// 
			this.txtPrevDispCassa_S.Location = new System.Drawing.Point(267, 214);
			...
			// txtPagamenti
			// 
			this.txtPagamenti.Location = new System.Drawing.Point(267, 162);
			...
			// 
			this.btnPrevInizialeCassa_S.Location = new System.Drawing.Point(414, 9);
			...
			// 
			this.lblPrevInizialeCassa_S.Location = new System.Drawing.Point(62, 14);
			...
			// 
			this.txtPrevInizialeCassa_S.Location = new System.Drawing.Point(268, 9);
			...
			this.tabPage4.Size = new System.Drawing.Size(586, 430);
			...
			// btnCalcolaTutto
			// 
			this.btnCalcolaTutto.Location = new System.Drawing.Point(517, 5);
        ...
        private void AbilitaSezioniRiepilogo() {
            ...
            if (flagcredit == null || flagproceeds == null) {
                flagcredit = "N";
                flagproceeds = "N";
                show("Manca la configurazione annuale dell'esercizio");
            }
        ...
        private void CalcolaTotaliEntrata() {
			...
			txtAccertamenti.Text = totAccertamentiAll.ToString("C");
			...
			TxtPrevDisponibileFase_E.Text = (totCassa - totAccertamentiAll).ToString("C");
        ...
        private void CalcolaTotaliSpese() {
			...
			txtImpegni.Text = totImpegniAll.ToString("C");

			decimal totPiccoleSpeseImp = calcFin.TotPiccoleSpeseImp();
            txtPiccoleSpeseImp.Text = totPiccoleSpeseImp.ToString("C");
			txtPiccoleSpeseImpegni.Text = totPiccoleSpeseImp.ToString("C");
			txtPrevDispCompetenza_S.Text = (totCompetenza - totImpegniCompetenza - totPiccoleSpeseImp).ToString("C");
            ...
            txtCreditiResidui.Text = (totcrediti - totImpegniCompetenza - totPiccoleSpeseImp).ToString("C");
			...
			txtPrevDisponibileFase_S.Text = (totCassa - totImpegniAll - totPiccoleSpeseImp).ToString("C");
        ...
        private void btnHideUnused_Click(object sender, EventArgs e) {
            ...
            if (tAll == null) {
                show("Nessuna voce di bilancio risulta utilizzata", "Avviso");
                return;
            }
		...
		private void btnImpegniCassa_Click(object sender, EventArgs e) {
			DataRow Curr = HelpForm.GetLastSelected(DS.finview);
			if (Curr == null)
				return;
		...
		private void btnPiccoleSpeseImpegni_Click(object sender, EventArgs e) {
			DataRow Curr = HelpForm.GetLastSelected(DS.finview);
			if (Curr == null)
				return;
