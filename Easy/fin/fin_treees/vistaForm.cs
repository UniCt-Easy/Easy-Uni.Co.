...
//Primary Key
	...
	T.Columns.Add(new DataColumn("!livello", typeof(System.String), ""));
	T.Columns.Add(new DataColumn("!responsabile", typeof(System.String), ""));
	Tables.Add(T);
//Primary Key
	key = new DataColumn[1]{
	T.Columns["idfin"]};
...
Relations.Add(new DataRelation("finlevelfin",CPar,CChild));

TPar= Tables["fin"];
TChild= Tables["fin"];
CPar = new DataColumn[1]{TPar.Columns["idfin"]};
CChild = new DataColumn[1]{TChild.Columns["paridfin"]};
Relations.Add(new DataRelation("finfin",CPar,CChild));
