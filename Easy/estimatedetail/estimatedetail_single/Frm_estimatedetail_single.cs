...
namespace estimatedetail_single {
    /// <summary>
    /// </summary>
    public class Frm_estimatedetail_single : MetaDataForm {
        ...
        private void InitializeComponent() {
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.TxtDescrCausaleDebIva.Location = new System.Drawing.Point(120, 16);
			...
			this.TxtDescrCausaleDebIva.Size = new System.Drawing.Size(268, 56);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.txtCodiceCausaleEntrataIva.Location = new System.Drawing.Point(10, 78);
			this.txtCodiceCausaleEntrataIva.Name = "txtCodiceCausaleEntrataIva";
			this.txtCodiceCausaleEntrataIva.Size = new System.Drawing.Size(378, 20);
			...
			this.button1.Tag = "manage.finmotive_iva_income.tree";
			...
			this.txtCodiceCausaleEntrata.Size = new System.Drawing.Size(378, 20);
			this.txtCodiceCausaleEntrata.TabIndex = 10;
			this.txtCodiceCausaleEntrata.Tag = "finmotive_income.codemotive?x";
			// 
			// button6
			// 
			this.button6.Location = new System.Drawing.Point(10, 49);
...
//			Calcola();
            ...
            if (Meta.FirstFillForThisRow) {
				aliquota = CfgFn.GetNoNullDouble(Curr["taxrate"]);
				calcolaIncassato();
			}
...
//			Calcola();
        ...
        void AggiornaListino(DataRow Choosen) {
            ...
            HelpForm.SetComboBoxValue(cmbTassonomia,Curr["idtassonomia"]);
        ...
        private void btnScollegaPreaccertamento_Click(object sender, EventArgs e) {
            ...
            DataRow Curr = DS.estimatedetail.Rows[0];
            if (Curr["idepacc"] != DBNull.Value) {
                show("Non è possibile scollegare un preimpegno avendo già generato l'accertamento di budget",
                    "Errore");
                return;
            }
