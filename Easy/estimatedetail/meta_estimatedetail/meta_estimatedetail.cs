    ...
    public class Meta_estimatedetail : Meta_easydata {
        ...
        public override bool IsValid(DataRow R, out string errmess, out string errfield) {
            ...
            if (R["idestimkind"].ToString() == "") {
                errmess = "Il codice tipo contratto Ë obbligatorio, annullare l'inserimento ed inserirlo nel contratto";
                errfield = "idestimkind";
                return false;
            }

            if (R["number"] == DBNull.Value) {
                errmess = "E' necessario specificare la quantit‡";
                errfield = "number";
                return false;
            }
            ...
            if (R["start"] != DBNull.Value) {
                ...
                if (start.Year < CfgFn.GetNoNullInt32(R["yestim"])) {
                    errmess = "La data di inizio validit‡ deve essere successiva all'anno di creazione del contratto";
                    errfield = "start";
                    return false;
                }
            }
