...
{
	partial class Frm_ddt_inattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new ddt_inattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "ddt_inattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "ddt_inattachment.idattachmentkind";
			...
			this.Name = "Frm_ddt_inattachment_detail";
			this.Text = "Frm_ddt_inattachment_detail";
