...
public partial class vistaForm: DataSet {
	...
	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public DataTable registrylegalstatusattachment 		=> Tables["registrylegalstatusattachment"];
...
private void initClass() {
	...
	tregistrylegalstatusregview.Columns.Add( new DataColumn("idinquadramento", typeof(int)));
	tregistrylegalstatusregview.Columns.Add( new DataColumn("inquadramento", typeof(string)));
	tregistrylegalstatusregview.Columns.Add( new DataColumn("extmatricula", typeof(string)));
	...
	//////////////////// REGISTRYLEGALSTATUSATTACHMENT /////////////////////////////////
	var tregistrylegalstatusattachment= new DataTable("registrylegalstatusattachment");
	C= new DataColumn("idreg", typeof(int));
	C.AllowDBNull=false;
	tregistrylegalstatusattachment.Columns.Add(C);
	C= new DataColumn("idregistrylegalstatus", typeof(int));
	C.AllowDBNull=false;
	tregistrylegalstatusattachment.Columns.Add(C);
	...
	C.AllowDBNull=false;
	tregistrylegalstatusattachment.Columns.Add(C);
	tregistrylegalstatusattachment.Columns.Add( new DataColumn("attachment", typeof(Byte[])));
	tregistrylegalstatusattachment.Columns.Add( new DataColumn("filename", typeof(string)));
	tregistrylegalstatusattachment.Columns.Add( new DataColumn("cu", typeof(string)));
	tregistrylegalstatusattachment.Columns.Add( new DataColumn("ct", typeof(DateTime)));
	tregistrylegalstatusattachment.Columns.Add( new DataColumn("lu", typeof(string)));
	tregistrylegalstatusattachment.Columns.Add( new DataColumn("lt", typeof(DateTime)));
	tregistrylegalstatusattachment.Columns.Add( new DataColumn("idattachmentkind", typeof(int)));
	tregistrylegalstatusattachment.Columns.Add( new DataColumn("idfilestorage", typeof(string)));
	Tables.Add(tregistrylegalstatusattachment);
	tregistrylegalstatusattachment.PrimaryKey =  new DataColumn[]{tregistrylegalstatusattachment.Columns["idreg"], tregistrylegalstatusattachment.Columns["idregistrylegalstatus"], tregistrylegalstatusattachment.Columns["idattachment"]};
	...
	cChild = new []{registrylegalstatusattachment.Columns["idreg"], registrylegalstatusattachment.Columns["idregistrylegalstatus"]};
	Relations.Add(new DataRelation("registrylegalstatus_registrylegalstatusattachment",cPar,cChild,false));
