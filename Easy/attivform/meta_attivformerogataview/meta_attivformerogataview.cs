...
namespace meta_attivformerogataview
{
    public class Meta_attivformerogataview : Meta_easydata 
	{
        public Meta_attivformerogataview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "attivformerogataview") {
