...
namespace meta_attivformgruppoview
{
    public class Meta_attivformgruppoview : Meta_easydata 
	{
        public Meta_attivformgruppoview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "attivformgruppoview") {
				Name = "Attività formative";
			EditTypes.Add("gruppo");
			ListingTypes.Add("gruppo");
			//$EditTypes$
        }
