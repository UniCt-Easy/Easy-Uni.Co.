...
namespace title_default {//cdtitoloanagrafica//
	/// <summary>
	/// Summary description for frmcdtitoloanagrafica.
	/// </summary>
	public class Frm_title_default : System.Windows.Forms.Form {
		...
		public Frm_title_default() {
			InitializeComponent();
			HelpForm.SetDenyNull(DS.title.Columns["active"], true);		
		}
		...
		private void InitializeComponent() {
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Frm_title_default));
			...
			this.checkBox1.Tag = "title.active:S:N";
			...
			this.textBox1.Tag = "title.idtitle";
			this.textBox1.Text = "";
			// 
			// textBox2
			// 
			...
			this.textBox2.Tag = "title.description";
			this.textBox2.Text = "";
			// 
			// label1
			// 
			...
			this.dataGrid1.Tag = "title.default";
			// 
			// DS
			// 
			...
			this.Name = "frmcdtitoloanagrafica";
			this.Text = "frmcdtitoloanagrafica";
