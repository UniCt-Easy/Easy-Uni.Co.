...
{
    public class Meta_didprogcurrcaratteristica : Meta_easydata 
	{
        public Meta_didprogcurrcaratteristica(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "didprogcurrcaratteristica") {
				Name = "Caratteristiche del curriculum";
		...
		public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
			...
			RowChange.MarkAsAutoincrement(T.Columns["iddidprogcurrcaratteristica"], null, null, 0);
			RowChange.setMinimumTempValue(T.Columns["iddidprogcurrcaratteristica"], 9990000);
			//$Get_New_Row$
		...
		public override bool IsValid(DataRow R, out string errmess, out string errfield) {
			...
			switch (edit_type) {
				case "default": {
						...
						if (R["iddidprogcurrcaratteristica"].ToString().Trim() == "") {
							errmess = "Attenzione! Il campo 'Identificativo' è obbligatorio";
							errfield = "iddidprogcurrcaratteristica";
							return false;
						}
