...
private void initClass() {
	...
	tconfigsmtp.Columns.Add( new DataColumn("signature", typeof(string)));
	tconfigsmtp.Columns.Add( new DataColumn("email_cc", typeof(string)));
	tconfigsmtp.Columns.Add( new DataColumn("responsabile_cu", typeof(string)));
