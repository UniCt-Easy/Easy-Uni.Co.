...
namespace meta_strutturadefaultview
{
    public class Meta_strutturadefaultview : Meta_easydata 
	{
        public Meta_strutturadefaultview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "strutturadefaultview") {
