...
public DataTable accmotivesorting{get { return this.Tables["accmotivesorting"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
...
//Primary Key
	...
	T.Columns["idaccmotive"], 	T.Columns["idsor"]};
	T.PrimaryKey = key;
...
DataColumn []CChild;
TPar= Tables["sorting"];
TChild= Tables["accmotivesorting"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor"]};
Relations.Add(new DataRelation("sorting_accmotivesorting",CPar,CChild));
