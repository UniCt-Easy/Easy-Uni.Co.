...
namespace meta_costoscontodefdettaglioscontiview
{
    public class Meta_costoscontodefdettaglioscontiview : Meta_easydata 
	{
        public Meta_costoscontodefdettaglioscontiview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "costoscontodefdettaglioscontiview") {
				Name = "Voci di dettaglio dello sconto";
