...
namespace meta_sdi_venditaview {
    public class Meta_sdi_venditaview : Meta_easydata {
        public Meta_sdi_venditaview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "sdi_venditaview") {
        ...
        public override string GetSorting(string ListingType) {
            if (ListingType == "default") {
                return "idsdi_vendita DESC";
            }
            return base.GetSorting(ListingType);
        }
        private string[] mykey = new string[] { "idsdi_vendita" };
        ...
        public override void DescribeColumns(DataTable T, string ListingType) {
            ...
            if (ListingType == "default") {
                ...
                int nPos = 1;
                DescribeAColumn(T, "idsdi_vendita", "Num.File", nPos++);
