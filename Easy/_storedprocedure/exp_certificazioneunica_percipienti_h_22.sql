...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_certificazioneunica_percipienti_h_22]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_certificazioneunica_percipienti_h_22]
GO
 --setuser'amministrazione'
--exec exp_certificazioneunica_percipienti_h_22  PRSRCC87R11H224K
CREATE PROCEDURE [exp_certificazioneunica_percipienti_h_22]
(
	@cf varchar(20)
 )
...
select distinct #expense2021.idreg from #expense2021

SELECT * FROM #percipienti_record_H_2021
