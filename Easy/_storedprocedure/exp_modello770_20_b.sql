...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_modello770_20_b]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_modello770_20_b]
GO
...
-- exec exp_modello770_20_b 1,1,1
create PROCEDURE [exp_modello770_20_b]
(
	@numdichquadrog int,
	@numdichquadroh int,
	@numdichquadroi int
...
--Dati relativi a: Protocollo dichiarazione inviata in gestione separata 
-- Non lo gestiamo, per cui non lo inviamo 
	--9 Protocollo dichiarazione inviata in gestione separata - Identificativo dell'invio
	--INSERT INTO #recordb (progr, quadro, riga, colonna, intero)  VALUES(1, 'HRB', 1, '009', )
	-- 10 Protocollo dichiarazione inviata in gestione separata -Progressivo Attribuito dal Servizio telematico alla singola dichiarazione 770
	--15 Denominazione
	...
	--22 Casella Casi Particolari "Esistenza di un rappresentante fiscale di intermediario estero nonostante la presenza di una stabile 
	INSERT INTO #recordb (progr, quadro, riga, colonna, intero) VALUES(1, 'HRB', 1, '022', 0)
...
--Dati Soggetti diversi da persona fisica
	-- 27 Codice paese estero 
	INSERT INTO #recordb (progr, quadro, riga, colonna, stringa) VALUES(1, 'HRB', 1, '027', '000')
...
-- 29 stato
	...
	INSERT INTO #recordb (progr, quadro, riga, colonna, intero)  VALUES(1, 'HRB', 1, '037', 1)
...
-- Firma della Dichiarazione - Prospetti compilati
 INSERT INTO #recordb (progr, quadro, riga, colonna, intero)  VALUES(1, 'HRB', 1, '056', 1)-- Se il campo “Tipologia Invio” è uguale a 1, tutti i campi da 78 a 89 del record B NON devono essere compilati (sezione Gestione separata).
	...
	INSERT INTO #recordb (progr, quadro, riga, colonna, intero)  VALUES(1, 'HRB', 1, '065', 0)
	INSERT INTO #recordb (progr, quadro, riga, colonna, intero)  VALUES(1, 'HRB', 1, '066', 0)
	--067 Casella prospetto ST
	INSERT INTO #recordb (progr, quadro, riga, colonna, intero)  VALUES(1, 'HRB', 1, '067', 0)
	-- 68 Casella quadro SV 
	INSERT INTO #recordb (progr, quadro, riga, colonna, intero)  VALUES(1, 'HRB', 1, '068', 0)
	--069 Casella prospetto SX
	INSERT INTO #recordb (progr, quadro, riga, colonna, intero)  VALUES(1, 'HRB', 1, '069', 0)
	

	--070 Casella prospetto SY   -- qui non deve essere 0 ma si dovrebbe verificare se pignoramenti sono stati fatti
	IF (@numdichquadroi > 0)
		INSERT INTO #recordb (progr, quadro, riga, colonna, intero)  VALUES(1, 'HRB', 1, '070', 1)
	ELSE
		INSERT INTO #recordb (progr, quadro, riga, colonna, intero)  VALUES(1, 'HRB', 1, '070', 0)

	--093 Casi di non trasmissione dei quadri ST,SV e SX
	INSERT INTO #recordb (progr, quadro, riga, colonna, intero)  VALUES(1, 'HRB', 1, '093', 1)
	-- 094 Firma del dichiarante
