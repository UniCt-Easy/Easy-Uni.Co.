...
CREATE  PROCEDURE [trasmele_income_unicredit_abi36_var]
(
	@y int,
	@n int
)
...
SELECT
	...
	CASE 
		...
		ELSE 'S'
	END, --esenzione bollo
	CASE WHEN ((tb.flag&0) = 0)/* esente */ AND (( il.flag & 1)<>0) /*a regolarizzazione*/ THEN 'DOCUMENTO A REGOLARIZZAZIONE DI PROVVISORI/SOSPESI'
...
(
	...
	causale_esenzione_bollo varchar(150),
	---------------------------------------------
	----------------- versante ------------------
	---------------------------------------------
