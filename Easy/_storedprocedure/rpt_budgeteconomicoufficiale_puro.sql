...
-- exec rpt_budgeteconomicoufficiale_puro 2017, '%','S'
CREATE      PROCEDURE [rpt_budgeteconomicoufficiale_puro](
...
set @A_IV_ProventiPerGestioneDiretta = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @A_V2_AltriProventi = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @A_VI_VariazioniRimanenze = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @A_VII_IncrementoImmobilizzazioni = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_VIII1a_CostiDocentiRicercatori = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_VIII1b_CollaborazioniScientifiche = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_VIII1c_DocentiAContratto = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_VIII1d_EspertiLinguistici = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_VIII1e_AltroPersonale = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_VIII2_CostiPersonaleDirigente = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_IX1_CostiSostegnoStudenti = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_IX2_CostiDirittoStudio = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_IX3_CostiRicercaAttivitaEditoriale = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_IX4_TrasferimentiPartner = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_IX5_AcquistoMaterialeConsumo = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_IX6_VariazioneRimanenze = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_IX7_AcquistoLibri = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_IX8_AcquistoServizi = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_IX9_AcquistoAltriMateriali = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_IX10_VariazioneRimanenze = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_IX11_CostiGodimento = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_IX12_AltriCosti = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_X2_AmmortamentiImmobMateriali = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_X3_SvalutazioniImmobilizzazioni = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_X4_SvalutazioniCrediti = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_XI_AccantonamentiRischiOneri = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_XII_OneriDversiGestione = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
