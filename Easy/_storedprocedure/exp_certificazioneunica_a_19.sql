...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_certificazioneunica_a_19]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_certificazioneunica_a_19]
GO

CREATE     PROCEDURE [exp_certificazioneunica_a_19]
AS BEGIN
	...
	--3 Codice fornitura
	INSERT INTO #recorda (progr, modulo, quadro, riga, colonna, stringa) VALUES(1, 1, 'HRA', 1, '03', 'CUR19')
	--4 Tipo fornitore
