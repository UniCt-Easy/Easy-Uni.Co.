...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_certificazioneunica_h_pign_20]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_certificazioneunica_h_pign_20]
GO  
 
CREATE PROCEDURE [exp_certificazioneunica_h_pign_20]
...
----------------------------------al prospetto SY del mod. 770/2020 semplificato ----------------------
-------------------------------------------------------------------------------------------------------
...
-- RECORD DI TIPO "H": Casi particolari operazioni straordinarie
	...
	--2020	AU	101	Codice Fiscale debitore   principale
	--2020	AU	102	Somme erogate
	--2020	AU	103	Ritenute operate
	--2020	AU	104	Somme erogate non tassate
	--2020	AU	105 Codice Fiscale debitore   principale
	--2020	AU	106	Somme erogate
	--2020	AU	107	Ritenute operate
	--2020	AU	108	Somme erogate non tassate
