...
if exists (select * from dbo.sysobjects where id = object_id(N'[rpt_budgeteconomico_all]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure rpt_budgeteconomico_all
GO
/****** Object:  StoredProcedure [amministrazione].[rpt_budgeteconomico_all]    Script Date: 21/11/2014 15:55:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
-- exec AMMINISTRAZIONE.rpt_budgeteconomico_all 2014, 21,'%','S'
CREATE      PROCEDURE [rpt_budgeteconomico_all](
