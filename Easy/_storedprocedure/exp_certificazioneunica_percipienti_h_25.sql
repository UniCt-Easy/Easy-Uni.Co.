...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_certificazioneunica_percipienti_h_25]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_certificazioneunica_percipienti_h_25]
GO
 --setuser'amministrazione'
--exec exp_certificazioneunica_percipienti_h_24  TSSNLS78S53D976S
CREATE PROCEDURE [exp_certificazioneunica_percipienti_h_25]
(
	@cf varchar(20)
 )
...
select distinct #expense2024.idreg from #expense2024

SELECT * FROM #percipienti_record_H_2024
