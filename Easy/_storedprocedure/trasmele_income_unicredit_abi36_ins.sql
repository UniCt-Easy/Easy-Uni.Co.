...
drop procedure [trasmele_income_unicredit_abi36_ins]
GO
...
CREATE  PROCEDURE [trasmele_income_unicredit_abi36_ins]
(
	@y int,
	@n int
)
...
SELECT
	...
	CASE	WHEN ctc.flaghuman = 'S' AND c.cf IS NOT NULL		THEN c.cf  
						WHEN ctc.flaghuman = 'S' AND c.cf IS NULL			THEN  null	 
					ELSE null 
	END,
-- Partita IVA
	CASE
