...
SET ANSI_NULLS ON 
GO
-- exec rpt_budgeteconomicoufficiale_triennale 2015, 62,'%','S',null,null,null,null,null, 'S'
CREATE      PROCEDURE [rpt_budgeteconomicoufficiale_triennale](
...
if (@budgetpuro='S') 
	Begin
		exec rpt_budgeteconomicoufficiale_triennale_puro @ayear, @idupb,@showchildupb,@idsor01,@idsor02,@idsor03,@idsor04,@idsor05
		RETURN
	End
...
SELECT @A_IV_ProventiPerGestioneDiretta = SUM(budgetprevision.prevision),
		@A_IV_ProventiPerGestioneDiretta_prev2 = SUM(budgetprevision.prevision2),
		@A_IV_ProventiPerGestioneDiretta_prev3 = SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT @A_V1_UtilizzoRiservePatrimonioNetto = SUM(budgetprevision.prevision),
		@A_V1_UtilizzoRiservePatrimonioNetto_prev2 = SUM(budgetprevision.prevision2),
		@A_V1_UtilizzoRiservePatrimonioNetto_prev3 = SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT @A_V2_AltriProventi = SUM(budgetprevision.prevision),
		@A_V2_AltriProventi_prev2 = SUM(budgetprevision.prevision2),
		@A_V2_AltriProventi_prev3 = SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT @A_VI_VariazioniRimanenze = SUM(budgetprevision.prevision),
		@A_VI_VariazioniRimanenze_prev2 = SUM(budgetprevision.prevision2),
		@A_VI_VariazioniRimanenze_prev3 = SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT @A_VII_IncrementoImmobilizzazioni = SUM(budgetprevision.prevision),
		@A_VII_IncrementoImmobilizzazioni_prev2 = SUM(budgetprevision.prevision2),
		@A_VII_IncrementoImmobilizzazioni_prev3 = SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT @B_VIII1a_CostiDocentiRicercatori = SUM(budgetprevision.prevision),
		@B_VIII1a_CostiDocentiRicercatori_prev2 = SUM(budgetprevision.prevision2),
		@B_VIII1a_CostiDocentiRicercatori_prev3 = SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT	@B_VIII1b_CollaborazioniScientifiche = SUM(budgetprevision.prevision),
		@B_VIII1b_CollaborazioniScientifiche_prev2 = SUM(budgetprevision.prevision2),
		@B_VIII1b_CollaborazioniScientifiche_prev3 = SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT	@B_VIII1c_DocentiAContratto = SUM(budgetprevision.prevision),
		@B_VIII1c_DocentiAContratto_prev2 = SUM(budgetprevision.prevision2),
		@B_VIII1c_DocentiAContratto_prev3 = SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT @B_VIII1d_EspertiLinguistici = SUM(budgetprevision.prevision),
		@B_VIII1d_EspertiLinguistici_prev2 = SUM(budgetprevision.prevision2),
		@B_VIII1d_EspertiLinguistici_prev3 = SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT	@B_VIII1e_AltroPersonale =  SUM(budgetprevision.prevision),
		@B_VIII1e_AltroPersonale_prev2 =  SUM(budgetprevision.prevision2),
		@B_VIII1e_AltroPersonale_prev3 =  SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT @B_VIII2_CostiPersonaleDirigente = SUM(budgetprevision.prevision),
		@B_VIII2_CostiPersonaleDirigente_prev2 = SUM(budgetprevision.prevision2),
		@B_VIII2_CostiPersonaleDirigente_prev3 = SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT	@B_IX1_CostiSostegnoStudenti = SUM(budgetprevision.prevision),
		@B_IX1_CostiSostegnoStudenti_prev2 = SUM(budgetprevision.prevision2),
		@B_IX1_CostiSostegnoStudenti_prev3 = SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT  @B_IX2_CostiDirittoStudio = SUM(budgetprevision.prevision),
		@B_IX2_CostiDirittoStudio_prev2 = SUM(budgetprevision.prevision2),
		@B_IX2_CostiDirittoStudio_prev3 = SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT @B_IX3_CostiRicercaAttivitaEditoriale =  SUM(budgetprevision.prevision),
		@B_IX3_CostiRicercaAttivitaEditoriale_prev2 =  SUM(budgetprevision.prevision2),
		@B_IX3_CostiRicercaAttivitaEditoriale_prev3 =  SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT	@B_IX4_TrasferimentiPartner = SUM(budgetprevision.prevision),
		@B_IX4_TrasferimentiPartner_prev2 = SUM(budgetprevision.prevision2),
		@B_IX4_TrasferimentiPartner_prev3 = SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT  @B_IX5_AcquistoMaterialeConsumo = SUM(budgetprevision.prevision),
		@B_IX5_AcquistoMaterialeConsumo_prev2 = SUM(budgetprevision.prevision2),
		@B_IX5_AcquistoMaterialeConsumo_prev3 = SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT  @B_IX6_VariazioneRimanenze = SUM(budgetprevision.prevision),
		@B_IX6_VariazioneRimanenze_prev2 = SUM(budgetprevision.prevision2),
		@B_IX6_VariazioneRimanenze_prev3 = SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT  @B_IX7_AcquistoLibri =  SUM(budgetprevision.prevision),
		@B_IX7_AcquistoLibri_prev2 =  SUM(budgetprevision.prevision2),
		@B_IX7_AcquistoLibri_prev3 =  SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT  @B_IX8_AcquistoServizi = SUM(budgetprevision.prevision),
		@B_IX8_AcquistoServizi_prev2 = SUM(budgetprevision.prevision2),
		@B_IX8_AcquistoServizi_prev3 = SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT  @B_IX9_AcquistoAltriMateriali = SUM(budgetprevision.prevision),
		@B_IX9_AcquistoAltriMateriali_prev2 = SUM(budgetprevision.prevision2),
		@B_IX9_AcquistoAltriMateriali_prev3 = SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT  @B_IX10_VariazioneRimanenze = SUM(budgetprevision.prevision),
		@B_IX10_VariazioneRimanenze_prev2 = SUM(budgetprevision.prevision2),
		@B_IX10_VariazioneRimanenze_prev3 = SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT  @B_IX11_CostiGodimento = SUM(budgetprevision.prevision),
		@B_IX11_CostiGodimento_prev2 = SUM(budgetprevision.prevision2),
		@B_IX11_CostiGodimento_prev3 = SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT  @B_IX12_AltriCosti = SUM(budgetprevision.prevision),
		@B_IX12_AltriCosti_prev2 = SUM(budgetprevision.prevision2),
		@B_IX12_AltriCosti_prev3 = SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT @B_X1_AmmortamentiImmobImmateriali =  SUM(budgetprevision.prevision),
		@B_X1_AmmortamentiImmobImmateriali_prev2 =  SUM(budgetprevision.prevision2),
		@B_X1_AmmortamentiImmobImmateriali_prev3 =  SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT @B_X2_AmmortamentiImmobMateriali = SUM(budgetprevision.prevision),
		@B_X2_AmmortamentiImmobMateriali_prev2 = SUM(budgetprevision.prevision2),
		@B_X2_AmmortamentiImmobMateriali_prev3 = SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT  @B_X3_SvalutazioniImmobilizzazioni = SUM(budgetprevision.prevision),
		@B_X3_SvalutazioniImmobilizzazioni_prev2 = SUM(budgetprevision.prevision2),
		@B_X3_SvalutazioniImmobilizzazioni_prev3 = SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT  @B_X4_SvalutazioniCrediti = SUM(budgetprevision.prevision),
		@B_X4_SvalutazioniCrediti_prev2 = SUM(budgetprevision.prevision2),
		@B_X4_SvalutazioniCrediti_prev3 = SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT @B_XI_AccantonamentiRischiOneri = SUM(budgetprevision.prevision),
		@B_XI_AccantonamentiRischiOneri_prev2 = SUM(budgetprevision.prevision2),
		@B_XI_AccantonamentiRischiOneri_prev3 = SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
...
SELECT  @B_XII_OneriDversiGestione = SUM(budgetprevision.prevision),
		@B_XII_OneriDversiGestione_prev2 = SUM(budgetprevision.prevision2),
		@B_XII_OneriDversiGestione_prev3 = SUM(budgetprevision.prevision3)
	FROM budgetprevision 
	join sorting S
		on budgetprevision.idsor = S.idsor
	JOIN upb U
