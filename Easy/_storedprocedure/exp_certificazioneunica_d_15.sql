...
-- exec exp_certificazioneunica_d_15  28427, 1, 'H', {d '2015-12-31'},'S'
CREATE PROCEDURE [exp_certificazioneunica_d_15]
...
-- Sezione dichiarativa	
	...
	--2015	DA001	001	Codice fiscale	CF
	--2015	DA001	002	Cognome o denominazione	AN
	--2015	DA001	003	Nome	AN
	--2015	DA001	004	Comune di Residenza	AN
	--2015	DA001	005	Provincia di Residenza (sigla)	PR
	--2015	DA001	006	CAP	AN
	...
	--2015	DA001	010	Codice Attività	AN
	--2015	DA001	011	Codice Sede	AN (solo per chi ha più sedi)
...
SET @IND001 = @DA002002 + ' ' + @DA002003 -- Riga 1: cognome nome
...
LEFT OUTER JOIN geo_nation_agency N -- eventuale nazione di residenza, se estero
    ...
    AND N.stop IS NULL
WHERE
((registryaddress.stop IS NULL AND registryaddress.active <>'N' ) OR (registryaddress.stop >= ISNULL(@datarif,@dateindi_01_gen_15)))
    AND registryaddress.start =
    (SELECT MAX(cdi.start)
    FROM registryaddress cdi
    WHERE cdi.idaddresskind = registryaddress.idaddresskind
        AND (cdi.start <= ISNULL(@datarif,@dateindi_01_gen_15))
        AND ((cdi.stop IS NULL AND cdi.active <>'N') OR (cdi.stop >= ISNULL(@datarif,@dateindi_01_gen_15)))
        AND cdi.idreg = registryaddress.idreg)
        AND idreg = @idreg
...
SELECT @DA002043 = codice_iso_nazione FROM #address WHERE nation <> 'ITALIA'

--select * from #address
	--2015	DA002	001	Codice fiscale	CF
	--2015	DA002	002	Cognome	AN
	--2015	DA002	003	Nome	AN
	--2015	DA002	004	Sesso	AN
	--2015	DA002	005	Data di nascita	DT
	--2015	DA002	006	Comune (o Stato estero) di nascita	AN
	--2015	DA002	007	Provincia di nascita (sigla)	PN
	--2015	DA002	008	Categorie particolari	AN -- non compiliamo
	--2015	DA002	009	Eventi eccezionali	N1 -- non compiliamo 
	--2015	DA002	010	Casi di esclusione dalla  precompilata	N1 -- non compiliamo
	--2015	DA002	020	Comune	AN  (Domicilio fiscale al 1/1/2014)
	--2015	DA002	021	Provincia (sigla)	PR  (Domicilio fiscale al 1/1/2014)
	--2015	DA002	022	Codice comune	AN (Domicilio fiscale al 1/1/2014) 
	--2015	DA002	023	Comune	AN   (Domicilio fiscale al 1/1/2015)
	--2015	DA002	024	Provincia (sigla)	PR  (Domicilio fiscale al 1/1/2015)
	...
	--2015	DA002	041	Località di residenza estera	AN
...
IF (@tipoRecord <> 'H')
	...
	INSERT INTO #recordd (progr,modulo, quadro, riga, colonna, intero)  VALUES(@progrCert, @progrModulo,'DA002', 1, '043', @DA002043)
