...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_modello770_22_a]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_modello770_22_a]
GO
 
CREATE     PROCEDURE [exp_modello770_22_a]
AS BEGIN
	...
	--3 Codice fornitura
	INSERT INTO #recorda (progr, quadro, riga, colonna, stringa) VALUES(1, 'HRA', 1, '03', '77022')
	--4 Tipo fornitore
