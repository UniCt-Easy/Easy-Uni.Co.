if exists (select * from dbo.sysobjects where id = object_id(N'[exp_modello770_13]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_modello770_13]
GO
...
CREATE    PROCEDURE [exp_modello770_13] (
...
AS BEGIN
	...
	EXEC exp_modello770_13_a

	DECLARE @progr_raggiunto int

	--if @recordGH = 'GH'
	--begin
	--	INSERT INTO #modello770 EXEC exp_modello770_13_g '770'
	--end
...
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	(
	 ...
	 EXEC exp_modello770_12_b @numdichquadrog, @numdichquadroh
