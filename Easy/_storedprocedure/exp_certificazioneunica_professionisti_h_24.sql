...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_certificazioneunica_professionisti_h_24]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_certificazioneunica_professionisti_h_24]
GO
 --setuser'amm'
 -- setuser 'amministrazione'
--exec exp_certificazioneunica_professionisti_h_24  PRSRCC87R11H224K 
CREATE PROCEDURE [exp_certificazioneunica_professionisti_h_24]
(
	@cf varchar(20)
 )
...
AS BEGIN
	...
	CREATE TABLE #percipienti_record_H_2023
	(
		idreg int,
		title varchar(150),
		cf varchar(50),
	...
	INSERT INTO #expense2023 --#percipienti_record_H_2023
		(
			idexp,
			idreg,
			title,
...
insert into #percipienti_record_H_2023
select #expense2023.idreg,
		#expense2023.title,
		#expense2023.cf,
		#expense2023.p_iva,
		#expense2023.ycon,  
		...
		#expense2023.ymov, 
		#expense2023.nmov, 
		#expense2023.curramount,
		#expense2023.codeser,
		#expense2023.ivakind,
		#expense2023.sortcode,
		#expense2023.sorting,
		#expense2023.taxref, 
		#expense2023.tax, 
		#expense2023.taxablenet,
		#expense2023.employtax--,
		--#expense2023.spese_nonimp,
		--#expense2023.spese_imp
from #expense2023
	...
	FROM	#percipienti_record_H_2023
