...
if exists (select * from dbo.sysobjects where id = object_id(N'[compute_filtered_idsor_income]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [compute_filtered_idsor_income]
GO
...
CREATE          PROCEDURE [compute_filtered_idsor_income] 
