...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_certificazioneunica_percipienti_g_24]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_certificazioneunica_percipienti_g_24]
GO
--setuser'amministrazione'
 
--exec exp_certificazioneunica_percipienti_g_24  NULL
CREATE PROCEDURE [exp_certificazioneunica_percipienti_g_24]
(
	@cf varchar(20)
 )
...
AS BEGIN
	...
	CREATE TABLE #percipienti_record_G_2023
	(
		idreg int,
	...
	INSERT INTO #percipienti_record_G_2023
		(
			idreg
		)
	...
	SELECT * FROM	#percipienti_record_G_2023
