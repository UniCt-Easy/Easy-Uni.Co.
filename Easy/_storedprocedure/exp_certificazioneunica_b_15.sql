...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_certificazioneunica_b_15]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_certificazioneunica_b_15]
GO
...
-- exec exp_certificazioneunica_b_15 1,1
create PROCEDURE [exp_certificazioneunica_b_15]
(
	@numdichquadrog int,
	@numdichquadroh int
)
...
--	--23 Numero comunicazioni relative a certificazioni lavoro dipendente ed assimilati
	INSERT INTO #recordb (progr,  modulo,quadro, riga, colonna, intero)  VALUES(1,1, 'HRB', 1, '023', @numdichquadrog)
	--24 Numero comunicazioni relative a certificazioni lavoro autonomo e provvigioni
	INSERT INTO #recordb (progr, modulo, quadro, riga, colonna, intero)  VALUES(1, 1,'HRB', 1, '024', @numdichquadroh)
	--25 Casella Quadro CT Se barrata deve essere compilato il campo 23. Vale 1 in presenza del quadro CT.
	IF (@numdichquadrog > 0)
		INSERT INTO #recordb (progr, modulo, quadro, riga, colonna, intero)  VALUES(1,1,'HRB', 1, '025', 1)
		ELSE
		INSERT INTO #recordb (progr, modulo, quadro, riga, colonna, intero)  VALUES(1,1, 'HRB', 1, '025', 0)
	--26 Firma 
