...
------- NUOVA VERSIONE ----------------
---------------------------------------
if exists (select * from dbo.sysobjects where id = object_id(N'[rpt_consuntivobudgeteconomicoufficiale_puro]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [rpt_consuntivobudgeteconomicoufficiale_puro]
GO
...
SET ANSI_NULLS ON 
GO
--exec rpt_consuntivobudgeteconomicoufficiale_puro 2017, {d'2017-12-31'},'%','S',null,null,null,null,null
--go
--exec rpt_consuntivobudgeteconomicoufficiale_puro_test  2018, {d'2018-12-31'},'%','S',null,null,null,null,null
--go
--exec rpt_consuntivobudgeteconomicoufficiale_puro 2018, {d'2018-12-31'},'%','S',null,null,null,null,null
CREATE      PROCEDURE [rpt_consuntivobudgeteconomicoufficiale_puro](
