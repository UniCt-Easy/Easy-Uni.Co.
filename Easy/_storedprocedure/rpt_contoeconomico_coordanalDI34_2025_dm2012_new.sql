...
if exists (select * from dbo.sysobjects where id = object_id(N'[rpt_contoeconomico_coordanalDI34_2025_dm2012_new]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [rpt_contoeconomico_coordanalDI34_2025_dm2012_new]
GO
...
--	exec rpt_contoeconomico_coordanalDI34_2025_dm2012_new 2018, {ts '2018-01-01 00:00:00'}, {ts '2018-12-31 00:00:00'}, '%','S','N',null,'N'
--	exec rpt_contoeconomico_coordanalDI34_2025_dm2012_new 2019, {ts '2019-01-01 00:00:00'}, {ts '2019-12-31 00:00:00'}, '0001','S', 'S',2033 ,'S'
--	exec rpt_contoeconomico_coordanalDI34_2025_dm2012_new 2018, {ts '2018-01-01 00:00:00'}, {ts '2018-12-31 00:00:00'}, '%','S',	'S',2033 ,'S'



CREATE PROCEDURE rpt_contoeconomico_coordanalDI34_2025_dm2012_new
	(
	@ayear int,
	@start datetime,
	@stop datetime,
...
INSERT INTO #dati  SELECT 2,'III. PROVENTI PER LA GESTIONE DIRETTA INTERVENTI PER IL DIRITTO ALLO STUDIO', 'A) IV',  0,0,0,0, 'R', null,1, _idsor1 from  #ANALITICA1
...
INSERT INTO #dati  SELECT 2,'IV. ALTRI PROVENTI  E RICAVI DIVERSI','A) IV',  0,0,0,0, 'R' ,  null,1, _idsor1 from  #ANALITICA1
-------------- Variazioni Rimanenze  ---------------------------------- 
INSERT INTO #dati  SELECT 2,'V. VARIAZIONE RIMANENZE', 'A) V', 0,0,0,0, 'R',  null,1 , _idsor1 from  #ANALITICA1
---------- Incremento Immobilizzazioni per lavoro interni ---------------------------------- 
INSERT INTO #dati  SELECT 2,'VI. INCREMENTO IMMOBILIZZAZIONI PER LAVORI INTERNI', 'A) VI', 0,0,0,0, 'R' , null,1, _idsor1 from  #ANALITICA1
----------- TOTALE PROVENTI (A)-----------------------------------------------------------------
...
*/
INSERT INTO #dati  SELECT 3,'VII.  COSTI DEL PERSONALE',										null, 0,0,0,0, 'C' ,null,1, _idsor1 from  #ANALITICA1
INSERT INTO #dati  SELECT 2,'1) Costi del personale dedicato alla ricerca e alla didattica',	 null, 0,0,0,0, 'C' ,'VII.  COSTI DEL PERSONALE',1, _idsor1 from  #ANALITICA1
INSERT INTO #dati  SELECT 1,'a) Docenti/Ricercatori',											'B) VII 1) a)', 0,0,0,0, 'C' ,'1) Costi del personale dedicato alla ricerca e alla didattica',1, _idsor1 from  #ANALITICA1
INSERT INTO #dati  SELECT 1,'b) Collaborazioni scientifiche (collaboratori, assegnisti, ecc)',	'B) VII 1) b)', 0,0,0,0, 'C' ,'1) Costi del personale dedicato alla ricerca e alla didattica',1 ,_idsor1 from  #ANALITICA1
INSERT INTO #dati  SELECT 1,'c) Docenti a contratto',											'B) VII 1) c)', 0,0,0,0, 'C' ,'1) Costi del personale dedicato alla ricerca e alla didattica',1, _idsor1 from  #ANALITICA1
INSERT INTO #dati  SELECT 1,'d) Esperti linguistici',											'B) VII 1) d)', 0,0,0,0, 'C' ,'1) Costi del personale dedicato alla ricerca e alla didattica',1, _idsor1 from  #ANALITICA1
INSERT INTO #dati  SELECT 1,'e) Altro personale dedicato alla didattica e alla ricerca',		'B) VII 1) e)', 0,0,0,0, 'C' ,'1) Costi del personale dedicato alla ricerca e alla didattica',1, _idsor1 from  #ANALITICA1
INSERT INTO #dati  SELECT 1,'2) Costi del personale dirigente e tecnico-amministrativo',		'B) VII 2)'   , 0,0,0,0, 'C' ,'1) Costi del personale dedicato alla ricerca e alla didattica',1, _idsor1 from  #ANALITICA1
...
12)Altri  costi 
*/
INSERT INTO #dati  SELECT 2,'VIII. COSTI DELLA GESTIONE CORRENTE', null, 0,0,0,0, 'C'  ,null,1   , _idsor1 from  #ANALITICA1
INSERT INTO #dati  SELECT 1,'1) Costi per sostegno agli studenti', 'B) VIII 1)', 0,0,0,0, 'C', 'VIII. COSTI DELLA GESTIONE CORRENTE',1   , _idsor1 from  #ANALITICA1
INSERT INTO #dati  SELECT 1,'2) Costi per il diritto allo studio', 'B) VIII 2)', 0,0,0,0, 'C'  , 'VIII. COSTI DELLA GESTIONE CORRENTE',1  , _idsor1 from  #ANALITICA1
INSERT INTO #dati  SELECT 1,'3) Costi per l''attività editoriale', 'B) VIII 3)', 0,0,0,0, 'C', 'VIII. COSTI DELLA GESTIONE CORRENTE',1  , _idsor1 from  #ANALITICA1
INSERT INTO #dati  SELECT 1,'4) Trasferimenti a partner di progetti coordinati', 'B) VIII 4)', 0,0,0,0, 'C' , 'VIII. COSTI DELLA GESTIONE CORRENTE',1  , _idsor1 from  #ANALITICA1
INSERT INTO #dati  SELECT 1,'5) Acquisto materiale consumo per laboratori', 'B) VIII 5)', 0,0,0,0, 'C'  , 'VIII. COSTI DELLA GESTIONE CORRENTE',1  , _idsor1 from  #ANALITICA1
INSERT INTO #dati  SELECT 1,'6) Variazione rimanenze di materiale di consumo per laboratori', 'B) VIII 6)', 0,0,0,0, 'C' , 'VIII. COSTI DELLA GESTIONE CORRENTE',1  , _idsor1 from  #ANALITICA1
INSERT INTO #dati  SELECT 1,'7)Acquisto di libri, periodici e matariale bibliografico', 'B) VIII 7)', 0,0,0,0, 'C', 'VIII. COSTI DELLA GESTIONE CORRENTE',1   , _idsor1 from  #ANALITICA1
INSERT INTO #dati  SELECT 1,'8) Acquisto di servizi e collaborazioni tecnico gestionali', 'B) VIII 8)', 0,0,0,0, 'C' , 'VIII. COSTI DELLA GESTIONE CORRENTE',1  , _idsor1 from  #ANALITICA1
INSERT INTO #dati  SELECT 1,'9) Acquisto altri materiali', 'B) VIII 9)', 0,0,0,0, 'C' , 'VIII. COSTI DELLA GESTIONE CORRENTE',1   , _idsor1 from  #ANALITICA1
INSERT INTO #dati  SELECT 1,'10) Variazione delle rimanenze di materiale', 'B) VIII 10)',  0,0,0,0, 'C' , 'VIII. COSTI DELLA GESTIONE CORRENTE',1  , _idsor1 from  #ANALITICA1
INSERT INTO #dati  SELECT 1,'11) Costi per godimento beni di terzi', 'B) VIII 11)', 0,0,0,0, 'C'  , 'VIII. COSTI DELLA GESTIONE CORRENTE',1  , _idsor1 from  #ANALITICA1
INSERT INTO #dati  SELECT 1,'12) Altri costi', 'B) VIII 12)', 0,0,0,0, 'C', 'VIII. COSTI DELLA GESTIONE CORRENTE',1    , _idsor1 from  #ANALITICA1
/*	
...
*/
INSERT INTO #dati  SELECT 2,'IX. AMMORTAMENTI E SVALUTAZIONI', null, 0,0,0,0, 'C' ,null,1, _idsor1 from  #ANALITICA1
INSERT INTO #dati  SELECT 1,'1) Ammortamenti immobilizzazioni immateriali', 'B) IX 1)', 0,0,0,0, 'C','IX. AMMORTAMENTI E SVALUTAZIONI',1, _idsor1 from  #ANALITICA1
INSERT INTO #dati  SELECT 1,'2) Ammortamenti immobilizzazioni materiali', 'B) IX 2)', 0,0,0,0, 'C','IX. AMMORTAMENTI E SVALUTAZIONI',1 , _idsor1 from  #ANALITICA1
INSERT INTO #dati  SELECT 1,'3) Svalutazioni immobilizzazioni', 'B) X 3)', 0,0,0,0, 'C','IX. AMMORTAMENTI E SVALUTAZIONI',1 , _idsor1 from  #ANALITICA1
INSERT INTO #dati  SELECT 1,'4) Svalutazioni dei crediti compresi nell’attivo circolante e nelle disponibilità liquide', 'B)I X 4)', 0,0,0,0, 'C' ,'IX. AMMORTAMENTI E SVALUTAZIONI',1, _idsor1 from  #ANALITICA1
INSERT INTO #dati  SELECT 2,'X. ACCANTONAMENTI PER RISCHI E ONERI', 'B) X', 0,0,0,0, 'C', null, 1 , _idsor1 from  #ANALITICA1
INSERT INTO #dati  SELECT 2,'XI. ONERI DIVERSI DI GESTIONE','B) XI', 0,0,0,0, 'C' , null, 1, _idsor1 from  #ANALITICA1
...
INSERT INTO #dati  SELECT 4,'RISULTATO DI ESERCIZIO', null,  0,0,0,0, 'SUBT' , null, 1 , _idsor1 from  #ANALITICA1
 ...
 DECLARE @codeplaccount_LK varchar(200)
 DECLARE @kind char(1)
 DECLARE @ass char(1)
 ...
 declare @crs_idsor1 int
	...
	begin
		   ...
		   Begin 
				...
				SET @codeplaccount_LK = (SELECT LK.codeplaccount_old from  lookupprintedplaccount LK
								where LK.ayear_old = @ayearPrec 
								and  LK.codeplaccount_new = @codeplaccount )
				set  @codeplaccount_LK	= ISNULL(@codeplaccount_LK,@codeplaccount)
