...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_modello770_14_b]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_modello770_14_b]
GO
...
create PROCEDURE [exp_modello770_14_b]
(
	@numdichquadrog int,
	@numdichquadroh int,
	@numdichquadroi int
...
--33-52La sezione (e i controlli in essa descritti) deve essere presente se presente il campo 15.
	--33 Natura giuridica (farlo scegliere a loro)
...
--75-82Redazione della dichiarazione
	...
	--127 Codice carica del rappresentante (farlo scegliere a loro)
