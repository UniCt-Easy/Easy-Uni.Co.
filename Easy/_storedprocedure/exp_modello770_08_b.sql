...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_modello770_08_b]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_modello770_08_b]
GO
...
create PROCEDURE [exp_modello770_08_b]
(
	@numdichquadrog int,
	@numdichquadroh int
)
...
--75-81Redazione della dichiarazione
	--74 Redazione della dichiarazione
	INSERT INTO #recordb (progr, quadro, riga, colonna, intero)  VALUES(1, 'HRB', 1, '074', 1)
	--75 Numero comunicazioni relative a certificazioni lavoro dipendente ed assimilati
	INSERT INTO #recordb (progr, quadro, riga, colonna, intero)  VALUES(1, 'HRB', 1, '075', @numdichquadrog)
	--76 Numero comunicazioni relative a certificazioni lavoro autonomo e provvigioni
	INSERT INTO #recordb (progr, quadro, riga, colonna, intero)  VALUES(1, 'HRB', 1, '076', @numdichquadroh)
	--77 Casella prospetto SS
	INSERT INTO #recordb (progr, quadro, riga, colonna, intero)  VALUES(1, 'HRB', 1, '077', 0)
...
--107-127La sezione è obbligatoria per i contribuenti diversi dalle persone fisiche
	--107 Codice fiscale del rappresentante
	INSERT INTO #recordb (progr, quadro, riga, colonna, stringa) VALUES(1, 'HRB', 1, '107', @manager_cf)
	--108 Codice carica del rappresentante
	INSERT INTO #recordb (progr, quadro, riga, colonna, intero)  VALUES(1, 'HRB', 1, '108', 14)
	--112 Cognome del rappresentante
	INSERT INTO #recordb (progr, quadro, riga, colonna, stringa) VALUES(1, 'HRB', 1, '112', @manager_surname)
	--113 Nome del rappresentante
	INSERT INTO #recordb (progr, quadro, riga, colonna, stringa) VALUES(1, 'HRB', 1, '113', @manager_forename)
	--114 Sesso del rappresentante
	INSERT INTO #recordb (progr, quadro, riga, colonna, stringa) VALUES(1, 'HRB', 1, '114', @manager_gender)
	--115 Data di nascita del rappresentante
	INSERT INTO #recordb (progr, quadro, riga, colonna, data)    VALUES(1, 'HRB', 1, '115', @manager_b_date)
	--116 Comune o stato estero di nascita del rappresentante
	INSERT INTO #recordb (progr, quadro, riga, colonna, stringa) VALUES(1, 'HRB', 1, '116', @manager_b_city)
	--117 Sigla della provincia di nascita del rappresentante
	INSERT INTO #recordb (progr, quadro, riga, colonna, stringa) VALUES(1, 'HRB', 1, '117', @manager_b_country)
	--118 Comune di residenza anagrafica del rappresentante
	INSERT INTO #recordb (progr, quadro, riga, colonna, stringa) VALUES(1, 'HRB', 1, '118', @manager_r_city)
	--119 Sigla della provincia di residenza del rappresentante
	INSERT INTO #recordb (progr, quadro, riga, colonna, stringa) VALUES(1, 'HRB', 1, '119', @manager_r_country)
	--120 Cap del comune di residenza del rappresentante
	INSERT INTO #recordb (progr, quadro, riga, colonna, intero)  VALUES(1, 'HRB', 1, '120', @manager_r_cap)
	--121 Frazione, via e numero civico del rappresentante
	INSERT INTO #recordb (progr, quadro, riga, colonna, stringa) VALUES(1, 'HRB', 1, '121', @manager_r_address)
	--122 Numero di telefono del rappresentante
	INSERT INTO #recordb (progr, quadro, riga, colonna, stringa) VALUES(1, 'HRB', 1, '122', @manager_phonenumber)
