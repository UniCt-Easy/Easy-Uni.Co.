if exists (select * from dbo.sysobjects where id = object_id(N'[exp_certificazioneunica_h_18]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_certificazioneunica_h_18]
GO
 
 --setuser 'amministrazione'
 --declare @newProg int
 --exec exp_certificazioneunica_h_18 148558,1, 'N', @newProg out
 --select @newProg
CREATE PROCEDURE [exp_certificazioneunica_h_18]
...
-- Sezione dichiarativa	
	...
	update #expense2017 set motive770 = motive770service.idmot,
		...
		where motive770service.idser = #expense2017.idser
		...
		SELECT 
			#expense2017.employtaxamount,
			#expense2017.idexp,
			#expense2017.idser,
			#expense2017.motive770,
			#expense2017.socialseccode,
			#expense2017.cfagency,
			#expense2017.titleagency 
		FROM #expense2017
		join expenselink  			on expenselink.idchild = #expense2017.idexp			and nlevel = @expensephase
 ...
 --SELECT * FROM #recHNonArrot
	...
	declare @cursore cursor
		...
		begin
			...
			exec exp_certificazioneunica_d_18  @idreg, @newprogrCom, 'H',NULL, @print
...
insert into #recordH (progr,modulo, quadro, riga, colonna, stringa,decimale, intero, data)
			exec exp_certificazioneunica_h_pign_18  @idreg, @newprogrCom, @modulo, @fattoprestazioni,  @inseritopignoramenti out, @newmodulo out
...
---  
 ...
 --declare @newProg int
 --exec exp_certificazioneunica_h_18 1126,3, 'N', @newProg out