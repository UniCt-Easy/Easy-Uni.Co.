...
-- setuser 'amm'
-- exec rpt_budgeteconomicoufficiale_triennale_puro 2017, '%','S'
CREATE      PROCEDURE [rpt_budgeteconomicoufficiale_triennale_puro](
...
SELECT @A_IV_ProventiPerGestioneDiretta = SUM(accountyear.prevision*A.economicbudget_sign_value),
		@A_IV_ProventiPerGestioneDiretta_prev2 = SUM(accountyear.prevision2*A.economicbudget_sign_value),
		@A_IV_ProventiPerGestioneDiretta_prev3 = SUM(accountyear.prevision3*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A			on accountyear.idacc = A.idacc
	JOIN upb U					ON accountyear.idupb = U.idupb
	join sorting S				on S.idsor = A.idsor_economicbudget
...
SELECT @A_V1_UtilizzoRiservePatrimonioNetto = SUM(accountyear.prevision*A.economicbudget_sign_value),
		@A_V1_UtilizzoRiservePatrimonioNetto_prev2 = SUM(accountyear.prevision2*A.economicbudget_sign_value),
		@A_V1_UtilizzoRiservePatrimonioNetto_prev3 = SUM(accountyear.prevision3*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A				on accountyear.idacc = A.idacc
	JOIN upb U						ON accountyear.idupb = U.idupb
	join sorting S					on S.idsor = A.idsor_economicbudget
...
SELECT @A_V2_AltriProventi = SUM(accountyear.prevision*A.economicbudget_sign_value),
		@A_V2_AltriProventi_prev2 = SUM(accountyear.prevision2*A.economicbudget_sign_value),
		@A_V2_AltriProventi_prev3 = SUM(accountyear.prevision3*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A				on accountyear.idacc = A.idacc
	JOIN upb U						ON accountyear.idupb = U.idupb
	join sorting S					on S.idsor = A.idsor_economicbudget
...
SELECT @A_VI_VariazioniRimanenze = SUM(accountyear.prevision*A.economicbudget_sign_value),
		@A_VI_VariazioniRimanenze_prev2 = SUM(accountyear.prevision2*A.economicbudget_sign_value),
		@A_VI_VariazioniRimanenze_prev3 = SUM(accountyear.prevision3*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A				on accountyear.idacc = A.idacc
	JOIN upb U						ON accountyear.idupb = U.idupb
	join sorting S					on S.idsor = A.idsor_economicbudget
...
SELECT @A_VII_IncrementoImmobilizzazioni = SUM(accountyear.prevision*A.economicbudget_sign_value),
		@A_VII_IncrementoImmobilizzazioni_prev2 = SUM(accountyear.prevision2*A.economicbudget_sign_value),
		@A_VII_IncrementoImmobilizzazioni_prev3 = SUM(accountyear.prevision3*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A			on accountyear.idacc = A.idacc
	JOIN upb U					ON accountyear.idupb = U.idupb
	join sorting S				on S.idsor = A.idsor_economicbudget
...
SELECT @B_VIII1a_CostiDocentiRicercatori = SUM(accountyear.prevision*A.economicbudget_sign_value),
		@B_VIII1a_CostiDocentiRicercatori_prev2 = SUM(accountyear.prevision2*A.economicbudget_sign_value),
		@B_VIII1a_CostiDocentiRicercatori_prev3 = SUM(accountyear.prevision3*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
...
SELECT	@B_VIII1b_CollaborazioniScientifiche = SUM(accountyear.prevision*A.economicbudget_sign_value),
		@B_VIII1b_CollaborazioniScientifiche_prev2 = SUM(accountyear.prevision2*A.economicbudget_sign_value),
		@B_VIII1b_CollaborazioniScientifiche_prev3 = SUM(accountyear.prevision3*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
SELECT	@B_VIII1c_DocentiAContratto = SUM(accountyear.prevision*A.economicbudget_sign_value),
		@B_VIII1c_DocentiAContratto_prev2 = SUM(accountyear.prevision2*A.economicbudget_sign_value),
		@B_VIII1c_DocentiAContratto_prev3 = SUM(accountyear.prevision3*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
SELECT @B_VIII1d_EspertiLinguistici = SUM(accountyear.prevision*A.economicbudget_sign_value),
		@B_VIII1d_EspertiLinguistici_prev2 = SUM(accountyear.prevision2*A.economicbudget_sign_value),
		@B_VIII1d_EspertiLinguistici_prev3 = SUM(accountyear.prevision3*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
SELECT	@B_VIII1e_AltroPersonale =  SUM(accountyear.prevision*A.economicbudget_sign_value),
		@B_VIII1e_AltroPersonale_prev2 =  SUM(accountyear.prevision2*A.economicbudget_sign_value),
		@B_VIII1e_AltroPersonale_prev3 =  SUM(accountyear.prevision3*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
SELECT @B_VIII2_CostiPersonaleDirigente = SUM(accountyear.prevision*A.economicbudget_sign_value),
		@B_VIII2_CostiPersonaleDirigente_prev2 = SUM(accountyear.prevision2*A.economicbudget_sign_value),
		@B_VIII2_CostiPersonaleDirigente_prev3 = SUM(accountyear.prevision3*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
SELECT	@B_IX1_CostiSostegnoStudenti = SUM(accountyear.prevision*A.economicbudget_sign_value),
		@B_IX1_CostiSostegnoStudenti_prev2 = SUM(accountyear.prevision2*A.economicbudget_sign_value),
		@B_IX1_CostiSostegnoStudenti_prev3 = SUM(accountyear.prevision3*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
SELECT @B_IX3_CostiRicercaAttivitaEditoriale =  SUM(accountyear.prevision*A.economicbudget_sign_value),
		@B_IX3_CostiRicercaAttivitaEditoriale_prev2 =  SUM(accountyear.prevision2*A.economicbudget_sign_value),
		@B_IX3_CostiRicercaAttivitaEditoriale_prev3 =  SUM(accountyear.prevision3*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
SELECT  @B_IX5_AcquistoMaterialeConsumo = SUM(accountyear.prevision*A.economicbudget_sign_value),
		@B_IX5_AcquistoMaterialeConsumo_prev2 = SUM(accountyear.prevision2*A.economicbudget_sign_value),
		@B_IX5_AcquistoMaterialeConsumo_prev3 = SUM(accountyear.prevision3*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
SELECT  @B_IX8_AcquistoServizi = SUM(accountyear.prevision*A.economicbudget_sign_value),
		@B_IX8_AcquistoServizi_prev2 = SUM(accountyear.prevision2*A.economicbudget_sign_value),
		@B_IX8_AcquistoServizi_prev3 = SUM(accountyear.prevision3*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
SELECT  @B_IX9_AcquistoAltriMateriali = SUM(accountyear.prevision*A.economicbudget_sign_value),
		@B_IX9_AcquistoAltriMateriali_prev2 = SUM(accountyear.prevision2*A.economicbudget_sign_value),
		@B_IX9_AcquistoAltriMateriali_prev3 = SUM(accountyear.prevision3*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
SELECT  @B_IX11_CostiGodimento = SUM(accountyear.prevision*A.economicbudget_sign_value),
		@B_IX11_CostiGodimento_prev2 = SUM(accountyear.prevision2*A.economicbudget_sign_value),
		@B_IX11_CostiGodimento_prev3 = SUM(accountyear.prevision3*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
SELECT  @B_IX12_AltriCosti = SUM(accountyear.prevision*A.economicbudget_sign_value),
		@B_IX12_AltriCosti_prev2 = SUM(accountyear.prevision2*A.economicbudget_sign_value),
		@B_IX12_AltriCosti_prev3 = SUM(accountyear.prevision3*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
SELECT @B_X1_AmmortamentiImmobImmateriali =  SUM(accountyear.prevision*A.economicbudget_sign_value),
		@B_X1_AmmortamentiImmobImmateriali_prev2 =  SUM(accountyear.prevision2*A.economicbudget_sign_value),
		@B_X1_AmmortamentiImmobImmateriali_prev3 =  SUM(accountyear.prevision3*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
SELECT @B_XI_AccantonamentiRischiOneri = SUM(accountyear.prevision*A.economicbudget_sign_value),
		@B_XI_AccantonamentiRischiOneri_prev2 = SUM(accountyear.prevision2*A.economicbudget_sign_value),
		@B_XI_AccantonamentiRischiOneri_prev3 = SUM(accountyear.prevision3*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
SELECT  @B_XII_OneriDversiGestione = SUM(accountyear.prevision*A.economicbudget_sign_value),
		@B_XII_OneriDversiGestione_prev2 = SUM(accountyear.prevision2*A.economicbudget_sign_value),
		@B_XII_OneriDversiGestione_prev3 = SUM(accountyear.prevision3*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
