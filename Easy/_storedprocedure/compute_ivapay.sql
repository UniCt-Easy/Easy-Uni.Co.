...
-- compute_ivapay '2020/07/01','2020/09/01'
-- compute_ivapay '2020/07/01','2020/09/01'
...
*/
	...
	SELECT #invoice.*,ivaregisterkind.codeivaregisterkind, ivaregisterkind.description,
		...
		--Questi campi sono stati aggiunti per poter visualizzare l'anteprima della fatture che entrano in liquidazione
		II.description as invoicedescription,
        II.invoicekind as invoicekind,
        II.doc as doc,
        II.docdate as docdate,
        II.adate as adate,
        II.registry as registry,
        II.unabatable as unabatable,
        II.tax as tax,
        II.taxable as taxable,
        II.total as total
	 FROM #invoice
	 JOIN invoiceview II
		on II.idinvkind=#invoice.idinvkind and II.yinv=#invoice.yinv and II.ninv= #invoice.ninv
