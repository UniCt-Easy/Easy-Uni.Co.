...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_certificazioneunica_h_pign_18]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_certificazioneunica_h_pign_18]
GO  
 
CREATE PROCEDURE [exp_certificazioneunica_h_pign_18]
...
----------------------------------al prospetto SY del mod. 770/2018 semplificato ----------------------
-------------------------------------------------------------------------------------------------------
...
-- RECORD DI TIPO "H": Casi particolari operazioni straordinarie
	...
	--2018	AU	101	Codice Fiscale debitore   principale
	--2018	AU	102	Somme erogate
	--2018	AU	103	Ritenute operate
