...
*/
 ...
 if exists (select * from dbo.sysobjects where id = object_id(N'[exp_modello770_14_h]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_modello770_14_h]
GO
--exec exp_modello770_14_h
CREATE PROCEDURE [exp_modello770_14_h]
AS BEGIN
-- OK
...
-- Sezione dichiarativa	
	...
	--AU001009 Provincia (sigla)
		...
		-- Il campo AU001010 non viene mai riempito in quanto la causale (campo AU001019) vale sempre A o M e mai N (condizione per cui tale campo deve essere valorizzato)
...
---AUX0025 = Imponibile Lordo SUM (feegross) - Imponibile Netto (SUM(taxablenet) da expensetax where (taxkind=1 ossia fiscali)
	...
	BEGIN
		...
		--- AUX0025 Altre Somme Non Soggette a Ritenuta
