...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_piano_annuale_flussi_cassa_all4_sql]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_piano_annuale_flussi_cassa_all4_sql]
GO
...
----------------------------------------------------------------------------
CREATE    PROCEDURE [exp_piano_annuale_flussi_cassa_all4_sql]
(
...
--- exec exp_piano_annuale_flussi_cassa_all4_sql 2025, {ts '2025-09-04 00:00:00'} , 'S', 103,104
AS BEGIN
