...
-- exec rpt_bilconsuntivo 2018, {ts '2018-07-31 00:00:00'}, 'E', 5, '%', 'N', 'S', 'S', 'S', NULL, NULL, NULL, NULL, NULL
-- exec rpt_bilconsuntivo 2018,{ts '2018-07-30 00:00:00'},'E',5,'%','N','N','S','N', null, null, null, null, null


CREATE       PROCEDURE [rpt_bilconsuntivo]
(
	@ayear int,
	@date datetime,
	@finpart char(1)='S',
...
Begin
	...
	where 	
	ISNULL(D.initialprevision,0) = 0 and 	ISNULL(D.variation,0)  = 0 and 
	...
	ISNULL(D.mov_finphase_R,0)  = 0 and 	ISNULL(D.var_finphase_R,0)  = 0 and 	ISNULL(D.mov_maxphase_R,0)  = 0 and 	ISNULL(D.var_maxphase_R,0) = 0 
	and fin.nlevel>=5
End
