...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_modello770_24_i]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_modello770_24_i]
GO
...
--exec exp_modello770_24_i
CREATE PROCEDURE [exp_modello770_24_i]
AS BEGIN
