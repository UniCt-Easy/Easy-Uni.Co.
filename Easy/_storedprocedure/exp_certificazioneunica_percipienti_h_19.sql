...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_certificazioneunica_percipienti_h_19]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_certificazioneunica_percipienti_h_19]
GO
 
--exec [exp_certificazioneunica_percipienti_h_19]  NULL 
CREATE PROCEDURE [exp_certificazioneunica_percipienti_h_19]
(
	@cf varchar(20)
 )
...
AS BEGIN
	...
	CREATE TABLE #percipienti_record_H_2018
	(
		idreg int,
	...
	INSERT INTO #percipienti_record_H_2018
		(
			idreg
		)
	SELECT DISTINCT
...
GROUP BY T.idreg, T.idreg_distrained, T.idexp,
	...
	SELECT * FROM	#percipienti_record_H_2018
