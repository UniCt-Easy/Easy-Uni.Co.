...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_electronicinvoiceallegati_estere]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_electronicinvoiceallegati_estere]
GO
...
CREATE procedure exp_electronicinvoiceallegati_estere(
	@yinv int,
	@ninv int,
	@idinvkind int) as
begin
