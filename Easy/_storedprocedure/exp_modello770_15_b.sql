...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_modello770_15_b]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_modello770_15_b]
GO
...
-- exec exp_modello770_15_b 1,1,1
create PROCEDURE [exp_modello770_15_b]
(
	@numdichquadrog int,
	@numdichquadroh int,
	@numdichquadroi int
...
--75-82Redazione della dichiarazione
	...
	--82 Casella prospetto SY   -- qui non deve essere 0 ma si dovrebbe verificare se pignoramenti sono stati fatti
	IF (@numdichquadroi > 0)
		INSERT INTO #recordb (progr, quadro, riga, colonna, intero)  VALUES(1, 'HRB', 1, '082', 1)
	ELSE
	...
	INSERT INTO #recordb (progr, quadro, riga, colonna, intero)  VALUES(1, 'HRB', 1, '110', 1)
...
-- 137	Codice stato estero
	INSERT INTO #recordb (progr, quadro, riga, colonna, intero) VALUES(1, 'HRB', 1, '137',  CONVERT(INT,@manager_r_code_e) )
