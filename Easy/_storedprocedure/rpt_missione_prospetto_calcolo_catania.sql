...
SELECT 
	...
	itineration.totadvance,												--  tot anticipo 
	...
	CASE DATEDIFF(day, itineration.start,itineration.stop)
		WHEN 0 THEN 1
		ELSE DATEDIFF(day, itineration.start,itineration.stop)+1 -- Aggiungo + 1 perchè se la missione fosse di un solo giorno, darebbe 0, e se fosse dal 05 al 06, darebbe 1gg invede deve risultare di 2 gg
	END ndays,
