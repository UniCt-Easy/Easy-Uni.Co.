...
if exists (select * from dbo.sysobjects where id = object_id(N'[rpt_bilconsuntivosorting_mpsiope_ct]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [rpt_bilconsuntivosorting_mpsiope_ct]
GO
...
--exec rpt_bilconsuntivosorting_mpsiope_ct 2017, {ts '2017-12-31 00:00:00'}, 23, 47, '000100020001', 'N', 'N', NULL, NULL, NULL, NULL, NULL
---exec rpt_bilconsuntivosorting_mpsiope_ct 2018, {ts '2018-01-19 00:00:00'}, 70, 47, '%', 'S', 'S', NULL, NULL, NULL, NULL, NULL

CREATE  PROCEDURE [rpt_bilconsuntivosorting_mpsiope_ct]
	@ayear			int,
...
BEGIN
 	...
 	SELECT 
		...
		round(isnull(sum(pagamenti),0) ,10)as pagamenti,
