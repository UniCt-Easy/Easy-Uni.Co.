...
if exists (select * from dbo.sysobjects where id = object_id(N'[rpt_bilprevisionesorting]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [rpt_bilprevisionesorting]
GO
...
-- exec rpt_bilprevisionesorting 2015,'S',3,'%','N','N','N', null, null, null, null, null,62
-- exec rpt_bilprevisionesorting 2015,'S',null,'00010002','S','S','S', null, null, null, null, null,62

CREATE    PROCEDURE [rpt_bilprevisionesorting]
(
	@ayear smallint,
	@finpart char(1)='S',
	@levelusable tinyint,
...
select isnull(SLK.idparent, sorFin.idsor) ,isnull(@fixedidupb,finyear.idupb),
		ISNULL(SUM(finyear.prevision*ISNULL(FS.quota,0)),0),ISNULL(SUM(finyear.previousprevision*ISNULL(FS.quota,0)),0),
		ISNULL(SUM(finyear.secondaryprev*ISNULL(FS.quota,0)),0),ISNULL(SUM(finyear.previoussecondaryprev*ISNULL(FS.quota,0)),0),
		ISNULL(SUM(finyear.currentarrears*ISNULL(FS.quota,0)),0),ISNULL(SUM(finyear.previousarrears*ISNULL(FS.quota,0)),0)
from finyear 
...
--select @lencod_lev1, @startpos1 , @lev_desc1
--select @lencod_lev2, @startpos2 , @lev_desc2
--select @lencod_lev3, @startpos3 , @lev_desc3
--select @lencod_lev4, @startpos4 , @lev_desc4
--select @lencod_lev5, @startpos5 , @lev_desc5
--select @lencod_lev6, @startpos6 , @lev_desc6
--select @lencod_lev7, @startpos7 , @lev_desc7
