...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_modello770_17_i_stranieri]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_modello770_17_i_stranieri]
GO
--setuser 'amm'
--setuser'amministrazione'
--exec exp_modello770_17_i_stranieri
CREATE PROCEDURE [exp_modello770_17_i_stranieri]
AS BEGIN
-- OK
	...
	--2017	SY016	001	Cognome/Denominazione	AN
	--2017	SY016	002	Nome	AN
	--2017	SY016	003	Sesso	AN
	--2017	SY016	004	Data di Nascita	DT
	--2017	SY016	005	Codice di identificazione  fiscale estero	AN
	--2017	SY016	006	Località di residenza estera	AN
	--2017	SY016	007	Via e numero civico	AN
	--2017	SY016	008	Codice stato estero	N3
	--2017	SY016	009	Causale	AN
	--2017	SY016	010	Ammontare lordo corrisposto	VP
	--2017	SY016	011	Somme non soggette a  ritenuta per regime  convenzionale	VP
	--2017	SY016	012	Altre somme non soggette a ritenuta	VP
	--2017	SY016	013	Imponibile	VP
	--2017	SY016	014	Ritenute a titolo d''imposta	VP
	--2017	SY016	015	Ritenute sospese	VP
