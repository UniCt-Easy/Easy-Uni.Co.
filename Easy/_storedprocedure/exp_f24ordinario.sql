...
--setuser 'amm'
--exec exp_f24ordinario 16
CREATE procedure exp_f24ordinario(@idf24ordinario int) as
begin
	...
	*/
	insert into #tributi values ('S','3848','CCCC','00MM','AAAA') -- 384E Addizionale comunale Irpef trattenuta dai sostituti d’imposta -saldo  
	insert into #tributi values ('S','3847','CCCC','00MM','AAAA') -- 385E Addizionale comunale Irpef trattenuta dai sostituti d’imposta- acconto 
	insert into #tributi values ('S','8926','CCCC',  null,'AAAA') -- 891E Sanzioni per ravvedimento su Addizionale comunale Irpef trattenuta dai sostituti d’imposta 
	
	insert into #tributi values ('R','3858',  'RR','00MM','AAAA') -- 380E IRAP  	
	insert into #tributi values ('R','3802',  'RR','00MM','AAAA') -- 381E Addizionale regionale Irpef trattenuta dai sostituti d’imposta  
	insert into #tributi values ('R','8907',  'RR',  null,'AAAA') -- 892E Sanzioni per ravvedimento su IRAP 
	insert into #tributi values ('R','8902',  'RR',  null,'AAAA') -- 893E Sanzioni per ravvedimento Addizionale regionale Irpef trattenuta dai sostituti d’imposta  
	
	insert into #tributi values ('F','1001',  null,'00MM','AAAA') -- 100E Ritenute sui redditi da lavoro dipendente ed assimilati  
	insert into #tributi values ('F','1040',  null,'00MM','AAAA') -- 104E Ritenute sui redditi da lavoro autonomo  
	insert into #tributi values ('F','1052',  null,'00MM','AAAA') -- 105E Ritenute sulle indennità di esproprio, occupazione , etc. - articolo 11, legge 413/91  
	insert into #tributi values ('F','1045',  null,'00MM','AAAA') -- 106E Ritenute sui contributi corrisposti alle imprese - articolo 28 D.P.R. 600/73 
/**/insert into #tributi values ('F','_107',  null,'00MM','AAAA') -- 107E Altre ritenute alla fonte  
/**/insert into #tributi values ('F','_890',  null,  null,'AAAA') -- 890E Sanzioni per ravvedimento su ritenute erariali 
	insert into #tributi values ('F','1049',  null,'00MM','AAAA') -- 112E Ritenuta alla fonte su somme pignorate 

/**/insert into #tributi values ('I','_C10',  null,  'MMAAAA',null)		-- C10 Sanzioni per ravvedimento su ritenute erariali 
/**/insert into #tributi values ('I','_CXX',  null,  'MMAAAA',null)		-- CXX Sanzioni per ravvedimento su ritenute erariali 
/**/insert into #tributi values ('Q','_101', null,  'MMAAAA','MMAAAA')	-- P101 Sanzioni per ravvedimento su ritenute erariali 
/**/insert into #tributi values ('Q','_909', null,  'MMAAAA','MMAAAA')	-- P909 Sanzioni per ravvedimento su ritenute erariali 
	insert into #tributi values ('F','1631', null,  null,'AAAA')		-- 150E SOMME A TITOLO DI IMPOSTE ERARIALI RIMBORSATE DAL SOSTITUTO D''IMPOSTA A SEGUITO DI ASSISTENZA FISCALE - ART.15, C.1,LETT.A)
	insert into #tributi values ('F','4731', null, '00MM','AAAA')		-- 134E IRPEF A SALDO TRATTENUTA DAL SOSTITUTO D''IMPOSTA
	insert into #tributi values ('F','3803', 'RR', null,'AAAA')			-- 126E ADDIZIONALE REGIONALE ALL''IRPEF TRATTENUTA DAL SOSTITUTO D''IMPOSTA A SEGUITO DI ASSISTENZA FISCALE
	insert into #tributi values ('R','3796', 'RR', null, 'AAAA')		-- 153E SOMME A TITOLO DI ADDIZIONALE REGIONALE ALL''IRPEF RIMBORSATE DAL SOSTITUTO D''IMPOSTA A SEGUITO DI ASSISTENZA FISCALE - ART. 15, COMMA1,LETT.A)D.LGS. N. 175/2014
	insert into #tributi values ('S','3845', 'CCCC','00MM','AAAA')		-- 127E ADDIZIONALE COMUNALE ALL''IRPEF TRATTENUTA DAL SOSTITUTO D''IMPOSTA MOD. 730- ACCONTO –
	insert into #tributi values ('S','3846', 'CCCC','00MM','AAAA')		-- 128E ADDIZIONALE COMUNALE ALL''IRPEF TRATTENUTA DAL SOSTITUTO D''IMPOSTA MOD. 730- 
	insert into #tributi values ('S','3797', 'CCCC', null,'AAAA')		-- 154E SOMME A TITOLO DI ADDIZIONALE COMUNALE ALL'IRPEF RIMBORSATE DAL SOSTITUTO D'IMPOSTA A SEGUITO DI ASSISTENZA FISCALE - ART. 15, COMMA1,LETT.A)D.LGS. N. 175/2014
	insert into #tributi values ('F','4730', null , '00MM','AAAA')		-- 133E SOMME A TITOLO DI ADDIZIONALE COMUNALE ALL'IRPEF RIMBORSATE DAL SOSTITUTO D'IMPOSTA A SEGUITO DI ASSISTENZA FISCALE - ART. 15, COMMA1,LETT.A)D.LGS. N. 175/2014
	...
	--insert into #tributi values ('S','1669','CCCC','00MM','AAAA') -- 161E Addizionale comunale Irpef trattenuta dai sostituti d’imposta -saldo  
	  insert into #tributi values ('S','1669','RR',null,'AAAA') -- 161E Addizionale comunale Irpef trattenuta dai sostituti d’imposta -saldo  
	
	insert into #tributi values ('R','1671',  'RR',null,'AAAA') -- 160E Addizionale regionale Irpef trattenuta dai sostituti d’imposta  
	insert into #tributi values ('F','1628',  null, null,'AAAA') -- 156E Ritenute sui redditi da lavoro autonomo  	
	insert into #tributi values ('F','1627',  null, null,'AAAA') -- 155E Ritenute sui redditi da lavoro dipendente ed assimilati  
	insert into #tributi values ('F','1701',  null,'00MM','AAAA') -- 165E Bonus fiscale 
	
	insert into #tributi values ('F','6001',null, null,'AAA')--	601E "VERSAMENTO IVA MENSILE GENNAIO"
	insert into #tributi values ('F','6002',null, null,'AAA')--	602E "VERSAMENTO IVA MENSILE FEBBRAIO"
	insert into #tributi values ('F','6003',null, null,'AAA')--	603E "VERSAMENTO IVA MENSILE MARZO"
	insert into #tributi values ('F','6004',null, null,'AAA')--	604E "VERSAMENTO IVA MENSILE APRILE"
	insert into #tributi values ('F','6005',null, null,'AAA')--	605E "VERSAMENTO IVA MENSILE MAGGIO"
	insert into #tributi values ('F','6006',null, null,'AAA')--	606E "VERSAMENTO IVA MENSILE GIUGNO"
	insert into #tributi values ('F','6007',null, null,'AAA')--	607E "VERSAMENTO IVA MENSILE LUGLIO"
	insert into #tributi values ('F','6008',null, null,'AAA')--	608E "VERSAMENTO IVA MENSILE AGOSTO"
	insert into #tributi values ('F','6009',null, null,'AAA')--	609E "VERSAMENTO IVA MENSILE SETTEMBRE"
	insert into #tributi values ('F','6010',null, null,'AAA')--	610E "VERSAMENTO IVA MENSILE OTTOBRE"
	insert into #tributi values ('F','6011',null, null,'AAA')--	611E "VERSAMENTO IVA MENSILE NOVEMBRE"
	insert into #tributi values ('F','6012',null, null,'AAA')--	612E "VERSAMENTO IVA MENSILE DICEMBRE"

	insert into #tributi values ('F','6013',null, null,'AAAA')-- 613E	VERSAMENTO ACCONTO PER IVA MENSILE
	insert into #tributi values ('F','6031',null, null,'AAAA')-- 614E	VERSAMENTO IVA TRIMESTRALE 1 TRIMESTRE
	insert into #tributi values ('F','6032',null, null,'AAAA')-- 615E	VERSAMENTO IVA TRIMESTRALE 2 TRIMESTRE
	insert into #tributi values ('F','6033',null, null,'AAAA')-- 616E	VERSAMENTO IVA TRIMESTRALE 3 TRIMESTRE
	insert into #tributi values ('F','6034',null, null,'AAAA')-- 617E	VERSAMENTO IVA TRIMESTRALE 4 TRIMESTRE 
	insert into #tributi values ('F','6035',null, null,'AAAA')-- 618E	VERSAMENTO IVA ACCONTO  
	insert into #tributi values ('F','6099',null, null,'AAAA')-- 619E	VERSAMENTO IVA SULLA BASE DELLA DICHIARAZIONE ANNUALE
	insert into #tributi values ('F','6040',null,'00MM','AAAA')-- 620E	SPLIT ISTITUZIONALE
	insert into #tributi values ('F','6041',null,'00MM','AAAA')-- 621E	SPLIT COMMERCIALE
	insert into #tributi values ('F','6043',null,'00MM','AAAA')-- 622E	INTRA 12
	insert into #tributi values ('F','8904',null, null,'AAAA')-- 801E	SANZIONE PECUNIARIA IVA
	insert into #tributi values ('F','9399',null,null,'AAAA')-- 901E	REGOLARIZZAZIONE OPERAZIONI SOGGETTE AD IVA IN CASO DI MANCATA/ IRREGOLARE FATTURAZ.
	...
	create table #f24 (
		...
		estremi varchar(17),
		riferimentoA	varchar(10),			--Rateazione/Regione/Provincia/mese rif./Periodo rif. da : dipende dal codice Tributo
		riferimentoB	varchar(10),			--Rateazione/anno di riferimento/Periodo rif. a : dipende dal codice Tributo
...
declare @matricolaInpsF24 varchar(17)
select @matricolaInpsF24 =
case when DATALENGTH(ISNULL(matricolainpsf24,''))<=17
				then SUBSTRING(REPLICATE('',17), 1, 17 - DATALENGTH(ISNULL(matricolainpsf24,'')))+ ISNULL(matricolainpsf24,'')
		else space(17)
		end	
  ...
  insert into #f24 (tiporecord, declaration_on_behalf_of, cf_contributor)
	...
	begin
	 ...
	 select 
		...
		codicetributo, 
		codice, estremi,
		case when tiporiga='I' and  (DATALENGTH(ISNULL(riferimentoA,''))<=6) /* INPS, len = 6*/ 
				then SUBSTRING(REPLICATE('0',6),1,6 - DATALENGTH(ISNULL(riferimentoA,'')))+ ISNULL(riferimentoA,'')
			 when tiporiga in ('R','S') and  (DATALENGTH(ISNULL(riferimentoA,'')) <= 4) /* REGIONI,IMU e altri tributi locali ==> len = 4*/
		...
		codiceatto	,
		--> Sezione INPS(I)
		case when tiporiga='I' then @codicesedeINPS else null end as codicesedeINPS,
		case when tiporiga='I' then @matricolaInpsF24 else null end as matricolaInpsF24,
		...
		identificativooperazione,
		codiceente_provincia_comune ,
		isnull(ravvedimentooperoso,0) as ravvedimentooperoso,
		isnull(immobilivariati,0) as immobilivariati	,
		case when accontosaldo ='A' then 1 else	0 end as acconto,
		case when accontosaldo ='S' then 1 else	0 end as saldo,
		
		SUBSTRING(REPLICATE('0',3),1,3 - DATALENGTH(convert(varchar(3), isnull(numeroimmobili, 0))))+ convert(varchar(3), isnull(numeroimmobili, 0))
		as numeroimmobili,
		isnull(detrazioneabitazione,0) as detrazioneabitazione,

		--> Sezione INAIL(N)
		isnull(codicesedeinail,replicate('0',5)) as codicesedeinail,
		isnull(codiceditta,replicate('0',8)) as 	codiceditta,
		isnull(cc_codiceditta,replicate('0',2)) as cc_codiceditta,
		ISNULL(numerodiriferimento,replicate('0',6)) as numerodiriferimento,
		isnull(causaleinail, 'X') as causaleinail	,
		
		-->Sezione Altri Enti previdenziali ed assicurativi(A)
		isnull(idaltrienti,REPLICATE('0',4)) as idaltrienti ,
		idcodicesedealtrienti,
		isnull(codiceposizione,	REPLICATE('0',9)) as codiceposizione
	from #f24 
