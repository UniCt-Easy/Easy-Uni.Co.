...
if exists (select * from dbo.sysobjects where id = object_id(N'[trasmele_expense_carimenew_ins]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [trasmele_expense_carimenew_ins]
GO
...
CREATE        PROCEDURE [trasmele_expense_carimenew_ins]
(
	@y int,
	@n int
)
AS BEGIN
--
--[trasmele_expense_carimenew_ins] 2015,3
--------------------------------------------------------------
