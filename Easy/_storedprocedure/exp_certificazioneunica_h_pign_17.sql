...
if exists (select * from dbo.sysobjects where id = object_id(N'exp_certificazioneunica_h_pign_17') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure exp_certificazioneunica_h_pign_17 
GO
...
--exec exp_certificazioneunica_h_pign_17 212,1, 'S', @inserito out
--select @newProg
CREATE PROCEDURE exp_certificazioneunica_h_pign_17
...
----------------------------------al prospetto SY del mod. 770/2017 semplificato ----------------------
-------------------------------------------------------------------------------------------------------
...
-- RECORD DI TIPO "H": Casi particolari operazioni straordinarie
	...
	--2017	AU	101	Codice Fiscale debitore   principale
	--2017	AU	102	Somme erogate
	--2017	AU	103	Ritenute operate
	--2017	AU	104	Somme erogate non tassate
	--2017	AU	105 Codice Fiscale debitore   principale
	--2017	AU	106	Somme erogate
	--2017	AU	107	Ritenute operate
	--2017	AU	108	Somme erogate non tassate
