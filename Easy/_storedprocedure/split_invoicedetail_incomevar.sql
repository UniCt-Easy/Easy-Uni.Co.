...
CREATE           PROCEDURE [split_invoicedetail_incomevar]
(
	@ayear int 
)
AS
...
SELECT COUNT(DISTINCT incomevar.idinc),invoice.idinvkind,invoice.yinv,invoice.ninv
FROM invoice 
JOIN invoicedetail
...
HAVING COUNT(DISTINCT incomevar.idinc) >1	
