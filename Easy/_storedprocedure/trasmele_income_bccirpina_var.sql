...
if exists (select * from dbo.sysobjects where id = object_id(N'[trasmele_income_bccirpina_var]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [trasmele_income_bccirpina_var]
GO
...
CREATE  PROCEDURE [trasmele_income_bccirpina_var]
(
	@y int,
	@n int
)
...
(
	yproceedstransmission, nproceedstransmission, kpro, ydoc, ndoc, idinc, 
...
-- Partita Iva estera
	...
	END,
	c.ccp,
	null,-- destinazione non utilizzato
	null,-- tipo_entrata non utilizzato
