...
if exists (select * from dbo.sysobjects where id = object_id(N'[esporta_rivalutazioni_positive_ente]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [esporta_rivalutazioni_positive_ente]
GO
...
CREATE         PROCEDURE [esporta_rivalutazioni_positive_ente]
@year			int,
...
-------------------------------------------------------------------------------------
	...
	WHERE  
		...
		AND inventoryamortization.flag&2 = 1
