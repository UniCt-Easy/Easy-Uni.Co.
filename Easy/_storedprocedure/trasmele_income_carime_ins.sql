...
--setuser 'amm' 
if exists (select * from dbo.sysobjects where id = object_id(N'[trasmele_income_carime_ins]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [trasmele_income_carime_ins]
GO
...
CREATE        PROCEDURE [trasmele_income_carime_ins]
(
	@y int,
	@n int
)
...
SELECT
	...
	SUM(#proceeds.curramount_expense),
