...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_certificazioneunica_percipienti_h_26]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_certificazioneunica_percipienti_h_26]
GO
 --setuser'amministrazione'
--exec exp_certificazioneunica_percipienti_h_24  TSSNLS78S53D976S
CREATE PROCEDURE [exp_certificazioneunica_percipienti_h_26]
(
	@cf varchar(20)
 )
 -- estraggo l'elenco dei percipienti, autonomi, che hanno eseguito prestazioni mappate con il Record H
 -- dal 2020 aggiungo anche i percipienti (creditori pignoratizi) che hanno beneficiato di somme in virt di pignoramenti 
...
select distinct #expense2025.idreg from #expense2025

SELECT * FROM #percipienti_record_H_2025
