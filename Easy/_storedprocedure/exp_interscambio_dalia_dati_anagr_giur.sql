...
exec exp_interscambio_dalia_dati_anagr_giur 2020, {ts '2020-09-01 00:00:00'},  {ts '2020-09-30 00:00:00'} 
*/
BEGIN
...
SELECT DISTINCT
	...
	SUBSTRING(R.forename,1,30),				--COGNOME			,	  PIC X(30). Cognome del dipendente.
	SUBSTRING(R.surname,1,30),				--NOME				,     PIC X(30). Nome del dipendente.
...
SELECT
	...
	[dbo].[GetStringFormatted_r](CONVERT(VARCHAR(8),DATAIMMQUA,112),8)     +  -- PIC 9(08). Data dell'ultima variazione di classe, scatto o qualifica COD-QUA
								 ...
								 --"Ricercatore non confermato" a "Ricercatore non confermato dopo un anno").
								 --(Sostituisce: Data dell'ultima variazione di inquadramento, classe, scatto o qualifica). Formato: AAAAMMGG.
	[dbo].[Getint](CAUIMM,2)				+  -- X(02).Codice causale di immissione nell’ente.
	[dbo].[Getint](CAUIMMQUALIFICA,2)		+  -- PIC X(02).Codice causale di immissione nella qualifica.
