...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_electronicinvoiceriepilogo_estere]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_electronicinvoiceriepilogo_estere]
GO
...
CREATE procedure exp_electronicinvoiceriepilogo_estere(
	@yinv int,
	@ninv int,
	@idinvkind int
) as
begin
-- exec exp_electronicinvoiceriepilogo_estere 2019, 127
