...
if exists (select * from dbo.sysobjects where id = object_id(N'[rpt_newbilconsuntivo_cassa_comp_residui_riep]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [rpt_newbilconsuntivo_cassa_comp_residui_riep]
GO
...
--setuser 'amm'
--rpt_newbilconsuntivo_cassa_comp_residui_riep 2005,'2005-12-31','S','3','0001','S','S','S','S','S'
--rpt_bilconsuntivo_cassa_comp_residui_riep 2005,'31-12-2005','S','3','0001','S','S','S','S','S'

CREATE        PROCEDURE [rpt_newbilconsuntivo_cassa_comp_residui_riep]
(
	@ayear int,
	@date datetime,
	@finpart char(1),
...
BEGIN
	...
	(
		select 					
			...
			---prevision_diff_cassa =  
			ISNULL(SUM(secondaryprev),0) + 	 	ISNULL(SUM(varprev_s_acc),0) - 	ISNULL(SUM(varprev_s_red),0) -
