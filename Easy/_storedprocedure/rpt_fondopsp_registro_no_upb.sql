...
-- rpt_fondopsp_registro_no_upb  2009, 5,  {ts '2009-01-01 00:00:00'}, {ts '2009-12-31 00:00:00'}
...
DECLARE cursore CURSOR FORWARD_ONLY for 
	...
	UPDATE 	#pettycashreg set
	  detail = isnull(detail,'') + isnull(convert(varchar(10),@noperation),'') + ', '
...
ORDER BY idpettycash, adate, noperation
 ...
 --exec rpt_fondopsp_registro 2009, 1, 'S','%', 'S',{ts '2009-01-01 00:00:00'}, {ts '2009-12-16 00:00:00'}
