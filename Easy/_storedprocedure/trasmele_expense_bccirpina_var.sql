...
if exists (select * from dbo.sysobjects where id = object_id(N'[trasmele_expense_bccirpina_var]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [trasmele_expense_bccirpina_var]
GO
...
CREATE        PROCEDURE [trasmele_expense_bccirpina_var]
(
	@y int,
	@n int
)
