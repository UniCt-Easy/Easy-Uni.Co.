...
if exists (select * from dbo.sysobjects where id = object_id(N'[rpt_sit_residui_per_anno_riep_dett]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [rpt_sit_residui_per_anno_riep_dett]
GO
...
CREATE   PROCEDURE [rpt_sit_residui_per_anno_riep_dett]
	@ayear 		int,
	@date		datetime,
	@finpart 	char(1),
	@levelusable 	tinyint,
...
UPDATE #report_residual SET codefin = fin.codefin ,
...
FROM #report_residual
GROUP BY finprintingorder,
ayear,codefin,idfin,fin
