...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_certificazioneunica_b_26]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_certificazioneunica_b_26]
GO
...
create PROCEDURE [exp_certificazioneunica_b_26]
(
	@numdichquadrog int,
	@numdichquadroh int,
