...
if exists (select * from dbo.sysobjects where id = object_id(N'[show_upbannual_comp]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [show_upbannual_comp]
GO
...
CREATE      PROCEDURE [show_upbannual_comp]
	@date datetime,
	@idupb varchar(36)
AS BEGIN
	DECLARE @ayear int
	...
	SELECT @usablelevel = MIN(nlevel) FROM finlevel 	
	...
	CREATE TABLE #competency_income	(nphase varchar(20) NULL,total decimal(19,2) NULL)
	...
	CREATE TABLE #competency_expense(nphase varchar(20) NULL,total decimal(19,2) NULL)
	...
	CREATE TABLE #arrear_income(nphase varchar(20) NULL,total decimal(19,2) NULL)
	...
	CREATE TABLE #arrear_expense(nphase varchar(20) NULL,total decimal(19,2) NULL)
	...
	CREATE TABLE #competency_incomevar(	nphase varchar(20) NULL,total decimal(19,2) NULL)
	...
	CREATE TABLE #competency_expensevar(nphase varchar(20) NULL,total decimal(19,2) NULL)
	...
	CREATE TABLE #arrear_incomevar(	nphase varchar(20) NULL,total decimal(19,2) NULL)
	...
	CREATE TABLE #arrear_expensevar(nphase varchar(20) NULL,total decimal(19,2) NULL)
			...
			BEGIN
				...
				IF(@nphase = @maxincomephase)
						BEGIN
							...
							ISNULL(@arrears_tot,0)-     -- sono il tot delle reversali residue perchè siamo nell'ulima fase
...
-- Crediti
	...
	BEGIN
		...
		BEGIN
			...
			INSERT INTO #situation VALUES ('Assegnazioni', @totalcreditpart, '')
