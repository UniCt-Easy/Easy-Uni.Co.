...
if exists (select * from dbo.sysobjects where id = object_id(N'[rpt_sitbilancio_respons_spesa_2fasi]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [rpt_sitbilancio_respons_spesa_2fasi]
GO
...
CREATE  PROCEDURE [rpt_sitbilancio_respons_spesa_2fasi]
	@ayear			int,
	@nlevel			tinyint,
	@hierarchy		char(1),
	@idman			int,
...
BEGIN
 ...
 /*	exec rpt_sitbilancio_respons_spesa_2fasi 2013, 3, 'N', null, '%', 'N', 'N', 'N', null,{ts '1900-12-31 00:00:00'},{ts '2012-12-31 00:00:00'}, null,null,null,null,null	*/
...
BEGIN
	SELECT @fin_phase = expensefinphase
	FROM uniconfig
END
...
JOIN manager 
	ON upb.idman = manager.idman
		...
		left outer join finlink fl4 on fl4.idchild=#fin_situation.idfin and fl4.nlevel=4
		left outer join finlink fl5 on fl5.idchild=#fin_situation.idfin and fl5.nlevel=5
GROUP BY upb.idman,manager.title, #fin_situation.idupb,upb.codeupb, upb.title,upb.printingorder,
		#fin_situation.idfin, fin.codefin,fin.title,fin.printingorder,#fin_situation.nlevel,
		flag_assign_credit,flag_assign_cash,
