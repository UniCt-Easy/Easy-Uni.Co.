...
if exists (SELECT * from dbo.sysobjects where id = object_id(N'[exp_modello770_11_g]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_modello770_11_g]
GO
...
CREATE  PROCEDURE [exp_modello770_11_g] (@modello varchar(10))
AS BEGIN
-- exec exp_modello770_11_g '770'
-- exec exp_modello770_11_g 'CUD'
-- OK
	...
	set @annodichiarazione = 2011

	declare @annoredditi int
	set @annoredditi = 2010
	-- Ricordarsi di cambiare ogni anno l'anno delle date
	declare @1gen10_XXX datetime
	set @1gen10_XXX = dateadd(yy, @annoredditi-2000, {d '2000-01-01'})

	declare @13gen10_XXX datetime
	set @13gen10_XXX = dateadd(yy, @annoredditi-2000, {d '2000-01-13'})

	declare @31dic10_XXX datetime
	set @31dic10_XXX = dateadd(yy, @annoredditi-2000, {d '2000-12-31'})

	declare @1gen11_XXX datetime
	set @1gen11_XXX = dateadd(yy, @annodichiarazione-2000, {d '2000-01-01'})

	declare @12gen11_XXX datetime
	set @12gen11_XXX = dateadd(yy, @annodichiarazione-2000, {d '2000-01-12'})
...
*/
	...
	-- Esempi:
	-- @wb1RedditoDedArt11_MOD significa che questa variabile è valorizzata nel ramo delle prestazioni inserite
	...
	declare
		...
		@a12comune01gen2010  varchar(50),
		@a13prov01gen2010  varchar(2),
		@a14codicecomune01gen2010  varchar(10),
		@a15comune31dic2010  varchar(50),
		@a16prov31dic2010  varchar(2),
		@a17comune01gen2011  varchar(50),
		@a18prov01gen2011  varchar(2),
		@a19codiceComune01gen2011  varchar(10),

		@wb1RedditoDedArt11_MOD decimal(19,2),		--Redditi per i quali è possibile fruire della detrazione di cui all’art. 13, commi 1, 2, 3 e 4 del Tuir
		@wb3workingdays int,					--Lavoro dipendente
		@wb5ritIRPEF_MOD decimal(19,2),				--Pensione
		@wb6add_reg_MOD decimal(19,2),				--Addizionale regionale all’Irpef
		@wb10addcomacconto2010  decimal(19,2),		--Addizionale regionale @annoredditi trattenuta nel @annodichiarazione
		@wb11addcomsaldo2010  decimal(19,2),		--Saldo @annodichiarazione
		@wb13addcomacconto2011  decimal(19,2),		--Acconto 2010
		@wb33impostalorda  decimal(19,2),		--Imposta lorda
		@wb41detrazioniperoneri_MOD  decimal(19,2),	--b21 Detrazioni per oneri

		@wb46totaledetrazioni_MOD  decimal(19,2),	--b Totale Detrazioni

		@wb59deductionart10_MOD  decimal(19,2),		--b58 Totale oneri sostenuti esclusi dai redditi indicati nei punti 1 e 2
		@wb60oneridetraibili_MOD  decimal(19,2),		--b59 Totale oneri per i quali è prevista la detrazione d’imposta
		@wb64maggioreritenuta_MOD  varchar(10),		--Applicazione maggiore ritenuta
		...
		@wb256_ai varchar(100),						-- Variabile che contiene la nota AI
		@wb257_aj varchar(100),						-- Variabile che contiene la nota AJ
		...
		@wc8start_MOD datetime,						--c81 Data inizio
		@wc86stop_MOD datetime,							--c82 Data fine
		...
		@zb10addcomacconto2010 decimal(19,2),			--b10 Acconto @annodichiarazione
		@zb11addcomsaldo2010 decimal(19,2),			--b11 Saldo @annodichiarazione
		@zb13addcomacconto2011 decimal(19,2),			--b13 Acconto 2010
		...
		@zb34ImpostaLorda_MOD  decimal(19,2),		--b33 Imposta lorda
		@zb35detrazionipercarichifamiliari_MOD  decimal(19,2),	--b34 Detrazioni per oneri
		@zb40detrazioniperreddito_MOD  decimal(19,2),			--b39 Detrazioni per oneri
		@zb41detrazioniperoneri_MOD  decimal(19,2),				--b40 Detrazioni per oneri
		@zb46totaledetrazioni_MOD  decimal(19,2),				--b45 Totale Detrazioni 
		@zb59deductionart10_MOD  decimal(19,2),					--b58 Totale oneri sostenuti esclusi dai redditi indicati nei punti 1 e 2
		@zb60oneridetraibili_MOD  decimal(19,2),					--b59 Totale oneri per i quali è prevista la detrazione d’imposta
		@zb64maggioreritenuta_MOD  varchar(10),					--b63 Applicazione maggiore ritenuta
		@zb50altriredditi decimal(19,2),					--b40 Altri redditi				>>>> NON LO USA, sara
		@zb77totaleredditiconguagliato_MOD  decimal(19,2),	--b73 Totale redditi conguagliato già compreso nel punto 1
		@zb78cudcodfisc_MOD varchar(16),						--b47 Codice fiscale			
		@zb81cudimpfisclordo_MOD decimal(19,2),					--b50 Reddito conguagliato		
		@zb83cudirpef_MOD decimal(19,2),						--b51 Ritenute					
		@zb84cudirpefsosp_MOD decimal(19,2),					--b52 Ritenute sospese			
		@zb87cudaddreg_MOD decimal(19,2),						--b53 Addizionale regionale		
		@zb88cudaddregsosp_MOD decimal(19,2),					--b54 Addizionale regionale sospesa						
		@zb89cudaddcomacconto_MOD decimal(19,2),				--b55 Addizionale comunale acconto @annodichiarazione	
		@zb90cudaddcomsaldo_MOD decimal(19,2),					--b55 Addizionale comunale saldo @annodichiarazione		
		@zb91cudaddcomsosp_MOD decimal(19,2),					--b56 Addizionale comunale sospesa						
		@zb245_ai varchar(100),			-- Variabile che contiene la nota AI
		@zb257_aj varchar(100),			-- Variabile che contiene la nota AJ
		...
		@zb271_ax varchar(100),			-- Variabile che contiene la nota AX
		...
		@zc84patcode_MOD varchar(10),				--c80 Posizione assicurativa territoriale		
		@zc82start datetime,					--c81 Data inizio								>>>> NON LO USA, sara
		@zc83stop datetime,						--c82 Data fine									>>>> NON LO USA, sara
		@zc87codiceComuneEnte_MOD varchar(4)		--c83 Codice comune							
	...
	where transmissiondate between @13gen10_XXX and @12gen11_XXX
...
-- FINE PRELIEVO DATI DA expensetax
	...
	create table #coniuge (
		idconiuge int,
		b297codiceFiscaleConiuge_MOD varchar(16),
		b298numeroMesiACarico_MOD int,
		bXXXanno int
	)
	...
	create table #primoFiglio (
		idPrimoFiglio int,
		b299casellaPrimoFiglio_MOD int,
		b300casellaDisabile_MOD int, 
		b301codiceFiscalePrimoFiglio varchar(16),
		b302numeroMesiACarico_MOD int, 
		b303minoreDiTreAnni int,
		bC04percentualeDiDetrazioneSpettante_MOD dec(19,6),
		bD04detrazionePerConiugeACarico_MOD char,
		bYYYanno int
	)
	...
	create table #altroFiglio (
		idAltroFiglio int,
		b305casellaFiglio_MOD int,
		b306casellaAltroFamiliare_MOD int,
		b307casellaDisabile_MOD int,
		b308codiceFiscaleFamiliare_MOD varchar(16),
		b309numeroMesiACarico_MOD int,
		b310minoreDiTreAnni_MOD int, 
		bc11percentualeDiDetrazioneSpettante_MOD dec(19,6),
		bd11detrazionePerConiugeACarico_MOD char,
		bZZZAnno int
	)
...
/*		SELECT distinct idcon, tipo='C', surname from #modulocococo
	...
	begin
		...
		set @a12comune01gen2010  = null
		set @a13prov01gen2010  = null
		set @a14codicecomune01gen2010  = null
		set @a15comune31dic2010  = null
		set @a16prov31dic2010  = null
		set @a17comune01gen2011  = null
		set @a18prov01gen2011  = null
		set @a19codiceComune01gen2011  = null

		set @wb1RedditoDedArt11_MOD = null
		set @wb3workingdays = null
		set @wb5ritIRPEF_MOD = null
		set @wb6add_reg_MOD = null
		set @wb10addcomacconto2010  = null
		set @wb11addcomsaldo2010  = null
		set @wb13addcomacconto2011  = null
		set @wb33impostalorda  = null
		set @wb41detrazioniperoneri_MOD  = null
        set @wb46totaledetrazioni_MOD  = null
		set @wb59deductionart10_MOD  = null
		set @wb60oneridetraibili_MOD  = null
		set @wb64maggioreritenuta_MOD  = null
		...
		set @wc8start_MOD = null
		set @wc86stop_MOD = null

		set @zb1RedditoDedArt11 = null
		set @zb3workingdays = null
		set @zb5ritIRPEF = null
		set @zb6add_reg = null
		set @zb10addcomacconto2010 = null
		set @zb11addcomsaldo2010 = null
		set @zb13addcomacconto2011 = null

		SET @zb21primaratairpef_caf = NULL
		SET @zb22secondaratairpef_caf = NULL

		set @zb34ImpostaLorda_MOD  = null
		set @zb35detrazionipercarichifamiliari_MOD  = null
		set @zb40detrazioniperreddito_MOD  = null
		set @zb41detrazioniperoneri_MOD  = null
		set @zb46totaledetrazioni_MOD  = null
		set @zb59deductionart10_MOD  = null
		set @zb60oneridetraibili_MOD  = null
		set @zb64maggioreritenuta_MOD  = null
		set @zb50altriredditi = null
		set @zb77totaleredditiconguagliato_MOD  = null
		set @zb78cudcodfisc_MOD = null
		set @zb81cudimpfisclordo_MOD = null
		set @zb83cudirpef_MOD = null
		set @zb84cudirpefsosp_MOD = null
		set @zb87cudaddreg_MOD = null
		set @zb88cudaddregsosp_MOD = null
		set @zb89cudaddcomacconto_MOD = null
		set @zb90cudaddcomsaldo_MOD = null
		set @zb91cudaddcomsosp_MOD = null
		SET @zb245_ai = NULL
		SET @zb257_aj = NULL
		SET @zb249_am = NULL
		SET @zb254_ar = NULL
		...
		set @zc84patcode_MOD = null
		set @zc82start = null
		set @zc83stop = null
		set @zc87codiceComuneEnte_MOD = null
	
		-- Inizio Sezione azzeramento variabili

		SELECT @zc87codiceComuneEnte_MOD = value from geo_city_agency 
...
--		SELECT  @idresidence01gen09  = idresidence, @ayear = ayear from parasubcontractyear where idcon = @chiave and ayear = @annoredditi
		...
		begin
			...
			DECLARE @start01gen2010_YYY  datetime
			exec trovaIndirizzo770 @idreg, @1gen10_XXX, @idaddresskind01gen09  OUTPUT, @start01gen2010_YYY  OUTPUT
			...
			SELECT @idresidence01gen09  = idcity 
				...
				AND registryaddress.start = @start01gen2010_YYY 
		end
		...
		SELECT
			@a12comune01gen2010  = geo_city.title,
			@a13prov01gen2010  = 
			CASE 
				...
				ELSE geo_country.province 
			END,
			@a14codicecomune01gen2010  = geo_city_agency.value
		FROM geo_city
		...
		declare @idresidence31dic2010_YYY  int
		set 	@idresidence31dic2010_YYY  = null
		-- J.T.R. Commentiamo in quanto non lavoriamo più per contratto ma per percipiente.
		-- L'IF di sotto sarà sempre vero, in effetti si potrebbe togliere l'if a questo punto.
--		SELECT  @idresidence31dic2010_YYY  = idresidence from parasubcontractyear where idcon = @chiave and ayear = @annoredditi
		...
		if ((@idresidence31dic2010_YYY  is null) OR (ISNULL(@ayear, @annoredditi) > 2010))
		begin
			DECLARE @idaddresskind31dic2010_YYY  int
			DECLARE @start31dic2010_YYY  datetime
			...
			if (ISNULL(@stop,@31dic10_XXX) < @31dic10_XXX)
			begin
				exec trovaIndirizzo770 @idreg, @stop, @idaddresskind31dic2010_YYY  OUTPUT, @start31dic2010_YYY  OUTPUT
			end 
			else
			begin
				exec trovaIndirizzo770 @idreg, @31dic10_XXX, @idaddresskind31dic2010_YYY  OUTPUT, @start31dic2010_YYY  OUTPUT
			end
	
			SELECT @idresidence31dic2010_YYY  = idcity 
				FROM registryaddress
				where registryaddress.idreg = @idreg
				AND registryaddress.idaddresskind = @idaddresskind31dic2010_YYY 
				AND registryaddress.start = @start31dic2010_YYY 
		end
	
		-- Si attualizza il comune di residenza all'31 dicembre (o data di cessazione del rapporto)
		WHILE (SELECT newcity from geo_city where idcity=@idresidence31dic2010_YYY ) is not null
		BEGIN
			SELECT @idresidence31dic2010_YYY =newcity from geo_city where idcity=@idresidence31dic2010_YYY  
		END
	
		-- Si determinano il nome del comune e della provincia di residenza, tenendo sempre conto dell'eccezione
		-- inerente la costituenda provincia BT (come per la provincia di nascita).
		SELECT
			@a15comune31dic2010  = geo_city.title,
			@a16prov31dic2010  = 
			case 
				WHEN @idresidence31dic2010_YYY  in (13935, 13936, 13937, 13938, 13940, 13942, 13943) THEN 'BA'
				WHEN @idresidence31dic2010_YYY  in (13939, 13941, 13944) THEN 'FG'
				ELSE geo_country.province 
			end
		FROM geo_city
		LEFT OUTER JOIN geo_country
			on geo_city.idcountry = geo_country.idcountry
		where geo_city.idcity = @idresidence31dic2010_YYY 
	
		declare @idresidence01gen2011_YYY  int
		set  	@idresidence01gen2011_YYY  = null
		set  	@ayear = null
		-- J.T.R. Commentiamo in quanto non lavoriamo più per contratto ma per percipiente.
		-- L'IF di sotto sarà sempre vero, in effetti si potrebbe togliere l'if a questo punto.
--		SELECT @idresidence01gen2011_YYY  = idresidence, @ayear = ayear from parasubcontractyear where idcon = @chiave and ayear = @annodichiarazione
		...
		-- dell'indirizzo.
		-- A questo punto si può interrogare la tabella REGISTRYADDRESS filtrando per idreg, idaddresskind e start (la chiave!)
		if ((@idresidence01gen2011_YYY  is null) OR (ISNULL(@ayear,@annodichiarazione) > 2009))
		begin
			DECLARE @idaddresskind01gen2011_YYY  int
			DECLARE @start01gen2011_YYY datetime
			exec trovaIndirizzo770 @idreg, @1gen11_XXX, @idaddresskind01gen2011_YYY  OUTPUT, @start01gen2011_YYY OUTPUT
	
			SELECT @idresidence01gen2011_YYY  = idcity 
				FROM registryaddress
				where registryaddress.idreg = @idreg
				AND registryaddress.idaddresskind = @idaddresskind01gen2011_YYY 
				AND registryaddress.start = @start01gen2011_YYY
		end

		-- Si attualizza il comune di residenza all'1 gennaio dell'anno della dichiarazione (o data di cessazione del rapporto)	
		WHILE (SELECT newcity from geo_city where idcity=@idresidence01gen2011_YYY ) is not null
		BEGIN
			SELECT @idresidence01gen2011_YYY =newcity from geo_city where idcity=@idresidence01gen2011_YYY  
		END

		-- Si determinano il nome del comune e della provincia di residenza, tenendo sempre conto dell'eccezione
		-- inerente la costituenda provincia BT (come per la provincia di nascita).	
		if (@idresidence01gen2011_YYY  != @idresidence31dic2010_YYY )
		begin
			SELECT
				@a17comune01gen2011  = geo_city.title,
				@a18prov01gen2011  = 
				case 
					WHEN @idresidence01gen2011_YYY  in (13935, 13936, 13937, 13938, 13940, 13942, 13943) THEN 'BA'
					WHEN @idresidence01gen2011_YYY  in (13939, 13941, 13944) THEN 'FG'
					ELSE geo_country.province 
				end,
				@a19codiceComune01gen2011  = geo_city_agency.value
				FROM geo_city
				LEFT OUTER JOIN geo_country
					on geo_city.idcountry = geo_country.idcountry
				LEFT OUTER JOIN geo_city_agency 
					on geo_city.idcity=geo_city_agency.idcity and geo_city_agency.idagency = 1 and geo_city_agency.idcode = 1
				where geo_city.idcity = @idresidence01gen2011_YYY 
		end
	...
	--Dati relativi al dipendente, pensionato o altro percettore delle somme
		...
		--DA001012 Comune
		INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DA', 1, '012', @a12comune01gen2010 )
		--DA001013 Provincia (sigla)
		INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DA', 1, '013', @a13prov01gen2010 )
		--DA001014 Codice comune
		INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DA', 1, '014', @a14codicecomune01gen2010 )
		--DA001015 Comune
		INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DA', 1, '015', @a15comune31dic2010 )
		--DA001016 Provincia (sigla)
		INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DA', 1, '016', @a16prov31dic2010 )
		--DA001017 Comune
		INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DA', 1, '017', @a17comune01gen2011 )
		--DA001018 Provincia (sigla)
		INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DA', 1, '018', @a18prov01gen2011 )
		--DA001019 Codice comune
		INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DA', 1, '019', @a19codiceComune01gen2011 )
...
--			SELECT  @idpayroll=idpayroll from #modulocococo where idcon=@chiave
			...
			SELECT @zb1RedditoDedArt11 = ISNULL(SUM(taxablegross),0),
				@zb34ImpostaLorda_MOD  = ISNULL(SUM(employtaxgross),0)
			FROM payrolltax cr
			JOIN #contratti
			...
			SET @zb35detrazionipercarichifamiliari_MOD  =
			ISNULL(
			...
			SET @zb40detrazioniperreddito_MOD  =
			ISNULL(
				(SELECT SUM(payrollabatement.curramount)
				FROM payrollabatement
				JOIN #contratti
			...
			SET @zb41detrazioniperoneri_MOD  =
			ISNULL(
				(SELECT SUM(payrollabatement.curramount)
				FROM payrollabatement
				JOIN #contratti
			...
			SET @zb46totaledetrazioni_MOD  = @zb35detrazionipercarichifamiliari_MOD  + @zb40detrazioniperreddito_MOD  + @zb41detrazioniperoneri_MOD 
			...
			SELECT @zb11addcomsaldo2010  = @zb11addcomsaldo2010 - @zb10addcomacconto2010   
			...
			if @zb11addcomsaldo2010 < 0
			begin
				set @zb10addcomacconto2010 = @zb10addcomacconto2010 + @zb11addcomsaldo2010
				set @zb11addcomsaldo2010 = null
			end
			else
			begin
				if @zb10addcomacconto2010 < 0
				begin
					set @zb11addcomsaldo2010 = @zb11addcomsaldo2010 + @zb10addcomacconto2010
					set @zb10addcomacconto2010 = null
				end
			end
	
			-- Calcolo inutile, si lascia se si dovesse in futuro produrre il record SS
			set @SS002009 = isnull(@SS002009,0) + isnull(@zb10addcomacconto2010, 0)
	...
	--					from parasubcontractyear where idcon=@chiave and ayear=@annoredditi
			...
			BEGIN
				...
				BEGIN
					...
					INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '010', @zb10addcomacconto2010)
					--DB001011 Addizionale comunale all'Irpef - Saldo @annodichiarazione
					INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '011', @zb11addcomsaldo2010)
					--DB001013 Addizionale comunale all'Irpef - Acconto 2010
					INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '013', @zb13addcomacconto2011)
					...
					--DB001034 Imposta lorda
					INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '034', @zb34ImpostaLorda_MOD )
					--DB001035 Detrazioni per carichi familiari
					INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '035', @zb35detrazionipercarichifamiliari_MOD )
					--DB001040 Detrazioni per reddito
					INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '040', @zb40detrazioniperreddito_MOD )
					--DB001041 Detrazioni per oneri
					INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '041', @zb41detrazioniperoneri_MOD )
					--DB001046 Totale Detrazioni 
					INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '046', @zb46totaledetrazioni_MOD )
					--DB001059 Totale oneri sostenuti esclusi dai redditi indicati nei punti 1 e 2
					INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '059', @zb59deductionart10_MOD )
					--DB001060 Totale oneri per i quali è prevista la detrazione d'imposta
					INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '060', @zb60oneridetraibili_MOD )
					--DB001064 Applicazione maggiore ritenuta
					INSERT INTO #recordg (progr, quadro, riga, colonna, intero) VALUES(@progrComunic, 'DB', 1, '064', @zb64maggioreritenuta_MOD )

					-- Nota AL: Tale nota viene valorizzata solo se sono state pagate addizionali (regionali o comunali)
					IF (@zb6add_reg <> 0) OR (@zb10addcomacconto2010 <> 0) OR (@zb11addcomsaldo2010 <> 0)
					BEGIN
						--DBXXX259 Questa annotazione è una costante infatti riteniamo sempre le addizionali a fine anno in fase di conguaglio.
						--DB001259 Nota AL
						INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DB', 1, '259', 'AL')
						--DB002259 Testo Nota AL
						INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DB', 2, '259',
					...
					SET @zb77totaleredditiconguagliato_MOD  =
					ISNULL(
					...
					VALUES(@progrComunic, 'DB', 1, '077', @zb77totaleredditiconguagliato_MOD )--Totale redditi conguagliato già compreso nel punto 1
				END
			END
			...
			-- DBXXX260 [Nota AM] (Nota inerente i rimborsi da C.A.F.)
			IF ((@refund_irpefcaf < 0) OR (@refund_addregcaf < 0) OR (@refund_addcomcaf < 0))
			BEGIN
				-- DB001260
				INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DB', 1, '260', 'AM')
				DECLARE @j int
				SET @j = 2
				...
				BEGIN
					-- DB002260
					INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DB', @j, '260',
			...
			BEGIN
				...
				BEGIN
					...
					-- DB001261
					INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DB', 1, '261', 'AN')
					-- DB002261
					INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DB', 2, '261',
						'La detrazione minima è stata ragguagliata al periodo di lavoro, il percipiente può fruire della')
					-- DB003261
					INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DB', 3, '261',
						' detrazione per l''intero anno in sede di dichiarazione dei redditi, sempreché non sia stata già')
					-- DB004261
					INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DB', 4, '261',
			...
			BEGIN
				...
				BEGIN
					...
					BEGIN
						...
						BEGIN
							INSERT INTO #recordg (progr, quadro, riga, colonna, stringa)
							VALUES(@progrComunic, 'DB', 1, '267', 'AT')
						...
						BEGIN
                            ...
                            SET @atcount = @atcount + 1
							INSERT INTO #recordg (progr, quadro, riga, colonna, stringa)
							VALUES(@progrComunic, 'DB', @atcount, '267', @zb256_at)
					...
					BEGIN
						...
						BEGIN
							INSERT INTO #recordg (progr, quadro, riga, colonna, stringa)
							VALUES(@progrComunic, 'DB', 1, '273', 'AZ')
						...
						BEGIN
							SET @zb262_az = @codeabatement + ' ' + @descrabatement + ' ' + CONVERT(varchar(16), @gross_amount)
                                                        ...
                                                        SET @azcount = @azcount + 1
							INSERT INTO #recordg (progr, quadro, riga, colonna, stringa)
							VALUES(@progrComunic, 'DB', @atcount, '273', @zb262_az)
			...
			BEGIN
				...
				BEGIN
					...
					BEGIN
						...
						-- DBXXX256 [Nota AI] (Questa nota è sicuramente presente almeno per il contratto principale)
						-- DB001256
						IF (@ai_inserted = 'N')
						BEGIN
							INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DB', 1, '256', 'AI')
							SET @ai_inserted = 'S'
						END
	
						INSERT INTO #recordg (progr, quadro, riga, colonna, stringa)
							VALUES(@progrComunic, 'DB', @offset_ai + @contacud, '256', @zb245_ai)
					END
				END
				...
				BEGIN
					...
					SET @zb257_aj = 'Importo ' + CONVERT(varchar(16), @previdenza)
					...
					BEGIN
						...
						IF (@aj_inserted = 'N')
						BEGIN
							INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DB', 1, '257', 'AJ')
							-- DB002257
							INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DB', 2, '257',
							'Redditi totalmente o parzialmente esentati da imposizione in Italia in quanto il percipiente risiede')
							-- DB003257
							INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DB', 3, '257',
							'in uno Stato Estero con cui è in vigore una convenzione per evitare le doppie imposizioni in materia')
							-- DB004257
							INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DB', 4, '257',
							'di imposte dirette: ' + @zb257_aj)
					...
					-- DB005246
					INSERT INTO #recordg (progr, quadro, riga, colonna, stringa)
					VALUES(@progrComunic, 'DB', @offset_aj + @contacudconvenzione, '257', @zb257_aj)
			...
			fetch next from @cursorecud 
				into @zb78cudcodfisc_MOD, @zb81cudimpfisclordo_MOD, @zb83cudirpef_MOD, 
				@zb84cudirpefsosp_MOD, @zb87cudaddreg_MOD, @zb88cudaddregsosp_MOD, @zb89cudaddcomacconto_MOD, @zb91cudaddcomsosp_MOD
			
			WHILE @@fetch_status=0 
			begin
				-- Inizio Parte inutile
	--			set @SS002001 = isnull(@SS002001,0) - isnull(@zb83cudirpef_MOD, 0)
				set @SS002002 = isnull(@SS002002,0) - isnull(@zb84cudirpefsosp_MOD, 0)
				set @SS002009 = isnull(@SS002009,0) - isnull(@zb89cudaddcomacconto_MOD, 0)
				-- Fine Parte inutile
				...
				BEGIN
					...
					--DBXXX078 Codice fiscale
					INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DB', @contacud, '078', @zb78cudcodfisc_MOD)
					--DBXXX079 Causa - Casella 79
					INSERT INTO #recordg (progr, quadro, riga, colonna, intero) VALUES(@progrComunic, 'DB', @contacud, '079', 6)
					--DBXXX080 Causa - Casella 80
					INSERT INTO #recordg (progr, quadro, riga, colonna, intero) VALUES(@progrComunic, 'DB', @contacud, '080', 1)
					--DBXXX081 Reddito conguagliato
					INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', @contacud, '081', @zb81cudimpfisclordo_MOD)
					--DBXXX083 Ritenute
					INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', @contacud, '083', @zb83cudirpef_MOD)
					--DBXXX084 Ritenute sospese
					INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', @contacud, '084', @zb84cudirpefsosp_MOD)
					--DBXXX087 Addizionale regionale
					INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', @contacud, '087', @zb87cudaddreg_MOD)
					--DBXXX088 Addizionale regionale sospesa
					INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', @contacud, '088', @zb88cudaddregsosp_MOD)
					--DBXXX089 Addizionale comunale acconto @annodichiarazione
					INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', @contacud, '089', @zb89cudaddcomacconto_MOD)
					--DBXXX090 Addizionale comunale saldo @annodichiarazione
					INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', @contacud, '090', @zb90cudaddcomsaldo_MOD)
					--DBXXX091 Addizionale comunale sospesa
					INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', @contacud, '091', @zb91cudaddcomsosp_MOD)
			...
			BEGIN
				DECLARE @zb107RedditoDedArt11_MOD  decimal(19,2)
				DECLARE @zb108ritIRPEF_MOD  decimal(19,2)
				DECLARE @zb109add_reg_MOD  decimal(19,2)
				...
				--DB00107 Totale Redditi
				INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '107', @zb107RedditoDedArt11_MOD )
				--DB001108 Ritenute Irpef
				INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '108', @zb108ritIRPEF_MOD )
				--DB001109 Addizionale regionale all'Irpef
				INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '109', @zb109add_reg_MOD )
	
				-- Solo per il modello 770 si dettagliano in altri campi i valori calcolati precedentemente
				IF (@modello = '770')
				BEGIN
					DECLARE @zb112causale_MOD int
					DECLARE @zb113dettaglio82_MOD decimal(19,2)
					DECLARE @zb114dettaglio83_MOD decimal(19,2)
					DECLARE @zb115dettaglio84_MOD decimal(19,2)

					SET @zb112causale_MOD = 2 -- Per noi vale sempre 2: La popoliamo solo x i redditi a stranieri
					SET @zb113dettaglio82_MOD = @zb107RedditoDedArt11_MOD 
					SET @zb114dettaglio83_MOD = @zb108ritIRPEF_MOD 
					SET @zb115dettaglio84_MOD = @zb109add_reg_MOD 

					--DB001112 Causale
					INSERT INTO #recordg (progr, quadro, riga, colonna, intero) VALUES(@progrComunic, 'DB', 1, '112', @zb112causale_MOD)
					--DB001113 Totale Redditi
					INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '113', @zb113dettaglio82_MOD)
					--DB001114 Ritenute Irpef
					INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '114', @zb114dettaglio83_MOD)
					--DB001115 Addizionale regionale all'Irpef
					INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '115', @zb115dettaglio84_MOD)
				END

				SET @zb271_ax = 'Reddito ' + CONVERT(varchar(16), @zb107RedditoDedArt11_MOD )
	
				-- DB001271
				INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DB', 1, '271', 'AX')
				-- DB002271
				INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DB', 2, '271',
					'Assimilato a lavoro dipendente - Tempo det.')
				-- DB003271
				INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DB', 3, '271', @zb271_ax)
				IF (@zb108ritIRPEF_MOD  > 0)
				BEGIN
					SET @zb271_ax = 'Ritenuta IRPEF applicata ' + CONVERT(varchar(16), @zb5ritIRPEF)
					-- DB004271
					INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DB', 4, '271', @zb271_ax)
				END

				IF (@zb109add_reg_MOD  > 0)
				BEGIN
					SET @zb271_ax = 'Addizionale Regionale applicata ' + CONVERT(varchar(16), @zb6add_reg)
					-- DB004271
					INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DB', 5, '271', @zb271_ax)
				END

				--DBXXX112 Causale
				INSERT INTO #recordg (progr, quadro, riga, colonna, intero) VALUES(@progrComunic, 'DB', 1, '112', 2)
				--DBXXX107 Redditi
				INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '107', @zb107RedditoDedArt11_MOD )
				--DBXXX108 Ritenute Irpef
				INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '108', @zb108ritIRPEF_MOD )
				--DBXXX109 Addizionale regionale all'Irpef
				INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '109', @zb109add_reg_MOD ) 
			END
			...
			set @cursFamigliare = cursor for 
				SELECT
					...
					ISNULL(F.startapplication, @1gen10_XXX),
					ISNULL(F.stopapplication, @31dic10_XXX),
					ISNULL(F.starthandicap, @1gen11_XXX),
					ISNULL(F.cf, ''),
			...
			begin
				...
				begin
					...
					set @diffhand = datediff(m, @starthandicap, dateadd(m, @mese-1, @1gen10_XXX))
					...
					begin
						...
						SELECT @idconiuge = idconiuge from #coniuge
							where b297codiceFiscaleConiuge_MOD = @cfFamigliare
							and bXXXanno = @annoredditi
		
						if @idconiuge is not null
						begin
							update #coniuge set
								b298numeroMesiACarico_MOD = b298numeroMesiACarico_MOD + 1 
					...
					begin
						...
						SELECT @idPrimoFiglio = idPrimoFiglio
							from #primofiglio
							where (b299casellaPrimoFiglio_MOD=1 and @casellaParentela=280 
								or b300casellaDisabile_MOD=1 and @casellaParentela=281)
							and b301codiceFiscalePrimoFiglio = @cfFamigliare
							and bD04detrazionePerConiugeACarico_MOD = @detrazionePerConiugeACarico
							and bYYYanno = @annoredditi
		
						if @idPrimoFiglio is not null
						begin
							update #PrimoFiglio set
								b302numeroMesiACarico_MOD = isnull(b302numeroMesiACarico_MOD,0) + 1,
								b303minoreDiTreAnni = isnull(b303minoreDiTreAnni,0) + case WHEN datediff(m, dateadd(m, @mese-1, @1gen10_XXX), dateadd(yy, 3, @birthdate)) >= 0 THEN 1 ELSE 0 end,
								bC04percentualeDiDetrazioneSpettante_MOD = isnull(bC04percentualeDiDetrazioneSpettante_MOD,0) 
							...
							insert into #PrimoFiglio values (
								...
								@cfFamigliare,
								1,
								case WHEN datediff(m, dateadd(m, @mese-1, @1gen10_XXX), dateadd(yy, 3, @birthdate)) >= 0 THEN 1 end,
					...
					begin
						...
						SELECT @idAltroFiglio = idAltroFiglio
							from #altrofiglio
							where (b305casellaFiglio_MOD=1 and @casellaParentela=286 
								or b306casellaAltroFamiliare_MOD=1 and @casellaParentela=287
								or b307casellaDisabile_MOD=1 and @casellaParentela=288)
							and b308codiceFiscaleFamiliare_MOD = @cfFamigliare
							and bd11detrazionePerConiugeACarico_MOD = @detrazionePerConiugeACarico
							and bZZZAnno = @annoredditi
		
						if @idAltroFiglio is not null
						begin
							update #AltroFiglio set
								b309numeroMesiACarico_MOD = isnull(b309numeroMesiACarico_MOD,0) + 1,
								b310minoreDiTreAnni_MOD = isnull(b310minoreDiTreAnni_MOD,0) + 
										case WHEN datediff(m, dateadd(m, @mese-1, @1gen10_XXX), 
											dateadd(yy, 3, @birthdate)) >= 0 THEN 1 
											ELSE 0 
										end,
								bc11percentualeDiDetrazioneSpettante_MOD = isnull(bc11percentualeDiDetrazioneSpettante_MOD,0)
													 + isnull(@appliancepercentage,1)
			...
			--DBXXX296 casella coniuge
			INSERT INTO #recordg (progr, quadro, riga, colonna, intero) 
				SELECT @progrComunic, 'DB', idconiuge, '296', 1 from #coniuge
		
			--DBXXX297 codice fiscale coniuge
			INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) 
				SELECT @progrComunic, 'DB', idconiuge, '297', b297codiceFiscaleConiuge_MOD from #coniuge where b297codiceFiscaleConiuge_MOD <> ''
		
			--DBXXX298 numero mesi a carico
			INSERT INTO #recordg (progr, quadro, riga, colonna, intero) 
				SELECT @progrComunic, 'DB', idconiuge, '298', b298numeroMesiACarico_MOD from #coniuge

			--DBXXX259 anno
--			INSERT INTO #recordg (progr, quadro, riga, colonna, intero)
--				SELECT @progrComunic, 'DB', idconiuge, '259', bXXXanno from #coniuge
		
			--DBXXX299 casella primo figlio
			INSERT INTO #recordg (progr, quadro, riga, colonna, intero)
				SELECT @progrComunic, 'DB', idprimofiglio, '299', b299casellaPrimoFiglio_MOD from #primofiglio
		
			--DBXXX300 casella disabile
			INSERT INTO #recordg (progr, quadro, riga, colonna, intero) 
				SELECT @progrComunic, 'DB', idprimofiglio, '300', b300casellaDisabile_MOD from #primofiglio
		
			--DBXXX301 codice fiscale primo figlio
			INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) 
				SELECT @progrComunic, 'DB', idprimofiglio, '301', b301codiceFiscalePrimoFiglio from #primofiglio where b301codiceFiscalePrimoFiglio <> ''
		
			--DBXXX302 numero mesi a carico
			INSERT INTO #recordg (progr, quadro, riga, colonna, intero)
				SELECT @progrComunic, 'DB', idprimofiglio, '302', b302numeroMesiACarico_MOD from #primofiglio
		
			--DBXXX303 minore di tre anni
			INSERT INTO #recordg (progr, quadro, riga, colonna, intero)
				SELECT @progrComunic, 'DB', idprimofiglio, '303', b303minoreDiTreAnni from #primofiglio
		
			--DBXXXc04 percentuale di detrazione spettante
			INSERT INTO #recordg (progr, quadro, riga, colonna, intero)
				SELECT @progrComunic, 'DB', idprimofiglio, 'c04', 100 * bC04percentualeDiDetrazioneSpettante_MOD / b302numeroMesiACarico_MOD from #primofiglio
		
			--DBXXXd04 percentuale di detrazione spettante
			INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) 
				SELECT @progrComunic, 'DB', idprimofiglio, 'd04', 'C' from #primofiglio where bD04detrazionePerConiugeACarico_MOD = 'C'
		
			--DBXXX266 anno
--			INSERT INTO #recordg (progr, quadro, riga, colonna, intero)
--				SELECT @progrComunic, 'DB', idprimofiglio, '285', bYYYanno from #primofiglio
		
			--DBXXX0305 casella figlio
			INSERT INTO #recordg (progr, quadro, riga, colonna, intero)
				SELECT @progrComunic, 'DB', idaltrofiglio, '305', b305casellaFiglio_MOD from #altrofiglio
		
			--DBXXX306 casella altro familiare
			INSERT INTO #recordg (progr, quadro, riga, colonna, intero)
				SELECT @progrComunic, 'DB', idaltrofiglio, '306', b306casellaAltroFamiliare_MOD from #altrofiglio
		
			--DBXXX307 casella disabile
			INSERT INTO #recordg (progr, quadro, riga, colonna, intero)
				SELECT @progrComunic, 'DB', idaltrofiglio, '307', b307casellaDisabile_MOD from #altrofiglio
		
			--DBXXX308 codice fiscale familiare
			INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) 
				SELECT @progrComunic, 'DB', idaltrofiglio, '308', b308codiceFiscaleFamiliare_MOD from #altrofiglio where b308codiceFiscaleFamiliare_MOD <> ''
		
			--DBXXX309 numero mesi a carico
			INSERT INTO #recordg (progr, quadro, riga, colonna, intero)
				SELECT @progrComunic, 'DB', idaltrofiglio, '309', b309numeroMesiACarico_MOD from #altrofiglio
		
			--DBXXX310 minore di tre anni
			INSERT INTO #recordg (progr, quadro, riga, colonna, intero)
				SELECT @progrComunic, 'DB', idaltrofiglio, '310', b310minoreDiTreAnni_MOD from #altrofiglio
		
			--DBXXXc11 percentuale di detrazione spettante
			INSERT INTO #recordg (progr, quadro, riga, colonna, intero)
				SELECT @progrComunic, 'DB', idaltrofiglio, 'c11', 100 * bc11percentualeDiDetrazioneSpettante_MOD / b309numeroMesiACarico_MOD from #altrofiglio
		
			--DBXXXd11 percentuale di detrazione spettante
			INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) 
				SELECT @progrComunic, 'DB', idaltrofiglio, 'd11', 'C' from #altrofiglio where bd11detrazionePerConiugeACarico_MOD = 'C'
	...
	--inizio wizard
			...
			SELECT
				...
				@wb5ritIRPEF_MOD = ISNULL(SUM(importoritenuta),0),
				@deduzioneirpef = ISNULL(SUM(deduzione),0),
				@wb41detrazioniperoneri_MOD  = ISNULL(SUM(detrazione),0)
				FROM #wizard 
				WHERE taxkind = 1
				AND geoappliance IS NULL
				and idexp=@chiave
                        ...
                        set @wb46totaledetrazioni_MOD  = @wb41detrazioniperoneri_MOD 

			-- Inizio Codice Inutile
			set @SS002001 = isnull(@SS002001,0) + isnull(@wb5ritIRPEF_MOD,0)
			-- Fine Codice Inutile
			...
			SELECT @wb6add_reg_MOD = ISNULL(SUM(importoritenuta),0), @imponibileaddreg=isnull(SUM(imponibile),0)
				FROM #wizard
				WHERE taxkind = 1
				AND geoappliance = 'R'
				and idexp=@chiave
			...
			SELECT @wb10addcomacconto2010  = ISNULL(SUM(importoritenuta),0), @imponibileaddcom=isnull(SUM(imponibile),0)
				FROM #wizard
			...
			SELECT @wb11addcomsaldo2010  = ISNULL(SUM(importoritenuta),0), 
			...
			-- sarà posto uguale
			set @wb1RedditoDedArt11_MOD = isnull(@imponibilelordoirpef, 0)
			if @wb1RedditoDedArt11_MOD < @imponibileaddcom set @wb1RedditoDedArt11_MOD = @imponibileaddcom
			if @wb1RedditoDedArt11_MOD < @imponibileaddreg set @wb1RedditoDedArt11_MOD = @imponibileaddreg
			...
			SELECT @wb59deductionart10_MOD  = ISNULL(SUM(importoritenuta),0) 
				FROM #wizard WHERE taxkind<>1
				and exists (SELECT * from #wizard s2 where s2.idexp=#wizard.idexp and taxkind=1)
				and idexp=@chiave
	
			set @wb33impostalorda  = @wb5ritIRPEF_MOD + @wb41detrazioniperoneri_MOD 

		-- Inserimento dei dati fiscali
		--DB001001 Redditi per i quali è possibile fruire della deduzione di cui all'art. 11 del TUIR
			INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '001', @wb1RedditoDedArt11_MOD)
		--DB001002 Redditi per i quali è possibile fruire della sola deduzione di cui all'art.11, c. 1 del TUIR
			-- Il campo seguente viene posto a zero in quanto non riusciamo a distinguere tali prestazioni e, quindi a valorizzarlo correttamente
			INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '002', 0)
		--DB001003 Numero di giorni per i quali spettano le deduzioni di cui all'art. 11 commi 2 e 3 del TUIR - LAVORO DIPENDENTE
		...
		--DB001005 Ritenute Irpef
			INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '005', @wb5ritIRPEF_MOD)
		--DB001006 Addizionale regionale all'Irpef
	--				if isnull(@codeser,'') not in ('05_COOSTRA', '07_BRS_STN')
	--ho commentato in quanto quelle due prestazioni non hanno addizionali regionali e quindi l'if è inutile.
			INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '006', @wb6add_reg_MOD)
		--DB001010 Addizionale comunale all'Irpef - Acconto @annodichiarazione
			INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '010', @wb10addcomacconto2010 )
		--DB001011 Addizionale comunale all'Irpef - Saldo @annodichiarazione
			INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '011', @wb11addcomsaldo2010 )
		--DB001013 Addizionale comunale all'Irpef - Acconto 2010
			INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '013', @wb13addcomacconto2011 )
		--DB001041 Detrazioni per oneri
			INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '041', @wb41detrazioniperoneri_MOD )
		--DB001046 Totale Detrazioni 
			INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '046', @wb46totaledetrazioni_MOD )
		--DB001059 Totale oneri sostenuti esclusi dai redditi indicati nei punti 1 e 2
			INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '059', @wb59deductionart10_MOD )
		--DB001060 Totale oneri per i quali è prevista la detrazione d'imposta
			INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '060', @wb60oneridetraibili_MOD )
		--DB001064 Applicazione maggiore ritenuta
			INSERT INTO #recordg (progr, quadro, riga, colonna, intero) VALUES(@progrComunic, 'DB', 1, '064', @wb64maggioreritenuta_MOD )
			...
			begin
				--DB001107 Totale Redditi
				INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '107', @wb1RedditoDedArt11_MOD)
				--DB001108 Ritenute Irpef
				INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '108', @wb5ritIRPEF_MOD)
				--DB001109 Addizionale regionale all'Irpef
				INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '109', @wb6add_reg_MOD)
	
				--DBXXX112 Causale
				INSERT INTO #recordg (progr, quadro, riga, colonna, intero) VALUES(@progrComunic, 'DB', 1, '104', 2)
				--DBXXX113 Redditi
				INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '113', @wb1RedditoDedArt11_MOD)
				--DBXXX114 Ritenute Irpef
				INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '114', @wb5ritIRPEF_MOD) 
				--DBXXX115 Addizionale regionale all'Irpef
				INSERT INTO #recordg (progr, quadro, riga, colonna, decimale) VALUES(@progrComunic, 'DB', 1, '115', @wb6add_reg_MOD) 
			end
			...
			BEGIN
				...
				INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DB', 1, '256', 'AI')
				-- DB002256
				INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DB', 2, '256', @wb256_ai)
			END
			...
			BEGIN
				SET @wb257_aj = 'Importo ' + CONVERT(varchar(16), @impon)
			...
			BEGIN
				...
				BEGIN
					-- DB002260
					INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DB', @jj, '260',
	...
	--				INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DC', 1, '080', @patcode)
				set @wc8start_MOD=ISNULL(@servicestart,@adate)
		--DCXXX085 Data inizio
				INSERT INTO #recordg (progr, quadro, riga, colonna, data) VALUES(@progrComunic, 'DC', 1, '085', @wc8start_MOD)
				set @wc86stop_MOD=ISNULL(@servicestop,@adate)
		--DCXXX086 Data fine
				INSERT INTO #recordg (progr, quadro, riga, colonna, data) VALUES(@progrComunic, 'DC', 1, '086', @wc86stop_MOD)
		--DCXXX087 Codice comune
				INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DC', 1, '087', @zc87codiceComuneEnte_MOD)
			end
	--fine wizard
		end
...
--			DECLARE @idpayroll int
			...
			if @startpayroll < @1gen10_XXX set @oldstart = @1gen10_XXX ELSE set @oldstart = @startpayroll
	
			-- Inserimento dei dati assicurativi distinti per mese
			WHILE @@fetch_status = 0
			begin
				--Dati assicurativi INAIL
				if @startpayroll < @1gen10_XXX set @startpayroll = @1gen10_XXX
				if @stoppayroll > @31dic10_XXX set @stoppayroll = @31dic10_XXX
		...
		--DCXXX084 Posizione assicurativa territoriale
					INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DC', @contaPrestazioni, '084', @zc84patcode_MOD)
		--DCXXX085 Data inizio
					INSERT INTO #recordg (progr, quadro, riga, colonna, data) VALUES(@progrComunic, 'DC', @contaPrestazioni, '085', @oldstart)
		--DCXXX086 Data fine
					INSERT INTO #recordg (progr, quadro, riga, colonna, data) VALUES(@progrComunic, 'DC', @contaPrestazioni, '086', @oldstop)
		--DCXXX087 Codice comune
					INSERT INTO #recordg (progr, quadro, riga, colonna, stringa) VALUES(@progrComunic, 'DC', @contaPrestazioni, '087', @zc87codiceComuneEnte_MOD)
