...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_certificazioneunica_b_25]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_certificazioneunica_b_25]
GO
...
create PROCEDURE [exp_certificazioneunica_b_25]
(
	@numdichquadrog int,
	@numdichquadroh int,
