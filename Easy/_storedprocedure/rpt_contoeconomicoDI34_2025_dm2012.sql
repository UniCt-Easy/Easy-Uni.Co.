...
if exists (select * from dbo.sysobjects where id = object_id(N'[rpt_contoeconomicoDI34_2025_dm2012]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [rpt_contoeconomicoDI34_2025_dm2012]
GO
...
CREATE  PROCEDURE [rpt_contoeconomicoDI34_2025_dm2012]
--setuser 'amministrazione'

-- exec rpt_contoeconomico_dm2012 2025, {ts '2025-01-01 00:00:00'}, {ts '2025-10-23 00:00:00'}, '%','N',null,'N',null,null
...
END
	...
	-->	B) VII - COSTI DEL PERSONALE
	DECLARE @PY_C_BVII1a decimal(19,2)
	SET @PY_C_BVII1a =
	ISNULL(
	(SELECT -SUM(amount)
	FROM entrydetail
	...
	AND placcount.codeplaccount = 
				isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'B) VII 1) a)' and L.ayear_old = @ayearPrec),'B) VII 1) a)')
	...
	DECLARE @PY_C_BVII1b decimal(19,2)
	SET @PY_C_BVII1b =
	ISNULL(
	(SELECT -SUM(amount)
	FROM entrydetail
	...
	AND placcount.codeplaccount = 
				isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'B) VII 1) b)' and L.ayear_old = @ayearPrec),'B) VII 1) b)')
	AND placcount.placcpart = 'C'
	...
	DECLARE @PY_C_BVII1c decimal(19,2)
	SET @PY_C_BVII1c =
	ISNULL(
	(SELECT -SUM(amount)
	FROM entrydetail
	...
	AND placcount.codeplaccount = 
					isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'B) VII 1) c)' and L.ayear_old = @ayearPrec),'B) VII 1) c)')
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayearPrec
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	DECLARE @PY_C_BVII1d decimal(19,2)
	SET @PY_C_BVII1d =
	ISNULL(
	(SELECT -SUM(amount)
	FROM entrydetail
	...
	AND placcount.codeplaccount = 
					isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'B) VII 1) d)' and L.ayear_old = @ayearPrec),'B) VII 1) d)')
	...
	DECLARE @PY_C_BVII1e decimal(19,2)
	SET @PY_C_BVII1e =
	ISNULL(
	(SELECT -SUM(amount)
	FROM entrydetail
	...
	AND placcount.codeplaccount = 
					isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'B) VII 1) e)' and L.ayear_old = @ayearPrec),'B) VII 1) e)')
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayearPrec
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	DECLARE @PY_C_BVII2 decimal(19,2)
	SET @PY_C_BVII2 =
	ISNULL(
	(SELECT -SUM(amount)
	FROM entrydetail
	...
	AND placcount.codeplaccount = 
					isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'B) VII 2)' and L.ayear_old = @ayearPrec),'B) VII 2)')
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayearPrec
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	DECLARE @PY_C_BVII decimal(19,2)
	SET @PY_C_BVII = @PY_C_BVII1a + @PY_C_BVII1b + @PY_C_BVII1c +@PY_C_BVII1d + @PY_C_BVII1e + @PY_C_BVII2
	
	
	--> B) VIII - COSTI DELLA GESTIONE CORRENTE
	DECLARE @PY_C_BVIII1 decimal(19,2)
	SET @PY_C_BVIII1 =
	ISNULL(
	(SELECT -SUM(amount)
	FROM entrydetail
	...
	AND placcount.codeplaccount = 
					isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'B) VIII 1)' and L.ayear_old = @ayearPrec),'B) VIII 1)')
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayearPrec
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	AND placcount.codeplaccount = 
					isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'B) VIII 2)' and L.ayear_old = @ayearPrec),'B) VIII 2)')
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayearPrec
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	DECLARE @PY_C_BVIII3 decimal(19,2)
	SET @PY_C_BVIII3 =
	ISNULL(
	(SELECT -SUM(amount)
	FROM entrydetail
	...
	AND placcount.codeplaccount = 
					isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'B) VIII 3)' and L.ayear_old = @ayearPrec),'B) VIII 3)')
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayearPrec
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	DECLARE @PY_C_BVIII4 decimal(19,2)
	SET @PY_C_BVIII4 =
	ISNULL(
	(SELECT -SUM(amount)
	FROM entrydetail
	...
	AND placcount.codeplaccount = 
					isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'B) VIII 4)' and L.ayear_old = @ayearPrec),'B) VIII 4)')
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayearPrec
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	DECLARE @PY_C_BVIII5 decimal(19,2)
	SET @PY_C_BVIII5 =
	ISNULL(
	(SELECT -SUM(amount)
	FROM entrydetail
	...
	AND placcount.codeplaccount =
					isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'B) VIII 5)' and L.ayear_old = @ayearPrec),'B) VIII 5)')
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayearPrec
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	,0)
	DECLARE @PY_C_BVIII6 decimal(19,2)
	SET @PY_C_BVIII6 =
	ISNULL(
	(SELECT -SUM(amount)
	FROM entrydetail
	...
	AND placcount.codeplaccount = 
						isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'B) VIII 6)' and L.ayear_old = @ayearPrec),'B) VIII 6)')
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayearPrec
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	DECLARE @PY_C_BVIII7 decimal(19,2)
	SET @PY_C_BVIII7 =
	ISNULL(
	(SELECT -SUM(amount)
	FROM entrydetail
	...
	AND placcount.codeplaccount =
					isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'B) VIII 7)' and L.ayear_old = @ayearPrec),'B) VIII 7)')
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayearPrec
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	,0)
	DECLARE @PY_C_BVIII8 decimal(19,2)
	SET @PY_C_BVIII8 =
	ISNULL(
	(SELECT -SUM(amount)
	FROM entrydetail
	...
	AND placcount.codeplaccount = 
					isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'B) VIII 8)' and L.ayear_old = @ayearPrec),'B) VIII 8)')
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayearPrec
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	,0)
	DECLARE @PY_C_BVIII9 decimal(19,2)
	SET @PY_C_BVIII9 =
	ISNULL(
	(SELECT -SUM(amount)
	FROM entrydetail
	...
	AND placcount.codeplaccount =
						isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'B) VIII 9)' and L.ayear_old = @ayearPrec),'B) VIII 9)')
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayearPrec
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	DECLARE @PY_C_BVIII10 decimal(19,2)
	SET @PY_C_BVIII10 =
	ISNULL(
	(SELECT -SUM(amount)
	FROM entrydetail
	...
	AND placcount.codeplaccount = 
						isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'B) VIII 10)' and L.ayear_old = @ayearPrec),'B) VIII 10)')
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayearPrec
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	DECLARE @PY_C_BVIII11 decimal(19,2)
	SET @PY_C_BVIII11 =
	ISNULL(
	(SELECT -SUM(amount)
	FROM entrydetail
	...
	AND placcount.codeplaccount =
						isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'B) VIII 11)' and L.ayear_old = @ayearPrec),'B) VIII 11)')
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayearPrec
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	,0)
	DECLARE @PY_C_BVIII12 decimal(19,2)
	SET @PY_C_BVIII12 =
	ISNULL(
	(SELECT -SUM(amount)
	FROM entrydetail
	...
	AND placcount.codeplaccount =
						isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'B) VIII 12)' and L.ayear_old = @ayearPrec),'B) VIII 12)')
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayearPrec
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	SET @PY_C_BVIII = @PY_C_BVIII1 + @PY_C_BVIII2 + @PY_C_BVIII3 + @PY_C_BVIII4 + @PY_C_BVIII5 + @PY_C_BVIII6
	+ @PY_C_BVIII7 + @PY_C_BVIII8 + @PY_C_BVIII9+ @PY_C_BVIII10 + @PY_C_BVIII11 + @PY_C_BVIII12
	...
	AND placcount.codeplaccount = 
						isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'B) IX 1)' and L.ayear_old = @ayearPrec),'B) IX 1)')
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayearPrec
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	AND placcount.codeplaccount = 
						isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'B) IX 2)' and L.ayear_old = @ayearPrec),'B) IX 2)')
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayearPrec
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	AND placcount.codeplaccount = 
						isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'B) IX 3)' and L.ayear_old = @ayearPrec),'B) IX 3)')
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayearPrec
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	AND placcount.codeplaccount = 
						isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'B) IX 4)' and L.ayear_old = @ayearPrec),'B) IX 4)')
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayearPrec
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	SET @PY_C_BIX = @PY_C_BIX1 + @PY_C_BIX2 + @PY_C_BIX3 + @PY_C_BIX4
	...
	AND placcount.codeplaccount = 
						isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'B) X' and L.ayear_old = @ayearPrec),'B) X')
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayearPrec
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	--> B) XI - ONERI DIVERSI DI GESTIONE
	...
	AND placcount.codeplaccount = 
							isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'B) XI' and L.ayear_old = @ayearPrec),'B) XI')
	...
	SET @PY_C_B = @PY_C_BVII + @PY_C_BVIII + @PY_C_BIX + @PY_C_BX + @PY_C_BXI
	...
	SET @PY_TOTCOSTI = @PY_C_BVII + @PY_C_BVIII + @PY_C_BIX + @PY_C_BX  + @PY_C_BXI +
	...
	--> A) III  - PROVENTI PER LA GESTIONE DIRETTA INTERVENTI DIRITTO ALLO STUDIO
	DECLARE @PY_R_AIII decimal(19,2)
	SET @PY_R_AIII =
	ISNULL(
	(SELECT SUM(amount)
	...
	-- AND placcount.codeplaccount = 'A) III'
		AND placcount.codeplaccount = 
				isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'A) III' and L.ayear_old = @ayearPrec),'A) III')
	AND placcount.placcpart = 'R'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayearPrec
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	AND placcount.codeplaccount = 
				isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'A) IV' and L.ayear_old = @ayearPrec),'A) IV')
	AND placcount.placcpart = 'R'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayearPrec
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	--> A) V VARIAZIONE LAVORI IN CORSO
	...
	-- AND placcount.codeplaccount = 'A) V'
		AND placcount.codeplaccount = 
				isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'A) V' and L.ayear_old = @ayearPrec),'A) V')
	AND placcount.placcpart = 'R'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayearPrec
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	--> A) VI - INCREMENTO IMMOBILIZZAZIONI PER LAVORI INTERNI
	...
	-- AND placcount.codeplaccount = 'A) VI'
		AND placcount.codeplaccount = 
				isnull((select L.codeplaccount_old from lookupprintedplaccount L 
				where L.codeplaccount_new = 'A) VI' and L.ayear_old = @ayearPrec),'A) VI')
	AND placcount.placcpart = 'R'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayearPrec
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	SET @PY_R_A = @PY_R_AI + @PY_R_AII + @PY_R_AIII + @PY_R_AIV + @PY_R_AV + @PY_R_AVI
	...
	SET @PY_TOTRICAVI = @PY_R_AI + @PY_R_AII + @PY_R_AIII + @PY_R_AIV +@PY_R_AV + @PY_R_AVI
	...
	AND entry.identrykind  not in (6,11,12) -- DEVO ESCLUDERE LE SCRITTURE DI EPILOGO
	AND ((account.flag&4)= 0)	-- ESCLUDO I CONTI D'ORDINE
	AND placcount.codeplaccount = 'B) VII 1) a)'
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	...
	AND entry.identrykind  not in (6,11,12) -- DEVO ESCLUDERE LE SCRITTURE DI EPILOGO
	AND ((account.flag&4)= 0)	-- ESCLUDO I CONTI D'ORDINE
	AND placcount.codeplaccount = 'B) VII 1) b)'
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayear
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	AND entry.identrykind  not in (6,11,12) -- DEVO ESCLUDERE LE SCRITTURE DI EPILOGO
	AND ((account.flag&4)= 0)	-- ESCLUDO I CONTI D'ORDINE
	AND placcount.codeplaccount = 'B) VII 1) c)'
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayear
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	AND entry.identrykind  not in (6,11,12) -- DEVO ESCLUDERE LE SCRITTURE DI EPILOGO
	AND ((account.flag&4)= 0)	-- ESCLUDO I CONTI D'ORDINE
	AND placcount.codeplaccount = 'B) VII 1) d)'
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayear
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	AND entry.identrykind  not in (6,11,12) -- DEVO ESCLUDERE LE SCRITTURE DI EPILOGO
	AND ((account.flag&4)= 0)	-- ESCLUDO I CONTI D'ORDINE
	AND placcount.codeplaccount = 'B) VII 1) e)'
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayear
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	AND entry.identrykind  not in (6,11,12) -- DEVO ESCLUDERE LE SCRITTURE DI EPILOGO
	AND ((account.flag&4)= 0)	-- ESCLUDO I CONTI D'ORDINE
	AND placcount.codeplaccount = 'B) VII 2)'
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayear
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	DECLARE @C_BVII decimal(19,2)
	SET @C_BVII = @C_BVII1a + @C_BVII1b + @C_BVII1c +@C_BVII1d + @C_BVII1e + @C_BVII2
	
	
	--> B) VIII - COSTI DELLA GESTIONE CORRENTE
	DECLARE @C_BVIII1 decimal(19,2)
	SET @C_BVIII1 =
	ISNULL(
	(SELECT -SUM(amount)
	FROM entrydetail
	...
	AND entry.identrykind  not in (6,11,12) -- DEVO ESCLUDERE LE SCRITTURE DI EPILOGO
	AND ((account.flag&4)= 0)	-- ESCLUDO I CONTI D'ORDINE
	AND placcount.codeplaccount = 'B) VIII 1)'
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayear
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	AND entry.identrykind  not in (6,11,12) -- DEVO ESCLUDERE LE SCRITTURE DI EPILOGO
	AND ((account.flag&4)= 0)	-- ESCLUDO I CONTI D'ORDINE
	AND placcount.codeplaccount = 'B) VIII 3)'
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayear
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	AND entry.identrykind  not in (6,11,12) -- DEVO ESCLUDERE LE SCRITTURE DI EPILOGO
	AND ((account.flag&4)= 0)	-- ESCLUDO I CONTI D'ORDINE
	AND placcount.codeplaccount = 'B) VIII 4)'
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayear
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	AND entry.identrykind  not in (6,11,12) -- DEVO ESCLUDERE LE SCRITTURE DI EPILOGO
	AND ((account.flag&4)= 0)	-- ESCLUDO I CONTI D'ORDINE
	AND placcount.codeplaccount = 'B) VIII 5)'
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayear
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	AND entry.identrykind  not in (6,11,12) -- DEVO ESCLUDERE LE SCRITTURE DI EPILOGO
	AND ((account.flag&4)= 0)	-- ESCLUDO I CONTI D'ORDINE
	AND placcount.codeplaccount = 'B) VIII 6)'
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayear
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	AND entry.identrykind  not in (6,11,12) -- DEVO ESCLUDERE LE SCRITTURE DI EPILOGO
	AND ((account.flag&4)= 0)	-- ESCLUDO I CONTI D'ORDINE
	AND placcount.codeplaccount = 'B) VIII 7)'
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayear
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	AND entry.identrykind  not in (6,11,12) -- DEVO ESCLUDERE LE SCRITTURE DI EPILOGO
	AND ((account.flag&4)= 0)	-- ESCLUDO I CONTI D'ORDINE
	AND placcount.codeplaccount = 'B) VIII 8)'
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayear
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	AND entry.identrykind  not in (6,11,12) -- DEVO ESCLUDERE LE SCRITTURE DI EPILOGO
	AND ((account.flag&4)= 0)	-- ESCLUDO I CONTI D'ORDINE
	AND placcount.codeplaccount = 'B) VIII 9)'
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayear
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	DECLARE @C_BVIII10 decimal(19,2)
	SET @C_BVIII10 =
	ISNULL(
	(SELECT -SUM(amount)
	FROM entrydetail
	...
	AND entry.identrykind  not in (6,11,12) -- DEVO ESCLUDERE LE SCRITTURE DI EPILOGO
	AND ((account.flag&4)= 0)	-- ESCLUDO I CONTI D'ORDINE
	AND placcount.codeplaccount = 'B) VIII 10)'
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayear
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	DECLARE @C_BVIII11 decimal(19,2)
	SET @C_BVIII11 =
	ISNULL(
	(SELECT -SUM(amount)
	FROM entrydetail
	...
	AND entry.identrykind  not in (6,11,12) -- DEVO ESCLUDERE LE SCRITTURE DI EPILOGO
	AND ((account.flag&4)= 0)	-- ESCLUDO I CONTI D'ORDINE
	AND placcount.codeplaccount = 'B) VIII 11)'
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayear
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	,0)
	DECLARE @C_BVIII12 decimal(19,2)
	SET @C_BVIII12 =
	ISNULL(
	(SELECT -SUM(amount)
	FROM entrydetail
	...
	AND entry.identrykind  not in (6,11,12) -- DEVO ESCLUDERE LE SCRITTURE DI EPILOGO
	AND ((account.flag&4)= 0)	-- ESCLUDO I CONTI D'ORDINE
	AND placcount.codeplaccount = 'B) VIII 12)'
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayear
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	SET @C_BVIII = @C_BVIII1 + @C_BVIII2 + @C_BVIII3 + @C_BVIII4 + @C_BVIII5 + @C_BVIII6
	+ @C_BVIII7 + @C_BVIII8 + @C_BVIII9+ @C_BVIII10 + @C_BVIII11 + @C_BVIII12
	
	-->	B) IX - AMMORTAMENTI E SVALUTAZIONI
	...
	SET @C_BIX = @C_BIX1 + @C_BIX2 + @C_BIX3 + @C_BIX4
	
	--> B) X - ACCANTONAMENTI PER RISCHI E ONERI
	...
	AND entry.identrykind  not in (6,11,12) -- DEVO ESCLUDERE LE SCRITTURE DI EPILOGO
	AND ((account.flag&4)= 0)	-- ESCLUDO I CONTI D'ORDINE
	AND placcount.codeplaccount = 'B) X'
	AND placcount.placcpart = 'C'
	AND (entrydetail.idsor1 IN (SELECT idchild FROM #sortinglink1) OR @idsor1 IS NULL) AND (@idsor2 IS NULL OR entrydetail.idsor2 = @idsor2)AND (@idsor3 IS NULL OR entrydetail.idsor3 = @idsor3)
	AND placcount.ayear = @ayear
	AND (@idsor01 IS NULL OR upb.idsor01 = @idsor01)
	...
	SET @C_B = @C_BVII + @C_BVIII + @C_BIX + @C_BX + @C_BXI
	...
	SET @TOTCOSTI = @C_BVII + @C_BVIII + @C_BIX + @C_BX +  @C_BXI  + 
	@C_C + @C_D + @C_E + @C_F
	...
	SET @R_A = @R_AI + @R_AII + @R_AIII + @R_AIV + @R_AV + @R_AVI 
	...
	SET @TOTRICAVI = @R_AI + @R_AII + @R_AIII + @R_AIV + @R_AV +@R_AVI 
	+ @R_C + @R_D + @R_E
	...
	@codeupb				  as codeupb	   ,
	@title				  as upb		   ,
	@PY_C_BVII1a  		  as PY_C_BVII1a  ,
	@PY_C_BVII1b  		  as PY_C_BVII1b  ,
	@PY_C_BVII1c  		  as PY_C_BVII1c  ,
	@PY_C_BVII1d  		  as PY_C_BVII1d  ,
	@PY_C_BVII1e  		  as PY_C_BVII1e  ,
	@PY_C_BVII2  		  as PY_C_BVII2  ,
	@PY_C_BVII  		  as PY_C_BVII  ,
	@PY_C_BVIII  		  as PY_C_BVIII  ,
	@PY_C_BVIII1  		  as PY_C_BVIII1  ,
	@PY_C_BVIII2  		  as PY_C_BVIII2  ,
	@PY_C_BVIII3  		  as PY_C_BVIII3  ,
	@PY_C_BVIII4  		  as PY_C_BVIII4  ,
	@PY_C_BVIII5  		  as PY_C_BVIII5  ,
	@PY_C_BVIII6  		  as PY_C_BVIII6  ,
	@PY_C_BVIII7  		  as PY_C_BVIII7  ,
	@PY_C_BVIII8  		  as PY_C_BVIII8  ,
	@PY_C_BVIII9  		  as PY_C_BVIII9  ,
	@PY_C_BVIII10  		  as PY_C_BVIII10  ,
	@PY_C_BVIII11  		  as PY_C_BVIII11  ,
	@PY_C_BVIII12  		  as PY_C_BVIII12  ,
	...
	@C_BVII1a  	   as C_BVII1a  	,
	@C_BVII1b  	   as C_BVII1b  	,
	@C_BVII1c  	   as C_BVII1c  	,
	@C_BVII1d  	   as C_BVII1d  	,
	@C_BVII1e  	   as C_BVII1e  	,
	@C_BVII2  	   as C_BVII2  	,
	@C_BVII  	   as C_BVII  	,
	@C_BVIII1  	   as C_BVIII1  	,
	@C_BVIII2  	   as C_BVIII2  	,
	@C_BVIII3  	   as C_BVIII3  	,
	@C_BVIII4  	   as C_BVIII4  	,
	@C_BVIII5  	   as C_BVIII5  	,
	@C_BVIII6  	   as C_BVIII6  	,
	@C_BVIII7  	   as C_BVIII7  	,
	@C_BVIII8  	   as C_BVIII8  	,
	@C_BVIII9  	   as C_BVIII9  	,
	@C_BVIII10  	   as C_BVIII10,
	@C_BVIII11  	   as C_BVIII11 ,
	@C_BVIII12  	   as C_BVIII12  	,
	@C_BVIII  	   as C_BVIII  	,
	@C_BIX1  	   as C_BIX1  	,
	@C_BIX2  	   as C_BIX2  	,
	@C_BIX3  	   as C_BIX3  	,
...
--exec rpt_contoeconomicoDI34_2025_dm2012 2025, {ts '2025-01-01 00:00:00'}, {ts '2025-12-31 00:00:00'}, '%','N',null,'N',null,null