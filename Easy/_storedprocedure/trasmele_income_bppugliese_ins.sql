...
if exists (select * from dbo.sysobjects where id = object_id(N'[trasmele_income_bppugliese_ins]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [trasmele_income_bppugliese_ins]
GO
...
CREATE  PROCEDURE [trasmele_income_bppugliese_ins]
(
	@y int,
	@n int
)
...
DECLARE @ABI_codebpp  varchar(5)
SET @ABI_codebpp  = '05262'   -- 05262   BANCA POPOLARE PUGLIESE SAN PAOLO  
...
(
	...
	varamount_expense decimal(19,2),
	idpro int
)
