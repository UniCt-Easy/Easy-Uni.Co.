...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_modello770_12_h]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_modello770_12_h]
GO
--exec exp_modello770_12_h
CREATE PROCEDURE [exp_modello770_12_h]
AS BEGIN
-- OK
