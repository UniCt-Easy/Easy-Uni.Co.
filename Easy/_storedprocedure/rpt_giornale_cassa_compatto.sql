...
-- exec rpt_giornale_cassa_compatto 2025, {ts '2025-01-01 00:00:00'}, {ts '2025-03-28 00:00:00'}, 'N','N', null, 'N'
-- exec rpt_giornale_cassa_compatto 2025, {ts '2025-03-28 00:00:00'}, {ts '2025-06-30 00:00:00'}, 'N','N', null, 'N'
...
Begin
	...
	group by HPV.adate,		HPV.nmov,		HPV.npro,		HPV.competencydate,
		registry.title,		HPV.description,HPV.doc,HPV.docdate,fin.codefin,HPV.idfin,
		upb.codeupb,HPV.idinc,totflag
End
Begin
	INSERT INTO #journal
	(
