...
if exists (select * from dbo.sysobjects where id = object_id(N'[rpt_bilprevisione_gestionale]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [rpt_bilprevisione_gestionale]
GO
...
-- setuser 'amm'
--	exec rpt_bilprevisione_gestionale 2012,'S',1,'%','S','S','S'
-- setuser 'amministrazione'
CREATE    PROCEDURE [rpt_bilprevisione_gestionale]
(
	@ayear smallint,
	@finpart char(1)='S',
