...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_certificazioneunica_b_16]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_certificazioneunica_b_16]
GO
...
-- exec exp_certificazioneunica_b_16 1,1,'S'
create PROCEDURE [exp_certificazioneunica_b_16]
(
	@numdichquadrog int,
	@numdichquadroh int,
...
--exec exp_certificazioneunica_b_16 10,1
