...
if exists (select * from dbo.sysobjects where id = object_id(N'[trasmele_income_bpcassinate_var]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [trasmele_income_bpcassinate_var]
GO
...
CREATE  PROCEDURE [trasmele_income_bpcassinate_var]
(
	@y int,
	@n int
)
