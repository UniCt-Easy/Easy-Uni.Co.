...
------- NUOVA VERSIONE ----------------
---------------------------------------
if exists (select * from dbo.sysobjects where id = object_id(N'[rpt_consuntivobudgeteconomicoufficialeDI34_2025_puro]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [rpt_consuntivobudgeteconomicoufficialeDI34_2025_puro]
GO
...
SET ANSI_NULLS ON 
GO
--exec rpt_consuntivobudgeteconomicoufficialeDI34_2025_puro 2017, {d'2017-12-31'},'%','S',null,null,null,null,null
--go
--exec rpt_consuntivobudgeteconomicoufficialeDI34_2025_puro_test  2018, {d'2018-12-31'},'%','S',null,null,null,null,null
--go
--exec rpt_consuntivobudgeteconomicoufficialeDI34_2025_puro 2018, {d'2018-12-31'},'%','S',null,null,null,null,null
CREATE      PROCEDURE [rpt_consuntivobudgeteconomicoufficialeDI34_2025_puro](
...
INSERT INTO #dati  SELECT 2,'III. PROVENTI PER LA GESTIONE DIRETTA INTERVENTI PER IL DIRITTO ALLO STUDIO', 'EA1301%',  0,0,0,0,0,0,0,0, 'R', null,1
...
INSERT INTO #dati  SELECT 2,'IV. ALTRI PROVENTI  E RICAVI DIVERSI',null,  0,0,0,0,0,0,0,0, 'R' ,  null,1
INSERT INTO #dati  SELECT 1,'1) Utilizzo di riserve di Patrimonio netto derivanti dalla contabilità finanziaria', 'EA1401%', 0,0,0,0,0,0,0,0, 'R' ,  'IV. ALTRI PROVENTI  E RICAVI DIVERSI',1
INSERT INTO #dati  SELECT 1,'2) Altri Proventi e Ricavi Diversi', 'EA1402%', 0,0,0,0,0,0,0,0, 'R' ,'IV. ALTRI PROVENTI  E RICAVI DIVERSI',1 
-------------- Variazioni Rimanenze  ---------------------------------- 
INSERT INTO #dati  SELECT 2,'V. VARIAZIONE RIMANENZE', 'EA1501%', 0,0,0,0,0,0,0,0, 'R',  null,1 
---------- Incremento Immobilizzazioni per lavoro interni ---------------------------------- 
INSERT INTO #dati  SELECT 2,'VI. INCREMENTO IMMOBILIZZAZIONI PER LAVORI INTERNI', 'EA1601%',0,0,0,0,0,0,0,0, 'R' , null,1
----------- TOTALE PROVENTI (A)-----------------------------------------------------------------
...
*/
INSERT INTO #dati  SELECT 2,'VII.  COSTI DEL PERSONALE', null, 0,0,0,0,0,0,0,0, 'C' ,null,1
INSERT INTO #dati  SELECT 1,'1) Costi del personale dedicato alla ricerca e alla didattica', null, 0,0,0,0,0,0,0,0, 'C' ,null,1
INSERT INTO #dati  SELECT 1,'a) Docenti/Ricercatori',  'EB1101%', 0,0,0,0,0,0,0,0, 'C' ,'VII.  COSTI DEL PERSONALE',1
INSERT INTO #dati  SELECT 1,'b) Collaborazioni scientifiche (collaboratori, assegnisti, ecc)', 'EB1102%', 0,0,0,0,0,0,0,0, 'C','VII.  COSTI DEL PERSONALE',1 
INSERT INTO #dati  SELECT 1,'c) Docenti a contratto', 'EB1103%', 0,0,0,0,0,0,0,0, 'C' ,'VII.  COSTI DEL PERSONALE',1
INSERT INTO #dati  SELECT 1,'d) Esperti linguistici', 'EB1104%', 0,0,0,0,0,0,0,0, 'C' ,'VII.  COSTI DEL PERSONALE',1
INSERT INTO #dati  SELECT 1,'e) Altro personale dedicato alla didattica e alla ricerca', 'EB1105%', 0,0,0,0,0,0,0,0, 'C' ,'VII.  COSTI DEL PERSONALE',1
INSERT INTO #dati  SELECT 1,'2) Costi del personale dirigente e tecnico-amministrativo', 'EB1201%', 0,0,0,0,0,0,0,0, 'C','VII.  COSTI DEL PERSONALE',1
...
12)Altri  costi 
*/
INSERT INTO #dati  SELECT 2,'VIII. COSTI DELLA GESTIONE CORRENTE', null, 0,0,0,0,0,0,0,0, 'C'  ,null,1   
INSERT INTO #dati  SELECT 1,'1) Costi per sostegno agli studenti', 'EB2101%', 0,0,0,0,0,0,0,0, 'C', 'VIII. COSTI DELLA GESTIONE CORRENTE',1   
INSERT INTO #dati  SELECT 1,'2) Costi per il diritto allo studio', 'EB2102%', 0,0,0,0,0,0,0,0, 'C'  , 'VIII. COSTI DELLA GESTIONE CORRENTE',1  
IF (@ayear<=2017)  
	SET @label_1 = '3) Costi per la ricerca e l''attività editoriale'
else 
	SET @label_1 = '3) Costi per l''attività editoriale'

INSERT INTO #dati  SELECT 1,@label_1, 'EB2103%', 0,0,0,0,0,0,0,0, 'C', 'VIII. COSTI DELLA GESTIONE CORRENTE',1  
INSERT INTO #dati  SELECT 1,'4) Trasferimenti a partner di progetti coordinati', 'EB2104%',0,0,0,0,0,0,0,0, 'C' , 'VIII. COSTI DELLA GESTIONE CORRENTE',1  
INSERT INTO #dati  SELECT 1, '5) Acquisto materiale consumo per laboratori', 'EB2105%',0,0,0,0,0,0,0,0, 'C'  , 'VIII. COSTI DELLA GESTIONE CORRENTE',1  
INSERT INTO #dati  SELECT 1,'6) Variazione rimanenze di materiale di consumo per laboratori', 'EB2106%',0,0,0,0,0,0,0,0, 'C' , 'VIII. COSTI DELLA GESTIONE CORRENTE',1  
INSERT INTO #dati  SELECT 1,'7)Acquisto di libri, periodici e matariale bibliografico', 'EB2107%', 0,0,0,0,0,0,0,0, 'C', 'VIII. COSTI DELLA GESTIONE CORRENTE',1   
INSERT INTO #dati  SELECT 1,'8) Acquisto di servizi e collaborazioni tecnico gestionali', 'EB2108%',0,0,0,0,0,0,0,0, 'C' , 'VIII. COSTI DELLA GESTIONE CORRENTE',1  
INSERT INTO #dati  SELECT 1,'9) Acquisto altri materiali', 'EB2109%',0,0,0,0,0,0,0,0, 'C' , 'VIII. COSTI DELLA GESTIONE CORRENTE',1   
INSERT INTO #dati  SELECT 1,'10) Variazione delle rimanenze di materiale', 'EB2110%',  0,0,0,0,0,0,0,0, 'C' , 'VIII. COSTI DELLA GESTIONE CORRENTE',1  
INSERT INTO #dati  SELECT 1,'11) Costi per godimento beni di terzi', 'EB2111%',0,0,0,0,0,0,0,0, 'C'  , 'VIII. COSTI DELLA GESTIONE CORRENTE',1  
INSERT INTO #dati  SELECT 1,'12) Altri costi', 'EB2112%', 0,0,0,0,0,0,0,0, 'C', 'VIII. COSTI DELLA GESTIONE CORRENTE',1    
/*	
...
*/
INSERT INTO #dati  SELECT 2,'IX. AMMORTAMENTI E SVALUTAZIONI', null,0,0,0,0,0,0,0,0, 'C' ,null,1
INSERT INTO #dati  SELECT 1,'1) Ammortamenti immobilizzazioni immateriali', 'EB3101%',0,0,0,0,0,0,0,0, 'C','IX. AMMORTAMENTI E SVALUTAZIONI',1
INSERT INTO #dati  SELECT 1,'2) Ammortamenti immobilizzazioni materiali', 'EB3102%', 0,0,0,0,0,0,0,0, 'C','IX. AMMORTAMENTI E SVALUTAZIONI',1 
INSERT INTO #dati  SELECT 1,'3) Svalutazioni immobilizzazioni', 'EB3103%',0,0,0,0,0,0,0,0, 'C','IX. AMMORTAMENTI E SVALUTAZIONI',1 
INSERT INTO #dati  SELECT 1,'4) Svalutazioni dei crediti compresi nell’attivo circolante e nelle disponibilità liquide', 'EB3104%', 0,0,0,0,0,0,0,0, 'C' ,'IX. AMMORTAMENTI E SVALUTAZIONI',1
INSERT INTO #dati  SELECT 2,'X. ACCANTONAMENTI PER RISCHI E ONERI', 'EB4101%', 0,0,0,0,0,0,0,0, 'C', null, 1 
INSERT INTO #dati  SELECT 2,'XI. ONERI DIVERSI DI GESTIONE','EB5101%',0,0,0,0,0,0,0,0, 'C' , null, 1
