...
if exists (select * from dbo.sysobjects where id = object_id(N'[rpt_statopatrimoniale_sub_tree]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [rpt_statopatrimoniale_sub_tree]
GO
...
CREATE PROCEDURE [rpt_statopatrimoniale_sub_tree]
(
@ayear int,
@start datetime,
@stop datetime
...
--SELECT * FROM    #dati  /*WHERE idpatrimony = '23A0004'*/ order by idpatrimony; -- 
