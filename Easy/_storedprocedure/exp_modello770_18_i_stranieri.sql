...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_modello770_18_i_stranieri]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_modello770_18_i_stranieri]
GO
--setuser 'amm'
--setuser'amministrazione'
--exec exp_modello770_18_i_stranieri
CREATE PROCEDURE [exp_modello770_18_i_stranieri]
AS BEGIN
-- OK
