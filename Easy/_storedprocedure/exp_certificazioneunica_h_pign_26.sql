...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_certificazioneunica_h_pign_26]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_certificazioneunica_h_pign_26]
GO  
--setuser 'amministrazione'
CREATE PROCEDURE [exp_certificazioneunica_h_pign_26]
...
----------------------------------al prospetto SY del mod. 770/2025 semplificato ----------------------
-------------------------------------------------------------------------------------------------------
...
-- RECORD DI TIPO "H": Casi particolari operazioni straordinarie
	...
	--Pu essere presente solo  compilata la sezione Somme
	...
	--2025	AU	101	Codice Fiscale debitore   principale
	--2025	AU	102	Somme erogate
	--2025	AU	103	Ritenute operate
	--2025	AU	104	Somme erogate non tassate
	--2025	AU	105 Codice Fiscale debitore   principale
	--2025	AU	106	Somme erogate
	--2025	AU	107	Ritenute operate
	--2025	AU	108	Somme erogate non tassate
...
delete from #expense where idexp in( 
SELECT #expense.idexp FROM #expense
