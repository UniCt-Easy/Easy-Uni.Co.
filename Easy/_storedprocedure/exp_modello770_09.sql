...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_modello770_09]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_modello770_09]
GO
...
CREATE    PROCEDURE [exp_modello770_09] (@recordGH varchar(2)='GH')
AS BEGIN
	declare @statementyear smallint
	set @statementyear = 2009
...
--	set @ayear = @statementyear - 1
	...
	INSERT INTO #modello770 EXEC exp_modello770_09_a

	DECLARE @progr_raggiunto int

	if @recordGH = 'GH'
	begin
		INSERT INTO #modello770 EXEC exp_modello770_09_g '770'
	end

	INSERT INTO #modello770 EXEC exp_modello770_09_h
	...
	INSERT INTO #modello770 EXEC exp_modello770_09_b @numdichquadrog, @numdichquadroh
