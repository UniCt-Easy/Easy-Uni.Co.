...
select 
	...
	CASE  
		WHEN (select idnso_vendita from estimate where idestimkind = ID.idestimkind and yestim=ID.yestim and nestim = ID.nestim) IS NOT NULL AND R.ipa_fe IS NOT NULL  THEN  '#'+ R.ipa_fe +'#'
		ELSE NULL 
