if exists (select * from dbo.sysobjects where id = object_id(N'[exp_certificazioneunica_d_19]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_certificazioneunica_d_19]
GO

-- exec exp_certificazioneunica_d_19  19335 , 1, 'G', {d '2018-12-31'},'S'
CREATE PROCEDURE [exp_certificazioneunica_d_19]
