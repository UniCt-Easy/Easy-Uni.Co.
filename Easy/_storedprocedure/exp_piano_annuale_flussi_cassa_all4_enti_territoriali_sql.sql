...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_piano_annuale_flussi_cassa_all4_enti_territoriali_sql]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_piano_annuale_flussi_cassa_all4_enti_territoriali_sql]
GO
...
GO
----------------------------------------------------------------------------
---------------- solo per monitoraggio della sp di calcolo------------------
---------------- non deve andare in linea ----------------------------------
----------------------------------------------------------------------------
CREATE    PROCEDURE [exp_piano_annuale_flussi_cassa_all4_enti_territoriali_sql]
(
...
--- exec exp_piano_annuale_flussi_cassa_all4_enti_territoriali_sql 2025, {ts '2025-09-04 00:00:00'} , 'S', 103,104
AS BEGIN
...
WITH FL_VAR_PREV_USCITE_BUDGETPURO AS
		(
			...
			ORDER BY  printingorder   
END
SELECT '#OUTPUT_DATA_N_MENO_2',* FROM #OUTPUT_DATA_N_MENO_2
SELECT '#OUTPUT_DATA',* FROM #OUTPUT_DATA
 ...
 --   END  AS 'Conf. Bilancio'
	...
	IF ( @trimestre) = 0  -- solo previsioni
		...
		--- 2) IN ASSENZA DI DATI STORICI RELATIVI AI FLUSSI DI CASSA ANNO PRECEDENTE RIPARTISCO LA PREVISIONE INIZIALE AL 25% SU OGNI TRIMESTRE
			...
			T2.trimestre_1, T3.curramount_1 as es_n_2_effettivo_1,	perc_1, convert(decimal(19,2),round((perc_1*T2.curramount/100),2)) as previsioni_1, 
			T2.trimestre_2, T3.curramount_2 as es_n_2_effettivo_2,	perc_2, convert(decimal(19,2),round((perc_2*T2.curramount/100),2)) as previsioni_2,
			T2.trimestre_3, T3.curramount_3 as es_n_2_effettivo_3,	perc_3, convert(decimal(19,2),round((perc_3*T2.curramount)/100,2)) as previsioni_3,
			/*ultimo trimestre chiude la percentuale 100% per differenza dagli importi degli altri tre trimestri*/
			T2.trimestre_4, T3.curramount_4 as es_n_2_effettivo_4,	perc_4, 
	...
	IF (@trimestre = 1)
		BEGIN
			...
			1 as trimestre_1,T3.curramount_1 as es_n_2_effettivo_1, T2.NuovaPercTr1, T2.NuovaPrevTr1 as effettivo_1, 
			2 as trimestre_2,T3.curramount_2 as es_n_2_effettivo_2, T2.NuovaPercTr2, T2.NuovaPrevTr2 as previsioni_2,
			3 as trimestre_3,T3.curramount_3 as es_n_2_effettivo_3, T2.NuovaPercTr3, T2.NuovaPrevTr3 as previsioni_3,
			4 as trimestre_4,T3.curramount_4 as es_n_2_effettivo_4, T2.NuovaPercTr4, T2.NuovaPrevTr4 as previsioni_4
			...
			1 as trimestre_1,T4.curramount_1 as es_n_2_effettivo_1,T3.perc_1 as  NuovaPercTr1, 0 as effettivo_1, 
			2 as trimestre_2,T4.curramount_2 as es_n_2_effettivo_2,T3.perc_2 as  NuovaPercTr2, 0 as previsioni_2,
			3 as trimestre_3,T4.curramount_3 as es_n_2_effettivo_3,T3.perc_3 as  NuovaPercTr3, 0 as previsioni_3,
			4 as trimestre_4,T4.curramount_4 as es_n_2_effettivo_4,T3.perc_4 as  NuovaPercTr4, 0 as previsioni_4
			FROM #PERCENTUALI   T3 
	...
	IF (@trimestre = 2)
		BEGIN
			SELECT @startfloatfund as fondocassainiziale, @ayear as esercizio, @trimestre as trimestre,
				T2.kind as tipo , T2.label as descrizione, T2.printingorder as ordinestampa, 
				T2.PrevisioneTotale  as previsione,

				1 as trimestre_1, T3.curramount_1 as es_n_2_effettivo_1, T2.NuovaPercTr1, T2.NuovaPrevTr1 as effettivo_1, 
				2 as trimestre_2, T3.curramount_2 as es_n_2_effettivo_2,T2.NuovaPercTr2, T2.NuovaPrevTr2 as effettivo_2,
				3 as trimestre_3, T3.curramount_3 as es_n_2_effettivo_3,T2.NuovaPercTr3, T2.NuovaPrevTr3 as previsioni_3,
				4 as trimestre_4, T3.curramount_4 as es_n_2_effettivo_4,T2.NuovaPercTr4, T2.NuovaPrevTr4 as previsioni_4
			...
			SELECT @startfloatfund as fondocassainiziale, @ayear as esercizio , @trimestre as trimestre,
				T3.kind as tipo, T3.label as descrizione, T3.printingorder as ordinestampa, 0  as previsione,
				1 as trimestre_1, T4.curramount_1 as es_n_2_effettivo_1,T3.perc_1 as  NuovaPercTr1, 0 as effettivo_1, 
				2 as trimestre_2, T4.curramount_2 as es_n_2_effettivo_2,T3.perc_2 as  NuovaPercTr2, 0 as effettivo_2,
				3 as trimestre_3, T4.curramount_3 as es_n_2_effettivo_3,T3.perc_3 as  NuovaPercTr3, 0 as previsioni_3,
				4 as trimestre_4, T4.curramount_4 as es_n_2_effettivo_4,T3.perc_4 as  NuovaPercTr4, 0 as previsioni_4
				FROM #PERCENTUALI   T3 
	...
	IF (/*DATEPART(q,isnull(@date_rif,GetDate())) -1)*/ @trimestre  = 3)
		BEGIN
			SELECT @startfloatfund as fondocassainiziale, @ayear as esercizio, @trimestre as trimestre,
				...
				1 as trimestre_1,T3.curramount_1 as es_n_2_effettivo_1, T2.NuovaPercTr1, T2.NuovaPrevTr1 as effettivo_1, 
				2 as trimestre_2,T3.curramount_2 as es_n_2_effettivo_2, T2.NuovaPercTr2, T2.NuovaPrevTr2 as effettivo_2,
				3 as trimestre_3,T3.curramount_3 as es_n_2_effettivo_3, T2.NuovaPercTr3, T2.NuovaPrevTr3 as effettivo_3,
				4 as trimestre_4,T3.curramount_4 as es_n_2_effettivo_4, T2.NuovaPercTr4, T2.NuovaPrevTr4 as previsioni_4
			FROM #PERCENTUALI_RICALCOLATE  T2
			LEFT OUTER JOIN #OUTPUT_DATA_N_MENO_2 T3 ON T2.printingorder = T3.printingorder
			UNION 
			SELECT @startfloatfund as fondocassainiziale, @ayear as esercizio, @trimestre as trimestre,
				...
				1 as trimestre_1,T4.curramount_1 as es_n_2_effettivo_1, T3.perc_1 as  NuovaPercTr1, 0 as effettivo_1, 
				2 as trimestre_2,T4.curramount_2 as es_n_2_effettivo_2, T3.perc_2 as  NuovaPercTr2, 0 as effettivo_2,
				3 as trimestre_3,T4.curramount_3 as es_n_2_effettivo_3, T3.perc_3 as  NuovaPercTr3, 0 as effettivo_3,
				4 as trimestre_4,T4.curramount_4 as es_n_2_effettivo_4, T3.perc_4 as  NuovaPercTr4, 0 as previsioni_4
				FROM #PERCENTUALI   T3 
				LEFT OUTER JOIN #OUTPUT_DATA_N_MENO_2 T4 ON T4.printingorder = T3.printingorder
				WHERE NOT EXISTS (SELECT * FROM #PERCENTUALI_RICALCOLATE T2 WHERE T2.printingorder= T3.printingorder)
	...
	IF (@trimestre  = 4)   
		BEGIN
				...
				2 as trimestre_2, T3.curramount_2 as es_n_2_effettivo_2,T2.NuovaPercTr2, T2.NuovaPrevTr2 as effettivo_2,
				3 as trimestre_3, T3.curramount_3 as es_n_2_effettivo_3,T2.NuovaPercTr3, T2.NuovaPrevTr3 as effettivo_3,
				4 as trimestre_4, T3.curramount_4 as es_n_2_effettivo_4,T2.NuovaPercTr4, T2.NuovaPrevTr4 as effettivo_4
			FROM #PERCENTUALI_RICALCOLATE  T2
			LEFT OUTER JOIN #OUTPUT_DATA_N_MENO_2 T3 ON T3.printingorder = T2.printingorder
			UNION 
				SELECT @startfloatfund as fondocassainiziale, @ayear as esercizio, @trimestre as trimestre,
				...
				2 as trimestre_2, T4.curramount_2 as es_n_2_effettivo_2,T3.perc_2 as  NuovaPercTr2, 0 as effettivo_2,
				3 as trimestre_3, T4.curramount_3 as es_n_2_effettivo_3,T3.perc_3 as  NuovaPercTr3, 0 as effettivo_3,
				4 as trimestre_4, T4.curramount_4 as es_n_2_effettivo_4,T3.perc_4 as  NuovaPercTr4, 0 as effettivo_4
				FROM #PERCENTUALI   T3 
				LEFT OUTER JOIN #OUTPUT_DATA_N_MENO_2 T4 ON T4.printingorder = T3.printingorder
				WHERE NOT EXISTS (SELECT * FROM #PERCENTUALI_RICALCOLATE T2 WHERE T2.printingorder= T3.printingorder)
				ORDER BY 6 /*PRINTINGORDER*/
...
SET ANSI_NULLS ON 
GO
--exec exp_piano_annuale_flussi_cassa_all4_enti_territoriali 2025,  {ts '2025-09-25 00:00:00'}, 'S', 10,11	  --arpal
--exec exp_piano_annuale_flussi_cassa_all4_enti_territoriali_sql 2025,  {ts '2025-09-25 00:00:00'}, 'S', 10,11	  --arpal
