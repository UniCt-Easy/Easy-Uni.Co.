...
begin
	...
	insert into #tributi values ('R','126E', 'RR', '00MM','AAAA') --ADDIZIONALE REGIONALE ALL''IRPEF TRATTENUTA DAL SOSTITUTO D''IMPOSTA A SEGUITO DI ASSISTENZA FISCALE
	...
	insert into #tributi values ('I','DM10', null,'MMAAAA',null)
