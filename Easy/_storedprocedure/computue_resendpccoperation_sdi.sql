...
if exists (select * from dbo.sysobjects where id = object_id(N'[computue_resendpccoperation_sdi]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [computue_resendpccoperation_sdi]
GO
...
CREATE procedure computue_resendpccoperation_sdi( 
	@idpcc int 
	)
	as
begin
...
-- setuser 'amministrazione'
 --exec computue_resendpccoperation_sdi 622
