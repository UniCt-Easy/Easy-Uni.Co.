...
if exists (SELECT * from dbo.sysobjects where id = object_id(N'[exp_modello770_pat_23]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_modello770_pat_23]
GO
...
CREATE  PROCEDURE [exp_modello770_pat_23] 
AS BEGIN
-- setuser'amministrazione'
-- setuser 'amm'
-- exec exp_modello770_pat_23  
