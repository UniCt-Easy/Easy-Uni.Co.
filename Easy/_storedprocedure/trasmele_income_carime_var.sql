...
CREATE        PROCEDURE [trasmele_income_carime_var]
(
	@y int,
	@n int
)
...
LEFT OUTER JOIN expensetotal et
	ON et.idexp = ey.idexp
WHERE d.kpro IN (SELECT kpro FROM #proceedsvar) 
AND ((il.flag&32) <> 0) 
...
(
	...
	sortcode, sorting, curramount, amount, amount_expense,
	cupcodefin, cupcodeupb, cupcodeincome, progressive,flagpendingincome
)
SELECT
