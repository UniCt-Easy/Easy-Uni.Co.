...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_certificazioneunica_percipienti_h_23]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_certificazioneunica_percipienti_h_23]
GO
 --setuser'amministrazione'
--exec exp_certificazioneunica_percipienti_h_23  PRSRCC87R11H224K
CREATE PROCEDURE [exp_certificazioneunica_percipienti_h_23]
(
	@cf varchar(20)
 )
...
select distinct #expense2022.idreg from #expense2022

SELECT * FROM #percipienti_record_H_2022
