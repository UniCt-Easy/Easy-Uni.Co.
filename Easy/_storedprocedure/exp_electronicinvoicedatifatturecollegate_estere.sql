...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_electronicinvoicedatifatturecollegate_estere]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_electronicinvoicedatifatturecollegate_estere]
GO
...
CREATE procedure exp_electronicinvoicedatifatturecollegate_estere(@yelectronicinvoice smallint=null, @nelectronicinvoice int=null, @yinv int=null,	@ninv int=null,	@idinvkind int=null) as
begin
-- exec exp_electronicinvoicedatifatturecollegate_estere 2021, 1
