...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_modello770_25_b]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_modello770_25_b]
GO
...
GO
 ...
 --setuser 'amm'
-- exec exp_modello770_25_b 1,1,1
create PROCEDURE [exp_modello770_25_b]
(
	@numdichquadrog int,
	@numdichquadroh int,
	@numdichquadroi int
