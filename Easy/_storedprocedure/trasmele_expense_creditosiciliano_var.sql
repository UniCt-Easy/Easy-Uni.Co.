...
if exists (select * from dbo.sysobjects where id = object_id(N'[trasmele_expense_creditosiciliano_var]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [trasmele_expense_creditosiciliano_var]
GO
...
CREATE        PROCEDURE [trasmele_expense_creditosiciliano_var]
(
	@y int,
	@n int
)
...
(
	...
	txt varchar(200), 
	expenselast_paymentdescr varchar(200),
	fulfilled char(1),
...
(
	...
	numero_conto_corrente_beneficiario varchar(12),
