...
if exists (select * from dbo.sysobjects where id = object_id(N'[rpt_budgeteconomicoufficialeDI34_2025_puro]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [rpt_budgeteconomicoufficialeDI34_2025_puro]
GO
...
-- exec rpt_budgeteconomicoufficialeDI34_2025 2025, NULL, '00010004', 'S', NULL, NULL, NULL, NULL, NULL, 'N'
-- go
-- exec rpt_budgeteconomicoufficialeDI34_2025 2025, NULL, '00010004', 'S', NULL, NULL, NULL, NULL, NULL, 'S'
-- go
--exec rpt_budgeteconomicoufficialeDI34_2025_puro 2025, '00010004','S'

CREATE      PROCEDURE [rpt_budgeteconomicoufficialeDI34_2025_puro](
...
set @A_I1_ProventiPerLaDidattica = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
...
set @A_I2_ProventiDaRicercheCommissionate = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @A_I3_ProventiDaRicercheConFinanziamento = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @A_II1_ContributiMIUR = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @A_II2_ContributiRegioni = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @A_II3_ContributiAltreAmministrazioni = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @A_II4_ContributiUE = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @A_II5_ContributiUniversita = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @A_II6_ContributiAltriPubblici = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @A_II7_ContributiAltriPrivati = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
------------set @A_III_ProventiPerAttivitaAssistenziale = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
------------	FROM accountyear 
------------	join accountview A
------------		on accountyear.idacc = A.idacc
------------	JOIN upb U
...
set @A_III_ProventiPerGestioneDiretta = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @A_IV1_UtilizzoRiservePatrimonioNetto = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @A_IV2_AltriProventi = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @A_V_VariazioniRimanenze = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @A_VI_IncrementoImmobilizzazioni = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_VII1a_CostiDocentiRicercatori = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_VII1b_CollaborazioniScientifiche = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_VII1c_DocentiAContratto = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_VII1d_EspertiLinguistici = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_VII1e_AltroPersonale = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_VII2_CostiPersonaleDirigente = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_VIII1_CostiSostegnoStudenti = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
declare @B_VIII2_CostiDirittoStudio decimal(19,2)set @B_VIII2_CostiDirittoStudio = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_VIII3_CostiRicercaAttivitaEditoriale = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_VIII4_TrasferimentiPartner = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_VIII5_AcquistoMaterialeConsumo = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
declare @B_VIII6_VariazioneRimanenze decimal(19,2)set @B_VIII6_VariazioneRimanenze = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
	...
	WHERE accountyear.ayear = @ayear
		...
		AND (@idsor01 IS NULL OR U.idsor01 = @idsor01)	AND (@idsor02 IS NULL OR U.idsor02 = @idsor02)	AND (@idsor03 IS NULL OR U.idsor03 = @idsor03)	
		AND (@idsor04 IS NULL OR U.idsor04 = @idsor04)	AND (@idsor05 IS NULL OR U.idsor05 = @idsor05)
		AND S.sortcode LIKE 'EB2106%'),0)declare @B_VIII7_AcquistoLibri decimal(19,2)set @B_VIII7_AcquistoLibri = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_VIII8_AcquistoServizi = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_VIII9_AcquistoAltriMateriali = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
declare @B_VIII10_VariazioneRimanenze decimal(19,2)set @B_VIII10_VariazioneRimanenze = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_VIII11_CostiGodimento = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_VIII12_AltriCosti = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_IX1_AmmortamentiImmobImmateriali = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
declare @B_IX2_AmmortamentiImmobMateriali decimal(19,2)set @B_IX2_AmmortamentiImmobMateriali = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
	...
	WHERE accountyear.ayear = @ayear
		...
		AND (@idsor01 IS NULL OR U.idsor01 = @idsor01)	AND (@idsor02 IS NULL OR U.idsor02 = @idsor02)	AND (@idsor03 IS NULL OR U.idsor03 = @idsor03)	
		AND (@idsor04 IS NULL OR U.idsor04 = @idsor04)	AND (@idsor05 IS NULL OR U.idsor05 = @idsor05)
		AND S.sortcode LIKE 'EB3102%'),0)declare @B_IX3_SvalutazioniImmobilizzazioni decimal(19,2)set @B_IX3_SvalutazioniImmobilizzazioni = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
	...
	WHERE accountyear.ayear = @ayear
		...
		AND (@idsor01 IS NULL OR U.idsor01 = @idsor01)	AND (@idsor02 IS NULL OR U.idsor02 = @idsor02)	AND (@idsor03 IS NULL OR U.idsor03 = @idsor03)	
		AND (@idsor04 IS NULL OR U.idsor04 = @idsor04)	AND (@idsor05 IS NULL OR U.idsor05 = @idsor05)
		AND S.sortcode LIKE 'EB3103%'),0)declare @B_IX4_SvalutazioniCrediti decimal(19,2)set @B_IX4_SvalutazioniCrediti = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_X_AccantonamentiRischiOneri = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @B_XI_OneriDversiGestione = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
declare @C_1ProventiFinanziari decimal(19,2)set @C_1ProventiFinanziari = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @C_3Utili = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @C_3Perdite = ISNULL(( SELECT - SUM(accountyear.prevision)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @D_2Svalutazioni_orig = ISNULL(( SELECT - SUM(accountyear.prevision)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @E_1ProventiStraordinari = ISNULL(( SELECT SUM(accountyear.prevision*A.economicbudget_sign_value)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @E_2OneriStraordinari_orig = ISNULL(( SELECT  SUM(accountyear.prevision)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
...
set @F_Imposte = ISNULL(( SELECT - SUM(accountyear.prevision)
	FROM accountyear 
	join accountview A
		on accountyear.idacc = A.idacc
	JOIN upb U
