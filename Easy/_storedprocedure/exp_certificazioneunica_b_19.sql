...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_certificazioneunica_b_19]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_certificazioneunica_b_19]
GO
...
-- exec exp_certificazioneunica_b_19 1,1,'S'
create PROCEDURE [exp_certificazioneunica_b_19]
(
	@numdichquadrog int,
	@numdichquadroh int,
