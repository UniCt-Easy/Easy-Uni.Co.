...
declare @is_variation char(1) 
	...
	begin	
		if (@trasferisci='S')									
		begin 
			update epexpyear set amount=@newarrear, amount2=@new2, amount3=@new3, amount4=@new4, amount5=null,					
		...
		if (@trasferisci='S') begin
			...
			if(	@newidacc is not null and @idupb is not null 	)
				begin 
					...
					VALUES(@idmov,@newayear,@newidacc,@idupb,@newarrear,@new2,@new3, @new4, null, 'trg_updatearrearsepexp',GETDATE(),'trg_updatearrearsepexp',GETDATE())
				end
		end
	END
