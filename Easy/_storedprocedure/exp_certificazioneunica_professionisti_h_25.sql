...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_certificazioneunica_professionisti_h_25]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_certificazioneunica_professionisti_h_25]
GO
 --setuser'amm'
 -- setuser 'amministrazione'
--exec exp_certificazioneunica_professionisti_h_24  TSSNLS78S53D976S 
CREATE PROCEDURE [exp_certificazioneunica_professionisti_h_25]
(
	@cf varchar(20)
 )
...
AS BEGIN
	...
	CREATE TABLE #percipienti_record_H_2024
	(
		idreg int,
		title varchar(150),
		cf varchar(50),
	...
	INSERT INTO #expense2024 --#percipienti_record_H_2024
		(
			idexp,
			idreg,
			title,
...
insert into #percipienti_record_H_2024
select #expense2024.idreg,
		#expense2024.title,
		#expense2024.cf,
		#expense2024.p_iva,
		#expense2024.ycon,  
		...
		#expense2024.ymov, 
		#expense2024.nmov, 
		#expense2024.curramount,
		#expense2024.codeser,
		#expense2024.ivakind,
		#expense2024.sortcode,
		#expense2024.sorting,
		#expense2024.taxref, 
		#expense2024.tax, 
		#expense2024.taxablenet,
		#expense2024.employtax--,
		--#expense2024.spese_nonimp,
		--#expense2024.spese_imp
from #expense2024
	...
	FROM	#percipienti_record_H_2024
...
GO
 ...
 --exec exp_certificazioneunica_professionisti_h_24  null