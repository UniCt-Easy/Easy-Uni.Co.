...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_calcolo_missione_idsor01]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_calcolo_missione_idsor01]
GO
...
-- [exp_calcolo_missione_idsor01] 2021, null, null
CREATE PROCEDURE  [exp_calcolo_missione_idsor01]
(
  @yitineration INT,
...
SELECT 
	...
	s.description as [Descr. Centro di Costo] 
FROM  itineration
