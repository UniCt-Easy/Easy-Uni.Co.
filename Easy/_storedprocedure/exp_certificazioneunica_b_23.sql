...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_certificazioneunica_b_23]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_certificazioneunica_b_23]
GO
...
-- exec exp_certificazioneunica_b_23 1,1,'S'
create PROCEDURE [exp_certificazioneunica_b_23]
(
	@numdichquadrog int,
	@numdichquadroh int,
...
DECLARE @HRB016 varchar(50)
	...
	INSERT INTO #recordb (progr,  modulo,quadro, riga, colonna, intero)  VALUES(1,1, 'HRB', 1, '037', 0)
	...
	BEGIN
		...
		INSERT INTO #recordb (progr, modulo,quadro, riga, colonna, stringa) VALUES(1, 1, 'FIR', 1, '001', ISNULL(@manager_annotations,'') )
	END
