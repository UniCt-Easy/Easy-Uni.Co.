...
if exists (select * from dbo.sysobjects where id = object_id(N'[get_assetvalueatdate]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [get_assetvalueatdate]
GO

/*
declare @originalvalue	decimal (19,2) ;
declare @totale  decimal (19,2) ;
exec get_assetvalueatdate 721,1,'31-12-2018', @originalvalue output ,@totale output

print @originalvalue
print @totale
*/
CREATE    PROCEDURE [get_assetvalueatdate]
(
	 @idasset int,
	 @idpiece int,
	 @date    datetime,
