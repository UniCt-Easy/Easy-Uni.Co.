...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_certificazioneunica_h_pign_23]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_certificazioneunica_h_pign_23]
GO  
--setuser 'amministrazione'
CREATE PROCEDURE [exp_certificazioneunica_h_pign_23]
