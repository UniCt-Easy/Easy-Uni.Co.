...
if exists (select * from dbo.sysobjects where id = object_id(N'[trasmele_income_bppugliese_var]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [trasmele_income_bppugliese_var]
GO
...
CREATE  PROCEDURE [trasmele_income_bppugliese_var]
(
	@y int,
	@n int
)
...
DECLARE @ABI_codebppugliese varchar(5)
SET @ABI_codebppugliese = '05262'   -- 05262   BANCA POPOLARE PUGLIESE 
...
SET @codice_ABI_BT = @ABI_codebppugliese
---------------------------------------------
----- fine testata flusso -------------------
---------------------------------------------
