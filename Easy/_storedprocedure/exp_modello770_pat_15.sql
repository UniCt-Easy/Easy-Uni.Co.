if exists (SELECT * from dbo.sysobjects where id = object_id(N'[exp_modello770_pat_15]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_modello770_pat_15]
GO
...
CREATE  PROCEDURE [exp_modello770_pat_15] 
AS BEGIN
-- exec exp_modello770_pat_15  
