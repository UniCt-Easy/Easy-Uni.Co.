...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_certificazioneunica_h_20]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_certificazioneunica_h_20]
GO
 
 --setuser 'amministrazione'
 --declare @newProg int
 --exec exp_certificazioneunica_h_20 148558,1, 'N', @newProg out
 --select @newProg
CREATE PROCEDURE [exp_certificazioneunica_h_20]
...
-- Sezione dichiarativa	
	...
	update #expense2019 set motive770 = motive770service.idmot,
		...
		where motive770service.idser = #expense2019.idser
		...
		SELECT 
			#expense2019.employtaxamount,
			#expense2019.idexp,
			#expense2019.idser,
			#expense2019.motive770,
			#expense2019.socialseccode,
			#expense2019.cfagency,
			#expense2019.titleagency 
		FROM #expense2019
		join expenselink  			on expenselink.idchild = #expense2019.idexp			and nlevel = @expensephase
 ...
 --SELECT * FROM #recHNonArrot
	...
	declare @cursore cursor
		...
		begin
			...
			exec exp_certificazioneunica_d_20  @idreg, @newprogrCom, 'H',NULL, @print
...
insert into #recordH (progr,modulo, quadro, riga, colonna, stringa,decimale, intero, data)
			exec exp_certificazioneunica_h_pign_20  @idreg, @newprogrCom, @modulo, @fattoprestazioni,  @inseritopignoramenti out, @newmodulo out
...
---  
 ...
 --declare @newProg int
 --exec exp_certificazioneunica_h_20 1126,3, 'N', @newProg out
