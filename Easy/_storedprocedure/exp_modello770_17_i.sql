...
if exists (select * from dbo.sysobjects where id = object_id(N'[exp_modello770_17_i]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_modello770_17_i]
GO
...
--setuser 'amm' 
--exec exp_modello770_17_i
CREATE PROCEDURE [exp_modello770_17_i]
AS BEGIN

-------------------------------------------------------------------------------------------------------
----------------------------------------- RECORD DI TIPO "I": Dati relativi ---------------------------
----------------------------------al prospetto SY del mod. 770/2017 -----------------------------------
-------------------------------------------------------------------------------------------------------
...
-- RECORD DI TIPO "I": Dati relativi al prospetto SY del mod. 770/2017 
