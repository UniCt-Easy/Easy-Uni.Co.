if exists (select * from dbo.sysobjects where id = object_id(N'[exp_modello770_14_i]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [exp_modello770_14_i]
GO
...
CREATE PROCEDURE [exp_modello770_14_i]
AS BEGIN

-------------------------------------------------------------------------------------------------------
----------------------------------------- RECORD DI TIPO "I": Dati relativi ---------------------------
----------------------------------al prospetto SY del mod. 770/2014 semplificato ----------------------
-------------------------------------------------------------------------------------------------------
...
-- RECORD DI TIPO "I": Dati relativi al prospetto SY del mod. 770/2013 semplificato
...
SELECT 
		#expense2013.cf_reg,
		#expense2013.cf_reg_distrained,
		isnull(sum(#expense2013.taxablenet),0),
		isnull(sum(#expense2013.employtax),0), 
		isnull(sum(#expense2013.admintax),0),
		isnull(sum(#expense2013.grossamount),0),--Importo Lordo del Pagamento
		#expense2013.codeser 
FROM #expense2013
GROUP BY #expense2013.cf_reg,
		#expense2013.cf_reg_distrained,#expense2013.codeser
