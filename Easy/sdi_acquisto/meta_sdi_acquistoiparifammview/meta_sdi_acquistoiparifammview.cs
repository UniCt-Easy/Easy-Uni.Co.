...
namespace meta_sdi_acquistoiparifammview {
    public class Meta_sdi_acquistoiparifammview : Meta_easydata {
        public Meta_sdi_acquistoiparifammview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "sdi_acquistoiparifammview") {
