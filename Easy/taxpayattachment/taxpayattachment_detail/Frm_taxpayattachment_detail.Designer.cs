...
namespace taxpayattachment_detail
{
	partial class Frm_taxpayattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new taxpayattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "taxpayattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "taxpayattachment.idattachmentkind";
			...
			this.Name = "Frm_taxpayattachment_detail";
			this.Text = "Frm_taxpayattachment_detail";
