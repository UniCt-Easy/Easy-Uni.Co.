...
private void initClass() {
	...
	C.AllowDBNull=false;
	ttaxpayattachment.Columns.Add(C);
	ttaxpayattachment.Columns.Add( new DataColumn("idfilestorage", typeof(string)));
	...
	var cChild = new []{taxpayattachment.Columns["idattachmentkind"]};
	Relations.Add(new DataRelation("attachmentkind_taxpayattachment",cPar,cChild,false));
