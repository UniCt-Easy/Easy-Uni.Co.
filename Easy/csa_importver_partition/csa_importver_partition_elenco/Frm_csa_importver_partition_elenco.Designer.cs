...
namespace csa_importver_partition_elenco {
    partial class Frm_csa_importver_partition_elenco {
        ...
        private void InitializeComponent() {
			this.DS = new csa_importver_partition_elenco.vistaForm();
			...
			this.grpVoceCSA = new System.Windows.Forms.GroupBox();
			...
			this.tabControl1.Size = new System.Drawing.Size(713, 315);
			...
			this.tabPage1.Size = new System.Drawing.Size(705, 289);
			...
			this.gboxclassSiope.Location = new System.Drawing.Point(335, 18);
			this.gboxclassSiope.Name = "gboxclassSiope";
			this.gboxclassSiope.Size = new System.Drawing.Size(339, 132);
			this.gboxclassSiope.TabIndex = 19;
			...
			this.txtDenomSiope.Size = new System.Drawing.Size(229, 76);
			...
			this.txtCodiceSiope.Tag = "sorting.sortcode?csa_importver_partitionview.sortcode_siope";
			// 
			...
			this.grpBilancioVersamento.Location = new System.Drawing.Point(20, 157);
			...
			this.txtBilancio.Tag = "fin.codefin";
			// 
			// btnBilancio
			// 
			...
			this.gboxUPB.Location = new System.Drawing.Point(22, 18);
			...
			this.gboxSpesa.Location = new System.Drawing.Point(338, 157);
			...
			this.gboxSpesa.Text = "Movimento di Spesa a cui collegare il Versamento";
			// 
			// label7
			// 
			...
			this.txtNum.Tag = "expenseview.nmov?csa_importver_partitionview.nmov";
			...
			this.txtEserc.Tag = "expenseview.ymov.year?csa_importver_partitionview.ymov.year";
			...
			this.cmbFaseSpesa.Tag = "expenseview.nphase?csa_importver_partitionview.nphaseexpense";
			...
			this.btnSpesa.Size = new System.Drawing.Size(161, 23);
			...
			this.tabPage2.Size = new System.Drawing.Size(705, 289);
			...
			// gboxImpegnoBudget
			// 
			this.gboxImpegnoBudget.Controls.Add(this.label2);
			...
			this.gboxImpegnoBudget.Size = new System.Drawing.Size(427, 92);
			...
			this.btnLinkEpExp.Size = new System.Drawing.Size(181, 23);
			...
			this.txtImporto.Tag = "csa_importver_partition.amount?csa_importver_partitionview.amount";
			// 
			// label11
			// 
			...
			this.gBoxImporto.Location = new System.Drawing.Point(281, 12);
			this.gBoxImporto.Name = "gBoxImporto";
			this.gBoxImporto.Size = new System.Drawing.Size(144, 46);
			this.gBoxImporto.TabIndex = 22;
			...
			this.txtCompetenza.Tag = "csa_importver.competenza?csa_importver_partitionview.competenza";
			// 
			// gBoxDatiCSA
			// 
			...
			this.gBoxDatiCSA.Location = new System.Drawing.Point(431, 12);
			this.gBoxDatiCSA.Name = "gBoxDatiCSA";
			this.gBoxDatiCSA.Size = new System.Drawing.Size(292, 142);
			this.gBoxDatiCSA.TabIndex = 33;
			...
			// txtEnteCsa
			// 
			this.txtEnteCsa.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.txtEnteCsa.Location = new System.Drawing.Point(6, 62);
			this.txtEnteCsa.Name = "txtEnteCsa";
			this.txtEnteCsa.ScrollBars = System.Windows.Forms.ScrollBars.Vertical;
			this.txtEnteCsa.Size = new System.Drawing.Size(280, 20);
			this.txtEnteCsa.TabIndex = 2;
			this.txtEnteCsa.TabStop = false;
			this.txtEnteCsa.Tag = "csa_importver.ente?csa_importver_partitionview.ente";
			// 
			// label6
			// 
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.txtRuoloCsa.Location = new System.Drawing.Point(6, 102);
			this.txtRuoloCsa.Name = "txtRuoloCsa";
			this.txtRuoloCsa.ScrollBars = System.Windows.Forms.ScrollBars.Vertical;
			this.txtRuoloCsa.Size = new System.Drawing.Size(280, 20);
			this.txtRuoloCsa.TabIndex = 3;
			this.txtRuoloCsa.TabStop = false;
			this.txtRuoloCsa.Tag = "csa_importver.ruolocsa?csa_importver_partitionview.ruolocsa";
			// 
			// txtCapitoloCsa
			// 
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.txtCapitoloCsa.Location = new System.Drawing.Point(6, 22);
			this.txtCapitoloCsa.Name = "txtCapitoloCsa";
			this.txtCapitoloCsa.ScrollBars = System.Windows.Forms.ScrollBars.Vertical;
			this.txtCapitoloCsa.Size = new System.Drawing.Size(280, 20);
			this.txtCapitoloCsa.TabIndex = 1;
			this.txtCapitoloCsa.TabStop = false;
			this.txtCapitoloCsa.Tag = "csa_importver.capitolocsa?csa_importver_partitionview.capitolocsa";
			// 
			// label8
			// 
			...
			this.gboxtipo.Location = new System.Drawing.Point(9, 116);
			this.gboxtipo.Name = "gboxtipo";
			this.gboxtipo.Size = new System.Drawing.Size(230, 37);
			this.gboxtipo.TabIndex = 30;
			...
			this.rdbCompetenza.Tag = "csa_importver.flagcr:C?csa_importver_partitionview.flagcr:C";
			this.rdbCompetenza.Text = "Competenza";
			// 
			// rdbResidui
			// 
			this.rdbResidui.Location = new System.Drawing.Point(107, 16);
			this.rdbResidui.Name = "rdbResidui";
			this.rdbResidui.Size = new System.Drawing.Size(90, 16);
			this.rdbResidui.TabIndex = 1;
			this.rdbResidui.Tag = "csa_importver.flagcr:R?csa_importver_partitionview.flagcr:R";
			...
			this.gBoxImportazione.Location = new System.Drawing.Point(136, 65);
			this.gBoxImportazione.Name = "gBoxImportazione";
			this.gBoxImportazione.Size = new System.Drawing.Size(289, 50);
			this.gBoxImportazione.TabIndex = 32;
			...
			this.txtNumImport.Tag = "csa_import.nimport?csa_importver_partitionview.nimport";
			// 
			// label9
			// 
			...
			this.txtEsercImport.Tag = "csa_import.yimport.year?csa_importver_partitionview.yimport.year";
			// 
			// label10
			// 
			...
			this.GBoxVersamento.Location = new System.Drawing.Point(9, 12);
			this.GBoxVersamento.Name = "GBoxVersamento";
			this.GBoxVersamento.Size = new System.Drawing.Size(105, 51);
			this.GBoxVersamento.TabIndex = 29;
			...
			// txtNumVer
			// 
			this.txtNumVer.Location = new System.Drawing.Point(22, 29);
			this.txtNumVer.Name = "txtNumVer";
			this.txtNumVer.Size = new System.Drawing.Size(56, 20);
			this.txtNumVer.TabIndex = 2;
			this.txtNumVer.Tag = "csa_importver.idver?csa_importver_partitionview.idver";
			// 
			// label14
			// 
			...
			// gBoxContratto
			// 
			this.gBoxContratto.Controls.Add(this.label15);
			this.gBoxContratto.Controls.Add(this.cmbTipoContratto);
			this.gBoxContratto.Controls.Add(this.txtNumContratto);
			this.gBoxContratto.Controls.Add(this.label16);
			this.gBoxContratto.Controls.Add(this.txtEsercContratto);
			this.gBoxContratto.Controls.Add(this.label17);
			this.gBoxContratto.Location = new System.Drawing.Point(7, 154);
			this.gBoxContratto.Name = "gBoxContratto";
			this.gBoxContratto.Size = new System.Drawing.Size(418, 72);
			this.gBoxContratto.TabIndex = 34;
			this.gBoxContratto.TabStop = false;
			this.gBoxContratto.Tag = "AutoChoose.txtNumContratto.default";
			this.gBoxContratto.Text = "Regola specifica CSA";
			// 
			// label15
			// 
			...
			this.cmbTipoContratto.Tag = "csa_importver.idcsa_contractkind?csa_importver_partitionview.idcsa_contractkind";
			...
			this.txtNumContratto.Tag = "csa_contract.ncontract?csa_importver_partitionview.ncontract";
			// 
			// label16
			// 
			this.label16.Location = new System.Drawing.Point(152, 48);
			...
			this.txtEsercContratto.Tag = "csa_contract.ycontract.year?csa_importver_partitionview.ycontract.year";
			// 
			// label17
			// 
			...
			// grpVoceCSA
			// 
			this.grpVoceCSA.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.grpVoceCSA.Controls.Add(this.textBox4);
			this.grpVoceCSA.Controls.Add(this.label4);
			this.grpVoceCSA.Controls.Add(this.txtVoceCsa);
			this.grpVoceCSA.Controls.Add(this.label3);
			this.grpVoceCSA.Location = new System.Drawing.Point(431, 154);
			this.grpVoceCSA.Name = "grpVoceCSA";
			this.grpVoceCSA.Size = new System.Drawing.Size(292, 104);
			this.grpVoceCSA.TabIndex = 35;
			this.grpVoceCSA.TabStop = false;
			// 
			// textBox4
			// 
			...
			this.textBox4.Tag = "csa_importver.vocecsaunified?csa_importver_partitionview.vocecsaunified";
			// 
			// label4
			// 
			...
			// txtVoceCsa
			// 
			this.txtVoceCsa.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.txtVoceCsa.Location = new System.Drawing.Point(11, 25);
			this.txtVoceCsa.Name = "txtVoceCsa";
			this.txtVoceCsa.ScrollBars = System.Windows.Forms.ScrollBars.Vertical;
			this.txtVoceCsa.Size = new System.Drawing.Size(270, 20);
			this.txtVoceCsa.TabIndex = 8;
			this.txtVoceCsa.TabStop = false;
			this.txtVoceCsa.Tag = "csa_importver.vocecsa?csa_importver_partitionview.vocecsa";
			// 
			// label3
			// 
			...
			this.gBoxAnagrafica.Location = new System.Drawing.Point(7, 232);
			this.gBoxAnagrafica.Name = "gBoxAnagrafica";
			this.gBoxAnagrafica.Size = new System.Drawing.Size(415, 48);
			this.gBoxAnagrafica.TabIndex = 36;
			this.gBoxAnagrafica.TabStop = false;
			this.gBoxAnagrafica.Tag = "AutoChoose.txtCredDeb.lista.(active=\'S\')";
			this.gBoxAnagrafica.Text = "Anagrafica Regola specifica CSA";
			// 
			// txtCredDeb
			// 
			...
			this.txtCredDeb.Tag = "registry.title?csa_importver_partitionview.registry";
			// 
			// cmbEnte
			// 
			...
			this.cmbEnte.Tag = "csa_importver.idcsa_agency?csa_importver_partitionview.idcsa_agency";
			this.cmbEnte.ValueMember = "idcsa_agency";
			// 
			// gBoxEnte
			// 
			this.gBoxEnte.Controls.Add(this.cmbEnte);
			this.gBoxEnte.Location = new System.Drawing.Point(9, 287);
			this.gBoxEnte.Name = "gBoxEnte";
			this.gBoxEnte.Size = new System.Drawing.Size(301, 48);
			this.gBoxEnte.TabIndex = 37;
			...
			this.txtCredDebEnte.Size = new System.Drawing.Size(383, 20);
			this.txtCredDebEnte.TabIndex = 1;
			this.txtCredDebEnte.Tag = "registry_agency.title?csa_importver_partitionview.registry_agency";
			// 
			// gBoxAnagraficaEnte
			// 
			...
			this.gBoxAnagraficaEnte.Location = new System.Drawing.Point(323, 294);
			this.gBoxAnagraficaEnte.Name = "gBoxAnagraficaEnte";
			this.gBoxAnagraficaEnte.Size = new System.Drawing.Size(397, 41);
			this.gBoxAnagraficaEnte.TabIndex = 38;
			...
			this.Controls.Add(this.grpVoceCSA);
			...
			this.Name = "Frm_csa_importver_partition_elenco";
			this.Text = "Frm_csa_importver_partition_elenco";
			...
			this.grpVoceCSA.ResumeLayout(false);
			this.grpVoceCSA.PerformLayout();
        ...
        private System.Windows.Forms.GroupBox grpVoceCSA;
