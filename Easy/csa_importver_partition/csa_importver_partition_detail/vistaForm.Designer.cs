...
private void initClass() {
	...
	var cChild = new []{csa_importver_partition.Columns["idupb"]};
	Relations.Add(new DataRelation("upb_csa_importver_partition",cPar,cChild,false));
	...
	Relations.Add(new DataRelation("sorting_csa_importver_partition",cPar,cChild,false));
