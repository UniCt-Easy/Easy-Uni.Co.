...
public DataTable blacklist{get { return this.Tables["blacklist"];}}
...
this.EnforceConstraints = false;
	...
	DataColumn C;
	DataColumn [] key;
	T= new DataTable("blacklist");
	C= new DataColumn("idblacklist", typeof(System.Int32), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);
