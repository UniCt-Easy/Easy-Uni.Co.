...
namespace registryattachment_default {
    public partial class Frm_registryattachment_default : MetaDataForm {
        MetaData Meta;
        public IOpenFileDialog openFileDialog1;

        public Frm_registryattachment_default() {
            InitializeComponent();
        ...
        public void MetaData_AfterFill() {
            DataRow R = DS.registryattachment.Rows[0];
        ...
        private void btnAllega_Click(object sender, EventArgs e) {
            ...
            DataRow Curr = DS.registryattachment.Rows[0];
