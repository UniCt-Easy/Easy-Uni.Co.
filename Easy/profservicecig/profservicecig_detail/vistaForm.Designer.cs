...
public DataTable profservicecig{get { return Tables["profservicecig"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
...
EnforceConstraints = false;
	...
	DataColumn C;
	DataColumn [] key;
	T= new DataTable("profservicecig");
	...
	T.Columns.Add(new DataColumn("!capogruppo", typeof(System.String), ""));
	Tables.Add(T);
//Primary Key
	key = new DataColumn[3]{
	T.Columns["ycon"], 	T.Columns["ncon"], 	T.Columns["cigcode"]};
	T.PrimaryKey = key;
