...
namespace banktransaction_recuperadati {
	...
	/// </summary>
	public class FrmBankTransaction_RecuperaDati : System.Windows.Forms.Form {
		MetaData Meta;
...
//			}
		...
		private bool creaEsitiDoveUnMovimentoBancarioUnMovimentoFinanziario(DataTable tDettMovBanc,
			...
			return lanciaScript(this, destConn, bankTransaction, "Generazione Esiti dove c'Ë un mov. fin. per ogni mov. bancario");
		}
		...
		private bool creaEsitiDoveImportoCorrMovFinIsImportoEsito(DataTable tDettMovBanc, DataTable tMovFin_src,
			...
			return lanciaScript(this, destConn, bankTransaction, "Generazione Esiti dove c'Ë un mov. fin. con importo pari all'esito");
		}
		...
		private bool creaEsitiDoveImportoNettoMovSpesaIsImportoEsito (DataTable tDettMovBanc, DataTable tMovFin_src,
			...
			return lanciaScript(this, destConn, bankTransaction, "Generazione Esiti dove c'Ë un mov. di spesa con importo netto pari all'esito");
		}
		...
		private bool creaEsitiDoveImportoRitMovSpesaIsImportoEsito (DataTable tDettMovBanc, DataTable tMovFin_src,
			...
			return lanciaScript(this, destConn, bankTransaction, "Generazione Esiti dove c'Ë un mov. di spesa con importo ritenute pari all'esito");
		}
