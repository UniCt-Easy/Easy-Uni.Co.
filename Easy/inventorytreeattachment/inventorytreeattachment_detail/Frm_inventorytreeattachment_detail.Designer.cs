...
{
	partial class Frm_inventorytreeattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new inventorytreeattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "inventorytreeattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "inventorytreeattachment.idattachmentkind";
			...
			// 
			// Frm_inventorytreeattachment_detail
			// 
			...
			this.Name = "Frm_inventorytreeattachment_detail";
			this.Text = "Frm_inventorytreeattachment_detail";
