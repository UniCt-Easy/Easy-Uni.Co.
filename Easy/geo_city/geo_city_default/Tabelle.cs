...
*/
			...
			DS.coppie_della_provincia_corrente.nome2Column.Caption = "nome del comune gi‡ memorizzato";
			...
			DS.single2_della_provincia_corrente.denominazioneColumn.Caption = "nome del comune gi‡ memorizzato";
