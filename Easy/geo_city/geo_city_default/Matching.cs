...
namespace geo_city_default//geo_comune//
{
	...
	public class Matching
	{
		...
		private static string eliminaAccenti(string comuneDaTabellaEsterna) 
		{
			...
			comuneConAccenti = comuneConAccenti.Replace("‡ ","A' ");
			comuneConAccenti = comuneConAccenti.Replace("Ë ","E' ");
			comuneConAccenti = comuneConAccenti.Replace("È ","E' ");
			comuneConAccenti = comuneConAccenti.Replace("Ï ","I' ");
			comuneConAccenti = comuneConAccenti.Replace("Ú ","O' ");
			comuneConAccenti = comuneConAccenti.Replace("˘ ","U' ");
			comuneConAccenti = comuneConAccenti.Replace("‡-","A' ");
			comuneConAccenti = comuneConAccenti.Replace("Ë-","E' ");
			comuneConAccenti = comuneConAccenti.Replace("È-","E' ");
			comuneConAccenti = comuneConAccenti.Replace("Ï-","I' ");
			...
			foreach (char c in comuneConAccenti.Remove(comuneConAccenti.Length-1,1))
			{
				switch(c) 
				{
					case '‡': comuneDaCercare += "A"; break;
					case 'Ë': comuneDaCercare += "E"; break;
					case 'È': comuneDaCercare += "E"; break;
					case 'Ï': comuneDaCercare += "I"; break;
					case 'Ú': comuneDaCercare += "O"; break;
					case '˘': comuneDaCercare += "U"; break;
