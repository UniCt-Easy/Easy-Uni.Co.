...
public class instmkwcamporicercaRow: MetaRow  {
	public instmkwcamporicercaRow(DataRowBuilder rb) : base(rb) {} 
...
public class instmkwcamporicercaTable : MetaTableBase<instmkwcamporicercaRow> {
	public instmkwcamporicercaTable() : base("instmkwcamporicerca"){
