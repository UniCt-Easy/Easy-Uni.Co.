...
ï»¿namespace csa_importver_partition_expense_detail {
    partial class Frm_csa_importver_partition_expense_detail {
        /// <summary>
        ...
        private void InitializeComponent() {
			...
			this.DS = new csa_importver_partition_expense_detail.vistaForm();
			...
			this.txtImporto.Tag = "csa_importver_partition_expense.amount";
			// 
			// groupBox4
			// 
			...
			this.txtNumRiep.Tag = "csa_importver_partition_expense.idver";
			// 
			// label6
			// 
			...
			this.textBox1.Tag = "csa_importver_partition_expense.ndetail";
			// 
			// label1
			// 
			...
			// 
			// Frm_csa_importver_partition_expense_detail
			// 
			...
			this.Name = "Frm_csa_importver_partition_expense_detail";
			this.Text = "Frm_csa_importver_partition_expense_detail";
