...
namespace meta_csa_importver_partition_expenseview {
    /// <summary>
    /// </summary>
    public class Meta_csa_importver_partition_expenseview :Meta_easydata {
        public Meta_csa_importver_partition_expenseview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "csa_importver_partition_expenseview") {
