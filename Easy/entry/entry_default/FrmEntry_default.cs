	...
	public class FrmEntry_default : System.Windows.Forms.Form {
        ...
        void AggiustaDateCompetenzaScrittureConRateiAssociati() {
            ...
            foreach (DataRow RRateo in DS.entrydetailaccrual.Rows) {
                ...
                if (CStartDet.CompareTo(CStartRateo) > 0) {//occhio: qui c'Ë il GREATER THAN
            ...
            //la data Ë posta al 1/1 dell'anno successivo alla data fine del rateo associato sempre se non Ë gi‡ superiore a quel valore
            foreach (DataRow RRateo in DS.entrydetailaccrual.Select()) {
                ...
                DateTime CStartDet = (DateTime)datestartdet;
                if (CStartDet.CompareTo(CStartRateo) < 0) {  //occhio: qui c'Ë il LESS THAN
                    myR[0]["competencystart"] = CStartRateo;
                }
        ...
        void RicalcolaRatei() {
            ...
            if (DS.entrydetailaccrual.Select().Length == 0) return; //Se Ë una scrittura puramente manuale non fa nulla
            ...
            foreach (DataRow RC in DS.entrydetail.Select()) {
                ...
                foreach (DataRow Rateo in Ratei) {
                    ...
                    //Se l'anno della scrittura collegata Ë l'anno attuale allora Ë un rateo relativo all'upb pluriennale
