...
namespace meta_instmusersasd {
public class instmusersasdRow: MetaRow  {
	public instmusersasdRow(DataRowBuilder rb) : base(rb) {} 
	...
	public Int32? idinstmusersasd{ 
		get {if (this["idinstmusersasd"]==DBNull.Value)return null; return  (Int32?)this["idinstmusersasd"];}
		set {if (value==null) this["idinstmusersasd"]= DBNull.Value; else this["idinstmusersasd"]= value;}
	}
	public object idinstmusersasdValue { 
		get{ return this["idinstmusersasd"];}
		set {if (value==null|| value==DBNull.Value) this["idinstmusersasd"]= DBNull.Value; else this["idinstmusersasd"]= value;}
	}
	public Int32? idinstmusersasdOriginal { 
		get {if (this["idinstmusersasd",DataRowVersion.Original]==DBNull.Value)return null; return  (Int32?)this["idinstmusersasd",DataRowVersion.Original];}
	}
...
public class instmusersasdTable : MetaTableBase<instmusersasdRow> {
	public instmusersasdTable() : base("instmusersasd"){
		baseColumns = new Dictionary<string, DataColumn>(){
			{"ct",createColumn("ct",typeof(DateTime),false,false)},
			{"cu",createColumn("cu",typeof(string),false,false)},
			{"idinstmusersasd",createColumn("idinstmusersasd",typeof(int),false,false)},
