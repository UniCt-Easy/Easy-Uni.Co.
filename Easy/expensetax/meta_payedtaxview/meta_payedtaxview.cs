...
namespace meta_payedtaxview//meta_ritenuteapplicateview//
{
	/// <summary>
	/// Summary description for ritenuteapplicateview.
	/// </summary>
	public class Meta_payedtaxview : Meta_easydata 
	{
		public Meta_payedtaxview(DataAccess Conn, MetaDataDispatcher Dispatcher):
		base(Conn, Dispatcher, "payedtaxview") 
		{
		...
		protected override Form GetForm(string FormName)
		{
			if (FormName=="default") 
			{
				...
				Name="Ritenute applicate";
				return MetaData.GetFormByDllName("payedtaxview_default");//PinoRana
			}
			return null;
		}
