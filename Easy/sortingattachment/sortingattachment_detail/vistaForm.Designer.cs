...
private void initClass() {
	...
	C.AllowDBNull=false;
	tsortingattachment.Columns.Add(C);
	tsortingattachment.Columns.Add( new DataColumn("idfilestorage", typeof(string)));
	...
	var cChild = new []{sortingattachment.Columns["idattachmentkind"]};
	Relations.Add(new DataRelation("attachmentkind_sortingattachment",cPar,cChild,false));
