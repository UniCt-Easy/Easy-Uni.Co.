...
namespace sortingattachment_detail
{
	partial class Frm_sortingattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new sortingattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "sortingattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "sortingattachment.idattachmentkind";
			...
			this.Name = "Frm_sortingattachment_detail";
			this.Text = "Frm_sortingattachment_detail";
