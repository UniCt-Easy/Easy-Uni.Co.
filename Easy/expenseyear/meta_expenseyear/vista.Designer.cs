...
namespace meta_expenseyear {
public class expenseyearRow: MetaRow  {
	public expenseyearRow(DataRowBuilder rb) : base(rb) {} 
...
public class expenseyearTable : MetaTableBase<expenseyearRow> {
	public expenseyearTable() : base("expenseyear"){}
