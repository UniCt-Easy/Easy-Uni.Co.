...
public class proceeds_bankRow: MetaRow  {
	public proceeds_bankRow(DataRowBuilder rb) : base(rb) {} 
...
///Movimento Bancario
///</summary>
public class proceeds_bankTable : MetaTableBase<proceeds_bankRow> {
	public proceeds_bankTable() : base("proceeds_bank"){}
	public override void addBaseColumns(params string [] cols){
		...
		if (definedColums.ContainsKey("idpro")){ 
			defineColumn("idpro", typeof(System.Int32),false);
		}
