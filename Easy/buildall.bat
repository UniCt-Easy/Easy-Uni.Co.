...
rem if not exist %MSBUILD% set MSBUILD="%ProgramFiles(x86)%\Microsoft Visual Studio\2019\Community\MSBuild\Current\Bin\MSBuild.exe"
rem if not exist %MSBUILD% set MSBUILD="%ProgramW6432%\Microsoft Visual Studio\2022\Community\MSBuild\Current\Bin\MSBuild.exe"
