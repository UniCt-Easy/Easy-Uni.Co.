...
namespace registryaddress_default {//cdindirizzo//
	...
	public class Frm_registryaddress_default : System.Windows.Forms.Form {
		...
		private void InitializeComponent() {
			...
			// 
			this.labComuneEsteroLocalita.Location = new System.Drawing.Point(10, 400);
			this.labComuneEsteroLocalita.Name = "labComuneEsteroLocalita";
			this.labComuneEsteroLocalita.Size = new System.Drawing.Size(109, 18);
			this.labComuneEsteroLocalita.TabIndex = 165;
            ...
            if (capPrincipale != null) {
                ...
                if (cap == "") {
                    ...
                    if ((cap != capPrincipale.ToString()) && (t.Rows.Count == 0)) {
                        DialogResult dr = MetaFactory.factory.getSingleton<IMessageShower>().Show(this, "Il C.A.P. non è coerente con il comune scelto. Si desidera aggiornarlo?", "Avviso", MessageBoxButtons.YesNo);
