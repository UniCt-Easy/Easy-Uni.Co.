...
namespace registryaddress_anagraficasingle//cdindirizzo_anagrafica//
{
    ...
    /// </summary>
    public class Frm_registryaddress_anagraficasingle : MetaDataForm {
        ...
        private System.Windows.Forms.Label labComuneEsteroLocalita;
        ...
        private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Frm_registryaddress_anagraficasingle));
			...
			this.labComuneEsteroLocalita = new System.Windows.Forms.Label();
			...
			// 
			// labComuneEsteroLocalita
			// 
			this.labComuneEsteroLocalita.Location = new System.Drawing.Point(11, 327);
			this.labComuneEsteroLocalita.Name = "labComuneEsteroLocalita";
			this.labComuneEsteroLocalita.Size = new System.Drawing.Size(103, 18);
			this.labComuneEsteroLocalita.TabIndex = 173;
			this.labComuneEsteroLocalita.Text = "Località o frazione";
			this.labComuneEsteroLocalita.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// grpEstero
			// 
    ...
    " essere almeno di 60 giorni successiva alla variazione anagrafica effettiva";
			...
			this.Controls.Add(this.labComuneEsteroLocalita);
        ...
        private void ConfiguraCampiGeo() {
            ...
            if (chkEstero.CheckState == CheckState.Checked) {
	            labComuneEsteroLocalita.Text = "Comune estero";
                if (!Meta.IsEmpty) {
	            ...
	            labComuneEsteroLocalita.Text = "Località o frazione";
                if (!Meta.IsEmpty) {
                    Meta.GetFormData(true);
