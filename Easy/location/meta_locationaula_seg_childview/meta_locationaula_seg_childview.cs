...
namespace meta_locationaula_seg_childview
{
    public class Meta_locationaula_seg_childview : Meta_easydata 
	{
        public Meta_locationaula_seg_childview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "locationaula_seg_childview") {
				Name = "Aula";
