...
namespace meta_locationsede_seg_childview
{
    public class Meta_locationsede_seg_childview : Meta_easydata 
	{
        public Meta_locationsede_seg_childview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "locationsede_seg_childview") {
				Name = "Sedi";
