...
namespace meta_location_edifici {
public class location_edificiRow: MetaRow  {
	public location_edificiRow(DataRowBuilder rb) : base(rb) {} 
...
///2.4.25 Edifici
///</summary>
public class location_edificiTable : MetaTableBase<location_edificiRow> {
	public location_edificiTable() : base("location_edifici"){
