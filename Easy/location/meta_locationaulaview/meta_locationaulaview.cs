...
namespace meta_locationaulaview
{
    public class Meta_locationaulaview : Meta_easydata 
	{
        public Meta_locationaulaview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "locationaulaview") {
				Name = "Aula";
			EditTypes.Add("aula");
		...
		public override void DescribeColumns(DataTable T, string ListingType) {
			...
			switch (ListingType) {
				case "aula": {
						DescribeAColumn(T, "locationparent_description", "Edificio", nPos++);
						...
						DescribeAColumn(T, "location_aula_capienza", "Capienza", nPos++);
						DescribeAColumn(T, "location_aula_capienzadis", "Capienza disabili", nPos++);
						DescribeAColumn(T, "aulakind_title", "Tipologia", nPos++);
						DescribeAColumn(T, "aulakind_description", "Tipologia", nPos++);
		...
		public override string GetSorting(string ListingType) {
			...
			switch (ListingType) {
				case "aula": {
						return "aulakind_title desc, location_struttura_description desc";
					}
				//$GetSorting$
			}
