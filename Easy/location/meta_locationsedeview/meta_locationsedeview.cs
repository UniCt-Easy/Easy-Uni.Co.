...
namespace meta_locationsedeview
{
    public class Meta_locationsedeview : Meta_easydata 
	{
        public Meta_locationsedeview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "locationsedeview") {
				Name = "Sedi";
			EditTypes.Add("sede");
		...
		public override void DescribeColumns(DataTable T, string ListingType) {
			...
			switch (ListingType) {
				case "sede": {
						...
						DescribeAColumn(T, "registry_title", "Istituto o Ente", nPos++);
						DescribeAColumn(T, "location_sede_idsedemiur", "Identificativo MIUR", nPos++);
						break;
					}
				//$DescribeAColumn$
			}
