...
namespace meta_locationedifici_seg_childview
{
    public class Meta_locationedifici_seg_childview : Meta_easydata 
	{
        public Meta_locationedifici_seg_childview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "locationedifici_seg_childview") {
				Name = "Edifici";
