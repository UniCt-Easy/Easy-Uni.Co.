...
namespace affinity_default {//tipoparentelalista//
	/// <summary>
	/// Summary description for frmtipoparentelalista.
	/// </summary>
	public class Frm_affinity_default : System.Windows.Forms.Form {
		...
		private void InitializeComponent() {
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Frm_affinity_default));
			...
			this.dataGrid1.Tag = "affinity.default";
			// 
			// label1
			// 
			...
			this.label1.Text = "Codice Parentela";
			...
			this.textBox1.Tag = "affinity.idaffinity";
			this.textBox1.Text = "";
			// 
			// label2
			// 
			...
			this.textBox2.Tag = "affinity.description";
			this.textBox2.Text = "";
			// 
			// MetaDataDetail
			// 
			...
			this.MetaDataDetail.Size = new System.Drawing.Size(568, 88);
			...
			this.Name = "frmtipoparentelalista";
			this.Text = "frmtipoparentelalista";
