...
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
public DataTable upb_dest{get { return Tables["upb_dest"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
public DataTable upbprofitpartition{get { return Tables["upbprofitpartition"];}}
...
//Primary Key
	...
	T= new DataTable("upbprofitpartition");
	C= new DataColumn("idupb", typeof(System.String), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);

	C= new DataColumn("idupb_dest", typeof(System.String), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);
...
//Primary Key
	...
	T.Columns["idupb"], 	T.Columns["idupb_dest"]};
	T.PrimaryKey = key;
...
DataColumn []CPar;
DataColumn []CChild;
TPar= Tables["upb_dest"];
TChild= Tables["upbprofitpartition"];
CPar = new DataColumn[1]{TPar.Columns["idupb"]};
CChild = new DataColumn[1]{TChild.Columns["idupb_dest"]};
Relations.Add(new DataRelation("upb_dest_upbprofitpartition",CPar,CChild));

TPar= Tables["upb"];
TChild= Tables["upbprofitpartition"];
CPar = new DataColumn[1]{TPar.Columns["idupb"]};
CChild = new DataColumn[1]{TChild.Columns["idupb"]};
Relations.Add(new DataRelation("upb_upbprofitpartition",CPar,CChild));
