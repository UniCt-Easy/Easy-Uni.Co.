...
private void initClass() {
	...
	tincomelastview.Columns.Add( new DataColumn("flag", typeof(byte)));
	...
	tproceedsattachment.Columns.Add( new DataColumn("idfilestorage", typeof(string)));
	...
	var cChild = new []{incomelastview.Columns["kpro"], incomelastview.Columns["idpro"]};
	Relations.Add(new DataRelation("proceeds_bankviewincomelastview",cPar,cChild,false));

	cPar = new []{proceeds.Columns["kpro"]};
	cChild = new []{incomelastview.Columns["kpro"]};
	Relations.Add(new DataRelation("proceedsincomelastview",cPar,cChild,false));

	cPar = new []{proceeds.Columns["kpro"]};
	cChild = new []{proceeds_bankview.Columns["kpro"]};
	Relations.Add(new DataRelation("proceedsproceeds_bankview",cPar,cChild,false));
