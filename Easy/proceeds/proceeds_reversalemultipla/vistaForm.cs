...
private void initClass() {
	...
	tincomelastview.defineColumn("codetreasurer", typeof(string));
	tincomelastview.defineColumn("treasurer", typeof(string));
	...
	tproceedsattachment.defineColumn("idfilestorage", typeof(string));
