...
namespace no_table_entry_rettifica {
    ...
    "la chiusura dei Ratei da Percentuale di completamento";
			...
			this.chkRiscontaAmmortamentiFuturi.Location = new System.Drawing.Point(336, 73);
			this.chkRiscontaAmmortamentiFuturi.Name = "chkRiscontaAmmortamentiFuturi";
			this.chkRiscontaAmmortamentiFuturi.Size = new System.Drawing.Size(318, 17);
			this.chkRiscontaAmmortamentiFuturi.TabIndex = 10;
			this.chkRiscontaAmmortamentiFuturi.Text = "Risconta ammortamenti futuri su UPB a commessa completata";
			...
			this.Controls.Add(this.chkRiscontaAmmortamentiFuturi);
