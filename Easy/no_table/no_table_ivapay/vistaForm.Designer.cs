...
public partial class vistaForm: System.Data.DataSet {
	...
	[DebuggerNonUserCodeAttribute()][DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)][Browsable(false)]
	public DataTable trimestre		{get { return Tables["trimestre"];}}
	#endregion
...
this.SchemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
	...
	//////////////////// trimestre /////////////////////////////////
	T= new DataTable("trimestre");
	C= new DataColumn("idtrimestre", typeof(System.Int32));
	C.AllowDBNull=false;
	T.Columns.Add(C);
	T.Columns.Add( new DataColumn("descrizione", typeof(System.String)));
	Tables.Add(T);
	T.PrimaryKey =  new DataColumn[]{T.Columns["idtrimestre"]};
