...
public partial class vistaTipoContrattiCSA: System.Data.DataSet {
// List of DataTables
...
DataSetName = "vistaTipoContrattiCSA";
Prefix = "";
Namespace = "http://tempuri.org/vistaTipoContrattiCSA.xsd";
...
CChild = new DataColumn[1]{TChild.Columns["idsor_siope_main"]};
Relations.Add(new DataRelation("sorting_csa_contractkindyear",CPar,CChild));
...
Relations.Add(new DataRelation("upb_csa_contract",CPar,CChild));

TPar= Tables["fin"];
TChild= Tables["csa_contract"];
CPar = new DataColumn[1]{TPar.Columns["idfin"]};
CChild = new DataColumn[1]{TChild.Columns["idfin_main"]};
Relations.Add(new DataRelation("fin_csa_contract",CPar,CChild));
...
Relations.Add(new DataRelation("underwriting_csa_contract",CPar,CChild));
