...
public partial class vistaBilancio: System.Data.DataSet {
// List of DataTables
...
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
public DataTable finlast{get { return this.Tables["finlast"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
...
this.DataSetName = "vistaBilancio";
this.Prefix = "";
this.Namespace = "http://tempuri.org/vistaBilancio.xsd";
...
Relations.Add(new DataRelation("finlevel_fin",CPar,CChild));

TPar= Tables["fin"];
TChild= Tables["fin"];
CPar = new DataColumn[1]{TPar.Columns["idfin"]};
CChild = new DataColumn[1]{TChild.Columns["paridfin"]};
Relations.Add(new DataRelation("fin_fin",CPar,CChild));
