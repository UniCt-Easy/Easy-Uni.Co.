...
[System.Xml.Serialization.XmlRoot("vistaRipUnicaContrattiCSA"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class vistaRipUnicaContrattiCSA: DataSet {
...
[DebuggerNonUserCode]
public vistaRipUnicaContrattiCSA(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected vistaRipUnicaContrattiCSA (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "vistaRipUnicaContrattiCSA";
	Prefix = "";
	Namespace = "http://tempuri.org/vistaRipUnicaContrattiCSA.xsd";
