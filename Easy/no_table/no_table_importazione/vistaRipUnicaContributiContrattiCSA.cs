...
[System.Xml.Serialization.XmlRoot("vistaRipUnicaContributiContrattiCSA"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class vistaRipUnicaContributiContrattiCSA: DataSet {
...
[DebuggerNonUserCode]
public vistaRipUnicaContributiContrattiCSA(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected vistaRipUnicaContributiContrattiCSA (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "vistaRipUnicaContributiContrattiCSA";
	Prefix = "";
	Namespace = "http://tempuri.org/vistaRipUnicaContributiContrattiCSA.xsd";
