...
[System.Xml.Serialization.XmlRootAttribute("vistaUbicazioniCespiti")][System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
public partial class vistaUbicazioniCespiti: DataSet {
...
public vistaUbicazioniCespiti(){
	BeginInit();
	InitClass();
	EndInit();
}
[DebuggerNonUserCodeAttribute()]
protected vistaUbicazioniCespiti (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCodeAttribute()]
private void InitClass() {
	DataSetName = "vistaUbicazioniCespiti";
	Prefix = "";
	Namespace = "http://tempuri.org/vistaUbicazioniCespiti.xsd";
