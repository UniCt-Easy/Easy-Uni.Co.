...
public partial class vistaPianoConti: System.Data.DataSet {
// List of DataTables
...
DataSetName = "vistaPianoConti";
Prefix = "";
Namespace = "http://tempuri.org/vistaPianoConti.xsd";
...
Relations.Add(new DataRelation("FK_accountlevel_account",CPar,CChild));

TPar= Tables["account"];
TChild= Tables["account"];
CPar = new DataColumn[1]{TPar.Columns["idacc"]};
CChild = new DataColumn[1]{TChild.Columns["paridacc"]};
Relations.Add(new DataRelation("FK_account_parentaccount",CPar,CChild));
