...
[System.Xml.Serialization.XmlRootAttribute("vistaSubConsegnatariCespiti")][System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
public partial class vistaSubConsegnatariCespiti: DataSet {
...
public vistaSubConsegnatariCespiti(){
	BeginInit();
	InitClass();
	EndInit();
}
[DebuggerNonUserCodeAttribute()]
protected vistaSubConsegnatariCespiti (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCodeAttribute()]
private void InitClass() {
	DataSetName = "vistaSubConsegnatariCespiti";
	Prefix = "";
	Namespace = "http://tempuri.org/vistaSubConsegnatariCespiti.xsd";
