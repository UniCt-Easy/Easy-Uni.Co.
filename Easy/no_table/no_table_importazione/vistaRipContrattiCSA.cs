...
public partial class vistaRipContrattiCSA: System.Data.DataSet {
// List of DataTables
...
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
public DataTable csa_contractexpense{get { return Tables["csa_contractexpense"];}}
...
DataSetName = "vistaRipContrattiCSA";
Prefix = "";
Namespace = "http://tempuri.org/vistaRipContrattiCSA.xsd";
...
//Primary Key
	...
	T= new DataTable("csa_contractexpense");
	C= new DataColumn("idcsa_contract", typeof(System.Int32), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);
...
//Primary Key
	...
	T.Columns["idcsa_contract"], 	T.Columns["ayear"], 	T.Columns["ndetail"]};
	T.PrimaryKey = key;
...
TChild= Tables["csa_contractexpense"];
...
Relations.Add(new DataRelation("csa_contract_csa_contractexpense",CPar,CChild));
