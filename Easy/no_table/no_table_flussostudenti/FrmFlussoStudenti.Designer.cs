...
namespace no_table_flussostudenti {
    partial class Frmflussostudenti {
        ...
        private void InitializeComponent() {
			...
			this.tabPageCreditiAnnullati = new System.Windows.Forms.TabPage();
			...
			this.txtANumFlussoIncassi = new System.Windows.Forms.TextBox();
			this.labNFlussoIncassi = new System.Windows.Forms.Label();
			this.txtDaNumFlussoIncassi = new System.Windows.Forms.TextBox();
			...
			this.tabPageAnnullaCrediti = new System.Windows.Forms.TabPage();
			...
			this.tabPageCreditiAnnullati.SuspendLayout();
			...
			this.tabGrid.Controls.Add(this.tabPageCreditiAnnullati);
			...
			// 
			// tabPageCreditiAnnullati
			// 
			this.tabPageCreditiAnnullati.Controls.Add(this.dgrCreditiAnnullati);
			...
			// 
			this.grpElaborazioneIncassi.Controls.Add(this.label6);
			this.grpElaborazioneIncassi.Controls.Add(this.label4);
			this.grpElaborazioneIncassi.Controls.Add(this.txtANumFlussoIncassi);
			this.grpElaborazioneIncassi.Controls.Add(this.labNFlussoIncassi);
			this.grpElaborazioneIncassi.Controls.Add(this.txtDaNumFlussoIncassi);
			...
			this.label6.Text = "A n° flusso (opzionale)";
			// 
			// label4
			// 
			...
			this.labNFlussoIncassi.Text = "N. Flusso incassi - se specificati l\'elaborazione è limitata a questi flussi";
			// 
    ...
    "ivi, normalmente non dovrebbe essere usata ";
			...
			this.btnElaboraIncassi.Text = "2 - Crea fatture da dettagli flussi incassi";
			...
			// 
			// tabPageAnnullaCrediti
			// 
			this.tabPageAnnullaCrediti.Controls.Add(this.txtCodiceBollettinoUnivoco);
			this.tabPageAnnullaCrediti.Controls.Add(this.label5);
			this.tabPageAnnullaCrediti.Controls.Add(this.btnAnnullaCrediti);
			...
			this.label5.Text = "n. Codice Bollettino Univoco";
			// 
			// btnAnnullaCrediti
			// 
			...
			this.btnAnnullaCrediti.Text = "1 - Annulla Dettagli Crediti da Codice Bollettino Univoco";
			this.btnAnnullaCrediti.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			...
			this.tabPageCreditiAnnullati.ResumeLayout(false);
        ...
        private System.Windows.Forms.TextBox txtDaNumFlussoIncassi;
		...
		private System.Windows.Forms.TabPage tabPageCreditiAnnullati;
