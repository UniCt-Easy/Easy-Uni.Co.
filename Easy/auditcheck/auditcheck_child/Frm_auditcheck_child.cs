...
//			DS.ruleenforcement.messageColumn.ExtendedProperties["sqltype"]="text";
		...
		private void InitializeComponent()
		{
			...
			// cmbRuleID
			// 
			this.cmbRuleID.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
			...
			// cmbTabella
			// 
			this.cmbTabella.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
...
//			RecalcRule(Meta.Conn, lastdbtable, lastdboperation);
        ...
        private void btnAddScriptAuditCheck_Click(object sender, EventArgs e) {
            ...
            MetaFactory.factory.getSingleton<IMessageShower>().Show("Script " + filename + (append ? " aggiornato " : " generato ") + " con successo", "Avviso");
