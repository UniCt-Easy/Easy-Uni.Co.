...
namespace meta_accountvarattachment {
    public class Meta_accountvarattachment : Meta_easydata {
        public Meta_accountvarattachment(DataAccess Conn, MetaDataDispatcher Dispatcher)
            :
            base(Conn, Dispatcher, "accountvarattachment") {
            EditTypes.Add("detail");
            ListingTypes.Add("default");
        }
        protected override Form GetForm(string EditType) {
            if (EditType == "detail") {
                Name = "Allegato alla variazione";
                return GetFormByDllName("accountvarattachment_detail");
            }
            return null;
        }
        ...
        public override bool IsValid(DataRow R, out string errmess, out string errfield) {
            ...
            if (R["attachment"].ToString() == "" && R["idfilestorage"] == DBNull.Value) {
