...
select 
	...
	P.title as progetto,
	P.idprogettokind,
	PM.idprogettotiporicavo as idprogettotiporicavo,
...
join progettotiporicavo PTC		/*Tipo voce ricavo*/
	on PTC.idprogetto = PM.idprogetto   and  PTC.idprogettotiporicavo = PM.idprogettotiporicavo
join progetto P 
...
WHERE estimatekind.linktoinvoice = 'N'
 ...
 --select * from estimatedetailexpworkpackageview
