...
--setuser 'amm'
--clear_table_info 'estimatedetailtoinvoiceyear'
--select * from estimatedetailtoinvoiceyear 
CREATE  VIEW [estimatedetailtoinvoiceyear]
(	ayear,
	idestimkind,
	yestim,
	nestim,
        ...
        JOIN estimatedetail estimatedetail2
		  ON invoicedetail.idestimkind = estimatedetail2.idestimkind AND
		    ...
		    WHERE   invoicedetail.yinv <= MYEAR.ayear AND
					invoicedetail.idestimkind = estimatedetail.idestimkind AND
