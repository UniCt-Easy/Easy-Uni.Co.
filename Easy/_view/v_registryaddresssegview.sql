...
INSERT INTO columntypes (format,allownull,tablename,sqldeclaration,createuser,field,col_len,denynull,sqltype,systemtype,defaultvalue,col_scale,lastmoduser,col_precision,iskey) VALUES('','N','registryaddresssegview','varchar(368)','ASSISTENZA','dropdown_title','368','S','varchar','System.String','','','''ASSISTENZA''','','N')
GO
