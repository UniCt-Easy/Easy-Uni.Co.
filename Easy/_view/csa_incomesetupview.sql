...
-- CREAZIONE VISTA csa_incomesetupview_test
...
--select * from csa_incomesetupview
...
(
	...
	idacc_expense,	codeacc_expense,	account_expense,
...
AS SELECT 
	...
	C.idacc_cost, account_cost.codeacc, account_cost.title,
	C.idacc_expense,	account_expense.codeacc,	account_expense.title,
...
LEFT OUTER JOIN account account_expense	ON account_expense.idacc=C.idacc_expense
