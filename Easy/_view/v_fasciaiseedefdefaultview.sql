...
CREATE VIEW [dbo].[fasciaiseedefdefaultview] AS SELECT  fasciaiseedef.ct AS fasciaiseedef_ct, fasciaiseedef.cu AS fasciaiseedef_cu, fasciaiseedef.idcostoscontodef, fasciaiseedef.idfasciaisee, fasciaiseedef.idfasciaiseedef, fasciaiseedef.lt AS fasciaiseedef_lt, fasciaiseedef.lu AS fasciaiseedef_lu, isnull('Fascia ISEE: ' + fasciaiseedef.idfasciaisee + '; ','') as dropdown_title FROM [dbo].fasciaiseedef WITH (NOLOCK)  WHERE  fasciaiseedef.idcostoscontodef IS NOT NULL  AND fasciaiseedef.idfasciaiseedef IS NOT NULL 
GO
