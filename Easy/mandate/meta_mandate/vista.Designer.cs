...
public class mandateRow: MetaRow  {
	...
	public Int32? idtemporaneogara{ 
		get {if (this["idtemporaneogara"]==DBNull.Value)return null; return  (Int32?)this["idtemporaneogara"];}
		set {if (value==null) this["idtemporaneogara"]= DBNull.Value; else this["idtemporaneogara"]= value;}
	}
	public object idtemporaneogaraValue { 
		get{ return this["idtemporaneogara"];}
		set {if (value==null|| value==DBNull.Value) this["idtemporaneogara"]= DBNull.Value; else this["idtemporaneogara"]= value;}
	}
	public Int32? idtemporaneogaraOriginal { 
		get {if (this["idtemporaneogara",DataRowVersion.Original]==DBNull.Value)return null; return  (Int32?)this["idtemporaneogara",DataRowVersion.Original];}
	}
	#endregion
...
public class mandateTable : MetaTableBase<mandateRow> {
	public mandateTable() : base("mandate"){
		baseColumns = new Dictionary<string, DataColumn>(){
			...
			{"idtemporaneogara",createColumn("idtemporaneogara",typeof(int),true,false)},
		};
	}
}
}
