...
namespace meta_admpay_income {
    class Meta_admpay_income: Meta_easydata {
		...
		protected override Form GetForm(string EditType) {
			if (EditType == "default") {
				...
				Name = "Entrate dei Pagamenti Stipendi";
				return GetFormByDllName("admpay_income_default");
			}
			return null;
		}
        ...
        public override bool IsValid(DataRow R, out string errmess, out string errfield) {
            ...
            if (CfgFn.GetNoNullInt32(R["nassessment"]) == 0) {
                errfield = "nassessment";
                errmess = "E' necessario selezionare il meta accertamento";
                return false;
            }
            return true;
        }
        ...
        public override DataRow SelectOne(string ListingType, string filter, string searchtable, DataTable ToMerge) {
            if (ListingType == "default") {
                return base.SelectOne(ListingType, filter, "admpay_incomeview", ToMerge);
            }
