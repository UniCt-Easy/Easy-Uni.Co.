...
private void initClass() {
	...
	C.AllowDBNull=false;
	tpaymentattachment.Columns.Add(C);
	tpaymentattachment.Columns.Add( new DataColumn("idfilestorage", typeof(string)));
	...
	var cChild = new []{paymentattachment.Columns["idattachmentkind"]};
	Relations.Add(new DataRelation("attachmentkind_paymentattachment",cPar,cChild,false));
