...
namespace paymentattachment_detail
{
	partial class Frm_paymentattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new paymentattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "paymentattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "paymentattachment.idattachmentkind";
			...
			this.Name = "Frm_paymentattachment_detail";
			this.Text = "Frm_paymentattachment_detail";
