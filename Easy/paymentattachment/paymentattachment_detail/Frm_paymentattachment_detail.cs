...
{
	public partial class Frm_paymentattachment_detail : MetaDataForm
    {
        MetaData Meta;
        public IOpenFileDialog openFileDialog1;
        public Frm_paymentattachment_detail()
		{
			InitializeComponent();
        ...
        public void MetaData_AfterFill(){
            DataRow R = DS.paymentattachment.Rows[0];
		...
		{
            if (Meta.IsEmpty) return;
            DataRow Curr = DS.paymentattachment.Rows[0];
