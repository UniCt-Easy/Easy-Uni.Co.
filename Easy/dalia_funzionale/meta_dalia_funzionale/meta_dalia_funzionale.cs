...
{
    public class Meta_dalia_funzionale : Meta_easydata {
        public Meta_dalia_funzionale(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "dalia_funzionale") {
...
protected override Form GetForm(string FormName) {
    ...
    //    return MetaData.GetFormByDllName("dalia_funzionale_default");
    //}
    return null;
}
...
public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
    ...
    T.setAutoincrement("iddalia_funzionale", null, null, 0);  //idtabella è campo ad autoincremento
...
public override DataRow SelectOne(string ListingType, string filter, string searchtable, DataTable Exclude) {
    ...
    //    return base.SelectOne(ListingType, filter, "dalia_funzionaleview", Exclude);
    //else
    return base.SelectOne(ListingType, filter, "dalia_funzionale", Exclude);
}
    ...
    base.DescribeColumns(T, ListingType);
            ...
            switch (ListingType) {
                case "default": {
                        ...
                        int nPos = 1;
                        DescribeAColumn(T, "codefunz", "Codice", nPos++);
