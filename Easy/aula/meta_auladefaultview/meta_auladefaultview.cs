...
namespace meta_auladefaultview
{
    public class Meta_auladefaultview : Meta_easydata 
	{
        public Meta_auladefaultview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "auladefaultview") {
				Name = "Aule";
		...
		public override void DescribeColumns(DataTable T, string ListingType) {
			...
			switch (ListingType) {
				case "default": {
						...
						DescribeAColumn(T, "edificio_title", "Edificio", nPos++);
