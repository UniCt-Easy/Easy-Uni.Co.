...
namespace meta_pianostudiosegstudview
{
    public class Meta_pianostudiosegstudview : Meta_easydata 
	{
        public Meta_pianostudiosegstudview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "pianostudiosegstudview") {
