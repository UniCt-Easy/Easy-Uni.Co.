...
namespace meta_tipoattform {
public class tipoattformRow: MetaRow  {
	public tipoattformRow(DataRowBuilder rb) : base(rb) {} 
...
///<summary>
///VOCABOLARIO classificazione delle attività formative del MIUR
///</summary>
public class tipoattformTable : MetaTableBase<tipoattformRow> {
	public tipoattformTable() : base("tipoattform"){
		baseColumns = new Dictionary<string, DataColumn>(){
			{"description",createColumn("description",typeof(string),true,false)},
			{"idtipoattform",createColumn("idtipoattform",typeof(int),false,false)},
