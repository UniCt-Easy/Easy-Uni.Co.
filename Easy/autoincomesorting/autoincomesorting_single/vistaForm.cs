...
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
public DataTable autoincomesortingview{get { return this.Tables["autoincomesortingview"];}}
...
//Primary Key
	...
	T= new DataTable("autoincomesortingview");
...
DataColumn []CChild;
TPar= Tables["sorting"];
TChild= Tables["autoincomesorting"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor"]};
Relations.Add(new DataRelation("FK_sorting_autoincomesorting",CPar,CChild));

TPar= Tables["upb"];
TChild= Tables["autoincomesorting"];
CPar = new DataColumn[1]{TPar.Columns["idupb"]};
CChild = new DataColumn[1]{TChild.Columns["idupb"]};
Relations.Add(new DataRelation("FK_upb_autoincomesorting",CPar,CChild));
