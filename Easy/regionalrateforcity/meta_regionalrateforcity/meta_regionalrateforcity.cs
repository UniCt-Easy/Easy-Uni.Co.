...
namespace meta_regionalrateforcity//meta_aliquotaregionalepercomune//
{
	/// <summary>
	/// Summary description for Meta_aliquotaregionalepercomune.
	/// </summary>
	public class Meta_regionalrateforcity : Meta_easydata
	{
		public Meta_regionalrateforcity(DataAccess Conn, MetaDataDispatcher Dispatcher):
			base(Conn, Dispatcher, "regionalrateforcity")
		{			
		...
		protected override Form GetForm(string FormName)
		{
			if (FormName=="default") 
			{
				Name = "Aliquote Regionali per Comune";
				ActAsList();
				DefaultListType = "default";
				StartEmpty=true;
				SearchEnabled=false;
				return GetFormByDllName("regionalrateforcity_default");
			}
		...
		public override void DescribeColumns(DataTable T, string ListingType)
		{
			...
			if (ListingType=="default"){
				...
				DescribeAColumn(T,"ratestart","Data Inizio Aliquota");
