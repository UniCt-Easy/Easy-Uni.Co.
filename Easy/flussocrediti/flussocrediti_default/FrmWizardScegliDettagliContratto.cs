...
namespace flussocrediti_default {
    ...
    /// </summary>
    public class FrmWizardScegliDettagliContratto : System.Windows.Forms.Form {
        ...
        private ComboBox cmbTipocontrattoattivo;
        ...
        void FormInit() {
            CustomTitle = "Inserimento multiplo dettagli Contratto attivo";
        ...
        private void InitializeComponent() {
            ...
            this.label16.Text = "Tenere premuto il tasto CTRL o MAIUSC e contemporaneamente cliccare con il mouse " +
                                "per selezionare pi˘ dettagli da inserire";
            // 
            // gridDettagli
            // 
        ...
        void RiempiGrid() {
            ...
            if (EstimateDetail.Rows.Count != 0) {
                ...
                //Ora ha messo in EstimateDetail tutto ciÚ che da DB risulta 'da fatturare'.
                ...
                foreach (DataRow R in Flussocreditidetail.Select()) {
                    ...
                    if (R["idestimkind"] == DBNull.Value)
                        continue; //Non Ë una riga collegata a dettagli contratto attivo
        ...
        bool ScegliDocs() {
            ...
            if (SelectedRows.Length > 1)
                ...
                labelMsg.Text = "Sar‡ aggiunto un dettaglio.";
            return true;
        }
        ...
        DataRow GetGridRow(DataGrid G, int index) {
            ...
            string filter;
            filter = QHC.AppAnd(QHC.CmpEq("idestimkind", G[index, 0]),
