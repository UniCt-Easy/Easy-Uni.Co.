...
namespace meta_expensecasualcontractview//meta_contrattooccmovspesaview//
{
	/// <summary>
	/// Summary description for Class1.
	/// </summary>
	public class Meta_expensecasualcontractview : Meta_easydata
	{
		public Meta_expensecasualcontractview(DataAccess Conn, MetaDataDispatcher Dispatcher):
			base(Conn, Dispatcher, "expensecasualcontractview") 
		{
			ListingTypes.Add("default");
			Name = "Prestazione Occasionale - Mov. Spesa";
		}
		...
		public override void DescribeColumns(DataTable T, string listtype)
		{
			...
			if (listtype=="default") 
			{
                ...
                int nPos = 1;
                DescribeAColumn(T, "ncon", "Num. Prestazione", nPos++);
				DescribeAColumn(T, "ycon", "Esercizio Prestazione", nPos++);
                DescribeAColumn(T, "idexp", ".id exp", nPos++);
