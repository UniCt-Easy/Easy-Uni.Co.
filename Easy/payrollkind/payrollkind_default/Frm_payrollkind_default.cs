...
namespace payrollkind_default {//descrizionecedolinolista//
	/// <summary>
	/// Summary description for frmdescrizionecedolinolista.
	/// </summary>
	public class Frm_payrollkind_default : System.Windows.Forms.Form {
		public vistaForm DS;
		...
		public Frm_payrollkind_default() {
			InitializeComponent();
		}
		...
		private void InitializeComponent() {
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Frm_payrollkind_default));
			this.DS = new payrollkind_default.vistaForm();
			...
			this.dataGrid1.Size = new System.Drawing.Size(568, 168);
			this.dataGrid1.TabIndex = 41;
			this.dataGrid1.Tag = "payrollkind.default";
			// 
			// MetaDataDetail
			// 
			...
			this.MetaDataDetail.Size = new System.Drawing.Size(560, 88);
			...
			this.textBox2.Tag = "payrollkind.description";
			this.textBox2.Text = "";
			// 
			// textBox1
			// 
			...
			this.textBox1.Tag = "payrollkind.idpayrollkind";
			this.textBox1.Text = "";
			// 
			// label2
			// 
			...
			this.label1.Text = "Tipo Cedolino";
			this.label1.TextAlign = System.Drawing.ContentAlignment.TopRight;
			// 
			// Frm_payrollkind_default
			// 
			...
			this.Name = "Frm_payrollkind_default";
			this.Text = "frmdescrizionecedolinolista";
