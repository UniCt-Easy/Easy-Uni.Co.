...
namespace meta_csa_contract_partition{
    /// <summary>
    /// Summary description for Class1.
    /// </summary>
    public class Meta_csa_contract_partition : Meta_easydata
    {
        public Meta_csa_contract_partition(DataAccess Conn, MetaDataDispatcher Dispatcher):
            base(Conn, Dispatcher, "csa_contract_partition"){
        ...
        protected override Form GetForm(string FormName){
            if (FormName == "elenco"){
                ...
                Name = "Dettaglio Ripartizione Regola specifica";
                return MetaData.GetFormByDllName("csa_contract_partition_elenco");
            }
            if (FormName == "detail"){
                Name = "Dettaglio";
                return MetaData.GetFormByDllName("csa_contract_partition_detail");
            }
            return null;
        }
        ...
        public override bool IsValid(DataRow R, out string errmess, out string errfield) {
            ...
            if (CfgFn.GetNoNullDecimal(R["quota"]) == 0) {
                errmess = "Non Ë stata valorizzata la quota";
                errfield = "quota";
                return false;
            }
            if (CfgFn.GetNoNullInt32(R["idfin"]) == 0) {
                errmess = "Non Ë stato valorizzato il capitolo";
                errfield = "idfin";
                return false;
            }
            if (R["idupb"] == DBNull.Value) {
                errmess = "Non Ë stato valorizzato l'UPB";
                errfield = "idupb";
                return false;
            }
            return true;
        ...
        public override void DescribeColumns(DataTable T, string ListingType)
        {
            ...
            if (ListingType == "default")
            {
                ...
                DescribeAColumn(T, "!phasemovfin", "Fase Mov. Fin.", "expenseview4.phase", nPos++);
                ...
                DescribeAColumn(T, "!sortcode", "Cod. SIOPE Spesa", "sorting2.sortcode", nPos++);
        ...
        public override DataRow SelectOne(string ListingType, string filter, string searchtable, DataTable Exclude){
            if (ListingType == "elenco")
                return base.SelectOne(ListingType, filter, "csa_contract_partitionview", Exclude);
            else
                return base.SelectOne(ListingType, filter, "csa_contract_partition", Exclude);
        }
