...
public class vistaForm: DataSet {
	...
	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public DataTable csa_contract_partitionview 		=> Tables["csa_contract_partitionview"];
...
private void initClass() {
	...
	//////////////////// CSA_CONTRACT_PARTITIONVIEW /////////////////////////////////
	var tcsa_contract_partitionview= new DataTable("csa_contract_partitionview");
	C= new DataColumn("idcsa_contract", typeof(int));
	C.AllowDBNull=false;
	tcsa_contract_partitionview.Columns.Add(C);
	C= new DataColumn("ayear", typeof(short));
	C.AllowDBNull=false;
	tcsa_contract_partitionview.Columns.Add(C);
	C= new DataColumn("ycontract", typeof(short));
	...
	C.AllowDBNull=false;
	tcsa_contract_partitionview.Columns.Add(C);
	tcsa_contract_partitionview.Columns.Add( new DataColumn("active", typeof(string)));
	C= new DataColumn("idcsa_contractkind", typeof(int));
	C.AllowDBNull=false;
	tcsa_contract_partitionview.Columns.Add(C);
	...
	C.AllowDBNull=false;
	tcsa_contract_partitionview.Columns.Add(C);
	tcsa_contract_partitionview.Columns.Add( new DataColumn("quota", typeof(double)));
	tcsa_contract_partitionview.Columns.Add( new DataColumn("idexp", typeof(int)));
	tcsa_contract_partitionview.Columns.Add( new DataColumn("ymov", typeof(short)));
	tcsa_contract_partitionview.Columns.Add( new DataColumn("nmov", typeof(int)));
	tcsa_contract_partitionview.Columns.Add( new DataColumn("paridexp", typeof(int)));
	tcsa_contract_partitionview.Columns.Add( new DataColumn("nphaseexpense", typeof(byte)));
	C= new DataColumn("lu", typeof(string));
	C.AllowDBNull=false;
	tcsa_contract_partitionview.Columns.Add(C);
	C= new DataColumn("lt", typeof(DateTime));
	...
	C.AllowDBNull=false;
	tcsa_contract_partitionview.Columns.Add(C);
	tcsa_contract_partitionview.Columns.Add( new DataColumn("idepexp", typeof(int)));
	tcsa_contract_partitionview.Columns.Add( new DataColumn("yepexp", typeof(short)));
	tcsa_contract_partitionview.Columns.Add( new DataColumn("nepexp", typeof(int)));
	tcsa_contract_partitionview.Columns.Add( new DataColumn("idrelated", typeof(string)));
	tcsa_contract_partitionview.Columns.Add( new DataColumn("paridepexp", typeof(int)));
	tcsa_contract_partitionview.Columns.Add( new DataColumn("nphaseepexp", typeof(short)));
	tcsa_contract_partitionview.Columns.Add( new DataColumn("idupb", typeof(string)));
	tcsa_contract_partitionview.Columns.Add( new DataColumn("codeupb", typeof(string)));
	tcsa_contract_partitionview.Columns.Add( new DataColumn("upb", typeof(string)));
	tcsa_contract_partitionview.Columns.Add( new DataColumn("idacc", typeof(string)));
	tcsa_contract_partitionview.Columns.Add( new DataColumn("codeacc", typeof(string)));
	tcsa_contract_partitionview.Columns.Add( new DataColumn("account", typeof(string)));
	tcsa_contract_partitionview.Columns.Add( new DataColumn("idfin", typeof(int)));
	tcsa_contract_partitionview.Columns.Add( new DataColumn("codefin", typeof(string)));
	tcsa_contract_partitionview.Columns.Add( new DataColumn("fin", typeof(string)));
	tcsa_contract_partitionview.Columns.Add( new DataColumn("idsorkind", typeof(int)));
	tcsa_contract_partitionview.Columns.Add( new DataColumn("codesorkind", typeof(string)));
	tcsa_contract_partitionview.Columns.Add( new DataColumn("sortingkind", typeof(string)));
	tcsa_contract_partitionview.Columns.Add( new DataColumn("idsor", typeof(int)));
	tcsa_contract_partitionview.Columns.Add( new DataColumn("sortcode", typeof(string)));
	tcsa_contract_partitionview.Columns.Add( new DataColumn("sorting", typeof(string)));
	Tables.Add(tcsa_contract_partitionview);
	tcsa_contract_partitionview.PrimaryKey =  new DataColumn[]{tcsa_contract_partitionview.Columns["idcsa_contract"], tcsa_contract_partitionview.Columns["ayear"], tcsa_contract_partitionview.Columns["ndetail"]};
	...
	cChild = new []{csa_contract_partition.Columns["idexp"], csa_contract_partition.Columns["ayear"]};
	Relations.Add(new DataRelation("expenseview_csa_contract_partition",cPar,cChild,false));

	cPar = new []{epexpview.Columns["idepexp"], epexpview.Columns["ayear"]};
	cChild = new []{csa_contract_partition.Columns["idepexp"], csa_contract_partition.Columns["ayear"]};
	Relations.Add(new DataRelation("epexpview_csa_contract_partition",cPar,cChild,false));

	cPar = new []{fin.Columns["idfin"]};
	cChild = new []{csa_contract_partition.Columns["idfin"]};
	Relations.Add(new DataRelation("fin_csa_contract_partition",cPar,cChild,false));

	cPar = new []{upb.Columns["idupb"]};
	cChild = new []{csa_contract_partition.Columns["idupb"]};
	Relations.Add(new DataRelation("upb_csa_contract_partition",cPar,cChild,false));

	cPar = new []{account.Columns["idacc"]};
	cChild = new []{csa_contract_partition.Columns["idacc"]};
	Relations.Add(new DataRelation("account_csa_contract_partition",cPar,cChild,false));
