...
private void InitClass() {
	...
	T.defineColumn("iskey", typeof(Char),false);
	T.defineColumn("sqltype", typeof(String),false);		
	T.defineColumn("sqldeclaration", typeof(String),false);	
	T.defineColumn("allownull", typeof(Char),false);	
	T.defineColumn("denynull", typeof(Char),false);
	Tables.Add(T);
