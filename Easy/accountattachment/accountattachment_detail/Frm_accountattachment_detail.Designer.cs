...
namespace accountattachment_detail
{
	partial class Frm_accountattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new accountattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "accountattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "accountattachment.idattachmentkind";
			...
			this.Name = "Frm_accountattachment_detail";
			this.Text = "Frm_accountattachment_detail";
