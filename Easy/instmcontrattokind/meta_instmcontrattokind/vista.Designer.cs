...
public class instmcontrattokindRow: MetaRow  {
	public instmcontrattokindRow(DataRowBuilder rb) : base(rb) {} 
...
public class instmcontrattokindTable : MetaTableBase<instmcontrattokindRow> {
	public instmcontrattokindTable() : base("instmcontrattokind"){
		baseColumns = new Dictionary<string, DataColumn>(){
			...
			{"idinstmcontrattokind",createColumn("idinstmcontrattokind",typeof(int),false,false)},
