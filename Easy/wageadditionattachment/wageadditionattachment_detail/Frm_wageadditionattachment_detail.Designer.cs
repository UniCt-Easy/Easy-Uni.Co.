...
{
	partial class Frm_wageadditionattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new wageadditionattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "wageadditionattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "wageadditionattachment.idattachmentkind";
			...
			// 
			// Frm_wageadditionattachment_detail
			// 
			...
			this.Name = "Frm_wageadditionattachment_detail";
			this.Text = "Frm_wageadditionattachment_detail";
