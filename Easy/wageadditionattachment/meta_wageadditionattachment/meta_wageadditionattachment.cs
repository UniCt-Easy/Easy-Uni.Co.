...
namespace meta_wageadditionattachment{
    public class Meta_wageadditionattachment : Meta_easydata{
        public Meta_wageadditionattachment(DataAccess Conn, MetaDataDispatcher Dispatcher)
            :
            base(Conn, Dispatcher, "wageadditionattachment"){
            Name = "Allegato al Compenso";
            EditTypes.Add("detail");
            ListingTypes.Add("lista");
        }
        protected override Form GetForm(string EditType){
            if (EditType == "detail") return GetFormByDllName("wageadditionattachment_detail");
            return null;
        }
