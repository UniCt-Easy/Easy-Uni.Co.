...
namespace meta_epaccattachment
{
    public class Meta_epaccattachment : Meta_easydata
	{
        public Meta_epaccattachment(DataAccess Conn, MetaDataDispatcher Dispatcher)
            :
            base(Conn, Dispatcher, "epaccattachment"){
            Name = "Allegato al Accertamento di Budget";
            EditTypes.Add("detail");
            ListingTypes.Add("lista");
        }
        protected override Form GetForm(string EditType)
		{
            if (EditType == "detail") return GetFormByDllName("epaccattachment_detail");
            return null;
        }
        ...
        public override void DescribeColumns(DataTable T, string listtype)
        {
            ...
            if (listtype == "lista")
            {
                ...
                DescribeAColumn(T, "!attachmentkind", "Tipo Allegato", "epaccattachmentkind.title", nPos++);
            }
        }
