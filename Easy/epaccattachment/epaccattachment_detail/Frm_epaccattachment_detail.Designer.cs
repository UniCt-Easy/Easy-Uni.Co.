...
{
	partial class Frm_epaccattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new epaccattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "epaccattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "epaccattachment.idattachmentkind";
			...
			this.Name = "Frm_epaccattachment_detail";
			this.Text = "Frm_epaccattachment_detail";
