...
namespace meta_estimateattachmentkind {
    /// <summary>
    /// Summary description for tipooperazioneiva.
    /// </summary>
    public class Meta_estimateattachmentkind : Meta_easydata {
        public Meta_estimateattachmentkind(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "estimateattachmentkind") {
        ...
        protected override Form GetForm(string FormName) {
            if (FormName == "default") {
                ...
                return GetFormByDllName("estimateattachmentkind_default");
            }
            return null;
        }
