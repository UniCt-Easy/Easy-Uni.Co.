...
namespace incomevarattachment_detail
{
	partial class Frm_incomevarattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new incomevarattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "incomevarattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "incomevarattachment.idattachmentkind";
			...
			// 
			// Frm_incomevarattachment_detail
			// 
			...
			this.Name = "Frm_incomevarattachment_detail";
			this.Text = "Frm_incomevarattachment_detail";
