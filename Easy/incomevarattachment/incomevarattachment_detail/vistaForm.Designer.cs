...
private void initClass() {
	...
	C.AllowDBNull=false;
	tincomevarattachment.Columns.Add(C);
	tincomevarattachment.Columns.Add( new DataColumn("idfilestorage", typeof(string)));
	...
	var cChild = new []{incomevarattachment.Columns["idattachmentkind"]};
	Relations.Add(new DataRelation("attachmentkind_incomevarattachment",cPar,cChild,false));
