...
namespace assetgrantdetail_default {
    public partial class Frm_assetgrantdetail_default : MetaDataForm {
        ...
        private void InitializeComponent() {
			...
			// grpContributo
			// 
			this.grpContributo.Controls.Add(this.groupBox2);
			...
			this.grpContributo.Location = new System.Drawing.Point(6, 110);
			this.grpContributo.Name = "grpContributo";
			this.grpContributo.Size = new System.Drawing.Size(452, 156);
			this.grpContributo.TabIndex = 42;
			this.grpContributo.TabStop = false;
			this.grpContributo.Tag = "";
			this.grpContributo.Text = "Finanziamento";
			// 
			// textBox3
			// 
			this.textBox3.Location = new System.Drawing.Point(118, 48);
			this.textBox3.Multiline = true;
			this.textBox3.Name = "textBox3";
			this.textBox3.ScrollBars = System.Windows.Forms.ScrollBars.Vertical;
			this.textBox3.Size = new System.Drawing.Size(328, 38);
			...
			this.grpDettagli.Text = "Risconto/Riserva utilizzata";
			// 
			// txtImporto
			// 
