...
namespace paymethod_anagrafica//modalitapagamentoanagrafica//
{
	...
	public class Frm_paymethod_anagrafica : System.Windows.Forms.Form
	{
        ...
        private void CheckBoxVincolatoChange(object sender, EventArgs e) {
            ...
            if (C==null) {
                MetaFactory.factory.getSingleton<IMessageShower>().Show("Metodo CheckBoxVincolatoChange con parametro non checkbox","Errore");
                return;
            }
            GroupBox  CParent = C.Parent as GroupBox;
            if (CParent==null){
                MetaFactory.factory.getSingleton<IMessageShower>().Show("Metodo CheckBoxVincolatoChange con parametro checkbox non contenuto in g.box","Errore");
                return;
            }
