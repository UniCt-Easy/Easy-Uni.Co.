...
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
public DataTable accountprevisionview{get { return Tables["accountprevisionview"];}}
...
//Primary Key
	...
	T= new DataTable("accountprevisionview");
	C= new DataColumn("idacc", typeof(System.String), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);
	...
	T.Columns.Add(new DataColumn("prevision2", typeof(System.Decimal), ""));
	C= new DataColumn("currentprevision2", typeof(System.Decimal), "");
	C.ReadOnly=true;
	T.Columns.Add(C);

	C= new DataColumn("availableprevision2", typeof(System.Decimal), "");
	C.ReadOnly=true;
	T.Columns.Add(C);

	T.Columns.Add(new DataColumn("prevision3", typeof(System.Decimal), ""));
	C= new DataColumn("currentprevision3", typeof(System.Decimal), "");
	C.ReadOnly=true;
	T.Columns.Add(C);

	C= new DataColumn("availableprevision3", typeof(System.Decimal), "");
	C.ReadOnly=true;
	T.Columns.Add(C);

	T.Columns.Add(new DataColumn("prevision4", typeof(System.Decimal), ""));
	C= new DataColumn("currentprevision4", typeof(System.Decimal), "");
	C.ReadOnly=true;
	T.Columns.Add(C);

	C= new DataColumn("availableprevision4", typeof(System.Decimal), "");
	C.ReadOnly=true;
	T.Columns.Add(C);

	T.Columns.Add(new DataColumn("prevision5", typeof(System.Decimal), ""));
	C= new DataColumn("currentprevision5", typeof(System.Decimal), "");
	C.ReadOnly=true;
	T.Columns.Add(C);

	C= new DataColumn("availableprevision5", typeof(System.Decimal), "");
	C.ReadOnly=true;
	T.Columns.Add(C);
...
DataColumn []CPar;
DataColumn []CChild;
TPar= Tables["accountyear"];
TChild= Tables["accountprevisionview"];
CPar = new DataColumn[2]{TPar.Columns["idacc"], TPar.Columns["idupb"]};
CChild = new DataColumn[2]{TChild.Columns["idacc"], TChild.Columns["idupb"]};
Relations.Add(new DataRelation("accountyear_accountprevisionview",CPar,CChild));
...
Relations.Add(new DataRelation("accountlevel_accountprevisionview",CPar,CChild));

TPar= Tables["upb"];
TChild= Tables["accountprevisionview"];
CPar = new DataColumn[1]{TPar.Columns["idupb"]};
CChild = new DataColumn[1]{TChild.Columns["idupb"]};
Relations.Add(new DataRelation("upb_accountprevisionview",CPar,CChild));

TPar= Tables["account"];
TChild= Tables["accountprevisionview"];
CPar = new DataColumn[1]{TPar.Columns["idacc"]};
CChild = new DataColumn[1]{TChild.Columns["idacc"]};
Relations.Add(new DataRelation("account_accountprevisionview",CPar,CChild));

TPar= Tables["accountprevisionview"];
TChild= Tables["accountprevisionview"];
CPar = new DataColumn[2]{TPar.Columns["idacc"], TPar.Columns["idupb"]};
CChild = new DataColumn[2]{TChild.Columns["paridacc"], TChild.Columns["idupb"]};
Relations.Add(new DataRelation("accountprevisionview_accountprevisionview",CPar,CChild));
