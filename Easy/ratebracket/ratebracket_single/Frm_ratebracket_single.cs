...
namespace ratebracket_single//scaglionealiquotesingle//
{
	/// <summary>
	/// Summary description for frmscaglionealiquotesingle.
	/// </summary>
	public class Frm_ratebracket_single : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.textBox1.Tag = "ratebracket.minamount";
			this.textBox1.Text = "";
			// 
			// textBox3
			// 
			...
			this.textBox3.Tag = "ratebracket.maxamount";
			this.textBox3.Text = "";
			// 
			// label1
			// 
			...
			this.OkButton.Location = new System.Drawing.Point(168, 88);
			...
			this.CancButton.Location = new System.Drawing.Point(72, 88);
			this.CancButton.Name = "CancButton";
			this.CancButton.Size = new System.Drawing.Size(64, 24);
			...
			this.Name = "frmscaglionealiquotesingle";
			this.Text = "frmscaglionealiquotesingle";
