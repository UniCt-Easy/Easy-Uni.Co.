...
namespace assetunloadattachment_detail
{
	partial class Frm_assetunloadattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new assetunloadattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "assetunloadattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "assetunloadattachment.idattachmentkind";
			...
			// 
			// Frm_assetunloadattachment_detail
			// 
			...
			this.Name = "Frm_assetunloadattachment_detail";
			this.Text = "Frm_assetunloadattachment_detail";
