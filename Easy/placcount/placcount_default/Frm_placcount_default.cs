...
namespace placcount_default
{
	...
	/// </summary>
	public class Frm_placcount_default : MetaDataForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.dataGridAllegati.Tag = "placcountattachment.lista.detail";
			// 
			// btnDelAtt
			// 
...
//		}
		...
		public void MetaData_AfterFill(){
            ...
            // ===============================================================================
            QueryCreator.setSkipInsertCopy(DS.placcountattachment, true);
        }
