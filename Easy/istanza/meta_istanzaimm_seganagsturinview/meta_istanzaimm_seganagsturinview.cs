...
namespace meta_istanzaimm_seganagsturinview
{
    public class Meta_istanzaimm_seganagsturinview : Meta_easydata 
	{
        public Meta_istanzaimm_seganagsturinview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "istanzaimm_seganagsturinview") {
