...
namespace meta_istanzasosp_segview
{
    public class Meta_istanzasosp_segview : Meta_easydata 
	{
        public Meta_istanzasosp_segview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "istanzasosp_segview") {
				Name = "Istanza di sospensione degli studi";
		...
		public override void DescribeColumns(DataTable T, string ListingType) {
			...
			switch (ListingType) {
				case "sosp_seg": {
						...
						DescribeAColumn(T, "istanza_sosp_motivo", "Motivo", nPos++);
						DescribeAColumn(T, "istanza_sosp_start", "Data di Inizio", nPos++);
						DescribeAColumn(T, "istanza_sosp_stop", "Data di fine", nPos++);
						break;
					}
					//$DescribeAColumn$
			}
