...
namespace meta_istanzacert_segview
{
    public class Meta_istanzacert_segview : Meta_easydata 
	{
        public Meta_istanzacert_segview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "istanzacert_segview") {
		...
		public override void DescribeColumns(DataTable T, string ListingType) {
			...
			switch (ListingType) {
				case "cert_seg": {
						...
						DescribeAColumn(T, "istanza_cert_idcertkind", "Tipologia di certificato", nPos++);
						break;
					}
					//$DescribeAColumn$
			}
