...
namespace meta_istanzaimm_segpreview
{
    public class Meta_istanzaimm_segpreview : Meta_easydata 
	{
        public Meta_istanzaimm_segpreview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "istanzaimm_segpreview") {
		...
		public override string GetStaticFilter(string ListingType) {
			switch (ListingType) {
				case "imm_segpre": {
						return "istanza_idistanzakind =13";
						break;
					}
				//$GetStaticFilter$
			}
