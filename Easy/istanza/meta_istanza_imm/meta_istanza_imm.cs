...
namespace meta_istanza_imm
{
    public class Meta_istanza_imm : Meta_easydata 
	{
        public Meta_istanza_imm(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "istanza_imm") {
