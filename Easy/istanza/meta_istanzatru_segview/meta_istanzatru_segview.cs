...
namespace meta_istanzatru_segview
{
    public class Meta_istanzatru_segview : Meta_easydata 
	{
        public Meta_istanzatru_segview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "istanzatru_segview") {
				Name = "Istanza di trasferimento in uscita";
		...
		public override void DescribeColumns(DataTable T, string ListingType) {
			...
			switch (ListingType) {
				case "tru_seg": {
						...
						DescribeAColumn(T, "istanza_tru_idistanza", "Identificativo", nPos++);
						break;
					}
					//$DescribeAColumn$
			}
