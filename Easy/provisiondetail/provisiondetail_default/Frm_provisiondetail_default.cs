...
namespace provisiondetail_default {//UnDettVarBilancio//
	...
	public class Frm_provisiondetail_default : MetaDataForm {
		...
		private void InitializeComponent() {
			...
			this.txtDenominzioneFondo.Tag = "provision.title?provisiondetailview.provisiontitle";
			// 
			// textBox17
			// 
			...
			this.textBox17.Tag = "provision.idprovision?provisiondetailview.idprovision";
			// 
			// label1
			// 
