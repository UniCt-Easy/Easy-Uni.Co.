...
namespace meta_geo_countrydefaultview
{
    public class Meta_geo_countrydefaultview : Meta_easydata 
	{
		...
		//    //    return MetaData.GetFormByDllName("geo_countrydefaultview_default");
		//    //}
		//    return null;
		//}
		...
		//public override DataRow SelectOne(string ListingType, string filter, string searchtable, DataTable Exclude) {
			...
			//    return base.SelectOne(ListingType, filter, "geo_countrydefaultviewview", Exclude);
			//else
			//return base.SelectOne(ListingType, filter, "geo_countrydefaultview", Exclude);
		//}
