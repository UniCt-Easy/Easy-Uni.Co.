...
namespace sorting_default {//classmovimenti//
    ...
    "e è usata come attributo per la gestione della sicurezza.";
            // 
            // label7
            // 
    ...
    "ni e magazzino ove siano assenti altre email specifiche";
		...
		public void MetaData_AfterActivation(){
			if (DS.sortingkind.Rows.Count>0){
				...
				MetaFactory.factory.getSingleton<IMessageShower>().Show("Non ho trovato il tipo classificazione "+ (Meta.ExtraParameter as string)+
		...
		void VisualizzaPrevisioni(){
			...
			//Se non c'è un codicefaseentrata associato nasconde la prev. entrata
			...
			//Se non c'è un codicefasespesa associato nasconde la prev. spesa
		...
		// Eliminato perchè scatta l'AfterFill
		//		public void MetaData_AfterRowSelect(DataTable T, DataRow R){
		...
		private void btnBudget_Click(object sender, System.EventArgs e) {
			...
			string sortingPassed = idSorKind + "§" + idSor;
