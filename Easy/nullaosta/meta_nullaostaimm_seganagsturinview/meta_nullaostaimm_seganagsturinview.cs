...
namespace meta_nullaostaimm_seganagsturinview
{
    public class Meta_nullaostaimm_seganagsturinview : Meta_easydata 
	{
        public Meta_nullaostaimm_seganagsturinview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "nullaostaimm_seganagsturinview") {
				Name = "Nullaosta";
