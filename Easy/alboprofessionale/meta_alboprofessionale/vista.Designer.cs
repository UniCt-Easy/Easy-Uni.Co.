...
public class alboprofessionaleRow: MetaRow  {
	public alboprofessionaleRow(DataRowBuilder rb) : base(rb) {} 
...
public class alboprofessionaleTable : MetaTableBase<alboprofessionaleRow> {
	public alboprofessionaleTable() : base("alboprofessionale"){
		baseColumns = new Dictionary<string, DataColumn>(){
			...
			{"idalboprofessionale",createColumn("idalboprofessionale",typeof(int),false,false)},
