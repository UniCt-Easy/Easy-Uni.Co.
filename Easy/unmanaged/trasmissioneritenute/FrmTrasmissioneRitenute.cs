...
//		private System.Windows.Forms.ComboBox cmbRitenuta;
		...
		private bool verificaTrasmissione()
		{
			...
			if (esistonoRighe)
			{
				...
				string messaggio = "Attenzione! la trasmissione non puÚ essere confermata in quanto si sono verificati errori in : ";
		...
		public void MetaData_AfterPost()
		{
			...
			if (isSalvabile)
			{
				DialogResult dr = MessageBox.Show(this, @"Si Ë scelto di confermare la trasmissione.
	Se si continua nel salvataggio non sar‡ pi˘ possibile modificare i dettagli delle ritenute inclusi in questa trasmissione.
