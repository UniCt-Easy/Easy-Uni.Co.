...
namespace trasmissioneritenute//trasmissioneritenute//
{
	...
	public class SubForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Non Ë possibile effettuare la trasmissione delle ritenute se non si correggono i " +
			...
			this.label2.Text = "Non Ë possibile effettuare la trasmissione delle ritenute se non si correggono i " +
