	...
	public class frmCambiaDataContabile : System.Windows.Forms.Form
	{
		...
		public bool DatiValidi(){
            ...
            if (esercizio < 2000 || esercizio > 2099) {
                MetaFactory.factory.getSingleton<IMessageShower>().Show("L'esercizio " + esercizio + " non è presente.");
                txtDataContabile.Focus();
                return false;
            }
		...
		private void btnOK_Click(object sender, System.EventArgs e)
		{
			...
			if (TT.Year!=CurrentEsercizio)
				MetaFactory.factory.getSingleton<IMessageShower>().Show("Avvertimento: l'esercizio è stato automaticamente impostato al "+
