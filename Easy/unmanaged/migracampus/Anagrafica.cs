...
namespace Install
{
	...
	public class Anagrafica
	{
        ...
        public static bool controllaIndTrasfertaSenzaValuta (Form form, DataAccess SourceConn, bool question) {
            ...
            if (t.Rows.Count > 0) {
                messaggio = "Esistono le seguenti indennità di trasferta con valuta non riconosciuta:";
                string domanda = null;
                if (question) domanda = "Si intende procedere nella migrazione?";
                t.Columns["codicevaluta"].Caption = "Codice Valuta";
                t.Columns["codicelocalita"].Caption = "Località";
        ...
        static void ElaboraRegistryTitle(DataRow A) {
            ...
            //ATTENZIONE ADESSO : SE @denominazione contiene ' DI '  allora è una ditta individuale!!!!!
            if (title.Length >= 5) {
            ...
            di_position = -1;
            //ATTENZIONE ADESSO : SE @denominazione contiene '% C/O %'  allora la parte dopo C/O è rimossa
            if (title.Length >= 5) {
            ...
            di_position = -1;
            //ATTENZIONE ADESSO : SE @denominazione contiene '%-%'  allora ciò che segue il - 
            //          non è considerato ai fine di nome/cogn./titolo
            if (title.Length >= 5) {
        ...
        static void ImpostaLuogoNascitaDaCF(DataRow A, DataAccess Dest) {
            ...
            //Codice fiscale non valido oppure città non trovata dal CF
