...
namespace Install
{
	...
	public class Iva
	{
        ...
        /// <summary>
        /// Metodo che migra i dati da documentoiva a invoice (La gestione dell'idcentrospesa Ë demandata alla migrazione
        ...
        /// <summary>
        /// Per ogni riga di tipodocumentoiva crea n righe di invoicekindyear dove n Ë il numero di esercizi
        /// </summary>
        /// <param name="form"></param>
        /// <param name="sourceConn"></param>
        /// <param name="destConn"></param>
		...
		/// <summary>
		/// Metodo da chiamare se il checkBox dell'IVA Ë checked.
