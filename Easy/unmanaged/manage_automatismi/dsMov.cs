...
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
public DataTable incomevarview{get { return Tables["incomevarview"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
...
//Primary Key
	...
	T.Columns.Add(new DataColumn("invoicekind", typeof(System.String), ""));
...
//Primary Key
	key = new DataColumn[2]{
	T.Columns["idexp"], 	T.Columns["nvar"]};
	T.PrimaryKey = key;
...
Relations.Add(new DataRelation("expenseview_underwritingpayment",CPar,CChild));

TPar= Tables["expenseview"];
TChild= Tables["underwritingappropriation"];
CPar = new DataColumn[1]{TPar.Columns["idexp"]};
CChild = new DataColumn[1]{TChild.Columns["idexp"]};
Relations.Add(new DataRelation("expenseview_underwritingappropriation",CPar,CChild));
...
Relations.Add(new DataRelation("incomeviewincomesorted",CPar,CChild));

TPar= Tables["expenseview"];
TChild= Tables["expensesorted"];
CPar = new DataColumn[1]{TPar.Columns["idexp"]};
CChild = new DataColumn[1]{TChild.Columns["idexp"]};
Relations.Add(new DataRelation("expenseviewexpensesorted",CPar,CChild));
