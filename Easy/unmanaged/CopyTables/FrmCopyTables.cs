...
namespace CopyTables {
    ...
    public class FrmCopyTables : System.Windows.Forms.Form {
        ...
        private void InitializeComponent() {
            ...
            this.btnSourceCheck.Text = "Verifica connettivit‡";
            ...
            this.btnDestCheck.Text = "Verifica connettivit‡";
        ...
        private void btnSourceCheck_Click(object sender, EventArgs e) {
            ...
            try {
                if (Conn.Open()) {
                    ...
                    MessageBox.Show("Non Ë stato possibile connettersi al db." + Conn.LastError);
                }
            }
            catch (Exception E) {
        ...
        bool CopyTable(DataAccess Source, DataAccess Dest, string dest_owner,
            ...
            if (Exists.Rows.Count == 0) {
                MessageBox.Show("Tabella " + tablename +
                                        " non trovata nel nuovo dipartimento. Questa tabella sar‡ saltata. ",
            ...
            if (clear) {
                ...
                if (Num > 0) {
                    MessageBox.Show("La tabella " + tablename + " sar‡ saltata perchÈ contiene gi‡ " +
