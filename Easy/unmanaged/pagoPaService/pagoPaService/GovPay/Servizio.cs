...
namespace GovPay {
    ...
    public interface IServizio {
        ...
        [OperationContract(Action = "generaRicevuta", ReplyAction = "*")]
        [XmlSerializerFormat]
        generaRicevutaResponse generaRicevuta(generaRicevutaRequest request);

    }

    public static class Servizio {

        //private static readonly string URL = "http://your-db-server:8080/govpay/PagamentiTelematiciGPAppService";
    ...
    public class gpChiediListaFlussiRendicontazioneRequestBody {
        ...
        [XmlElement("dataInizio", Form = XmlSchemaForm.Unqualified, DataType = "date", Order = 1)]
        public DateTime dataInizio { get; set; }

        [XmlElement("dataFine", Form = XmlSchemaForm.Unqualified, DataType = "date", Order = 2)]
    ...
    public class gpChiediFlussoRendicontazioneRequestBody {
        ...
        [XmlElement("annoRiferimento", Form = XmlSchemaForm.Unqualified, DataType = "gYear", Order = 0)]
        public string annoRiferimento { get; set; }

        [XmlElement("codFlusso", Form = XmlSchemaForm.Unqualified, Order = 1)]
        public string codFlusso { get; set; }
    }
    ...
    [MessageContract(IsWrapped = false)]
    public class generaRicevutaRequest {

        [MessageBodyMember(Name = "generaRicevuta", Namespace = "http://www.govpay.it/servizi/gpRnd/", Order = 0)]
        public generaRicevutaRequestBody body;

        public generaRicevutaRequest() { }

        public generaRicevutaRequest(generaRicevutaRequestBody body) {
            this.body = body;
        }
    }

    [MessageContract(IsWrapped = false)]
    public class generaRicevutaResponse {

        [MessageBodyMember(Name = "generaRicevutaResponse", Namespace = "http://www.govpay.it/servizi/gpRnd/", Order = 0)]
        public generaRicevutaResponseBody body;

        public generaRicevutaResponse() { }

        public generaRicevutaResponse(generaRicevutaResponseBody body) {
            this.body = body;
        }
    }
    ...
    [Serializable]
    [XmlType(AnonymousType = true, Namespace = "http://www.govpay.it/servizi/gpRnd/")]
    public class generaRicevutaRequestBody
    {
    ...
    [Serializable]
    [XmlType(AnonymousType = true, Namespace = "http://www.govpay.it/servizi/gpRnd//")]
    public class generaRicevutaResponseBody
    {

        [XmlElement("pdf", Form = XmlSchemaForm.Unqualified, Order = 0)]
