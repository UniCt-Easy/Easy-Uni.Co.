...
namespace meta_entryattachment
{
    public class Meta_entryattachment : Meta_easydata
	{
        public Meta_entryattachment(DataAccess Conn, MetaDataDispatcher Dispatcher)
            :
            base(Conn, Dispatcher, "entryattachment"){
            Name = "Allegato al Scrittura";
            EditTypes.Add("detail");
            ListingTypes.Add("lista");
        }
        protected override Form GetForm(string EditType)
		{
            if (EditType == "detail") return GetFormByDllName("entryattachment_detail");
            return null;
        }
        ...
        public override void DescribeColumns(DataTable T, string listtype)
        {
            ...
            if (listtype == "lista")
            {
                ...
                DescribeAColumn(T, "!attachmentkind", "Tipo Allegato", "entryattachmentkind.title", nPos++);
            }
        }
