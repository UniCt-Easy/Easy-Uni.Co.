...
namespace entryattachment_detail
{
	partial class Frm_entryattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new entryattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "entryattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "entryattachment.idattachmentkind";
			...
			this.Name = "Frm_entryattachment_detail";
			this.Text = "Frm_entryattachment_detail";
