...
{
	public partial class Frm_entryattachment_detail : MetaDataForm
    {
        MetaData Meta;
        public IOpenFileDialog openFileDialog1;
        public Frm_entryattachment_detail()
		{
			InitializeComponent();
        ...
        public void MetaData_AfterFill(){
            DataRow R = DS.entryattachment.Rows[0];
		...
		{
            if (Meta.IsEmpty) return;
            DataRow Curr = DS.entryattachment.Rows[0];
