...
namespace meta_profserviceavailable//meta_contrattoprofoperativo//
{
	/// <summary>
	/// Summary description for Class1.
	/// </summary>
	public class Meta_profserviceavailable : Meta_easydata
	{
		public Meta_profserviceavailable(DataAccess Conn, MetaDataDispatcher Dispatcher):
		base(Conn, Dispatcher, "profserviceavailable") 
	{		
