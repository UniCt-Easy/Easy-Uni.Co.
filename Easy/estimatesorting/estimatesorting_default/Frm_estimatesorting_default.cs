...
namespace estimatesorting_default
{
	/// <summary>
	/// </summary>
	public class Frm_estimatesorting_default : System.Windows.Forms.Form
	{
		...
		public estimatesorting_default.vistaForm DS;
		/// <summary>
		/// Required designer variable.
		/// </summary>
		private System.ComponentModel.Container components = null;

		public Frm_estimatesorting_default()
		{
			InitializeComponent();
		}
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Frm_estimatesorting_default));
            ...
            this.DS = new estimatesorting_default.vistaForm();
            ...
            this.textBox1.Tag = "estimatesorting.quota.fixed.2..%.100";
            // 
            // label2
            // 
            ...
            this.Name = "Frm_estimatesorting_default";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Classificazione Contratto Attivo";
		...
		public void MetaData_AfterRowSelect(DataTable T, DataRow R){
			...
			if (MetaData.GetMetaData(this).DrawState== MetaData.form_drawstates.done) {
				if ((!MetaData.Empty(this))){
					DS.estimatesorting.Rows[0]["idsor"]=0;
				}
				txtCodice.Text="";
				txtDescrizione.Text="";
				DS.sorting.Clear();
