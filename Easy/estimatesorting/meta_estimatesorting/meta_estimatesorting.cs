...
namespace meta_estimatesorting
{
	/// <summary>
	/// Summary description for Class1.
	/// </summary>
	public class Meta_estimatesorting : Meta_easydata {
		public Meta_estimatesorting(DataAccess Conn, MetaDataDispatcher Dispatcher):
			base(Conn, Dispatcher, "estimatesorting") {
			EditTypes.Add("default");
			ListingTypes.Add("default");
			Name = "Classificazione Contratto Attivo";
		}

		protected override Form GetForm(string FormName){
			if (FormName=="default")
			{
				return GetFormByDllName("estimatesorting_default");
			}
			return null;
		}
		...
		public override void DescribeColumns(DataTable T, string ListingType){
			...
			DescribeAColumn(T, "idestimkind", "");
			DescribeAColumn(T, "yestim", "");
			DescribeAColumn(T, "nestim", "");
