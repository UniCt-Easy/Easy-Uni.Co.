...
namespace meta_unifiedtax
{
    public class Meta_unifiedtax : Meta_easydata 
    {
        public Meta_unifiedtax(DataAccess Conn, MetaDataDispatcher Dispatcher):
        base(Conn, Dispatcher, "unifiedtax") 
		{
        ...
        protected override Form GetForm(string FormName)  {
            if (FormName == "default")
            {
                ...
                return MetaData.GetFormByDllName("unifiedtax_default");
            }
            return null;
        }
        public override DataRow Get_New_Row(DataRow ParentRow, DataTable T){
            RowChange.MarkAsAutoincrement(T.Columns["idunifiedtax"], null, null, 6);
        ...
        public override DataRow SelectOne(string ListingType, string filter, string searchtable, DataTable ToMerge) {
            if (ListingType == "default")
            {
                return base.SelectOne(ListingType, filter, "unifiedtaxview", ToMerge);
            }
            return base.SelectOne(ListingType, filter, "unifiedtax", ToMerge);
        }
