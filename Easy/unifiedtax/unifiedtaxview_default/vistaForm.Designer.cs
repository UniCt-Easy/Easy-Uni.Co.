...
namespace unifiedtaxview_default {
using System;
using System.Data;
...
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
public DataTable unifiedtaxview{get { return this.Tables["unifiedtaxview"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
...
//Primary Key
	...
	T= new DataTable("unifiedtaxview");
	T.Columns.Add(new DataColumn("cf", typeof(System.String), ""));
...
TChild= Tables["unifiedtaxview"];
CPar = new DataColumn[1]{TPar.Columns["idreg"]};
CChild = new DataColumn[1]{TChild.Columns["idreg"]};
Relations.Add(new DataRelation("FK_registry_unifiedtaxview",CPar,CChild));
...
Relations.Add(new DataRelation("FK_dbdepartment_unifiedtaxview",CPar,CChild));

TPar= Tables["tax"];
TChild= Tables["unifiedtaxview"];
CPar = new DataColumn[1]{TPar.Columns["taxcode"]};
CChild = new DataColumn[1]{TChild.Columns["taxcode"]};
Relations.Add(new DataRelation("FK_tax_unifiedtaxview",CPar,CChild));
