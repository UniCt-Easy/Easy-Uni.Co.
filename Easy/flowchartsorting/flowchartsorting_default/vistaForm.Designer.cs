...
public DataTable flowchartsorting{get { return Tables["flowchartsorting"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
...
EnforceConstraints = false;
	...
	DataColumn C;
	DataColumn [] key;
	T= new DataTable("flowchartsorting");
...
//Primary Key
	...
	T.Columns["idflowchart"], 	T.Columns["idsor"]};
	T.PrimaryKey = key;
...
TPar= Tables["sorting"];
TChild= Tables["flowchartsorting"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor"]};
Relations.Add(new DataRelation("sorting_flowchartsorting",CPar,CChild));
