...
namespace meta_aulakind {
public class aulakindRow: MetaRow  {
	public aulakindRow(DataRowBuilder rb) : base(rb) {} 
...
///<summary>
///VOCABOLARIO modificabile da loro delle tipologie delle aule
///</summary>
public class aulakindTable : MetaTableBase<aulakindRow> {
	public aulakindTable() : base("aulakind"){
		baseColumns = new Dictionary<string, DataColumn>(){
			...
			{"idaulakind",createColumn("idaulakind",typeof(int),false,false)},
