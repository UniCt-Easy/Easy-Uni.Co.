...
public class flussoincassidetailRow: MetaRow  {
	...
	public String codicepsp{ 
		get {if (this["codicepsp"]==DBNull.Value)return null; return  (String)this["codicepsp"];}
		set {if (value==null) this["codicepsp"]= DBNull.Value; else this["codicepsp"]= value;}
	}
	public object codicepspValue { 
		get{ return this["codicepsp"];}
		set {if (value==null|| value==DBNull.Value) this["codicepsp"]= DBNull.Value; else this["codicepsp"]= value;}
	}
	public String codicepspOriginal { 
		get {if (this["codicepsp",DataRowVersion.Original]==DBNull.Value)return null; return  (String)this["codicepsp",DataRowVersion.Original];}
	}
	public String identificativounivocoriscossione{ 
		get {if (this["identificativounivocoriscossione"]==DBNull.Value)return null; return  (String)this["identificativounivocoriscossione"];}
		set {if (value==null) this["identificativounivocoriscossione"]= DBNull.Value; else this["identificativounivocoriscossione"]= value;}
	}
	public object identificativounivocoriscossioneValue { 
		get{ return this["identificativounivocoriscossione"];}
		set {if (value==null|| value==DBNull.Value) this["identificativounivocoriscossione"]= DBNull.Value; else this["identificativounivocoriscossione"]= value;}
	}
	public String identificativounivocoriscossioneOriginal { 
		get {if (this["identificativounivocoriscossione",DataRowVersion.Original]==DBNull.Value)return null; return  (String)this["identificativounivocoriscossione",DataRowVersion.Original];}
	}
	#endregion
...
public class flussoincassidetailTable : MetaTableBase<flussoincassidetailRow> {
	public flussoincassidetailTable() : base("flussoincassidetail"){
		baseColumns = new Dictionary<string, DataColumn>(){
			...
			{"codicepsp",createColumn("codicepsp",typeof(string),true,false)},
			{"identificativounivocoriscossione",createColumn("identificativounivocoriscossione",typeof(string),true,false)},
		};
	}
}
}
