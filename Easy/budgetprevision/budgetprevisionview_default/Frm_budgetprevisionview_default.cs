...
namespace budgetprevisionview_default {
	...
	/// </summary>
	public class Frm_budgetprevisionview_default : System.Windows.Forms.Form {
		...
		/// <summary>
		/// Abilita / Disabilita l'icona di inserimento (se siamo su di un nodo foglia Insert Ë disabilitato altrimenti Ë abilitato)
		/// </summary>
