...
namespace meta_didproggrupp
{
    public class Meta_didproggrupp : Meta_easydata 
	{
        public Meta_didproggrupp(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "didproggrupp") {
				Name = "Gruppi opzionali";
		...
		public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
			...
			RowChange.MarkAsAutoincrement(T.Columns["iddidproggrupp"], null, null, 0);
			RowChange.setMinimumTempValue(T.Columns["iddidproggrupp"], 9990000);
			//$Get_New_Row$
