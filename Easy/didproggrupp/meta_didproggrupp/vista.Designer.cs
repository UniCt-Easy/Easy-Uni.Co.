...
public class didproggruppRow: MetaRow  {
	public didproggruppRow(DataRowBuilder rb) : base(rb) {} 
...
///</summary>
public class didproggruppTable : MetaTableBase<didproggruppRow> {
	public didproggruppTable() : base("didproggrupp"){
