...
namespace servicetrasmissionattachment_detail
{
	partial class Frm_servicetrasmissionattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new servicetrasmissionattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "servicetrasmissionattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "servicetrasmissionattachment.idattachmentkind";
			...
			// 
			// Frm_servicetrasmissionattachment_detail
			// 
			...
			this.Name = "Frm_servicetrasmissionattachment_detail";
			this.Text = "Frm_servicetrasmissionattachment_detail";
