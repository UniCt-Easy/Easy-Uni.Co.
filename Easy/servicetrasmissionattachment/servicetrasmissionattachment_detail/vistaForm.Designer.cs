...
private void initClass() {
	...
	C= new DataColumn("idtrasmission", typeof(Int32));
	C.AllowDBNull=true;
	...
	var cChild = new []{servicetrasmissionattachment.Columns["idattachmentkind"]};
	Relations.Add(new DataRelation("attachmentkind_servicetrasmissionattachment",cPar,cChild,false));
