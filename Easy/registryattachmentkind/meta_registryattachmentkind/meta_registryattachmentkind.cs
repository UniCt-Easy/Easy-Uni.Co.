...
namespace meta_registryattachmentkind {
    /// <summary>
    /// Summary description for tipooperazioneiva.
    /// </summary>
    public class Meta_registryattachmentkind : Meta_easydata {
        public Meta_registryattachmentkind(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "registryattachmentkind") {
        ...
        protected override Form GetForm(string FormName) {
            if (FormName == "default") {
                ...
                return GetFormByDllName("registryattachmentkind_default");
            }
            return null;
        }
        ...
        public override void SetDefaults(DataTable PrimaryTable) {
            ...
            MetaData.SetDefault(PrimaryTable, "mandatory", "N");
        }
