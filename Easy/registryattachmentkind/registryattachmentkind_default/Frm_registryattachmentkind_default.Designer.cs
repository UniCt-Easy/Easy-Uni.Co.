...
namespace registryattachmentkind_default {
    partial class Frm_registryattachmentkind_default {
        /// <summary>
        ...
        private void InitializeComponent() {
			this.DS = new registryattachmentkind_default.vistaForm();
			...
			this.checkBox1.Tag = "registryattachmentkind.active:S:N";
			...
			this.txtCodice.Tag = "registryattachmentkind.idattachmentkind";
			// 
			// textBox2
			// 
			...
			this.textBox2.Tag = "registryattachmentkind.title";
			// 
			// label1
			// 
			...
			this.checkBox2.Tag = "registryattachmentkind.mandatory:S:N";
			this.checkBox2.Text = "Obbligatorio";
			this.checkBox2.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// Frm_registryattachmentkind_default
			// 
			...
			this.Name = "Frm_registryattachmentkind_default";
			this.Text = "Frm_registryattachmentkind_default";
