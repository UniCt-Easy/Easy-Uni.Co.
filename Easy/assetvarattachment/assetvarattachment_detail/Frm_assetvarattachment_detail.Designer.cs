...
namespace assetvarattachment_detail
{
	partial class Frm_assetvarattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new assetvarattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "assetvarattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "assetvarattachment.idattachmentkind";
			...
			this.Name = "Frm_assetvarattachment_detail";
			this.Text = "Frm_assetvarattachment_detail";
