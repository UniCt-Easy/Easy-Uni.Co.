...
namespace meta_expensesorted {
public class expensesortedRow: MetaRow  {
	public expensesortedRow(DataRowBuilder rb) : base(rb) {} 
	...
	///	 N: Non ̬ vero che: "classificazione da completare"
	///	 S: classificazione da completare
	///</summary>
	...
	///<summary>
	///valore decimal1 associato al tipo class.
	///</summary>
	...
	///<summary>
	///valore decimal 2 associato al tipo class.
	///</summary>
	...
	///<summary>
	///valore decimal3  associato al tipo class.
	///</summary>
	...
	///<summary>
	///valore decimal 4 associato al tipo class.
	///</summary>
	...
	///<summary>
	///valore decimal 5 associato al tipo class.
	///</summary>
...
///</summary>
public class expensesortedTable : MetaTableBase<expensesortedRow> {
	public expensesortedTable() : base("expensesorted"){
