...
namespace expensesorted_main //impclassspesa_main//
{
    ...
    /// </summary>
    public class Frm_expensesorted_main : MetaDataForm {
        ...
        private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Frm_expensesorted_main));
        ...
        public void MetaData_AfterLink() {
            ...
            GetData.SetStaticFilter(DS.expensesortedview, QHS.AppAnd(filter, filterEsercizio));
            ...
            if (ConfClassMovimento == null || ConfClassMovimento.Rows.Count == 0) {
                show("Non ho trovato il tipo classificazione " + classname.ToString() +
            ...
            */
            ...
            if (codicefase == "") {
                show("Non è stata configurata la Fase di Spesa per  il tipo classificazione " +
                                (param as string) +
            ...
            string filtermovimento = QHC.CmpEq("nphase", CfgFn.GetNoNullInt32( codicefase));
            ...
            if (Meta.FirstFillForThisRow && (DS.sortingkind.Rows.Count > 0)) {
                ...
                if (R != null) {
                    ...
                    DataTable TCurrSpesa = Meta.Conn.RUN_SELECT("expenseview", "*", null,
                        QHS.AppAnd(QHS.CmpEq("idexp", R["idexp"]), QHS.CmpEq("ayear", Meta.GetSys("esercizio"))), null,
                        true);
        ...
        Label GetLblByname(string Name) {
            foreach (Control L in this.Controls)
                if (L.GetType().ToString() == "System.Windows.Forms.Label" && L.Name == Name)
                    return (Label) L;
            return null;
        }
...
//				NumberFormatInfo.CurrentInfo);
        ...
        private bool checkpercentuale() {
            ...
            if (Meta.EditMode)
                importooriginale = GetNoNullDecimal(DS.expensesorted.Rows[0]["amount", DataRowVersion.Original]);
        ...
        private bool checkimporto() {
            ...
            decimal importooriginale = 0;
            if (Meta.EditMode)
                importooriginale = GetNoNullDecimal(DS.expensesorted.Rows[0]["amount",
            ...
            try {
                ...
                show("E' necessario inserire un numero", "Avviso", System.Windows.Forms.MessageBoxButtons.OK,
                    System.Windows.Forms.MessageBoxIcon.Exclamation);
                return false;
            }
