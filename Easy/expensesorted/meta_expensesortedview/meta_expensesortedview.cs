...
namespace meta_expensesortedview//meta_impclassspesaview//
{
	/// <summary>
	/// Summary description for Class1.
	/// </summary>
	public class Meta_expensesortedview : Meta_easydata 
	{
		public Meta_expensesortedview(DataAccess Conn, MetaDataDispatcher Dispatcher):
			base(Conn, Dispatcher, "expensesortedview") {		
			Name= "Imputazioni mov. spesa";
		}
		...
		public override void DescribeColumns(DataTable T, string ListingType)
		{
			...
			if (ListingType.StartsWith("lista")) 
			{
				...
				DataTable TipoClassMov = Conn.RUN_SELECT("sortingkind","*",null,
							"(idsorkind="+QueryCreator.quotedstrvalue(codicetipoclass, true)+")",
					null, true);
                ...
                DescribeAColumn(T, "npay", "N.Mandato", nPos++);
                ...
                DescribeAColumn(T, "expensedescr", "Movimento", nPos++);
                DescribeAColumn(T, "ypaymenttransmission", "Eserc. Elenco. Trasmissione", nPos++);
                DescribeAColumn(T, "npaymenttransmission", "Num. Elenco. Trasmissione", nPos++);
