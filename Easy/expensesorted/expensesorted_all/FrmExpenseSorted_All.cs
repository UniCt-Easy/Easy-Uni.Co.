...
namespace expensesorted_all {
	/// <summary>
	/// Summary description for FrmExpenseSorted_All.
	/// </summary>
	public class FrmExpenseSorted_All : System.Windows.Forms.Form {
		MetaData Meta;
		...
		public expensesorted_all.vistaForm DS;
		...
		private void InitializeComponent() {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmExpenseSorted_All));
            ...
            this.DS = new expensesorted_all.vistaForm();
            ...
            this.grpClassificazione.TabIndex = 3;
            ...
            this.btnAnnulla.TabIndex = 311;
            this.btnAnnulla.Text = "Annulla";
            // 
            // txtCurrAmount
            // 
            this.txtCurrAmount.Location = new System.Drawing.Point(248, 142);
            ...
            this.txtCurrAmount.TabIndex = 253;
            ...
            this.Name = "FrmExpenseSorted_All";
            this.Text = "FrmExpenseSorted_All";
		...
		public void MetaData_AfterLink() {
            ...
            rExpense = r.GetParentRow("expenseviewexpensesorted");
            SourceImpClass = r.Table;
			object nphase = rExpense["nphase"];
            fase = CfgFn.GetNoNullInt32(nphase);

            string sortingkindFilter = QHC.AppAnd(
                QHC.NullOrLe("start", Meta.GetSys("esercizio")),
                QHC.NullOrGe("stop", Meta.GetSys("esercizio")),
                QHC.CmpEq("nphaseexpense", nphase)
                );

            GetData.CacheTable(DS.sortingkind, sortingkindFilter, null, true);
            currAmount = CfgFn.GetNoNullDecimal(rExpense["curramount"]);
		}

        public void MetaData_AfterActivation() {
          
            txtCurrAmount.Text = currAmount.ToString("c");
            if (Meta.InsertMode && DS.sortingkind.Rows.Count == 2) {
                try {
        ...
        DataTable CalcAvailableIDClassesFor(object codicetipoclass) {
            ...
            if (!Meta.InsertMode) IDForSP = currClass["idexp"];
