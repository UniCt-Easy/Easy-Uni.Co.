...
ï»¿namespace csa_importriep_partition_income_detail {
    partial class Frm_csa_importriep_partition_income_detail {
        /// <summary>
        ...
        private void InitializeComponent() {
			...
			this.DS = new csa_importriep_partition_income_detail.vistaForm();
			...
			this.txtImporto.Tag = "csa_importriep_partition_income.amount";
			// 
			// groupBox4
			// 
			...
			this.txtNumRiep.Tag = "csa_importriep_partition_income.idriep";
			// 
			// label6
			// 
			...
			this.textBox1.Tag = "csa_importriep_partition_income.ndetail";
			// 
			// label1
			// 
			...
			// 
			// Frm_csa_importriep_partition_income_detail
			// 
			...
			this.Name = "Frm_csa_importriep_partition_income_detail";
			this.Text = "Frm_csa_importriep_partition_income_detail";
