...
namespace meta_csa_importriep_partition_incomeview{
    /// <summary>
    /// </summary>
    public class Meta_csa_importriep_partition_incomeview:Meta_easydata {
        public Meta_csa_importriep_partition_incomeview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "csa_importriep_partition_incomeview") {
