...
{
	partial class Frm_registrylegalstatusattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new registrylegalstatusattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "registrylegalstatusattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "registrylegalstatusattachment.idattachmentkind";
			...
			// 
			// Frm_registrylegalstatusattachment_detail
			// 
			...
			this.Name = "Frm_registrylegalstatusattachment_detail";
			this.Text = "Frm_registrylegalstatusattachment_detail";
