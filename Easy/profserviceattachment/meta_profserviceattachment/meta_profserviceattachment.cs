...
namespace meta_profserviceattachment{
    public class Meta_profserviceattachment : Meta_easydata{
        public Meta_profserviceattachment(DataAccess Conn, MetaDataDispatcher Dispatcher)
            :
            base(Conn, Dispatcher, "profserviceattachment"){
            Name = "Allegato al Compenso";
            EditTypes.Add("detail");
            ListingTypes.Add("lista");
        }
        protected override Form GetForm(string EditType){
            if (EditType == "detail") return GetFormByDllName("profserviceattachment_detail");
            return null;
        }
