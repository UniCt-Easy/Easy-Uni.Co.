...
namespace meta_didprogcurr
{
    public class Meta_didprogcurr : Meta_easydata 
	{
		...
		public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
			...
			RowChange.MarkAsAutoincrement(T.Columns["iddidprogcurr"], null, null, 0);
			RowChange.setMinimumTempValue(T.Columns["iddidprogcurr"], 9990000);
			//$Get_New_Row$
			...
			switch (edit_type) {
				case "default": {
						...
						if (R["codicemiur"].ToString().Trim().Length > 50) {
							errmess = "Attenzione! Il campo 'Codicemiur' può essere al massimo di 50 caratteri";
							errfield = "codicemiur";
							return false;
						}
		...
		public override void DescribeColumns(DataTable T, string ListingType) {
			...
			switch (ListingType) {
				case "default": {
						...
						DescribeAColumn(T, "codicemiur", "Codicemiur", nPos++);
						break;
					}
				//$DescribeAColumn$
			}
