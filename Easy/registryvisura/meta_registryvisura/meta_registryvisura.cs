...
namespace meta_registryvisura {
    /// <summary>
    /// MetaData for visura
    /// </summary>
    public class Meta_registryvisura :Meta_easydata {
        public Meta_registryvisura(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "registryvisura") {
        ...
        protected override Form GetForm(string FormName) {
            if (FormName == "default") {
                ...
                Name = "visura";
                return MetaData.GetFormByDllName("registryvisura_default");
            }
            if (FormName == "anagraficadetail") {
                Name = "visura";
                DefaultListType = "anagraficadetail";
                return MetaData.GetFormByDllName("registryvisura_anagraficadetail");
            }
            return null;
        }
        ...
        public override DataRow SelectOne(string ListingType, string filter, string searchtable, DataTable ToMerge) {
            if (ListingType == "default") {
                return base.SelectOne(ListingType, filter, "registryvisuraview", ToMerge);
            }
        ...
        public override void DescribeColumns(DataTable T, string ListingType) {
            ...
            if (ListingType == "anagraficadetail") {
                foreach (DataColumn C in T.Columns)
                    DescribeAColumn(T, C.ColumnName, "", -1);
                int nPos = 1;
                DescribeAColumn(T, "idregistryvisura", "#", nPos++);
        ...
        public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
            ...
            RowChange.MarkAsAutoincrement(T.Columns["idregistryvisura"], null, null, 0);
