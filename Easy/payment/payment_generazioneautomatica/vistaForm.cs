...
private void initClass() {
	...
	texpenselastview.Columns.Add( new DataColumn("cu", typeof(string)));
	texpenselastview.Columns.Add( new DataColumn("ct", typeof(DateTime)));
	texpenselastview.Columns.Add( new DataColumn("lu", typeof(string)));
	texpenselastview.Columns.Add( new DataColumn("lt", typeof(DateTime)));
	...
	texpenselastview.Columns.Add( new DataColumn("idtreasurer_main", typeof(int)));
	texpenselastview.Columns.Add( new DataColumn("idtreasurer_bill", typeof(int)));
	...
	var cChild = new []{expenselastview.Columns["kpay"]};
	...
	cChild = new []{payment.Columns["idfin"]};
	Relations.Add(new DataRelation("finpayment",cPar,cChild,false));

	cPar = new []{manager.Columns["idman"]};
	cChild = new []{payment.Columns["idman"]};
	Relations.Add(new DataRelation("managerpayment",cPar,cChild,false));
