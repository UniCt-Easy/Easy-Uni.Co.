    ...
    public class Frm_payment_generazioneautomatica : System.Windows.Forms.Form {
        ...
        private void InitializeComponent() {
            ...
            System.ComponentModel.ComponentResourceManager resources =
                new System.ComponentModel.ComponentResourceManager(typeof(Frm_payment_generazioneautomatica));
...
//			Text="Generazione automatica documenti di pagamento";
        ...
        private void FillTempTable() {
            ...
            if (flagbilancio) {
                if (livbilancio == DBNull.Value) {
                    ...
                    //se c'Ë il rag.per Capitolo: idparente Ë il capitolo e codefin l'articolo perchË letto da expenselastview
        ...
        private void CollegaRigheADocumento(bool quiet) {
            if (TempTable == null || TempTable.Rows.Count == 0) {
                if (!quiet) MessageBox.Show("Non ci sono movimenti di spesa da elaborare");
                btnSuccessivo.Enabled = false;
                grpConferma.Enabled = false;
                return;
            }
...
//			}
       ...
       //controlla che si debba usare la trasmissione Siope+ 
        ...
        /// </summary>
        /// <param name="all">Vale TRUE se Ë stato premuto il bottone "Si Tutti", altrimenti vale FALSE</param>
