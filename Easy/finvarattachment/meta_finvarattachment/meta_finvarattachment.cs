...
namespace meta_finvarattachment {
    public class Meta_finvarattachment : Meta_easydata {
        public Meta_finvarattachment(DataAccess Conn, MetaDataDispatcher Dispatcher)
            :
            base(Conn, Dispatcher, "finvarattachment") {
        ...
        protected override Form GetForm(string EditType) {
            if (EditType == "default") {
                ...
                return GetFormByDllName("finvarattachment_default");
            }
            return null;
        }
