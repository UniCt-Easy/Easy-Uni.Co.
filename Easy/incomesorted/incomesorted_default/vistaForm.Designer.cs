...
private void initClass() {
	...
	var cChild = new []{incomesorted.Columns["idsor"]};
	...
	cChild = new []{incomesorted.Columns["paridsor"], incomesorted.Columns["idsor"]};
	Relations.Add(new DataRelation("sortingtranslationincomesorted",cPar,cChild,false));
