...
namespace taxpay_wiz_liquidperiodica //liquidazioneritenuta//
{
    ...
    /// </summary>
    public class Frm_taxpay_wiz_liquidperiodica : MetaDataForm {
           ...
           //Cancella tutto ciò che non ha figli e non è di ultima fase sino a che non trova + nulla
            ...
            if (res) {
                ...
                if (girofondigenerati) {
                    show(this, "I Girofondi sono stati generati!");
                }
...
//				RS["!fondorip"]= RS["idres"].ToString()+"#"+RS["idpar"].ToString();
        ...
        private void leggiIDettagliDiUnaRitenuta() {
            ...
            if (!ControllaConfRitenuta(RigaPeriodo)) {
                Cursor = null;
                show(this, "Errore: i dati relativi alla liquidazione della ritenuta sono errati!",
                    "Errore configurazione");
                btnOK.Enabled = false;
                CanSave = false;
                return;
            ...
            if (t.Rows.Count > 0) {
                ...
                show(errore, "Attenzione", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            ...
            if ((oldTab == 1) && (newTab == 2)) {
                ...
                if ((cmbRitenuta.SelectedValue != null) && (cmbRitenuta.SelectedValue != DBNull.Value)
                    ...
                    if (!checkVincoloLiquidazione() || !checkVincoloFinanziario()) {
                        ...
                        if (taxPayKind == null) {
                            show("La ritenuta selezionata non è adatta per il modello F24 o F24EP", "Errore");
                            deselezionaDettagli();
                            DisplayTabs(oldTab);
                            return;
                        }
