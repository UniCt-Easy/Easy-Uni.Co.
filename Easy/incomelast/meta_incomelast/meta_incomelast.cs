...
namespace meta_incomelast {
    public class Meta_incomelast : Meta_easydata {
        ...
        override public bool IsValid(DataRow R, out string errmess, out string errfield){
            ...
            //if (fulfilled) {
            //    string messaggio = "Attenzione!, impostando il flag 'Regolarizza disposizione di incasso gi‡ effettuata' " +
            //        " il movimento sar‡ nascosto nella stampa della distinta di trasmissione a meno che non venga impostato " +
            //        " il parametro MostraMovGiaTrasmessi a S, dal bottone Altri Parametri, in tal caso il movimento verr‡ visualizzato su sfondo grigio";
