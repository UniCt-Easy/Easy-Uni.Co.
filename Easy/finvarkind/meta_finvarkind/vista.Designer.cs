...
namespace mate_finvarkind {
public class finvarkindRow: MetaRow  {
	public finvarkindRow(DataRowBuilder rb) : base(rb) {} 
	...
	///Codice
	///</summary>
	public String codevarkind{ 
		get {if (this["codevarkind"]==DBNull.Value)return null; return  (String)this["codevarkind"];}
		set {if (value==null) this["codevarkind"]= DBNull.Value; else this["codevarkind"]= value;}
	}
	public object codevarkindValue { 
		get{ return this["codevarkind"];}
		set {if (value==null|| value==DBNull.Value) this["codevarkind"]= DBNull.Value; else this["codevarkind"]= value;}
	}
	public String codevarkindOriginal { 
		get {if (this["codevarkind",DataRowVersion.Original]==DBNull.Value)return null; return  (String)this["codevarkind",DataRowVersion.Original];}
	}
	///<summary>
	///Descrizione
	///</summary>
...
///Tipo Variazione
///</summary>
public class finvarkindTable : MetaTableBase<finvarkindRow> {
	public finvarkindTable() : base("finvarkind"){}
	public override void addBaseColumns(params string [] cols){
		...
		if (definedColums.ContainsKey("idfinvarkind")){ 
			defineColumn("idfinvarkind", typeof(System.Int32),false);
		}
		if (definedColums.ContainsKey("codevarkind")){ 
			defineColumn("codevarkind", typeof(System.String),false);
		}
