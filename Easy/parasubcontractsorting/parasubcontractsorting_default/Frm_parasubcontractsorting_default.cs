...
namespace parasubcontractsorting_default {//classtreecontratto//
	/// <summary>
	/// Summary description for frmClasstreecontratto.
	/// </summary>
	public class Frm_parasubcontractsorting_default : System.Windows.Forms.Form {
		...
		public Frm_parasubcontractsorting_default() {
			InitializeComponent();
		}
		...
		public void MetaData_AfterRowSelect(DataTable T, DataRow R) {
			...
			if (MetaData.GetMetaData(this).DrawState== MetaData.form_drawstates.done) {
				if ((!MetaData.Empty(this))) {
					DS.parasubcontractsorting.Rows[0]["idsor"]=0;
				}
				txtCodice.Text="";
				txtDescrizione.Text="";
				DS.sorting.Clear();
        ...
        public void MetaData_AfterLink() {
            ...
            string filterCT = QHS.CmpEq("tablename", "parasubcontract");
