...
public DataTable epaccvar{get { return Tables["epaccvar"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
...
//Primary Key
	...
	T.Columns["idepacc"], 	T.Columns["nvar"]};
	T.PrimaryKey = key;
	...
	T.Columns.Add(new DataColumn("parentyepacc", typeof(System.Int16), ""));
	T.Columns.Add(new DataColumn("parentnepacc", typeof(System.Int32), ""));
...
DataColumn []CPar;
DataColumn []CChild;
TPar= Tables["epaccview"];
TChild= Tables["epaccvar"];
CPar = new DataColumn[1]{TPar.Columns["idepacc"]};
CChild = new DataColumn[1]{TChild.Columns["idepacc"]};
Relations.Add(new DataRelation("epaccview_epaccvar",CPar,CChild));
