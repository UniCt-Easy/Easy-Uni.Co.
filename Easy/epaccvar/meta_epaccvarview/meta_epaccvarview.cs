...
namespace meta_epaccvarview {
    /// <summary>
    /// Summary description for meta_epexpvar.
    /// </summary>
    /// 

    public class Meta_epaccvarview : Meta_easydata {
        public Meta_epaccvarview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "epaccvarview") {
 
            ListingTypes.Add("lista");
            Name = "Variazione movimento Accertamento di Budget";
        }
        private string[] mykey = new string[] { "idepacc", "nvar" };
        ...
        public override void DescribeColumns(DataTable T, string listtype) {
            ...
            if (listtype == "lista")
            {
                ...
                DescribeAColumn(T, "yepacc", "Eserc. mov.", pos++);
                DescribeAColumn(T, "nepacc", "Num. mov.", pos++);
