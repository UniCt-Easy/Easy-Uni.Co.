...
namespace otherinsurance_default//altraformaassicurativalista//
{
	/// <summary>
	/// Summary description for frmaltraformaassicurativalista.
	/// </summary>
	public class Frm_otherinsurance_default : System.Windows.Forms.Form
	{
		public vistaForm DS;
		...
		public Frm_otherinsurance_default()
		{
			//
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Frm_otherinsurance_default));
			this.DS = new otherinsurance_default.vistaForm();
			...
			this.MetaDataToolBar.Size = new System.Drawing.Size(616, 106);
			this.MetaDataToolBar.TabIndex = 39;
			...
			this.dataGrid1.Size = new System.Drawing.Size(600, 207);
			this.dataGrid1.TabIndex = 40;
			this.dataGrid1.Tag = "otherinsurance.default";
			// 
			// MetaDataDetail
			// 
			...
			this.MetaDataDetail.Location = new System.Drawing.Point(8, 271);
			this.MetaDataDetail.Name = "MetaDataDetail";
			this.MetaDataDetail.Size = new System.Drawing.Size(600, 80);
			...
			this.textBox2.Tag = "otherinsurance.description";
			this.textBox2.Text = "";
			// 
			// label2
			// 
			...
			this.textBox1.Tag = "otherinsurance.idotherinsurance";
			this.textBox1.Text = "";
			// 
			// label1
			// 
			...
			this.label1.Text = "Codice Forma Ass.";
			this.label1.TextAlign = System.Drawing.ContentAlignment.TopRight;
			// 
			// Frm_otherinsurance_default
			// 
			...
			this.Name = "Frm_otherinsurance_default";
			this.Text = "frmaltraformaassicurativalista";
