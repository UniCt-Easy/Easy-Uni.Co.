...
namespace epexpvar_default {
    /// <summary>
    /// Summary description for Frm_epexpvardefault.
    /// </summary>
    public class Frm_epexpvardefault : System.Windows.Forms.Form {
        public epexpvar_default.vistaForm DS;
        ...
        public void MetaData_AfterLink() {
            ...
            command = "choose.epexpview.default";
            GetData.SetStaticFilter(DS.epexpview, filteresercizio);
            SetImportoName();
        ...
        private void ClearSpesa(bool ClearEsercizio) {
            ...
            DS.epexpvar.Rows[0]["nvar"] = 0;
            DS.epexpvar.Rows[0]["yvar"] = 0;
