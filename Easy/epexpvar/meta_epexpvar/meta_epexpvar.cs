...
namespace meta_epexpvar {
    /// <summary>
    /// Summary description for meta_epexpvar.
    /// </summary>
    /// 

    public class Meta_epexpvar : Meta_easydata {
        public Meta_epexpvar(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "epexpvar") {
        ...
        protected override Form GetForm(string FormName) {
            if (FormName == "default") {
                ...
                Name = "Variazione Impegno di Budget";
                return GetFormByDllName("epexpvar_default");
            }
            if (FormName == "detail") {
                return MetaData.GetFormByDllName("epexpvar_detail");
            }
            return null;
        }
        ...
        public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
            RowChange.SetSelector(T, "idepexp");
        ...
        public override DataRow SelectOne(string ListingType, string filter, string searchtable, DataTable Exclude)
        {
            ...
            {
                return base.SelectOne(ListingType, filter, "epexpvar", Exclude);
            }
            return base.SelectOne(ListingType, filter, "epexpvarview", Exclude);
