...
public DataTable casualcontractsorting{get { return this.Tables["casualcontractsorting"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
...
this.EnforceConstraints = false;
	...
	DataColumn C;
	DataColumn [] key;
	T= new DataTable("casualcontractsorting");
...
TPar= Tables["sorting"];
TChild= Tables["casualcontractsorting"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor"]};
Relations.Add(new DataRelation("sortingcasualcontractsorting",CPar,CChild));
