...
public class instmcommitteeregistry_instmuserRow: MetaRow  {
	public instmcommitteeregistry_instmuserRow(DataRowBuilder rb) : base(rb) {} 
...
public class instmcommitteeregistry_instmuserTable : MetaTableBase<instmcommitteeregistry_instmuserRow> {
	public instmcommitteeregistry_instmuserTable() : base("instmcommitteeregistry_instmuser"){
