...
public class affidamentocaratteristicaoraRow: MetaRow  {
	public affidamentocaratteristicaoraRow(DataRowBuilder rb) : base(rb) {} 
	...
	public Int32? idaffidamentocaratteristica{ 
		get {if (this["idaffidamentocaratteristica"]==DBNull.Value)return null; return  (Int32?)this["idaffidamentocaratteristica"];}
		set {if (value==null) this["idaffidamentocaratteristica"]= DBNull.Value; else this["idaffidamentocaratteristica"]= value;}
	}
	public object idaffidamentocaratteristicaValue { 
		get{ return this["idaffidamentocaratteristica"];}
		set {if (value==null|| value==DBNull.Value) this["idaffidamentocaratteristica"]= DBNull.Value; else this["idaffidamentocaratteristica"]= value;}
	}
	public Int32? idaffidamentocaratteristicaOriginal { 
		get {if (this["idaffidamentocaratteristica",DataRowVersion.Original]==DBNull.Value)return null; return  (Int32?)this["idaffidamentocaratteristica",DataRowVersion.Original];}
	}
	public Int32? idaffidamentocaratteristicaora{ 
		get {if (this["idaffidamentocaratteristicaora"]==DBNull.Value)return null; return  (Int32?)this["idaffidamentocaratteristicaora"];}
		set {if (value==null) this["idaffidamentocaratteristicaora"]= DBNull.Value; else this["idaffidamentocaratteristicaora"]= value;}
	}
	public object idaffidamentocaratteristicaoraValue { 
		get{ return this["idaffidamentocaratteristicaora"];}
		set {if (value==null|| value==DBNull.Value) this["idaffidamentocaratteristicaora"]= DBNull.Value; else this["idaffidamentocaratteristicaora"]= value;}
	}
	public Int32? idaffidamentocaratteristicaoraOriginal { 
		get {if (this["idaffidamentocaratteristicaora",DataRowVersion.Original]==DBNull.Value)return null; return  (Int32?)this["idaffidamentocaratteristicaora",DataRowVersion.Original];}
	}
...
public class affidamentocaratteristicaoraTable : MetaTableBase<affidamentocaratteristicaoraRow> {
	public affidamentocaratteristicaoraTable() : base("affidamentocaratteristicaora"){
		baseColumns = new Dictionary<string, DataColumn>(){
			{"ct",createColumn("ct",typeof(DateTime),false,false)},
			{"cu",createColumn("cu",typeof(string),false,false)},
			{"idaffidamento",createColumn("idaffidamento",typeof(int),false,false)},
			{"idaffidamentocaratteristica",createColumn("idaffidamentocaratteristica",typeof(int),false,false)},
			{"idaffidamentocaratteristicaora",createColumn("idaffidamentocaratteristicaora",typeof(int),false,false)},
