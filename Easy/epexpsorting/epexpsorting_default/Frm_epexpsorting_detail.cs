...
namespace epexpsorting_default
{
	/// <summary>
	/// Summary description for Frm_expsorting_detail.
	/// </summary>
	public class Frm_epexpsorting_detail : System.Windows.Forms.Form
	{
		private System.Windows.Forms.Button btnOk;
		private System.Windows.Forms.Button btnAnnulla;
		public epexpsorting_default.vistaForm DS;
		MetaData Meta;
        CQueryHelper QHC;
        QueryHelper QHS;
		...
		public Frm_epexpsorting_detail()
		{
			InitializeComponent();		
		}
		...
		public void MetaData_AfterRowSelect(DataTable T, DataRow R){
			...
			if (MetaData.GetMetaData(this).DrawState== MetaData.form_drawstates.done) {
				if ((!MetaData.Empty(this))){
					DS.epexpsorting.Rows[0]["idsor"]=0;
				}
				txtCodice.Text="";
				txtDescrizione.Text="";
				DS.sorting.Clear();
        ...
        public void MetaData_AfterLink() {
            ...
            DataTable TEpexpParent = Source.Table.DataSet.Tables["epexp"];
            if (TEpexpParent==null) TEpexpParent = Source.Table.DataSet.Tables["epexpview"];
            DataRow ParEpExp = TEpexpParent.Select(QHC.CmpEq("idepexp", Source["idepexp"]))[0];
            int nphase = CfgFn.GetNoNullInt32(  ParEpExp["nphase"]);
            string s_table = "epexp";
            if (nphase == 1)
                s_table = "epexp1";
		...
		public void MetaData_AfterActivation(){
			if (DS.epexpsorting.Rows.Count==0) return;

			DataRow CurrRow = DS.epexpsorting.Rows[0];
			importoclassificazione= CfgFn.GetNoNullDecimal(CurrRow["amount"]);
			importototale= CfgFn.GetNoNullDecimal(DS.epexpsorting.ExtendedProperties["importototale"]);
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Frm_epexpsorting_detail));
            this.DS = new epexpsorting_default.vistaForm();
            ...
            this.txtImporto.Tag = "epexpsorting.amount";
            ...
            this.textBox1.Tag = "epexpsorting.description";
            // 
            // label1
            // 
            ...
            this.txtDataContabile.Tag = "epexpsorting.adate";
            // 
            // label5
            // 
            ...
            this.rdbVariazione.Tag = "epexpsorting.kind:V";
            ...
            this.rdbNormale.Tag = "epexpsorting.kind:N";
            ...
            this.Name = "Frm_epexpsorting_detail";
