	...
	public class Meta_casualcontractview : Meta_easydata
	{
        ...
        public override void DescribeColumns(DataTable T, string ListingType)
		{
			...
			if (ListingType=="default")
			{
				...
				DescribeAColumn(T,"activitycode","Codice Attività",pos++);
				DescribeAColumn(T,"activity","Attività Prev. INPS",pos++);
				...
				DescribeAColumn(T,"flagexcludefromcertificate","Escludi da CU",pos++); 
