...
namespace csa_contractkind_default
{
    ...
    public class Frm_csa_contractkind_default : System.Windows.Forms.Form {
        ...
        public void MetaData_AfterGetFormData () {
            // In questo modo la libreria riconosce come sub entit‡ di casualcontract la tabella casualcontractyear
            Meta.myHelpForm.addExtraEntity("csa_contractkindyear");
            if (Meta.InsertMode) {
