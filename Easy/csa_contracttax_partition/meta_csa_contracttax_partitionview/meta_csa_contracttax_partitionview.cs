...
namespace meta_csa_contracttax_partitionview {
    /// <summary>
    /// Summary description for Class1.
    /// </summary>
    public class Meta_csa_contracttax_partitionview :Meta_easydata {
        public Meta_csa_contracttax_partitionview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "csa_contracttax_partitionview") {
