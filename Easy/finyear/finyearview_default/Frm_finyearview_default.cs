...
namespace finyearview_default {
	...
	/// </summary>
	public class Frm_finyearview_default : MetaDataForm {
		...
		private Label lblPrevisioneDisponibileImpegni;
		private TextBox txtPrevDisponibileFase;
		private TextBox txtImpegni;
		private Label label14;
		private Button btnImpegni;
		private Button btnAccertamenti;
		private TextBox txtAccertamenti;
		private Label lblTotaleAccertamenti;
		private Button btnPSpeseImp;
		private TextBox txtPSpeseImp;
		...
		public void MetaData_AfterLink() {
            ...
            DataTable BilTable = Meta.Conn.RUN_SELECT("fin", "idfin,paridfin,codefin,title,nlevel,flag", null, filter,null, null, true);
			if (BilTable.Rows.Count>0){
			    ...
			    flag_E_S = CfgFn.GetNoNullInt32(BilRow["flag"]);
			}
		...
		private void cambiaEtichette() {
			...
			// Cambio Label
			lblTotaleAccertamenti.Text = "Totale fase (" + nomeFaseAccertamento + ")";
			...
			lblImpegniCompetenza.Text = Pluralize(nomeFaseImpegno) + " di Competenza)";
			...
			if ((flag_E_S & 1) == 1) // spesa
			{
				lblPrevisioneDisponibileImpegni.Text = "Previsione disponibile (" + nomeFaseImpegno +")";
			}
			else {
				lblPrevisioneDisponibileImpegni.Text = "Previsione disponibile (" + nomeFaseAccertamento + ")";
			}
		...
		private void InitializeComponent() {
			...
			this.btnPSpeseImp = new System.Windows.Forms.Button();
			this.txtPSpeseImp = new System.Windows.Forms.TextBox();
			...
			this.lblTotaleAccertamenti = new System.Windows.Forms.Label();
			this.label14 = new System.Windows.Forms.Label();
			this.btnImpegni = new System.Windows.Forms.Button();
			this.txtPrevDisponibileFase = new System.Windows.Forms.TextBox();
			this.txtImpegni = new System.Windows.Forms.TextBox();
			this.lblPrevisioneDisponibileImpegni = new System.Windows.Forms.Label();
			...
			this.tabPrincipale.Size = new System.Drawing.Size(574, 400);
			...
			this.TabConsolidato.Size = new System.Drawing.Size(574, 400);
			...
			// grpPrevCassa
			// 
			this.grpPrevCassa.Controls.Add(this.btnPSpeseImp);
			this.grpPrevCassa.Controls.Add(this.txtPSpeseImp);
			this.grpPrevCassa.Controls.Add(this.lblPSpeseImpegni);
			this.grpPrevCassa.Controls.Add(this.btnAccertamenti);
			this.grpPrevCassa.Controls.Add(this.txtAccertamenti);
			this.grpPrevCassa.Controls.Add(this.lblTotaleAccertamenti);
			this.grpPrevCassa.Controls.Add(this.label14);
			this.grpPrevCassa.Controls.Add(this.btnImpegni);
			this.grpPrevCassa.Controls.Add(this.txtPrevDisponibileFase);
			this.grpPrevCassa.Controls.Add(this.txtImpegni);
			this.grpPrevCassa.Controls.Add(this.lblPrevisioneDisponibileImpegni);
			this.grpPrevCassa.Controls.Add(this.lblTotaleImpegni);
			...
			this.grpPrevCassa.Size = new System.Drawing.Size(545, 319);
			this.grpPrevCassa.TabIndex = 0;
			this.grpPrevCassa.TabStop = false;
			// 
			// btnPSpeseImp
			// 
			this.btnPSpeseImp.Location = new System.Drawing.Point(374, 150);
			this.btnPSpeseImp.Name = "btnPSpeseImp";
			this.btnPSpeseImp.Size = new System.Drawing.Size(75, 20);
			this.btnPSpeseImp.TabIndex = 32;
			this.btnPSpeseImp.Text = "I";
			this.btnPSpeseImp.UseVisualStyleBackColor = true;
			this.btnPSpeseImp.Click += new System.EventHandler(this.btnPSpeseImp_Click);
			// 
			// txtPSpeseImp
			// 
			this.txtPSpeseImp.Location = new System.Drawing.Point(234, 150);
			this.txtPSpeseImp.Name = "txtPSpeseImp";
			this.txtPSpeseImp.ReadOnly = true;
			this.txtPSpeseImp.Size = new System.Drawing.Size(121, 20);
			this.txtPSpeseImp.TabIndex = 31;
			this.txtPSpeseImp.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// lblPSpeseImpegni
			// 
			this.lblPSpeseImpegni.Location = new System.Drawing.Point(9, 150);
			this.lblPSpeseImpegni.Name = "lblPSpeseImpegni";
			this.lblPSpeseImpegni.Size = new System.Drawing.Size(215, 13);
			this.lblPSpeseImpegni.TabIndex = 30;
			this.lblPSpeseImpegni.Text = "Piccole Spese non rientegrate (Impegni)";
			this.lblPSpeseImpegni.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// btnAccertamenti
			// 
			this.btnAccertamenti.Location = new System.Drawing.Point(374, 121);
			this.btnAccertamenti.Name = "btnAccertamenti";
			this.btnAccertamenti.Size = new System.Drawing.Size(75, 20);
			this.btnAccertamenti.TabIndex = 29;
			...
			// txtAccertamenti
			// 
			this.txtAccertamenti.Location = new System.Drawing.Point(233, 121);
			this.txtAccertamenti.Name = "txtAccertamenti";
			this.txtAccertamenti.ReadOnly = true;
			this.txtAccertamenti.Size = new System.Drawing.Size(121, 20);
			this.txtAccertamenti.TabIndex = 28;
			this.txtAccertamenti.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// lblTotaleAccertamenti
			// 
			this.lblTotaleAccertamenti.Location = new System.Drawing.Point(29, 121);
			this.lblTotaleAccertamenti.Name = "lblTotaleAccertamenti";
			this.lblTotaleAccertamenti.Size = new System.Drawing.Size(195, 13);
			this.lblTotaleAccertamenti.TabIndex = 27;
			this.lblTotaleAccertamenti.Text = "Totale Accertamenti";
			this.lblTotaleAccertamenti.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// label14
			// 
			this.label14.AutoSize = true;
			this.label14.Location = new System.Drawing.Point(377, 183);
			this.label14.Name = "label14";
			this.label14.Size = new System.Drawing.Size(71, 13);
			this.label14.TabIndex = 26;
			this.label14.Text = "= F + G - H - I";
			// 
			// btnImpegni
			// 
			this.btnImpegni.Location = new System.Drawing.Point(374, 95);
			this.btnImpegni.Name = "btnImpegni";
			this.btnImpegni.Size = new System.Drawing.Size(75, 20);
			this.btnImpegni.TabIndex = 25;
			this.btnImpegni.Text = "H";
			this.btnImpegni.UseVisualStyleBackColor = true;
			this.btnImpegni.Click += new System.EventHandler(this.btnImpegni_Click);
			// 
			// txtPrevDisponibileFase
			// 
			this.txtPrevDisponibileFase.Location = new System.Drawing.Point(233, 176);
			this.txtPrevDisponibileFase.Name = "txtPrevDisponibileFase";
			this.txtPrevDisponibileFase.ReadOnly = true;
			this.txtPrevDisponibileFase.Size = new System.Drawing.Size(121, 20);
			this.txtPrevDisponibileFase.TabIndex = 24;
			this.txtPrevDisponibileFase.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// txtImpegni
			// 
			this.txtImpegni.Location = new System.Drawing.Point(234, 95);
			this.txtImpegni.Name = "txtImpegni";
			this.txtImpegni.ReadOnly = true;
			this.txtImpegni.Size = new System.Drawing.Size(121, 20);
			this.txtImpegni.TabIndex = 23;
			this.txtImpegni.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// lblPrevisioneDisponibileImpegni
			// 
			this.lblPrevisioneDisponibileImpegni.Location = new System.Drawing.Point(28, 170);
			this.lblPrevisioneDisponibileImpegni.Name = "lblPrevisioneDisponibileImpegni";
			this.lblPrevisioneDisponibileImpegni.Size = new System.Drawing.Size(195, 30);
			this.lblPrevisioneDisponibileImpegni.TabIndex = 22;
			this.lblPrevisioneDisponibileImpegni.Text = "Previsione Disponibile";
			this.lblPrevisioneDisponibileImpegni.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// lblTotaleImpegni
			// 
			this.lblTotaleImpegni.Location = new System.Drawing.Point(29, 95);
			this.lblTotaleImpegni.Name = "lblTotaleImpegni";
			this.lblTotaleImpegni.Size = new System.Drawing.Size(195, 13);
			this.lblTotaleImpegni.TabIndex = 21;
			...
			// txtPrevAttualeCassa
			// 
			this.txtPrevAttualeCassa.Location = new System.Drawing.Point(235, 65);
			...
			// txtPrevDispCassa
			// 
			this.txtPrevDispCassa.Location = new System.Drawing.Point(229, 281);
			...
			// 
			this.btnPiccoleSpesePagamenti.Location = new System.Drawing.Point(370, 256);
			...
			// 
			this.lblPiccoleSpesePagamenti.Location = new System.Drawing.Point(15, 247);
			this.lblPiccoleSpesePagamenti.Name = "lblPiccoleSpesePagamenti";
			this.lblPiccoleSpesePagamenti.Size = new System.Drawing.Size(208, 29);
			...
			// 
			this.txtPiccoleSpesePagamenti.Location = new System.Drawing.Point(231, 255);
			...
			// txtIncassi
			// 
			this.txtIncassi.Location = new System.Drawing.Point(232, 228);
			this.txtIncassi.Name = "txtIncassi";
			this.txtIncassi.ReadOnly = true;
			this.txtIncassi.Size = new System.Drawing.Size(120, 20);
			...
			this.label4.Text = "= F + G - L - M";
			// 
			// btnVarPrevisioneCassa
			// 
			this.btnVarPrevisioneCassa.Location = new System.Drawing.Point(370, 35);
			...
			// 
			this.lblVarPrevisioneCassa.Location = new System.Drawing.Point(25, 37);
			this.lblVarPrevisioneCassa.Name = "lblVarPrevisioneCassa";
			this.lblVarPrevisioneCassa.Size = new System.Drawing.Size(195, 13);
			...
			// 
			this.txtVarPrevisioneCassa.Location = new System.Drawing.Point(235, 34);
			...
			// lblPrevDispCassa
			// 
			this.lblPrevDispCassa.Location = new System.Drawing.Point(25, 284);
			this.lblPrevDispCassa.Name = "lblPrevDispCassa";
			this.lblPrevDispCassa.Size = new System.Drawing.Size(195, 13);
			...
			// btnPagamenti
			// 
			this.btnPagamenti.Location = new System.Drawing.Point(370, 204);
			...
			// lblPagamenti
			// 
			this.lblPagamenti.Location = new System.Drawing.Point(25, 209);
			this.lblPagamenti.Name = "lblPagamenti";
			this.lblPagamenti.Size = new System.Drawing.Size(195, 13);
			...
			// txtPagamenti
			// 
			this.txtPagamenti.Location = new System.Drawing.Point(230, 202);
			...
			// 
			this.btnPrevInizialeCassa.Location = new System.Drawing.Point(370, 9);
			...
			// 
			this.lblPrevInizialeCassa.Location = new System.Drawing.Point(25, 11);
			this.lblPrevInizialeCassa.Name = "lblPrevInizialeCassa";
			this.lblPrevInizialeCassa.Size = new System.Drawing.Size(195, 13);
			...
			// 
			this.txtPrevInizialeCassa.Location = new System.Drawing.Point(235, 8);
			...
			this.tabCrediti.Size = new System.Drawing.Size(557, 331);
			...
			this.tabAssCassa.Size = new System.Drawing.Size(557, 331);
        ...
        private void CalcolaValoriText() {
			...
			txtPSpeseImp.Text = totPiccoleSpeseImp.ToString("C");
			...
			txtAccertamenti.Text = totAccertamentiComp.ToString("C");
            ...
            if ((flag & 1) == 1) // spesa
            {
				...
				txtPrevDisponibileFase.Text = (totPrevCassa - totImpegniAll - totPiccoleSpeseImp).ToString("C");
				lblPrevisioneDisponibileImpegni.Text = "Previsione disponibile (" + nomeFaseImpegno + ")";
			}
			else {
				...
				txtPrevDisponibileFase.Text = (totPrevCassa - totAccertamentiAll).ToString("C");
			}
		...
		private void btnPSpeseImp_Click(object sender, EventArgs e) {
			DataRow Curr = HelpForm.GetLastSelected(DS.finyearview);
			if (Curr == null)
				return;
