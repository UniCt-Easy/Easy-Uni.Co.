...
//Primary Key
	...
	C= new DataColumn("idassetmanager", typeof(System.Int32), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);
...
//Primary Key
	...
	T.Columns["idasset"], 	T.Columns["idassetmanager"]};
	T.PrimaryKey = key;
...
DataColumn []CChild;
TPar= Tables["manager"];
TChild= Tables["assetmanager"];
CPar = new DataColumn[1]{TPar.Columns["idman"]};
CChild = new DataColumn[1]{TChild.Columns["idman"]};
Relations.Add(new DataRelation("manager_assetmanager",CPar,CChild));
