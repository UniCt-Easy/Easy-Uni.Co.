...
namespace resultparameter_default//Report//
{
    ...
    public class FrmViewReport : System.Windows.Forms.Form {
        ...
        public bool StampaReport() {
            ...
            if (oneprint && printed) {
                MessageBox.Show("Una sola copia della stampa Ë ammessa.");
                return false;
            }
            //se in anteprima mostro il printDialog con tutte le propriet‡ impostate
            //in precedenza
            ...
            try {
                ...
                operating = false;
                QueryCreator.ShowException("La stampante selezionata (" + printerName + ") non Ë valida", E);
                errore = true;
                return false;
            }
            ...
            try {
                ...
                QueryCreator.ShowException(
                        ...
                        "Si Ë verificato un errore in fase di invio dei dati alla stampante.\n" +
        ...
        private void toolBar_ButtonClick(object sender, System.Windows.Forms.ToolBarButtonClickEventArgs e) {
			...
			switch(e.Button.Tag.ToString().ToLower()) {
				...
				case "export":
                    if (oneprint) {
                        MessageBox.Show("L'esportazione Ë vietata sulle stampe protette");
                        return;
                    }
			        try {
