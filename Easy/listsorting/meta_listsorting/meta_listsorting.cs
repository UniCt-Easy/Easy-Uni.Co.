...
namespace meta_listsorting  {
    /// <summary>
    /// Summary description for Class1.
    /// </summary>
    public class Meta_listsorting  : Meta_easydata {
        public Meta_listsorting (DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "listsorting") {
        ...
        protected override Form GetForm(string FormName) {
            if (FormName == "default") {
                Name = "Classificazione listino";
                return MetaData.GetFormByDllName("listsorting_default");
            }
            return null;
        }
