...
namespace meta_flussocreditidetail_gomp {
    ...
    /// </summary>
    public class Meta_flussocreditidetail_gomp : Meta_easydata {
        public Meta_flussocreditidetail_gomp(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "flussocreditidetail_gomp") {
        ...
        protected override Form GetForm(string FormName) {
            if (FormName == "default") {
                Name = "Dettaglio Flusso crediti Gomp";
                return MetaData.GetFormByDllName("flussocreditidetail_gomp_default");
            }
            return null;
        }
        ...
        public override DataRow SelectOne(string ListingType, string filter, string searchtable, DataTable Exclude) {
            return base.SelectOne(ListingType, filter, "flussocreditidetail_gomp", Exclude);
        }
