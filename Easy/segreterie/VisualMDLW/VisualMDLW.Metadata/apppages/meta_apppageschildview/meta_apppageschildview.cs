...
namespace meta_apppageschildview
{
    public class Meta_apppageschildview : Meta_easydata 
	{
        public Meta_apppageschildview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "apppageschildview") {
		...
		//    //    return MetaData.GetFormByDllName("apppageschildview_default");
		//    //}
		//    return null;
		//}
		...
		//public override DataRow SelectOne(string ListingType, string filter, string searchtable, DataTable Exclude) {
			...
			//    return base.SelectOne(ListingType, filter, "apppageschildviewview", Exclude);
			//else
			//return base.SelectOne(ListingType, filter, "apppageschildview", Exclude);
		//}
		...
		public override void DescribeColumns(DataTable T, string ListingType) {
			...
			switch (ListingType) {
case "child": {
				DescribeAColumn(T, "apppages_customcode", "Codice Aggiuntivo", nPos++);
				DescribeAColumn(T, "apppages_customreference", "Customreference", nPos++);
				DescribeAColumn(T, "apppages_customusing", "Using aggiuntivi", nPos++);
				DescribeAColumn(T, "apppages_editlistingtype", "Edit Listing Type", nPos++);
				DescribeAColumn(T, "apppages_idapppages", "Identificativo", nPos++);
				DescribeAColumn(T, "apppages_title", "Titolo", nPos++);
