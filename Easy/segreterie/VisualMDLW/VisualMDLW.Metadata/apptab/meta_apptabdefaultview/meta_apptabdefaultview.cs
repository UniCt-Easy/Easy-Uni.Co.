...
namespace meta_apptabdefaultview
{
    public class Meta_apptabdefaultview : Meta_easydata 
	{
        public Meta_apptabdefaultview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "apptabdefaultview") {
		...
		//}
		       ...
		       private string[] mykey = new string[] {"idapptab"};
		...
		//    //    return MetaData.GetFormByDllName("apptabdefaultview_default");
		//    //}
		//    return null;
		//}
		...
		//public override DataRow SelectOne(string ListingType, string filter, string searchtable, DataTable Exclude) {
			...
			//    return base.SelectOne(ListingType, filter, "apptabdefaultviewview", Exclude);
			//else
			//return base.SelectOne(ListingType, filter, "apptabdefaultview", Exclude);
		//}
...
case "default": {
				...
				DescribeAColumn(T, "apptab_idapptab", "Idapptab", nPos++);
				DescribeAColumn(T, "apptab_position", "Position", nPos++);
				DescribeAColumn(T, "apptab_title", "Title", nPos++);
						break;
					}
				//$DescribeAColumn$
			}
