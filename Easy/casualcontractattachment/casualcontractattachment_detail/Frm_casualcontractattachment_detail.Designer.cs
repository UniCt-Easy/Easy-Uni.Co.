...
namespace casualcontractattachment_detail
{
	partial class Frm_casualcontractattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new casualcontractattachment_detail.vistaForm();
			...
			this.grpTipoallegato.TabIndex = 90;
			...
			this.cmbCodiceAllegato.Tag = "casualcontractattachment.idattachmentkind";
			...
			this.btnVisualizza.TabIndex = 86;
			...
			this.btnCancel.Location = new System.Drawing.Point(474, 191);
			...
			this.btnOk.Location = new System.Drawing.Point(373, 191);
			...
			this.labAutocertFileName.Tag = "casualcontractattachment.filename";
			// 
			// _openFileDialog1
			// 
			this._openFileDialog1.Title = "Selezione documento";
			// 
			// Frm_casualcontractattachment_detail
			// 
			...
			this.Name = "Frm_casualcontractattachment_detail";
			this.Text = "Frm_casualcontractattachment_detail";
