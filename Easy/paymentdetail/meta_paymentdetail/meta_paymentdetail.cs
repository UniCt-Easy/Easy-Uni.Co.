...
namespace meta_paymentdetail
{

	public class Meta_paymentdetail : Meta_easydata {
		public Meta_paymentdetail(DataAccess Conn, MetaDataDispatcher Dispatcher):
			base(Conn, Dispatcher, "paymentdetail") {
		...
		public override void DescribeColumns(DataTable T, string ListingType){
			...
			if (ListingType=="default"){
				DescribeAColumn(T,"ypay","",-1);
				DescribeAColumn(T,"npay","",-1);
		...
		protected override Form GetForm(string FormName){
			...
			if (FormName=="single"){
				return MetaData.GetFormByDllName("paymentdetail_single");//PinoRana
			}
			return null;
		}			
	}
