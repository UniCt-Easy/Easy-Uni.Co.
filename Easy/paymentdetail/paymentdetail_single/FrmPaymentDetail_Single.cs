...
{
	/// <summary>
	/// Summary description for FrmPaymentDetail_Single.
	/// </summary>
	public class FrmPaymentDetail_Single : System.Windows.Forms.Form
	{
		...
		public paymentdetail_single.vistaForm DS;
		/// <summary>
		/// Required designer variable.
		/// </summary>
		private System.ComponentModel.Container components = null;

		public FrmPaymentDetail_Single()
		{
			//
		...
		private void InitializeComponent()
		{
			...
			this.DS = new paymentdetail_single.vistaForm();
			...
			this.textBox2.Tag = "oaymentdetail.transactiondate";
			this.textBox2.Text = "";
			// 
			// label2
			// 
			...
			this.textBox3.Tag = "paymentdetail.valuedate";
			this.textBox3.Text = "";
			// 
			// groupBox2
			// 
			...
			this.textBox1.Tag = "paymentdetail.bankreference";
			this.textBox1.Text = "";
			// 
			// label4
			// 
			...
			this.textBox4.Tag = "paymentdetail.amount";
			this.textBox4.Text = "";
			// 
			// btnAnnulla
			// 
			...
			this.Name = "FrmPaymentDetail_Single";
			this.Text = "FrmPaymentDetail_Single";
