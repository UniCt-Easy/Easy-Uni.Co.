...
namespace payroll_nontrasferibile//cedolino_nontrasferibile//
{
	...
	public class Frm_payroll_nontrasferibile : System.Windows.Forms.Form
	{
		...
		/// <summary>
		/// Metodo che assegna la causa di non trasferibilità dei cedolini presenti in CEDOLINONONTRASFERIBILE
		/// </summary>
        ...
        private void riempiCedolinoNonTrasferibile() {
            ...
            // nell'anno in corso. Se non è mai stato erogato alcun cedolino si possono trasferire tutti i cedolini dell'anno
