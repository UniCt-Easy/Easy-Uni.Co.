    ...
    public class CalcoliCococo {
        ...
        */
        ...
        private decimal calcola_detrazione_reddito_3_2020(
            ...
            if (redditoComplessivo <= 15000/*28000*/) return 0;
        ...
        private decimal calcola_detrazione_reddito(
            ...
            // ✅ Detrazione aggiuntiva 2026: +65€ se 25.000 < reddito <= 35.000
            // (da non riproporzionare ai giorni: aggiunta dopo i metodi fascia)
            if (redditoComplessivo > 25000 && redditoComplessivo <= 35000) {
                detrazioneannua += 65;
            }
        ...
        private decimal detrazione_reddito_fascia2(decimal reddito, int giorniCompetenza) {
            ...
            // Parametri 2026 (detrazione lavoro dipendente)
            decimal DB = 1910;
            decimal K = 1190;
            decimal M = 28000;
            decimal min = 13000;
        ...
        private decimal calcola_detrazione_altri(object idcontratto, decimal reddito, DateTime dataInizioCedolino,
            ...
            string filtroFamiliare = "";

            if (esercizio < 2026)
                filtroFamiliare = QHC.AppAnd(QHC.CmpEq("idcon", idcontratto), QHC.CmpEq("idaffinity", "A"),
                QHC.CmpEq("flagdependent", "S"));
            else
                filtroFamiliare = QHC.AppAnd(QHC.CmpEq("idcon", idcontratto), QHC.CmpEq("idaffinity", "G"),
                QHC.CmpEq("flagdependent", "S"));
...
//22
        ...
        private bool RitenutaAttiva(object codiceRitenuta) {
			if ((codiceRitenuta == null) || (codiceRitenuta.ToString() == "")) return false;
			string filtroRitenuta = QHS.CmpEq("taxref", codiceRitenuta);
			object active = Conn.DO_READ_VALUE("tax", filtroRitenuta, "active");
			if (active.ToString() == "N") return false;
			return true ;
        }
