...
namespace meta_payroll{//meta_cedolino//
	...
	public class Meta_payroll : Meta_easydata {
		...
		public override bool IsValid(DataRow R, out string errmess, out string errfield) {
		    ...
		    if (app == null) {
		        errmess = "Non Ë possibile modificare il cedolino se in questo esercizio";
		        errfield = "fiscalyear";
		        return false;
		    }
			...
			if (annofiscale < eserccontratto) {
				errmess = "Non Ë possibile inserire un anno fiscale antecedente all'esercizio di creazione del contratto";
				errfield = "fiscalyear";
				return false;
			}
			return true;
