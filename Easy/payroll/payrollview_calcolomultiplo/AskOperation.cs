	...
	public class AskOperation : System.Windows.Forms.Form {
		...
		public AskOperation(int idCedolino)
		{
			...
			lblQuestion.Text = "Vuoi generare gli impegni di budget per il cedolino n. " + idCedolino
				+ "?\nSe si risponde Si, Tutti questa domanda non verr‡ rifatta per i cedolini successivi per i quali verranno generati gli impengi di budget"
				+ "\nSe si risponde No, Tutti questa domanda non verr‡ rifatta per i cedolini successivi per i quali non verranno generati gli impegni di budget";
		}
