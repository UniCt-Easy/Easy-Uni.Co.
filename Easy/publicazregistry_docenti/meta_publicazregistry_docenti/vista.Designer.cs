...
public class publicazregistry_docentiRow: MetaRow  {
	public publicazregistry_docentiRow(DataRowBuilder rb) : base(rb) {} 
...
///<summary>
///autori della 2.4.27 pubblicazione
///</summary>
public class publicazregistry_docentiTable : MetaTableBase<publicazregistry_docentiRow> {
	public publicazregistry_docentiTable() : base("publicazregistry_docenti"){
