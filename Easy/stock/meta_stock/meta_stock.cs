    ...
    public class Meta_stock : Meta_easydata
    {
        ...
        public override void DescribeColumns(DataTable T, string listtype){
            ...
            if (listtype == "ddt_in"){
                ...
                DescribeAColumn(T, "!unitacarico", "U.tà di misura", "listview.unit", nPos++);
        ...
        public override bool IsValid(DataRow R, out string errmess, out string errfield){
            ...
            if (CfgFn.GetNoNullInt32(R["idlist"]) == 0){
                errmess = "Il campo 'Listino' è obbligatorio";
                errfield = "idlist";
                return false;
            }
            if (CfgFn.GetNoNullInt32(R["idstoreload_motive"]) == 0) {
                errmess = "Il campo 'Causale di carico' è obbligatorio";
            ...
            if (CfgFn.GetNoNullDecimal( R["number"]) == 0){
                errmess = "La quantità deve essere maggiore di zero";
                errfield = "number";
                return false;
            }
