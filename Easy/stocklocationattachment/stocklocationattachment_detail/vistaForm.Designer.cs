...
private void initClass() {
	...
	C= new DataColumn("idstocklocation", typeof(Int32));
	C.AllowDBNull=true;
	...
	C.AllowDBNull=false;
	tstocklocationattachment.Columns.Add(C);
	tstocklocationattachment.Columns.Add( new DataColumn("idfilestorage", typeof(string)));
	...
	var cChild = new []{stocklocationattachment.Columns["idattachmentkind"]};
	Relations.Add(new DataRelation("attachmentkind_stocklocationattachment",cPar,cChild,false));
