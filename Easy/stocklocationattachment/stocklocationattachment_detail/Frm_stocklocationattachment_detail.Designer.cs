...
namespace stocklocationattachment_detail
{
	partial class Frm_stocklocationattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new stocklocationattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "stocklocationattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "stocklocationattachment.idattachmentkind";
			...
			// 
			// Frm_stocklocationattachment_detail
			// 
			...
			this.Name = "Frm_stocklocationattachment_detail";
			this.Text = "Frm_stocklocationattachment_detail";
