...
namespace meta_provaingressoview
{
    public class Meta_provaingressoview : Meta_easydata 
	{
        public Meta_provaingressoview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "provaingressoview") {
				Name = "Prove";
		...
		private string[] mykey = new string[] {"idcorsostudio","iddidprog","idprova"};
