    ...
    public class Meta_paydispositiondetail : Meta_easydata {
        ...
        public override bool IsValid(DataRow R, out string errmess, out string errfield) {
            ...
            if (CfgFn.GetNoNullDecimal(R["amount"]) <= 0) {
                errmess = "L'importo non puÚ essere nullo, negativo o uguale a zero";
                errfield = "amount";
                return false;
            }
            ...
            if (R["flaghuman"].ToString().ToUpper() == "S") {
                ...
                {
                    errmess = "Inserire la citt‡ di nascita o lo stato estero di nascita";
                    errfield = "idcity";
                    return false;
                }
            ...
            {
                errmess = "Deve essere scelta una modalit‡ di pagamento";
