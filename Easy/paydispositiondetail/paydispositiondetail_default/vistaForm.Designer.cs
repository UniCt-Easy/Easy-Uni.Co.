...
private void initClass() {
	...
	var cChild = new []{paydisposition.Columns["kpay"]};
	...
	cChild = new []{paydispositiondetail.Columns["idcbimotive"]};
	Relations.Add(new DataRelation("FK_cbimotive_paydispositiondetail",cPar,cChild,false));

	cPar = new []{paydisposition.Columns["idpaydisposition"]};
	cChild = new []{paydispositiondetail.Columns["idpaydisposition"]};
