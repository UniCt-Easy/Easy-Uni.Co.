...
namespace residence_lista//tiporesidenza//
{
	/// <summary>
	/// Summary description for frmtiporesidenza.
	/// </summary>
	public class Frm_residence_lista : System.Windows.Forms.Form
	{
		...
		public Frm_residence_lista()
		{
			InitializeComponent();
			HelpForm.SetDenyNull(DS.residence.Columns["active"], true);
		}
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Frm_residence_lista));
			this.DS = new residence_lista.vistaForm();
			...
			this.MetaDataDetail.Size = new System.Drawing.Size(320, 128);
			this.MetaDataDetail.TabIndex = 12;
			// 
			// checkBox1
			// 
			this.checkBox1.Location = new System.Drawing.Point(248, 40);
			this.checkBox1.Name = "checkBox1";
			this.checkBox1.Size = new System.Drawing.Size(56, 24);
			this.checkBox1.TabIndex = 2;
			this.checkBox1.Tag = "residence.active:S:N";
			...
			this.textBox1.Tag = "residence.coderesidence";
			this.textBox1.Text = "";
			// 
			// textBox2
			// 
			...
			this.textBox2.Tag = "residence.description";
			this.textBox2.Text = "";
			// 
			// label1
			// 
			...
			this.dataGrid1.Size = new System.Drawing.Size(328, 129);
			this.dataGrid1.TabIndex = 11;
			this.dataGrid1.Tag = "residence.lista";
			// 
			// MetaDataToolBar
			// 
			...
			this.MetaDataToolBar.TabIndex = 13;
			...
			this.Name = "Frm_residence_lista";
			this.Text = "frmtiporesidenza";
