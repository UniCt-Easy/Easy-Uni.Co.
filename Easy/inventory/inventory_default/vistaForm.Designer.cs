...
this.EnforceConstraints = false;
	...
	T.Columns.Add(new DataColumn("!enteinventario", typeof(System.String), ""));
	T.Columns.Add(new DataColumn("!tipoinventario", typeof(System.String), ""));
...
Relations.Add(new DataRelation("FK_sorting05_inventory",CPar,CChild));

TPar= Tables["sorting04"];
TChild= Tables["inventory"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor04"]};
Relations.Add(new DataRelation("FK_sorting04_inventory",CPar,CChild));

TPar= Tables["sorting03"];
TChild= Tables["inventory"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor03"]};
Relations.Add(new DataRelation("FK_sorting03_inventory",CPar,CChild));

TPar= Tables["sorting02"];
TChild= Tables["inventory"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor02"]};
Relations.Add(new DataRelation("FK_sorting02_inventory",CPar,CChild));

TPar= Tables["sorting01"];
TChild= Tables["inventory"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor01"]};
Relations.Add(new DataRelation("FK_sorting01_inventory",CPar,CChild));
...
Relations.Add(new DataRelation("inventorykindinventory",CPar,CChild));
...
Relations.Add(new DataRelation("inventoryagencyinventory",CPar,CChild));
