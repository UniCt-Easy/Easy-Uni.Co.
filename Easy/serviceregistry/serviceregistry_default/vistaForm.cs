...
public partial class vistaForm: DataSet {
	...
	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public DataTable publicinstitutionservice 		=> Tables["publicinstitutionservice"];

	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public DataTable thematicscope 		=> Tables["thematicscope"];

	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public DataTable apactivitykind 		=> Tables["apactivitykind"];

	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public DataTable thematicscope_backup 		=> Tables["thematicscope_backup"];
...
private void initClass() {
	...
	var tpublicinstitutionservice= new DataTable("publicinstitutionservice");
	C= new DataColumn("idpublicinstitutionservice", typeof(int));
	C.AllowDBNull=false;
	tpublicinstitutionservice.Columns.Add(C);
	C= new DataColumn("ayear", typeof(int));
	C.AllowDBNull=false;
	tpublicinstitutionservice.Columns.Add(C);
	tpublicinstitutionservice.Columns.Add( new DataColumn("idservizio", typeof(string)));
	tpublicinstitutionservice.Columns.Add( new DataColumn("description", typeof(string)));
	tpublicinstitutionservice.Columns.Add( new DataColumn("printingorder", typeof(string)));
	tpublicinstitutionservice.Columns.Add( new DataColumn("paridpublicinstitutionservice", typeof(int)));
	tpublicinstitutionservice.Columns.Add( new DataColumn("nlevel", typeof(int)));
	tpublicinstitutionservice.Columns.Add( new DataColumn("active", typeof(Char)));
	tpublicinstitutionservice.Columns.Add( new DataColumn("ct", typeof(DateTime)));
	tpublicinstitutionservice.Columns.Add( new DataColumn("cu", typeof(string)));
	tpublicinstitutionservice.Columns.Add( new DataColumn("lt", typeof(DateTime)));
	tpublicinstitutionservice.Columns.Add( new DataColumn("lu", typeof(string)));
	Tables.Add(tpublicinstitutionservice);
	tpublicinstitutionservice.PrimaryKey =  new DataColumn[]{tpublicinstitutionservice.Columns["idpublicinstitutionservice"], tpublicinstitutionservice.Columns["ayear"]};


	//////////////////// THEMATICSCOPE /////////////////////////////////
	var tthematicscope= new DataTable("thematicscope");
	C= new DataColumn("idthematicscope", typeof(int));
	C.AllowDBNull=false;
	tthematicscope.Columns.Add(C);
	tthematicscope.Columns.Add( new DataColumn("description_consultant", typeof(string)));
	tthematicscope.Columns.Add( new DataColumn("description_employee", typeof(string)));
	tthematicscope.Columns.Add( new DataColumn("idemployee", typeof(string)));
	tthematicscope.Columns.Add( new DataColumn("idconsultant", typeof(string)));
	tthematicscope.Columns.Add( new DataColumn("code", typeof(string)));
	tthematicscope.Columns.Add( new DataColumn("ct", typeof(DateTime)));
	tthematicscope.Columns.Add( new DataColumn("cu", typeof(string)));
	tthematicscope.Columns.Add( new DataColumn("lt", typeof(DateTime)));
	tthematicscope.Columns.Add( new DataColumn("lu", typeof(string)));
	C= new DataColumn("ayear", typeof(int));
	C.AllowDBNull=false;
	tthematicscope.Columns.Add(C);
	tthematicscope.Columns.Add( new DataColumn("active", typeof(string)));
	tthematicscope.Columns.Add( new DataColumn("description", typeof(string)));
	Tables.Add(tthematicscope);
	tthematicscope.PrimaryKey =  new DataColumn[]{tthematicscope.Columns["ayear"], tthematicscope.Columns["idthematicscope"]};
	...
	//////////////////// THEMATICSCOPE_BACKUP /////////////////////////////////
	var tthematicscope_backup= new DataTable("thematicscope_backup");
	C= new DataColumn("idthematicscope", typeof(int));
	C.AllowDBNull=false;
	tthematicscope_backup.Columns.Add(C);
	tthematicscope_backup.Columns.Add( new DataColumn("description_consultant", typeof(string)));
	tthematicscope_backup.Columns.Add( new DataColumn("description_employee", typeof(string)));
	tthematicscope_backup.Columns.Add( new DataColumn("idemployee", typeof(string)));
	tthematicscope_backup.Columns.Add( new DataColumn("idconsultant", typeof(string)));
	tthematicscope_backup.Columns.Add( new DataColumn("code", typeof(string)));
	tthematicscope_backup.Columns.Add( new DataColumn("ct", typeof(DateTime)));
	tthematicscope_backup.Columns.Add( new DataColumn("cu", typeof(string)));
	tthematicscope_backup.Columns.Add( new DataColumn("lt", typeof(DateTime)));
	tthematicscope_backup.Columns.Add( new DataColumn("lu", typeof(string)));
	C= new DataColumn("ayear", typeof(int));
	C.AllowDBNull=false;
	tthematicscope_backup.Columns.Add(C);
	tthematicscope_backup.Columns.Add( new DataColumn("active", typeof(string)));
	tthematicscope_backup.Columns.Add( new DataColumn("description", typeof(string)));
	Tables.Add(tthematicscope_backup);
	tthematicscope_backup.PrimaryKey =  new DataColumn[]{tthematicscope_backup.Columns["ayear"], tthematicscope_backup.Columns["idthematicscope"]};


	//////////////////// APACTIVITYKIND_BACKUP /////////////////////////////////
	var tapactivitykind_backup= new DataTable("apactivitykind_backup");
	C= new DataColumn("idapactivitykind", typeof(string));
	C.AllowDBNull=false;
	tapactivitykind_backup.Columns.Add(C);
	C= new DataColumn("ayear", typeof(int));
	C.AllowDBNull=false;
	tapactivitykind_backup.Columns.Add(C);
	C= new DataColumn("description", typeof(string));
	...
	C.AllowDBNull=false;
	tapactivitykind_backup.Columns.Add(C);
	tapactivitykind_backup.Columns.Add( new DataColumn("active", typeof(string)));
	tapactivitykind_backup.Columns.Add( new DataColumn("description_consultant", typeof(string)));
	tapactivitykind_backup.Columns.Add( new DataColumn("description_employee", typeof(string)));
	tapactivitykind_backup.Columns.Add( new DataColumn("idconsultant", typeof(string)));
	tapactivitykind_backup.Columns.Add( new DataColumn("idemployee", typeof(string)));
	Tables.Add(tapactivitykind_backup);
	...
	cPar = new []{publicinstitutionservice.Columns["idpublicinstitutionservice"], publicinstitutionservice.Columns["ayear"]};
	cChild = new []{serviceregistry.Columns["idpublicinstitutionservice"], serviceregistry.Columns["yservreg"]};
	Relations.Add(new DataRelation("publicinstitutionservice_serviceregistry",cPar,cChild,false));

	cPar = new []{thematicscope.Columns["ayear"], thematicscope.Columns["idthematicscope"]};
	cChild = new []{serviceregistry.Columns["yservreg"], serviceregistry.Columns["idthematicscope"]};
	Relations.Add(new DataRelation("thematicscope_serviceregistry",cPar,cChild,false));
