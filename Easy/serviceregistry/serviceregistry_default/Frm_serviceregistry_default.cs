...
namespace serviceregistry_default
{
	...
	/// </summary>
	public class Frm_serviceregistry_default : MetaDataForm
	{
		/// <summary>
		...
		private TabPage tabPerla;
		private Label label37;
		private TextBox textBox2;
		private TabPage tabAllegati;
		private GroupBox groupBox5;
		private Label labAutoCertificazione;
		private Button btnVisualizzaDichiarazioneIncarichi;
		private Button btnRimuoviDichiarazioneIncarichi;
		private Button btnAllegaDichiarazioneIncarichi;
		...
		private TextBox txtpa_code;
		private Label label41;
        private ComboBox cmbServizio;
        private Label lblServizio;
        private GroupBox grpAmbitoTematico;
        private ComboBox cmbAmbitoTematico;
		...
		public Frm_serviceregistry_default()
		{
			...
			//
			InitializeComponent();
            opendlg = createOpenFileDialog(this._opendlg);
            opendlg.Title = "Scegli il file da allegare";
		...
		private void InitializeComponent()
		{
			...
			this.grpAmbitoTematico = new System.Windows.Forms.GroupBox();
			this.cmbAmbitoTematico = new System.Windows.Forms.ComboBox();
			this.lblServizio = new System.Windows.Forms.Label();
			this.cmbServizio = new System.Windows.Forms.ComboBox();
			...
			this.grpAmbitoTematico.SuspendLayout();
			...
			this.Principale.Controls.Add(this.tabAllegati);
			this.Principale.Controls.Add(this.tabPerla);
			this.Principale.Location = new System.Drawing.Point(2, 1);
			this.Principale.Name = "Principale";
			this.Principale.SelectedIndex = 0;
			this.Principale.Size = new System.Drawing.Size(933, 780);
			...
			this.txtBozza.Location = new System.Drawing.Point(838, 9);
			...
			this.grpAnagraficaConferente.Location = new System.Drawing.Point(8, 617);
			this.grpAnagraficaConferente.Name = "grpAnagraficaConferente";
			this.grpAnagraficaConferente.Size = new System.Drawing.Size(893, 125);
			...
			this.groupBox4.Size = new System.Drawing.Size(455, 46);
			...
			this.txtGeoComuneConferente.Size = new System.Drawing.Size(448, 20);
			...
			this.grpSessoConferente.Size = new System.Drawing.Size(212, 44);
			...
			this.chkEsteroConferente.Size = new System.Drawing.Size(260, 19);
			...
			this.cmbtipologiaconferente.Location = new System.Drawing.Point(142, 589);
			this.cmbtipologiaconferente.Name = "cmbtipologiaconferente";
			this.cmbtipologiaconferente.Size = new System.Drawing.Size(467, 21);
			...
			// 
			this.btnTipologiaConferente.Location = new System.Drawing.Point(8, 587);
			...
			this.cmbTipologia.Size = new System.Drawing.Size(266, 21);
			...
			this.grpContratto.Controls.Add(this.chkdelivered);
			...
			this.grpContratto.Size = new System.Drawing.Size(909, 42);
			...
			this.chkblocked.Size = new System.Drawing.Size(379, 32);
			this.chkblocked.TabIndex = 7;
			this.chkblocked.Tag = "serviceregistry.is_blocked:S:N";
			this.chkblocked.Text = "Incarico da correggere, vedasi sezione Perla per i dettagli sugli errori. ";
			...
			// chkdelivered
			// 
			this.chkdelivered.Location = new System.Drawing.Point(264, 16);
			this.chkdelivered.Name = "chkdelivered";
			this.chkdelivered.Size = new System.Drawing.Size(80, 16);
			this.chkdelivered.TabIndex = 3;
			this.chkdelivered.TabStop = false;
			this.chkdelivered.Tag = "serviceregistry.is_delivered:S:N";
			this.chkdelivered.Text = "Trasmesso";
			// 
			// chkis_annulled
			// 
			...
			this.grbincarico.Location = new System.Drawing.Point(8, 365);
			this.grbincarico.Name = "grbincarico";
			this.grbincarico.Size = new System.Drawing.Size(909, 216);
			...
			this.groupBox2.Location = new System.Drawing.Point(751, 10);
			...
			this.grpAttivitaEconomica.Location = new System.Drawing.Point(591, 140);
    ...
    "tivitycode";
			...
			this.chkofficeduty.Location = new System.Drawing.Point(789, 90);
			...
			this.txtvariaizoneincarico.Size = new System.Drawing.Size(306, 33);
			...
			this.txtdescription.Size = new System.Drawing.Size(339, 40);
			...
			this.cmbtiporapporto.Size = new System.Drawing.Size(355, 21);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.grpincaricato.Controls.Add(this.grpAmbitoTematico);
			this.grpincaricato.Controls.Add(this.lblServizio);
			this.grpincaricato.Controls.Add(this.cmbServizio);
			...
			this.grpincaricato.Size = new System.Drawing.Size(909, 288);
			...
			// grpAmbitoTematico
			// 
			this.grpAmbitoTematico.Controls.Add(this.cmbAmbitoTematico);
			this.grpAmbitoTematico.Location = new System.Drawing.Point(6, 77);
			this.grpAmbitoTematico.Name = "grpAmbitoTematico";
			this.grpAmbitoTematico.Size = new System.Drawing.Size(447, 50);
			this.grpAmbitoTematico.TabIndex = 194;
			this.grpAmbitoTematico.TabStop = false;
			this.grpAmbitoTematico.Text = "Ambito Tematico";
			// 
			// cmbAmbitoTematico
			// 
			this.cmbAmbitoTematico.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.cmbAmbitoTematico.DataSource = this.DS.thematicscope;
			this.cmbAmbitoTematico.DisplayMember = "description_employee";
			this.cmbAmbitoTematico.FormattingEnabled = true;
			this.cmbAmbitoTematico.Location = new System.Drawing.Point(4, 19);
			this.cmbAmbitoTematico.Name = "cmbAmbitoTematico";
			this.cmbAmbitoTematico.Size = new System.Drawing.Size(437, 21);
			this.cmbAmbitoTematico.TabIndex = 193;
			this.cmbAmbitoTematico.Tag = "serviceregistry.idthematicscope";
			this.cmbAmbitoTematico.ValueMember = "idthematicscope";
			// 
			// lblServizio
			// 
			this.lblServizio.Location = new System.Drawing.Point(275, 45);
			this.lblServizio.Name = "lblServizio";
			this.lblServizio.Size = new System.Drawing.Size(51, 29);
			this.lblServizio.TabIndex = 193;
			this.lblServizio.Text = "Servizio\r\nPubblico";
			// 
			// cmbServizio
			// 
			this.cmbServizio.DataSource = this.DS.publicinstitutionservice;
			this.cmbServizio.DisplayMember = "description";
			this.cmbServizio.FormattingEnabled = true;
			this.cmbServizio.Location = new System.Drawing.Point(332, 48);
			this.cmbServizio.Name = "cmbServizio";
			this.cmbServizio.Size = new System.Drawing.Size(386, 21);
			this.cmbServizio.TabIndex = 192;
			this.cmbServizio.Tag = "serviceregistry.idpublicinstitutionservice";
			this.cmbServizio.ValueMember = "idservizio";
			// 
			// btnTipologiaSocieta
			// 
			this.btnTipologiaSocieta.Location = new System.Drawing.Point(378, 14);
			...
			this.cmbTipologiaSocieta.Size = new System.Drawing.Size(399, 21);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.groupBox1.Controls.Add(this.lblMatricola);
			this.groupBox1.Controls.Add(this.txtMatricola);
			...
			this.groupBox1.Size = new System.Drawing.Size(893, 125);
			...
			this.lblMatricola.Location = new System.Drawing.Point(32, 104);
			this.lblMatricola.Name = "lblMatricola";
			this.lblMatricola.Size = new System.Drawing.Size(50, 13);
			this.lblMatricola.TabIndex = 197;
			this.lblMatricola.Text = "Matricola";
			// 
			// txtMatricola
			// 
			this.txtMatricola.Location = new System.Drawing.Point(88, 101);
			this.txtMatricola.Name = "txtMatricola";
			this.txtMatricola.Size = new System.Drawing.Size(224, 20);
			this.txtMatricola.TabIndex = 196;
			this.txtMatricola.Tag = "registry.extmatricula?serviceregistryview.extmatricula";
			// 
			// groupBox3
			// 
			...
			this.groupBox3.Location = new System.Drawing.Point(514, 73);
			this.groupBox3.Name = "groupBox3";
			this.groupBox3.Size = new System.Drawing.Size(379, 46);
			...
			this.txtGeoComune.Size = new System.Drawing.Size(372, 20);
			...
			this.grbSesso.Size = new System.Drawing.Size(212, 44);
			...
			// txtDataNascita
			// 
			this.txtDataNascita.Location = new System.Drawing.Point(384, 55);
			...
			// lblPartitaIVA
			// 
			this.lblPartitaIVA.Location = new System.Drawing.Point(18, 81);
			...
			// txtPartitaIva
			// 
			this.txtPartitaIva.Location = new System.Drawing.Point(88, 79);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.chkestero.Location = new System.Drawing.Point(360, 84);
			this.chkestero.Name = "chkestero";
			this.chkestero.Size = new System.Drawing.Size(148, 19);
			...
			// txtCodiceFiscale
			// 
			this.txtCodiceFiscale.Location = new System.Drawing.Point(88, 57);
			...
			// txtforename
			// 
			this.txtforename.Location = new System.Drawing.Point(384, 33);
			...
			this.cmbQualifica.Location = new System.Drawing.Point(789, 48);
			this.cmbQualifica.Name = "cmbQualifica";
			this.cmbQualifica.Size = new System.Drawing.Size(113, 21);
			...
			// btnqualifica
			// 
			this.btnqualifica.Location = new System.Drawing.Point(724, 45);
			this.btnqualifica.Name = "btnqualifica";
			this.btnqualifica.Size = new System.Drawing.Size(61, 24);
			...
			this.tabPubblicazione.Size = new System.Drawing.Size(925, 754);
    ...
    "azione sul sito web istituzionale.";
			...
			this.tabPagamento.Size = new System.Drawing.Size(925, 754);
			...
			this.GBoxPagamento.Size = new System.Drawing.Size(909, 294);
			...
			this.gridPagamento.Size = new System.Drawing.Size(813, 270);
			...
			this.tabConferente.Size = new System.Drawing.Size(925, 754);
			...
			this.grbconferente.Size = new System.Drawing.Size(900, 744);
			...
			this.txtNote.Size = new System.Drawing.Size(750, 56);
			this.txtNote.TabIndex = 60;
			this.txtNote.Tag = "serviceregistry.notes";
			// 
			// txtIdMittente
			// 
			this.txtIdMittente.Location = new System.Drawing.Point(159, 49);
    ...
    "ottato dall\'amministrazione";
			...
			this.textBox8.Size = new System.Drawing.Size(747, 41);
			...
			this.txtRelazioneAccompagnamento.Size = new System.Drawing.Size(750, 75);
    ...
    " \t\r\n";
			...
			this.tabAttributi.Size = new System.Drawing.Size(925, 754);
			...
			this.gboxclass05.Size = new System.Drawing.Size(710, 64);
			...
			this.txtDenom05.Size = new System.Drawing.Size(468, 52);
			...
			this.gboxclass04.Size = new System.Drawing.Size(710, 64);
			...
			this.txtDenom04.Size = new System.Drawing.Size(468, 46);
			...
			this.gboxclass03.Size = new System.Drawing.Size(710, 64);
			...
			this.txtDenom03.Size = new System.Drawing.Size(469, 52);
			...
			this.gboxclass02.Size = new System.Drawing.Size(710, 64);
			...
			this.txtDenom02.Size = new System.Drawing.Size(469, 52);
			...
			this.gboxclass01.Size = new System.Drawing.Size(710, 64);
			...
			this.txtDenom01.Size = new System.Drawing.Size(469, 52);
			...
			// tabAllegati
			// 
			this.tabAllegati.Controls.Add(this.groupBox6);
			this.tabAllegati.Controls.Add(this.groupBox5);
			...
			this.tabAllegati.Size = new System.Drawing.Size(925, 754);
			this.tabAllegati.TabIndex = 6;
			...
			this.groupBox5.Controls.Add(this.btnVisualizzaDichiarazioneIncarichi);
			this.groupBox5.Controls.Add(this.btnRimuoviDichiarazioneIncarichi);
			this.groupBox5.Controls.Add(this.btnAllegaDichiarazioneIncarichi);
			this.groupBox5.Location = new System.Drawing.Point(21, 18);
			this.groupBox5.Name = "groupBox5";
			this.groupBox5.Size = new System.Drawing.Size(438, 110);
			this.groupBox5.TabIndex = 206;
			this.groupBox5.TabStop = false;
			this.groupBox5.Text = "Dichiarazione incarichi";
			// 
			// labAutoCertificazione
			// 
			this.labAutoCertificazione.Location = new System.Drawing.Point(16, 32);
			this.labAutoCertificazione.Name = "labAutoCertificazione";
			this.labAutoCertificazione.Size = new System.Drawing.Size(407, 22);
			this.labAutoCertificazione.TabIndex = 74;
			this.labAutoCertificazione.Tag = "";
			// 
			// btnVisualizzaDichiarazioneIncarichi
			// 
			this.btnVisualizzaDichiarazioneIncarichi.Location = new System.Drawing.Point(353, 70);
			this.btnVisualizzaDichiarazioneIncarichi.Name = "btnVisualizzaDichiarazioneIncarichi";
			this.btnVisualizzaDichiarazioneIncarichi.Size = new System.Drawing.Size(79, 24);
			this.btnVisualizzaDichiarazioneIncarichi.TabIndex = 2;
			this.btnVisualizzaDichiarazioneIncarichi.Text = "Visualizza";
			this.btnVisualizzaDichiarazioneIncarichi.UseVisualStyleBackColor = true;
			this.btnVisualizzaDichiarazioneIncarichi.Click += new System.EventHandler(this.btnVisualizzaDichiarazioneIncarichi_Click);
			// 
			// btnRimuoviDichiarazioneIncarichi
			// 
			this.btnRimuoviDichiarazioneIncarichi.Location = new System.Drawing.Point(232, 70);
			this.btnRimuoviDichiarazioneIncarichi.Name = "btnRimuoviDichiarazioneIncarichi";
			this.btnRimuoviDichiarazioneIncarichi.Size = new System.Drawing.Size(101, 24);
			this.btnRimuoviDichiarazioneIncarichi.TabIndex = 1;
			this.btnRimuoviDichiarazioneIncarichi.Text = "Rimuovi Allegato";
			this.btnRimuoviDichiarazioneIncarichi.UseVisualStyleBackColor = true;
			this.btnRimuoviDichiarazioneIncarichi.Click += new System.EventHandler(this.btnRimuoviDichiarazioneIncarichi_Click);
			// 
			// btnAllegaDichiarazioneIncarichi
			// 
			this.btnAllegaDichiarazioneIncarichi.Location = new System.Drawing.Point(136, 70);
			this.btnAllegaDichiarazioneIncarichi.Name = "btnAllegaDichiarazioneIncarichi";
			this.btnAllegaDichiarazioneIncarichi.Size = new System.Drawing.Size(79, 24);
			this.btnAllegaDichiarazioneIncarichi.TabIndex = 0;
			...
			// tabPerla
			// 
			this.tabPerla.Controls.Add(this.label41);
			this.tabPerla.Controls.Add(this.txtCodicePaIpa);
			this.tabPerla.Controls.Add(this.label40);
			this.tabPerla.Controls.Add(this.txtUOIpa);
			this.tabPerla.Controls.Add(this.label39);
			this.tabPerla.Controls.Add(this.txtAOOIpa);
			this.tabPerla.Controls.Add(this.label38);
			this.tabPerla.Controls.Add(this.label21);
			this.tabPerla.Controls.Add(this.button1);
			this.tabPerla.Controls.Add(this.txtpa_code);
			this.tabPerla.Controls.Add(this.label37);
			this.tabPerla.Controls.Add(this.textBox2);
			this.tabPerla.Location = new System.Drawing.Point(4, 22);
			this.tabPerla.Name = "tabPerla";
			this.tabPerla.Padding = new System.Windows.Forms.Padding(3);
			this.tabPerla.Size = new System.Drawing.Size(925, 754);
			this.tabPerla.TabIndex = 5;
			this.tabPerla.Text = "Perla";
			this.tabPerla.UseVisualStyleBackColor = true;
			// 
			// label41
			// 
			this.label41.AutoSize = true;
			this.label41.Location = new System.Drawing.Point(422, 19);
			this.label41.Name = "label41";
			this.label41.Size = new System.Drawing.Size(325, 26);
			this.label41.TabIndex = 84;
			this.label41.Text = "Nota: AOO e UO vanno valorizzati in modo mutualmente esclusivo. \r\nOve inseriti en" +
    "trambi sar‡ considerato solo AOO";
			// 
			// txtCodicePaIpa
			// 
			this.txtCodicePaIpa.Location = new System.Drawing.Point(196, 83);
			this.txtCodicePaIpa.Name = "txtCodicePaIpa";
			this.txtCodicePaIpa.Size = new System.Drawing.Size(158, 20);
			this.txtCodicePaIpa.TabIndex = 76;
			this.txtCodicePaIpa.Tag = "serviceregistry.codicepaipa";
			// 
			// label40
			// 
			this.label40.AutoSize = true;
			this.label40.Location = new System.Drawing.Point(133, 86);
			...
			// txtUOIpa
			// 
			this.txtUOIpa.Location = new System.Drawing.Point(425, 80);
			this.txtUOIpa.Name = "txtUOIpa";
			this.txtUOIpa.Size = new System.Drawing.Size(279, 20);
			this.txtUOIpa.TabIndex = 74;
			this.txtUOIpa.Tag = "serviceregistry.codiceuoipa";
			// 
			// label39
			// 
			this.label39.AutoSize = true;
			this.label39.Location = new System.Drawing.Point(384, 83);
			...
			// txtAOOIpa
			// 
			this.txtAOOIpa.Location = new System.Drawing.Point(425, 54);
			this.txtAOOIpa.Name = "txtAOOIpa";
			this.txtAOOIpa.Size = new System.Drawing.Size(279, 20);
			this.txtAOOIpa.TabIndex = 72;
			this.txtAOOIpa.Tag = "serviceregistry.codiceaooipa";
			// 
			// label38
			// 
			this.label38.AutoSize = true;
			this.label38.Location = new System.Drawing.Point(384, 57);
			...
			this.label21.Location = new System.Drawing.Point(16, 57);
			...
			this.button1.Tag = "choose.serviceagency.default";
			this.button1.Text = "Seleziona Aoo o Uo";
			// 
			// txtpa_code
			// 
			this.txtpa_code.Location = new System.Drawing.Point(196, 52);
			this.txtpa_code.Name = "txtpa_code";
			this.txtpa_code.ReadOnly = true;
			this.txtpa_code.Size = new System.Drawing.Size(158, 20);
			this.txtpa_code.TabIndex = 68;
			this.txtpa_code.Tag = "serviceregistry.pa_code";
			// 
			// label37
			// 
			this.label37.AutoSize = true;
			this.label37.Location = new System.Drawing.Point(6, 167);
			this.label37.Name = "label37";
			this.label37.Size = new System.Drawing.Size(61, 13);
			this.label37.TabIndex = 1;
			this.label37.Text = "Errore perla";
			// 
			// textBox2
			// 
			...
			this.textBox2.Size = new System.Drawing.Size(913, 556);
			this.textBox2.TabIndex = 0;
			this.textBox2.Tag = "serviceregistry.perla_error";
			// 
			// radioButton2
			// 
			...
			this.ClientSize = new System.Drawing.Size(937, 786);
			...
			this.grpAmbitoTematico.ResumeLayout(false);
        ...
        public void MetaData_AfterLink() {
            ...
            #region task_17488
            GetData.CacheTable(DS.publicinstitutionservice, filteresercizio, null, false);
            GetData.CacheTable(DS.thematicscope, filteresercizio, null, false);
			GetData.CacheTable(DS.thematicscope_backup, filteresercizio, null, false);
			GetData.CacheTable(DS.apactivitykind, filteresercizio, null, false);
			GetData.CacheTable(DS.apactivitykind_backup, filteresercizio, null, false);
            GetData.CacheTable(DS.referencerule, filteresercizio, null, false);
            GetData.MarkToAddBlankRow(DS.thematicscope);
			GetData.MarkToAddBlankRow(DS.publicinstitutionservice);
            GetData.MarkToAddBlankRow(DS.apactivitykind);
            GetData.Add_Blank_Row(DS.thematicscope);
            GetData.Add_Blank_Row(DS.publicinstitutionservice);
            ...
            DataAccess.SetTableForReading(DS.apactivitykind_backup, "apactivitykind");
            DataAccess.SetTableForReading(DS.thematicscope_backup, "thematicscope");

            PostData.MarkAsTemporaryTable(DS.apactivitykind_backup, false);
			PostData.MarkAsTemporaryTable(DS.thematicscope_backup, false);
        ...
        public void MetaData_AfterPost() {
          if (DS.serviceregistry.Rows.Count==0) return; //It was an insert-cancel
			...
			if(Curr["authorizationdate"]==DBNull.Value) {
                show("Non Ë stata inserita la data Conferimento/Autorizzazione. Questo causer‡ lo scarto dell'incarico nella pubblicazione sul sito Web Istituzionale"
		...
		public void MetaData_AfterClear() 
		{
			...
			txtAOOIpa.ReadOnly = false;
			txtUOIpa.ReadOnly = false;
...
//			chkblocked.Visible = true;
        ...
        public void MetaData_AfterRowSelect(DataTable T, DataRow R) {
            ...
            if (T.TableName == "serviceagency" && Meta.DrawStateIsDone && R!=null && (chkdelivered.Checked==false) && (chkblocked.Checked==false) ) {
	            if (R["codicepaipa"] != DBNull.Value) {
		            Curr["codicepaipa"] = R["codicepaipa"];
		            txtCodicePaIpa.Text = Curr["codicepaipa"].ToString();
	            }
	            if (R["codiceaooipa"] != DBNull.Value) {
		            Curr["codiceaooipa"] = R["codiceaooipa"];
		            Curr["codiceuoipa"] = DBNull.Value;
		            txtAOOIpa.Text = Curr["codiceaooipa"].ToString();
		            txtUOIpa.Text = Curr["codiceuoipa"].ToString();
	            }
	            else {
		            if (R["codiceuoipa"] != DBNull.Value) {
			            Curr["codiceuoipa"] = R["codiceuoipa"];
			            Curr["codiceaooipa"] = DBNull.Value;
			            txtAOOIpa.Text = Curr["codiceaooipa"].ToString();
			            txtUOIpa.Text = Curr["codiceuoipa"].ToString();
		            }
	            }
		...
		private void RiempieOggettiCD(DataRow R) {
			...
			if(R["idregistryclass"] == DBNull.Value) {
				show("Selezionare la tipologia dell'anagrafica nella scheda principale dell'anagrafica");
				return;
			}
		...
		private void gestioneFlag() 
		{
			...
			{
				ConsentiElimina(false);
                if (annullato && chkdelivered.Checked)	
			...
			txtAOOIpa.ReadOnly = (chkblocked.Checked || chkdelivered.Checked);
			txtUOIpa.ReadOnly = (chkblocked.Checked || chkdelivered.Checked);
        ...
        void VerificaCoerenzaEsercizio(string kind){
            ...
            if (kind == "C") {
                ...
                if (riferimento is DateTime) {
                    ...
                    if (Anno != Esercizio) {
                        show(this, "L'anno di Affidamento deve essere uguale all'esercizio incarico.");
                    }
                }
            }
            // D
                ...
                if (riferimento is DateTime) {
                    ...
                    int Anno = dataRiferimento.Year;
                    if (Anno != Esercizio) {
                        show(this, "L'anno di Conferimento/Autorizzazione deve essere uguale all'esercizio incarico.");
                    }
                }
            }
        }
        ...
        public void MetaData_AfterFill() {
			...
			if (Meta.InsertMode || Meta.EditMode){
				...
				if (Curr.RowState == DataRowState.Modified &&
				    Curr["id_service", DataRowVersion.Original] == DBNull.Value) {
					txtidservice.Enabled = true;
				}
			...
			DataRow dichiarazioneIncarichi = DS.serviceregistry.Rows[0];
			if (dichiarazioneIncarichi["dichiarazione_incarichi"] != DBNull.Value) {
				byte[] B = (byte[])dichiarazioneIncarichi["dichiarazione_incarichi"];
        ...
        private void AggiornamentoSaldoIncarico(){
            ...
            if (expectedamount == 0) {
                if (show("Aggiorno il campo Incarico Saldato ponendolo uguale a SÏ?",
        ...
        private void VisualizzaStatoCV() {
            ...
            if (maxreferencedate == DBNull.Value) {
                ...
                if (CVObbligatorio) {
                    show("La Tipologia Incarico scelta, prevede la presenza del CV dell'incaricato. Inserirlo nella scheda Anagrafica.");
                }
            }
            else{
        ...
        private void AbilitaCodiciValidi()
        {
            ...
            #region task_17488
            //Servizio Pubblico
            DS.publicinstitutionservice.Clear();
            cmbServizio.DataSource = null;
            filtro_active = QHS.AppAnd(filtrocmb_ayear, QHS.CmpEq("active", "S"));
            GetData.Add_Blank_Row(DS.publicinstitutionservice);
            DataAccess.RUN_SELECT_INTO_TABLE(Meta.Conn, DS.publicinstitutionservice, null, filtro_active, null, true);
            cmbServizio.DataSource = DS.publicinstitutionservice;
            cmbServizio.DisplayMember = "description";
            cmbServizio.ValueMember = "idpublicinstitutionservice";
            Meta.myHelpForm.PreFillControlsTable(cmbServizio, null);
            if (DS.serviceregistry.Rows.Count > 0) {
                HelpForm.SetComboBoxValue(cmbServizio, DS.serviceregistry.Rows[0]["idpublicinstitutionservice"]);
            }
            #endregion
			...
			bool consulente = (rdbconsulente01.Checked || rdbconsulente02.Checked);

			//Extensions.UpdateADP(cmbtipologiaincarico, Meta);
			cmbtipologiaincarico.UpdateADP();
			//Extensions.UpdateADP(cmbAmbitoTematico, Meta);
			cmbAmbitoTematico.UpdateADP();
        ...
        private void ImpostaComune(object idComune) {
			...
			if (maxversion!= DBNull.Value){
				...
				show("Il Comune Sede selezionato non Ë valido");
				txtGeoComune.Text="";
				if ((!MetaData.Empty(this))){
...
Componenti variabili del compenso(componentsvariable)
        ...
        private void abilitaControlli(bool consulente)	{
            ...
            if (!Meta.IsEmpty) {
                ...
                if (idapregistrykind == 4 || idapregistrykind == 5) abilitaSelezioneTipologiaConsulente_AziendaConferente = true;
            }
            else {
...
//3) Oggetto dell'incarico
            if (ToPublish() == "S") {//Il controllo Ë presente nell'IsValid
                ...
                cmbtipologiaincarico.Enabled = true;//!consulente;
                if (consulente) {
            ...
            #region task_17488
            cmbServizio.Enabled = consulente;
            #endregion
        }

        #region task_17488
   //     /// <summary>
   //     /// Aggiorna la sorgente dati di un ComboBox in base al parametro "isConsulente".
   //     /// </summary>
   //     /// <param name="cmb">ComboBox da aggiornare</param>
   //     /// <param name="dt">DataTable che contiene i dati da mostrare. Deve avere una chiave nel formato id+"TableName",
   //     /// i campi "description_consultant" e "description_employee", "idconsultant" e "idemployee"</param>
   //     /// <param name="isConsulente">Parametro usato per discriminare la colonna da visualizzare</param>
   //     /// <returns>true se l'aggiornamento Ë andato a buon fine, false altrimenti</returns>
   //     private bool TryUpdateCmbADP(ComboBox cmb, DataTable dt, bool isConsulente, bool changed) {
			//if (cmb == null) return false;
			
   //         if (dt == null || string.IsNullOrEmpty(dt.TableName)) return false;
   //         string suffix = isConsulente ? "consultant" : "employee";
		 
   //         if (!changed) return true;

   //         string displayMember = "description_" + suffix;
   //         string valueMember = "id" + dt.TableName;
   //         string filtro_tipologia = QHS.IsNotNull("id" + suffix);
			//string filter =  filteresercizio;
			//filter = QHS.AppAnd(filtro_tipologia, filteresercizio);
			//bool enableold = true;
			//object oldcode = DBNull.Value;
			//if (cmb.SelectedValue != null)
			//	oldcode = cmb.SelectedValue;
			//if ((oldcode == null) || (oldcode.ToString() == "")) enableold = false;
			 
			//if ((enableold)&&(Meta.EditMode))
			//	filter = QHS.DoPar(QHS.AppOr(filter, QHS.CmpEq(valueMember, oldcode)));
			//if ((Meta.InsertMode) && (Meta.EditMode))
			//	filter = QHS.DoPar(QHS.AppOr(filter, QHS.CmpEq("active", "S")));

			//DataRow Curr = HelpForm.GetLastSelected(DS.serviceregistry);
			//// nokind
			//if ((Curr == null) && (!rdbdipendente.Checked) && (!rdbconsulente01.Checked) && (!rdbconsulente02.Checked)) { 
			//	filter = filteresercizio;
			//	if (dt.Columns.Contains("description")) displayMember = "description";
			//}

			//if (!dt.Columns.Contains(valueMember) || !dt.Columns.Contains(displayMember)) return false;
			//cmb.DataSource = null;
			//dt.Clear();
   //         GetData.Add_Blank_Row(dt);

   //         DataAccess.RUN_SELECT_INTO_TABLE(Conn, dt, null, filter, null, true);
   //         cmb.DataSource = dt;
   ...
   //     }
        ...
        private void rdbconsulente_CheckedChanged(object sender, System.EventArgs e){
			bool consulente = !rdbdipendente.Checked;
			if ((Meta!=null)&&Meta.DrawStateIsDone) {

				//Extensions.UpdateADP(cmbtipologiaincarico, Meta);
				cmbtipologiaincarico.UpdateADP(consulente? EmployKind.consultant : EmployKind.employee);
				//Extensions.UpdateADP(cmbAmbitoTematico, Meta);
				cmbAmbitoTematico.UpdateADP();
		...
		private void chkis_annulled_CheckedChanged(object sender, System.EventArgs e)
		{
			...
			{
                if (Meta.IsEmpty) return;
                chkdelivered.Checked = !annullato;
        ...
        private void txtDataautorizzazione_Leave(object sender, EventArgs e) {
            if (!Meta.DrawStateIsDone) return;
            if (Meta.IsEmpty) return;
            if (Meta.InsertMode || Meta.EditMode ) { //&& rdbdipendente.Checked, ora Ë obbligatorio anche per consulenti
		...
		private void btnAllegaDichiarazioneIncarichi_Click(object sender, EventArgs e) {
			SalvaAllegato("dichiarazione_incarichi");
		}

		void SalvaAllegato(string certification) {
			// Legge il file indicato dall'utente e lo scrive nel DB in 'dichiarazione_incarichi' 
			if (Meta.IsEmpty) return;
		...
		void abilitaDisabilitaAllegati() {
			...
			if (Curr["dichiarazione_incarichi"] != DBNull.Value) {
				byte[] B = (byte[])Curr["dichiarazione_incarichi"];
				labAutoCertificazione.Text = GetFileName(B);
				btnAllegaDichiarazioneIncarichi.Enabled = false;
				btnVisualizzaDichiarazioneIncarichi.Enabled = true;
				btnRimuoviDichiarazioneIncarichi.Enabled = true;
		...
		private void visualizzaAllegato(string certification) {
			...
			if (!CfgFn.ExtensionAllowed(estensione)) {
				DialogResult dr = show("Questo file puÚ danneggiare il computer! Sei sicuro di voler aprire questo file?", "Attenzione!", MessageBoxButtons.YesNo);
		...
		void ScriviFile(string sw, byte[] documento, int offset) {
			...
			var FS = new FileStream(sw, FileMode.Create, FileAccess.Write);
		...
		private void chkblocked_CheckedChanged(object sender, EventArgs e) {
			if (Meta.DrawStateIsDone) gestioneFlag();
		}
    }
}
