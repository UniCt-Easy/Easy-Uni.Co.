        ...
        public override void DescribeColumns(DataTable T, string ListingType)
			{
                ...
                DescribeAColumn(T,"apregistrykind","Tipologia conferente",nPos++);
					...
					DescribeAColumn(T,"acquirekind","Modalit‡ di acquisizione",nPos++);
					DescribeAColumn(T,"apcontractkind","Tipo rapporto",nPos++);
					DescribeAColumn(T,"financialactivity","Attivit‡ economica",nPos++);
...
//					DescribeAColumn(T,"payedamount","Importo pagato",nPos++);
	                ...
	                DescribeAColumn(T, "professionalservice", "Eventuali attivit‡ professionali", nPos++);	
