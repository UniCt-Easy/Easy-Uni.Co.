...
//Primary Key
	...
	T.Columns["yadmpay"], 	T.Columns["nadmpay"], 	T.Columns["nincome"], 	T.Columns["idsorkind"], 	T.Columns["idsor"], 	T.Columns["idsubclass"]};
	T.PrimaryKey = key;
...
//Primary Key
	key = new DataColumn[6]{
	T.Columns["yadmpay"], 	T.Columns["nadmpay"], 	T.Columns["nexpense"], 	T.Columns["idsorkind"], 	T.Columns["idsor"], 	T.Columns["idsubclass"]};
	T.PrimaryKey = key;
