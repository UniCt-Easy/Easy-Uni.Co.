...
namespace meta_$tableName$
{
    public class Meta_$tableName$ : Meta_easydata {
        public Meta_$tableName$(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "$tableName$") {
...
protected override Form GetForm(string FormName) {
    ...
    //    return MetaData.GetFormByDllName("$tableName$_default");
    //}
    return null;
}
...
public override DataRow SelectOne(string ListingType, string filter, string searchtable, DataTable Exclude) {
    ...
    //    return base.SelectOne(ListingType, filter, "$tableName$view", Exclude);
    //else
    return base.SelectOne(ListingType, filter, "$tableName$", Exclude);
}
