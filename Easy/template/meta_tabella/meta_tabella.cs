...
namespace meta_tabella
{
    public class Meta_tabella : Meta_easydata {
        public Meta_tabella(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "tabella") {
        ...
        protected override Form GetForm(string FormName) {
            ...
            //    return MetaData.GetFormByDllName("tabella_default");
            //}
            return null;
        }
