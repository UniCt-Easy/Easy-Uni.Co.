...
public class instmuserstrutturaRow: MetaRow  {
	public instmuserstrutturaRow(DataRowBuilder rb) : base(rb) {} 
	...
	public Int32? idinstmuserstruttura{ 
		get {if (this["idinstmuserstruttura"]==DBNull.Value)return null; return  (Int32?)this["idinstmuserstruttura"];}
		set {if (value==null) this["idinstmuserstruttura"]= DBNull.Value; else this["idinstmuserstruttura"]= value;}
	}
	public object idinstmuserstrutturaValue { 
		get{ return this["idinstmuserstruttura"];}
		set {if (value==null|| value==DBNull.Value) this["idinstmuserstruttura"]= DBNull.Value; else this["idinstmuserstruttura"]= value;}
	}
	public Int32? idinstmuserstrutturaOriginal { 
		get {if (this["idinstmuserstruttura",DataRowVersion.Original]==DBNull.Value)return null; return  (Int32?)this["idinstmuserstruttura",DataRowVersion.Original];}
	}
	///<summary>
	///Dipartimento
	///</summary>
...
public class instmuserstrutturaTable : MetaTableBase<instmuserstrutturaRow> {
	public instmuserstrutturaTable() : base("instmuserstruttura"){
		baseColumns = new Dictionary<string, DataColumn>(){
			{"ct",createColumn("ct",typeof(DateTime),false,false)},
			{"cu",createColumn("cu",typeof(string),false,false)},
			{"idinstmuserstruttura",createColumn("idinstmuserstruttura",typeof(int),false,false)},
