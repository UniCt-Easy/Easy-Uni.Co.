...
namespace meta_registryinstmuser_anagraficaview
{
    public class Meta_registryinstmuser_anagraficaview : Meta_easydata 
	{
        public Meta_registryinstmuser_anagraficaview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "registryinstmuser_anagraficaview") {
				Name = "Dati personali";
