...
namespace meta_docentidefaultview
{
    public class Meta_docentidefaultview : Meta_easydata 
	{
        public Meta_docentidefaultview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "docentidefaultview") {
		...
		//    //    return MetaData.GetFormByDllName("docentidefaultview_default");
		//    //}
		//    return null;
		//}
		...
		//public override DataRow SelectOne(string ListingType, string filter, string searchtable, DataTable Exclude) {
			...
			//    return base.SelectOne(ListingType, filter, "docentidefaultviewview", Exclude);
			//else
			//return base.SelectOne(ListingType, filter, "docentidefaultview", Exclude);
		//}
