...
namespace meta_registryistituti_princview
{
    public class Meta_registryistituti_princview : Meta_easydata 
	{
        public Meta_registryistituti_princview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "registryistituti_princview") {
				Name = "Istituto in gestione";
		...
		public override void DescribeColumns(DataTable T, string ListingType) {
			...
			switch (ListingType) {
				case "istituti_princ": {
						...
						DescribeAColumn(T, "registry_istituti_codiceustat", "Codice USTAT", nPos++);
						DescribeAColumn(T, "registry_istituti_comune", "Comune", nPos++);
						DescribeAColumn(T, "istitutokind_tipoistituto", "Tipologia", nPos++);
						DescribeAColumn(T, "registry_istituti_idistitutoustat", "Codice USTAT", nPos++);
