...
namespace meta_registryisituto_princview
{
    public class Meta_registryisituto_princview : Meta_easydata 
	{
        public Meta_registryisituto_princview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "registryisituto_princview") {
				Name = "Istituto in gestione";
			EditTypes.Add("isituto_princ");
			ListingTypes.Add("isituto_princ");
			//$EditTypes$
        }
		...
		public override void DescribeColumns(DataTable T, string ListingType) {
			...
			switch (ListingType) {
				case "isituto_princ": {
						...
						DescribeAColumn(T, "registry_extension", "tabella che estende il record", nPos++);
