...
//					SetTipoClassExtraParam(R["idregistryclass"].ToString());
			...
			//in fase di ricerca il codice fiscale non mi Ë utile
		...
		private void ConfiguraCredDebi(DataRow R) {
			...
			//se uno dei due codici fiscali Ë visibile tutti i campi dipendenti lo sono
			...
			// 13.07.05 Rusciano G. Questa riga Ë stata commentata in quanto sembra ci siano problemi
			// nel settare la propriet‡ Visible di una Label quando questa non Ë presente nel tabControl attivo
