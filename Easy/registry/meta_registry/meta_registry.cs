...
namespace meta_registry
{
	...
	public class Meta_registry : Meta_easydata
	{
						...
						if (edit_type == "anagrafica" || R["active"].ToString().ToUpper() == "S") {
							...
							if (rowTipo["flaghuman"].ToString().ToUpper() == "S" && R["active"].ToString().ToUpper() == "S") {
								if (R["surname"].ToString().Trim() == "") {
									errmess = "Attenzione! Per le persone fisiche il campo 'Cognome' Ë obbligatorio";
									errfield = "surname";
									return false;
								}

								if (R["forename"].ToString().Trim() == "") {
									errmess = "Attenzione! Per le persone fisiche il campo 'Nome' Ë obbligatorio";
									errfield = "forename";
									return false;
								}
								...
								if (R["birthdate"] != DBNull.Value) {
									if (((DateTime)R["birthdate"]).CompareTo(DateTime.Today) > 0) {
										errmess = "Attenzione! Non puÚ essere immessa una data di nascita futura";
										errfield = "birthdate";
										return false;
									}
								}
								...
								if (R["gender"].ToString() == "") {
									errmess = "Attenzione! Per le persone fisiche Ë necessario inserire il sesso";
									errfield = "gender";
									return false;
								}
							}
							...
							if (R["title"].ToString().Trim() == "") {
								errmess = "Attenzione! Il campo 'Denominazione' Ë obbligatorio";
								errfield = "title";

								messaggio = "Attenzione! Il campo 'Denominazione' Ë obbligatorio";
								return false;
							...
							if ((!CheckNOTNULL(R, "p_iva", rowTipo, "flagp_iva_forced"))
								&& R["active"].ToString().ToUpper() == "S") {
								errmess = "Attenzione! Il campo 'Partita IVA' Ë obbligatorio";
								errfield = "p_iva";
								return false;
							}
							...
							if (partitaIva != "" && R["active"].ToString().ToUpper() == "S") {
								...
								if (errorePIVA != null) {
									errmess = "Attenzione! La Partita IVA inserita non Ë valida\n" + errorePIVA;
									errfield = "p_iva";
									return false;
								}
							}
							...
							if ((!CheckNOTNULL(R, "idtitle", rowTipo, "flagqualification_forced"))
								&& R["active"].ToString().ToUpper() == "S") {
								errmess = "Attenzione! Il campo 'Titolo' Ë obbligatorio";
								errfield = "idtitle";

								messaggio = "Attenzione! Il campo 'Titolo' Ë obbligatorio";
							...
							if ((!CheckNOTNULL(R, "extmatricula", rowTipo, "flagextmatricula_forced"))
								&& R["active"].ToString().ToUpper() == "S") {
								errmess = "Attenzione! Il campo 'Matricola ext.' Ë obbligatorio. Procedo ugualmente?";
								errfield = "extmatricula";


								messaggio = "Attenzione! Il campo 'Matricola ext.' Ë obbligatorio. Procedo ugualmente?";
							...
							if ((!CheckNOTNULL(R, "badgecode", rowTipo, "flagbadgecode_forced"))
								&& R["active"].ToString().ToUpper() == "S") {
								errmess = "Attenzione! Il campo 'Badge' Ë obbligatorio. Procedo ugualmente?";
								errfield = "badgecode";


								messaggio = "Attenzione! Il campo 'Badge' Ë obbligatorio. Procedo ugualmente?";
							...
							if ((!CheckNOTNULL(R, "idmaritalstatus", rowTipo, "flagmaritalstatus_forced"))
								...
								errmess = "Attenzione! Il campo 'Stato civile' Ë obbligatorio";
								errfield = "idmaritalstatus";

								messaggio = "Attenzione! Il campo 'Stato civile' Ë obbligatorio";
							...
							if ((!CheckNOTNULL(R, "foreigncf", rowTipo, "flagforeigncf_forced"))
								...
								errmess = "Attenzione! Il campo 'Codice Fiscale Estero' Ë obbligatorio. Procedo ugualmente?";
								errfield = "foreigncf";


								messaggio = "Attenzione! Il campo 'Codice Fiscale Estero' Ë obbligatorio. Procedo ugualmente?";
							...
							if ((!CheckNOTNULL(R, "maritalsurname", rowTipo, "flagmaritalsurname_forced"))
								...
								errmess = "Attenzione! Il campo 'Cognome acquisito' Ë obbligatorio";
								errfield = "maritalsurname";

								messaggio = "Attenzione! Il campo 'Cognome acquisito' Ë obbligatorio";
							...
							"description");
									...
									errmess = $"Attenzione! Non Ë stato inserito l\'indirizzo di residenza ({predefinito}) valido per la data odierna.";
									errfield = "idaddresskind";
									return false;
									/*
									messaggio =
										$"Attenzione! Non Ë stato inserito l\'indirizzo di residenza ({predefinito}) valido per la data odierna.";
							...
							if (R["active"].ToString().ToUpper() == "S" &&
								...
								if (TBIndirizzo.Select(filtro).Length == 0) {
									errmess = "Attenzione! Non Ë stato inserito il domicilio fiscale per l'anagrafica.";
									errfield = "idaddresskind";
									messaggio = "Attenzione! Non Ë stato inserito il domicilio fiscale per l'anagrafica.";
									return false;
							...
							//se sono arrivato qui vuol dire che o il CF Ë <> "" oppure non Ë obbligatorio
							if (R["cf"].ToString() != "" && R["active"].ToString().ToUpper() == "S") {
								//se CF <> ""
								if (ValoreCampoTrue(rowTipo, "flaghuman")) {
									//e personafisica = S effettuo controllo su validit‡
									string errori;
									if (!CalcolaCodiceFiscale.CodiceFiscaleValido(Conn, R, out errori)) {

										errmess = "Il Codice Fiscale non Ë valido!\n" + errori;
										errfield = "cf";
										return false;
								...
								//	errmess = "La modalit‡ di pagamento predefinita non Ë stata inserita.";
							...
							//controllo validit‡ comune di nascita rispetto alla data di nascita
							//				if (R["birthdate"].ToString()!="" && R["idcity"].ToString()!="") {
							//					if (!IdGeoValido(R,"geo_comune_alias","idcomune")) {
							//						errmess="Attenzione! Il comune selezionato non Ë valido in relazione alla data nascita.";
							//						errfield="idcity";
							//						return false;
							//					}
							//				}
							//controllo validit‡ stato di nascita rispetto alla data di nascita
							//				if (R["birthdate"].ToString()!="" && R["idnation"].ToString()!="") {
							//					if (!IdGeoValido(R,"geo_nazione_alias","idstatoestero")) {
							//						errmess="Attenzione! Lo stato selezionato non Ë valido in relazione alla data nascita.";
							//						errfield="idnation";
							//						return false;
							//					}
							//				}
		...
		public override void DescribeColumns(DataTable T, string ListingType) {
			...
			switch (ListingType) {
				...
				case "istitutiesteri": {
						...
						DescribeAColumn(T, "p_iva", "Partita iva", nPos++);
						DescribeAColumn(T, "active", "attivo", nPos++);
						DescribeAColumn(T, "!idcity_geo_city_title", "Citt‡", nPos++);
		...
		/// <summary>
		/// Se il campo di creditoredebitore non Ë valorizzato e
