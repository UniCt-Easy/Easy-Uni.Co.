...
namespace meta_ivakindview {
public class ivakindviewRow: MetaRow  {
	public ivakindviewRow(DataRowBuilder rb) : base(rb) {} 
	...
	public String fenature{ 
		get {if (this["fenature"]==DBNull.Value)return null; return  (String)this["fenature"];}
		set {if (value==null) this["fenature"]= DBNull.Value; else this["fenature"]= value;}
	}
	public object fenatureValue { 
		get{ return this["fenature"];}
		set {if (value==null|| value==DBNull.Value) this["fenature"]= DBNull.Value; else this["fenature"]= value;}
	}
	public String fenatureOriginal { 
		get {if (this["fenature",DataRowVersion.Original]==DBNull.Value)return null; return  (String)this["fenature",DataRowVersion.Original];}
	}
	public String ivataxablekind{ 
		get {if (this["ivataxablekind"]==DBNull.Value)return null; return  (String)this["ivataxablekind"];}
		set {if (value==null) this["ivataxablekind"]= DBNull.Value; else this["ivataxablekind"]= value;}
	}
	public object ivataxablekindValue { 
		get{ return this["ivataxablekind"];}
		set {if (value==null|| value==DBNull.Value) this["ivataxablekind"]= DBNull.Value; else this["ivataxablekind"]= value;}
	}
	public String ivataxablekindOriginal { 
		get {if (this["ivataxablekind",DataRowVersion.Original]==DBNull.Value)return null; return  (String)this["ivataxablekind",DataRowVersion.Original];}
	}
	#endregion

}
public class ivakindviewTable : MetaTableBase<ivakindviewRow> {
	public ivakindviewTable() : base("ivakindview"){
		baseColumns = new Dictionary<string, DataColumn>(){
			...
			{"fenature",createColumn("fenature",typeof(string),true,false)},
			{"ivataxablekind",createColumn("ivataxablekind",typeof(string),true,false)},
		};
	}
}
}
