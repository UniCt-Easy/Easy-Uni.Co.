...
{
    public class Meta_attivformcaratteristicaora : Meta_easydata 
	{
        public Meta_attivformcaratteristicaora(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "attivformcaratteristicaora") {
				Name = "Ore";
		...
		public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
			...
			RowChange.MarkAsAutoincrement(T.Columns["idattivformcaratteristicaora"], null, null, 0);
			RowChange.setMinimumTempValue(T.Columns["idattivformcaratteristicaora"], 9990000);
			//$Get_New_Row$
		...
		public override bool IsValid(DataRow R, out string errmess, out string errfield) {
			...
			switch (edit_type) {
				case "default": {
						...
						if (R["idattivformcaratteristicaora"].ToString().Trim() == "") {
							errmess = "Attenzione! Il campo 'Identificativo' è obbligatorio";
							errfield = "idattivformcaratteristicaora";
							return false;
						}
