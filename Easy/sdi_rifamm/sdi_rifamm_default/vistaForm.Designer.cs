...
public DataTable sdi_rifamm{get { return Tables["sdi_rifamm"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
...
EnforceConstraints = false;
	...
	DataColumn C;
	DataColumn [] key;
	T= new DataTable("sdi_rifamm");
	C= new DataColumn("idsdi_rifamm", typeof(System.String), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);

	T.Columns.Add(new DataColumn("codiceufficio", typeof(System.String), ""));
	T.Columns.Add(new DataColumn("voceindice", typeof(System.String), ""));
	T.Columns.Add(new DataColumn("diritto", typeof(System.String), ""));
	T.Columns.Add(new DataColumn("nomeufficio", typeof(System.String), ""));
	T.Columns.Add(new DataColumn("nomepersona", typeof(System.String), ""));
	...
	T.Columns.Add(new DataColumn("nomeufficioricevente", typeof(System.String), ""));
	T.Columns.Add(new DataColumn("cod_amm_aoo", typeof(System.String), ""));
	T.Columns.Add(new DataColumn("ws_user", typeof(System.String), ""));
	T.Columns.Add(new DataColumn("cf_operatore", typeof(System.String), ""));
	T.Columns.Add(new DataColumn("email_alert", typeof(System.String), ""));
	Tables.Add(T);
//Primary Key
	key = new DataColumn[1]{
	T.Columns["idsdi_rifamm"]};
	T.PrimaryKey = key;
...
TChild= Tables["sdi_rifamm"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor04"]};
Relations.Add(new DataRelation("FK_sorting04_sdi_rifamm",CPar,CChild));

TPar= Tables["sorting03"];
TChild= Tables["sdi_rifamm"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor03"]};
Relations.Add(new DataRelation("FK_sorting03_sdi_rifamm",CPar,CChild));

TPar= Tables["sorting02"];
TChild= Tables["sdi_rifamm"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor02"]};
Relations.Add(new DataRelation("FK_sorting02_sdi_rifamm",CPar,CChild));

TPar= Tables["sorting01"];
TChild= Tables["sdi_rifamm"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor01"]};
Relations.Add(new DataRelation("FK_sorting01_sdi_rifamm",CPar,CChild));

TPar= Tables["sorting05"];
TChild= Tables["sdi_rifamm"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor05"]};
Relations.Add(new DataRelation("FK_sorting05_sdi_rifamm",CPar,CChild));
