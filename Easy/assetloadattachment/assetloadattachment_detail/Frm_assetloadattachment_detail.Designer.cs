...
{
	partial class Frm_assetloadattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new assetloadattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "assetloadattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "assetloadattachment.idattachmentkind";
			...
			// 
			// Frm_assetloadattachment_detail
			// 
			...
			this.Name = "Frm_assetloadattachment_detail";
			this.Text = "Frm_assetloadattachment_detail";
