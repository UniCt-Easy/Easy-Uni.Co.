...
{
    public class Meta_studprenotkind : Meta_easydata 
	{
        public Meta_studprenotkind(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "studprenotkind") {
		...
		public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
			...
			RowChange.MarkAsAutoincrement(T.Columns["idstudprenotkind"], null, null, 0);
			RowChange.setMinimumTempValue(T.Columns["idstudprenotkind"], 9990000);
			//$Get_New_Row$
		...
		public override bool IsValid(DataRow R, out string errmess, out string errfield) {
			...
			switch (edit_type) {
				case "default": {
						...
						if (R["idstudprenotkind"].ToString().Trim() == "") {
