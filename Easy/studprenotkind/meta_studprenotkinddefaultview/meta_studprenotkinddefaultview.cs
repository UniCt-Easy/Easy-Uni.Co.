...
namespace meta_studprenotkinddefaultview
{
    public class Meta_studprenotkinddefaultview : Meta_easydata 
	{
        public Meta_studprenotkinddefaultview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
