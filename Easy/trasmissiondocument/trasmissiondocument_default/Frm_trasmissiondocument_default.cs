...
namespace trasmissiondocument_default//tipodocumentolista//
{
	/// <summary>
	/// Summary description for frmtipodocumentolista.
	/// </summary>
	public class Frm_trasmissiondocument_default : System.Windows.Forms.Form
	{
		public vistaForm DS;
		...
		public Frm_trasmissiondocument_default()
		{
			InitializeComponent();
		}
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Frm_trasmissiondocument_default));
			...
			this.dataGrid1.Tag = "trasmissiondocument.default";
			// 
			// MetaDataDetail
			// 
			...
			this.textBox2.Tag = "trasmissiondocument.description";
			this.textBox2.Text = "";
			// 
			// label2
			// 
			...
			this.textBox1.Tag = "trasmissiondocument.idtrasmissiondocument";
			this.textBox1.Text = "";
			// 
			// label1
			// 
			...
			this.Name = "frmtipodocumentolista";
			this.Text = "frmtipodocumentolista";
