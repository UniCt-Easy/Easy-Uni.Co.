...
private void initClass() {
	...
	C.AllowDBNull=false;
	tsortingprevexpensevarattachment.Columns.Add(C);
	tsortingprevexpensevarattachment.Columns.Add( new DataColumn("idfilestorage", typeof(string)));
	...
	var cChild = new []{sortingprevexpensevarattachment.Columns["idattachmentkind"]};
	Relations.Add(new DataRelation("attachmentkind_sortingprevexpensevarattachment",cPar,cChild,false));
