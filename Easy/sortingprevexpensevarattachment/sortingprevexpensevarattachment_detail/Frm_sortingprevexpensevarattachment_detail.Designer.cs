...
namespace sortingprevexpensevarattachment_detail
{
	partial class Frm_sortingprevexpensevarattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new sortingprevexpensevarattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "sortingprevexpensevarattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "sortingprevexpensevarattachment.idattachmentkind";
			...
			// 
			// Frm_sortingprevexpensevarattachment_detail
			// 
			...
			this.Name = "Frm_sortingprevexpensevarattachment_detail";
			this.Text = "Frm_sortingprevexpensevarattachment_detail";
