...
{
	public partial class Frm_sortingprevexpensevarattachment_detail : MetaDataForm
    {
        MetaData Meta;
        public IOpenFileDialog openFileDialog1;
        public Frm_sortingprevexpensevarattachment_detail()
		{
			InitializeComponent();
        ...
        public void MetaData_AfterFill(){
            DataRow R = DS.sortingprevexpensevarattachment.Rows[0];
		...
		{
            if (Meta.IsEmpty) return;
            DataRow Curr = DS.sortingprevexpensevarattachment.Rows[0];
