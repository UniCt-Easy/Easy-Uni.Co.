...
namespace inpsactivity_default//attivitaprevidenzialeinps//
{
	/// <summary>
	/// Summary description for Form1.
	/// </summary>
	public class Frm_inpsactivity_default : System.Windows.Forms.Form
	{
		public vistaForm DS;
		...
		public Frm_inpsactivity_default()
		{
			//
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Frm_inpsactivity_default));
			...
			this.dataGrid1.Size = new System.Drawing.Size(576, 200);
			this.dataGrid1.TabIndex = 40;
			this.dataGrid1.Tag = "inpsactivity.default";
			// 
			// MetaDataDetail
			// 
			...
			this.MetaDataDetail.Size = new System.Drawing.Size(576, 96);
			...
			this.textBox2.Tag = "inpsactivity.description";
			this.textBox2.Text = "";
			// 
			// label2
			// 
			...
			this.textBox1.Tag = "inpsactivity.activitycode";
			this.textBox1.Text = "";
			// 
			// label1
			// 
			...
			this.label1.Text = "Codice Attività";
			this.label1.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// frmattivitaprevidenzialeinpslista
			// 
			...
			this.Name = "frmattivitaprevidenzialeinpslista";
			this.Text = "frmattivitaprevidenzialeinpslista";
		...
		public void MetaData_AfterLink()
		{
			...
			GetData.SetStaticFilter(DS.inpsactivity,filteresercizio);
		}
