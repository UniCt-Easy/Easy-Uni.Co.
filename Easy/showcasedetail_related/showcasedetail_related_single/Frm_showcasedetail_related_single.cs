...
namespace showcasedetail_related_single {
    ...
    public partial class Frm_showcasedetail_related_single : MetaDataForm {
        ...
        DataAccess Conn;
        public Frm_showcasedetail_related_single() {
            InitializeComponent();
        }
        ...
        private void enableControls(bool abilita)
        {
            ...
            btnOK.Enabled = abilita;
            btnAnnulla.Enabled = abilita;
            ...
            txtDisponibilità.Enabled = abilita;
        ...
        void CalcolaIVA() {
            if (DS.showcasedetail_related.Rows.Count == 0) return;
            DataRow Curr = DS.showcasedetail_related.Rows[0];

            if (Curr.IsNull("unitprice")) return;
            if (Curr.IsNull("idivakind")) return;

            try {
                DataRow DR = Curr.GetParentRow("ivakind_showcasedetail_related");
        ...
        void FreshLogo() {
            ...
            DataRow DR = Curr.GetParentRow("listview_showcasedetail_related");
            if (DR!=null) { 
                try {
        ...
        private void btnListino_Click(object sender, EventArgs e) {
            ...
            Meta.DoMainCommand("choose.listview_related.default." + filter);
        }
