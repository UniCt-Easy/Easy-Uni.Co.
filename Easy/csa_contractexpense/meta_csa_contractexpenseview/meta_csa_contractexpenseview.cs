...
namespace meta_csa_contractexpenseview {
    /// <summary>
    /// Summary description for Class1.
    /// </summary>
    public class Meta_csa_contractexpenseview :Meta_easydata {
        public Meta_csa_contractexpenseview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "csa_contractexpenseview") {
