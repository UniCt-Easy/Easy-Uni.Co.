...
namespace meta_csa_contractepexpview {
    /// <summary>
    /// Summary description for Class1.
    /// </summary>
    public class Meta_csa_contractepexpview :Meta_easydata {
        public Meta_csa_contractepexpview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "csa_contractepexpview") {
