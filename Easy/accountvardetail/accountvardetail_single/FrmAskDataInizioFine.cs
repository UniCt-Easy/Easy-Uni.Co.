...
namespace accountvardetail_single {
	public partial class FrmAskDataInizioFine : MetaDataForm {
		...
		public bool DatiValidi() {
			try {
				...
				show("E' necessario inserire una data inizio valida");
				txtDataInizio.Focus();
				return false;
			}
			try {
				...
				show("E' necessario inserire una data fine valida");
				txtDataInizio.Focus();
				return false;
			}
