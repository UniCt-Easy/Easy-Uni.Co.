...
private void initClass() {
	...
	taccountminusable.Columns.Add( new DataColumn("accountkind", typeof(string)));
	...
	var cPar = new []{accountenactment.Columns["idenactment"]};
	var cChild = new []{accountvar.Columns["idenactment"]};
	Relations.Add(new DataRelation("FK_accountenactment_accountvar",cPar,cChild,false));

	cPar = new []{manager.Columns["idman"]};
	cChild = new []{accountvar.Columns["idman"]};
	Relations.Add(new DataRelation("FK_manager_accountvar",cPar,cChild,false));

	cPar = new []{accountvarstatus.Columns["idaccountvarstatus"]};
	cChild = new []{accountvar.Columns["idaccountvarstatus"]};
	Relations.Add(new DataRelation("FK_accountvarstatus_accountvar",cPar,cChild,false));
