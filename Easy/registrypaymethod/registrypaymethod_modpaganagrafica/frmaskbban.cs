...
namespace registrypaymethod_modpaganagrafica//modpagamentocreddebianagrafica//
{
	...
	public class frmaskbban : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            // txtBBAN
            // 
            this.txtBBAN.Location = new System.Drawing.Point(144, 24);
            this.txtBBAN.Name = "txtBBAN";
            this.txtBBAN.Size = new System.Drawing.Size(200, 20);
            this.txtBBAN.TabIndex = 7;
            // 
            // frmaskbban
            // 
        ...
        private void btnOk_Click(object sender, EventArgs e) {
            ...
            if (bban.Length != 23) {
                MetaFactory.factory.getSingleton<IMessageShower>().Show(this, "Attenzione: Il codice BBAN deve essere composto da 23 caratteri!");
                insertedBBAN = "";
                DialogResult = DialogResult.None;
                return;
            }
            if (CfgFn.CheckLetter(bban.Substring(1), 22) != bban[0]) {
                MetaFactory.factory.getSingleton<IMessageShower>().Show(this, "Attenzione il BBAN inserito non è corretto!");
                insertedBBAN = "";
                DialogResult = DialogResult.None;
                return;
            }
