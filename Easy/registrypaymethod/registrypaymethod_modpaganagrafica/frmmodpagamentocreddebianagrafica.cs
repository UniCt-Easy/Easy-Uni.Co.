...
namespace registrypaymethod_modpaganagrafica {//modpagamentocreddebianagrafica//
    ...
    "il BBAN come da regolamento bancario";
		...
		private bool controllaBanca(string insertedBBAN) {
			...
			if (codiceABI == null) {
				MetaFactory.factory.getSingleton<IMessageShower>().Show(this,"La banca inserita nell'IBAN non esiste in Easy. Deve essere inserito in Anagrafiche - ABI (Banche)");
				return false;
			}
