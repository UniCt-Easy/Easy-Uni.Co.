	...
	public class Meta_registrypaymethodview : Meta_easydata {
        ...
        public override void DescribeColumns(DataTable T, string listtype) {
			...
			if (listtype=="modpaganagrafica") {
                ...
                int nPos = 1;
				DescribeAColumn(T,"regmodcode","Nome modalit‡", nPos++);
                DescribeAColumn(T, "registry", "Denom. Anagrafica", nPos++);
                DescribeAColumn(T, "paymethod", "Modalit‡ pagamento", nPos++);
                ...
                DescribeAColumn(T, "extracode", "Codice contabilit‡ speciale", nPos++);
			}
		}   
	}
}
