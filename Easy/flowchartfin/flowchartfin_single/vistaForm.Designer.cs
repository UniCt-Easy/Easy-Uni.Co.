...
public DataTable flowchartfin{get { return this.Tables["flowchartfin"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
...
//Primary Key
	...
	T.Columns["idflowchart"], 	T.Columns["idfin"]};
	T.PrimaryKey = key;
...
DataColumn []CChild;
TPar= Tables["fin"];
TChild= Tables["flowchartfin"];
CPar = new DataColumn[1]{TPar.Columns["idfin"]};
CChild = new DataColumn[1]{TChild.Columns["idfin"]};
Relations.Add(new DataRelation("fin_flowchartfin",CPar,CChild));
