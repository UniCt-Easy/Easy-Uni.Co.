...
namespace meta_didproganno
{
    public class Meta_didproganno : Meta_easydata 
	{
        public Meta_didproganno(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "didproganno") {
				Name = "Anno di corso";
		...
		public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
			...
			RowChange.MarkAsAutoincrement(T.Columns["iddidproganno"], null, null, 0);
			RowChange.setMinimumTempValue(T.Columns["iddidproganno"], 9990000);
			//$Get_New_Row$
			...
			switch (edit_type) {
				case "default": {
						if (R["aa"].ToString().Trim().Length > 9) {
							errmess = "Attenzione! Il campo 'Aa' può essere al massimo di 9 caratteri";
							errfield = "aa";
							return false;
						}
		...
		public override void DescribeColumns(DataTable T, string ListingType) {
			...
			switch (ListingType) {
				case "default": {
						...
						DescribeAColumn(T, "!aa_annoaccademico_aa", "Aa", nPos++);
						break;
					}
				//$DescribeAColumn$
			}
