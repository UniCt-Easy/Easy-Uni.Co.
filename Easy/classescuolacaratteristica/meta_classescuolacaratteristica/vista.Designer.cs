...
public class classescuolacaratteristicaRow: MetaRow  {
	public classescuolacaratteristicaRow(DataRowBuilder rb) : base(rb) {} 
	...
	public Int32? idclassescuolacaratteristica{ 
		get {if (this["idclassescuolacaratteristica"]==DBNull.Value)return null; return  (Int32?)this["idclassescuolacaratteristica"];}
		set {if (value==null) this["idclassescuolacaratteristica"]= DBNull.Value; else this["idclassescuolacaratteristica"]= value;}
	}
	public object idclassescuolacaratteristicaValue { 
		get{ return this["idclassescuolacaratteristica"];}
		set {if (value==null|| value==DBNull.Value) this["idclassescuolacaratteristica"]= DBNull.Value; else this["idclassescuolacaratteristica"]= value;}
	}
	public Int32? idclassescuolacaratteristicaOriginal { 
		get {if (this["idclassescuolacaratteristica",DataRowVersion.Original]==DBNull.Value)return null; return  (Int32?)this["idclassescuolacaratteristica",DataRowVersion.Original];}
	}
	///<summary>
	///SASD
	///</summary>
	...
	///<summary>
	///Tipo della seconda attività formativa
	///</summary>
	public Int32? idtipoattform_2{ 
		get {if (this["idtipoattform_2"]==DBNull.Value)return null; return  (Int32?)this["idtipoattform_2"];}
		set {if (value==null) this["idtipoattform_2"]= DBNull.Value; else this["idtipoattform_2"]= value;}
	}
	public object idtipoattform_2Value { 
		get{ return this["idtipoattform_2"];}
		set {if (value==null|| value==DBNull.Value) this["idtipoattform_2"]= DBNull.Value; else this["idtipoattform_2"]= value;}
	}
	public Int32? idtipoattform_2Original { 
		get {if (this["idtipoattform_2",DataRowVersion.Original]==DBNull.Value)return null; return  (Int32?)this["idtipoattform_2",DataRowVersion.Original];}
	}
	public DateTime? lt{ 
...
///<summary>
///Caratteristiche della classe o scuola (solitamente dei minimi o dei totali)
///</summary>
public class classescuolacaratteristicaTable : MetaTableBase<classescuolacaratteristicaRow> {
	public classescuolacaratteristicaTable() : base("classescuolacaratteristica"){
		baseColumns = new Dictionary<string, DataColumn>(){
			...
			{"idclassescuolacaratteristica",createColumn("idclassescuolacaratteristica",typeof(int),false,false)},
			{"idsasd",createColumn("idsasd",typeof(int),true,false)},
			{"idtipoattform",createColumn("idtipoattform",typeof(int),true,false)},
			{"idtipoattform_2",createColumn("idtipoattform_2",typeof(int),true,false)},
