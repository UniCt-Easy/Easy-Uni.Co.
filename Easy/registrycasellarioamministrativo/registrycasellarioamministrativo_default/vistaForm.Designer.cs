...
private void initClass() {
	...
	var cChild = new []{registrycasellarioamministrativo.Columns["idreg"]};
	Relations.Add(new DataRelation("registry_registrycasellarioamministrativo",cPar,cChild,false));
