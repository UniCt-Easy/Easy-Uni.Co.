...
public class enteprevidenzialeRow: MetaRow  {
	public enteprevidenzialeRow(DataRowBuilder rb) : base(rb) {} 
...
public class enteprevidenzialeTable : MetaTableBase<enteprevidenzialeRow> {
	public enteprevidenzialeTable() : base("enteprevidenziale"){
		baseColumns = new Dictionary<string, DataColumn>(){
			...
			{"identeprevidenziale",createColumn("identeprevidenziale",typeof(int),false,false)},
