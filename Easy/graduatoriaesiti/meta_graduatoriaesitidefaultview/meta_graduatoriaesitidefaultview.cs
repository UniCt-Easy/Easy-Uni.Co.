...
namespace meta_graduatoriaesitidefaultview
{
    public class Meta_graduatoriaesitidefaultview : Meta_easydata 
	{
        public Meta_graduatoriaesitidefaultview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "graduatoriaesitidefaultview") {
