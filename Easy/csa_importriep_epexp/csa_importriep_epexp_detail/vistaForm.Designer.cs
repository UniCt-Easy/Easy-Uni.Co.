...
public DataTable csa_importriep_epexp{get { return Tables["csa_importriep_epexp"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
...
EnforceConstraints = false;
	...
	DataColumn C;
	DataColumn [] key;
	T= new DataTable("csa_importriep_epexp");
...
DataColumn []CChild;
TPar= Tables["epexp"];
TChild= Tables["csa_importriep_epexp"];
CPar = new DataColumn[1]{TPar.Columns["idepexp"]};
CChild = new DataColumn[1]{TChild.Columns["idepexp"]};
Relations.Add(new DataRelation("FK_epexp_csa_importriep_epexp",CPar,CChild));
