...
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
public DataTable purchasepaymentkind{get { return this.Tables["purchasepaymentkind"];}}
...
this.EnforceConstraints = false;
	...
	T= new DataTable("purchasepaymentkind");
	C= new DataColumn("idpurchasepaymentkind", typeof(System.Byte), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);
	...
	Tables.Add(T);
	//Primary Key
	T.PrimaryKey =  new DataColumn[]{T.Columns["idpurchasepaymentkind"]};;
...
Relations.Add(new DataRelation("registry_purchasepayment",CPar,CChild));

TPar= Tables["purchasepaymentkind"];
TChild= Tables["purchasepayment"];
CPar = new DataColumn[1]{TPar.Columns["idpurchasepaymentkind"]};
CChild = new DataColumn[1]{TChild.Columns["idpurchasepaymentkind"]};
Relations.Add(new DataRelation("purchasepaymentkind_purchasepayment",CPar,CChild));
