...
private void initClass() {
	...
	C.AllowDBNull=false;
	tplaccountattachment.Columns.Add(C);
	tplaccountattachment.Columns.Add( new DataColumn("idfilestorage", typeof(string)));
	...
	var cChild = new []{placcountattachment.Columns["idattachmentkind"]};
	Relations.Add(new DataRelation("attachmentkind_placcountattachment",cPar,cChild,false));
