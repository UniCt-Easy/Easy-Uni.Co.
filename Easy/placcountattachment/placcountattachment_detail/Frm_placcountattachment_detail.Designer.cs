...
namespace placcountattachment_detail
{
	partial class Frm_placcountattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new placcountattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "placcountattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "placcountattachment.idattachmentkind";
			...
			// 
			// Frm_placcountattachment_detail
			// 
			...
			this.Name = "Frm_placcountattachment_detail";
			this.Text = "Frm_placcountattachment_detail";
