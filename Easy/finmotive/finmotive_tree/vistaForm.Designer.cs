...
DataColumn []CPar;
DataColumn []CChild;
TPar= Tables["finmotive"];
TChild= Tables["finmotive"];
CPar = new DataColumn[1]{TPar.Columns["idfinmotive"]};
CChild = new DataColumn[1]{TChild.Columns["paridfinmotive"]};
Relations.Add(new DataRelation("finmotivefinmotive",CPar,CChild));
