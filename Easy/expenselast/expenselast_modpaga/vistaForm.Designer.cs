...
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
public DataTable deputy{get { return this.Tables["deputy"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
...
//Primary Key
	...
	C= new DataColumn("idpaymethod", typeof(System.String), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);
	...
	T.Columns.Add(new DataColumn("flagpaymentadvice", typeof(System.String), ""));
	C= new DataColumn("cu", typeof(System.String), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);
...
TPar= Tables["cab"];
TChild= Tables["expenselast"];
CPar = new DataColumn[2]{TPar.Columns["idbank"], TPar.Columns["idcab"]};
CChild = new DataColumn[2]{TChild.Columns["idbank"], TChild.Columns["idcab"]};
Relations.Add(new DataRelation("cab_expenselast",CPar,CChild));

TPar= Tables["bank"];
TChild= Tables["expenselast"];
CPar = new DataColumn[1]{TPar.Columns["idbank"]};
CChild = new DataColumn[1]{TChild.Columns["idbank"]};
Relations.Add(new DataRelation("bank_expenselast",CPar,CChild));

TPar= Tables["deputy"];
TChild= Tables["expenselast"];
CPar = new DataColumn[1]{TPar.Columns["idreg"]};
CChild = new DataColumn[1]{TChild.Columns["iddeputy"]};
Relations.Add(new DataRelation("deputy_expenselast",CPar,CChild));
