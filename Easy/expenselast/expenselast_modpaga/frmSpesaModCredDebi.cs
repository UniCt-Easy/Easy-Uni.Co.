...
namespace expenselast_modpaga//spesamodcreddebi//
{
    ...
    /// </summary>
    public class Frm_expenselast_modpaga : System.Windows.Forms.Form {
        ...
        private void InitializeComponent() {
            ...
            this.cmbModalita.Location = new System.Drawing.Point(112, 56);
            this.cmbModalita.Name = "cmbModalita";
            this.cmbModalita.Size = new System.Drawing.Size(510, 21);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
            this.descrizione.Location = new System.Drawing.Point(112, 88);
            ...
            this.label3.Text = "Note per il Tesoriere";
    ...
    "s not null))";
            ...
            this.label8.Text = "Nota: solo inserendo correttamente tutti i dati sar‡ visualizzato, nelle stampe, " +
    "il BBAN come da regolamento bancario";
            ...
            this.groupBox1.Text = "Opzioni Tipo Modalit‡ Pagamento";
            // 
            // groupBox2
            // 
        ...
        private void inserisciBBAN() {
            ...
            if (BBAN.insertedBBAN.Length < 23) {
                MessageBox.Show("Testo inserito troppo corto per calcolare abi cab etc.");
                return;
            }
