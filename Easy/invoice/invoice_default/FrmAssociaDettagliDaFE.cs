...
namespace invoice_default {
    ...
    public class FrmAssociaDettagliDaFE : MetaDataForm {
        ...
        void CreaStrutturaTassociazioni() {
            ...
            Tassociazioni.Columns.Add("rownum", typeof(int));       Tassociazioni.Columns["rownum"].Caption = ".";//è quello della riga ordine
        ...
        void CreaStrutturaDettagli_fe() {
            ...
            dettagli_fe.Columns.Add("Quantita", typeof(decimal));           dettagli_fe.Columns["Quantita"].Caption = "Q.tà";
    ...
    "sivo dovrà essere associato, oppure,";
        ...
        private void btnEseguiAssociazione_Click(object sender, EventArgs e) {
            ...
            // Se la q.tà del dettaglio CP è minore della q.tà dettaglio FE, deseleziona l'associazione
            decimal quantitaFE = CfgFn.GetNoNullDecimal(FE_SelectedRows[0]["quantita"]);    //FE_SelectedRows[0]: C'è solo un dettaglio FE selezionato
            decimal quantitaCP = CfgFn.GetNoNullDecimal(CP_SelectedRows[0]["number"]);    //Se sono stati selezionati più dettagli CP, vuol dire che sono fratelli di split, 
            ...
            DataRow R=null;
            DataRow FE_Selected = FE_SelectedRows[0];//C'è solo un dettaglio FE selezionato
                ...
                foreach (DataRow rCP in CP_SelectedRows) {
                    ...
                    //se la q.tà della FE è diversa da quella del CP, per esempio ho ordinato 10 e mi sta arrivando 2, deve calcolare l'iva come:q.tà FE * imponibile CP * sconto CP
