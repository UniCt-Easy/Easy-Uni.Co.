...
namespace meta_invoiceexpenselinked {
	/// <summary>
	/// Summary description for Meta_invoiceexpenselinked.
	/// </summary>
	public class Meta_invoiceexpenselinked : Meta_easydata {
		public Meta_invoiceexpenselinked(DataAccess Conn, 
			MetaDataDispatcher Dispatcher):
			base(Conn,Dispatcher, "invoiceexpenselinked") {
