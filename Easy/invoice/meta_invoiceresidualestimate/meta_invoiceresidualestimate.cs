...
namespace meta_invoiceresidualestimate 
{
	/// <summary>
	/// Summary description for Class1.
	/// </summary>
	public class Meta_invoiceresidualestimate : Meta_easydata 
	{
		public Meta_invoiceresidualestimate(DataAccess Conn, MetaDataDispatcher Dispatcher):
			base(Conn, Dispatcher, "invoiceresidualestimate") 
		{
			Name = "Documenti IVA da contabilizzare";
			ListingTypes.Add("default");
		}

        private string[] mykey = new string[] { "idinvkind", "yinv", "ninv",   "idupb","idupb_iva",
		...
		public override void DescribeColumns(DataTable T, string ListingType) 
		{
			...
			if (ListingType=="default") 
			{
				...
				DescribeAColumn(T,"estimatekind","Contratto Attivo",nPos++);
                DescribeAColumn(T,"yestim", "Eserc.", nPos++);
                DescribeAColumn(T,"nestim", "Num.", nPos++);
                DescribeAColumn(T,"estimrownum", "Riga", nPos++);
