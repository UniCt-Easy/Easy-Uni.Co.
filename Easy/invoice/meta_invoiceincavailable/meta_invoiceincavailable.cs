...
namespace meta_invoiceincavailable {
    class Meta_invoiceincavailable  : Meta_easydata {
        public Meta_invoiceincavailable(DataAccess Conn, MetaDataDispatcher Dispatcher)
            :
			base(Conn, Dispatcher, "invoiceincavailable")  {
			Name= "Contabilizzazione Fattura di Vendita";
