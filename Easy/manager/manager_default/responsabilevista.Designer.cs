...
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
public DataTable managersorting{get { return Tables["managersorting"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
...
//Primary Key
	...
	T= new DataTable("managersorting");
...
//Primary Key
	...
	T.Columns["idsor"], 	T.Columns["idman"]};
	T.PrimaryKey = key;
...
Relations.Add(new DataRelation("divisionmanager",CPar,CChild));

TPar= Tables["sorting01"];
TChild= Tables["manager"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor01"]};
Relations.Add(new DataRelation("sorting01_manager",CPar,CChild));

TPar= Tables["sorting02"];
TChild= Tables["manager"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor02"]};
Relations.Add(new DataRelation("sorting02_manager",CPar,CChild));

TPar= Tables["sorting03"];
TChild= Tables["manager"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor03"]};
Relations.Add(new DataRelation("sorting03_manager",CPar,CChild));

TPar= Tables["sorting04"];
TChild= Tables["manager"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor04"]};
Relations.Add(new DataRelation("sorting04_manager",CPar,CChild));

TPar= Tables["sorting05"];
TChild= Tables["manager"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor05"]};
Relations.Add(new DataRelation("sorting05_manager",CPar,CChild));
