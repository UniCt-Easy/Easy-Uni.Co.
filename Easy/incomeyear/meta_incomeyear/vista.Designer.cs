...
namespace meta_incomeyear {
public class incomeyearRow: MetaRow  {
	public incomeyearRow(DataRowBuilder rb) : base(rb) {} 
...
public class incomeyearTable : MetaTableBase<incomeyearRow> {
	public incomeyearTable() : base("incomeyear"){}
