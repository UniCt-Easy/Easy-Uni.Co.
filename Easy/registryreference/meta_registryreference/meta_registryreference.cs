	...
	public class Meta_registryreference : Meta_easydata
	{
		...
		public override bool IsValid(DataRow R, out string errmess, out string errfield) {
			...
			if (s != "") {
				...
				if (!m.Success) {
					errfield = "email";
					errmess = "Inserire correttamente l'indirizzo email nel seguente formato: your-email@example.com";
					return false;
				}
			}
			if (edit_type == "default") {
				...
				errmess = "Esiste già un contatto predefinito. Eliminarlo prima di impostare quello corrente";
