...
namespace csa_bill_detail
{
    ...
    public class Frm_csa_bill_detail : MetaDataForm {
		...
		private TextBox txtEsercBolletta;
        ...
        public void MetaData_AfterLink () {
            ...
            DS.bill.setStaticFilter(QHS.CmpGe("ybill", Meta.GetSys("esercizio")));
    ...
    "l(reduction,0)>covered ) AND (ISNULL(toregularize,0)>0))" + $" AND (ybill >= \'{Meta.GetSys("esercizio")}\')";
        ...
        private void InitializeComponent()
		{
			...
			this.txtEsercBolletta = new System.Windows.Forms.TextBox();
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.gboxBolletta.Controls.Add(this.label8);
			this.gboxBolletta.Controls.Add(this.txtEsercBolletta);
			...
			// txtEsercBolletta
			// 
			this.txtEsercBolletta.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.txtEsercBolletta.Location = new System.Drawing.Point(346, 19);
			this.txtEsercBolletta.Name = "txtEsercBolletta";
			this.txtEsercBolletta.Size = new System.Drawing.Size(94, 20);
			this.txtEsercBolletta.TabIndex = 4;
			this.txtEsercBolletta.Tag = "bill.ybill?csa_bill.ybill.year";
			// 
			// label8
			// 
