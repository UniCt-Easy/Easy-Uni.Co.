...
public partial class dsmeta: DataSet {
	...
	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public MetaTable webpayment_prenotazioniview 		=> (MetaTable)Tables["webpayment_prenotazioniview"];
...
private void initClass() {
	...
	//////////////////// WEBPAYMENT_PRENOTAZIONIVIEW /////////////////////////////////
	var twebpayment_prenotazioniview= new MetaTable("webpayment_prenotazioniview");
	twebpayment_prenotazioniview.defineColumn("idwebpayment", typeof(int),false);
	twebpayment_prenotazioniview.defineColumn("ywebpayment", typeof(short),false);
	twebpayment_prenotazioniview.defineColumn("nwebpayment", typeof(int));
	twebpayment_prenotazioniview.defineColumn("forename", typeof(string));
	twebpayment_prenotazioniview.defineColumn("surname", typeof(string));
	twebpayment_prenotazioniview.defineColumn("email", typeof(string));
	twebpayment_prenotazioniview.defineColumn("idcustomuser", typeof(string));
	twebpayment_prenotazioniview.defineColumn("idflussocrediti", typeof(int));
	twebpayment_prenotazioniview.defineColumn("idlcard", typeof(int));
	twebpayment_prenotazioniview.defineColumn("iuv", typeof(string));
	twebpayment_prenotazioniview.defineColumn("idman", typeof(int));
	twebpayment_prenotazioniview.defineColumn("manager", typeof(string));
	twebpayment_prenotazioniview.defineColumn("idreg", typeof(int),false);
	twebpayment_prenotazioniview.defineColumn("registry", typeof(string),false);
	twebpayment_prenotazioniview.defineColumn("cf", typeof(string));
	twebpayment_prenotazioniview.defineColumn("p_iva", typeof(string));
	twebpayment_prenotazioniview.defineColumn("idwebpaymentstatus", typeof(short),false);
	twebpayment_prenotazioniview.defineColumn("webpaymentstatus", typeof(string),false);
	twebpayment_prenotazioniview.defineColumn("adate", typeof(DateTime));
	twebpayment_prenotazioniview.defineColumn("qrcode", typeof(string));
	twebpayment_prenotazioniview.defineColumn("cu", typeof(string));
	twebpayment_prenotazioniview.defineColumn("ct", typeof(DateTime));
	twebpayment_prenotazioniview.defineColumn("lu", typeof(string));
	twebpayment_prenotazioniview.defineColumn("lt", typeof(DateTime));
	Tables.Add(twebpayment_prenotazioniview);
	twebpayment_prenotazioniview.defineKey("idwebpayment");
