...
namespace meta_orakind {
public class orakindRow: MetaRow  {
	public orakindRow(DataRowBuilder rb) : base(rb) {} 
...
///<summary>
///VOCABOLARIO modificabile da loro delle tipologie di ore: didattica frontale, laboratorio, ecc.
///</summary>
public class orakindTable : MetaTableBase<orakindRow> {
	public orakindTable() : base("orakind"){
		baseColumns = new Dictionary<string, DataColumn>(){
			...
			{"idorakind",createColumn("idorakind",typeof(int),false,false)},
