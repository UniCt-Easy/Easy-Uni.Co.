...
EnforceConstraints = false;
	...
	T.Columns.Add(new DataColumn("organizational_unit", typeof(System.String), ""));
	T.Columns.Add(new DataColumn("bursarship", typeof(System.String), ""));
	Tables.Add(T);
//Primary Key
