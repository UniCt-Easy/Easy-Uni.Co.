...
public class instmentierogantiRow: MetaRow  {
	public instmentierogantiRow(DataRowBuilder rb) : base(rb) {} 
...
public class instmentierogantiTable : MetaTableBase<instmentierogantiRow> {
	public instmentierogantiTable() : base("instmentieroganti"){
		baseColumns = new Dictionary<string, DataColumn>(){
			...
			{"idinstmentieroganti",createColumn("idinstmentieroganti",typeof(int),false,false)},
