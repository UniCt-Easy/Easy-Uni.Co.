...
namespace meta_instmcontrattodefaultview
{
    public class Meta_instmcontrattodefaultview : Meta_easydata 
	{
        public Meta_instmcontrattodefaultview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "instmcontrattodefaultview") {
				Name = "Contratti";
