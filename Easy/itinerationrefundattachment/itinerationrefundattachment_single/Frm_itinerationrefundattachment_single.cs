...
namespace itinerationrefundattachment_single {
	public partial class Frm_itinerationrefundattachment_single : MetaDataForm {
		MetaData Meta;
        public IOpenFileDialog openFileDialog1;

		public Frm_itinerationrefundattachment_single() {
			InitializeComponent();
        ...
        public void MetaData_AfterFill() {
            DataRow R = DS.itinerationrefundattachment.Rows[0];
