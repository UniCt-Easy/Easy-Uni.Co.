...
namespace assetvardetailattachment_detail
{
	partial class Frm_assetvardetailattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new assetvardetailattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "assetvardetailattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "assetvardetailattachment.idattachmentkind";
			...
			// 
			// Frm_assetvardetailattachment_detail
			// 
			...
			this.Name = "Frm_assetvardetailattachment_detail";
			this.Text = "Frm_assetvardetailattachment_detail";
