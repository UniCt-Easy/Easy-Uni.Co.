...
private void initClass() {
	...
	C= new DataColumn("idassetvar", typeof(Int32));
	C.AllowDBNull=true;
	tassetvardetailattachment.Columns.Add(C);
			C= new DataColumn("idassetvardetail", typeof(Int32));
	C.AllowDBNull=true;
	tassetvardetailattachment.Columns.Add(C);
	...
	C.AllowDBNull=false;
	tassetvardetailattachment.Columns.Add(C);
	tassetvardetailattachment.Columns.Add( new DataColumn("idfilestorage", typeof(string)));
	...
	var cChild = new []{assetvardetailattachment.Columns["idattachmentkind"]};
	Relations.Add(new DataRelation("attachmentkind_assetvardetailattachment",cPar,cChild,false));
