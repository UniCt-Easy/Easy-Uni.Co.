...
{
	public partial class Frm_assetvardetailattachment_detail : MetaDataForm
    {
        MetaData Meta;
        public IOpenFileDialog openFileDialog1;
        public Frm_assetvardetailattachment_detail()
		{
			InitializeComponent();
        ...
        public void MetaData_AfterFill(){
            DataRow R = DS.assetvardetailattachment.Rows[0];
		...
		{
            if (Meta.IsEmpty) return;
            DataRow Curr = DS.assetvardetailattachment.Rows[0];
