...
namespace meta_corsostudiokind
{
    public class Meta_corsostudiokind : Meta_easydata 
	{
        public Meta_corsostudiokind(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "corsostudiokind") {
		...
		public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
			...
			RowChange.MarkAsAutoincrement(T.Columns["idcorsostudiokind"], null, null, 0);
			RowChange.setMinimumTempValue(T.Columns["idcorsostudiokind"], 9990000);
			//$Get_New_Row$
