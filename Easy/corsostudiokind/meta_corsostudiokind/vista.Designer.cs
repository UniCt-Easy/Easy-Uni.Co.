...
public class corsostudiokindRow: MetaRow  {
	public corsostudiokindRow(DataRowBuilder rb) : base(rb) {} 
...
///<summary>
///VOCABOLARIO modificabile da loro delle tipologie dei  2.4.2 Corso di studio 
///</summary>
public class corsostudiokindTable : MetaTableBase<corsostudiokindRow> {
	public corsostudiokindTable() : base("corsostudiokind"){
