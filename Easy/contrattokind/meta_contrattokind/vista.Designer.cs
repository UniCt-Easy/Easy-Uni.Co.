...
public class contrattokindRow: MetaRow  {
	public contrattokindRow(DataRowBuilder rb) : base(rb) {} 
...
///</summary>
public class contrattokindTable : MetaTableBase<contrattokindRow> {
	public contrattokindTable() : base("contrattokind"){
