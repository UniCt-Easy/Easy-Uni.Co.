...
namespace meta_regionalrateforcitybracket//meta_scaglionealiquoteregionalipercomune//
{
	/// <summary>
	/// Summary description for Meta_scaglionealiquoteregionalipercomune.
	/// </summary>
	public class Meta_regionalrateforcitybracket : Meta_easydata
	{
		public Meta_regionalrateforcitybracket(DataAccess Conn, MetaDataDispatcher Dispatcher):
			base(Conn, Dispatcher, "regionalrateforcitybracket")
		{
		...
		protected override Form GetForm(string FormName)
		{
			if (FormName=="single") 
			{
				...
				return GetFormByDllName("regionalrateforcitybracket_single");
			}
			return null;
		}
