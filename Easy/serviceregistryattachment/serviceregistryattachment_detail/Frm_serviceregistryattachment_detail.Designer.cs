...
namespace serviceregistryattachment_detail
{
	partial class Frm_serviceregistryattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new serviceregistryattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "serviceregistryattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "serviceregistryattachment.idattachmentkind";
			...
			// 
			// Frm_serviceregistryattachment_detail
			// 
			...
			this.Name = "Frm_serviceregistryattachment_detail";
			this.Text = "Frm_serviceregistryattachment_detail";
