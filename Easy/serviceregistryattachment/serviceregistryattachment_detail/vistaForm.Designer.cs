...
private void initClass() {
	...
	var cChild = new []{serviceregistryattachment.Columns["idattachmentkind"]};
	Relations.Add(new DataRelation("attachmentkind_serviceregistryattachment",cPar,cChild,false));
