...
namespace entrydetail_single {
	...
	/// </summary>
	public class FrmEntryDetail_single : MetaDataForm {
		MetaData Meta;
        CQueryHelper QHC;
        QueryHelper QHS;
    ...
    //            if ((idsorkind1 == DBNull.Value) && (idsorkind2 == DBNull.Value) && (idsorkind3 == DBNull.Value)) {
        ...
        public bool UtenteAbilitatoA_ValorizzareManualmenteIdrelaredEP() {
            object idflowchart = getSys("idflowchart");
            // Nessuna restrizione
            if (idflowchart == null || idflowchart == DBNull.Value)
                return true;
            object edit_idrelated_scritture = getUsr("edit_idrelated_scritture");
			//Utente abilitato alla funzione di sicurezza:Valorizzazione manuale Idrelared EP
			if (edit_idrelated_scritture != null && edit_idrelated_scritture.ToString().ToUpper() == "'S'") {
				return true;
            }
            return false;
        }
		...
		public void MetaData_AfterFill() {
            ...
            AbilitaDisabilitaModificaIdrelated();
        }

        private void AbilitaDisabilitaModificaIdrelated() {
            DataRow Curr = DS.entrydetail.Rows[0];
            if ( UtenteAbilitatoA_ValorizzareManualmenteIdrelaredEP()) {
				txtIdrelated.ReadOnly = false;
			}
			else {
				txtIdrelated.ReadOnly = true;
			}
        }
		...
		private void EnableDisableGBox() {
            ...
            else
            {
                ...
                if ((Curr["idrelated"] != DBNull.Value) &&
					(Curr["idrelated"].ToString().Length >= 5) &&
					   (
		...
		private void InitializeComponent() {
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.txtDescrUPB.Location = new System.Drawing.Point(167, 8);
			this.txtDescrUPB.Multiline = true;
			this.txtDescrUPB.Name = "txtDescrUPB";
			this.txtDescrUPB.ReadOnly = true;
			this.txtDescrUPB.Size = new System.Drawing.Size(204, 73);
			...
			// 
			this.txtDenominazioneConto.Location = new System.Drawing.Point(168, 16);
			...
			this.txtDenominazioneConto.Size = new System.Drawing.Size(263, 64);
			...
			// btnConto
			// 
			this.btnConto.Location = new System.Drawing.Point(8, 58);
			this.btnConto.Name = "btnConto";
			this.btnConto.Size = new System.Drawing.Size(88, 23);
			...
			// txtIdrelated
			// 
			this.txtIdrelated.Location = new System.Drawing.Point(593, 489);
			this.txtIdrelated.Name = "txtIdrelated";
			this.txtIdrelated.Size = new System.Drawing.Size(257, 20);
			this.txtIdrelated.TabIndex = 46;
			this.txtIdrelated.Tag = "entrydetail.idrelated";
			...
			this.Controls.Add(this.txtIdrelated);
