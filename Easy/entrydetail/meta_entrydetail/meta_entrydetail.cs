	...
	public class Meta_entrydetail : Meta_easydata {
		...
		public override void DescribeColumns(DataTable T, string listtype){
			...
			if (listtype=="default") {
				...
				DescribeAColumn(T, "amount", "Saldo",pos++);
		...
		public override bool IsValid(DataRow R, out string errmess, out string errfield){            
            ...
            if(rParent != null) {
                if((rParent["flagregistry"].ToString().ToUpper() == "S") && (CfgFn.GetNoNullDecimal(R["idreg"]) <= 0)) {
                    errmess = "Per il conto scelto è obbligatorio specificare il Cliente/Fornitore";
                    errfield = "idreg";
                    return false;
                }
                if((rParent["flagupb"].ToString().ToUpper() == "S") &&
                    ((R["idupb"] == DBNull.Value) || (R["idupb"].ToString().Trim() == ""))) {
                    errmess = "Per il conto scelto è obbligatorio specificare l'U.P.B.";
                    errfield = "idupb";
                    return false;
                }
            }
