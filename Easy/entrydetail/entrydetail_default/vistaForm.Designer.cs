...
//Primary Key
	...
	T.Columns["yentry"], 	T.Columns["nentry"], 	T.Columns["ndetail"]};
	T.PrimaryKey = key;
...
//Primary Key
	...
	C= new DataColumn("identrykind", typeof(System.Int32), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);
...
//Primary Key
	...
	C= new DataColumn("idepacc", typeof(System.Int32), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);
	...
	C= new DataColumn("nepacc", typeof(System.Int32), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);
	...
	T.Columns.Add(new DataColumn("paridepacc", typeof(System.Int32), ""));
	T.Columns.Add(new DataColumn("rtf", typeof(System.Byte[]), ""));
	T.Columns.Add(new DataColumn("start", typeof(System.DateTime), ""));
	T.Columns.Add(new DataColumn("stop", typeof(System.DateTime), ""));
	T.Columns.Add(new DataColumn("txt", typeof(System.String), ""));
	C= new DataColumn("yepacc", typeof(System.Int16), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);
...
DataColumn []CPar;
DataColumn []CChild;
TPar= Tables["entrykind"];
TChild= Tables["entry"];
CPar = new DataColumn[1]{TPar.Columns["identrykind"]};
CChild = new DataColumn[1]{TChild.Columns["identrykind"]};
Relations.Add(new DataRelation("entrykindentry",CPar,CChild));

TPar= Tables["epacc"];
TChild= Tables["entrydetail"];
CPar = new DataColumn[1]{TPar.Columns["idepacc"]};
CChild = new DataColumn[1]{TChild.Columns["idepacc"]};
Relations.Add(new DataRelation("epacc_entrydetail",CPar,CChild));

TPar= Tables["epexp"];
TChild= Tables["entrydetail"];
CPar = new DataColumn[1]{TPar.Columns["idepexp"]};
CChild = new DataColumn[1]{TChild.Columns["idepexp"]};
Relations.Add(new DataRelation("epexp_entrydetail",CPar,CChild));

TPar= Tables["sorting1"];
TChild= Tables["entrydetail"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor1"]};
Relations.Add(new DataRelation("sorting1entrydetail",CPar,CChild));
