...
namespace underwritingpayment_default {
    partial class Frm_underwritingpayment_default {
        /// <summary>
        ...
        private void InitializeComponent() {
			...
			this.DS = new underwritingpayment_default.vistaForm();
			...
			this.gboxFinanziamento.Location = new System.Drawing.Point(12, 198);
			this.gboxFinanziamento.Name = "gboxFinanziamento";
			this.gboxFinanziamento.Size = new System.Drawing.Size(344, 73);
			...
			this.txtUnderwriting.Location = new System.Drawing.Point(3, 47);
			this.txtUnderwriting.Name = "txtUnderwriting";
			this.txtUnderwriting.Size = new System.Drawing.Size(333, 20);
			this.txtUnderwriting.TabIndex = 3;
			this.txtUnderwriting.Tag = "underwriting.title?underwritingpaymentview.underwriting";
			// 
			// btnFinanziamento
			// 
			...
			// txtAmount
			// 
			this.txtAmount.Location = new System.Drawing.Point(109, 277);
			this.txtAmount.Name = "txtAmount";
			this.txtAmount.Size = new System.Drawing.Size(145, 20);
			this.txtAmount.TabIndex = 7;
			this.txtAmount.Tag = "underwritingpayment.amount?underwritingpaymentview.amount";
			// 
			// DS
			// 
			...
			this.groupBox20.Location = new System.Drawing.Point(12, 152);
			...
			this.txtAdateExpense.Tag = "expense.adate?underwritingpaymentview.adate";
			...
			this.groupBox17.Location = new System.Drawing.Point(364, 12);
			...
			this.txtDescrExpense.Tag = "expense.description?underwritingpaymentview.description";
			// 
			// groupCredDeb
			// 
			...
			this.groupCredDeb.Location = new System.Drawing.Point(364, 106);
			...
			this.txtCredDeb.Tag = "registry.title?underwritingpaymentview.registry";
			// 
			// gboxMovimento
			// 
			...
			this.txtFaseSpesa.Multiline = true;
			...
			this.txtFaseSpesa.Tag = "expensephase.description?underwritingpaymentview.expensephase";
			// 
			// btnSelectMov
			// 
			...
			this.txtNmovExpense.Tag = "expense.nmov?underwritingpaymentview.nmov";
			...
			this.txtYmovExpense.Tag = "expense.ymov.year?underwritingpaymentview.ymov";
			...
			this.gboxDocCollegato.Location = new System.Drawing.Point(364, 152);
			...
			this.txtDocumento.Tag = "expense.doc?underwritingpaymentview.doc";
			// 
			// label10
			// 
			...
			this.txtDataDocumento.Tag = "expense.docdate?underwritingpaymentview.docdate";
			// 
			// label14
			// 
			...
			this.gboxResponsabile.Location = new System.Drawing.Point(12, 105);
			this.gboxResponsabile.Name = "gboxResponsabile";
			this.gboxResponsabile.Size = new System.Drawing.Size(337, 40);
			...
			this.txtResponsabile.Size = new System.Drawing.Size(326, 20);
			this.txtResponsabile.TabIndex = 0;
			this.txtResponsabile.Tag = "manager.title?x";
			// 
			// Frm_underwritingpayment_default
			// 
			...
			this.Name = "Frm_underwritingpayment_default";
			this.Tag = "";
			this.Text = "Frm_underwritingpayment_default";
