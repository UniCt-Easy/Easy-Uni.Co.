...
namespace assetunload_storico
{
	...
	public class Frm_assetunload_storico : MetaDataForm
	{
		...
		public Frm_assetunload_storico()
		{
			InitializeComponent();
			GetData.SetSorting(DS.assetunloadview,"yassetunload DESC,nassetunload DESC");
		...
		{
			this.DS = new assetunload_storico.vistaForm();
			...
			this.dataGridAllegati.Tag = "assetunloadattachment.lista.detail";
			// 
			// btnDelAtt
			// 
			...
			this.tabBuono.Size = new System.Drawing.Size(687, 405);
			...
			this.gboxtotali.Location = new System.Drawing.Point(535, 12);
			this.gboxtotali.Name = "gboxtotali";
			this.gboxtotali.Size = new System.Drawing.Size(136, 170);
			this.gboxtotali.TabIndex = 81;
			...
			this.chkTransmitted.Location = new System.Drawing.Point(258, 345);
			...
			this.cboTipo.Size = new System.Drawing.Size(401, 21);
			...
			this.groupBox5.Location = new System.Drawing.Point(24, 62);
			...
			this.grpCausale.Location = new System.Drawing.Point(24, 182);
			this.grpCausale.Name = "grpCausale";
			this.grpCausale.Size = new System.Drawing.Size(647, 40);
			...
			this.cboCausale.Size = new System.Drawing.Size(623, 21);
			this.cboCausale.TabIndex = 48;
			this.cboCausale.Tag = "assetunload.idmot.(causale=\'S\')";
			...
			this.groupBox2.Location = new System.Drawing.Point(256, 222);
			...
			this.grpCred.Location = new System.Drawing.Point(24, 134);
			this.grpCred.Name = "grpCred";
			this.grpCred.Size = new System.Drawing.Size(505, 48);
			...
			this.txtCredDeb.Size = new System.Drawing.Size(473, 20);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.textBox13.Location = new System.Drawing.Point(200, 78);
			this.textBox13.Multiline = true;
			this.textBox13.Name = "textBox13";
			this.textBox13.ScrollBars = System.Windows.Forms.ScrollBars.Vertical;
			this.textBox13.Size = new System.Drawing.Size(329, 56);
			...
			// textBox14
			// 
			this.textBox14.Location = new System.Drawing.Point(144, 342);
			...
			// label16
			// 
			this.label16.Location = new System.Drawing.Point(32, 342);
			...
			// label17
			// 
			this.label17.Location = new System.Drawing.Point(32, 366);
			...
			// textBox15
			// 
			this.textBox15.Location = new System.Drawing.Point(144, 366);
			...
			this.groupBox3.Location = new System.Drawing.Point(24, 222);
			...
			this.tabOperazioni.Size = new System.Drawing.Size(687, 405);
			...
			this.dgrScaricoBene.Size = new System.Drawing.Size(671, 362);
			...
			this.tabAmmortamenti.Size = new System.Drawing.Size(687, 405);
			...
			this.dgrAmmortamenti.Size = new System.Drawing.Size(671, 362);
			...
			this.tabRatifica.Size = new System.Drawing.Size(687, 405);
			...
			this.grpMovimenti.Size = new System.Drawing.Size(679, 345);
			...
			this.dgrRatifica.Size = new System.Drawing.Size(663, 281);
			...
			this.btnScollegaMov.Location = new System.Drawing.Point(591, 24);
			...
			this.btnCollegaMov.Location = new System.Drawing.Point(511, 24);
			...
			this.tabEP.Size = new System.Drawing.Size(687, 405);
		...
		public void MetaData_AfterLink() {
            ...
            // ===============================================================================
            QueryCreator.setSkipInsertCopy(DS.assetunloadattachment, true);
        }
        ...
        void CalcolaTotali() {
            ...
            decimal totcarichi = MetaData.SumColumn(DS.assetpieceview, "total");
		...
		public void MetaData_AfterFill() {
            ...
            CalcolaTotali();
            if ((Meta.InsertMode) && (DS.assetunload.Rows.Count > 0)) {
                if (CfgFn.GetNoNullInt32(DS.assetunload.Rows[0]["nassetunload"]) == 0) {
                    txtNumero.Text = "";
                }
            }
        ...
        public void MetaData_BeforePost() {
            if (DS.assetunload.Rows.Count == 0) return;
            if (DS.assetunload.Rows[0].RowState == DataRowState.Deleted) {
                idrelated = EP_functions.GetIdForDocument(DS.assetunload.Rows[0]);
                fromDelete = true;
            }
        }
		...
		private string CalcolaFiltroDocCollegato(string tipo, bool SQL) {
			...
			if (!Meta.IsEmpty && cboTipo.SelectedIndex>0) {
                ...
                if (Rinv!=null) {
                    filter = qh.AppAnd(filter, GetInventoryFilter(QHS, Rinv["idinventory"]));
				}
			}
            if (tipo.ToUpper() == "A")
            {
...
//		}
        ...
        private DataRow ottieniRowTipoAmm(object idinventoryamortization) {
            ...
            DataAccess.RUN_SELECT_INTO_TABLE(Meta.Conn, tInventoryAmortization, null, filterSQL, null, true);
            if (tInventoryAmortization.Select(filter).Length > 0) {
                return tInventoryAmortization.Select(filter)[0];
            }
            return null;
        ...
        private object ottieniIdAccMotiveAmm(object tipoAmm, object idasset, object idpiece) {
            int ayear = (int)Meta.GetSys("esercizio");
            ...
            string filter = QHC.AppAnd(QHC.CmpEq("idinventoryamortization", tipoAmm),
                QHC.CmpEq("idinv", idinv), QHC.CmpEq("ayear", ayear));
            string filterSQL = QHS.AppAnd(QHS.CmpEq("idinventoryamortization", tipoAmm),
            ...
            if (tInventorySortingAmortizationYear.Select(filter).Length > 0) {
                ...
                return rClass["idaccmotive"];
            }

            DataAccess.RUN_SELECT_INTO_TABLE(Meta.Conn, tInventorySortingAmortizationYear, null, filterSQL, null, true);
            if (tInventorySortingAmortizationYear.Select(filter).Length > 0) {
                DataRow rClass = tInventorySortingAmortizationYear.Select(filter)[0];
                return rClass["idaccmotive"];
            }
        ...
        private decimal calcolaImportoOriginaleCespite(DataRow rCespite) {
            ...
            ParameterDirection[] dir = new ParameterDirection[4]{ParameterDirection.Input,ParameterDirection.Input,
																  ParameterDirection.Input,ParameterDirection.Output};
            object[] valori = new object[4] { rCespite["idasset"], rCespite["idpiece"], "S", null };
            bool res = Meta.Conn.CallSPParameter("get_originalassetvalue", ParamName, tipi, len, dir, ref valori, true, -1);
            if (res) return CfgFn.GetNoNullDecimal(valori[3]);
            QueryCreator.ShowError(this, "Errore chiamando get_originalassetvalue.", Meta.Conn.LastError);
            return 0;
        }
        ...
        private decimal calcolaImportoInizialeCespite(DataRow rCespite)
        {
            ...
            ParameterDirection[] dir = new ParameterDirection[3]{ParameterDirection.Input,ParameterDirection.Input,
																  ParameterDirection.Output};
            object[] valori = new object[3] { rCespite["idasset"], rCespite["idpiece"], null };
            bool res = Meta.Conn.CallSPParameter("get_initialamount", ParamName, tipi, len, dir, ref valori, true, -1);
            if (res) return CfgFn.GetNoNullDecimal(valori[2]);
            QueryCreator.ShowError(this, "Errore chiamando get_initialamount", Meta.Conn.LastError);
            return 0;
        }
        ...
        private decimal calcolaTotAccessoriPossedutiScaricati(DataRow rCespite)
        {
            ...
            object importo = DataAccess.DO_SYS_CMD(Meta.Conn, query, true);
        ...
        private decimal calcolaimportoSvalutazioni(DataRow rCespite) {
            string filter = QHS.AppAnd(QHS.BitClear("i.flag",3), QHS.CmpEq("idasset", rCespite["idasset"]),
                QHS.CmpEq("idpiece", rCespite["idpiece"]));
            string query = "SELECT a.amount FROM assetamortizationview a "
        ...
        private object calcolaIdAccMotiveCespite(object idinv) {
        ...
        void GeneraScritture() {
            if (DS.assetunload.Rows.Count == 0) return; //It was an insert-cancel
            ...
            if (Curr["yassetunload"].ToString() != esercizio.ToString()) {
                return;
            }
            ...
            string idepcontext = "";
            foreach (DataRow rAssAmm in DS.assetamortizationunloadview.Rows) {
                ...
                foreach(DataRow r1 in ContiSpesa) {
                    object idacc = r1["idacc"];
                    EP.EffettuaScrittura(idepcontext, importoAmm, idacc, idreg, idupb, null, null, null, idaccmotive);
                }
            }

            foreach (DataRow rAsset in DS.assetpieceview.Rows) {
                ...
                string query = "SELECT a.amount, isay.idaccmotiveunload FROM assetamortizationview a "
                + " JOIN inventoryamortization i ON i.idinventoryamortization = a.idinventoryamortization "
                + " JOIN inventorysortingamortizationyear isay ON isay.idinventoryamortization = a.idinventoryamortization "
                + " AND isay.ayear = YEAR(a.adate) "
                + " WHERE " + QHS.AppAnd(QHS.MCmp(rAsset, new string[] { "idasset", "idpiece" }),
                QHS.CmpEq("isay.idinv", rAsset["idinv"]), QHS.BitSet("i.flag",3));
                
                tAmmortamento = Meta.Conn.SQLRunner(query);

                decimal totammortamenti = 0;
                foreach (DataRow rAmm in tAmmortamento.Rows) {
                    if (rAmm["idaccmotiveunload"] == DBNull.Value) {
                        continue;
                    }
                    decimal importoAmm = -CfgFn.GetNoNullDecimal(rAmm["amount"]);
                    totammortamenti += importoAmm;

                    DataRow[] ContiAmm = EP.GetAccMotiveDetails(rAmm["idaccmotiveunload"]);
                    foreach (DataRow rr in ContiAmm) {
                        object idaccamm = rr["idacc"];
                        EP.EffettuaScrittura(idepcontext, importoAmm, idaccamm, idreg, idupb, null, rAmm["idaccmotiveunload"]);
                    }
                }
                ...
                foreach (DataRow r3 in ContiSpesa) {
                    object idacc = r3["idacc"];
                    EP.EffettuaScrittura(idepcontext, importoAttuale, idacc, idreg, idupb, null, null, null, idaccmotive);
                }
