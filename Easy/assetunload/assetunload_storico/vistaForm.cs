...
public partial class vistaForm: DataSet {
	...
	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public DataTable assetunloadview 		=> Tables["assetunloadview"];
...
private void initClass() {
	...
	tassetunload.Columns.Add( new DataColumn("idcostpartition", typeof(int)));
	...
	//////////////////// ASSETUNLOADVIEW /////////////////////////////////
	var tassetunloadview= new DataTable("assetunloadview");
	C= new DataColumn("idassetunload", typeof(int));
	C.AllowDBNull=false;
	tassetunloadview.Columns.Add(C);
	C= new DataColumn("idassetunloadkind", typeof(int));
	C.AllowDBNull=false;
	tassetunloadview.Columns.Add(C);
	C= new DataColumn("assetunloadkind", typeof(string));
	C.AllowDBNull=false;
	tassetunloadview.Columns.Add(C);
	C= new DataColumn("yassetunload", typeof(short));
	C.AllowDBNull=false;
	...
	C.AllowDBNull=false;
	tassetunloadview.Columns.Add(C);
	tassetunloadview.Columns.Add( new DataColumn("idreg", typeof(int)));
	tassetunloadview.Columns.Add( new DataColumn("registry", typeof(string)));
	tassetunloadview.Columns.Add( new DataColumn("idmot", typeof(int)));
	tassetunloadview.Columns.Add( new DataColumn("assetunloadmotive", typeof(string)));
	tassetunloadview.Columns.Add( new DataColumn("doc", typeof(string)));
	tassetunloadview.Columns.Add( new DataColumn("docdate", typeof(DateTime)));
	tassetunloadview.Columns.Add( new DataColumn("description", typeof(string)));
	tassetunloadview.Columns.Add( new DataColumn("enactment", typeof(string)));
	tassetunloadview.Columns.Add( new DataColumn("enactmentdate", typeof(DateTime)));
	tassetunloadview.Columns.Add( new DataColumn("adate", typeof(DateTime)));
	tassetunloadview.Columns.Add( new DataColumn("printdate", typeof(DateTime)));
	tassetunloadview.Columns.Add( new DataColumn("ratificationdate", typeof(DateTime)));
	C= new DataColumn("cu", typeof(string));
	C.AllowDBNull=false;
	tassetunloadview.Columns.Add(C);
	C= new DataColumn("ct", typeof(DateTime));
	...
	C.AllowDBNull=false;
	tassetunloadview.Columns.Add(C);
	tassetunloadview.Columns.Add( new DataColumn("transmitted", typeof(string)));
	tassetunloadview.Columns.Add( new DataColumn("idsor01", typeof(int)));
	tassetunloadview.Columns.Add( new DataColumn("idsor02", typeof(int)));
	tassetunloadview.Columns.Add( new DataColumn("idsor03", typeof(int)));
	tassetunloadview.Columns.Add( new DataColumn("idsor04", typeof(int)));
	tassetunloadview.Columns.Add( new DataColumn("idsor05", typeof(int)));
	Tables.Add(tassetunloadview);
	...
	tassetamortizationunloadview.Columns.Add( new DataColumn("idcostpartition", typeof(int)));
	...
	tassetpieceview.Columns.Add( new DataColumn("idcostpartition", typeof(int)));
	...
	tassetunloadattachment.Columns.Add( new DataColumn("idfilestorage", typeof(string)));
