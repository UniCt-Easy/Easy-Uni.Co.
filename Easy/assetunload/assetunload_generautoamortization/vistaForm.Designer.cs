...
private void initClass() {
	...
	tassetunloadkind.Columns.Add( new DataColumn("flag", typeof(byte)));
	tassetunloadkind.Columns.Add( new DataColumn("codeassetunloadkind", typeof(string)));
	...
	tassetpieceview.Columns.Add( new DataColumn("idinventoryagency", typeof(int)));
	tassetpieceview.Columns.Add( new DataColumn("inventoryagency", typeof(string)));
