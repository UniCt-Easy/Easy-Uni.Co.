...
namespace assetunload_default {
    public partial class FrmWizardAmortization : MetaDataForm {
        MetaData Meta;
        DataAccess Conn;
        ...
        void FormInit() {
            CustomTitle = "Svalutazione Cespiti";
        ...
        private void tabIntro_PropertyChanged(Crownwood.Magic.Controls.TabPage page,
