...
namespace clawbacksorting_single {
	/// <summary>
	/// Summary description for FrmClawBackSorting_Single.
	/// </summary>
	public class FrmClawBackSorting_Single : System.Windows.Forms.Form {
		public clawbacksorting_single.vistaForm DS;
		...
		public FrmClawBackSorting_Single() {
			InitializeComponent();
		}
		...
		private void InitializeComponent() {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmClawBackSorting_Single));
            this.DS = new clawbacksorting_single.vistaForm();
            ...
            this.textBox1.Tag = "clawbacksorting.quota.fixed.2..%.100";
            // 
            // label2
            // 
            ...
            this.btnOk.Location = new System.Drawing.Point(344, 180);
            ...
            this.btnAnnulla.Location = new System.Drawing.Point(440, 180);
            this.btnAnnulla.Name = "btnAnnulla";
            this.btnAnnulla.Size = new System.Drawing.Size(75, 23);
            this.btnAnnulla.TabIndex = 16;
            this.btnAnnulla.Text = "Annulla";
            // 
            // FrmClawBackSorting_Single
            // 
            ...
            this.Name = "FrmClawBackSorting_Single";
            this.Text = "FrmClawBackSorting_Single";
		...
		public void MetaData_AfterRowSelect(DataTable T, DataRow R){
			...
			if (MetaData.GetMetaData(this).DrawState== MetaData.form_drawstates.done) {
				if ((!MetaData.Empty(this))){
					DS.clawbacksorting.Rows[0]["idsor"]=0;
				}
				txtCodice.Text="";
				txtDescrizione.Text="";
				DS.sorting.Clear();
		...
		void SetCodice(){
			...
			if (cmbTipo.SelectedIndex<=0){
				...
				string filter = "(idsorkind="+
					QueryCreator.quotedstrvalue(cmbTipo.SelectedValue,true)+")";
        ...
        public void MetaData_AfterLink() {
            ...
            string filterCT = QHS.CmpEq("tablename", "clawback");
