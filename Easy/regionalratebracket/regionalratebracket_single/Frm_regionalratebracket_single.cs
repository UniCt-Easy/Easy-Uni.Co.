...
namespace regionalratebracket_single//scaglionealiquoteregionalisingle//
{
	/// <summary>
	/// Summary description for frmscaglionealiquoteregionalisingle.
	/// </summary>
	public class Frm_regionalratebracket_single : System.Windows.Forms.Form
	{
		public vistaForm DS;
		...
		public Frm_regionalratebracket_single()
		{
			//
		...
		{
			this.DS = new regionalratebracket_single.vistaForm();
			...
			this.textBox2.Tag = "regionalratebracket.maxamount";
			this.textBox2.Text = "";
			// 
			// textBox1
			// 
			...
			this.textBox1.Tag = "regionalratebracket.minamount";
			this.textBox1.Text = "";
			// 
			// label2
			// 
			...
			// 
			// Frm_regionalratebracket_single
			// 
			...
			this.Name = "Frm_regionalratebracket_single";
			this.Text = "frmscaglionealiquoteregionalisingle";
