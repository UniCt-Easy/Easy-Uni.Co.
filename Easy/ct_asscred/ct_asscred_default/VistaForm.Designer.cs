...
public class VistaForm: DataSet {
	...
	///<summary>
	///Contiene la percentuale con cui la voce di spesa ̬ assegnata alla voce di entrata
	///</summary>
	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	...
	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public DataTable ct_asscredview 		=> Tables["ct_asscredview"];
...
private void initClass() {
	...
	C.AllowDBNull=false;
	tct_asscreddetail.Columns.Add(C);
	tct_asscreddetail.Columns.Add( new DataColumn("!bilanciospesa", typeof(string)));
	...
	//////////////////// CT_ASSCREDVIEW /////////////////////////////////
	var tct_asscredview= new DataTable("ct_asscredview");
	C= new DataColumn("idct_asscred", typeof(int));
	C.AllowDBNull=false;
	tct_asscredview.Columns.Add(C);
	C= new DataColumn("idfin_income", typeof(int));
	C.AllowDBNull=false;
	tct_asscredview.Columns.Add(C);
	...
	C.AllowDBNull=false;
	tct_asscredview.Columns.Add(C);
	tct_asscredview.Columns.Add( new DataColumn("idsor", typeof(int)));
	tct_asscredview.Columns.Add( new DataColumn("sortcode", typeof(string)));
	tct_asscredview.Columns.Add( new DataColumn("sorting", typeof(string)));
	Tables.Add(tct_asscredview);
	tct_asscredview.PrimaryKey =  new DataColumn[]{tct_asscredview.Columns["idct_asscred"]};
	...
	var cPar = new []{ct_asscred.Columns["idct_asscred"]};
	var cChild = new []{ct_asscreddetail.Columns["idct_asscred"]};
	...
	cChild = new []{ct_asscred.Columns["idsor"]};
