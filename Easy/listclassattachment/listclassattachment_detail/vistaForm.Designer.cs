...
private void initClass() {
	...
	C.AllowDBNull=false;
	tlistclassattachment.Columns.Add(C);
	tlistclassattachment.Columns.Add( new DataColumn("idfilestorage", typeof(string)));
	...
	var cChild = new []{listclassattachment.Columns["idattachmentkind"]};
	Relations.Add(new DataRelation("attachmentkind_listclassattachment",cPar,cChild,false));
