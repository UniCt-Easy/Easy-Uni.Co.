...
namespace listclassattachment_detail
{
	partial class Frm_listclassattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new listclassattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "listclassattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "listclassattachment.idattachmentkind";
			...
			// 
			// Frm_listclassattachment_detail
			// 
			...
			this.Name = "Frm_listclassattachment_detail";
			this.Text = "Frm_listclassattachment_detail";
