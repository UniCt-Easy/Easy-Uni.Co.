...
{
    public class Meta_dalia_dipartimento : Meta_easydata {
        public Meta_dalia_dipartimento(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "dalia_dipartimento") {
...
protected override Form GetForm(string FormName) {
    ...
    //    return MetaData.GetFormByDllName("dalia_dipartimento_default");
    //}
    return null;
}
...
public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
    ...
    T.setAutoincrement("iddalia_dipartimento", null, null, 0);  //ntabella è campo ad autoincremento
...
public override DataRow SelectOne(string ListingType, string filter, string searchtable, DataTable Exclude) {
    ...
    //    return base.SelectOne(ListingType, filter, "dalia_dipartimentoview", Exclude);
    //else
    return base.SelectOne(ListingType, filter, "dalia_dipartimento", Exclude);
}
...
public override void DescribeColumns(DataTable T, string ListingType) {
    ...
    switch (ListingType) {
	    case "default": {
		    ...
		    int nPos = 1;
		    DescribeAColumn(T, "codedip", "Codice", nPos++);
