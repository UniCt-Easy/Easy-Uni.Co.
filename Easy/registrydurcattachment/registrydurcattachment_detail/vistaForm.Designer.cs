...
private void initClass() {
	...
	tregistrydurcattachment.Columns.Add(C);
			C= new DataColumn("idregistrydurc", typeof(Int32));
	C.AllowDBNull=true;
	tregistrydurcattachment.Columns.Add(C);
	...
	var cChild = new []{registrydurcattachment.Columns["idattachmentkind"]};
	Relations.Add(new DataRelation("attachmentkind_registrydurcattachment",cPar,cChild,false));
