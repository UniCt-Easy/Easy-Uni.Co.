...
namespace registrydurcattachment_detail
{
	partial class Frm_registrydurcattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new registrydurcattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "registrydurcattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "registrydurcattachment.idattachmentkind";
			...
			// 
			// Frm_registrydurcattachment_detail
			// 
			...
			this.Name = "Frm_registrydurcattachment_detail";
			this.Text = "Frm_registrydurcattachment_detail";
