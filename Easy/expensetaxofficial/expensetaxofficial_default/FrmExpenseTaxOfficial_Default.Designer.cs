...
namespace expensetaxofficial_default {
    partial class FrmExpenseTaxOfficial_Default {
        ...
        private void InitializeComponent() {
			...
			// txtAnnoCompetenza
			// 
			this.txtAnnoCompetenza.Enabled = false;
			this.txtAnnoCompetenza.Location = new System.Drawing.Point(120, 53);
			this.txtAnnoCompetenza.Name = "txtAnnoCompetenza";
			this.txtAnnoCompetenza.Size = new System.Drawing.Size(112, 20);
			this.txtAnnoCompetenza.TabIndex = 18;
			this.txtAnnoCompetenza.Tag = "expensetaxofficial.ayear.year";
			// 
			// grpRegion
			// 
