...
namespace meta_viterbo_finvarview {
    public class Meta_viterbo_finvarview :Meta_easydata {
        public Meta_viterbo_finvarview(DataAccess Conn, MetaDataDispatcher Dispatcher)
            :
