...
namespace meta_csa_contracttaxepexpview {
    /// <summary>
    /// Summary description for Class1.
    /// </summary>
    public class Meta_csa_contracttaxepexpview :Meta_easydata {
        public Meta_csa_contracttaxepexpview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "csa_contracttaxepexpview") {
        ...
        public override void DescribeColumns(DataTable T, string ListingType) {
            ...
            if (ListingType == "elenco"||ListingType == "default") {
                ...
                DescribeAColumn(T, "voce CSA", "Voce CSA", nPos++);
