...
public DataTable sortingprevexpensevarview{get { return this.Tables["sortingprevexpensevarview"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
public DataTable sortingview{get { return this.Tables["sortingview"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
public DataTable sortingprevexpensevar{get { return this.Tables["sortingprevexpensevar"];}}
...
this.EnforceConstraints = false;
	...
	DataColumn C;
	DataColumn [] key;
	T= new DataTable("sortingprevexpensevarview");
...
//Primary Key
	...
	T.Columns["idsorkind"], 	T.Columns["idsor"], 	T.Columns["ayear"]};
	T.PrimaryKey = key;

	T= new DataTable("sortingprevexpensevar");
	C= new DataColumn("yvar", typeof(System.Int16), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);
...
TChild= Tables["sortingprevexpensevar"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor"]};
Relations.Add(new DataRelation("sortingview_sortingprevexpensevar",CPar,CChild));
