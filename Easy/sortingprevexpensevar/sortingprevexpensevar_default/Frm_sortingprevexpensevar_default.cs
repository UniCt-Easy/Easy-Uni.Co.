...
namespace sortingprevexpensevar_default//varclassmovimentispese//
{
	...
	public class Frm_sortingprevexpensevar_default : MetaDataForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.groupBox4.Location = new System.Drawing.Point(8, 358);
			...
			this.dataGridAllegati.Tag = "sortingprevexpensevarattachment.lista.detail";
			// 
			// btnDelAtt
			// 
		...
		public void MetaData_AfterLink()
		{
            ...
            // ===============================================================================
            QueryCreator.setSkipInsertCopy(DS.sortingprevexpensevarattachment, true);
        }
