...
{
    public class Meta_caratteristicaora : Meta_easydata 
	{
        public Meta_caratteristicaora(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "caratteristicaora") {
				Name = "Ore";
		...
		public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
			...
			RowChange.MarkAsAutoincrement(T.Columns["idcaratteristicaora"], null, null, 0);
			RowChange.setMinimumTempValue(T.Columns["idcaratteristicaora"], 9990000);
			//$Get_New_Row$
		...
		public override bool IsValid(DataRow R, out string errmess, out string errfield) {
			...
			switch (edit_type) {
				case "default": {
						...
						if (R["idattivformcaratteristica"].ToString().Trim() == "") {
							errmess = "Attenzione! Il campo 'Idattivformcaratteristica' è obbligatorio";
							errfield = "idattivformcaratteristica";
							return false;
						}
						if (R["idcaratteristicaora"].ToString().Trim() == "") {
							errmess = "Attenzione! Il campo 'Identificativo' è obbligatorio";
							errfield = "idcaratteristicaora";
							return false;
						}
		...
		public override void DescribeColumns(DataTable T, string ListingType) {
			...
			switch (ListingType) {
				case "default": {
						...
						DescribeAColumn(T, "ora", "Ora", nPos++);
						break;
					}
				//$DescribeAColumn$
			}
