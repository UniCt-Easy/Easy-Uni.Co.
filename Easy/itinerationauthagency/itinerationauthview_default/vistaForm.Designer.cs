...
public partial class dsmeta: DataSet {
	...
	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public MetaTable itinerationrefundkindgroup_balance 		=> (MetaTable)Tables["itinerationrefundkindgroup_balance"];

	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public MetaTable itinerationrefundkindgroup_advance 		=> (MetaTable)Tables["itinerationrefundkindgroup_advance"];

	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public MetaTable itinerationview 		=> (MetaTable)Tables["itinerationview"];
...
private void initClass() {
	...
	titinerationrefundkind_advance.defineColumn("flagautofill", typeof(int));
	titinerationrefundkind_advance.defineColumn("flagvisible", typeof(int));
	...
	titinerationrefundkind_balance.defineColumn("flagautofill", typeof(int));
	titinerationrefundkind_balance.defineColumn("flagvisible", typeof(int));
	...
	titinerationrefundattachment.defineColumn("lt", typeof(DateTime),false);
	...
	titinerationrefundattachment.defineColumn("idfilestorage", typeof(string));
	...
	//////////////////// ITINERATIONREFUNDKINDGROUP_BALANCE /////////////////////////////////
	var titinerationrefundkindgroup_balance= new MetaTable("itinerationrefundkindgroup_balance");
	titinerationrefundkindgroup_balance.defineColumn("iditinerationrefundkindgroup", typeof(int),false);
	titinerationrefundkindgroup_balance.defineColumn("description", typeof(string),false);
	titinerationrefundkindgroup_balance.defineColumn("ct", typeof(DateTime),false);
	titinerationrefundkindgroup_balance.defineColumn("cu", typeof(string),false);
	titinerationrefundkindgroup_balance.defineColumn("lt", typeof(DateTime),false);
	titinerationrefundkindgroup_balance.defineColumn("lu", typeof(string),false);
	Tables.Add(titinerationrefundkindgroup_balance);
	titinerationrefundkindgroup_balance.defineKey("iditinerationrefundkindgroup");

	//////////////////// ITINERATIONREFUNDKINDGROUP_ADVANCE /////////////////////////////////
	var titinerationrefundkindgroup_advance= new MetaTable("itinerationrefundkindgroup_advance");
	titinerationrefundkindgroup_advance.defineColumn("iditinerationrefundkindgroup", typeof(int),false);
	titinerationrefundkindgroup_advance.defineColumn("description", typeof(string),false);
	titinerationrefundkindgroup_advance.defineColumn("ct", typeof(DateTime),false);
	titinerationrefundkindgroup_advance.defineColumn("cu", typeof(string),false);
	titinerationrefundkindgroup_advance.defineColumn("lt", typeof(DateTime),false);
	titinerationrefundkindgroup_advance.defineColumn("lu", typeof(string),false);
	Tables.Add(titinerationrefundkindgroup_advance);
	titinerationrefundkindgroup_advance.defineKey("iditinerationrefundkindgroup");

	//////////////////// ITINERATIONVIEW /////////////////////////////////
	var titinerationview= new MetaTable("itinerationview");
	titinerationview.defineColumn("iditineration", typeof(int),false);
	titinerationview.defineColumn("yitineration", typeof(short),false);
	titinerationview.defineColumn("nitineration", typeof(int),false);
	titinerationview.defineColumn("description", typeof(string),false);
	titinerationview.defineColumn("idreg", typeof(int),false);
	titinerationview.defineColumn("registry", typeof(string),false);
	titinerationview.defineColumn("iddaliaposition", typeof(int));
	titinerationview.defineColumn("codedaliaposition", typeof(string));
	titinerationview.defineColumn("daliaposition", typeof(string));
	titinerationview.defineColumn("idser", typeof(int),false);
	titinerationview.defineColumn("service", typeof(string));
	titinerationview.defineColumn("codeser", typeof(string));
	titinerationview.defineColumn("admincarkmcost", typeof(decimal));
	titinerationview.defineColumn("owncarkmcost", typeof(decimal));
	titinerationview.defineColumn("footkmcost", typeof(decimal));
	titinerationview.defineColumn("admincarkm", typeof(double));
	titinerationview.defineColumn("owncarkm", typeof(double));
	titinerationview.defineColumn("footkm", typeof(double));
	titinerationview.defineColumn("authorizationdate", typeof(DateTime),false);
	titinerationview.defineColumn("start", typeof(DateTime),false);
	titinerationview.defineColumn("stop", typeof(DateTime),false);
	titinerationview.defineColumn("adate", typeof(DateTime),false);
	titinerationview.defineColumn("grossfactor", typeof(double));
	titinerationview.defineColumn("netfee", typeof(decimal));
	titinerationview.defineColumn("totalgross", typeof(decimal));
	titinerationview.defineColumn("total", typeof(decimal));
	titinerationview.defineColumn("totadvance", typeof(decimal));
	titinerationview.defineColumn("location", typeof(string));
	titinerationview.defineColumn("cu", typeof(string),false);
	titinerationview.defineColumn("ct", typeof(DateTime),false);
	titinerationview.defineColumn("lu", typeof(string),false);
	titinerationview.defineColumn("lt", typeof(DateTime),false);
	titinerationview.defineColumn("active", typeof(string));
	titinerationview.defineColumn("completed", typeof(string));
	titinerationview.defineColumn("iditinerationstatus", typeof(int));
	titinerationview.defineColumn("itinerationstatus", typeof(string));
	titinerationview.defineColumn("idaccmotive", typeof(string));
	titinerationview.defineColumn("codemotive", typeof(string));
	titinerationview.defineColumn("accmotive", typeof(string));
	titinerationview.defineColumn("idaccmotivedebit", typeof(string));
	titinerationview.defineColumn("codemotivedebit", typeof(string));
	titinerationview.defineColumn("accmotivedebit", typeof(string));
	titinerationview.defineColumn("idaccmotivedebit_crg", typeof(string));
	titinerationview.defineColumn("codemotivedebit_crg", typeof(string));
	titinerationview.defineColumn("accmotive_crg", typeof(string));
	titinerationview.defineColumn("idaccmotivedebit_datacrg", typeof(DateTime));
	titinerationview.defineColumn("idupb", typeof(string));
	titinerationview.defineColumn("codeupb", typeof(string));
	titinerationview.defineColumn("idsor01", typeof(int),true,true);
	titinerationview.defineColumn("idsor02", typeof(int),true,true);
	titinerationview.defineColumn("idsor03", typeof(int),true,true);
	titinerationview.defineColumn("idsor04", typeof(int),true,true);
	titinerationview.defineColumn("idsor05", typeof(int),true,true);
	titinerationview.defineColumn("idsor1", typeof(int));
	titinerationview.defineColumn("idsor2", typeof(int));
	titinerationview.defineColumn("idsor3", typeof(int));
	titinerationview.defineColumn("txt", typeof(string));
	titinerationview.defineColumn("rtf", typeof(Byte[]));
	titinerationview.defineColumn("position", typeof(string));
	titinerationview.defineColumn("incomeclass", typeof(short),true,true);
	titinerationview.defineColumn("incomeclassvalidity", typeof(DateTime));
	titinerationview.defineColumn("extmatricula", typeof(string));
	titinerationview.defineColumn("foreigngroupnumber", typeof(short));
	titinerationview.defineColumn("idregistrylegalstatus", typeof(int));
	titinerationview.defineColumn("applierannotations", typeof(string));
	titinerationview.defineColumn("webwarn", typeof(string));
	titinerationview.defineColumn("idman", typeof(int));
	titinerationview.defineColumn("manager", typeof(string));
	titinerationview.defineColumn("flagweb", typeof(string));
	titinerationview.defineColumn("idauthmodel", typeof(int));
	titinerationview.defineColumn("authmodel", typeof(string));
	titinerationview.defineColumn("authmodtitle", typeof(string));
	titinerationview.defineColumn("statusimage", typeof(string),true,true);
	titinerationview.defineColumn("listingorder", typeof(short));
	titinerationview.defineColumn("authneeded", typeof(string));
	titinerationview.defineColumn("authdoc", typeof(string));
	titinerationview.defineColumn("authdocdate", typeof(DateTime));
	titinerationview.defineColumn("noauthreason", typeof(string));
	titinerationview.defineColumn("clause_accepted", typeof(string));
	titinerationview.defineColumn("vehicle_info", typeof(string));
	titinerationview.defineColumn("vehicle_motive", typeof(string));
	titinerationview.defineColumn("advancelinked", typeof(decimal),true,true);
	...
	titinerationview.defineColumn("iditineration_ref", typeof(int));
	titinerationview.defineColumn("nref", typeof(int));
	titinerationview.defineColumn("yref", typeof(short));
	titinerationview.defineColumn("iddalia_dipartimento", typeof(int));
	titinerationview.defineColumn("iddalia_funzionale", typeof(int));
	titinerationview.defineColumn("idcostpartition", typeof(int));
	titinerationview.defineColumn("advancepercentagefood", typeof(decimal));
	titinerationview.defineColumn("advancepercentageliving", typeof(decimal));
	...
	titinerationauthview.defineColumn("totadvance", typeof(decimal),true,true);
	...
	titinerationauthview.defineColumn("iditinerationstatus", typeof(short));
	titinerationauthview.defineColumn("location", typeof(string));
	titinerationauthview.defineColumn("idsor01", typeof(int),true,true);
	titinerationauthview.defineColumn("idsor02", typeof(int),true,true);
	titinerationauthview.defineColumn("idsor03", typeof(int),true,true);
	titinerationauthview.defineColumn("idsor04", typeof(int),true,true);
	titinerationauthview.defineColumn("idsor05", typeof(int),true,true);
	...
	titinerationauthview.defineColumn("annotationsrejectapproval_prec", typeof(string),true,true);
	...
	this.defineRelation("itinerationrefundkindgroup_balance_itinerationrefundkind_balance","itinerationrefundkindgroup_balance","itinerationrefundkind_balance","iditinerationrefundkindgroup");
	this.defineRelation("itinerationrefundkindgroup_advance_itinerationrefundkind_advance","itinerationrefundkindgroup_advance","itinerationrefundkind_advance","iditinerationrefundkindgroup");
