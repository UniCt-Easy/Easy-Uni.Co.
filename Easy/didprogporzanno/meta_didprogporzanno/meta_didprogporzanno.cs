...
{
    public class Meta_didprogporzanno : Meta_easydata 
	{
        public Meta_didprogporzanno(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "didprogporzanno") {
		...
		public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
			...
			RowChange.MarkAsAutoincrement(T.Columns["iddidprogporzanno"], null, null, 0);
			RowChange.setMinimumTempValue(T.Columns["iddidprogporzanno"], 9990000);
			//$Get_New_Row$
		...
		public override void DescribeColumns(DataTable T, string ListingType) {
			...
			switch (ListingType) {
				case "default": {
						...
						DescribeAColumn(T, "!iddidprogporzannokind_didprogporzannokind_title", "Iddidprogporzannokind", nPos++);
						break;
					}
				//$DescribeAColumn$
			}
