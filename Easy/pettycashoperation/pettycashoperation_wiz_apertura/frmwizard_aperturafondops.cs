...
namespace pettycashoperation_wiz_apertura{//wizard_aperturafondops//
	...
	public class Frm_pettycashoperation_wiz_apertura : System.Windows.Forms.Form {
		...
		public void MetaData_AfterLink() {
			...
			Messaggi.Add("err_fondoaperto", "Errore: Ë gi‡ presente una operazione di apertura del fondo selezionato "+
			...
			Messaggi.Add("warn_salvataggio", "Avvertimento: se l'operazione viene confermata, verranno generati i " +
				"seguenti movimenti di contabilit‡ finanziaria. Se si vuole inserire l'operazione di apertura " +
				"cliccare su Fine.");
		...
		private void InitializeComponent() {
			...
			this.label3.Text = @"ATTENZIONE! Questa procedura Ë l'unica che consente di aprire un fondo economale, tutti gli altri metodi di procedere NON SONO CORRETTI. Di seguito si potranno generare movimenti di contabilit‡ finanziaria e/o collegarne di esistenti  per aprire il fondo economale.";
