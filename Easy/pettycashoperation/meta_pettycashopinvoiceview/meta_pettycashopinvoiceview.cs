...
namespace meta_pettycashopinvoiceview {
	/// <summary>
	/// Summary description for Class1.
	/// </summary>
	public class Meta_pettycashopinvoiceview : Meta_easydata {
		public Meta_pettycashopinvoiceview(DataAccess Conn, MetaDataDispatcher Dispatcher):
			base(Conn, Dispatcher, "pettycashopinvoiceview") {
