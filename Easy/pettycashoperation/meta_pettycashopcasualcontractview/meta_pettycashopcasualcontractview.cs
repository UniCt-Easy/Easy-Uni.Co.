...
namespace meta_pettycashopcasualcontractview
{
	/// <summary>
	/// Summary description for Class1.
	/// </summary>
	public class Meta_pettycashopcasualcontractview : Meta_easydata {
		public Meta_pettycashopcasualcontractview(DataAccess Conn, MetaDataDispatcher Dispatcher):
			base(Conn, Dispatcher, "pettycashopcasualcontractview") {
