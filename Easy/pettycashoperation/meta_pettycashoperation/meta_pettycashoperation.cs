...
namespace meta_pettycashoperation {//meta_opfondopiccolespese//
	...
	public class Meta_pettycashoperation : Meta_easydata {
		...
		public override bool IsValid(DataRow R, out string errmess, out string errfield) {
            ...
            {
                errmess = "Non è stato selezionato il Fondo Economale";
			...
			if (((R["idfin"]!=DBNull.Value) ||
				...
				errmess="Non è possibile specificare sia il movimento di spesa che un'attribuzione normale";
				return false;
			}
			
			if (R["amount"]==DBNull.Value) {
				errmess="Non è stato immesso l'importo originale";
				errfield="amount";
				return false;
			}
            ...
            {
                errmess = "Il numero Nota Spese può essere negativo";
                errfield = "nlist";
                return false;
            }
			return true;
