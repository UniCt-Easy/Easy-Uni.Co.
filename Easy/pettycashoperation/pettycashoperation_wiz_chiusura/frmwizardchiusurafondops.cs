...
namespace pettycashoperation_wiz_chiusura {//wizard_chiusurafondops//
	...
	public class Frm_pettycashoperation_wiz_chiusura : System.Windows.Forms.Form {
		...
		public void MetaData_AfterLink() {
			...
			Messaggi.Add("err_fondochiuso", "Errore: è già presente una operazione di chiusura del fondo selezionato.");
			...
			Messaggi.Add("warn_salvataggio", "Avvertimento: se l'operazione viene confermata, verranno generati i " +
				"seguenti movimenti di contabilità finanziaria. Se si vuole inserire l'operazione di chiusura " +
				"cliccare su Fine.");
		...
		private void InitializeComponent() {
			...
			this.label1.Text = @"ATTENZIONE! Questa procedura è l'unica che consente di chiudere un fondo economale, tutti gli altri metodi di procedere NON SONO CORRETTI. Di seguito si potranno generare movimenti di contabilità finanziaria e/o collegarne di esistenti  per chiudere il fondo economale.";
			// 
			// tabPage2
			// 
		...
		private void btnCollega_Click(object sender, System.EventArgs e) {
			...
			if (maxfase<1){
				MetaFactory.factory.getSingleton<IMessageShower>().Show("Non è possibile collegare tutte le righe selezionate ad uno stesso movimento.\n"+
