...
namespace stocklocation_default{
	public class Frm_stocklocation_default : MetaDataForm {
		...
		private void InitializeComponent()
		{
			...
			this.dataGridAllegati.Tag = "stocklocationattachment.lista.detail";
			// 
			// btnDelAtt
			// 
		...
		public void MetaData_AfterLink(){
            ...
            // ===============================================================================
            QueryCreator.setSkipInsertCopy(DS.stocklocationattachment, true);
        }
