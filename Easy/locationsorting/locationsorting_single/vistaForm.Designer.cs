...
namespace locationsorting_single {
using System;
using System.Data;
...
public DataTable locationsorting{get { return this.Tables["locationsorting"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
...
this.EnforceConstraints = false;
	...
	DataColumn C;
	DataColumn [] key;
	T= new DataTable("locationsorting");
...
//Primary Key
	...
	T.Columns["idlocation"], 	T.Columns["idsor"]};
	T.PrimaryKey = key;
...
DataColumn []CChild;
TPar= Tables["sorting"];
TChild= Tables["locationsorting"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor"]};
Relations.Add(new DataRelation("sortinglocationsorting",CPar,CChild));
