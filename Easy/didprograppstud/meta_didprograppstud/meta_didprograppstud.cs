...
namespace meta_didprograppstud
{
    public class Meta_didprograppstud : Meta_easydata 
	{
        public Meta_didprograppstud(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "didprograppstud") {
				Name = "Rappresentanti degli studenti per la didattica programmata";
			...
			switch (edit_type) {
				case "default": {
						...
						if (R["iddidprog"].ToString().Trim() == "") {
							errmess = "Attenzione! Il campo 'Didattica Programmata' è obbligatorio";
							errfield = "iddidprog";
							return false;
						}
