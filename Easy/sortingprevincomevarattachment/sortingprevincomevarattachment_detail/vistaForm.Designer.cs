...
private void initClass() {
	...
	C.AllowDBNull=false;
	tsortingprevincomevarattachment.Columns.Add(C);
	tsortingprevincomevarattachment.Columns.Add( new DataColumn("idfilestorage", typeof(string)));
	...
	var cChild = new []{sortingprevincomevarattachment.Columns["idattachmentkind"]};
	Relations.Add(new DataRelation("attachmentkind_sortingprevincomevarattachment",cPar,cChild,false));
