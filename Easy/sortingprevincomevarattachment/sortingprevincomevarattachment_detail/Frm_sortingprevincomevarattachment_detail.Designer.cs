...
namespace sortingprevincomevarattachment_detail
{
	partial class Frm_sortingprevincomevarattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new sortingprevincomevarattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "sortingprevincomevarattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "sortingprevincomevarattachment.idattachmentkind";
			...
			// 
			// Frm_sortingprevincomevarattachment_detail
			// 
			...
			this.Name = "Frm_sortingprevincomevarattachment_detail";
			this.Text = "Frm_sortingprevincomevarattachment_detail";
