...
namespace expensevar_default{
	...
	/// </summary>
	public class Frm_expensevar_default : MetaDataForm {
		int CurrCausaleIva;
		DataRow IvaLinked;
		...
		private void InitializeComponent() {
			...
			this.txtEsercVariazione.Tag = "expensevar.yvar.year?expensevarview.yvar.year";
			// 
			// grpMovimento
			// 
			...
			// radCsa
			// 
			this.radCsa.Location = new System.Drawing.Point(12, 97);
			...
			this.radAnnullo.CheckedChanged += new System.EventHandler(this.radAnnullo_CheckedChanged);
			// 
			// radNormale
			// 
			...
			this.tabDettagli.Size = new System.Drawing.Size(985, 446);
			...
			this.grpInvoiceDetail.Size = new System.Drawing.Size(967, 426);
			...
			this.dgrDettagliFattura.Size = new System.Drawing.Size(865, 410);
			...
			this.tabPage2.Size = new System.Drawing.Size(985, 446);
			...
			this.DGridClassificazioni.Size = new System.Drawing.Size(967, 89);
		...
		public void MetaData_AfterLink() {
            ...
            // ===============================================================================
            QueryCreator.setSkipInsertCopy(DS.expensevarattachment, true);
        }
    	...
    	public void MetaData_BeforePost() {
            ...
            if (DS.expensevar.Rows[0].RowState == DataRowState.Added) {
                object Idinvkind = DS.expensevar.Rows[0]["idinvkind", DataRowVersion.Default];
            ...
            if (DS.expensevar.Rows[0].RowState == DataRowState.Modified) {
                object oldIdinvkind_main = DS.expensevar.Rows[0]["idinvkind", DataRowVersion.Original];
                object newIdinvkind_main = DS.expensevar.Rows[0]["idinvkind", DataRowVersion.Current];
		...
		private void fillPaymentBank() {
			...
			// Nel caso la var. è stata cancellata e il mov. di spesa non era presente in un mandato non devo eseguire
		...
		private void FillAnnullo() {
            ...
            //ANNUL
            radAnnullo.Checked = currauto==11;
            
            //ANPAR
            radAnnPar.Checked = currauto == 10;
            
            //EDIT
            radEdit.Checked = (currauto == 22);
		...
		private void EnableDisableCheckDocIVA(int currphase){
			...
			bool abilita = ((DS.expenseview.Rows.Count > 0) || Meta.IsEmpty)
                && (currphase == maxPhase) && !Meta.InsertMode && !Meta.EditMode;
		...
		private void btnInsertClass_Click(object sender, System.EventArgs e) {
			...
			DataRow Added = MetaData.Insert_Grid(DGridDettagliClassificazioni, "default");//qui è scattata un'eccezione ma non ne trovo il motivo 
