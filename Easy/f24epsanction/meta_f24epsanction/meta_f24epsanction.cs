...
namespace meta_f24epsanction
{
	/// <summary>
	/// Summary description for Meta_casualrefund.
	/// </summary>
    public class Meta_f24epsanction : Meta_easydata
	{
		public Meta_f24epsanction(DataAccess Conn, MetaDataDispatcher Dispatcher) :
			base(Conn, Dispatcher, "f24epsanction") 
		{
		...
		protected override Form GetForm(string FormName)
		{
			if (FormName=="single")
			{
		        ...
		        return GetFormByDllName("f24epsanction_single");
			}
			return null;
		}
        ...
        public override DataRow Get_New_Row (DataRow ParentRow, DataTable T) {
            RowChange.SetSelector(T, "idf24ep");
