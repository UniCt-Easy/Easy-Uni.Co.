...
namespace f24epsanction_single
{
	/// <summary>
	/// </summary>
    public class Frm_f24epsanction_single : System.Windows.Forms.Form {
		...
		public f24epsanction_single.vistaForm DS;
        ...
        public Frm_f24epsanction_single ()
		{
			InitializeComponent();
		...
		private void InitializeComponent()
		{
            ...
            this.DS = new f24epsanction_single.vistaForm();
            ...
            this.cmbTipo.Tag = "f24epsanction.idsanction?x";
            ...
            this.textBox1.Tag = "f24epsanction.amount";
            // 
            // label2
            // 
            ...
            this.txtGeoComune.Tag = "geo_city.title?f24epsanctionview.city";
            // 
            // label4
            // 
            ...
            this.txtEsercizio.Tag = "f24epsanction.ayear.year";
            // 
            // label7
            // 
            ...
            this.cmbRegioneFiscale.Tag = "f24epsanction.idfiscaltaxregion?geo_cityview.title?f24epsanctionview.region";
            ...
            this.Name = "Frm_f24epsanction_single";
        ...
        public void MetaData_AfterRowSelect (DataTable T, DataRow R) {
            switch (T.TableName) {
                case "f24epsanctionkind": {
                    if (R != null) {
                        if (DS.f24epsanction.Rows.Count == 0) return;
                        DataRow Curr = DS.f24epsanction.Rows[0];
