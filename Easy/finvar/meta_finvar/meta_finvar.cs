...
//using finvar_default;//VariazioneBilancio
using System.Data;
...
namespace meta_finvar {
    ...
    /// </summary>
    public class Meta_finvar : Meta_easydata {
        public Meta_finvar(DataAccess Conn, MetaDataDispatcher Dispatcher)
            :
            base(Conn, Dispatcher, "finvar") {
        ...
        public override DataRow SelectOne (string ListingType, string filter, string searchtable, DataTable Exclude) {
            if (ListingType == "default"||ListingType == "documentocollegato") return base.SelectOne(ListingType, filter, "finvarview", Exclude);
            return base.SelectOne(ListingType, filter, "finvar", Exclude);
        }	
