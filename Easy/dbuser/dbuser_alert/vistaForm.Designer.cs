...
private void initClass() {
	...
	var cPar = new []{alert.Columns["idalert"]};
	var cChild = new []{dbuseralert.Columns["idalert"]};
	Relations.Add(new DataRelation("alert_dbuseralert",cPar,cChild,false));

	cPar = new []{dbuser.Columns["login"]};
	cChild = new []{dbuseralert.Columns["login"]};
	Relations.Add(new DataRelation("dbuser_dbuseralert",cPar,cChild,false));
