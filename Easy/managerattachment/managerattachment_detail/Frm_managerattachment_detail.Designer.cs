...
namespace managerattachment_detail
{
	partial class Frm_managerattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new managerattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "managerattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "managerattachment.idattachmentkind";
			...
			this.Name = "Frm_managerattachment_detail";
			this.Text = "Frm_managerattachment_detail";
