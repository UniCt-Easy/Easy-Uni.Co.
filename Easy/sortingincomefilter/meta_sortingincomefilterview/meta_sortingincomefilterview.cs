...
namespace meta_sortingincomefilterview {//meta_filtraclassentrateview//
	/// <summary>
	/// Summary description for Class1.
	/// </summary>
	public class Meta_sortingincomefilterview : Meta_easydata {
		public Meta_sortingincomefilterview(DataAccess Conn, MetaDataDispatcher Dispatcher):
			base(Conn, Dispatcher, "sortingincomefilterview") {
