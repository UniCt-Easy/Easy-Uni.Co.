...
namespace wageaddition_default //contrattodipendente//
{
    ...
    /// </summary>
    public class Frm_wageaddition_default : System.Windows.Forms.Form {
        public vistaForm DS;
        ...
        private void InitializeComponent() {
            ...
            // btnTrasfdipendenti
            // 
            this.btnTrasfdipendenti.Location = new System.Drawing.Point(531, 434);
            this.btnTrasfdipendenti.Name = "btnTrasfdipendenti";
            this.btnTrasfdipendenti.Size = new System.Drawing.Size(197, 28);
            ...
            this.groupDebPignoratizio.Location = new System.Drawing.Point(479, 127);
            ...
            // btnRicalcola
            // 
            this.btnRicalcola.Location = new System.Drawing.Point(579, 278);
            ...
            this.groupBox7.Size = new System.Drawing.Size(169, 116);
            ...
            // btnCambiaRuolo
            // 
            this.btnCambiaRuolo.Location = new System.Drawing.Point(78, 88);
            ...
            // txtInquadrcsa
            // 
            this.txtInquadrcsa.Location = new System.Drawing.Point(86, 62);
            ...
            // checkBox1
            // 
            this.checkBox1.Location = new System.Drawing.Point(583, 218);
            ...
            // 
            this.txtImponibileFiscale.Location = new System.Drawing.Point(568, 184);
            ...
            // label7
            // 
            this.label7.Location = new System.Drawing.Point(464, 184);
            ...
            this.cmbOrario.Location = new System.Drawing.Point(96, 8);
            ...
            this.cmbDurata.Location = new System.Drawing.Point(96, 8);
            ...
            this.cmbQualifica.Location = new System.Drawing.Point(96, 8);
            ...
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this.textBox2.Location = new System.Drawing.Point(8, 385);
            this.textBox2.Multiline = true;
            this.textBox2.Name = "textBox2";
            this.textBox2.Size = new System.Drawing.Size(515, 77);
            ...
            // txtCostoTotaleInput
            // 
            this.txtCostoTotaleInput.Location = new System.Drawing.Point(328, 184);
            ...
            // label40
            // 
            this.label40.Location = new System.Drawing.Point(248, 184);
            ...
            // 
            this.txtLordoAlBeneficiario.Location = new System.Drawing.Point(120, 184);
            ...
            this.grpPrestazione.Location = new System.Drawing.Point(8, 126);
            ...
            this.grpPercipiente.Location = new System.Drawing.Point(8, 81);
    ...
    "";
            ...
            this.grpCausaliAssunzioneDalia.Location = new System.Drawing.Point(18, 168);
        ...
        private void visualizzaMessaggio() {
            string messaggio = "Il calcolo non puÚ essere effettuato in quanto mancano i seguenti dati:";
            if (lastCreditore == 0) {
                messaggio += "\nIl Percipiente";
            }
            ...
            MessageBox.Show(this, messaggio, "Avvertimento", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        }
        ...
        private void calcolaRitenute(ImportoDiPartenza tipoImporto, decimal importoInserito, bool visualizzaAvvertimento) {
            ...
            if (currParams != lastParams) {
                ...
                // Controllo il risultato della S.P. con le ritenute gi‡ presenti in DS.contrattodipritenuta
                // Se la ritenuta Ë presente in DS.contrattodipritenuta e non Ë presente in Out.Tables[0] cancello la riga di DS
                ...
                // Se la ritenuta non Ë presente in DS.contrattodipritenuta ed Ë presente in Out.Tables[0] aggiungo la riga di DS
        ...
        void GeneraScrittureAP() {
            ...
            if (!(idser == DBNull.Value || CfgFn.GetNoNullInt32(idser) == 0)) {
                ...
                if (codeser == "08_PREMI") {
                    MessageBox.Show("Su Premi di studio e altri premi non Ë possibile " +
                                    "\ngenerare l'Anagrafe delle Prestazioni");
                    return;
                }
                if (codeser == "08_CONTRIB_C_ESERC") {
                    MessageBox.Show("Sui contributi in conto esercizio non Ë possibile " +
                                    "\ngenerare l'Anagrafe delle Prestazioni");
                    return;
                }
            }
        ...
        private void btnTrasfdipendenti_Click(object sender, EventArgs e) {
            if (Meta.IsEmpty) {
                MessageBox.Show(this, "Sei in modalit‡ ricerca, effettua la ricerca prima di trasferire");
                return;
            }

            if (Meta.InsertMode) {
                MessageBox.Show(this, "Sei in modalit‡ inserimento non puoi ancora trasferire il contratto");
                return;
            }
