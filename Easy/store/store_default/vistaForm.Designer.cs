...
private void initClass() {
	...
	var cChild = new []{store.Columns["idupb"]};
	Relations.Add(new DataRelation("upb_store",cPar,cChild,false));

	cPar = new []{sorting01.Columns["idsor"]};
	cChild = new []{store.Columns["idsor01"]};
	Relations.Add(new DataRelation("sorting01_store",cPar,cChild,false));

	cPar = new []{sorting02.Columns["idsor"]};
	cChild = new []{store.Columns["idsor02"]};
	Relations.Add(new DataRelation("sorting02_store",cPar,cChild,false));

	cPar = new []{sorting03.Columns["idsor"]};
	cChild = new []{store.Columns["idsor03"]};
	Relations.Add(new DataRelation("sorting03_store",cPar,cChild,false));

	cPar = new []{sorting04.Columns["idsor"]};
	cChild = new []{store.Columns["idsor04"]};
	Relations.Add(new DataRelation("sorting04_store",cPar,cChild,false));

	cPar = new []{sorting05.Columns["idsor"]};
	cChild = new []{store.Columns["idsor05"]};
	Relations.Add(new DataRelation("sorting05_store",cPar,cChild,false));

	cPar = new []{estimatekind.Columns["idestimkind"]};
	cChild = new []{store.Columns["idestimkind"]};
	Relations.Add(new DataRelation("estimatekind_store",cPar,cChild,false));
