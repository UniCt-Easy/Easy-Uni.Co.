...
namespace meta_instmuseristituti {
public class instmuseristitutiRow: MetaRow  {
	public instmuseristitutiRow(DataRowBuilder rb) : base(rb) {} 
	...
	public Int32? idinstmuseristituti{ 
		get {if (this["idinstmuseristituti"]==DBNull.Value)return null; return  (Int32?)this["idinstmuseristituti"];}
		set {if (value==null) this["idinstmuseristituti"]= DBNull.Value; else this["idinstmuseristituti"]= value;}
	}
	public object idinstmuseristitutiValue { 
		get{ return this["idinstmuseristituti"];}
		set {if (value==null|| value==DBNull.Value) this["idinstmuseristituti"]= DBNull.Value; else this["idinstmuseristituti"]= value;}
	}
	public Int32? idinstmuseristitutiOriginal { 
		get {if (this["idinstmuseristituti",DataRowVersion.Original]==DBNull.Value)return null; return  (Int32?)this["idinstmuseristituti",DataRowVersion.Original];}
	}
	...
	///<summary>
	///Università Consorziata a INSTM o Ente accademico collegato
	///</summary>
...
public class instmuseristitutiTable : MetaTableBase<instmuseristitutiRow> {
	public instmuseristitutiTable() : base("instmuseristituti"){
		baseColumns = new Dictionary<string, DataColumn>(){
			{"ct",createColumn("ct",typeof(DateTime),false,false)},
			{"cu",createColumn("cu",typeof(string),false,false)},
			{"idinstmuseristituti",createColumn("idinstmuseristituti",typeof(int),false,false)},
