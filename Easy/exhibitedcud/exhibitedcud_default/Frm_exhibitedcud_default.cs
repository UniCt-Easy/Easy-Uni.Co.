...
namespace exhibitedcud_default {//cudpresentato//
	...
	/// </summary>
	public class Frm_exhibitedcud_default : MetaDataForm {
		public vistaForm DS;
            ...
            if ((T.TableName == "parasubcontractlist")||(T.TableName == "parasubcontractlistview")) {
                ...
                if (cmbContrattoPrecedente.SelectedIndex <= 0) {
                    ...
                    CalcoliCococo.cudContratto cud = CalcoliCococo.getInfoCudFromContratto(
                        ...
                        r);
                    if (cud == null) {
                        show("Il contratto selezionato non è di tipologia cud", "Avviso");
                        return;
                    }
                    ...
                    if (contrattoGiaConguagliato) {
                        if (errori != "") {
                            show(this, "Ci sono le seguenti incoerenze tra il contratto scelto e le informazioni contenute nel cud:"
                                + errori);
                        }
                    }
                    else {
                        if (errori != "" ) {
                            if (Meta.EditMode) {
                                show(this, "Ci sono le seguenti incoerenze tra il contratto scelto e le informazioni contenute nel cud:" + errori,
