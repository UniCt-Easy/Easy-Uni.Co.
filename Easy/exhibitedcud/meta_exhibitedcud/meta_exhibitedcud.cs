	...
	public class Meta_exhibitedcud : Meta_easydata {
		...
		public override bool IsValid(DataRow R, out string errmess, out string errfield) {
			...
			if ((lunghezzaCF != 11) && (lunghezzaCF != 16)) {
				errmess = "La lunghezza del Codice Fiscale Ë errata, essa deve essere di 11 o 16 caratteri";
				errfield = "cfotherdeputy";
				return false;
			}
            ...
            if (((R["regionaltaxapplied"] != DBNull.Value) || (R["suspendedregionaltax"] != DBNull.Value))
             && (R["idfiscaltaxregion"] == DBNull.Value)){
                    errmess = "Bisogna specificare la regione fiscale alla quale si Ë versata l'addizionale regionale";
            ...
            && (R["idcity"] == DBNull.Value)){
                    errmess = "Bisogna specificare il comune al quale si Ë versata l'addizionale comunale e/o l'acconto";
                    errfield = "idcity";
                    return false;
            }
