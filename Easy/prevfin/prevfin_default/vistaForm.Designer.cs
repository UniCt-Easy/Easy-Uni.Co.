...
public DataTable prevfin{get { return this.Tables["prevfin"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
...
this.EnforceConstraints = false;
	...
	DataColumn C;
	DataColumn [] key;
	T= new DataTable("prevfin");
	C= new DataColumn("ayear", typeof(System.Int16), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);

	C= new DataColumn("nprevfin", typeof(System.Int32), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);
...
//Primary Key
	...
	T.Columns["ayear"], 	T.Columns["nprevfin"]};
	T.PrimaryKey = key;
...
//Primary Key
	...
	T.Columns["ayear"], 	T.Columns["nprevfin"], 	T.Columns["idfin"], 	T.Columns["idupb"]};
	T.PrimaryKey = key;
...
TPar= Tables["prevfin"];
TChild= Tables["prevfindetail"];
CPar = new DataColumn[2]{TPar.Columns["ayear"], TPar.Columns["nprevfin"]};
CChild = new DataColumn[2]{TChild.Columns["ayear"], TChild.Columns["nprevfin"]};
Relations.Add(new DataRelation("prevfinprevfindetail",CPar,CChild));

TPar= Tables["upb"];
TChild= Tables["prevfindetail"];
CPar = new DataColumn[1]{TPar.Columns["idupb"]};
CChild = new DataColumn[1]{TChild.Columns["idupb"]};
Relations.Add(new DataRelation("upbprevfindetail",CPar,CChild));
