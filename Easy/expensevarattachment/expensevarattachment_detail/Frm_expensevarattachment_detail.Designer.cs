...
namespace expensevarattachment_detail
{
	partial class Frm_expensevarattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new expensevarattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "expensevarattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "expensevarattachment.idattachmentkind";
			...
			// 
			// Frm_expensevarattachment_detail
			// 
			...
			this.Name = "Frm_expensevarattachment_detail";
			this.Text = "Frm_expensevarattachment_detail";
