...
{
    public class Meta_instmuserqualifies : Meta_easydata 
	{
        public Meta_instmuserqualifies(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "instmuserqualifies") {
				Name = "Qualifiche dell'afferente";
		...
		public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
			...
			RowChange.MarkAsAutoincrement(T.Columns["idinstmuserqualifies"], null, null, 0);
			RowChange.setMinimumTempValue(T.Columns["idinstmuserqualifies"], 9990000);
			//$Get_New_Row$
