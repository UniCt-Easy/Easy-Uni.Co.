...
namespace sortingservicefilter_default {
using System;
using System.Data;
...
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
public DataTable sortingservicefilter{get { return Tables["sortingservicefilter"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
public DataTable sortingservicefilterview{get { return Tables["sortingservicefilterview"];}}
...
//Primary Key
	...
	T.Columns.Add(new DataColumn("flagdalia", typeof(System.String), ""));
	Tables.Add(T);
//Primary Key
	key = new DataColumn[1]{
	T.Columns["idser"]};
	...
	T= new DataTable("sortingservicefilter");
	...
	T.Columns.Add(new DataColumn("jointolessspecifics", typeof(System.String), ""));
...
//Primary Key
	key = new DataColumn[1]{
	T.Columns["idautosort"]};
	T.PrimaryKey = key;

	T= new DataTable("sortingservicefilterview");
	T.Columns.Add(new DataColumn("idser", typeof(System.Int32), ""));
