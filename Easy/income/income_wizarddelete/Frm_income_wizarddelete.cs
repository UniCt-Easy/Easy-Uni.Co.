...
namespace income_wizarddelete {//entratawizardelimina//
	...
	public class Frm_income_wizarddelete : System.Windows.Forms.Form {
		...
		private void InitializeComponent() {
            ...
            this.label25.Text = "- Contabilizzazioni associate (iva). Nota: sar‡ cancellata solo la contabilizzazi" +
            ...
            this.label3.Text = "Nel secondo passo vi verranno mostrati tutti i movimenti che sono stati trovati e" +
                " vi sar‡ chiesta conferma di voler procedere nell\'operazione.";
            // 
            // label2
            // 
            ...
            this.label2.Text = "Nel primo passo vi verr‡ richiesto di selezionare un movimento di entrata, ";
            // 
            // label1
            // 
