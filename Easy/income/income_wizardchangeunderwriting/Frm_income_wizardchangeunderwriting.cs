...
namespace income_wizardchangeunderwriting {//spesawizardelimina//
	...
	public class Frm_income_wizardchangeunderwriting : System.Windows.Forms.Form {
		...
		private void InitializeComponent() {
            ...
            this.label3.Text = "Nel secondo passo vi verranno mostrati tutti i Finanziamenti utilizzabili e  sar‡" +
            ...
            this.label2.Text = " Nel primo passo vi verr‡ richiesto di selezionare un Accertamento tra quelli in " +
                "C/Competenza";
            // 
            // label1
            // 
        ...
        bool doAssocia () {
            ...
            {
                MessageBox.Show("Non Ë stato selezionato un finanziamento");
                return false;
            }
            if (DS.income.Rows.Count == 0) {
                MessageBox.Show("Non Ë stato selezionato nessun movimento finanziamento");
                return false;
            }
        ...
        {
            //Seleziona il finanziamento in modo diverso a seconda del Filtro su Disponibilit‡ Sufficiente
            ...
            if (chkFilterAvailable.Checked)
            {
                ...
                if (N == 0)
                {
                    MessageBox.Show("Non vi sono Finanziamenti con disponibilit‡ sufficiente");
                    return;
                }
