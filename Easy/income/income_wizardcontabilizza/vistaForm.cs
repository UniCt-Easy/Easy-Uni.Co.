...
namespace income_wizardcontabilizza {
using System;
using System.Data;
...
//Primary Key
	key = new DataColumn[3]{
	T.Columns["idexp"], 	T.Columns["nbracket"], 	T.Columns["taxcode"]};
	T.PrimaryKey = key;
...
Relations.Add(new DataRelation("estimate_incomeestimate",CPar,CChild));
