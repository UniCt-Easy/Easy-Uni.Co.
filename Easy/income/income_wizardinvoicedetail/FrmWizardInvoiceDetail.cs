    ...
    public class FrmWizardInvoiceDetail : System.Windows.Forms.Form {
        ...
        private void InitializeComponent() {
            ...
            this.label18.Text = "Selezionare i dettagli da contabilizzare (sono visualizzati solo i dettagli a cui" +
                                " è stato associato un UPB e il cui dettaglio  collegato non sia già stato incass" +
                                "ato)";
            // 
            // groupBox2
            // 
            ...
            this.labelAttenzione.Text = "Attenzione! Ci sono accertamenti che non hanno disponibilità sufficiente";
        ...
        void EliminaDettagliImpossibili() {
            ...
            foreach (DataRow InvDet in DSCopy.Tables["invoicedetail"].Rows) {
                ...
                InvDet["!idinctolink"] = DBNull.Value; //di default il dettaglio è da eliminare.
        ...
        void RecalcOperationsToDo() {
            ...
            foreach (DataRow InvDet in Details) {
                ...
                // Si predisponde già ad associare il dettaglio fattura con la corrispondente Incasso
                // Per il momento associa l'idinc dell'accertamento che contabilizza il dettaglio contratto, poi sarà
            ...
            /*if (ImportoResiduoSelezionato<importoDaIncassare){
				MetaFactory.factory.getSingleton<IMessageShower>().Show("L'importo da pagare è superiore al disponibile sugli impegni associati ai dettagli ordine");
				return;
			}*/

            //Tenterà di incassare, dettaglio per dettaglio, una porzione in base al totale specificato.
            ...
            if (totassegnato == 0) {
                MetaFactory.factory.getSingleton<IMessageShower>().Show("Non è stato possibile generare nessun incasso.");
                return;
            }
