...
private void initClass() {
	...
	tregistry.addBaseColumns("idreg","title","cf","p_iva","residence","annotation","birthdate","gender","surname","forename","foreigncf","active","ccp","flagbankitaliaproceeds","txt","rtf","cu","ct","lu","lt");
	Tables.Add(tregistry);
	tregistry.defineKey("idreg");

	//////////////////// INCOMEVAR /////////////////////////////////
	var tincomevar= new incomevarTable();
	tincomevar.addBaseColumns("idinc","nvar","yvar","description","amount","doc","docdate","adate","txt","rtf","cu","ct","lu","lt","transferkind","autokind","idinvkind","yinv","ninv","kproceedstransmission");
	...
	tinvoicekind.addBaseColumns("idinvkind","description","idsor01","idsor02","idsor03","idsor04","idsor05","cu","ct","lu","lt","active");
	...
	tincomeattachment.Columns.Add( new DataColumn("idfilestorage", typeof(string)));
