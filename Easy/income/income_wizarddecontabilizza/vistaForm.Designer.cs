...
namespace income_wizarddecontabilizza {
using System;
using System.Data;
...
this.SchemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
	...
	T.Columns.Add(new DataColumn("idreferencepaymethod", typeof(System.Int32), ""));
	Tables.Add(T);
//Primary Key
...
//Primary Key
	key = new DataColumn[3]{
	T.Columns["yman"], 	T.Columns["nman"], 	T.Columns["idexp"]};
	T.PrimaryKey = key;
...
CPar = new DataColumn[2]{TPar.Columns["yman"], TPar.Columns["nman"]};
CChild = new DataColumn[2]{TChild.Columns["yman"], TChild.Columns["nman"]};
