...
namespace meta_itinerationattachmentkind {
    /// <summary>
    /// Summary description for tipooperazioneiva.
    /// </summary>
    public class Meta_itinerationattachmentkind : Meta_easydata {
        public Meta_itinerationattachmentkind(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "itinerationattachmentkind") {
        ...
        protected override Form GetForm(string FormName) {
            if (FormName == "default") {
                ...
                return GetFormByDllName("itinerationattachmentkind_default");
            }
            return null;
        }
