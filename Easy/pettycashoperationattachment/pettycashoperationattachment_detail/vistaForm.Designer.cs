...
private void initClass() {
	...
	C.AllowDBNull=false;
	tpettycashoperationattachment.Columns.Add(C);
	tpettycashoperationattachment.Columns.Add( new DataColumn("idfilestorage", typeof(string)));
	...
	var cChild = new []{pettycashoperationattachment.Columns["idattachmentkind"]};
	Relations.Add(new DataRelation("attachmentkind_pettycashoperationattachment",cPar,cChild,false));
