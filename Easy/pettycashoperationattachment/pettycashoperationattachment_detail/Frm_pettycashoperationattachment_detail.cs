...
{
	public partial class Frm_pettycashoperationattachment_detail : MetaDataForm
    {
        MetaData Meta;
        public IOpenFileDialog openFileDialog1;
        public Frm_pettycashoperationattachment_detail()
		{
			InitializeComponent();
        ...
        public void MetaData_AfterFill(){
            DataRow R = DS.pettycashoperationattachment.Rows[0];
		...
		{
            if (Meta.IsEmpty) return;
            DataRow Curr = DS.pettycashoperationattachment.Rows[0];
