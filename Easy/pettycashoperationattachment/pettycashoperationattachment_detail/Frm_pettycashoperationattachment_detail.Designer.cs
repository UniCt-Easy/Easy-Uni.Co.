...
namespace pettycashoperationattachment_detail
{
	partial class Frm_pettycashoperationattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new pettycashoperationattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "pettycashoperationattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "pettycashoperationattachment.idattachmentkind";
			...
			// 
			// Frm_pettycashoperationattachment_detail
			// 
			...
			this.Name = "Frm_pettycashoperationattachment_detail";
			this.Text = "Frm_pettycashoperationattachment_detail";
