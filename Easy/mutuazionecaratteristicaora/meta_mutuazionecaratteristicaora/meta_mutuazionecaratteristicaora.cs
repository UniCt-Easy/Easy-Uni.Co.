...
{
    public class Meta_mutuazionecaratteristicaora : Meta_easydata 
	{
        public Meta_mutuazionecaratteristicaora(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "mutuazionecaratteristicaora") {
				Name = "Ore";
		...
		public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
			...
			RowChange.MarkAsAutoincrement(T.Columns["idmutuazionecaratteristicaora"], null, null, 0);
			RowChange.setMinimumTempValue(T.Columns["idmutuazionecaratteristicaora"], 9990000);
			//$Get_New_Row$
		...
		public override bool IsValid(DataRow R, out string errmess, out string errfield) {
			...
			switch (edit_type) {
				case "default": {
						...
						if (R["idmutuazionecaratteristicaora"].ToString().Trim() == "") {
							errmess = "Attenzione! Il campo 'Identificativo' è obbligatorio";
							errfield = "idmutuazionecaratteristicaora";
							return false;
						}
