...
namespace meta_mutuazionecaratteristicaora {
public class mutuazionecaratteristicaoraRow: MetaRow  {
	public mutuazionecaratteristicaoraRow(DataRowBuilder rb) : base(rb) {} 
	...
	public Int32? idmutuazionecaratteristicaora{ 
		get {if (this["idmutuazionecaratteristicaora"]==DBNull.Value)return null; return  (Int32?)this["idmutuazionecaratteristicaora"];}
		set {if (value==null) this["idmutuazionecaratteristicaora"]= DBNull.Value; else this["idmutuazionecaratteristicaora"]= value;}
	}
	public object idmutuazionecaratteristicaoraValue { 
		get{ return this["idmutuazionecaratteristicaora"];}
		set {if (value==null|| value==DBNull.Value) this["idmutuazionecaratteristicaora"]= DBNull.Value; else this["idmutuazionecaratteristicaora"]= value;}
	}
	public Int32? idmutuazionecaratteristicaoraOriginal { 
		get {if (this["idmutuazionecaratteristicaora",DataRowVersion.Original]==DBNull.Value)return null; return  (Int32?)this["idmutuazionecaratteristicaora",DataRowVersion.Original];}
	}
	///<summary>
	///Tipo
	///</summary>
...
public class mutuazionecaratteristicaoraTable : MetaTableBase<mutuazionecaratteristicaoraRow> {
	public mutuazionecaratteristicaoraTable() : base("mutuazionecaratteristicaora"){
		baseColumns = new Dictionary<string, DataColumn>(){
			...
			{"idmutuazionecaratteristicaora",createColumn("idmutuazionecaratteristicaora",typeof(int),false,false)},
