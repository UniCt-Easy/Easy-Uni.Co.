...
{
	partial class Frm_locationattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new locationattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "locationattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "locationattachment.idattachmentkind";
			...
			this.Name = "Frm_locationattachment_detail";
			this.Text = "Frm_locationattachment_detail";
