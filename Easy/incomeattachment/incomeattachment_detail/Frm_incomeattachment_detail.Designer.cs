...
namespace incomeattachment_detail
{
	partial class Frm_incomeattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new incomeattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "incomeattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "incomeattachment.idattachmentkind";
			...
			this.Name = "Frm_incomeattachment_detail";
			this.Text = "Frm_incomeattachment_detail";
