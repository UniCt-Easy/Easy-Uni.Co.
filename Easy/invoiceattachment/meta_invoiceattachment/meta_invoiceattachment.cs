    ...
    public class Meta_invoiceattachment : Meta_easydata {
        ...
        public override void DescribeColumns(DataTable T, string listtype) {
            ...
            if (listtype == "lista") {
                ...
                DescribeAColumn(T, "!attachmentkind", "Tipo Allegato", "invoiceattachmentkind.title", nPos++);
                DescribeAColumn(T, "!attachment_fe", "Invia in FE", "invoiceattachmentkind.attachment_fe", nPos++);
            }
        } 
