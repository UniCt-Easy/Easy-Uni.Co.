...
namespace invoiceattachment_default {
    partial class FrmInvoiceattachment_default {
        /// <summary>
        ...
        private void InitializeComponent() {
			...
			this.DS = new invoiceattachment_default.vistaForm();
			...
			this.btnCancel.Location = new System.Drawing.Point(470, 176);
			...
			this.btnOk.Location = new System.Drawing.Point(369, 176);
			...
			// labAutocertFileName
			// 
			this.labAutocertFileName.Location = new System.Drawing.Point(6, 25);
			this.labAutocertFileName.Name = "labAutocertFileName";
			this.labAutocertFileName.Size = new System.Drawing.Size(514, 16);
			this.labAutocertFileName.TabIndex = 75;
			this.labAutocertFileName.Tag = "invoiceattachment.filename";
			// 
			// btnVisualizza
			// 
			this.btnVisualizza.Location = new System.Drawing.Point(115, 138);
			...
			// btnAllega
			// 
			this.btnAllega.Location = new System.Drawing.Point(11, 138);
			...
			// cmbCodiceAllegato
			// 
			this.cmbCodiceAllegato.DataSource = this.DS.invoiceattachmentkind;
			...
			this.cmbCodiceAllegato.Tag = "invoiceattachment.idattachmentkind";
			...
			this.Name = "FrmInvoiceattachment_default";
			this.Text = "FrmInvoiceattachment_default";
