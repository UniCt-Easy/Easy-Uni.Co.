    ...
    public class Meta_provision : Meta_easydata{
        ...
        public override bool IsValid(DataRow R, out string errmess, out string errfield) {
            ...
            if (R["adate"] == DBNull.Value) {
                errmess = "Attenzione! Non Ë stata inserita la data contabile.";
                errfield = "adate";
                return false;
            }
            if (R["description"] == DBNull.Value) {
                errmess = "Attenzione! Non Ë stata inserita la descrizione del Fondo.";
                errfield = "description";
                return false;
            }
            if (R["title"] == DBNull.Value) {
                errmess = "Attenzione! Non Ë stata inserita la denominazione del Fondo.";
                errfield = "title";
                return false;
            }
            return true;
