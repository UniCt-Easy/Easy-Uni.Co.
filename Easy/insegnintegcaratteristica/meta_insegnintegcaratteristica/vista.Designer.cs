...
namespace meta_insegnintegcaratteristica {
public class insegnintegcaratteristicaRow: MetaRow  {
	public insegnintegcaratteristicaRow(DataRowBuilder rb) : base(rb) {} 
	...
	public Int32? idinsegnintegcaratteristica{ 
		get {if (this["idinsegnintegcaratteristica"]==DBNull.Value)return null; return  (Int32?)this["idinsegnintegcaratteristica"];}
		set {if (value==null) this["idinsegnintegcaratteristica"]= DBNull.Value; else this["idinsegnintegcaratteristica"]= value;}
	}
	public object idinsegnintegcaratteristicaValue { 
		get{ return this["idinsegnintegcaratteristica"];}
		set {if (value==null|| value==DBNull.Value) this["idinsegnintegcaratteristica"]= DBNull.Value; else this["idinsegnintegcaratteristica"]= value;}
	}
	public Int32? idinsegnintegcaratteristicaOriginal { 
		get {if (this["idinsegnintegcaratteristica",DataRowVersion.Original]==DBNull.Value)return null; return  (Int32?)this["idinsegnintegcaratteristica",DataRowVersion.Original];}
	}
	///<summary>
...
public class insegnintegcaratteristicaTable : MetaTableBase<insegnintegcaratteristicaRow> {
	public insegnintegcaratteristicaTable() : base("insegnintegcaratteristica"){
		baseColumns = new Dictionary<string, DataColumn>(){
			...
			{"idinsegnintegcaratteristica",createColumn("idinsegnintegcaratteristica",typeof(int),false,false)},
