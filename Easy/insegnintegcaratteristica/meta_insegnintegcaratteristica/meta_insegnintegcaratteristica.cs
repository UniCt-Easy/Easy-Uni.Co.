...
{
    public class Meta_insegnintegcaratteristica : Meta_easydata 
	{
        public Meta_insegnintegcaratteristica(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "insegnintegcaratteristica") {
				Name = "Caratteristiche degli insegnamenti integrandi";
		...
		public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
			...
			RowChange.MarkAsAutoincrement(T.Columns["idinsegnintegcaratteristica"], null, null, 0);
			RowChange.setMinimumTempValue(T.Columns["idinsegnintegcaratteristica"], 9990000);
			//$Get_New_Row$
		...
		public override bool IsValid(DataRow R, out string errmess, out string errfield) {
			...
			switch (edit_type) {
				case "default": {
						...
						if (R["idinsegninteg"].ToString().Trim() == "") {
							errmess = "Attenzione! Il campo 'Identificativo' è obbligatorio";
							errfield = "idinsegninteg";
							return false;
						}
						if (R["idinsegnintegcaratteristica"].ToString().Trim() == "") {
							errmess = "Attenzione! Il campo 'Identificativo' è obbligatorio";
							errfield = "idinsegnintegcaratteristica";
							return false;
						}
		...
		public override void DescribeColumns(DataTable T, string ListingType) {
			...
			switch (ListingType) {
				case "default": {
						...
						DescribeAColumn(T, "!idsasd_sasd_title", "Settore artistico scientifico disciplinare", nPos++);
