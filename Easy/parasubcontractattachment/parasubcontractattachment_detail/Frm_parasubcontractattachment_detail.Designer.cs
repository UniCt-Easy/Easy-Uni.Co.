...
{
	partial class Frm_parasubcontractattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new parasubcontractattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "parasubcontractattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "parasubcontractattachment.idattachmentkind";
			...
			// 
			// Frm_parasubcontractattachment_detail
			// 
			...
			this.Name = "Frm_parasubcontractattachment_detail";
			this.Text = "Frm_parasubcontractattachment_detail";
