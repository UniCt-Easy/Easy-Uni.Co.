...
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
public DataTable expenseclawback{get { return this.Tables["expenseclawback"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
...
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
public DataTable expensetaxcorrige{get { return this.Tables["expensetaxcorrige"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
public DataTable expensetaxofficial{get { return this.Tables["expensetaxofficial"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
...
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
public DataTable expensebill{get { return this.Tables["expensebill"];}}
...
this.EnforceConstraints = false;
	...
	Tables.Add(T);
	//Primary Key
	T.PrimaryKey =  new DataColumn[]{T.Columns["idexp"], T.Columns["iditineration"]};;
	...
	Tables.Add(T);
	//Primary Key
	T.PrimaryKey =  new DataColumn[]{T.Columns["iditineration"]};;
	...
	Tables.Add(T);
	//Primary Key
	T.PrimaryKey =  new DataColumn[]{T.Columns["idinc"], T.Columns["nvar"]};;
	...
	Tables.Add(T);
	//Primary Key
	T.PrimaryKey =  new DataColumn[]{T.Columns["idexp"], T.Columns["idclawback"]};;
	...
	Tables.Add(T);
	//Primary Key
	T.PrimaryKey =  new DataColumn[]{T.Columns["taxcode"], T.Columns["idexp"], T.Columns["nbracket"]};;
	...
	Tables.Add(T);
	//Primary Key
	T.PrimaryKey =  new DataColumn[]{T.Columns["idclawback"]};;
	...
	Tables.Add(T);
	//Primary Key
	T.PrimaryKey =  new DataColumn[]{T.Columns["idinvkind"], T.Columns["yinv"], T.Columns["ninv"], T.Columns["idexp"]};;
	...
	Tables.Add(T);
	//Primary Key
	T.PrimaryKey =  new DataColumn[]{T.Columns["idinvkind"], T.Columns["yinv"], T.Columns["ninv"], T.Columns["idinc"]};;
	...
	Tables.Add(T);
	//Primary Key
	T.PrimaryKey =  new DataColumn[]{T.Columns["idpayroll"], T.Columns["idexp"]};;
	...
	C= new DataColumn("movkind", typeof(System.Int16), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);

	Tables.Add(T);
	//Primary Key
	T.PrimaryKey =  new DataColumn[]{T.Columns["ycon"], T.Columns["idexp"], T.Columns["ncon"]};;
	...
	Tables.Add(T);
	//Primary Key
	T.PrimaryKey =  new DataColumn[]{T.Columns["ycon"], T.Columns["ncon"], T.Columns["idexp"]};;
	...
	Tables.Add(T);
	//Primary Key
	T.PrimaryKey =  new DataColumn[]{T.Columns["idmankind"], T.Columns["yman"], T.Columns["nman"], T.Columns["idexp"]};;
	...
	Tables.Add(T);
	//Primary Key
	T.PrimaryKey =  new DataColumn[]{T.Columns["idmankind"], T.Columns["yman"], T.Columns["nman"]};;
	...
	Tables.Add(T);
	//Primary Key
	T.PrimaryKey =  new DataColumn[]{T.Columns["idestimkind"], T.Columns["nestim"], T.Columns["yestim"], T.Columns["idinc"]};;
	...
	Tables.Add(T);
	//Primary Key
	T.PrimaryKey =  new DataColumn[]{T.Columns["idexp"], T.Columns["idexpensetaxcorrige"]};;

	T= new DataTable("expensetaxofficial");
	C= new DataColumn("idexp", typeof(System.Int32), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);

	C= new DataColumn("idexpensetaxofficial", typeof(System.Int32), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);
	...
	Tables.Add(T);
	//Primary Key
	T.PrimaryKey =  new DataColumn[]{T.Columns["idexp"], T.Columns["idexpensetaxofficial"]};;
	...
	Tables.Add(T);
	//Primary Key
	T.PrimaryKey =  new DataColumn[]{T.Columns["idexp"], T.Columns["ybill"], T.Columns["nbill"]};;
...
Relations.Add(new DataRelation("expense_expensebill",CPar,CChild));
...
TPar= Tables["expense"];
TChild= Tables["expensetaxofficial"];
CPar = new DataColumn[1]{TPar.Columns["idexp"]};
CChild = new DataColumn[1]{TChild.Columns["idexp"]};
Relations.Add(new DataRelation("expenseexpensetaxofficial",CPar,CChild));

TPar= Tables["tax"];
TChild= Tables["expensetaxofficial"];
CPar = new DataColumn[1]{TPar.Columns["taxcode"]};
CChild = new DataColumn[1]{TChild.Columns["taxcode"]};
Relations.Add(new DataRelation("taxexpensetaxofficial",CPar,CChild));

TPar= Tables["expense"];
TChild= Tables["expensetaxcorrige"];
CPar = new DataColumn[1]{TPar.Columns["idexp"]};
CChild = new DataColumn[1]{TChild.Columns["idexp"]};
Relations.Add(new DataRelation("expenseexpensetaxcorrige",CPar,CChild));

TPar= Tables["tax"];
TChild= Tables["expensetaxcorrige"];
CPar = new DataColumn[1]{TPar.Columns["taxcode"]};
CChild = new DataColumn[1]{TChild.Columns["taxcode"]};
Relations.Add(new DataRelation("taxexpensetaxcorrige",CPar,CChild));
...
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor"]};
Relations.Add(new DataRelation("sortingexpensesorted",CPar,CChild));
...
Relations.Add(new DataRelation("finproceedspart",CPar,CChild));
...
CPar = new DataColumn[1]{TPar.Columns["iditineration"]};
CChild = new DataColumn[1]{TChild.Columns["iditineration"]};
Relations.Add(new DataRelation("itineration_expenseitineration",CPar,CChild));
