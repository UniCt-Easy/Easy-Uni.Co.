    ...
    "i saranno suddivisi";
        ...
        void EliminaDettagliImpossibili() {
            ...
            foreach (DataRow InvDet in DSCopy.Tables["invoicedetail"].Rows) {
                ...
                InvDet["!idexptolink"] = DBNull.Value; //di default il dettaglio Ë da eliminare.
        ...
        void RecalcOperationsToDo() {
            ...
            foreach (DataRow InvDet in details) {
                ...
                // Si predisponde gi‡ ad associare il dettaglio fattura con la corrispondente liquidazione
                // Per il momento associa l'idexp dell'impegno che contabilizza il dettaglio ordine, poi sar‡
            ...
            //Tenter‡ di pagare, dettaglio per dettaglio, una porzione in base al totale specificato.
            ...
            if (totassegnato == 0) {
                MessageBox.Show("Non Ë stato possibile generare nessun pagamento.");
                return;
            }
            ...
            foreach (DataRow Liquid in LiquidazioniView.Rows) {
                ...
                for (int faseCorrente = faseinizio; faseCorrente <= fasefine; faseCorrente++) {
                    ...
                    if (faseCorrente == fasespesamax) {
                        ...
                        if (ModPagam == null) {
                            MessageBox.Show(
                                "E' necessario che sia definita almeno una modalit‡ di pagamento per il fornitore " +
                                "\"" + title + "\"\n\n" +
