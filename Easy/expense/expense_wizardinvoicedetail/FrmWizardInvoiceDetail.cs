...
namespace expense_wizardinvoicedetail {
    ...
    "i saranno suddivisi";
        ...
        void SetComboCausaleDocumento(DataRow Docum) {
            ...
            object currIdInvKind = Docum["idinvkind"];
            ...
            if ((Docum["flag_enable_split_payment"].ToString() == "S")&& (nVen > 0)&&(nAcq == 0)) {
                EnableDocum = false;
                EnableImpos = false;
            }
        ...
        void RecalcOperationsToDo() {
            ...
            if (totassegnato == 0) {
                show("Non è stato possibile generare nessun pagamento.");
                return;
            }
        ...
        bool doSave() {
            ...
            if (DS.registry.Select().Length == 0) return false;
            ...
            foreach (DataRow Liquid in LiquidazioniView.Rows) {
                ...
                if (DS.upb.Select(filterupb).Length == 0)  continue;
