...
namespace expense_wizardunlinkexpfrominc {//spesawizardelimina//
	...
	public class Frm_expense_wizardunlinkexpfrominc : System.Windows.Forms.Form {
		...
		private void InitializeComponent() {
            ...
            this.label22.Text = "Selezionare il movimento di entrata da scollegare. L\'eventuale reversale dovr‡ pr" +
            ...
            this.label3.Text = "Nel secondo passo vi verr‡ mostrato il pagamento collegato e vi verr‡ chiesta con" +
            ...
            this.label2.Text = " Nel primo passo vi verr‡ richiesto di selezionare un incasso. Se questo risulta " +
                "trasmesso non sar‡ possibile procedere, senza prima averlo rimosso dall\'elenco d" +
                "i trasmissione";
            // 
            // label1
            // 
		...
		bool GetExpense(){
            if (txtNmovExpense.Text.Trim() == "") {
                MessageBox.Show("Non Ë stato selezionato nessun movimento di spesa");
                return false;
            }
        ...
        string GetFilterIncome (bool IsNumMov) {
            ...
            // Se il form non viene utilizzato in modalit‡ Admin
            // Aggiungo il fitro sul tipo di automatismo che deve essere generico
            // non Ë necessario che l'anagrafica sia la stessa tra i due movimenti
            bool IsAdmin = false;
            if (Meta.GetSys("manage_prestazioni") != null)
                 IsAdmin = (Meta.GetSys("manage_prestazioni").ToString() == "S");
        ...
        bool doScollega () {
            if (DS.expense.Rows.Count == 0) {
                MessageBox.Show("Non Ë stato selezionato un movimento di spesa");
                return false;
            }
            if (DS.income.Rows.Count == 0) {
                MessageBox.Show("Non Ë stato selezionato un movimento di entrata");
                return false;
            }
