...
namespace meta_historypaymentview {
    class Meta_historypaymentview :Meta_easydata {
        public Meta_historypaymentview(DataAccess Conn,
                MetaDataDispatcher Dispatcher)
            :
                base(Conn, Dispatcher, "historypaymentview") {
            ListingTypes.Add("default");
            ListingTypes.Add("carico");
        }
        private string[] mykey = new string[] { "idexp" };
        ...
        public override void DescribeColumns(DataTable T, string listtype) {
            ...
            if (listtype == "default") {
                ...
                int nPos = 1;
                DescribeAColumn(T, "idexp", ".idspesa", nPos++);
