...
namespace expense_wizardinvoicedetailnomandate {
    public partial class FrmWizardInvoiceDetailNoMandate : Form {
        ...
        void SetNewLinkedMov() {
            ...
            AbilitaDisabilitaSelezioneMovimento(true);
            SelezioneMovimentiEffettuata = false;
            labMsgTODO1.Text = "Sar‡ creato un nuovo movimento di spesa";
            ...
            for (int faseCorrente = faseinizio; faseCorrente <= fasefine; faseCorrente++) {
                ...
                if (faseCorrente == fasespesamax) {
                    ...
                    if (NewLastMov["iddeputy"] != DBNull.Value && !avvisoDelegatoMostrato) {
                        ...
                        MessageBox.Show(
                            "Attenzione, l'anagrafica considerata Ë associata ad un delegato come modalit‡ di pagamento. Il pagamento sar‡ pertanto effettuato al delegato "
        ...
        void InsertNewDetail(DataRow Row, decimal taxable, decimal tax, decimal percindeduc) {
            ...
            rDT["nman"] = Row["nman"];
            rDT["yman"] = Row["yman"];
            rDT["idexp_taxable"] = Row["idexp_taxable"]; // contabilizzaione imponibile gi‡ effettuata
            rDT["idexp_iva"] = Row["idexp_iva"]; // contabilizzaione iva gi‡ effettuata
