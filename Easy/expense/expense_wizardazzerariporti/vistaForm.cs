...
private void initClass() {
	...
	C.AllowDBNull=false;
	tfinvar.Columns.Add(C);
	tfinvar.Columns.Add( new DataColumn("flagprevision", typeof(string)));
	tfinvar.Columns.Add( new DataColumn("flagcredit", typeof(string)));
	tfinvar.Columns.Add( new DataColumn("flagproceeds", typeof(string)));
	tfinvar.Columns.Add( new DataColumn("flagsecondaryprev", typeof(string)));
	Tables.Add(tfinvar);
	...
	C.AllowDBNull=false;
	texpenseview.Columns.Add(C);
	texpenseview.Columns.Add( new DataColumn("!realavailable", typeof(decimal)));
	...
	var cChild = new []{expense.Columns["nphase"]};
	...
	Relations.Add(new DataRelation("upb_finvardetail",cPar,cChild,false));

	cPar = new []{finvar.Columns["yvar"], finvar.Columns["nvar"]};
	cChild = new []{finvardetail.Columns["yvar"], finvardetail.Columns["nvar"]};
	Relations.Add(new DataRelation("finvar_finvardetail",cPar,cChild,false));

	cPar = new []{fin.Columns["idfin"]};
	cChild = new []{finvardetail.Columns["idfin"]};
	Relations.Add(new DataRelation("fin_finvardetail",cPar,cChild,false));
