...
namespace expense_clearprevphases//spesa_automatismiazzeramento//
{
	...
	/// </summary>
	public class Frm_expense_clearprevphases : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.Text = "Variazioni generate automaticamente per azzerare la disponibilit‡ delle fasi prec" +
				"edenti";
