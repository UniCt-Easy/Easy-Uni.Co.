...
namespace expense_wizardmandatedetail {
    ...
    /// </summary>
    public class FrmWizardMandateDetail : MetaDataForm {
        ...
        public void MetaData_AfterLink() {
            ...
            if (maxphase == 1) {
                GetData.SetStaticFilter(DS.mandatekind, QHS.AppAnd(QHS.CmpEq("active", "S") ,
                                                                   QHS.CmpEq("linktoinvoice", "N"),
                                                                   QHS.NullOrEq("isrequest","N")));
...
//			int faseordine = CfgFn.GetNoNullInt32(Meta.GetSys("mandatephase"));
        ...
        bool doSave() {
            DataSet DSP = DS.Copy();
            DSP.Tables["mandatedetail"]._safeMergeFromDb(Conn, q.keyCmp(DS.Tables["mandate"].Rows[0]));
            ...
            string newcomputesorting = Meta.Conn.DO_READ_VALUE("siopekind",
                                        QHS.AppAnd(QHS.CmpEq("codesorkind_siopespese", Meta.GetSys("codesorkind_siopespese")), QHS.CmpEq("ayear", CfgFn.GetNoNullInt32(Meta.GetSys("esercizio")))
                                            ),
            ...
            var metaMan = Meta.Dispatcher.Get("mandate");
            metaMan.DS = ga.dsAuto;

            var EPM = new EP_Manager(metaMan, null, null, null, null, null, null, null, null, "mandate");
...
//			Post.InitClass(DS,Conn);
        ...
        void InsertNewDetail(DataRow Row, decimal taxable, decimal tax, decimal percindeduc) {
            ...
            rDT["idaccmotiveannulment"] = Row["idaccmotiveannulment"];
        }
