...
private void initClass() {
	...
	tupb_income.Columns.Add( new DataColumn("idsor01", typeof(int)));
	tupb_income.Columns.Add( new DataColumn("idsor02", typeof(int)));
	tupb_income.Columns.Add( new DataColumn("idsor03", typeof(int)));
	tupb_income.Columns.Add( new DataColumn("idsor04", typeof(int)));
	tupb_income.Columns.Add( new DataColumn("idsor05", typeof(int)));
	...
	C.AllowDBNull=false;
	tmanager_income.Columns.Add(C);
	tmanager_income.Columns.Add( new DataColumn("idsor01", typeof(int)));
	tmanager_income.Columns.Add( new DataColumn("idsor02", typeof(int)));
	tmanager_income.Columns.Add( new DataColumn("idsor03", typeof(int)));
	tmanager_income.Columns.Add( new DataColumn("idsor04", typeof(int)));
	tmanager_income.Columns.Add( new DataColumn("idsor05", typeof(int)));
