...
public class expenseRow: MetaRow  {
	...
	///<summary>
	///id economia di spesa (idexp di expense) associata qualora questo movimento. Questo movimento ̬ valorizzato nella maschera ct_expenselast_reset (storno residui catania) e expense_wizardcreamovcompetenza (riemissione dei movimenti in competenza)
	///</summary>
	...
	///<summary>
	///impegno creato manualmente non legato a contabilizzaizone documenti
	///</summary>
	public Int32? flag{ 
