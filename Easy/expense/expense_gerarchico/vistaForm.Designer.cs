...
private void initClass() {
	...
	texpense.addBaseColumns("adate","ct","cu","description","doc","docdate","expiration","idreg","lt","lu","nmov","rtf","txt","ymov","idclawback","idman","nphase","idexp","parentidexp","idpayment","idformerexpense","autokind","autocode","cupcode","cigcode","external_reference","idinc_linked","flag");
	Tables.Add(texpense);
	...
	tregistry.addBaseColumns("idreg","title","cf","p_iva","residence","annotation","birthdate","gender","surname","forename","foreigncf","idregistryclass","active","txt","rtf","cu","ct","lu","lt");
	...
	texpensevar.addBaseColumns("nvar","idexp","yvar","description","amount","doc","autocode","autokind","idpayment","docdate","adate","txt","rtf","cu","ct","lu","lt","transferkind","idinvkind","ninv","yinv","kpaymenttransmission","idunderwriting","movkind");
	...
	tcasualcontract.addBaseColumns("ycon","ncon","idreg","idser","feegross","ct","cu","adate","stop","start","ndays","lt","lu","description","completed","idaccmotive","idsor1","idsor2","idsor3","idupb","idaccmotivedebit","idaccmotivedebit_crg","idsor01","idsor02","idsor03","idsor04","idsor05","idsor_siope","requested_doc");
	Tables.Add(tcasualcontract);
	tcasualcontract.defineKey("ycon", "ncon");

	//////////////////// PROFSERVICE /////////////////////////////////
	var tprofservice= new profserviceTable();
	tprofservice.addBaseColumns("ycon","ncon","socialsecurityrate","pensioncontributionrate","ivarate","idreg","idser","feegross","totalcost","totalgross","ct","cu","adate","stop","start","ndays","ivaamount","lt","lu","ivafieldnumber","description","idupb","doc","docdate","idaccmotivedebit","idaccmotivedebit_crg","idsor01","idsor02","idsor03","idsor04","idsor05","idinvkind","yinv","ninv","idsor_siope","requested_doc");
	...
	twageaddition.addBaseColumns("ycon","ncon","idreg","idser","feegross","ct","cu","adate","stop","start","description","ndays","lt","lu","completed","idaccmotive","idsor1","idsor2","idsor3","idupb","idaccmotivedebit","idaccmotivedebit_crg","idsor01","idsor02","idsor03","idsor04","idsor05","idsor_siope");
	...
	tbill.addBaseColumns("ybill","nbill","billkind","registry","covered","total","adate","active","motive","cu","ct","lu","lt","regularizationnote","idtreasurer");
	Tables.Add(tbill);
	...
	texpenseattachment.defineColumn("idfilestorage", typeof(string));
	...
	this.defineRelation("FK_mandatedetail_taxable_expenselastmandatedetail","mandatedetail_taxable","expenselastmandatedetail","idmankind","yman","nman","rownum");
	this.defineRelation("FK_mandatekind_expenselastmandatedetail","mandatekind","expenselastmandatedetail","idmankind");
	...
	this.defineRelation("wageadditionwageadditiontax","wageaddition","wageadditiontax","ycon","ncon");
	...
	Relations.Add(new DataRelation("income_linked_expense",cPar,cChild,false));
