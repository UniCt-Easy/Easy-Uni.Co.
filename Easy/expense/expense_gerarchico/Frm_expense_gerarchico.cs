...
namespace expense_gerarchico { //SpesaGerarchico//
	...
	/// </summary>
	public class Frm_expense_gerarchico : MetaDataForm {
		...
		private void InitializeComponent() {
			...
			this.gboxIncassoDettContratti.Location = new System.Drawing.Point(3, 206);
			this.gboxIncassoDettContratti.Name = "gboxIncassoDettContratti";
			this.gboxIncassoDettContratti.Size = new System.Drawing.Size(746, 295);
			this.gboxIncassoDettContratti.TabIndex = 71;
			...
			this.txtTotDettPagamenti.Location = new System.Drawing.Point(6, 267);
			...
			this.label30.Location = new System.Drawing.Point(6, 248);
			...
			this.gridDettPagamenti.Size = new System.Drawing.Size(635, 273);
			...
			this.tabFatture.Size = new System.Drawing.Size(757, 509);
			...
			this.gboxDettInvoice.Location = new System.Drawing.Point(3, 14);
    ...
    "ma che si sta versando";
			...
			this.tabAllegati.Size = new System.Drawing.Size(757, 509);
			...
			this.dataGridAllegati.Location = new System.Drawing.Point(7, 41);
			this.dataGridAllegati.Name = "dataGridAllegati";
			this.dataGridAllegati.ReadOnly = true;
			this.dataGridAllegati.Size = new System.Drawing.Size(742, 461);
			this.dataGridAllegati.TabIndex = 27;
			this.dataGridAllegati.Tag = "expenseattachment.lista.detail";
			// 
			// btnDelAtt
			// 
			this.btnDelAtt.Location = new System.Drawing.Point(198, 6);
			...
			// btnEditAtt
			// 
			this.btnEditAtt.Location = new System.Drawing.Point(102, 6);
			...
			// btnInsAtt
			// 
			this.btnInsAtt.Location = new System.Drawing.Point(7, 6);
...
//			txtNumMovBancario.ReadOnly		= !Meta.IsEmpty;
		...
		public void MetaData_BeforeFill() {
			...
			foreach (DataRow r in DS.expenselastmandatedetail.Select()) {
				DS.mandatedetail_pagamenti.safeMergeFromDb(MyConn,
		...
		void impostaFlagNonContabilizzazioneImpegno()
		{
			...
			if (rExpYear.idfin != null)
			{
				// Il flag sulla fase dell'impegno/accertamento non deve essere valorizzato quando:
		...
		void AggiornaBilancioResponsabile(DataRow UPB) {
			...
			if (filterprevU != lastfilterPrev) {
				if ((Meta.InsertMode) && (monofase)) {
					//lo fa perchè dopo si salva il filtro...
				...
				DataTable Previsione =
					Meta.Conn.SQLRunner("SELECT * from finview U join finusable F on F.idfin= U.idfin where " +
					                    filterprevU, true);
				//Escludo dal comportamento il monofase per il task 16413, perchè abbiamo precedentemente
...
//			}
		...
		void ReCalcImporto_Cedolino() {
			...
			if ((currphase > 1) && (importo > DisponibileDaFasePrecedente)) {
				show("Sarà effettuata una contabilizzazione parziale del cedolino poiché la " +
				                "disponibilità del movimento selezionato è inferiore a " + importo.ToString());
				importo = DisponibileDaFasePrecedente;
			}
		...
		void ReCalcImporto_Occasionale() {
			...
			if ((currphase > 1) && (importo > DisponibileDaFasePrecedente)) {
				show("Sarà effettuata una contabilizzazione parziale del contratto occasionale poiché la " +
				                "disponibilità del movimento selezionato è inferiore a " + importo.ToString());
				importo = DisponibileDaFasePrecedente;
			}
