...
namespace expense_gerarchico { //SpesaGerarchico//
    ...
    public class Frm_expense_gerarchico : System.Windows.Forms.Form {
        ...
        private void InitializeComponent() {
            ...
            // label27
            // 
            this.label27.Location = new System.Drawing.Point(11, 382);
            ...
            // textBox7
            // 
            this.textBox7.Location = new System.Drawing.Point(211, 385);
            ...
            // lblcig
            // 
            this.lblcig.Location = new System.Drawing.Point(206, 296);
            ...
            // txtcig
            // 
            this.txtcig.Location = new System.Drawing.Point(209, 322);
    ...
    "NS, Modello 770 ecc.";
            ...
            // 
            this.btnAggiornaCertificati.Location = new System.Drawing.Point(379, 336);
            ...
            this.grpCertificatiNecessari.Location = new System.Drawing.Point(7, 330);
            ...
            this.groupBox12.Size = new System.Drawing.Size(705, 297);
            ...
            // label26
            // 
            this.label26.Location = new System.Drawing.Point(528, 248);
            ...
            this.SubEntity_cmbChargeHandling.Location = new System.Drawing.Point(454, 270);
    ...
    "inite da precisi accordi con il Tesoriere";
            ...
            this.labBollette2.Location = new System.Drawing.Point(36, 39);
    ...
    "are una bolletta nella maschera principale";
            ...
            this.labBollette1.Location = new System.Drawing.Point(36, 14);
...
//			GeneraAutomatismiAfterPost();
        ...
        private void MovTree_BeforeSelect(object sender, System.Windows.Forms.TreeViewCancelEventArgs e) {
            if (!MovTree.Enabled) return;
            if (Meta.IsEmpty) return;
            if (Meta.curroperation != MetaData.mainoperations.none) {
                return;
            }
        ...
        */
        ...
        decimal GetIVANoteDiCredito() {
            ...
            if (CurrCausaleIva == 2) {
                filter = QHS.AppAnd(QHS.CmpEq("idexp_iva", Curr["idexp"]), QHS.BitSet("flag", 2));

            }

            if (CurrCausaleIva == 1) {
                filter = QHS.AppAnd(QHS.CmpEq("idexp_taxable", Curr["idexp"]), QHS.BitSet("flag", 2));
            ...
            foreach (DataRow R in invoicedetailview.Rows) {
                if (R.RowState == DataRowState.Deleted) continue;
                decimal R_imposta = CfgFn.GetNoNullDecimal(R["tax"]);
                imposta += CfgFn.RoundValuta(R_imposta * tassocambio);
            }
