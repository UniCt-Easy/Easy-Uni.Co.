...
namespace meta_f24ordinario {
	/// <summary>
	/// Summary description for Class1.
	/// </summary>
	public class Meta_f24ordinario : Meta_easydata {
		public Meta_f24ordinario(DataAccess Conn, MetaDataDispatcher Dispatcher) :
			base(Conn, Dispatcher, "f24ordinario") {
		...
		protected override Form GetForm(string FormName) {
			switch (FormName) {
				case "default": {
						...
						Name = "Modello F24 Ordinario da Liquidazioni";
						return MetaData.GetFormByDllName("f24ordinario_default");
					}
			}
			return null;
		}
		...
		public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
			RowChange.MarkAsAutoincrement(T.Columns["idf24ordinario"], null, null, 0);
		...
		public override void DescribeColumns(DataTable T, string ListingType) {
			...
			if (ListingType == "default") {
				...
				DescribeAColumn(T, "idf24ordinario", "Numero F24");
