                   ...
                   .then(function () {
                     ...
                     common.pageEventWaiter(mp, appMeta.EventEnum.showModalWindow).then(function () {
                        ...
                        if ($(".modal-footer .procedureMessage_btn_ignoreandsave").length) {
                         ...
                         if ($(".modal")) {
                             let button = $(".modal").find("button")[1];
                             if (button) {
                                 button.click();
                                 testHelper.log("Premuto ignora e salva");
                             }
                         }
                         //if ($(".modal-footer .bg-default")) {
                         //    let button = $(".modal-footer .bg-default").find("button")[1];
                         //    if (button) {
                         //        button.click();
                         //        testHelper.log("Premuto OK");
                         //    }
                         //}
                     });
