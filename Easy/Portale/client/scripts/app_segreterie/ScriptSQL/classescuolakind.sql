...
-- VERIFICA DI classescuolakind IN COLUMNTYPES --
DELETE FROM columntypes WHERE tablename = 'classescuolakind'
INSERT INTO columntypes (format,allownull,tablename,sqldeclaration,createuser,field,col_len,denynull,sqltype,systemtype,defaultvalue,col_scale,lastmoduser,col_precision,iskey) VALUES('','N','classescuolakind','nvarchar(50)','ASSISTENZA','idclassescuolakind','50','S','nvarchar','System.String','','','''ASSISTENZA''','','S')
GO

INSERT INTO columntypes (format,allownull,tablename,sqldeclaration,createuser,field,col_len,denynull,sqltype,systemtype,defaultvalue,col_scale,lastmoduser,col_precision,iskey) VALUES('','N','classescuolakind','int','ASSISTENZA','idcorsostudiokind','4','S','int','System.Int32','','','''ASSISTENZA''','','N')
GO

INSERT INTO columntypes (format,allownull,tablename,sqldeclaration,createuser,field,col_len,denynull,sqltype,systemtype,defaultvalue,col_scale,lastmoduser,col_precision,iskey) VALUES('','S','classescuolakind','int','ASSISTENZA','idcorsostudiolivello','4','N','int','System.Int32','','','''ASSISTENZA''','','N')
GO

INSERT INTO columntypes (format,allownull,tablename,sqldeclaration,createuser,field,col_len,denynull,sqltype,systemtype,defaultvalue,col_scale,lastmoduser,col_precision,iskey) VALUES('','N','classescuolakind','nvarchar(1024)','ASSISTENZA','title','1024','S','nvarchar','System.String','','','''ASSISTENZA''','','N')
GO

-- VERIFICA DI classescuolakind IN CUSTOMOBJECT --
IF EXISTS(select * from customobject where objectname = 'classescuolakind')
UPDATE customobject set isreal = 'S' where objectname = 'classescuolakind'
ELSE
INSERT INTO customobject (objectname, isreal) values('classescuolakind', 'S')
GO
