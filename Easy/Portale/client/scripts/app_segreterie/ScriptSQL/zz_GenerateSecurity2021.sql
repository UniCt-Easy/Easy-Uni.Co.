...
select * from [flowchart] where [codeflowchart] in ('SEGADM','SEGDOC','SEGAMM','SEGPRG','PERFADM')
...
IF NOT EXISTS(select * from [flowchart] where [idflowchart] = '212096')
INSERT INTO [flowchart]
           ([idflowchart]
           ,[address]
           ,[ayear]
...
IF NOT EXISTS(select * from [flowchart] where [idflowchart] = '212095')
INSERT INTO [flowchart]
           ([idflowchart]
           ,[address]
           ,[ayear]
...
--progetti
IF NOT EXISTS(select * from [flowchart] where [idflowchart] = '212098')
INSERT INTO [flowchart]
           ([idflowchart]
           ,[address]
           ,[ayear]
...
--performance
IF NOT EXISTS(select * from [flowchart] where [idflowchart] = '212094')
INSERT INTO [flowchart]
           ([idflowchart]
           ,[address]
           ,[ayear]
...
and not exists(select *  FROM [flowchartrestrictedfunction] fcrf  WHERE fcrf.idflowchart = '212096' and  fcrf.idrestrictedfunction = rf.idrestrictedfunction)
...
and not exists(select *  FROM [flowchartrestrictedfunction] fcrf  WHERE fcrf.idflowchart = '212095' and  fcrf.idrestrictedfunction = rf.idrestrictedfunction)
...
and not exists(select *  FROM [flowchartrestrictedfunction] fcrf  WHERE fcrf.idflowchart = '212099' and  fcrf.idrestrictedfunction = rf.idrestrictedfunction)
...
and not exists(select *  FROM [flowchartrestrictedfunction] fcrf  WHERE fcrf.idflowchart = '212094' and  fcrf.idrestrictedfunction = rf.idrestrictedfunction)
...
and not exists(select *  FROM [flowchartrestrictedfunction] fcrf  WHERE fcrf.idflowchart = '212098' and  fcrf.idrestrictedfunction = rf.idrestrictedfunction)
