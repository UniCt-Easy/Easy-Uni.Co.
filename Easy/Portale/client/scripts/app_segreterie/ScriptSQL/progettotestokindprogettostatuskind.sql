...
UPDATE [tabledescr] SET description = 'Stati in cui il testo è obbligatorio',idapplication = '3',isdbo = 'S',lt = {ts '2021-02-19 17:19:03.207'},lu = 'assistenza',title = 'Stati in cui il testo è obbligatorio' WHERE tablename = 'progettotestokindprogettostatuskind'
ELSE
INSERT INTO [tabledescr] (tablename,description,idapplication,isdbo,lt,lu,title) VALUES ('progettotestokindprogettostatuskind','Stati in cui il testo è obbligatorio','3','S',{ts '2021-02-19 17:19:03.207'},'assistenza','Stati in cui il testo è obbligatorio')
GO
