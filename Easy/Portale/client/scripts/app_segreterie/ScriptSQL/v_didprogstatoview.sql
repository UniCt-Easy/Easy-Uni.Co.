...
INSERT INTO columntypes (format,allownull,tablename,sqldeclaration,createuser,field,col_len,denynull,sqltype,systemtype,defaultvalue,col_scale,lastmoduser,col_precision,iskey) VALUES('','S','didprogstatoview','nvarchar(9)','ASSISTENZA','aa','9','N','nvarchar','System.String','','','''ASSISTENZA''','','N')
GO
...
INSERT INTO columntypes (format,allownull,tablename,sqldeclaration,createuser,field,col_len,denynull,sqltype,systemtype,defaultvalue,col_scale,lastmoduser,col_precision,iskey) VALUES('','N','didprogstatoview','nvarchar(1070)','ASSISTENZA','dropdown_title','1070','S','nvarchar','System.String','','','''ASSISTENZA''','','N')
GO
...
INSERT INTO columntypes (format,allownull,tablename,sqldeclaration,createuser,field,col_len,denynull,sqltype,systemtype,defaultvalue,col_scale,lastmoduser,col_precision,iskey) VALUES('','S','didprogstatoview','int','','sessione_idsessionekind','4','N','int','System.Int32','','','','','N')
GO
