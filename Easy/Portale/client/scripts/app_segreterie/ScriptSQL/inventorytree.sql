...
UPDATE [tabledescr] SET description = 'Classificazione inventariale',idapplication =3,isdbo = 'S',lt = {ts '1900-01-01 03:00:29.627'},lu = 'nino',title = 'Classificazione inventariale' WHERE tablename = 'inventorytree'
ELSE
