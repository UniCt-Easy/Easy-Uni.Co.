...
UPDATE [tabledescr] SET description = 'Istituti partner dei 2.5.15 Bandi per la mobilità internazionale
',idapplication = null,isdbo = 'N',lt = {ts '2018-07-27 11:17:15.907'},lu = 'assistenza',title = 'Istituti partner dei bandi per la mobilità internazionale' WHERE tablename = 'bandomiistitutiesteri'
ELSE
INSERT INTO [tabledescr] (tablename,description,idapplication,isdbo,lt,lu,title) VALUES ('bandomiistitutiesteri','Istituti partner dei 2.5.15 Bandi per la mobilità internazionale
',null,'N',{ts '2018-07-27 11:17:15.907'},'assistenza','Istituti partner dei bandi per la mobilità internazionale')
GO
...
UPDATE [relation] SET childtable = 'bandomiistitutiesteri',description = 'bando di mobilità internazionale di cui fanno parte ',lt = {ts '2018-07-27 11:17:34.593'},lu = 'assistenza',parenttable = 'bandomi',title = null WHERE idrelation = '3362'
ELSE
INSERT INTO [relation] (idrelation,childtable,description,lt,lu,parenttable,title) VALUES ('3362','bandomiistitutiesteri','bando di mobilità internazionale di cui fanno parte ',{ts '2018-07-27 11:17:34.593'},'assistenza','bandomi',null)
GO
