...
IF EXISTS(select * from sysobjects where id = object_id(N'[strutturaparentresponsabiliafferenzaview]') and OBJECTPROPERTY(id, N'IsView') = 1)
DROP VIEW [strutturaparentresponsabiliafferenzaview]
GO
