...
CREATE VIEW [rendicontattivitaprogettodocview] AS 
...
INSERT INTO columntypes (format,allownull,tablename,sqldeclaration,createuser,field,col_len,denynull,sqltype,systemtype,defaultvalue,col_scale,lastmoduser,col_precision,iskey) VALUES('','S','rendicontattivitaprogettodocview','date','','rendicontattivitaprogetto_stop','3','N','date','System.DateTime','','','','','N')
GO
