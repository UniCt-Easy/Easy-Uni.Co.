...
UPDATE [tabledescr] SET description = 'Tipi di ritenuta associati alla voce di costo della attività o progetto (modello)',idapplication = '3',isdbo = 'S',lt = {ts '2021-02-26 11:57:14.060'},lu = 'assistenza',title = 'Tipi di ritenuta associati' WHERE tablename = 'progettotipocostokindtax'
ELSE
INSERT INTO [tabledescr] (tablename,description,idapplication,isdbo,lt,lu,title) VALUES ('progettotipocostokindtax','Tipi di ritenuta associati alla voce di costo della attività o progetto (modello)','3','S',{ts '2021-02-26 11:57:14.060'},'assistenza','Tipi di ritenuta associati')
GO
