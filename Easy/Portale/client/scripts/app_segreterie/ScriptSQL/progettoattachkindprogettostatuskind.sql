...
UPDATE [tabledescr] SET description = 'Stati in cui l''allegato è obbligatorio',idapplication = '3',isdbo = 'S',lt = {ts '2021-02-19 17:21:33.010'},lu = 'assistenza',title = 'Stati in cui l''allegato è obbligatorio' WHERE tablename = 'progettoattachkindprogettostatuskind'
ELSE
INSERT INTO [tabledescr] (tablename,description,idapplication,isdbo,lt,lu,title) VALUES ('progettoattachkindprogettostatuskind','Stati in cui l''allegato è obbligatorio','3','S',{ts '2021-02-19 17:21:33.010'},'assistenza','Stati in cui l''allegato è obbligatorio')
GO
