...
INSERT INTO columntypes (format,allownull,tablename,sqldeclaration,createuser,field,col_len,denynull,sqltype,systemtype,defaultvalue,col_scale,lastmoduser,col_precision,iskey) VALUES('','N','diderogdefaultview','nvarchar(3255)','ASSISTENZA','dropdown_title','3255','S','nvarchar','System.String','','','''ASSISTENZA''','','N')
GO
