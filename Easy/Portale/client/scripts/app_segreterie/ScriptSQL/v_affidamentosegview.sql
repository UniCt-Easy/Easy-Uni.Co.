...
INSERT INTO columntypes (format,allownull,tablename,sqldeclaration,createuser,field,col_len,denynull,sqltype,systemtype,defaultvalue,col_scale,lastmoduser,col_precision,iskey) VALUES('','S','affidamentosegview','nvarchar(max)','','XXaffidamentocaratteristica','0','N','nvarchar','System.String','','','','','N')
GO
