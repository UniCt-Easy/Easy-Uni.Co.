...
-- CREAZIONE VISTA perfprogettoobiettivovalutazione_uoview
IF EXISTS(select * from sysobjects where id = object_id(N'[dbo].[perfprogettoobiettivovalutazione_uoview]') and OBJECTPROPERTY(id, N'IsView') = 1)
DROP VIEW [dbo].[perfprogettoobiettivovalutazione_uoview]
GO



CREATE VIEW [dbo].[perfprogettoobiettivovalutazione_uoview] AS 
