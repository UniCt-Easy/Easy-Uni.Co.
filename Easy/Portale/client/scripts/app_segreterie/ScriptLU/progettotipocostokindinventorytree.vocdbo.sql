...
UPDATE [tabledescr] SET description = 'Classificazione inventariale associata alla voce di costo del progetto o attività (modello)',idapplication = '3',isdbo = 'S',lt = {ts '2021-02-26 11:57:03.047'},lu = 'assistenza',title = 'Classificazione inventariale associata' WHERE tablename = 'progettotipocostokindinventorytree'
ELSE
INSERT INTO [tabledescr] (tablename,description,idapplication,isdbo,lt,lu,title) VALUES ('progettotipocostokindinventorytree','Classificazione inventariale associata alla voce di costo del progetto o attività (modello)','3','S',{ts '2021-02-26 11:57:03.047'},'assistenza','Classificazione inventariale associata')
GO
