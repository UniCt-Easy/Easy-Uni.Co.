...
UPDATE [tabledescr] SET description = 'Tipi di ritenuta associati alla voce di costo della attività o progetto',idapplication = '3',isdbo = 'N',lt = {ts '2021-02-19 16:54:30.267'},lu = 'assistenza',title = 'Tipi di ritenuta associati' WHERE tablename = 'progettotipocostotax'
ELSE
INSERT INTO [tabledescr] (tablename,description,idapplication,isdbo,lt,lu,title) VALUES ('progettotipocostotax','Tipi di ritenuta associati alla voce di costo della attività o progetto','3','N',{ts '2021-02-19 16:54:30.267'},'assistenza','Tipi di ritenuta associati')
GO
