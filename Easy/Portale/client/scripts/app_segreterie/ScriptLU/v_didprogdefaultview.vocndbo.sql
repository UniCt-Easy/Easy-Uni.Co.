...
INSERT INTO columntypes (format,allownull,tablename,sqldeclaration,createuser,field,col_len,denynull,sqltype,systemtype,defaultvalue,col_scale,lastmoduser,col_precision,iskey) VALUES('','S','didprogdefaultview','nvarchar(9)','ASSISTENZA','aa','9','N','nvarchar','System.String','','','''ASSISTENZA''','','N')
GO
...
INSERT INTO columntypes (format,allownull,tablename,sqldeclaration,createuser,field,col_len,denynull,sqltype,systemtype,defaultvalue,col_scale,lastmoduser,col_precision,iskey) VALUES('','N','didprogdefaultview','nvarchar(2103)','ASSISTENZA','dropdown_title','2103','S','nvarchar','System.String','','','''ASSISTENZA''','','N')
GO
...
INSERT INTO columntypes (format,allownull,tablename,sqldeclaration,createuser,field,col_len,denynull,sqltype,systemtype,defaultvalue,col_scale,lastmoduser,col_precision,iskey) VALUES('','S','didprogdefaultview','varchar(64)','','geo_nationlang_lang','64','N','varchar','System.String','','','','','N')
GO

INSERT INTO columntypes (format,allownull,tablename,sqldeclaration,createuser,field,col_len,denynull,sqltype,systemtype,defaultvalue,col_scale,lastmoduser,col_precision,iskey) VALUES('','S','didprogdefaultview','varchar(64)','','geo_nationlang2_lang','64','N','varchar','System.String','','','','','N')
GO

INSERT INTO columntypes (format,allownull,tablename,sqldeclaration,createuser,field,col_len,denynull,sqltype,systemtype,defaultvalue,col_scale,lastmoduser,col_precision,iskey) VALUES('','S','didprogdefaultview','varchar(64)','','geo_nationlangvis_lang','64','N','varchar','System.String','','','','','N')
GO
...
INSERT INTO columntypes (format,allownull,tablename,sqldeclaration,createuser,field,col_len,denynull,sqltype,systemtype,defaultvalue,col_scale,lastmoduser,col_precision,iskey) VALUES('','S','didprogdefaultview','int','','sessione_idsessionekind','4','N','int','System.Int32','','','','','N')
GO
