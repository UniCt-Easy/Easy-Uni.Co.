...
INSERT INTO columntypes (format,allownull,tablename,sqldeclaration,createuser,field,col_len,denynull,sqltype,systemtype,defaultvalue,col_scale,lastmoduser,col_precision,iskey) VALUES('','S','getregistrydocentiamministrativi','varchar(40)','Generator','extmatricula','40','N','varchar','System.String','','','','','N')
GO
