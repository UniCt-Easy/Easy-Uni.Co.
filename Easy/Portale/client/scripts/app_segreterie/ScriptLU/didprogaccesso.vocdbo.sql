...
UPDATE [tabledescr] SET description = 'Elenco delle 2.4.1 Didattica programmata a cui il test di ingresso da acesso',idapplication = '2',isdbo = 'S',lt = {ts '2021-02-19 15:28:27.150'},lu = 'assistenza',title = 'Elenco delle didattiche programmate a cui il test di ingresso da acesso' WHERE tablename = 'didprogaccesso'
ELSE
INSERT INTO [tabledescr] (tablename,description,idapplication,isdbo,lt,lu,title) VALUES ('didprogaccesso','Elenco delle 2.4.1 Didattica programmata a cui il test di ingresso da acesso','2','S',{ts '2021-02-19 15:28:27.150'},'assistenza','Elenco delle didattiche programmate a cui il test di ingresso da acesso')
GO
