    ...
    CodiceFiscale.prototype = {
        ...
        DataNascita: function (esercizio, codicefiscale) {
            ...
            try {
                ...
                if (mese == 0) {
                    outobj.errMessage = "Lettera relativa al mese di nascita non valida";
                    return outobj;
                }
         ...
         */
        computes_codice_fiscale:function(name, surname, gender, day, month, year, bornPlace) {
            var cf =
                this.computes_surname_code(surname) +
                this.computes_name_code(name) +
                this.computes_birthdate_code(day, month, year, gender) +
                this.computes_comune_code(bornPlace);
        ...
        reverse_codice_fiscale:function(cf) {
            ...
            var birthplace = _.find(this.codici_catastali, function(item, key) {return key === cc;});
