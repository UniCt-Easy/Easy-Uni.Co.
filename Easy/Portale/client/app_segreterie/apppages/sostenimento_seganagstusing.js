(function () {
    ...
    function metaPage_sostenimento() {
		MetaPage.apply(this, ['sostenimento', 'seganagstusing', true]);
    ...
    metaPage_sostenimento.prototype = _.extend(
        new MetaPage(),
        {
			...
			beforeFill: function () {
				...
				//parte asincrona
				var def = appMeta.Deferred("beforeFill-sostenimento_seganagstusing");
				var arraydef = [];
			...
			afterFill: function () {
				...
				this.enableControl($('#sostenimento_seganagstusing_protanno'), false);
				//afterFillin
	...
	window.appMeta.addMetaPage('sostenimento', 'seganagstusing', metaPage_sostenimento);
