        ...
        new MetaPage(),
        {
			...
			beforeFill: function () {
				...
				if (this.state.isSearchState()) {
					this.helpForm.filter($('#sostenimento_seganagstustato_idreg'), null);
				} else {
					this.helpForm.filter($('#sostenimento_seganagstustato_idreg'), this.q.eq('registry_active', 'Si'));
				}
				//beforeFillFilter
			...
			afterClear: function () {
				//parte sincrona
				this.enableControl($('#sostenimento_seganagstustato_idprova'), true);
				this.enableControl($('#sostenimento_seganagstustato_idreg'), true);
				this.helpForm.filter($('#sostenimento_seganagstustato_idreg'), null);
				this.enableControl($('#sostenimento_seganagstustato_protnumero'), true);
				this.enableControl($('#sostenimento_seganagstustato_protanno'), true);
				//afterClearin
			...
			afterRowSelect: function (t, r) {
				...
				$('#sostenimento_seganagstustato_idprova').prop("disabled", (this.state.isEditState() || this.haveChildren()) && this.state.currentRow.idprova);
				$('#sostenimento_seganagstustato_idprova').prop("readonly", (this.state.isEditState() || this.haveChildren()) && this.state.currentRow.idprova);
				$('#sostenimento_seganagstustato_idreg').prop("disabled", (this.state.isEditState() || this.haveChildren()) && this.state.currentRow.idreg);
				$('#sostenimento_seganagstustato_idreg').prop("readonly", (this.state.isEditState() || this.haveChildren()) && this.state.currentRow.idreg);
				//afterRowSelectin
				return def.resolve();
			},
