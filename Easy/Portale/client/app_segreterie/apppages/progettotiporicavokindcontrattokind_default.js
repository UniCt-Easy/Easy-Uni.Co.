    ...
    metaPage_progettotiporicavokindcontrattokind.prototype = _.extend(
        new MetaPage(),
        {
			...
			afterRowSelect: function (t, r) {
				...
				$('#progettotiporicavokindcontrattokind_default_idcontrattokind').prop("disabled", this.state.isEditState() || this.haveChildren());
				$('#progettotiporicavokindcontrattokind_default_idcontrattokind').prop("readonly", this.state.isEditState() || this.haveChildren());
				//afterRowSelectin
				return def.resolve();
			},
			...
			insertClick: function (that, grid) {
				if (!$('#progettotiporicavokindcontrattokind_default_idcontrattokind').val() && this.children.includes(grid.dataSourceName)) {
