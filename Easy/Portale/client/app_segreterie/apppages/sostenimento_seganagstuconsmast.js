    ...
    metaPage_sostenimento.prototype = _.extend(
        new MetaPage(),
        {
			...
			afterRowSelect: function (t, r) {
				...
				$('#sostenimento_seganagstuconsmast_idprova').prop("disabled", this.state.isEditState() || this.haveChildren());
				$('#sostenimento_seganagstuconsmast_idprova').prop("readonly", this.state.isEditState() || this.haveChildren());
				$('#sostenimento_seganagstuconsmast_idreg').prop("disabled", this.state.isEditState() || this.haveChildren());
				$('#sostenimento_seganagstuconsmast_idreg').prop("readonly", this.state.isEditState() || this.haveChildren());
				//afterRowSelectin
				return def.resolve();
			},
