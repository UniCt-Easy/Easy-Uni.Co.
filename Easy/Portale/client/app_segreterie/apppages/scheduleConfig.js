    ...
    scheduleConfig.prototype = {
        ...
        show: function () {
            ...
            if (this.chooseProject) {
                ...
                //recupero le sospensioni del soggetto schedulato
                this.metaPage.getSospensioniMembro(parseInt(this.metaPage.state.currentRow.idreg))
                    .then(function (dt) {
                        self.dtSospensioni = dt;
                    });
        ...
        getHoursToSchedule: function (date, hourDurataLezione, log) {
            ...
            //controllo le sospensioni di istituto
            ...
            //controllo le sospensioni del soggetto
            if (this.dtSospensioni && isSospensione == false) {
                // torna true se ricade fuori dalla sospensione
                isSospensione = !_.every(this.dtSospensioni.rows, function (rowSosp) {
                    if (rowSosp.start && rowSosp.stop) return !(date.isSameOrAfter(moment(rowSosp.start)) && date.isSameOrBefore(moment(rowSosp.stop)));
                    return true;
                });
            }
