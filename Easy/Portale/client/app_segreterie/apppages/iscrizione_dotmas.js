...
(function () {
    ...
    function metaPage_iscrizione() {
		MetaPage.apply(this, ['iscrizione', 'dotmas', true]);
        ...
        new MetaPage(),
        {
			...
			beforeFill: function () {
				...
				if (this.state.isSearchState()) {
					...
					this.helpForm.filter($('#iscrizione_dotmas_idreg'), this.q.eq('registry_active', 'Si'));
				}
				//beforeFillFilter
				
				//parte asincrona
				var def = appMeta.Deferred("beforeFill-iscrizione_dotmas");
				var arraydef = [];
			...
			insertClick: function (that, grid) {
				if (!$('#iscrizione_dotmas_idreg').val() && this.children.includes(grid.dataSourceName)) {
	...
	window.appMeta.addMetaPage('iscrizione', 'dotmas', metaPage_iscrizione);
