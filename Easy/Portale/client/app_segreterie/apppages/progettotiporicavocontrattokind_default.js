    ...
    metaPage_progettotiporicavocontrattokind.prototype = _.extend(
        new MetaPage(),
        {
			...
			afterRowSelect: function (t, r) {
				...
				$('#progettotiporicavocontrattokind_default_idcontrattokind').prop("disabled", this.state.isEditState() || this.haveChildren());
				$('#progettotiporicavocontrattokind_default_idcontrattokind').prop("readonly", this.state.isEditState() || this.haveChildren());
				//afterRowSelectin
				return def.resolve();
			},
			...
			insertClick: function (that, grid) {
				if (!$('#progettotiporicavocontrattokind_default_idcontrattokind').val() && this.children.includes(grid.dataSourceName)) {
