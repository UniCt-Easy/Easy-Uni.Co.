(function () {
    ...
    function metaPage_nullaosta() {
		MetaPage.apply(this, ['nullaosta', 'segistrin', true]);
        this.name = 'Nullaosta';
		this.defaultListType = 'segistrin';
    ...
    metaPage_nullaosta.prototype = _.extend(
        new MetaPage(),
        {
			...
			beforeFill: function () {
				...
				//parte asincrona
				var def = appMeta.Deferred("beforeFill-nullaosta_segistrin");
				var arraydef = [];
			...
			afterFill: function () {
				this.enableControl($('#nullaosta_segistrin_protnumero'), false);
				this.enableControl($('#nullaosta_segistrin_protanno'), false);
				//afterFillin
	...
	window.appMeta.addMetaPage('nullaosta', 'segistrin', metaPage_nullaosta);
