...
(function () {
    ...
    function metaPage_sostenimento() {
		MetaPage.apply(this, ['sostenimento', 'ingresso', true]);
    ...
    metaPage_sostenimento.prototype = _.extend(
        new MetaPage(),
        {
			...
			beforeFill: function () {
				...
				//parte asincrona
				var def = appMeta.Deferred("beforeFill-sostenimento_ingresso");
				var arraydef = [];
			...
			afterFill: function () {
				...
				this.enableControl($('#sostenimento_ingresso_protanno'), false);
				//afterFillin
			...
			insertClick: function (that, grid) {
				if (!$('#sostenimento_ingresso_idreg').val() && this.children.includes(grid.dataSourceName)) {
	...
	window.appMeta.addMetaPage('sostenimento', 'ingresso', metaPage_sostenimento);
