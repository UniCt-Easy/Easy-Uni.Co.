(function() {
    ...
    function meta_didprogcurrcaratteristica() {
        MetaData.apply(this, ["didprogcurrcaratteristica"]);
        this.name = 'meta_didprogcurrcaratteristica';
    }

    meta_didprogcurrcaratteristica.prototype = _.extend(
        new MetaData(),
        {
            constructor: meta_didprogcurrcaratteristica,
...
//$innerSetCaptionConfig$
			...
			getNewRow: function (parentRow, dt, editType){
               var def = appMeta.Deferred("getNewRow-meta_didprogcurrcaratteristica");

				//$getNewRowInside$

				dt.autoIncrement('iddidprogcurrcaratteristica', { minimum: 99990001 });
    ...
    window.appMeta.addMeta('didprogcurrcaratteristica', new meta_didprogcurrcaratteristica('didprogcurrcaratteristica'));
