        ...
        new MetaData(),
        {
			...
			describeColumns: function (table, listType) {
				...
				switch (listType) {
					...
					case 'default':
						this.describeAColumn(table, 'idreg_aziende', 'Ente promotore', null, 10, null);
						...
						this.describeAColumn(table, '!idreg_aziende_registry_pic', 'Participant Identification Code (PIC)', null, 22, null);
