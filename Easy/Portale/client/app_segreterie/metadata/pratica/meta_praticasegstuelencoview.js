...
(function() {
    ...
    function meta_praticasegstuelencoview() {
        MetaData.apply(this, ["praticasegstuelencoview"]);
        this.name = 'meta_praticasegstuelencoview';
    }

    meta_praticasegstuelencoview.prototype = _.extend(
        new MetaData(),
        {
            constructor: meta_praticasegstuelencoview,
...
//$objCalcFieldConfig$
    ...
    window.appMeta.addMeta('praticasegstuelencoview', new meta_praticasegstuelencoview('praticasegstuelencoview'));
