(function() {
    ...
    function meta_ratakind() {
        MetaData.apply(this, ["ratakind"]);
        this.name = 'meta_ratakind';
    }

    meta_ratakind.prototype = _.extend(
        new MetaData(),
        {
            constructor: meta_ratakind,
...
//$objCalcFieldConfig$
    ...
    window.appMeta.addMeta('ratakind', new meta_ratakind('ratakind'));
