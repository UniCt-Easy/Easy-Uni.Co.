			...
			describeColumns: function (table, listType) {
				...
				switch (listType) {
					...
					case 'seganagstuacc':
						...
						this.describeAColumn(table, 'didprog_title', 'Denominazione Prova di accesso', null, 5100, 1024);
						this.describeAColumn(table, 'didprog_aa', 'Anno accademico Prova di accesso', null, 5200, 9);
