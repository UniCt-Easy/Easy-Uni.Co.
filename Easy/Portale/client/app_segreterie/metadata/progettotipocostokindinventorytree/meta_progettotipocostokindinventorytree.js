...
(function() {
    ...
    function meta_progettotipocostokindinventorytree() {
        MetaData.apply(this, ["progettotipocostokindinventorytree"]);
        this.name = 'meta_progettotipocostokindinventorytree';
    }

    meta_progettotipocostokindinventorytree.prototype = _.extend(
        new MetaData(),
        {
            constructor: meta_progettotipocostokindinventorytree,
...
//$objCalcFieldConfig$
			...
			getNewRow: function (parentRow, dt, editType){
               var def = appMeta.Deferred("getNewRow-meta_progettotipocostokindinventorytree");
    ...
    window.appMeta.addMeta('progettotipocostokindinventorytree', new meta_progettotipocostokindinventorytree('progettotipocostokindinventorytree'));
