(function() {
    ...
    function meta_progettotipocostokindtax() {
        MetaData.apply(this, ["progettotipocostokindtax"]);
        this.name = 'meta_progettotipocostokindtax';
    }

    meta_progettotipocostokindtax.prototype = _.extend(
        new MetaData(),
        {
            constructor: meta_progettotipocostokindtax,
...
//$objCalcFieldConfig$
			...
			getNewRow: function (parentRow, dt, editType){
               var def = appMeta.Deferred("getNewRow-meta_progettotipocostokindtax");
    ...
    window.appMeta.addMeta('progettotipocostokindtax', new meta_progettotipocostokindtax('progettotipocostokindtax'));
