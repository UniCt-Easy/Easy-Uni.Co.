(function() {
    ...
    function meta_bandomididprogfrom() {
        MetaData.apply(this, ["bandomididprogfrom"]);
        this.name = 'meta_bandomididprogfrom';
    }

    meta_bandomididprogfrom.prototype = _.extend(
        new MetaData(),
        {
            constructor: meta_bandomididprogfrom,
...
//$objCalcFieldConfig$
			...
			getNewRow: function (parentRow, dt, editType){
               var def = appMeta.Deferred("getNewRow-meta_bandomididprogfrom");
    ...
    window.appMeta.addMeta('bandomididprogfrom', new meta_bandomididprogfrom('bandomididprogfrom'));
