(function () {
    ...
    function metaPage_graduatoriaesiti() {
		MetaPage.apply(this, ['graduatoriaesiti', 'default', true]);
...
;
				...
				//parte asincrona
				var def = appMeta.Deferred("afterGetFormData-graduatoriaesiti_default");
				var arraydef = [];
	...
	window.appMeta.addMetaPage('graduatoriaesiti', 'default', metaPage_graduatoriaesiti);
