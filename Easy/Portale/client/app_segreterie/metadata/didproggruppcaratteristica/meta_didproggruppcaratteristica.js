...
(function() {
    ...
    function meta_didproggruppcaratteristica() {
        MetaData.apply(this, ["didproggruppcaratteristica"]);
        this.name = 'meta_didproggruppcaratteristica';
    }

    meta_didproggruppcaratteristica.prototype = _.extend(
        new MetaData(),
        {
            constructor: meta_didproggruppcaratteristica,
			...
			describeColumns: function (table, listType) {
				...
				switch (listType) {
					...
					case 'default':
						...
						this.describeAColumn(table, 'profess', 'Professionalizzante', null, 70, null);
...
//$innerSetCaptionConfig$
			...
			getNewRow: function (parentRow, dt, editType){
               var def = appMeta.Deferred("getNewRow-meta_didproggruppcaratteristica");

				//$getNewRowInside$

				dt.autoIncrement('iddidproggruppcaratteristica', { minimum: 99990001 });
    ...
    window.appMeta.addMeta('didproggruppcaratteristica', new meta_didproggruppcaratteristica('didproggruppcaratteristica'));
