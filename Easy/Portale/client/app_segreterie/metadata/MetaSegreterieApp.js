(function () {
    ...
    MetaSegreterieApp.prototype = Object.create(MetaApp.prototype);
    // Aggiungi poi i metodi specifici di MetaSegreterieApp
    _.extend(MetaSegreterieApp.prototype, {
    ...
    //A differenza di quella originale non la cerco nella cache dell'applicativo.
    //Disabilito anche la cache del browser che di default è true.
