(function() {
    ...
    function meta_istanzaimm_segview() {
        MetaData.apply(this, ["istanzaimm_segview"]);
        this.name = 'meta_istanzaimm_segview';
    }

    meta_istanzaimm_segview.prototype = _.extend(
        new MetaData(),
        {
            constructor: meta_istanzaimm_segview,
...
//$objCalcFieldConfig$
    ...
    window.appMeta.addMeta('istanzaimm_segview', new meta_istanzaimm_segview('istanzaimm_segview'));
