...
(function() {
    ...
    function meta_geo_citysegview() {
        MetaData.apply(this, ["geo_citysegview"]);
        this.name = 'meta_geo_citysegview';
    }

    meta_geo_citysegview.prototype = _.extend(
        new MetaData(),
        {
            constructor: meta_geo_citysegview,
			...
			describeColumns: function (table, listType) {
				...
				switch (listType) {
					...
					case 'seg':
						...
						this.describeAColumn(table, 'geo_country_title', 'Provincia', null, 30, 50);
...
//$objCalcFieldConfig$
    ...
    window.appMeta.addMeta('geo_citysegview', new meta_geo_citysegview('geo_citysegview'));
