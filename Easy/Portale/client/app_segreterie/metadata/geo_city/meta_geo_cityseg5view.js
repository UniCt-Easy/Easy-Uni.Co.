(function() {
    ...
    function meta_geo_cityseg5view() {
        MetaData.apply(this, ["geo_cityseg5view"]);
        this.name = 'meta_geo_cityseg5view';
    }

    meta_geo_cityseg5view.prototype = _.extend(
        new MetaData(),
        {
            constructor: meta_geo_cityseg5view,
			...
			describeColumns: function (table, listType) {
				...
				switch (listType) {
					...
					case 'seg5':
						...
						this.describeAColumn(table, 'geo_city_1_title', 'id nuovo comune in cui questo è eventualmente confluito, se valorizzato questo comune non ? pi? valido', null, 40, 65);
...
//$objCalcFieldConfig$
    ...
    window.appMeta.addMeta('geo_cityseg5view', new meta_geo_cityseg5view('geo_cityseg5view'));
