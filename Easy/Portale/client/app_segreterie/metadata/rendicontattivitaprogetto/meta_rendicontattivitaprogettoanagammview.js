(function() {
    ...
    function meta_rendicontattivitaprogettoanagammview() {
        MetaData.apply(this, ["rendicontattivitaprogettoanagammview"]);
        this.name = 'meta_rendicontattivitaprogettoanagammview';
    }

    meta_rendicontattivitaprogettoanagammview.prototype = _.extend(
        new MetaData(),
        {
            constructor: meta_rendicontattivitaprogettoanagammview,
...
//$objCalcFieldConfig$
    ...
    window.appMeta.addMeta('rendicontattivitaprogettoanagammview', new meta_rendicontattivitaprogettoanagammview('rendicontattivitaprogettoanagammview'));
