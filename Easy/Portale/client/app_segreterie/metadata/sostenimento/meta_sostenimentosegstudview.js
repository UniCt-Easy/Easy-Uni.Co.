(function() {
    ...
    function meta_sostenimentosegstudview() {
        MetaData.apply(this, ["sostenimentosegstudview"]);
        this.name = 'meta_sostenimentosegstudview';
    }

    meta_sostenimentosegstudview.prototype = _.extend(
        new MetaData(),
        {
            constructor: meta_sostenimentosegstudview,
...
//$objCalcFieldConfig$
			...
			primaryKey: function () {
				return ["idreg", "iddidprog", "idattivform", "idiscrizione", "idcorsostudio", "idsostenimento"];
			},
    ...
    window.appMeta.addMeta('sostenimentosegstudview', new meta_sostenimentosegstudview('sostenimentosegstudview'));
