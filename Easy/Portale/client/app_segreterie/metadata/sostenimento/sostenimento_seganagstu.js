(function () {
    ...
    function metaPage_sostenimento() {
		MetaPage.apply(this, ['sostenimento', 'seganagstu', true]);
    ...
    metaPage_sostenimento.prototype = _.extend(
        new MetaPage(),
        {
			...
			beforeFill: function () {
				...
				//parte asincrona
				var def = appMeta.Deferred("beforeFill-sostenimento_seganagstu");
				var arraydef = [];
			...
			afterClear: function () {
				//parte sincrona
				this.enableControl($('#sostenimento_seganagstu_protanno'), true);
				//afterClearin
			...
			afterFill: function () {
				this.enableControl($('#sostenimento_seganagstu_protanno'), false);
				//afterFillin
	...
	window.appMeta.addMetaPage('sostenimento', 'seganagstu', metaPage_sostenimento);
