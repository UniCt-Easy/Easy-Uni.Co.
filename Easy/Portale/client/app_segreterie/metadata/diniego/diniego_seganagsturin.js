(function () {
    ...
    function metaPage_diniego() {
		MetaPage.apply(this, ['diniego', 'seganagsturin', true]);
        this.name = 'Diniego';
		this.defaultListType = 'seganagsturin';
    ...
    metaPage_diniego.prototype = _.extend(
        new MetaPage(),
        {
			...
			afterGetFormData: function () {
				...
				//parte asincrona
				var def = appMeta.Deferred("afterGetFormData-diniego_seganagsturin");
				var arraydef = [];
			...
			afterClear: function () {
				//parte sincrona
				this.enableControl($('#diniego_seganagsturin_protanno'), true);
				this.enableControl($('#diniego_seganagsturin_protnumero'), true);
				//afterClearin
			...
			afterFill: function () {
				this.enableControl($('#diniego_seganagsturin_protanno'), false);
				this.enableControl($('#diniego_seganagsturin_protnumero'), false);
				//afterFillin
	...
	window.appMeta.addMetaPage('diniego', 'seganagsturin', metaPage_diniego);
