...
(function () {
    ...
    function metaPage_diniego() {
		MetaPage.apply(this, ['diniego', 'segpratica', true]);
        this.name = 'Diniego';
    ...
    metaPage_diniego.prototype = _.extend(
        new MetaPage(),
        {
			...
			beforeFill: function () {
				...
				//parte asincrona
				var def = appMeta.Deferred("beforeFill-diniego_segpratica");
				var arraydef = [];
			...
			afterFill: function () {
				this.enableControl($('#diniego_segpratica_protanno'), false);
				this.enableControl($('#diniego_segpratica_protnumero'), false);
				//afterFillin
	...
	window.appMeta.addMetaPage('diniego', 'segpratica', metaPage_diniego);
