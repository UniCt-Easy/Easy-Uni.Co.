...
(function() {
    ...
    function meta_dichiardisabilsuppkind() {
        MetaData.apply(this, ["dichiardisabilsuppkind"]);
        this.name = 'meta_dichiardisabilsuppkind';
    }

    meta_dichiardisabilsuppkind.prototype = _.extend(
        new MetaData(),
        {
            constructor: meta_dichiardisabilsuppkind,
...
//$objCalcFieldConfig$
    ...
    window.appMeta.addMeta('dichiardisabilsuppkind', new meta_dichiardisabilsuppkind('dichiardisabilsuppkind'));
