			...
			describeColumns: function (table, listType) {
				...
				switch (listType) {
					...
					case 'default':
						...
						this.describeAColumn(table, 'costoscontodef_title', 'Costo', null, 3200, 2024);
						this.describeAColumn(table, 'istanzakind_title', 'Tipo di istanza', null, 4200, 50);
						this.describeAColumn(table, 'tassaistanzaconf_nullaosta', 'Nullaosta', null, 5000, null);
