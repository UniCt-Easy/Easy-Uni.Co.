			...
			describeColumns: function (table, listType) {
				...
				switch (listType) {
					...
					case 'default':
						...
						this.describeAColumn(table, 'perfindicatorekind_title', 'Tipo indicatore', null, 20, 1024);
						this.describeAColumn(table, 'perfindicatore_description', 'Descrizione', null, 30, -1);
