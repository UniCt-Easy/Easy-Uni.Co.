...
(function() {
    ...
    function meta_convenzioneattach() {
        MetaData.apply(this, ["convenzioneattach"]);
        this.name = 'meta_convenzioneattach';
    }

    meta_convenzioneattach.prototype = _.extend(
        new MetaData(),
        {
            constructor: meta_convenzioneattach,
...
//$objCalcFieldConfig$
			...
			getNewRow: function (parentRow, dt, editType){
               var def = appMeta.Deferred("getNewRow-meta_convenzioneattach");
    ...
    window.appMeta.addMeta('convenzioneattach', new meta_convenzioneattach('convenzioneattach'));
