        ...
        new MetaData(),
        {
			...
			describeColumns: function (table, listType) {
				...
				switch (listType) {
					...
					case 'seg':
						this.describeAColumn(table, 'idisced2013', 'Mansione', null, 30, null);
						this.describeAColumn(table, 'ideqf', 'Livello EQF', null, 50, null);
						this.describeAColumn(table, 'idnation', 'Lingua in cui svolge l’attività', null, 60, null);
						this.describeAColumn(table, 'idreg_docenti', 'Docente', null, 80, null);
						this.describeAColumn(table, 'idreg_resp', 'Responsabile', null, 90, null);
						this.describeAColumn(table, 'idreg_respestero', 'Responsabile estero', null, 100, null);
						...
						this.describeAColumn(table, '!ideqf_eqf_level', 'Livello EQF', null, 51, null);
						objCalcFieldConfig['!ideqf_eqf_level'] = { tableNameLookup:'eqf_alias1', columnNameLookup:'level', columnNamekey:'ideqf' };
						...
						this.describeAColumn(table, '!idreg_docenti_registry_title', 'Docente', null, 81, null);
