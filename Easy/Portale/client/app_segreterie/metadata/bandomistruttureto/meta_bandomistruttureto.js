			...
			describeColumns: function (table, listType) {
				...
				switch (listType) {
					...
					case 'seg':
						...
						this.describeAColumn(table, '!idstruttura_struttura_alias1_active', 'Attivo', null, 36, null);
						...
						objCalcFieldConfig['!idstruttura_struttura_alias1_active'] = { tableNameLookup:'struttura_alias1', columnNameLookup:'active', columnNamekey:'idstruttura' };
