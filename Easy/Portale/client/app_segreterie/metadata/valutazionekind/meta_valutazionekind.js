...
(function() {
    ...
    function meta_valutazionekind() {
        MetaData.apply(this, ["valutazionekind"]);
        this.name = 'meta_valutazionekind';
    }

    meta_valutazionekind.prototype = _.extend(
        new MetaData(),
        {
            constructor: meta_valutazionekind,
...
//$objCalcFieldConfig$
    ...
    window.appMeta.addMeta('valutazionekind', new meta_valutazionekind('valutazionekind'));
