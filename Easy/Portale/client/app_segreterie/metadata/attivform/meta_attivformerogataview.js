...
(function() {
    ...
    function meta_attivformerogataview() {
        MetaData.apply(this, ["attivformerogataview"]);
        this.name = 'meta_attivformerogataview';
    }

    meta_attivformerogataview.prototype = _.extend(
        new MetaData(),
        {
            constructor: meta_attivformerogataview,
...
//$objCalcFieldConfig$
    ...
    window.appMeta.addMeta('attivformerogataview', new meta_attivformerogataview('attivformerogataview'));
