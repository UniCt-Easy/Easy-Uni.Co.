...
(function() {
    ...
    function meta_attivformgruppoview() {
        MetaData.apply(this, ["attivformgruppoview"]);
        this.name = 'meta_attivformgruppoview';
    }

    meta_attivformgruppoview.prototype = _.extend(
        new MetaData(),
        {
            constructor: meta_attivformgruppoview,
...
//$objCalcFieldConfig$
			...
			getSorting: function (listType) {
				switch (listType) {
					case "gruppo": {
						return "didprogcurr_title asc , didprogori_title asc , didproganno_title asc , didprogporzanno_title asc ";
					}
					//$getSortingin$
				}
    ...
    window.appMeta.addMeta('attivformgruppoview', new meta_attivformgruppoview('attivformgruppoview'));
