        ...
        new MetaData(),
        {
			...
			describeColumns: function (table, listType) {
				...
				switch (listType) {
					...
					case 'seg':
						this.describeAColumn(table, 'idreg_aziende', 'Ente o azienda partner', null, 520, null);
						this.describeAColumn(table, 'idpartnerkind', 'Tipo di partnership', null, 1070, null);
						...
						this.describeAColumn(table, '!idreg_aziende_registry_pic', 'Participant Identification Code (PIC)', null, 532, null);
