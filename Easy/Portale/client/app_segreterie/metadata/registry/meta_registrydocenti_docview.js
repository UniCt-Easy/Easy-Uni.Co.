...
(function() {
    ...
    function meta_registrydocenti_docview() {
        MetaData.apply(this, ["registrydocenti_docview"]);
        this.name = 'meta_registrydocenti_docview';
    }

    meta_registrydocenti_docview.prototype = _.extend(
        new MetaData(),
        {
            constructor: meta_registrydocenti_docview,
			...
			describeColumns: function (table, listType) {
				...
				switch (listType) {
					...
					case 'docenti_doc':
						...
						this.describeAColumn(table, 'sasd_title', 'Settore Artistico Scientifico Disciplinare SASD', null, 20, 255);
...
//$objCalcFieldConfig$
    ...
    window.appMeta.addMeta('registrydocenti_docview', new meta_registrydocenti_docview('registrydocenti_docview'));
