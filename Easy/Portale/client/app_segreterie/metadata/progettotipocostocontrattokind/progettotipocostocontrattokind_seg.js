    ...
    metaPage_progettotipocostocontrattokind.prototype = _.extend(
        new MetaPage(),
        {
			...
			afterRowSelect: function (t, r) {
				...
				$('#progettotipocostocontrattokind_seg_idcontrattokind').prop("disabled", this.state.isEditState() || this.haveChildren());
				$('#progettotipocostocontrattokind_seg_idcontrattokind').prop("readonly", this.state.isEditState() || this.haveChildren());
				//afterRowSelectin
				return def.resolve();
			},
			...
			insertClick: function (that, grid) {
				if (!$('#progettotipocostocontrattokind_seg_idcontrattokind').val() && this.children.includes(grid.dataSourceName)) {
