			...
			describeColumns: function (table, listType) {
				...
				switch (listType) {
					...
					case 'seg':
						...
						this.describeAColumn(table, 'registryprogfinbando_number', 'Numero', null, 60, 2048);
						this.describeAColumn(table, 'registryprogfinbando_scadenza', 'Deadline of submission', null, 70, null);
