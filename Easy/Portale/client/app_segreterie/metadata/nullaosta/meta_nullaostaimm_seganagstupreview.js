...
(function() {
    ...
    function meta_nullaostaimm_seganagstupreview() {
        MetaData.apply(this, ["nullaostaimm_seganagstupreview"]);
        this.name = 'meta_nullaostaimm_seganagstupreview';
    }

    meta_nullaostaimm_seganagstupreview.prototype = _.extend(
        new MetaData(),
        {
            constructor: meta_nullaostaimm_seganagstupreview,
...
//$objCalcFieldConfig$
    ...
    window.appMeta.addMeta('nullaostaimm_seganagstupreview', new meta_nullaostaimm_seganagstupreview('nullaostaimm_seganagstupreview'));
