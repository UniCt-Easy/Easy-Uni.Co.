(function () {
    ...
    function metaPage_nullaosta() {
		MetaPage.apply(this, ['nullaosta', 'segisttru', true]);
        this.name = 'Nullaosta';
		this.defaultListType = 'segisttru';
    ...
    metaPage_nullaosta.prototype = _.extend(
        new MetaPage(),
        {
			...
			beforeFill: function () {
				...
				//parte asincrona
				var def = appMeta.Deferred("beforeFill-nullaosta_segisttru");
				var arraydef = [];
			...
			afterFill: function () {
				...
				this.enableControl($('#nullaosta_segisttru_protanno'), false);
				//afterFillin
	...
	window.appMeta.addMetaPage('nullaosta', 'segisttru', metaPage_nullaosta);
