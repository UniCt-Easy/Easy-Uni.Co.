        ...
        new MetaData(),
        {
			...
			describeColumns: function (table, listType) {
				...
				switch (listType) {
					...
					case 'segprg':
						this.describeAColumn(table, 'workpackage_raggruppamento', 'Raggruppamento Workpackage', null, 10, 2048);
						this.describeAColumn(table, 'workpackage_title', 'Titolo Workpackage', null, 10, 2048);
						this.describeAColumn(table, 'progettotipocosto_title', 'Voce di costo', null, 20, 2048);
						this.describeAColumn(table, 'progettocosto_amount', 'Importo', 'fixed.2', 30, null);
						this.describeAColumn(table, 'contrattokind_title', 'Tipo di contratto', null, 40, 50);
