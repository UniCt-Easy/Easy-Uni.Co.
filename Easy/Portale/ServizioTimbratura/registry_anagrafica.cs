...
[System.Xml.Serialization.XmlRoot("dsmeta_registry_anagrafica"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_registry_anagrafica: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_registry_anagrafica(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_registry_anagrafica (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_registry_anagrafica";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_registry_anagrafica.xsd";
	...
	ttimbratura.defineColumn("data", typeof(DateTime),false);
	ttimbratura.defineColumn("minuti", typeof(int),false);
	...
	ttimbratura.defineKey("idtimbratura");
	...
	tcostoorario.defineColumn("start", typeof(DateTime), true);
	tcostoorario.defineColumn("stop", typeof(DateTime), true);
	tcostoorario.defineColumn("netto", typeof(decimal), true);
	tcostoorario.defineColumn("oneri", typeof(decimal), true);
	tcostoorario.defineColumn("irap", typeof(decimal), true);
	tcostoorario.defineColumn("totale", typeof(decimal), true);
	...
	tcostoorario.defineKey("idcostoorario");
