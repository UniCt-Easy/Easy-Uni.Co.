...
namespace ServizioRendicontazione.Repositories
{
	public partial class Repository
	{
		...
		{
			return _context.corsostudiokinds.ToList();
		}
		...
		public corsostudiokind AddTipoCorsoStudio(string title)
		{
			...
			if (_context.corsostudiokinds.Any())
				idcorsostudiokind = _context.corsostudiokinds.Max(m => m.idcorsostudiokind);

			int sortcode = 0;
			if (_context.corsostudiokinds.Any())
				sortcode = _context.corsostudiokinds.Max(m => m.idcorsostudiokind);
