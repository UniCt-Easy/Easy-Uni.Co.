...
namespace Backend.Controllers {
	...
	public class AuthController : ApiController, IAuthController {
        ...
        /// <summary>
        /// Questa login è chiamata dalla dashboard che invia le credenziali, ovvero il cf criptato e il token di sessione SSO
		...
		/// Se tutto ok, viene eseguito il login con il solo cf senza la password perchè è SSO
        /// </summary>
