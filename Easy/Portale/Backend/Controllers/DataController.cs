...
namespace Backend.Controllers {
	...
	public class DataController : ApiController {
		...
		public IHttpActionResult generateExport(generateExportQueryParameters prms) {
            ...
            // l'istanza ce l'avevamo in createDataSet, per ora va bene così anche perchè altrimenti dovremmo cambiare
			...
			try {
                ...
                // il frontend dovrebbe saper gestire meglio anche 404 e altri stati... ma non è così quindi usiamo 200 OK con il messaggio di errore
                return Content(HttpStatusCode.OK, JsonConvert.SerializeObject(new {
					error = e.Message,
                }));
            }
