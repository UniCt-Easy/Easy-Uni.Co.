...
[System.Xml.Serialization.XmlRoot("dsmeta_istattitolistudio_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_istattitolistudio_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_istattitolistudio_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_istattitolistudio_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_istattitolistudio_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_istattitolistudio_default.xsd";
