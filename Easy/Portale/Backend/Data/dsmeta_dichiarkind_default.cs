...
[System.Xml.Serialization.XmlRoot("dsmeta_dichiarkind_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_dichiarkind_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_dichiarkind_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_dichiarkind_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_dichiarkind_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_dichiarkind_default.xsd";
