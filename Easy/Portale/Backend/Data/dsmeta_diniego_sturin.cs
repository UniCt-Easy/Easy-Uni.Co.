...
[System.Xml.Serialization.XmlRoot("dsmeta_diniego_sturin"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_diniego_sturin: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_diniego_sturin(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_diniego_sturin (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_diniego_sturin";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_diniego_sturin.xsd";
