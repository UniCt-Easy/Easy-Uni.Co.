...
public class dsmeta_bandodsiscr_seg: DataSet {
	...
	public MetaTable bandodsiscresitokinddefaultview 		=> (MetaTable)Tables["bandodsiscresitokinddefaultview"];
...
[DebuggerNonUserCode]
public dsmeta_bandodsiscr_seg(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_bandodsiscr_seg (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_bandodsiscr_seg";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_bandodsiscr_seg.xsd";
