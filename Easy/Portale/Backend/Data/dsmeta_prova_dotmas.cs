...
[System.Xml.Serialization.XmlRoot("dsmeta_prova_dotmas"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_prova_dotmas: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_prova_dotmas(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_prova_dotmas (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_prova_dotmas";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_prova_dotmas.xsd";
