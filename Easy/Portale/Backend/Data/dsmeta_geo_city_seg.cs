...
[System.Xml.Serialization.XmlRoot("dsmeta_geo_city_seg"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_geo_city_seg: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_geo_city_seg(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_geo_city_seg (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_geo_city_seg";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_geo_city_seg.xsd";
