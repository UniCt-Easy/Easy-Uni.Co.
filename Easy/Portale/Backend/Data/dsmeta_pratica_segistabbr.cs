...
[System.Xml.Serialization.XmlRoot("dsmeta_pratica_segistabbr"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_pratica_segistabbr: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_pratica_segistabbr(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_pratica_segistabbr (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_pratica_segistabbr";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_pratica_segistabbr.xsd";
