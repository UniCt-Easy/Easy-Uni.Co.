...
public partial class dsmeta_costoscontodef_sconti: DataSet {
...
private void initClass() {
	...
	var cPar = new []{costoscontodef_alias1.Columns["idcostoscontodef"]};
	var cChild = new []{costoscontodef.Columns["paridcostoscontodef"]};
