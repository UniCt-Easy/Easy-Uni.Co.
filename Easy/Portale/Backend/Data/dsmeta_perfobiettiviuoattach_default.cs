...
[System.Xml.Serialization.XmlRoot("dsmeta_perfobiettiviuoattach_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_perfobiettiviuoattach_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfobiettiviuoattach_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfobiettiviuoattach_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfobiettiviuoattach_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfobiettiviuoattach_default.xsd";
	...
	var cChild = new []{perfobiettiviuoattach.Columns["idattach"]};
	Relations.Add(new DataRelation("FK_perfobiettiviuoattach_attach_idattach",cPar,cChild,false));
