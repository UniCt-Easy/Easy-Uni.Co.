...
[System.Xml.Serialization.XmlRoot("dsmeta_iscrizione_dotmas"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_iscrizione_dotmas: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_iscrizione_dotmas(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_iscrizione_dotmas (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_iscrizione_dotmas";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_iscrizione_dotmas.xsd";
