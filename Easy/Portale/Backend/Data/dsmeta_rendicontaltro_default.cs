...
[System.Xml.Serialization.XmlRoot("dsmeta_rendicontaltro_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_rendicontaltro_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_rendicontaltro_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_rendicontaltro_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_rendicontaltro_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_rendicontaltro_default.xsd";
