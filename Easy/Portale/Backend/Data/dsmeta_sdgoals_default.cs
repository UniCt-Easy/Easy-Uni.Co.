...
[System.Xml.Serialization.XmlRoot("dsmeta_sdgoals_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_sdgoals_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_sdgoals_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_sdgoals_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_sdgoals_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_sdgoals_default.xsd";
	...
	var cChild = new []{sdgoals.Columns["idattach"]};
	Relations.Add(new DataRelation("FK_sdgoals_attach_idattach",cPar,cChild,false));
