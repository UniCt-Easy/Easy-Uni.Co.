...
[System.Xml.Serialization.XmlRoot("dsmeta_progettoattach_seg"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_progettoattach_seg: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_progettoattach_seg(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_progettoattach_seg (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_progettoattach_seg";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_progettoattach_seg.xsd";
	...
	var cChild = new []{progettoattach.Columns["idattach"]};
	Relations.Add(new DataRelation("FK_progettoattach_attach_idattach",cPar,cChild,false));
