...
[System.Xml.Serialization.XmlRoot("dsmeta_progettomesereport_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_progettomesereport_default: DataSet {
	...
	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public MetaTable progettomesereport 		=> (MetaTable)Tables["progettomesereport"];
...
[DebuggerNonUserCode]
public dsmeta_progettomesereport_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_progettomesereport_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_progettomesereport_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_progettomesereport_default.xsd";
	...
	//////////////////// PROGETTOMESEREPORT /////////////////////////////////
	var tprogettomesereport= new MetaTable("progettomesereport");
	tprogettomesereport.defineColumn("ct", typeof(DateTime),false);
	tprogettomesereport.defineColumn("cu", typeof(string),false);
	tprogettomesereport.defineColumn("idprogetto", typeof(int));
	tprogettomesereport.defineColumn("idprogettomesereport", typeof(int),false);
	tprogettomesereport.defineColumn("idreg", typeof(int));
	tprogettomesereport.defineColumn("idreg_user", typeof(int));
	...
	tprogettomesereport.defineKey("idprogettomesereport");
	...
	var cChild = new []{progettomesereport.Columns["idreg_user"]};
	Relations.Add(new DataRelation("FK_progettomesereport_registry_idreg_user",cPar,cChild,false));
	...
	Relations.Add(new DataRelation("FK_progettomesereport_progettoelenchiview_idprogetto",cPar,cChild,false));

	cPar = new []{year.Columns["year"]};
	cChild = new []{progettomesereport.Columns["year"]};
	Relations.Add(new DataRelation("FK_progettomesereport_year_year",cPar,cChild,false));
