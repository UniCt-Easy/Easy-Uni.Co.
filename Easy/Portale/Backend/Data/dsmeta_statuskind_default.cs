...
[System.Xml.Serialization.XmlRoot("dsmeta_statuskind_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_statuskind_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_statuskind_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_statuskind_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_statuskind_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_statuskind_default.xsd";
