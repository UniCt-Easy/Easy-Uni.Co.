...
[System.Xml.Serialization.XmlRoot("dsmeta_assetconsignsub_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_assetconsignsub_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_assetconsignsub_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_assetconsignsub_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_assetconsignsub_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_assetconsignsub_default.xsd";
	...
	tlogassetconsignsub.defineColumn("!idman_manager_title", typeof(string));
	tlogassetconsignsub.defineColumn("!idsubstate_substate_description", typeof(string));
	tlogassetconsignsub.ExtendedProperties["NotEntityChild"]="true";
	...
	var cPar = new []{assetconsignsub.Columns["idassetconsignsub"], assetconsignsub.Columns["idassetloadsub"], assetconsignsub.Columns["idman"], assetconsignsub.Columns["idsubstate"]};
	var cChild = new []{logassetconsignsub.Columns["idassetconsignsub"], logassetconsignsub.Columns["idassetloadsub"], logassetconsignsub.Columns["idman"], logassetconsignsub.Columns["idsubstate"]};
	Relations.Add(new DataRelation("FK_logassetconsignsub_assetconsignsub_idassetconsignsub-idassetloadsub-idman-idsubstate",cPar,cChild,false));

	cPar = new []{substate_alias1.Columns["idsubstate"]};
	cChild = new []{logassetconsignsub.Columns["idsubstate"]};
	Relations.Add(new DataRelation("FK_logassetconsignsub_substate_alias1_idsubstate",cPar,cChild,false));

	cPar = new []{manager_alias2.Columns["idman"]};
	cChild = new []{logassetconsignsub.Columns["idman"]};
	Relations.Add(new DataRelation("FK_logassetconsignsub_manager_alias2_idman",cPar,cChild,false));
	...
	cChild = new []{assetconsignsub.Columns["idassetloadsub"]};
	Relations.Add(new DataRelation("FK_assetconsignsub_assetloadsubdefaultview_idassetloadsub",cPar,cChild,false));
