...
[System.Xml.Serialization.XmlRoot("dsmeta_nullaosta_segpratica"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_nullaosta_segpratica: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_nullaosta_segpratica(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_nullaosta_segpratica (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_nullaosta_segpratica";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_nullaosta_segpratica.xsd";
