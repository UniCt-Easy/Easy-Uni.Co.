...
[System.Xml.Serialization.XmlRoot("dsmeta_pianostudio_stupiano"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_pianostudio_stupiano: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_pianostudio_stupiano(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_pianostudio_stupiano (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_pianostudio_stupiano";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_pianostudio_stupiano.xsd";
	...
	Relations.Add(new DataRelation("FK_pianostudio_didprogdefaultview_iddidprog",cPar,cChild,false));
