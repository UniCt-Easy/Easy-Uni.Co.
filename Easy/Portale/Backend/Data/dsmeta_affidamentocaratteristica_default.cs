...
[System.Xml.Serialization.XmlRoot("dsmeta_affidamentocaratteristica_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_affidamentocaratteristica_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_affidamentocaratteristica_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_affidamentocaratteristica_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_affidamentocaratteristica_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_affidamentocaratteristica_default.xsd";
