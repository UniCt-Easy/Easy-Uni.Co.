...
[System.Xml.Serialization.XmlRoot("dsmeta_debitodettaglio_seganagstu"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_debitodettaglio_seganagstu: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_debitodettaglio_seganagstu(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_debitodettaglio_seganagstu (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_debitodettaglio_seganagstu";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_debitodettaglio_seganagstu.xsd";
	...
	var cChild = new []{debitodettaglio.Columns["idratadef"]};
	Relations.Add(new DataRelation("FK_debitodettaglio_ratadefdefaultview_idratadef",cPar,cChild,false));

	cPar = new []{fasciaiseedefdefaultview.Columns["idfasciaiseedef"]};
	cChild = new []{debitodettaglio.Columns["idfasciaiseedef"]};
	Relations.Add(new DataRelation("FK_debitodettaglio_fasciaiseedefdefaultview_idfasciaiseedef",cPar,cChild,false));
