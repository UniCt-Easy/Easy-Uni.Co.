...
[System.Xml.Serialization.XmlRoot("dsmeta_diniego_stupass"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_diniego_stupass: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_diniego_stupass(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_diniego_stupass (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_diniego_stupass";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_diniego_stupass.xsd";
