...
[System.Xml.Serialization.XmlRoot("dsmeta_progettotiporicavocontrattokind_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_progettotiporicavocontrattokind_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_progettotiporicavocontrattokind_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_progettotiporicavocontrattokind_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_progettotiporicavocontrattokind_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_progettotiporicavocontrattokind_default.xsd";
	...
	var cChild = new []{progettotiporicavocontrattokind.Columns["idcontrattokind"]};
	Relations.Add(new DataRelation("FK_progettotiporicavocontrattokind_contrattokinddefaultview_idcontrattokind",cPar,cChild,false));
