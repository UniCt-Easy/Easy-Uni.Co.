...
public partial class dsmeta_progettotiporicavocontrattokind_default: DataSet {
...
private void initClass() {
	...
	var cChild = new []{progettotiporicavocontrattokind.Columns["idposition"]};
	Relations.Add(new DataRelation("FK_progettotiporicavocontrattokind_positiondefaultview_idposition",cPar,cChild,false));
