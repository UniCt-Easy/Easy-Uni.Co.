...
[System.Xml.Serialization.XmlRoot("dsmeta_filtrocapitolocsaposition_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_filtrocapitolocsaposition_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_filtrocapitolocsaposition_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_filtrocapitolocsaposition_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_filtrocapitolocsaposition_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_filtrocapitolocsaposition_default.xsd";
	...
	var cChild = new []{filtrocapitolocsaposition.Columns["idposition"]};
	Relations.Add(new DataRelation("FK_filtrocapitolocsaposition_positiondefaultview_idposition",cPar,cChild,false));
