...
[System.Xml.Serialization.XmlRoot("dsmeta_esonerocostoscontodef_stu"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_esonerocostoscontodef_stu: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_esonerocostoscontodef_stu(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_esonerocostoscontodef_stu (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_esonerocostoscontodef_stu";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_esonerocostoscontodef_stu.xsd";
	...
	var cPar = new []{costoscontodefscontiview.Columns["idcostoscontodef"]};
	var cChild = new []{esonerocostoscontodef.Columns["idcostoscontodef"]};
