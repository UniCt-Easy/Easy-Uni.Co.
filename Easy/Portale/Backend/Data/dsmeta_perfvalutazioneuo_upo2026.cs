...
[System.Xml.Serialization.XmlRoot("dsmeta_perfvalutazioneuo_upo2026"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_perfvalutazioneuo_upo2026: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfvalutazioneuo_upo2026(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfvalutazioneuo_upo2026 (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfvalutazioneuo_upo2026";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfvalutazioneuo_upo2026.xsd";
	...
	tgetdocentiamministrativiresponsabilinomcognview_alias4.defineColumn("getdocentiamministrativiresponsabili_resplevel", typeof(long));
	...
	var cPar = new []{getdocentiamministrativiresponsabilinomcognview_alias4.Columns["idreg"]};
