...
[System.Xml.Serialization.XmlRoot("dsmeta_diniego_imm_stu"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_diniego_imm_stu: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_diniego_imm_stu(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_diniego_imm_stu (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_diniego_imm_stu";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_diniego_imm_stu.xsd";
