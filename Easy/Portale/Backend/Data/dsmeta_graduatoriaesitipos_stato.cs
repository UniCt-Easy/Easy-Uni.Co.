...
[System.Xml.Serialization.XmlRoot("dsmeta_graduatoriaesitipos_stato"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_graduatoriaesitipos_stato: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_graduatoriaesitipos_stato(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_graduatoriaesitipos_stato (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_graduatoriaesitipos_stato";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_graduatoriaesitipos_stato.xsd";
