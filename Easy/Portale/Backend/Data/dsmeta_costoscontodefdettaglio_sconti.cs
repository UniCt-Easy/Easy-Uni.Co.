...
[System.Xml.Serialization.XmlRoot("dsmeta_costoscontodefdettaglio_sconti"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_costoscontodefdettaglio_sconti: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_costoscontodefdettaglio_sconti(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_costoscontodefdettaglio_sconti (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_costoscontodefdettaglio_sconti";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_costoscontodefdettaglio_sconti.xsd";
