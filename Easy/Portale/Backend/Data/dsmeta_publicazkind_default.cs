...
[System.Xml.Serialization.XmlRoot("dsmeta_publicazkind_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_publicazkind_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_publicazkind_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_publicazkind_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_publicazkind_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_publicazkind_default.xsd";
