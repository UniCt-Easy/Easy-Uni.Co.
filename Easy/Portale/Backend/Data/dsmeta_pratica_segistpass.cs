...
public partial class dsmeta_pratica_segistpass: DataSet {
...
private void initClass() {
	...
	var cPar = new []{pratica.Columns["idreg"], pratica.Columns["iddidprog"], pratica.Columns["idiscrizione"], pratica.Columns["idiscrizione_from"], pratica.Columns["idistanza"], pratica.Columns["idpratica"]};
	var cChild = new []{convalida.Columns["idreg"], convalida.Columns["iddidprog"], convalida.Columns["idiscrizione"], convalida.Columns["idiscrizione_from"], convalida.Columns["idistanza"], convalida.Columns["idpratica"]};
