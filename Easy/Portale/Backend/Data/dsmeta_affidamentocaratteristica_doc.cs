...
[System.Xml.Serialization.XmlRoot("dsmeta_affidamentocaratteristica_doc"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_affidamentocaratteristica_doc: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_affidamentocaratteristica_doc(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_affidamentocaratteristica_doc (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_affidamentocaratteristica_doc";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_affidamentocaratteristica_doc.xsd";
	...
	ttipoattformdefaultview.defineColumn("tipoattform_tipoente", typeof(string));
