...
[System.Xml.Serialization.XmlRoot("dsmeta_dichiarazioneserviziattach_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_dichiarazioneserviziattach_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_dichiarazioneserviziattach_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_dichiarazioneserviziattach_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_dichiarazioneserviziattach_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_dichiarazioneserviziattach_default.xsd";
	...
	var cChild = new []{dichiarazioneserviziattach.Columns["idattach"]};
	Relations.Add(new DataRelation("FK_dichiarazioneserviziattach_attach_idattach",cPar,cChild,false));
