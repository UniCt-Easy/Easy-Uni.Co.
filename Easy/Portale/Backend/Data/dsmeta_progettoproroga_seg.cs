...
[System.Xml.Serialization.XmlRoot("dsmeta_progettoproroga_seg"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_progettoproroga_seg: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_progettoproroga_seg(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_progettoproroga_seg (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_progettoproroga_seg";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_progettoproroga_seg.xsd";
