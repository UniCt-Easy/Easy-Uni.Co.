...
[System.Xml.Serialization.XmlRoot("dsmeta_convalidatoview_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_convalidatoview_default: DataSet {
	...
	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public MetaTable convalidatosegistabbrview 		=> (MetaTable)Tables["convalidatosegistabbrview"];
...
[DebuggerNonUserCode]
public dsmeta_convalidatoview_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_convalidatoview_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_convalidatoview_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_convalidatoview_default.xsd";
	...
	//////////////////// CONVALIDATOSEGISTABBRVIEW /////////////////////////////////
	var tconvalidatosegistabbrview= new MetaTable("convalidatosegistabbrview");
	tconvalidatosegistabbrview.defineColumn("attivform_title", typeof(string));
	tconvalidatosegistabbrview.defineColumn("convalidato_changesother", typeof(string));
	tconvalidatosegistabbrview.defineColumn("convalidato_ct", typeof(DateTime),false);
	tconvalidatosegistabbrview.defineColumn("convalidato_cu", typeof(string),false);
	tconvalidatosegistabbrview.defineColumn("convalidato_idchanges", typeof(int));
	tconvalidatosegistabbrview.defineColumn("convalidato_idchangeskind", typeof(int));
	tconvalidatosegistabbrview.defineColumn("convalidato_iddichiar", typeof(int));
	tconvalidatosegistabbrview.defineColumn("convalidato_iddidprog", typeof(int));
	tconvalidatosegistabbrview.defineColumn("convalidato_idiscrizione", typeof(int));
	tconvalidatosegistabbrview.defineColumn("convalidato_idiscrizione_from", typeof(int));
	tconvalidatosegistabbrview.defineColumn("convalidato_idiscrizionebmi", typeof(int));
	tconvalidatosegistabbrview.defineColumn("convalidato_idistanza", typeof(int));
	tconvalidatosegistabbrview.defineColumn("convalidato_idlearningagrstud", typeof(int));
	tconvalidatosegistabbrview.defineColumn("convalidato_idlearningagrtrainer", typeof(int));
	tconvalidatosegistabbrview.defineColumn("convalidato_idpratica", typeof(int));
	tconvalidatosegistabbrview.defineColumn("convalidato_lt", typeof(DateTime),false);
	tconvalidatosegistabbrview.defineColumn("convalidato_lu", typeof(string),false);
	tconvalidatosegistabbrview.defineColumn("dropdown_title", typeof(string),false);
	tconvalidatosegistabbrview.defineColumn("idattivform", typeof(int),false);
	tconvalidatosegistabbrview.defineColumn("idconvalida", typeof(int),false);
	tconvalidatosegistabbrview.defineColumn("idconvalidato", typeof(int),false);
	tconvalidatosegistabbrview.defineColumn("idreg", typeof(int),false);
	Tables.Add(tconvalidatosegistabbrview);
	tconvalidatosegistabbrview.defineKey("idconvalida", "idconvalidato", "idreg");
	...
	cPar = new []{convalidatosegistabbrview.Columns["idconvalidato"]};
	cChild = new []{convalidatoview.Columns["idconvalidato"]};
	Relations.Add(new DataRelation("FK_convalidatoview_convalidatosegistabbrview_idconvalidato",cPar,cChild,false));
