...
public class dsmeta_progettotipocostocontrattokind_seg: DataSet {
...
private void initClass() {
	...
	var cChild = new []{progettotipocostocontrattokind.Columns["idcontrattokind"]};
	Relations.Add(new DataRelation("FK_progettotipocostocontrattokind_contrattokinddefaultview_idcontrattokind",cPar,cChild,false));
