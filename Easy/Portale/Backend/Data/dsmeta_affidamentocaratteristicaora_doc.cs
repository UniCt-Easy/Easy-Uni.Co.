...
[System.Xml.Serialization.XmlRoot("dsmeta_affidamentocaratteristicaora_doc"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_affidamentocaratteristicaora_doc: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_affidamentocaratteristicaora_doc(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_affidamentocaratteristicaora_doc (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_affidamentocaratteristicaora_doc";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_affidamentocaratteristicaora_doc.xsd";
