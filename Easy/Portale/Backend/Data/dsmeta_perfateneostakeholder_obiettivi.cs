...
[System.Xml.Serialization.XmlRoot("dsmeta_perfateneostakeholder_obiettivi"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_perfateneostakeholder_obiettivi: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfateneostakeholder_obiettivi(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfateneostakeholder_obiettivi (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfateneostakeholder_obiettivi";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfateneostakeholder_obiettivi.xsd";
