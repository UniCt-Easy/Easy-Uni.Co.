...
[System.Xml.Serialization.XmlRoot("dsmeta_position_obsoleto"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_position_obsoleto: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_position_obsoleto(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_position_obsoleto (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_position_obsoleto";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_position_obsoleto.xsd";
