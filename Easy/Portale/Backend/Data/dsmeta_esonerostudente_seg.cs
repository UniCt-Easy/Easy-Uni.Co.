...
[System.Xml.Serialization.XmlRoot("dsmeta_esonerostudente_seg"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_esonerostudente_seg: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_esonerostudente_seg(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_esonerostudente_seg (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_esonerostudente_seg";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_esonerostudente_seg.xsd";
	...
	var cChild = new []{esonerostudente.Columns["idreg"]};
	Relations.Add(new DataRelation("FK_esonerostudente_registrystudentiview_idreg",cPar,cChild,false));
