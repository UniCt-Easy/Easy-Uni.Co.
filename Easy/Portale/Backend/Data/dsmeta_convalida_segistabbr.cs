...
[System.Xml.Serialization.XmlRoot("dsmeta_convalida_segistabbr"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_convalida_segistabbr: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_convalida_segistabbr(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_convalida_segistabbr (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_convalida_segistabbr";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_convalida_segistabbr.xsd";
	...
	var cChild = new []{convalidante.Columns["idconvalida"], convalidante.Columns["idreg"]};
