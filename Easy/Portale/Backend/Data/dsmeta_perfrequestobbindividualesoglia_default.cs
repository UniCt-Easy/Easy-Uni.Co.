...
[System.Xml.Serialization.XmlRoot("dsmeta_perfrequestobbindividualesoglia_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_perfrequestobbindividualesoglia_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfrequestobbindividualesoglia_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfrequestobbindividualesoglia_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfrequestobbindividualesoglia_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfrequestobbindividualesoglia_default.xsd";
	...
	var cChild = new []{perfrequestobbindividualesoglia.Columns["idperfsogliakind"]};
