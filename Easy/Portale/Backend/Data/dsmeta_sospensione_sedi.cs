...
[System.Xml.Serialization.XmlRoot("dsmeta_sospensione_sedi"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_sospensione_sedi: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_sospensione_sedi(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_sospensione_sedi (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_sospensione_sedi";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_sospensione_sedi.xsd";
