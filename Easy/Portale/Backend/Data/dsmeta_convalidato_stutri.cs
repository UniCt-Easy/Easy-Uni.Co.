...
[System.Xml.Serialization.XmlRoot("dsmeta_convalidato_stutri"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_convalidato_stutri: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_convalidato_stutri(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_convalidato_stutri (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_convalidato_stutri";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_convalidato_stutri.xsd";
