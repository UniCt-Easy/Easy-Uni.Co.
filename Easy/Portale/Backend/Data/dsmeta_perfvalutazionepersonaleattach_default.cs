...
[System.Xml.Serialization.XmlRoot("dsmeta_perfvalutazionepersonaleattach_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_perfvalutazionepersonaleattach_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfvalutazionepersonaleattach_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfvalutazionepersonaleattach_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfvalutazionepersonaleattach_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfvalutazionepersonaleattach_default.xsd";
	...
	var cChild = new []{perfvalutazionepersonaleattach.Columns["idattach"]};
