...
[System.Xml.Serialization.XmlRoot("dsmeta_sasdistitutokind_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_sasdistitutokind_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_sasdistitutokind_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_sasdistitutokind_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_sasdistitutokind_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_sasdistitutokind_default.xsd";
	...
	var cChild = new []{sasdistitutokind.Columns["idistitutokind"]};
