...
public partial class dsmeta_istanza_rein_seg: DataSet {
...
private void initClass() {
	...
	tistanzaseganagstusonpreview.defineColumn("idcorsostudio", typeof(int),false);
	tistanzaseganagstusonpreview.defineColumn("iddidprog", typeof(int),false);
	...
	tistanzaseganagstusonpreview.defineColumn("paridistanza", typeof(int),false);
	Tables.Add(tistanzaseganagstusonpreview);
	tistanzaseganagstusonpreview.defineKey("idcorsostudio", "iddidprog", "idistanza", "idistanzakind", "idreg_studenti", "paridistanza");
