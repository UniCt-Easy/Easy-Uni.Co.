...
private void initClass() {
	...
	var cPar = new []{dichiarkinddefaultview.Columns["iddichiarkind"]};
	var cChild = new []{dichiar.Columns["iddichiarkind"]};
	Relations.Add(new DataRelation("FK_dichiar_dichiarkinddefaultview_iddichiarkind",cPar,cChild,false));
