...
[System.Xml.Serialization.XmlRoot("dsmeta_ricostruzioneanniaccademici_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_ricostruzioneanniaccademici_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_ricostruzioneanniaccademici_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_ricostruzioneanniaccademici_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_ricostruzioneanniaccademici_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_ricostruzioneanniaccademici_default.xsd";
