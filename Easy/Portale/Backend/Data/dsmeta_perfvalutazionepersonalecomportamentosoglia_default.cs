...
[System.Xml.Serialization.XmlRoot("dsmeta_perfvalutazionepersonalecomportamentosoglia_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_perfvalutazionepersonalecomportamentosoglia_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfvalutazionepersonalecomportamentosoglia_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfvalutazionepersonalecomportamentosoglia_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfvalutazionepersonalecomportamentosoglia_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfvalutazionepersonalecomportamentosoglia_default.xsd";
