...
[System.Xml.Serialization.XmlRoot("dsmeta_learningagrtrainerkind_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_learningagrtrainerkind_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_learningagrtrainerkind_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_learningagrtrainerkind_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_learningagrtrainerkind_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_learningagrtrainerkind_default.xsd";
