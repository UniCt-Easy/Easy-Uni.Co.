...
[System.Xml.Serialization.XmlRoot("dsmeta_progettocostomembroreport_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_progettocostomembroreport_default: DataSet {
	...
	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public MetaTable progettocostomembroreport 		=> (MetaTable)Tables["progettocostomembroreport"];
...
[DebuggerNonUserCode]
public dsmeta_progettocostomembroreport_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_progettocostomembroreport_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_progettocostomembroreport_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_progettocostomembroreport_default.xsd";
	...
	//////////////////// PROGETTOCOSTOMEMBROREPORT /////////////////////////////////
	var tprogettocostomembroreport= new MetaTable("progettocostomembroreport");
	tprogettocostomembroreport.defineColumn("ct", typeof(DateTime),false);
	tprogettocostomembroreport.defineColumn("cu", typeof(string),false);
	tprogettocostomembroreport.defineColumn("idprogetto", typeof(int));
	tprogettocostomembroreport.defineColumn("idprogettocostomembroreport", typeof(int),false);
	tprogettocostomembroreport.defineColumn("idreg", typeof(int));
	tprogettocostomembroreport.defineColumn("idreg_user", typeof(int));
	tprogettocostomembroreport.defineColumn("idstruttura", typeof(int));
	tprogettocostomembroreport.defineColumn("lt", typeof(DateTime),false);
	tprogettocostomembroreport.defineColumn("lu", typeof(string),false);
	tprogettocostomembroreport.defineColumn("year", typeof(int));
	Tables.Add(tprogettocostomembroreport);
	tprogettocostomembroreport.defineKey("idprogettocostomembroreport");
	...
	var cChild = new []{progettocostomembroreport.Columns["idreg_user"]};
	Relations.Add(new DataRelation("FK_progettocostomembroreport_registry_idreg_user",cPar,cChild,false));

	cPar = new []{strutturadefaultview.Columns["idstruttura"]};
	cChild = new []{progettocostomembroreport.Columns["idstruttura"]};
	Relations.Add(new DataRelation("FK_progettocostomembroreport_strutturadefaultview_idstruttura",cPar,cChild,false));

	cPar = new []{getregistrydocentiamministrativiprjnomcognmatview.Columns["idreg"]};
	cChild = new []{progettocostomembroreport.Columns["idreg"]};
	Relations.Add(new DataRelation("FK_progettocostomembroreport_getregistrydocentiamministrativiprjnomcognmatview_idreg",cPar,cChild,false));

	cPar = new []{progettoelenchiview.Columns["idprogetto"]};
	cChild = new []{progettocostomembroreport.Columns["idprogetto"]};
	Relations.Add(new DataRelation("FK_progettocostomembroreport_progettoelenchiview_idprogetto",cPar,cChild,false));

	cPar = new []{year.Columns["year"]};
	cChild = new []{progettocostomembroreport.Columns["year"]};
	Relations.Add(new DataRelation("FK_progettocostomembroreport_year_year",cPar,cChild,false));
