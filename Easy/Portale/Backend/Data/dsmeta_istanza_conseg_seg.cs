...
private void initClass() {
	...
	var cChild = new []{relatore.Columns["idistanza"], relatore.Columns["idreg"]};
	...
	Relations.Add(new DataRelation("FK_relatore_registry_alias1_idreg_docenti",cPar,cChild,false));
	...
	cChild = new []{richitesi.Columns["idistanza"], richitesi.Columns["idreg"]};
	...
	Relations.Add(new DataRelation("FK_richitesi_registry_idreg_docenti",cPar,cChild,false));
