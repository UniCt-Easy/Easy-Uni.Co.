...
[System.Xml.Serialization.XmlRoot("dsmeta_nullaosta_imm_seganagstu"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_nullaosta_imm_seganagstu: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_nullaosta_imm_seganagstu(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_nullaosta_imm_seganagstu (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_nullaosta_imm_seganagstu";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_nullaosta_imm_seganagstu.xsd";
	...
	var cChild = new []{nullaosta_imm_alias1.Columns["iddidprogori"]};
	Relations.Add(new DataRelation("FK_nullaosta_imm_alias1_didprogoridefaultview_iddidprogori",cPar,cChild,false));
	...
	Relations.Add(new DataRelation("FK_nullaosta_imm_alias1_didprogcurr_iddidprogcurr",cPar,cChild,false));
	...
	Relations.Add(new DataRelation("FK_nullaosta_imm_alias1_nullaosta_idcorsostudio-iddidprog-idistanza-idistanzakind-idnullaosta-idreg-",cPar,cChild,false));
