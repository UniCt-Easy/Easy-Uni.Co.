...
[System.Xml.Serialization.XmlRoot("dsmeta_protocollo_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_protocollo_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_protocollo_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_protocollo_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_protocollo_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_protocollo_default.xsd";
    ...
    tattach.defineColumn("attachment", typeof(byte[]), true);
    tattach.defineColumn("counter", typeof(int), true);
    tattach.defineColumn("filename", typeof(string), true);
    tattach.defineColumn("hash", typeof(string), true);
    tattach.defineColumn("size", typeof(long), true);
    Tables.Add(tattach);
