...
[System.Xml.Serialization.XmlRoot("dsmeta_dichiarazioneservizi_seg"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_dichiarazioneservizi_seg: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_dichiarazioneservizi_seg(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_dichiarazioneservizi_seg (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_dichiarazioneservizi_seg";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_dichiarazioneservizi_seg.xsd";
	...
	cChild = new []{dichiarazioneservizi.Columns["idreg"]};
	Relations.Add(new DataRelation("FK_dichiarazioneservizi_registrydefaultview_idreg",cPar,cChild,false));
