...
[System.Xml.Serialization.XmlRoot("dsmeta_attivformcaratteristica_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_attivformcaratteristica_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_attivformcaratteristica_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_attivformcaratteristica_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_attivformcaratteristica_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_attivformcaratteristica_default.xsd";
