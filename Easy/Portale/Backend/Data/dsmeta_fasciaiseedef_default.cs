...
[System.Xml.Serialization.XmlRoot("dsmeta_fasciaiseedef_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_fasciaiseedef_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_fasciaiseedef_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_fasciaiseedef_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_fasciaiseedef_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_fasciaiseedef_default.xsd";
