...
[System.Xml.Serialization.XmlRoot("dsmeta_affidamentoattach_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_affidamentoattach_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_affidamentoattach_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_affidamentoattach_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_affidamentoattach_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_affidamentoattach_default.xsd";
