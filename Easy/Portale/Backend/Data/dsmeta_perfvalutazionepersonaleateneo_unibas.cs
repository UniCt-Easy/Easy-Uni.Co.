...
[System.Xml.Serialization.XmlRoot("dsmeta_perfvalutazionepersonaleateneo_unibas"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_perfvalutazionepersonaleateneo_unibas: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfvalutazionepersonaleateneo_unibas(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfvalutazionepersonaleateneo_unibas (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfvalutazionepersonaleateneo_unibas";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfvalutazionepersonaleateneo_unibas.xsd";

	#region create DataTables
	//////////////////// PERFVALUTAZIONEPERSONALEATENEO /////////////////////////////////
	var tperfvalutazionepersonaleateneo= new MetaTable("perfvalutazionepersonaleateneo");
	tperfvalutazionepersonaleateneo.defineColumn("!punti", typeof(int));
	tperfvalutazionepersonaleateneo.defineColumn("!puntipesati", typeof(decimal));
