...
[System.Xml.Serialization.XmlRoot("dsmeta_perfvalutazioneateneoresvalidatori_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_perfvalutazioneateneoresvalidatori_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfvalutazioneateneoresvalidatori_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfvalutazioneateneoresvalidatori_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfvalutazioneateneoresvalidatori_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfvalutazioneateneoresvalidatori_default.xsd";
	...
	var cChild = new []{perfvalutazioneateneoresvalidatori.Columns["idvalidatori"]};
