...
[System.Xml.Serialization.XmlRoot("dsmeta_relatore_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_relatore_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_relatore_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_relatore_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_relatore_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_relatore_default.xsd";
