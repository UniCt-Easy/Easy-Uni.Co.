...
[System.Xml.Serialization.XmlRoot("dsmeta_sospensione_aula"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_sospensione_aula: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_sospensione_aula(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_sospensione_aula (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_sospensione_aula";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_sospensione_aula.xsd";
