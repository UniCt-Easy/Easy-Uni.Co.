...
[DebuggerNonUserCode]
public dsmeta_nullaosta_segisteq(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_nullaosta_segisteq (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_nullaosta_segisteq";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_nullaosta_segisteq.xsd";
