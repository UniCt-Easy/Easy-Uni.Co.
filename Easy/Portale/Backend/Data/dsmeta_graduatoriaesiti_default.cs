...
[System.Xml.Serialization.XmlRoot("dsmeta_graduatoriaesiti_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_graduatoriaesiti_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_graduatoriaesiti_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_graduatoriaesiti_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_graduatoriaesiti_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_graduatoriaesiti_default.xsd";
