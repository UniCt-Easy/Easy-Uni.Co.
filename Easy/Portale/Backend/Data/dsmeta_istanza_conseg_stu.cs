...
[System.Xml.Serialization.XmlRoot("dsmeta_istanza_conseg_stu"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_istanza_conseg_stu: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_istanza_conseg_stu(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_istanza_conseg_stu (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_istanza_conseg_stu";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_istanza_conseg_stu.xsd";
	...
	var cPar = new []{appellosegview.Columns["idappello"]};
	var cChild = new []{istanza_conseg.Columns["idappello"]};
