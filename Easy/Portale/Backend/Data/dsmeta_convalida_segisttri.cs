...
[System.Xml.Serialization.XmlRoot("dsmeta_convalida_segisttri"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_convalida_segisttri: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_convalida_segisttri(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_convalida_segisttri (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_convalida_segisttri";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_convalida_segisttri.xsd";
