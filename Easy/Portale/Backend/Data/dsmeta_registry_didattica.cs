...
[System.Xml.Serialization.XmlRoot("dsmeta_registry_didattica"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_registry_didattica: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_registry_didattica(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_registry_didattica (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_registry_didattica";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_registry_didattica.xsd";
	...
	tregistry.defineColumn("!datafine", typeof(DateTime));
	tregistry.defineColumn("!datainizio", typeof(DateTime));
	...
	var cChild = new []{rendicontdidattica.Columns["idreg"]};
	Relations.Add(new DataRelation("FK_rendicontdidattica_registry_idreg",cPar,cChild,false));
