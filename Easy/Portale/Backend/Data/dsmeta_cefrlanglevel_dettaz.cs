...
[System.Xml.Serialization.XmlRoot("dsmeta_cefrlanglevel_dettaz"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_cefrlanglevel_dettaz: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_cefrlanglevel_dettaz(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_cefrlanglevel_dettaz (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_cefrlanglevel_dettaz";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_cefrlanglevel_dettaz.xsd";
	...
	var cPar = new []{cefrdefaultview_alias4.Columns["idcefr"]};
	var cChild = new []{cefrlanglevel.Columns["idcefr_scritto"]};
