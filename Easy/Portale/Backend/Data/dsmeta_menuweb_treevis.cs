...
[System.Xml.Serialization.XmlRoot("dsmeta_menuweb_treevis"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_menuweb_treevis: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_menuweb_treevis(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_menuweb_treevis (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_menuweb_treevis";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_menuweb_treevis.xsd";
