...
[System.Xml.Serialization.XmlRoot("dsmeta_nullaosta_stupass"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_nullaosta_stupass: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_nullaosta_stupass(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_nullaosta_stupass (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_nullaosta_stupass";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_nullaosta_stupass.xsd";
