...
[System.Xml.Serialization.XmlRoot("dsmeta_esoneroanskind_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_esoneroanskind_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_esoneroanskind_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_esoneroanskind_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_esoneroanskind_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_esoneroanskind_default.xsd";
