...
[System.Xml.Serialization.XmlRoot("dsmeta_cefrlanglevel_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_cefrlanglevel_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_cefrlanglevel_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_cefrlanglevel_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_cefrlanglevel_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_cefrlanglevel_default.xsd";
