...
[System.Xml.Serialization.XmlRoot("dsmeta_registrykind_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_registrykind_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_registrykind_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_registrykind_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_registrykind_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_registrykind_default.xsd";
