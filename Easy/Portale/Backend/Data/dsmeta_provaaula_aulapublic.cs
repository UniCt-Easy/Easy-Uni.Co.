...
[System.Xml.Serialization.XmlRoot("dsmeta_provaaula_aulapublic"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_provaaula_aulapublic: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_provaaula_aulapublic(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_provaaula_aulapublic (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_provaaula_aulapublic";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_provaaula_aulapublic.xsd";
