...
public partial class dsmeta_sostenimento_seganagstuacc: DataSet {
...
private void initClass() {
	...
	tprovaingressoview.defineColumn("idcorsostudio", typeof(int),false);
	tprovaingressoview.defineColumn("iddidprog", typeof(int),false);
	...
	tprovaingressoview.defineKey("idcorsostudio", "iddidprog", "idprova");
