...
[System.Xml.Serialization.XmlRoot("dsmeta_diniego_noiscr"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_diniego_noiscr: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_diniego_noiscr(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_diniego_noiscr (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_diniego_noiscr";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_diniego_noiscr.xsd";
