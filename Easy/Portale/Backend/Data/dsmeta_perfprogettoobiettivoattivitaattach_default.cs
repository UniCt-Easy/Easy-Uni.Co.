...
[System.Xml.Serialization.XmlRoot("dsmeta_perfprogettoobiettivoattivitaattach_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_perfprogettoobiettivoattivitaattach_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfprogettoobiettivoattivitaattach_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfprogettoobiettivoattivitaattach_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfprogettoobiettivoattivitaattach_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfprogettoobiettivoattivitaattach_default.xsd";
