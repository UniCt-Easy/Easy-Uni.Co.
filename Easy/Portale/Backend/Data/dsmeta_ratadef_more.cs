...
[System.Xml.Serialization.XmlRoot("dsmeta_ratadef_more"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_ratadef_more: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_ratadef_more(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_ratadef_more (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_ratadef_more";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_ratadef_more.xsd";
