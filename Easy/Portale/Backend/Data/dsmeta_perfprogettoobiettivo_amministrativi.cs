...
[System.Xml.Serialization.XmlRoot("dsmeta_perfprogettoobiettivo_amministrativi"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_perfprogettoobiettivo_amministrativi: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfprogettoobiettivo_amministrativi(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfprogettoobiettivo_amministrativi (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfprogettoobiettivo_amministrativi";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfprogettoobiettivo_amministrativi.xsd";
	...
	Relations.Add(new DataRelation("FK_perfprogettoobiettivo_perfprogettodefaultview_idperfprogetto",cPar,cChild,false));
