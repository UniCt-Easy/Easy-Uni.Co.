...
[System.Xml.Serialization.XmlRoot("dsmeta_getcostoview_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_getcostoview_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_getcostoview_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_getcostoview_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_getcostoview_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_getcostoview_default.xsd";
