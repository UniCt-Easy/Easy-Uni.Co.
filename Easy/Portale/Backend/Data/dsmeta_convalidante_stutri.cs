...
[System.Xml.Serialization.XmlRoot("dsmeta_convalidante_stutri"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_convalidante_stutri: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_convalidante_stutri(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_convalidante_stutri (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_convalidante_stutri";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_convalidante_stutri.xsd";
