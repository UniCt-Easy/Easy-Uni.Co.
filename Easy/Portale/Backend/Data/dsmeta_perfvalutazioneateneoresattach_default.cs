...
[System.Xml.Serialization.XmlRoot("dsmeta_perfvalutazioneateneoresattach_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_perfvalutazioneateneoresattach_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfvalutazioneateneoresattach_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfvalutazioneateneoresattach_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfvalutazioneateneoresattach_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfvalutazioneateneoresattach_default.xsd";
	...
	var cChild = new []{perfvalutazioneateneoresattach.Columns["idattach"]};
	Relations.Add(new DataRelation("FK_perfvalutazioneateneoresattach_attach_idattach",cPar,cChild,false));
