...
[System.Xml.Serialization.XmlRoot("dsmeta_istanza_imm_seg"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_istanza_imm_seg: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_istanza_imm_seg(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_istanza_imm_seg (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_istanza_imm_seg";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_istanza_imm_seg.xsd";
