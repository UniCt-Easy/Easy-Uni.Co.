...
public class dsmeta_istanza_tri_seg: DataSet {
...
private void initClass() {
	...
	tdichiar_alias1.defineColumn("extension", typeof(string));
	...
	tistanza_tri.defineKey("iddidprog", "idiscrizione", "idistanza", "idistanzakind", "idreg");
	...
	Relations.Add(new DataRelation("FK_pratica_dichiar_alias1_iddichiar",cPar,cChild,false));
	...
	Relations.Add(new DataRelation("FK_istanza_tri_registryistitutiview_idreg_istituti",cPar,cChild,false));

	cPar = new []{dichiar.Columns["iddichiar"]};
	cChild = new []{istanza_tri.Columns["iddichiar_titolo"]};
	Relations.Add(new DataRelation("FK_istanza_tri_dichiar_iddichiar_titolo",cPar,cChild,false));
	...
	cPar = new []{istanza.Columns["idistanza"], istanza.Columns["idistanzakind"], istanza.Columns["idreg_studenti"]};
	cChild = new []{istanza_tri.Columns["idistanza"], istanza_tri.Columns["idistanzakind"], istanza_tri.Columns["idreg"]};
	Relations.Add(new DataRelation("FK_istanza_tri_istanza_idistanza-idistanzakind-idreg-",cPar,cChild,false));
