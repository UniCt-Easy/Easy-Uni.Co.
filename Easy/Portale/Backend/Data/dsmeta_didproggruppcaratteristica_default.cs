...
[System.Xml.Serialization.XmlRoot("dsmeta_didproggruppcaratteristica_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_didproggruppcaratteristica_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_didproggruppcaratteristica_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_didproggruppcaratteristica_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_didproggruppcaratteristica_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_didproggruppcaratteristica_default.xsd";
	...
	var cChild = new []{didproggruppcaratteristica.Columns["idsasd"]};
	Relations.Add(new DataRelation("FK_didproggruppcaratteristica_sasddefaultview_idsasd",cPar,cChild,false));

	cPar = new []{sasdgruppodefaultview.Columns["idsasdgruppo"]};
	cChild = new []{didproggruppcaratteristica.Columns["idsasdgruppo"]};
	Relations.Add(new DataRelation("FK_didproggruppcaratteristica_sasdgruppodefaultview_idsasdgruppo",cPar,cChild,false));
	...
	Relations.Add(new DataRelation("FK_didproggruppcaratteristica_ambitoareadiscdefaultview_idambitoareadisc",cPar,cChild,false));

	cPar = new []{tipoattformdefaultview.Columns["idtipoattform"]};
	cChild = new []{didproggruppcaratteristica.Columns["idtipoattform"]};
	Relations.Add(new DataRelation("FK_didproggruppcaratteristica_tipoattformdefaultview_idtipoattform",cPar,cChild,false));
