...
[System.Xml.Serialization.XmlRoot("dsmeta_settoreerc_seg"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_settoreerc_seg: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_settoreerc_seg(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_settoreerc_seg (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_settoreerc_seg";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_settoreerc_seg.xsd";
