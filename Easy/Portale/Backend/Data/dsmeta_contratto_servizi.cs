...
[System.Xml.Serialization.XmlRoot("dsmeta_contratto_servizi"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_contratto_servizi: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_contratto_servizi(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_contratto_servizi (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_contratto_servizi";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_contratto_servizi.xsd";
