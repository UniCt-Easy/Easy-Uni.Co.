...
[System.Xml.Serialization.XmlRoot("dsmeta_iscrizione_ingresso"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_iscrizione_ingresso: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_iscrizione_ingresso(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_iscrizione_ingresso (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_iscrizione_ingresso";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_iscrizione_ingresso.xsd";
