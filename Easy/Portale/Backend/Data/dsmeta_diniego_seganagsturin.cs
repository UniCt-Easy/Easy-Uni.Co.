...
[System.Xml.Serialization.XmlRoot("dsmeta_diniego_seganagsturin"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_diniego_seganagsturin: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_diniego_seganagsturin(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_diniego_seganagsturin (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_diniego_seganagsturin";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_diniego_seganagsturin.xsd";
