...
[System.Xml.Serialization.XmlRoot("dsmeta_diniego_stutri"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_diniego_stutri: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_diniego_stutri(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_diniego_stutri (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_diniego_stutri";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_diniego_stutri.xsd";
