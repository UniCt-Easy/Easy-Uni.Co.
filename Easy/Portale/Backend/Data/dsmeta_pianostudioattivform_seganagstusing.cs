...
public partial class dsmeta_pianostudioattivform_seganagstusing: DataSet {

	#region Table members declaration
	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public MetaTable sostenimentoseganagstusingview 		=> (MetaTable)Tables["sostenimentoseganagstusingview"];
...
private void initClass() {
	...
	//////////////////// SOSTENIMENTOSEGANAGSTUSINGVIEW /////////////////////////////////
	var tsostenimentoseganagstusingview= new MetaTable("sostenimentoseganagstusingview");
	tsostenimentoseganagstusingview.defineColumn("dropdown_title", typeof(string),false);
	tsostenimentoseganagstusingview.defineColumn("idiscrizione", typeof(int),false);
	tsostenimentoseganagstusingview.defineColumn("idreg", typeof(int),false);
	tsostenimentoseganagstusingview.defineColumn("idsostenimento", typeof(int),false);
	Tables.Add(tsostenimentoseganagstusingview);
	tsostenimentoseganagstusingview.defineKey("idiscrizione", "idreg", "idsostenimento");
	...
	var cPar = new []{sostenimentoseganagstusingview.Columns["idsostenimento"]};
	var cChild = new []{pianostudioattivform.Columns["idsostenimento"]};
	Relations.Add(new DataRelation("FK_pianostudioattivform_sostenimentoseganagstusingview_idsostenimento",cPar,cChild,false));
