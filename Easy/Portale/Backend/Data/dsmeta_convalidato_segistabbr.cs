...
[System.Xml.Serialization.XmlRoot("dsmeta_convalidato_segistabbr"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_convalidato_segistabbr: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_convalidato_segistabbr(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_convalidato_segistabbr (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_convalidato_segistabbr";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_convalidato_segistabbr.xsd";
