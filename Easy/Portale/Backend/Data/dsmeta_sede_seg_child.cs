...
[System.Xml.Serialization.XmlRoot("dsmeta_sede_seg_child"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_sede_seg_child: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_sede_seg_child(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_sede_seg_child (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_sede_seg_child";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_sede_seg_child.xsd";
