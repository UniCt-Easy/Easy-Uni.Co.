...
[System.Xml.Serialization.XmlRoot("dsmeta_diniego_stueq"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_diniego_stueq: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_diniego_stueq(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_diniego_stueq (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_diniego_stueq";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_diniego_stueq.xsd";
