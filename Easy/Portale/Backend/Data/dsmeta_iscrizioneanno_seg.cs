...
[System.Xml.Serialization.XmlRoot("dsmeta_iscrizioneanno_seg"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_iscrizioneanno_seg: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_iscrizioneanno_seg(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_iscrizioneanno_seg (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_iscrizioneanno_seg";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_iscrizioneanno_seg.xsd";
