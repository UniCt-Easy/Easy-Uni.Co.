...
[System.Xml.Serialization.XmlRoot("dsmeta_nullaosta_segisttru"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_nullaosta_segisttru: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_nullaosta_segisttru(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_nullaosta_segisttru (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_nullaosta_segisttru";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_nullaosta_segisttru.xsd";
