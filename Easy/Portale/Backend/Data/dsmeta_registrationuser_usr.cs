...
private void initClass() {
	...
	tregistrationuser.defineColumn("idsor01", typeof(int),false);
	tregistrationuser.defineColumn("idsor02", typeof(int),false);
	tregistrationuser.defineColumn("idsor03", typeof(int));
	tregistrationuser.defineColumn("idsor04", typeof(int),false);
