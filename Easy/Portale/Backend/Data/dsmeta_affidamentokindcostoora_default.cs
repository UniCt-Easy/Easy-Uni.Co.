...
[System.Xml.Serialization.XmlRoot("dsmeta_affidamentokindcostoora_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_affidamentokindcostoora_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_affidamentokindcostoora_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_affidamentokindcostoora_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_affidamentokindcostoora_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_affidamentokindcostoora_default.xsd";
	...
	var cChild = new []{affidamentokindcostoora.Columns["aa"]};
