...
[System.Xml.Serialization.XmlRoot("dsmeta_assetconsignsub_subconsignee"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_assetconsignsub_subconsignee: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_assetconsignsub_subconsignee(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_assetconsignsub_subconsignee (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_assetconsignsub_subconsignee";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_assetconsignsub_subconsignee.xsd";
	...
	cChild = new []{assetconsignsub.Columns["idassetload"]};
	Relations.Add(new DataRelation("FK_assetconsignsub_assetload_idassetload",cPar,cChild,false));
