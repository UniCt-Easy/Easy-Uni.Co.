...
[System.Xml.Serialization.XmlRoot("dsmeta_dichiar_altrititoli_stu"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_dichiar_altrititoli_stu: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_dichiar_altrititoli_stu(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_dichiar_altrititoli_stu (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_dichiar_altrititoli_stu";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_dichiar_altrititoli_stu.xsd";
	...
	var cChild = new []{dichiar.Columns["aa"]};
