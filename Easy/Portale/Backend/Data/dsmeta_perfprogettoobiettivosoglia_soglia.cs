...
[System.Xml.Serialization.XmlRoot("dsmeta_perfprogettoobiettivosoglia_soglia"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_perfprogettoobiettivosoglia_soglia: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfprogettoobiettivosoglia_soglia(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfprogettoobiettivosoglia_soglia (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfprogettoobiettivosoglia_soglia";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfprogettoobiettivosoglia_soglia.xsd";
