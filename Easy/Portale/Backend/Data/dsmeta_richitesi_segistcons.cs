...
public partial class dsmeta_richitesi_segistcons: DataSet {
...
private void initClass() {
	...
	ttesikeyword.defineColumn("!idnation_lang_geo_nation_lang", typeof(string));
	...
	ttesikinddefaultview.defineColumn("tesikind_ct", typeof(DateTime),false);
	ttesikinddefaultview.defineColumn("tesikind_cu", typeof(string),false);
	ttesikinddefaultview.defineColumn("tesikind_description", typeof(string));
	ttesikinddefaultview.defineColumn("tesikind_lt", typeof(DateTime),false);
	ttesikinddefaultview.defineColumn("tesikind_lu", typeof(string),false);
	ttesikinddefaultview.defineColumn("tesikind_sortcode", typeof(int),false);
	ttesikinddefaultview.defineColumn("title", typeof(string),false);
	...
	cChild = new []{tesikeyword.Columns["idnation_lang"]};
	Relations.Add(new DataRelation("FK_tesikeyword_geo_nation_idnation_lang",cPar,cChild,false));
