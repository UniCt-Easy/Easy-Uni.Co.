...
[System.Xml.Serialization.XmlRoot("dsmeta_numerodip_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_numerodip_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_numerodip_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_numerodip_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_numerodip_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_numerodip_default.xsd";
