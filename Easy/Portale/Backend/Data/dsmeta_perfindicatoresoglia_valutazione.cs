...
[System.Xml.Serialization.XmlRoot("dsmeta_perfindicatoresoglia_valutazione"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_perfindicatoresoglia_valutazione: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfindicatoresoglia_valutazione(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfindicatoresoglia_valutazione (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfindicatoresoglia_valutazione";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfindicatoresoglia_valutazione.xsd";
	...
	tperfindicatoresoglia.defineColumn("description", typeof(string),false);
