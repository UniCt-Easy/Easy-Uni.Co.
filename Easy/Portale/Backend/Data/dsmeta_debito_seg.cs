...
[System.Xml.Serialization.XmlRoot("dsmeta_debito_seg"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_debito_seg: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_debito_seg(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_debito_seg (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_debito_seg";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_debito_seg.xsd";
	...
	cPar = new []{registrystudentiview.Columns["idreg"]};
	cChild = new []{iscrizioneanno.Columns["idreg"]};
	Relations.Add(new DataRelation("FK_iscrizioneanno_registrystudentiview_idreg",cPar,cChild,false));
	...
	cPar = new []{registrystudentiview.Columns["idreg"]};
	cChild = new []{debito.Columns["idreg"]};
	Relations.Add(new DataRelation("FK_debito_registrystudentiview_idreg",cPar,cChild,false));
