...
[System.Xml.Serialization.XmlRoot("dsmeta_importcontrattistipendiview_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_importcontrattistipendiview_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_importcontrattistipendiview_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_importcontrattistipendiview_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_importcontrattistipendiview_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_importcontrattistipendiview_default.xsd";
