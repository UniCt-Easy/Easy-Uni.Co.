...
[System.Xml.Serialization.XmlRoot("dsmeta_consolidamento_seg"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_consolidamento_seg: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_consolidamento_seg(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_consolidamento_seg (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_consolidamento_seg";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_consolidamento_seg.xsd";
	...
	tconsolidamentorendicontattivitaprogettoora.defineColumn("!idrendicontattivitaprogettoora_rendicontattivitaprogetto_rendicontattivitaprogettokind_title", typeof(string));
	...
	tconsolidamentorendicontattivitaprogettoora.defineColumn("!idrendicontattivitaprogettoora_rendicontattivitaprogetto_orepreventivate", typeof(int));
	tconsolidamentorendicontattivitaprogettoora.defineColumn("!idrendicontattivitaprogettoora_rendicontattivitaprogetto_datainizioprevista", typeof(DateTime));
	tconsolidamentorendicontattivitaprogettoora.defineColumn("!idrendicontattivitaprogettoora_rendicontattivitaprogetto_stop", typeof(DateTime));
