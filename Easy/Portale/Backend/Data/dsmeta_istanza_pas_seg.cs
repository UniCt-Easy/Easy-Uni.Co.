...
public class dsmeta_istanza_pas_seg: DataSet {
...
private void initClass() {
	...
	var cChild = new []{nullaosta_alias4.Columns["idistanza"], nullaosta_alias4.Columns["idistanzakind"], nullaosta_alias4.Columns["idreg"]};
	...
	cPar = new []{istanza.Columns["idistanza"], istanza.Columns["idistanzakind"], istanza.Columns["idreg_studenti"]};
	cChild = new []{pratica.Columns["idistanza"], pratica.Columns["idistanzakind"], pratica.Columns["idreg"]};
	...
	Relations.Add(new DataRelation("FK_istanza_pas_iscrizionedefaultview_alias1_idiscrizione_from",cPar,cChild,false));
	...
	cPar = new []{istanza.Columns["idistanza"], istanza.Columns["idistanzakind"], istanza.Columns["idreg_studenti"]};
	cChild = new []{istanza_pas.Columns["idistanza"], istanza_pas.Columns["idistanzakind"], istanza_pas.Columns["idreg"]};
	Relations.Add(new DataRelation("FK_istanza_pas_istanza_idistanza-idistanzakind-idreg-",cPar,cChild,false));
