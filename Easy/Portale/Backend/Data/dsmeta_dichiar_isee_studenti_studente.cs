...
[System.Xml.Serialization.XmlRoot("dsmeta_dichiar_isee_studenti_studente"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_dichiar_isee_studenti_studente: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_dichiar_isee_studenti_studente(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_dichiar_isee_studenti_studente (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_dichiar_isee_studenti_studente";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_dichiar_isee_studenti_studente.xsd";
	...
	var cPar = new []{dichiar.Columns["iddichiar"], dichiar.Columns["idreg"]};
	var cChild = new []{dichiar_isee.Columns["iddichiar"], dichiar_isee.Columns["idreg"]};
