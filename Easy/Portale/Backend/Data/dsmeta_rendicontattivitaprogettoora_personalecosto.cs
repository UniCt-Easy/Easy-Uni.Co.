...
[System.Xml.Serialization.XmlRoot("dsmeta_rendicontattivitaprogettoora_personalecosto"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_rendicontattivitaprogettoora_personalecosto: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_rendicontattivitaprogettoora_personalecosto(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_rendicontattivitaprogettoora_personalecosto (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_rendicontattivitaprogettoora_personalecosto";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_rendicontattivitaprogettoora_personalecosto.xsd";
	...
	Relations.Add(new DataRelation("FK_rendicontattivitaprogettoora_rendicontattivitaprogettopersonaleview_idrendicontattivitaprogetto",cPar,cChild,false));

	cPar = new []{workpackagesegview.Columns["idworkpackage"]};
	cChild = new []{rendicontattivitaprogettopersonaleview.Columns["idworkpackage"]};
	Relations.Add(new DataRelation("FK_rendicontattivitaprogettopersonaleview_workpackagesegview_idworkpackage",cPar,cChild,false));
