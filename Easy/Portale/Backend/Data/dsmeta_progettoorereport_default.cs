...
[System.Xml.Serialization.XmlRoot("dsmeta_progettoorereport_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_progettoorereport_default: DataSet {
	...
	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public MetaTable progettoorereport 		=> (MetaTable)Tables["progettoorereport"];
...
[DebuggerNonUserCode]
public dsmeta_progettoorereport_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_progettoorereport_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_progettoorereport_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_progettoorereport_default.xsd";
	...
	//////////////////// PROGETTOOREREPORT /////////////////////////////////
	var tprogettoorereport= new MetaTable("progettoorereport");
	tprogettoorereport.defineColumn("ct", typeof(DateTime));
	tprogettoorereport.defineColumn("cu", typeof(string));
	tprogettoorereport.defineColumn("idprogetto", typeof(int));
	tprogettoorereport.defineColumn("idprogettoorereport", typeof(int),false);
	tprogettoorereport.defineColumn("idreg", typeof(int));
	tprogettoorereport.defineColumn("idreg_user", typeof(int));
	tprogettoorereport.defineColumn("lt", typeof(DateTime));
	tprogettoorereport.defineColumn("lu", typeof(string));
	tprogettoorereport.defineColumn("start", typeof(DateTime));
	tprogettoorereport.defineColumn("stop", typeof(DateTime));
	tprogettoorereport.defineColumn("year", typeof(int));
	Tables.Add(tprogettoorereport);
	tprogettoorereport.defineKey("idprogettoorereport");
	...
	var cChild = new []{progettoorereport.Columns["idreg_user"]};
	Relations.Add(new DataRelation("FK_progettoorereport_registry_idreg_user",cPar,cChild,false));

	cPar = new []{getregistrydocentiamministrativiprjnomcognmatview.Columns["idreg"]};
	cChild = new []{progettoorereport.Columns["idreg"]};
	Relations.Add(new DataRelation("FK_progettoorereport_getregistrydocentiamministrativiprjnomcognmatview_idreg",cPar,cChild,false));

	cPar = new []{progettoelenchiview.Columns["idprogetto"]};
	cChild = new []{progettoorereport.Columns["idprogetto"]};
	Relations.Add(new DataRelation("FK_progettoorereport_progettoelenchiview_idprogetto",cPar,cChild,false));

	cPar = new []{year.Columns["year"]};
	cChild = new []{progettoorereport.Columns["year"]};
	Relations.Add(new DataRelation("FK_progettoorereport_year_year",cPar,cChild,false));
