...
[System.Xml.Serialization.XmlRoot("dsmeta_sospensione_aulapublic"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_sospensione_aulapublic: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_sospensione_aulapublic(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_sospensione_aulapublic (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_sospensione_aulapublic";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_sospensione_aulapublic.xsd";
