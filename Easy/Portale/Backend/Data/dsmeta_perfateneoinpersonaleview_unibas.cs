...
[System.Xml.Serialization.XmlRoot("dsmeta_perfateneoinpersonaleview_unibas"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_perfateneoinpersonaleview_unibas: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfateneoinpersonaleview_unibas(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfateneoinpersonaleview_unibas (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfateneoinpersonaleview_unibas";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfateneoinpersonaleview_unibas.xsd";
