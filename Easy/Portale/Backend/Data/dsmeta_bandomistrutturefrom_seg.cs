...
[System.Xml.Serialization.XmlRoot("dsmeta_bandomistrutturefrom_seg"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_bandomistrutturefrom_seg: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_bandomistrutturefrom_seg(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_bandomistrutturefrom_seg (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_bandomistrutturefrom_seg";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_bandomistrutturefrom_seg.xsd";
	...
	this.defineRelation("FK_bandomistrutturefrom_strutturadefaultview_idstruttura","strutturadefaultview","bandomistrutturefrom","idstruttura");
	#endregion
