...
[System.Xml.Serialization.XmlRoot("dsmeta_attach_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_attach_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_attach_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_attach_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_attach_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_attach_default.xsd";
