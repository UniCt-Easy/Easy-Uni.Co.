...
[System.Xml.Serialization.XmlRoot("dsmeta_iscrizione_segsing"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_iscrizione_segsing: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_iscrizione_segsing(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_iscrizione_segsing (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_iscrizione_segsing";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_iscrizione_segsing.xsd";
	...
	tpianostudio_alias1.defineColumn("!pianostudioattivform_alias1", typeof(string));
	...
	cPar = new []{sostenimento_alias1.Columns["idsostenimento"]};
	cChild = new []{pianostudioattivform_alias1.Columns["idsostenimento"]};
	Relations.Add(new DataRelation("FK_pianostudioattivform_alias1_sostenimento_alias1_idsostenimento",cPar,cChild,false));
