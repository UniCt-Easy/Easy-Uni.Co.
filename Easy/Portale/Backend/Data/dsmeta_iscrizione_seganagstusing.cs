...
public partial class dsmeta_iscrizione_seganagstusing: DataSet {
...
private void initClass() {
	...
	tsostenimento_alias2.defineKey("idiscrizione", "idreg", "idsostenimento");
	...
	var cChild = new []{pianostudio_alias1.Columns["idiscrizione"], pianostudio_alias1.Columns["idreg"]};
	...
	Relations.Add(new DataRelation("FK_pianostudioattivform_alias1_sostenimento_alias2_idsostenimento",cPar,cChild,false));
