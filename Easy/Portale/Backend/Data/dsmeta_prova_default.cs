...
[System.Xml.Serialization.XmlRoot("dsmeta_prova_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_prova_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_prova_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_prova_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_prova_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_prova_default.xsd";
	...
	Relations.Add(new DataRelation("FK_sostenimento_registry_alias3_idreg",cPar,cChild,false));
