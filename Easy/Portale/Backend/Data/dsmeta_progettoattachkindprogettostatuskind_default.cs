...
[System.Xml.Serialization.XmlRoot("dsmeta_progettoattachkindprogettostatuskind_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_progettoattachkindprogettostatuskind_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_progettoattachkindprogettostatuskind_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_progettoattachkindprogettostatuskind_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_progettoattachkindprogettostatuskind_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_progettoattachkindprogettostatuskind_default.xsd";
	...
	var cChild = new []{progettoattachkindprogettostatuskind.Columns["idprogettostatuskind"]};
