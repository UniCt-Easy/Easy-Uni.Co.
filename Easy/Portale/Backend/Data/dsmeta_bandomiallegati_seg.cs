...
[System.Xml.Serialization.XmlRoot("dsmeta_bandomiallegati_seg"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_bandomiallegati_seg: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_bandomiallegati_seg(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_bandomiallegati_seg (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_bandomiallegati_seg";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_bandomiallegati_seg.xsd";
