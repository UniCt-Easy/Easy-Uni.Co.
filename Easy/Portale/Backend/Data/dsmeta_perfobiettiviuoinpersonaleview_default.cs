...
[System.Xml.Serialization.XmlRoot("dsmeta_perfobiettiviuoinpersonaleview_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_perfobiettiviuoinpersonaleview_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfobiettiviuoinpersonaleview_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfobiettiviuoinpersonaleview_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfobiettiviuoinpersonaleview_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfobiettiviuoinpersonaleview_default.xsd";
