...
[System.Xml.Serialization.XmlRoot("dsmeta_contratto_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_contratto_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_contratto_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_contratto_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_contratto_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_contratto_default.xsd";
