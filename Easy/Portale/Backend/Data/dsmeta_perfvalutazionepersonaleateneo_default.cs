...
[System.Xml.Serialization.XmlRoot("dsmeta_perfvalutazionepersonaleateneo_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_perfvalutazionepersonaleateneo_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfvalutazionepersonaleateneo_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfvalutazionepersonaleateneo_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfvalutazionepersonaleateneo_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfvalutazionepersonaleateneo_default.xsd";
