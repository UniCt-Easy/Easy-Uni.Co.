...
[System.Xml.Serialization.XmlRoot("dsmeta_perfvalutazioneuo_onlyunatantumpunteggio"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_perfvalutazioneuo_onlyunatantumpunteggio: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfvalutazioneuo_onlyunatantumpunteggio(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfvalutazioneuo_onlyunatantumpunteggio (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfvalutazioneuo_onlyunatantumpunteggio";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfvalutazioneuo_onlyunatantumpunteggio.xsd";
	...
	tgetdocentiamministrativiresponsabilidefaultview_alias2.defineColumn("getdocentiamministrativiresponsabili_resplevel", typeof(long));
	...
	tgetdocentiamministrativiresponsabilidefaultview_alias2.defineColumn("getdocentiamministrativiresponsabili_start", typeof(DateTime));
	tgetdocentiamministrativiresponsabilidefaultview_alias2.defineColumn("getdocentiamministrativiresponsabili_stop", typeof(DateTime));
	tgetdocentiamministrativiresponsabilidefaultview_alias2.defineColumn("getdocentiamministrativiresponsabili_struttura", typeof(string));
	...
	tgetdocentiamministrativiresponsabilidefaultview_alias2.defineColumn("struttura_idstrutturakind", typeof(int));
	tgetdocentiamministrativiresponsabilidefaultview_alias2.defineColumn("struttura_title", typeof(string));
	tgetdocentiamministrativiresponsabilidefaultview_alias2.defineColumn("strutturakind_title", typeof(string));
	...
	tperfobiettiviuo.defineColumn("!perfobiettiviuoattach", typeof(string));
	...
	tperfvalutazioneuo.defineColumn("!risultatooriginale", typeof(decimal));
