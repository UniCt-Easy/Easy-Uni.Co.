...
[System.Xml.Serialization.XmlRoot("dsmeta_affidamentocaratteristicaora_seg"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_affidamentocaratteristicaora_seg: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_affidamentocaratteristicaora_seg(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_affidamentocaratteristicaora_seg (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_affidamentocaratteristicaora_seg";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_affidamentocaratteristicaora_seg.xsd";
