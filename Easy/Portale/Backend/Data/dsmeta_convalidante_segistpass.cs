...
[System.Xml.Serialization.XmlRoot("dsmeta_convalidante_segistpass"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_convalidante_segistpass: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_convalidante_segistpass(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_convalidante_segistpass (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_convalidante_segistpass";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_convalidante_segistpass.xsd";
