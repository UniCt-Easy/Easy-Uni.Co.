...
[System.Xml.Serialization.XmlRoot("dsmeta_aula_public"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_aula_public: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_aula_public(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_aula_public (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_aula_public";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_aula_public.xsd";
