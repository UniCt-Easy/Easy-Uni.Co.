...
[System.Xml.Serialization.XmlRoot("dsmeta_costoorario_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_costoorario_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_costoorario_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_costoorario_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_costoorario_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_costoorario_default.xsd";
