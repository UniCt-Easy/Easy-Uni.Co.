...
public partial class dsmeta_istanza_abbr_seg: DataSet {
...
private void initClass() {
	...
	tistanza_abbr.defineColumn("idcorsostudio", typeof(int),false);
	...
	tistanza_abbr.defineKey("idcorsostudio", "iddidprog", "idiscrizione", "idistanza", "idistanzakind", "idreg");
	...
	Relations.Add(new DataRelation("FK_istanza_abbr_dichiarsegview_iddichiar",cPar,cChild,false));
	...
	cPar = new []{istanza.Columns["idcorsostudio"], istanza.Columns["iddidprog"], istanza.Columns["idiscrizione"], istanza.Columns["idistanza"], istanza.Columns["idistanzakind"], istanza.Columns["idreg_studenti"]};
	cChild = new []{istanza_abbr.Columns["idcorsostudio"], istanza_abbr.Columns["iddidprog"], istanza_abbr.Columns["idiscrizione"], istanza_abbr.Columns["idistanza"], istanza_abbr.Columns["idistanzakind"], istanza_abbr.Columns["idreg"]};
	Relations.Add(new DataRelation("FK_istanza_abbr_istanza_idcorsostudio-iddidprog-idiscrizione-idistanza-idistanzakind-idreg",cPar,cChild,false));
