...
[System.Xml.Serialization.XmlRoot("dsmeta_menuweb_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_menuweb_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_menuweb_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_menuweb_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_menuweb_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_menuweb_default.xsd";
	...
	Relations.Add(new DataRelation("FK_menuweb_menuwebdefaultview_idmenuwebparent",cPar,cChild,false));
