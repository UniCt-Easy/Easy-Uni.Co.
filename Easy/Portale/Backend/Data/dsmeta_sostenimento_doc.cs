...
[System.Xml.Serialization.XmlRoot("dsmeta_sostenimento_doc"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_sostenimento_doc: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_sostenimento_doc(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_sostenimento_doc (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_sostenimento_doc";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_sostenimento_doc.xsd";
