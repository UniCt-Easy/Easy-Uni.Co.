...
[System.Xml.Serialization.XmlRoot("dsmeta_assetconsignsub_adminembedded"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_assetconsignsub_adminembedded: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_assetconsignsub_adminembedded(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_assetconsignsub_adminembedded (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_assetconsignsub_adminembedded";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_assetconsignsub_adminembedded.xsd";
