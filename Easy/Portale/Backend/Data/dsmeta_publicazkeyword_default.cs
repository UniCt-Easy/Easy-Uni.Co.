...
[System.Xml.Serialization.XmlRoot("dsmeta_publicazkeyword_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_publicazkeyword_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_publicazkeyword_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_publicazkeyword_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_publicazkeyword_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_publicazkeyword_default.xsd";
