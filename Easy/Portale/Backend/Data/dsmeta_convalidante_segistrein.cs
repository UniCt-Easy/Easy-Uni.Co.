...
[System.Xml.Serialization.XmlRoot("dsmeta_convalidante_segistrein"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_convalidante_segistrein: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_convalidante_segistrein(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_convalidante_segistrein (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_convalidante_segistrein";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_convalidante_segistrein.xsd";
