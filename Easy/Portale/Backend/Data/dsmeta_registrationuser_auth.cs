...
[DebuggerNonUserCode]
public dsmeta_registrationuser_auth(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_registrationuser_auth (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_registrationuser_auth";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_registrationuser_auth.xsd";
