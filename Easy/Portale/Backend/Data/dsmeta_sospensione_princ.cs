...
[System.Xml.Serialization.XmlRoot("dsmeta_sospensione_princ"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_sospensione_princ: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_sospensione_princ(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_sospensione_princ (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_sospensione_princ";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_sospensione_princ.xsd";
