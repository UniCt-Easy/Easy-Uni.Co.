...
public partial class dsmeta_progettotipocostokindcontrattokind_seg: DataSet {
...
private void initClass() {
	...
	var cChild = new []{progettotipocostokindcontrattokind.Columns["idposition"]};
	Relations.Add(new DataRelation("FK_progettotipocostokindcontrattokind_positiondefaultview_idposition",cPar,cChild,false));
