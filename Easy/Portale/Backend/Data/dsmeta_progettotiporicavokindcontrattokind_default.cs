...
public class dsmeta_progettotiporicavokindcontrattokind_default: DataSet {
...
private void initClass() {
	...
	var cChild = new []{progettotiporicavokindcontrattokind.Columns["idcontrattokind"]};
	Relations.Add(new DataRelation("FK_progettotiporicavokindcontrattokind_contrattokinddefaultview_idcontrattokind",cPar,cChild,false));
