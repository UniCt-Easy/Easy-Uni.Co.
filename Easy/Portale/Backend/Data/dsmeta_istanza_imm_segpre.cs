...
[System.Xml.Serialization.XmlRoot("dsmeta_istanza_imm_segpre"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_istanza_imm_segpre: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_istanza_imm_segpre(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_istanza_imm_segpre (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_istanza_imm_segpre";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_istanza_imm_segpre.xsd";
	...
	var cPar = new []{istanza.Columns["idistanza"], istanza.Columns["idreg_studenti"], istanza.Columns["idcorsostudio"], istanza.Columns["iddidprog"], istanza.Columns["idistanzakind"]};
	var cChild = new []{diniego_alias2.Columns["idistanza"], diniego_alias2.Columns["idreg"], diniego_alias2.Columns["idcorsostudio"], diniego_alias2.Columns["iddidprog"], diniego_alias2.Columns["idistanzakind"]};
	Relations.Add(new DataRelation("FK_diniego_alias2_istanza_idistanza-idreg-idcorsostudio-iddidprog-idistanzakind",cPar,cChild,false));
	...
	Relations.Add(new DataRelation("FK_nullaosta_istanza_idcorsostudio-iddidprog-idistanza-idistanzakind-idreg",cPar,cChild,false));
