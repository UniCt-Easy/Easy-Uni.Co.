...
[System.Xml.Serialization.XmlRoot("dsmeta_costoscontodef_more"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_costoscontodef_more: DataSet {
	...
	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public MetaTable costoscontodefkinddefaultview 		=> (MetaTable)Tables["costoscontodefkinddefaultview"];
...
[DebuggerNonUserCode]
public dsmeta_costoscontodef_more(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_costoscontodef_more (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_costoscontodef_more";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_costoscontodef_more.xsd";
	...
	//////////////////// COSTOSCONTODEFKINDDEFAULTVIEW /////////////////////////////////
	var tcostoscontodefkinddefaultview= new MetaTable("costoscontodefkinddefaultview");
	tcostoscontodefkinddefaultview.defineColumn("costoscontodefkind_active", typeof(string));
	tcostoscontodefkinddefaultview.defineColumn("costoscontodefkind_ct", typeof(DateTime),false);
	tcostoscontodefkinddefaultview.defineColumn("costoscontodefkind_cu", typeof(string),false);
	tcostoscontodefkinddefaultview.defineColumn("costoscontodefkind_description", typeof(string));
	tcostoscontodefkinddefaultview.defineColumn("costoscontodefkind_lt", typeof(DateTime),false);
	tcostoscontodefkinddefaultview.defineColumn("costoscontodefkind_lu", typeof(string),false);
	tcostoscontodefkinddefaultview.defineColumn("costoscontodefkind_sortcode", typeof(int),false);
	tcostoscontodefkinddefaultview.defineColumn("dropdown_title", typeof(string),false);
	tcostoscontodefkinddefaultview.defineColumn("idcostoscontodefkind", typeof(int),false);
	tcostoscontodefkinddefaultview.defineColumn("title", typeof(string),false);
	Tables.Add(tcostoscontodefkinddefaultview);
	tcostoscontodefkinddefaultview.defineKey("idcostoscontodefkind");
	...
	cPar = new []{costoscontodefkinddefaultview.Columns["idcostoscontodefkind"]};
	cChild = new []{costoscontodef.Columns["idcostoscontodefkind"]};
	Relations.Add(new DataRelation("FK_costoscontodef_costoscontodefkinddefaultview_idcostoscontodefkind",cPar,cChild,false));
