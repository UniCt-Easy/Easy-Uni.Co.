...
[System.Xml.Serialization.XmlRoot("dsmeta_affidamento_seg"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_affidamento_seg: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_affidamento_seg(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_affidamento_seg (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_affidamento_seg";
	Prefix = "";
