...
[System.Xml.Serialization.XmlRoot("dsmeta_esonerostudente_stu"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_esonerostudente_stu: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_esonerostudente_stu(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_esonerostudente_stu (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_esonerostudente_stu";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_esonerostudente_stu.xsd";
