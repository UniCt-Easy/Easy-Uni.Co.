...
[System.Xml.Serialization.XmlRoot("dsmeta_attivformcaratteristicaora_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_attivformcaratteristicaora_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_attivformcaratteristicaora_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_attivformcaratteristicaora_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_attivformcaratteristicaora_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_attivformcaratteristicaora_default.xsd";
