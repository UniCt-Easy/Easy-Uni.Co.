...
[System.Xml.Serialization.XmlRoot("dsmeta_perfrequestobbunatantumsoglia_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_perfrequestobbunatantumsoglia_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfrequestobbunatantumsoglia_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfrequestobbunatantumsoglia_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfrequestobbunatantumsoglia_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfrequestobbunatantumsoglia_default.xsd";
	...
	var cChild = new []{perfrequestobbunatantumsoglia.Columns["idperfsogliakind"]};
