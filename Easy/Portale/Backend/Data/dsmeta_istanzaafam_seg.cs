...
[System.Xml.Serialization.XmlRoot("dsmeta_istanzaafam_seg"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_istanzaafam_seg: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_istanzaafam_seg(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_istanzaafam_seg (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_istanzaafam_seg";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_istanzaafam_seg.xsd";
	...
	Relations.Add(new DataRelation("FK_servizioaltro_istanzaafam_idreg",cPar,cChild,false));

	cPar = new []{istanzaafam.Columns["idreg"]};
	cChild = new []{servizioricongiunzioni.Columns["idreg"]};
	Relations.Add(new DataRelation("FK_servizioricongiunzioni_istanzaafam_idreg",cPar,cChild,false));

	cPar = new []{istanzaafam.Columns["idreg"]};
	cChild = new []{serviziomilitare.Columns["idreg"]};
	Relations.Add(new DataRelation("FK_serviziomilitare_istanzaafam_idreg",cPar,cChild,false));
	...
	Relations.Add(new DataRelation("FK_serviziocontributi_istanzaafam_idreg",cPar,cChild,false));

	cPar = new []{istanzaafam.Columns["idreg"]};
	cChild = new []{serviziopreruoloinps.Columns["idreg"]};
	Relations.Add(new DataRelation("FK_serviziopreruoloinps_istanzaafam_idreg",cPar,cChild,false));
	...
	Relations.Add(new DataRelation("FK_serviziopreruolotesoro_istanzaafam_idreg",cPar,cChild,false));
	...
	cChild = new []{istanzaafam.Columns["idreg"]};
	Relations.Add(new DataRelation("FK_istanzaafam_registrydefaultview_idreg",cPar,cChild,false));
