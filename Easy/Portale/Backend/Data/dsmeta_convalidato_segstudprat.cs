...
[DebuggerNonUserCode]
public dsmeta_convalidato_segstudprat(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_convalidato_segstudprat (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_convalidato_segstudprat";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_convalidato_segstudprat.xsd";
