...
[System.Xml.Serialization.XmlRoot("dsmeta_accreditokind_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_accreditokind_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_accreditokind_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_accreditokind_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_accreditokind_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_accreditokind_default.xsd";
