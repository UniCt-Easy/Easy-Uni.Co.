...
[System.Xml.Serialization.XmlRoot("registrypaymethod_anagrafica"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class registrypaymethod_anagrafica: DataSet {
...
[DebuggerNonUserCode]
public registrypaymethod_anagrafica(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected registrypaymethod_anagrafica (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "registrypaymethod_anagrafica";
	Prefix = "";
	Namespace = "http://tempuri.org/registrypaymethod_anagrafica.xsd";
