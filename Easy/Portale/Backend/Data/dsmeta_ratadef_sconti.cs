...
[System.Xml.Serialization.XmlRoot("dsmeta_ratadef_sconti"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_ratadef_sconti: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_ratadef_sconti(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_ratadef_sconti (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_ratadef_sconti";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_ratadef_sconti.xsd";
