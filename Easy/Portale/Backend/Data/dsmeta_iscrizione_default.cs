...
[System.Xml.Serialization.XmlRoot("dsmeta_iscrizione_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_iscrizione_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_iscrizione_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_iscrizione_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_iscrizione_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_iscrizione_default.xsd";
