...
[System.Xml.Serialization.XmlRoot("dsmeta_perfprogettocambiostatoperfruolo_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_perfprogettocambiostatoperfruolo_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfprogettocambiostatoperfruolo_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfprogettocambiostatoperfruolo_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfprogettocambiostatoperfruolo_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfprogettocambiostatoperfruolo_default.xsd";
	...
	var cChild = new []{perfprogettocambiostatoperfruolo.Columns["idperfruolo"]};
	Relations.Add(new DataRelation("FK_perfprogettocambiostatoperfruolo_perfruolodefaultview_idperfruolo",cPar,cChild,false));
