...
[DebuggerNonUserCode]
public dsmeta_iscrizioneanno_didprog(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_iscrizioneanno_didprog (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_iscrizioneanno_didprog";
	Prefix = "";
