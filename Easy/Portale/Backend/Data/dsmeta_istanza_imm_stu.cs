...
[System.Xml.Serialization.XmlRoot("dsmeta_istanza_imm_stu"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_istanza_imm_stu: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_istanza_imm_stu(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_istanza_imm_stu (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_istanza_imm_stu";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_istanza_imm_stu.xsd";
	...
	var cPar = new []{istanza_imm.Columns["idistanza"], istanza_imm.Columns["idistanzakind"], istanza_imm.Columns["idreg_studenti"]};
	var cChild = new []{diniego_alias1.Columns["idistanza"], diniego_alias1.Columns["idistanzakind"], diniego_alias1.Columns["idreg"]};
	Relations.Add(new DataRelation("FK_diniego_alias1_istanza_imm_idistanza-idistanzakind-idreg",cPar,cChild,false));

	cPar = new []{istanza_imm.Columns["idcorsostudio"], istanza_imm.Columns["iddidprog"], istanza_imm.Columns["idistanza"], istanza_imm.Columns["idistanzakind"], istanza_imm.Columns["idreg_studenti"]};
	...
	Relations.Add(new DataRelation("FK_nullaosta_alias1_istanza_imm_idcorsostudio-iddidprog-idistanza-idistanzakind-idreg",cPar,cChild,false));
