...
[System.Xml.Serialization.XmlRoot("dsmeta_bandomididprogto_seg"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_bandomididprogto_seg: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_bandomididprogto_seg(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_bandomididprogto_seg (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_bandomididprogto_seg";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_bandomididprogto_seg.xsd";
	...
	this.defineRelation("FK_bandomididprogto_didprogdefaultview_iddidprog","didprogdefaultview","bandomididprogto","iddidprog");
	#endregion
