...
[System.Xml.Serialization.XmlRoot("dsmeta_istanzaafamattach_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_istanzaafamattach_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_istanzaafamattach_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_istanzaafamattach_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_istanzaafamattach_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_istanzaafamattach_default.xsd";
	...
	var cChild = new []{istanzaafamattach.Columns["idattach"]};
