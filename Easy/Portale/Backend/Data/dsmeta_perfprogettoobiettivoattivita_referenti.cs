...
[DebuggerNonUserCode]
public dsmeta_perfprogettoobiettivoattivita_referenti(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfprogettoobiettivoattivita_referenti (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfprogettoobiettivoattivita_referenti";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfprogettoobiettivoattivita_referenti.xsd";
	...
	cChild = new []{perfprogettoobiettivodefaultview.Columns["idperfprogetto"]};
	Relations.Add(new DataRelation("FK_perfprogettoobiettivodefaultview_perfprogettodefaultview_idperfprogetto",cPar,cChild,false));
