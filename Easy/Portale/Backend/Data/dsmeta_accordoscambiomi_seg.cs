...
public partial class dsmeta_accordoscambiomi_seg: DataSet {
...
private void initClass() {
	...
	taccordoscambiomidettaz.defineColumn("!idreg_aziende_registry_title", typeof(string));
	...
	taccordoscambiomiporzanno.ExtendedProperties["NotEntityChild"]="true";
	...
	ttorkind.defineColumn("active", typeof(string),false);
	...
	taccordoscambiomidett.defineColumn("!idreg_istitutiesteri_registry_title", typeof(string));
	...
	var cChild = new []{accordoscambiomidettaz.Columns["idaccordoscambiomi"]};
	...
	cChild = new []{cefrlanglevel_alias1.Columns["idaccordoscambiomi"], cefrlanglevel_alias1.Columns["idaccordoscambiomidettaz"]};
	Relations.Add(new DataRelation("FK_cefrlanglevel_alias1_accordoscambiomidettaz_idaccordoscambiomi-idaccordoscambiomidettaz",cPar,cChild,false));

	cPar = new []{registry_alias1.Columns["idreg"]};
	cChild = new []{accordoscambiomidettaz.Columns["idreg_aziende"]};
	Relations.Add(new DataRelation("FK_accordoscambiomidettaz_registry_alias1_idreg_aziende",cPar,cChild,false));

	cPar = new []{accordoscambiomi.Columns["idaccordoscambiomi"]};
	cChild = new []{accordoscambiomidett.Columns["idaccordoscambiomi"]};
	...
	cChild = new []{cefrlanglevel.Columns["idaccordoscambiomi"], cefrlanglevel.Columns["idaccordoscambiomidett"]};
	...
	Relations.Add(new DataRelation("FK_accordoscambiomidett_registry_idreg_istitutiesteri",cPar,cChild,false));
