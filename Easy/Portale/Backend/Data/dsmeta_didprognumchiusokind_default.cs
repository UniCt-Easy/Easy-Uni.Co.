...
[System.Xml.Serialization.XmlRoot("dsmeta_didprognumchiusokind_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_didprognumchiusokind_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_didprognumchiusokind_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_didprognumchiusokind_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_didprognumchiusokind_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_didprognumchiusokind_default.xsd";
