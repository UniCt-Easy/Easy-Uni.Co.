...
[System.Xml.Serialization.XmlRoot("dsmeta_aoo_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_aoo_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_aoo_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_aoo_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_aoo_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_aoo_default.xsd";
