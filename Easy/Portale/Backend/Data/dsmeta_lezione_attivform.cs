...
[DebuggerNonUserCode]
public dsmeta_lezione_attivform(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_lezione_attivform (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_lezione_attivform";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_lezione_attivform.xsd";
