...
[System.Xml.Serialization.XmlRoot("dsmeta_contrattostipendioview_tfr"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_contrattostipendioview_tfr: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_contrattostipendioview_tfr(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_contrattostipendioview_tfr (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_contrattostipendioview_tfr";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_contrattostipendioview_tfr.xsd";
	...
	cPar = new []{registrylegalstatusdefaultview.Columns["idregistrylegalstatus"], registrylegalstatusdefaultview.Columns["idreg"] };
	cChild = new []{contrattostipendioview.Columns["idregistrylegalstatus"], contrattostipendioview.Columns["idreg"] };
