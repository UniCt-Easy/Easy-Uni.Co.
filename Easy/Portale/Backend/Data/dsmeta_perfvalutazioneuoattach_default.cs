...
[System.Xml.Serialization.XmlRoot("dsmeta_perfvalutazioneuoattach_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_perfvalutazioneuoattach_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfvalutazioneuoattach_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfvalutazioneuoattach_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfvalutazioneuoattach_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfvalutazioneuoattach_default.xsd";
	...
	var cChild = new []{perfvalutazioneuoattach.Columns["idattach"]};
