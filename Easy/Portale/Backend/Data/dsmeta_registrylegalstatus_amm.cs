...
[System.Xml.Serialization.XmlRoot("dsmeta_registrylegalstatus_amm"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_registrylegalstatus_amm: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_registrylegalstatus_amm(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_registrylegalstatus_amm (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_registrylegalstatus_amm";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_registrylegalstatus_amm.xsd";
