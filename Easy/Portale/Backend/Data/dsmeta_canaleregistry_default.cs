...
[System.Xml.Serialization.XmlRoot("dsmeta_canaleregistry_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_canaleregistry_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_canaleregistry_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_canaleregistry_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_canaleregistry_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_canaleregistry_default.xsd";
	...
	var cChild = new []{canaleregistry.Columns["idreg"]};
	Relations.Add(new DataRelation("FK_canaleregistry_registrystudentiview_idreg",cPar,cChild,false));
