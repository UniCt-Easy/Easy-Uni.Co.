...
[DebuggerNonUserCode]
public dsmeta_fasciaiseedef_more(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_fasciaiseedef_more (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_fasciaiseedef_more";
	Prefix = "";
