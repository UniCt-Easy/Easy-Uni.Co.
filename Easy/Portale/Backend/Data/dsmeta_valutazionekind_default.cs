...
[System.Xml.Serialization.XmlRoot("dsmeta_valutazionekind_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_valutazionekind_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_valutazionekind_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_valutazionekind_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_valutazionekind_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_valutazionekind_default.xsd";
