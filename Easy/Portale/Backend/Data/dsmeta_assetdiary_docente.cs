...
[System.Xml.Serialization.XmlRoot("dsmeta_assetdiary_docente"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_assetdiary_docente: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_assetdiary_docente(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_assetdiary_docente (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_assetdiary_docente";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_assetdiary_docente.xsd";
	...
	tprogettosegview.defineColumn("progetto_respamministrativi", typeof(string));
	...
	tprogettosegview.defineColumn("progetto_respscientifici", typeof(string));
