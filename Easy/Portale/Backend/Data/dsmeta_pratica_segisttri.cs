...
[System.Xml.Serialization.XmlRoot("dsmeta_pratica_segisttri"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_pratica_segisttri: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_pratica_segisttri(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_pratica_segisttri (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_pratica_segisttri";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_pratica_segisttri.xsd";
