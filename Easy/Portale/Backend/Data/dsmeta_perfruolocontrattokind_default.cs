...
[System.Xml.Serialization.XmlRoot("dsmeta_perfruolocontrattokind_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_perfruolocontrattokind_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfruolocontrattokind_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfruolocontrattokind_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfruolocontrattokind_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfruolocontrattokind_default.xsd";
	...
	var cChild = new []{perfruolocontrattokind.Columns["idcontrattokind"]};
	Relations.Add(new DataRelation("FK_perfruolocontrattokind_contrattokinddefaultview_idcontrattokind",cPar,cChild,false));
