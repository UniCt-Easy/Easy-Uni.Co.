...
public partial class dsmeta_perfruolocontrattokind_default: DataSet {
...
private void initClass() {
	...
	var cChild = new []{perfruolocontrattokind.Columns["idposition"]};
	Relations.Add(new DataRelation("FK_perfruolocontrattokind_positiondefaultview_idposition",cPar,cChild,false));
