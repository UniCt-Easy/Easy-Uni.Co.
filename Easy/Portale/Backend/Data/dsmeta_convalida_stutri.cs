...
[System.Xml.Serialization.XmlRoot("dsmeta_convalida_stutri"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_convalida_stutri: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_convalida_stutri(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_convalida_stutri (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_convalida_stutri";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_convalida_stutri.xsd";
