...
[System.Xml.Serialization.XmlRoot("dsmeta_perfcomportamento_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_perfcomportamento_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfcomportamento_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfcomportamento_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfcomportamento_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfcomportamento_default.xsd";
	...
	var cPar = new []{perfcomportamento.Columns["idperfcomportamento"]};
	var cChild = new []{perfcomportamentosoglia.Columns["idperfcomportamento"]};
	Relations.Add(new DataRelation("FK_perfcomportamentosoglia_perfcomportamento_idperfcomportamento",cPar,cChild,false));
	...
	cChild = new []{perfcomportamentosoglia.Columns["idperfsogliakind"]};
