...
[System.Xml.Serialization.XmlRoot("dsmeta_pianostudioattivform_segstud"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_pianostudioattivform_segstud: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_pianostudioattivform_segstud(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_pianostudioattivform_segstud (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_pianostudioattivform_segstud";
	Prefix = "";
