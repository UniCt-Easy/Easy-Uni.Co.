...
[System.Xml.Serialization.XmlRoot("dsmeta_registrylegalstatus_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_registrylegalstatus_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_registrylegalstatus_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_registrylegalstatus_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_registrylegalstatus_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_registrylegalstatus_default.xsd";
