...
[System.Xml.Serialization.XmlRoot("dsmeta_issuesq_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_issuesq_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_issuesq_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_issuesq_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_issuesq_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_issuesq_default.xsd";
