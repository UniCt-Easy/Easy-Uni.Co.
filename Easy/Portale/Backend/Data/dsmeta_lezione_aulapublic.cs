...
[System.Xml.Serialization.XmlRoot("dsmeta_lezione_aulapublic"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_lezione_aulapublic: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_lezione_aulapublic(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_lezione_aulapublic (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_lezione_aulapublic";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_lezione_aulapublic.xsd";
