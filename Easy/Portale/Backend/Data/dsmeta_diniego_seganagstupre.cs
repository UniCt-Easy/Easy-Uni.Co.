...
[DebuggerNonUserCode]
public dsmeta_diniego_seganagstupre(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_diniego_seganagstupre (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_diniego_seganagstupre";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_diniego_seganagstupre.xsd";
