...
[System.Xml.Serialization.XmlRoot("dsmeta_diniego_stutru"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_diniego_stutru: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_diniego_stutru(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_diniego_stutru (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_diniego_stutru";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_diniego_stutru.xsd";
