...
[System.Xml.Serialization.XmlRoot("dsmeta_pianostudioattivform_seganagstu"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_pianostudioattivform_seganagstu: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_pianostudioattivform_seganagstu(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_pianostudioattivform_seganagstu (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_pianostudioattivform_seganagstu";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_pianostudioattivform_seganagstu.xsd";
