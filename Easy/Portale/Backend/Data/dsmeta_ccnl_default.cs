...
[System.Xml.Serialization.XmlRoot("dsmeta_ccnl_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_ccnl_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_ccnl_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_ccnl_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_ccnl_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_ccnl_default.xsd";
