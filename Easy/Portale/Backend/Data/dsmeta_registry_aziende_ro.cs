...
[DebuggerNonUserCode]
public dsmeta_registry_aziende_ro(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_registry_aziende_ro (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_registry_aziende_ro";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_registry_aziende_ro.xsd";
