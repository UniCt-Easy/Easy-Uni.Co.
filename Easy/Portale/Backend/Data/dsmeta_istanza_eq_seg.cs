...
public partial class dsmeta_istanza_eq_seg: DataSet {
...
private void initClass() {
	...
	var cChild = new []{nullaosta.Columns["idcorsostudio"], nullaosta.Columns["iddidprog"], nullaosta.Columns["idistanza"], nullaosta.Columns["idistanzakind"], nullaosta.Columns["idreg"]};
	...
	cChild = new []{dichiartitolo_segview.Columns["idreg"]};
	Relations.Add(new DataRelation("FK_dichiartitolo_segview_registrystudentiview_idreg",cPar,cChild,false));
