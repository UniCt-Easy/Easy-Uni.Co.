...
[System.Xml.Serialization.XmlRoot("dsmeta_pcscessazioniview_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_pcscessazioniview_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_pcscessazioniview_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_pcscessazioniview_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_pcscessazioniview_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_pcscessazioniview_default.xsd";
