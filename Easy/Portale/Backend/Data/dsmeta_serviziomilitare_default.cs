...
[System.Xml.Serialization.XmlRoot("dsmeta_serviziomilitare_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_serviziomilitare_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_serviziomilitare_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_serviziomilitare_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_serviziomilitare_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_serviziomilitare_default.xsd";
