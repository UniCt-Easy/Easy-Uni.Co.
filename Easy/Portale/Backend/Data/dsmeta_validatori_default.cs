...
[System.Xml.Serialization.XmlRoot("dsmeta_validatori_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_validatori_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_validatori_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_validatori_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_validatori_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_validatori_default.xsd";
