...
[System.Xml.Serialization.XmlRoot("dsmeta_titolostudio_studenti_studente"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_titolostudio_studenti_studente: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_titolostudio_studenti_studente(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_titolostudio_studenti_studente (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_titolostudio_studenti_studente";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_titolostudio_studenti_studente.xsd";
