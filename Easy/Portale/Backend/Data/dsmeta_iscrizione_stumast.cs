...
[System.Xml.Serialization.XmlRoot("dsmeta_iscrizione_stumast"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_iscrizione_stumast: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_iscrizione_stumast(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_iscrizione_stumast (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_iscrizione_stumast";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_iscrizione_stumast.xsd";
