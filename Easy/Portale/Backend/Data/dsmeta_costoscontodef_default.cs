...
[System.Xml.Serialization.XmlRoot("dsmeta_costoscontodef_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_costoscontodef_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_costoscontodef_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_costoscontodef_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_costoscontodef_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_costoscontodef_default.xsd";
