...
[System.Xml.Serialization.XmlRoot("dsmeta_perfprogettoattivitainterazione_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_perfprogettoattivitainterazione_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfprogettoattivitainterazione_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfprogettoattivitainterazione_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfprogettoattivitainterazione_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfprogettoattivitainterazione_default.xsd";
	...
	var cChild = new []{perfprogettoattivitainterazione.Columns["idperfinterazionekind"]};
	Relations.Add(new DataRelation("FK_perfprogettoattivitainterazione_perfinterazionekind_idperfinterazionekind",cPar,cChild,false));
