...
[System.Xml.Serialization.XmlRoot("dsmeta_istanza_imm_seganagstupre"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_istanza_imm_seganagstupre: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_istanza_imm_seganagstupre(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_istanza_imm_seganagstupre (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_istanza_imm_seganagstupre";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_istanza_imm_seganagstupre.xsd";
	...
	tistanzadichiar.defineColumn("!iddichiar_annoaccademico_alias2_aa", typeof(string));
	...
	tistanzadichiar.ExtendedProperties["filter"]="idistanzakind = 13";
	...
	tnullaosta_imm.defineColumn("!iddidprogcurr_didprogcurr_title", typeof(string));
	tnullaosta_imm.defineColumn("!iddidprogori_didprogori_title", typeof(string));
	...
	var cChild = new []{istanzadichiar.Columns["idcorsostudio"], istanzadichiar.Columns["iddidprog"], istanzadichiar.Columns["idistanza"], istanzadichiar.Columns["idistanzakind"], istanzadichiar.Columns["idreg"]};
	...
	cPar = new []{istanza.Columns["iddidprog"], istanza.Columns["idcorsostudio"], istanza.Columns["idistanza"], istanza.Columns["idistanzakind"], istanza.Columns["idreg_studenti"]};
	cChild = new []{nullaosta.Columns["iddidprog"], nullaosta.Columns["idcorsostudio"], nullaosta.Columns["idistanza"], nullaosta.Columns["idistanzakind"], nullaosta.Columns["idreg"]};
	Relations.Add(new DataRelation("FK_nullaosta_istanza_iddidprog-idcorsostudio-idistanza-idistanzakind-idreg",cPar,cChild,false));
	...
	cChild = new []{nullaosta_imm.Columns["iddidprogori"]};
	Relations.Add(new DataRelation("FK_nullaosta_imm_didprogori_iddidprogori",cPar,cChild,false));

	cPar = new []{didprogcurr_alias1.Columns["iddidprogcurr"]};
	cChild = new []{nullaosta_imm.Columns["iddidprogcurr"]};
	Relations.Add(new DataRelation("FK_nullaosta_imm_didprogcurr_alias1_iddidprogcurr",cPar,cChild,false));
