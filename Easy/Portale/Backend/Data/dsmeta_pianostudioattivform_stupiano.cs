...
[System.Xml.Serialization.XmlRoot("dsmeta_pianostudioattivform_stupiano"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_pianostudioattivform_stupiano: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_pianostudioattivform_stupiano(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_pianostudioattivform_stupiano (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_pianostudioattivform_stupiano";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_pianostudioattivform_stupiano.xsd";
	...
	var cPar = new []{pianostudioattivform.Columns["idiscrizione"], pianostudioattivform.Columns["idpianostudio"], pianostudioattivform.Columns["idpianostudioattivform"], pianostudioattivform.Columns["idreg"], pianostudioattivform.Columns["idattivform"]};
	var cChild = new []{prenotappello.Columns["idiscrizione"], prenotappello.Columns["idpianostudio"], prenotappello.Columns["idpianostudioattivform"], prenotappello.Columns["idreg"], prenotappello.Columns["idattivform"]};
