...
[System.Xml.Serialization.XmlRoot("dsmeta_ricostruzioneattach_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_ricostruzioneattach_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_ricostruzioneattach_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_ricostruzioneattach_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_ricostruzioneattach_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_ricostruzioneattach_default.xsd";
	...
	var cChild = new []{ricostruzioneattach.Columns["idattach"]};
