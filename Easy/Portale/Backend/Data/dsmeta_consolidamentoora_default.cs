...
[System.Xml.Serialization.XmlRoot("dsmeta_consolidamentoora_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_consolidamentoora_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_consolidamentoora_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_consolidamentoora_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_consolidamentoora_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_consolidamentoora_default.xsd";
