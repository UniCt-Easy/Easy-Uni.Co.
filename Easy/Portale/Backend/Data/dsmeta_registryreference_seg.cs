...
[System.Xml.Serialization.XmlRoot("dsmeta_registryreference_seg"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_registryreference_seg: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_registryreference_seg(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_registryreference_seg (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_registryreference_seg";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_registryreference_seg.xsd";
