...
[System.Xml.Serialization.XmlRoot("dsmeta_issues_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_issues_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_issues_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_issues_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_issues_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_issues_default.xsd";
