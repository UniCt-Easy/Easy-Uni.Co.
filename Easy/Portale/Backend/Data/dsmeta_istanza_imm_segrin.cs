...
[System.Xml.Serialization.XmlRoot("dsmeta_istanza_imm_segrin"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_istanza_imm_segrin: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_istanza_imm_segrin(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_istanza_imm_segrin (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_istanza_imm_segrin";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_istanza_imm_segrin.xsd";
