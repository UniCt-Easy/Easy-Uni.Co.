...
[System.Xml.Serialization.XmlRoot("dsmeta_rendicontattivitaprogetto_anag"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_rendicontattivitaprogetto_anag: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_rendicontattivitaprogetto_anag(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_rendicontattivitaprogetto_anag (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_rendicontattivitaprogetto_anag";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_rendicontattivitaprogetto_anag.xsd";
