...
[System.Xml.Serialization.XmlRoot("dsmeta_registryattach_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_registryattach_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_registryattach_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_registryattach_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_registryattach_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_registryattach_default.xsd";
	...
	var cChild = new []{registryattach.Columns["idattach"]};
	Relations.Add(new DataRelation("FK_registryattach_attach_idattach",cPar,cChild,false));
