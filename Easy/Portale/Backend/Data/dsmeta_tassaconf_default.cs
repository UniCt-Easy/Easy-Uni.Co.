...
public partial class dsmeta_tassaconf_default: DataSet {
...
private void initClass() {
	...
	ttassaconfkinddefaultview.defineColumn("tassaconfkind_active", typeof(string));
	ttassaconfkinddefaultview.defineColumn("tassaconfkind_ct", typeof(DateTime),false);
	ttassaconfkinddefaultview.defineColumn("tassaconfkind_cu", typeof(string),false);
	ttassaconfkinddefaultview.defineColumn("tassaconfkind_lt", typeof(DateTime),false);
	ttassaconfkinddefaultview.defineColumn("tassaconfkind_lu", typeof(string),false);
	ttassaconfkinddefaultview.defineColumn("tassaconfkind_sortcode", typeof(int),false);
	ttassaconfkinddefaultview.defineColumn("title", typeof(string),false);
