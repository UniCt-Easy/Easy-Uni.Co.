...
[System.Xml.Serialization.XmlRoot("dsmeta_parttimeinfo_seganagstu"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_parttimeinfo_seganagstu: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_parttimeinfo_seganagstu(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_parttimeinfo_seganagstu (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_parttimeinfo_seganagstu";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_parttimeinfo_seganagstu.xsd";
