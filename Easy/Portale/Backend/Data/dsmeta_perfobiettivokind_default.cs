...
[System.Xml.Serialization.XmlRoot("dsmeta_perfobiettivokind_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_perfobiettivokind_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfobiettivokind_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfobiettivokind_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfobiettivokind_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfobiettivokind_default.xsd";
