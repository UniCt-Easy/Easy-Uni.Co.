...
[System.Xml.Serialization.XmlRoot("dsmeta_convalidato_segistpass"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public partial class dsmeta_convalidato_segistpass: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_convalidato_segistpass(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_convalidato_segistpass (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_convalidato_segistpass";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_convalidato_segistpass.xsd";
