...
[System.Xml.Serialization.XmlRoot("dsmeta_perfvalutazionepersonalesoglia_default"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_perfvalutazionepersonalesoglia_default: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfvalutazionepersonalesoglia_default(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfvalutazionepersonalesoglia_default (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfvalutazionepersonalesoglia_default";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfvalutazionepersonalesoglia_default.xsd";
	...
	var cChild = new []{perfvalutazionepersonalesoglia.Columns["idperfsogliakind"]};
