...
[System.Xml.Serialization.XmlRoot("dsmeta_perfobiettiviuosoglia_target"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_perfobiettiviuosoglia_target: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_perfobiettiviuosoglia_target(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_perfobiettiviuosoglia_target (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_perfobiettiviuosoglia_target";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_perfobiettiviuosoglia_target.xsd";
