...
[System.Xml.Serialization.XmlRoot("dsmeta_dichiaraltrekind_elenchi"),System.ComponentModel.Design.HelpKeyword("vs.data.DataSet")]
public class dsmeta_dichiaraltrekind_elenchi: DataSet {
...
[DebuggerNonUserCode]
public dsmeta_dichiaraltrekind_elenchi(){
	BeginInit();
	initClass();
	EndInit();
}
[DebuggerNonUserCode]
protected dsmeta_dichiaraltrekind_elenchi (SerializationInfo info,StreamingContext ctx):base(info,ctx) {}
[DebuggerNonUserCode]
private void initClass() {
	DataSetName = "dsmeta_dichiaraltrekind_elenchi";
	Prefix = "";
	Namespace = "http://tempuri.org/dsmeta_dichiaraltrekind_elenchi.xsd";
