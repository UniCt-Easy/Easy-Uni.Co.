    ...
    public class ldapauth {
        ...
        public bool Authenticate(string username, string password) {
            ...
            if (userDN.IndexOf("<%USERID_FROMEMAIL%>") >= 0) {
                DataTable users = conn.RUN_SELECT("virtualuser", "*", null, QHS.AppAnd(QHS.CmpEq("userkind", 4), QHS.CmpEq("email", username)), null, true);
            ...
            try {
                ...
                ErrorMsg = ex.Message + " UserDN:" + userDN + "; E-mail:" + username;
                return false;
            }
