...
namespace employment_lista//tipocategorialista//
{
	/// <summary>
	/// Summary description for frmtipocategorialista.
	/// </summary>
	public class Frm_employment_lista : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Frm_employment_lista));
			...
			this.DS = new employment_lista.vistaForm();
			...
			this.dataGrid1.Size = new System.Drawing.Size(496, 256);
			this.dataGrid1.TabIndex = 37;
			this.dataGrid1.Tag = "employment.default";
			// 
			// textBox2
			// 
			...
			this.textBox2.Tag = "employment.description";
			this.textBox2.Text = "";
			// 
			// textBox1
			// 
			...
			this.textBox1.Tag = "employment.idemployment.categoria";
			this.textBox1.Text = "";
			...
			this.label1.Text = "Codice categoria";
			// 
			// images
			// 
			...
			this.MetaDataDetail.Location = new System.Drawing.Point(16, 328);
			this.MetaDataDetail.Name = "MetaDataDetail";
			this.MetaDataDetail.Size = new System.Drawing.Size(496, 96);
			...
			this.Name = "Frm_employment_lista";
