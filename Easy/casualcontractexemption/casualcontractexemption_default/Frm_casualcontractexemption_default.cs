...
namespace casualcontractexemption_default//occasionalequotaesentelista//
{
	/// <summary>
	/// Summary description for frmoccasionalequotaesentelista.
	/// </summary>
	public class Frm_casualcontractexemption_default : System.Windows.Forms.Form
	{
		public vistaForm DS;
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Frm_casualcontractexemption_default));
			this.DS = new casualcontractexemption_default.vistaForm();
			...
			this.dataGrid1.Size = new System.Drawing.Size(496, 224);
			this.dataGrid1.TabIndex = 47;
			this.dataGrid1.Tag = "casualcontractexemption.default";
			// 
			// MetaDataDetail
			// 
			...
			this.MetaDataDetail.Location = new System.Drawing.Point(8, 288);
			this.MetaDataDetail.Name = "MetaDataDetail";
			this.MetaDataDetail.Size = new System.Drawing.Size(496, 80);
			...
			this.textBox3.Tag = "casualcontractexemption.exemptionquota";
			this.textBox3.Text = "";
			// 
			// label3
			// 
			...
			this.checkBox1.Tag = "casualcontractexemption.active:S:N";
			...
			this.textBox1.Tag = "casualcontractexemption.startvalidity";
			this.textBox1.Text = "";
			// 
			// label1
			// 
			...
			this.label1.Text = "Data Decorrenza";
			this.label1.TextAlign = System.Drawing.ContentAlignment.TopRight;
			// 
			// Frm_casualcontractexemption_default
			// 
			...
			this.Name = "Frm_casualcontractexemption_default";
			this.Text = "frmoccasionalequotaesentelista";
