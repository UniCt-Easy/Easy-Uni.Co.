...
public partial class vistaForm: DataSet {
	...
	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public DataTable registryverificaanac 		=> Tables["registryverificaanac"];
...
private void initClass() {
	...
	var tregistryverificaanac= new DataTable("registryverificaanac");
	C= new DataColumn("idregistryverificaanac", typeof(int));
	C.AllowDBNull=false;
	tregistryverificaanac.Columns.Add(C);
	C= new DataColumn("idreg", typeof(int));
	C.AllowDBNull=false;
	tregistryverificaanac.Columns.Add(C);
	tregistryverificaanac.Columns.Add( new DataColumn("verificaanaccertification", typeof(Byte[])));
	tregistryverificaanac.Columns.Add( new DataColumn("start", typeof(DateTime)));
	tregistryverificaanac.Columns.Add( new DataColumn("stop", typeof(DateTime)));
	C= new DataColumn("cu", typeof(string));
	C.AllowDBNull=false;
	tregistryverificaanac.Columns.Add(C);
	C= new DataColumn("ct", typeof(DateTime));
	...
	tregistryverificaanac.PrimaryKey =  new DataColumn[]{tregistryverificaanac.Columns["idregistryverificaanac"], tregistryverificaanac.Columns["idreg"]};
	...
	var cChild = new []{registryverificaanac.Columns["idreg"]};
	Relations.Add(new DataRelation("registry_registryverificaanac",cPar,cChild,false));
