...
namespace registryverificaanac_default {
    public partial class Frm_registryverificaanac_default : MetaDataForm {
        ...
        public Frm_registryverificaanac_default() {
            InitializeComponent();
        ...
        void AbilitaDisabilitaAllegati() {
            ...
            if (Curr["verificaanaccertification"] != DBNull.Value || Curr["idfilestorage"] != DBNull.Value) {
                btnAllegaVerificaAnac.Enabled = false;
                ...
                {
                    // Attachment
                    ByteArray = (byte[])Curr["verificaanaccertification"];
                }
                else
                {
                    // MongoDb
        ...
        private void btnRimuoviVisura_Click(object sender, EventArgs e) {
            if (DS.registryverificaanac.Rows[0]["idfilestorage"] != DBNull.Value)
            {
                DS.registryverificaanac.Rows[0]["idfilestorage"] = DBNull.Value;
            }
            else
            {
                DS.registryverificaanac.Rows[0]["casellariocertverificaanaccertificationification"] = DBNull.Value;
            }
            AbilitaDisabilitaAllegati();
        }
