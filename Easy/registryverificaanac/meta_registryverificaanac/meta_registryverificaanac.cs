...
namespace meta_registryverificaanac {
    /// <summary>
    /// MetaData for visura
    /// </summary>
    public class Meta_registryverificaanac :Meta_easydata {
        public Meta_registryverificaanac(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "registryverificaanac") {
            Name = "Verifica Anac";
        ...
        protected override Form GetForm(string FormName) {
            if (FormName == "default") {
                ...
                Name = "verifica anac";
                return MetaData.GetFormByDllName("registryverificaanac_default");
            }
            if (FormName == "anagraficadetail") {
                Name = "verifica anac";
                DefaultListType = "anagraficadetail";
                return MetaData.GetFormByDllName("registryverificaanac_anagraficadetail");
            }
            return null;
        }
        ...
        public override DataRow SelectOne(string ListingType, string filter, string searchtable, DataTable ToMerge) {
            if (ListingType == "default") {
                return base.SelectOne(ListingType, filter, "registryverificaanacview", ToMerge);
            }
        ...
        public override void DescribeColumns(DataTable T, string ListingType) {
            ...
            if (ListingType == "anagraficadetail") {
                foreach (DataColumn C in T.Columns)
                    DescribeAColumn(T, C.ColumnName, "", -1);
                int nPos = 1;
                DescribeAColumn(T, "idregistryverificaanac", "#", nPos++);
        ...
        public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
            ...
            RowChange.MarkAsAutoincrement(T.Columns["idregistryverificaanac"], null, null, 0);
