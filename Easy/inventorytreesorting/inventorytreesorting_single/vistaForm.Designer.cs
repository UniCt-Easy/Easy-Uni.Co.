...
namespace inventorytreesorting_single {
using System;
using System.Data;
...
public DataTable inventorytreesorting{get { return this.Tables["inventorytreesorting"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
...
this.EnforceConstraints = false;
	...
	DataColumn C;
	DataColumn [] key;
	T= new DataTable("inventorytreesorting");
...
//Primary Key
	...
	T.Columns["idinv"], 	T.Columns["idsor"]};
	T.PrimaryKey = key;
...
DataColumn []CChild;
TPar= Tables["sorting"];
TChild= Tables["inventorytreesorting"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor"]};
Relations.Add(new DataRelation("sortinginventorytreesorting",CPar,CChild));
