...
namespace meta_incomebill {
    /// <summary>
    /// MetaData for spesa
    /// </summary>
    public class Meta_incomebill : Meta_easydata {
        public Meta_incomebill(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "incomebill") {
            Name = "Bolletta";
        ...
        protected override Form GetForm(string FormName) {
            if (FormName == "default") {
                ...
                return MetaData.GetFormByDllName("incomebill_default");
            }
            return null;
        }
