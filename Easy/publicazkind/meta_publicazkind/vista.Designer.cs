...
public class publicazkindRow: MetaRow  {
	public publicazkindRow(DataRowBuilder rb) : base(rb) {} 
...
///<summary>
///VOCABOLARIO modificabile dagli utenti delle tipologie di 2.4.27 pubblicazione 
///</summary>
public class publicazkindTable : MetaTableBase<publicazkindRow> {
	public publicazkindTable() : base("publicazkind"){
