...
public DataTable securityvar{get { return this.Tables["securityvar"];}}
...
this.EnforceConstraints = false;
	...
	DataColumn C;
	DataColumn [] key;
	T= new DataTable("securityvar");
	T.Namespace = this.Namespace;
	C= new DataColumn("idsecurityvar", typeof(System.Int32), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);
