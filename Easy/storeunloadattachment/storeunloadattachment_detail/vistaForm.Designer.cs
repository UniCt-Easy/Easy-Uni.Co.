...
private void initClass() {
	...
	C= new DataColumn("idstoreunload", typeof(Int32));
	C.AllowDBNull=true;
	...
	C.AllowDBNull=false;
	tstoreunloadattachment.Columns.Add(C);
	tstoreunloadattachment.Columns.Add( new DataColumn("idfilestorage", typeof(string)));
	...
	var cChild = new []{storeunloadattachment.Columns["idattachmentkind"]};
	Relations.Add(new DataRelation("attachmentkind_storeunloadattachment",cPar,cChild,false));
