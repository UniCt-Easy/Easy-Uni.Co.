...
namespace storeunloadattachment_detail
{
	partial class Frm_storeunloadattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new storeunloadattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "storeunloadattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "storeunloadattachment.idattachmentkind";
			...
			// 
			// Frm_storeunloadattachment_detail
			// 
			...
			this.Name = "Frm_storeunloadattachment_detail";
			this.Text = "Frm_storeunloadattachment_detail";
