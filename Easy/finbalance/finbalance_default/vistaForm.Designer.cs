...
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
public DataTable finbalance{get { return this.Tables["finbalance"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
public DataTable accountingyear{get { return this.Tables["accountingyear"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
...
this.EnforceConstraints = false;
	...
	C= new DataColumn("nfinbalance", typeof(System.Int32), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);
...
//Primary Key
	...
	T.Columns["ayear"], 	T.Columns["idfin"], 	T.Columns["idupb"], 	T.Columns["nfinbalance"]};
	T.PrimaryKey = key;

	T= new DataTable("finbalance");
	C= new DataColumn("ayear", typeof(System.Int32), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);
	...
	T.Columns.Add(new DataColumn("balancedate", typeof(System.DateTime), ""));
	T.Columns.Add(new DataColumn("cu", typeof(System.String), ""));
	T.Columns.Add(new DataColumn("ct", typeof(System.DateTime), ""));
	T.Columns.Add(new DataColumn("lu", typeof(System.String), ""));
	T.Columns.Add(new DataColumn("lt", typeof(System.DateTime), ""));
...
//Primary Key
	...
	T.Columns["ayear"], 	T.Columns["nfinbalance"]};
	T.PrimaryKey = key;

	T= new DataTable("accountingyear");
...
Relations.Add(new DataRelation("finvarfinvardetail",CPar,CChild));

TPar= Tables["fin"];
TChild= Tables["finvardetail"];
CPar = new DataColumn[1]{TPar.Columns["idfin"]};
CChild = new DataColumn[1]{TChild.Columns["idfin"]};
Relations.Add(new DataRelation("finfinvardetail",CPar,CChild));

TPar= Tables["upb"];
TChild= Tables["finbalancedetail"];
CPar = new DataColumn[1]{TPar.Columns["idupb"]};
CChild = new DataColumn[1]{TChild.Columns["idupb"]};
Relations.Add(new DataRelation("upbfinbalancedetail",CPar,CChild));

TPar= Tables["finbalance"];
TChild= Tables["finbalancedetail"];
CPar = new DataColumn[2]{TPar.Columns["ayear"], TPar.Columns["nfinbalance"]};
CChild = new DataColumn[2]{TChild.Columns["ayear"], TChild.Columns["nfinbalance"]};
Relations.Add(new DataRelation("finbalancefinbalancedetail",CPar,CChild));
