...
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
public DataTable mandatesorting{get { return this.Tables["mandatesorting"];}}
...
//Primary Key
	...
	T= new DataTable("mandatesorting");
	C= new DataColumn("idsor", typeof(System.Int32), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);
...
//Primary Key
	...
	T.Columns["idmankind"], 	T.Columns["idsor"], 	T.Columns["nman"], 	T.Columns["yman"]};
	T.PrimaryKey = key;
...
DataColumn []CChild;
TPar= Tables["sorting"];
TChild= Tables["mandatesorting"];
CPar = new DataColumn[1]{TPar.Columns["idsor"]};
CChild = new DataColumn[1]{TChild.Columns["idsor"]};
Relations.Add(new DataRelation("sortingmandatesorting",CPar,CChild));
