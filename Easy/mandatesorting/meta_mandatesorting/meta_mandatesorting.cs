...
namespace meta_mandatesorting
{
	/// <summary>
	/// </summary>
	public class Meta_mandatesorting : Meta_easydata {
		public Meta_mandatesorting(DataAccess Conn, MetaDataDispatcher Dispatcher):
			base(Conn, Dispatcher, "mandatesorting") {
			EditTypes.Add("default");
			ListingTypes.Add("default");
			Name = "Classificazione Contratto Passivo";
		}

		protected override Form GetForm(string FormName){
			if (FormName=="default")
			{
				return GetFormByDllName("mandatesorting_default");
			}
			return null;
		}
		...
		public override void DescribeColumns(DataTable T, string ListingType){
			...
			DescribeAColumn(T, "yman", "");
			DescribeAColumn(T, "nman", "");
