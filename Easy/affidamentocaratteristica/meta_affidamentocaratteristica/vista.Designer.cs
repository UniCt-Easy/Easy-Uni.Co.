...
namespace meta_affidamentocaratteristica {
public class affidamentocaratteristicaRow: MetaRow  {
	public affidamentocaratteristicaRow(DataRowBuilder rb) : base(rb) {} 
...
public class affidamentocaratteristicaTable : MetaTableBase<affidamentocaratteristicaRow> {
	public affidamentocaratteristicaTable() : base("affidamentocaratteristica"){
