...
{
    public class Meta_affidamentocaratteristica : Meta_easydata 
	{
        public Meta_affidamentocaratteristica(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "affidamentocaratteristica") {
				Name = "Caratteristiche dell'affidamento";
		...
		public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
			...
			RowChange.MarkAsAutoincrement(T.Columns["idaffidamentocaratteristica"], null, null, 0);
			RowChange.setMinimumTempValue(T.Columns["idaffidamentocaratteristica"], 9990000);
			//$Get_New_Row$
