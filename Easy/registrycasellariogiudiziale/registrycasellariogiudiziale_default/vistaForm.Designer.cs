...
public partial class vistaForm: DataSet {
	...
	[DebuggerNonUserCode,DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),Browsable(false)]
	public DataTable registrycasellariogiudiziale 		=> Tables["registrycasellariogiudiziale"];
...
private void initClass() {
	...
	var tregistrycasellariogiudiziale= new DataTable("registrycasellariogiudiziale");
	C= new DataColumn("idregistrycasellariogiudiziale", typeof(int));
	C.AllowDBNull=false;
	tregistrycasellariogiudiziale.Columns.Add(C);
	C= new DataColumn("idreg", typeof(int));
	C.AllowDBNull=false;
	tregistrycasellariogiudiziale.Columns.Add(C);
	tregistrycasellariogiudiziale.Columns.Add( new DataColumn("casellariocertification", typeof(Byte[])));
	tregistrycasellariogiudiziale.Columns.Add( new DataColumn("start", typeof(DateTime)));
	tregistrycasellariogiudiziale.Columns.Add( new DataColumn("stop", typeof(DateTime)));
	C= new DataColumn("cu", typeof(string));
	C.AllowDBNull=false;
	tregistrycasellariogiudiziale.Columns.Add(C);
	C= new DataColumn("ct", typeof(DateTime));
	...
	tregistrycasellariogiudiziale.PrimaryKey =  new DataColumn[]{tregistrycasellariogiudiziale.Columns["idregistrycasellariogiudiziale"], tregistrycasellariogiudiziale.Columns["idreg"]};
	...
	var cChild = new []{registrycasellariogiudiziale.Columns["idreg"]};
	Relations.Add(new DataRelation("registry_registrycasellariogiudiziale",cPar,cChild,false));
