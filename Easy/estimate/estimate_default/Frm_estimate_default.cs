...
namespace estimate_default {
    ...
    public class Frm_estimate_default : System.Windows.Forms.Form {
        ...
        void impostaSicurezza(DataRow TipoContratto) {
            ...
            if (someChange) {
                //MetaFactory.factory.getSingleton<IMessageShower>().Show("Gli attributi di sicurezza sono stati adeguati al nuovo tipo di contratto selezionato", "Avviso");
                Meta.FreshForm(true);
            }
        }
        ...
        public void MetaData_BeforePost() {
            ...
            if (DS.incomevar.Select().Length > 0) {
                if (MetaFactory.factory.getSingleton<IMessageShower>().Show("E' stata modificata la data di annullamento di alcuni dettagli contabilizzati. " +
        ...
        private void InitializeComponent() {
			...
			this.txtTotale.Location = new System.Drawing.Point(824, 312);
			...
			this.txtImponibile.Location = new System.Drawing.Point(536, 312);
			...
			this.label16.Location = new System.Drawing.Point(776, 312);
			...
			this.label17.Location = new System.Drawing.Point(648, 312);
			...
			this.label18.Location = new System.Drawing.Point(464, 312);
			...
			this.detailgrid.Size = new System.Drawing.Size(854, 186);
			...
			this.tabControl1.Size = new System.Drawing.Size(961, 370);
			...
			this.Principale.Size = new System.Drawing.Size(953, 344);
			...
			this.tabDettagli.Size = new System.Drawing.Size(953, 344);
			...
			this.grpDettagliAnnullati.Location = new System.Drawing.Point(76, 207);
			this.grpDettagliAnnullati.Name = "grpDettagliAnnullati";
			this.grpDettagliAnnullati.Size = new System.Drawing.Size(865, 99);
			this.grpDettagliAnnullati.TabIndex = 47;
			this.grpDettagliAnnullati.TabStop = false;
			this.grpDettagliAnnullati.Text = "Dettagli annullati collegati";
			// 
			// dataGridDettAnn
			// 
			...
			this.dataGridDettAnn.Size = new System.Drawing.Size(854, 76);
			this.dataGridDettAnn.TabIndex = 45;
			this.dataGridDettAnn.Tag = "estimatedetail.listacollegati.single";
			// 
			// btnRipartizione
			// 
			...
			this.Classificazioni.Size = new System.Drawing.Size(953, 344);
			...
			this.dgrClassificazioni.Size = new System.Drawing.Size(905, 280);
			...
			this.tabAllegati.Size = new System.Drawing.Size(953, 344);
			...
			this.dataGrid1.Size = new System.Drawing.Size(929, 272);
			...
			this.tabAttributi.Size = new System.Drawing.Size(953, 344);
			...
			this.tabEP.Size = new System.Drawing.Size(953, 344);
            ...
            foreach (DataRow rDetail in DS.estimatedetail.Select()) {
                ...
                if ((rDetail["stop", DataRowVersion.Original] == DBNull.Value) &&
                    ...
                    foreach (DataRow rBrother in DS.estimatedetail.Select(filtroBrother)) {
                        ...
                        if ((brtDate == null) || (brtDate == DBNull.Value)) {
                            if (viewMessage) {
                                MetaFactory.factory.getSingleton<IMessageShower>().Show(this, "E' stata impostata la data di annullamento di un dettaglio suddiviso," +
                ...
                if ((rDetail["stop", DataRowVersion.Original] != DBNull.Value) &&
                    ...
                    foreach (DataRow rBrother in DS.estimatedetail.Select(filtroBrother)) {
                        ...
                        if ((brtDate != null) && (brtDate != DBNull.Value)) {
                            if (viewMessage) {
                                MetaFactory.factory.getSingleton<IMessageShower>().Show(this, "E' stata rimossa la data di annullamento di un dettaglio suddiviso," +
				...
				if (idman != null && idman != DBNull.Value) {
					...
					if (getman != DBNull.Value) {
						if (getman.ToString() != idman.ToString())
							MetaFactory.factory.getSingleton<IMessageShower>().Show("Il responsabile del Contratto è stato reimpostato come da U.P.B.");
					}
        ...
        private void btnDividiDettaglio_Click(object sender, System.EventArgs e) {
            ...
            if (RigaSelezionata["stop"] != DBNull.Value) {
                MetaFactory.factory.getSingleton<IMessageShower>().Show("Dettaglio annullato", "Avviso");
                return;
            }
            if ((RigaSelezionata["idinc_taxable"] != DBNull.Value) && (RigaSelezionata["idinc_iva"] != DBNull.Value)) {
                MetaFactory.factory.getSingleton<IMessageShower>().Show("Dettaglio contabilizzato", "Avviso");
                return;
            }
        ...
        private void btnUnisciDettagli_Click(object sender, EventArgs e) {
            ...
            if (detailsGroup > 1) {
                ...
                foreach (DataRow DR in Selected) {
                    ...
                    if (ninvoiced > 0) {
                        MetaFactory.factory.getSingleton<IMessageShower>().Show("Alcuni dettagli dello stesso gruppo sono collegati a fattura. Non è possibile annullare la suddivisione.", "Avviso");
                        return;
                    }
                    if ((idinc_taxable.Length > 1) || (idinc_iva.Length > 1)) {
                        MetaFactory.factory.getSingleton<IMessageShower>().Show("Alcuni dettagli dello stesso gruppo sono contabilizzati. Non è possibile annullare la suddivisione.", "Avviso");
                        return;
                    }
		...
		private void btnSostituisciDettaglio_Click(object sender, EventArgs e) {
            ...
            if (DS.HasChanges()) {
                MetaFactory.factory.getSingleton<IMessageShower>().Show(this, "Prima di sostituire il dettaglio bisogna salvare!");
                return;
            }
            ...
            if ((listaDettagliSplittati.Length > 1) && (listaDettagliSplittati.Length <= 10)) {
                ...
                if (dr2 != DialogResult.OK) {
                    MetaFactory.factory.getSingleton<IMessageShower>().Show(this, "Operazione di split annullata");
                    return;
                }
                else {
		...
		private void dataGridDettAnn_Click(object sender, EventArgs e){
