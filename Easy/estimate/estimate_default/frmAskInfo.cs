...
namespace estimate_default {
	...
	public class frmAskInfo : MetaDataForm {
		...
		public frmAskInfo(DataRow Contratto, DataRow RigaSelezionata, MetaData Meta, MetaDataDispatcher Disp) {
			...
			string codecurrency = Meta.Conn
				.DO_READ_VALUE("currency", QHS.CmpEq("idcurrency", Contratto["idcurrency"]), "codecurrency").ToString();
		...
		private void fillOggetti(DataRow[] Detail) {
			...
			foreach (DataRow rDetail in Detail) {
				...
				T_Upb[nCiclo].Text = (rDetail["idupb"] != DBNull.Value)
					? Conn.DO_READ_VALUE("upb", QHS.CmpEq("idupb", rDetail["idupb"]), "title").ToString()
					: "";
		...
		private void InitializeComponent() {
			...
			this.btnUpb7.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular,
				System.Drawing.GraphicsUnit.Point, ((byte) (0)));
			...
			// labelImponibile
			// 
			this.labelImponibile.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F,
			...
			this.btnUpb1.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular,
				System.Drawing.GraphicsUnit.Point, ((byte) (0)));
			...
			this.btnUpb2.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular,
				System.Drawing.GraphicsUnit.Point, ((byte) (0)));
			...
			this.btnUpb3.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular,
				System.Drawing.GraphicsUnit.Point, ((byte) (0)));
			...
			this.btnUpb4.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular,
				System.Drawing.GraphicsUnit.Point, ((byte) (0)));
			...
			this.btnUpb5.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular,
				System.Drawing.GraphicsUnit.Point, ((byte) (0)));
			...
			this.btnUpb6.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular,
				System.Drawing.GraphicsUnit.Point, ((byte) (0)));
			...
			this.btnUpb8.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular,
				System.Drawing.GraphicsUnit.Point, ((byte) (0)));
			...
			this.btnUpb9.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular,
				System.Drawing.GraphicsUnit.Point, ((byte) (0)));
			...
			this.btnUpb10.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F,
		...
		decimal GetImponibileNear(decimal imponibiletest, bool silent) {
			...
			while (cent < 0.3M) {
				...
				if (totale1 + totale2 == TotaleImponibile) {
					if (!silent)
						show("L'imponibile è stato portato da " +
		...
		private decimal CalcolaPercentualeResidua(object sender) {
			...
			for (int i = 1; i <= 10; i++) {
				...
				if (suffix != sendSuffix) {
					...
					importoassegnato +=
						CfgFn.GetNoNullDecimal(HelpForm.GetObjectFromString(typeof(Decimal), T.Text, "x.y.c"));
				}
			}
		...
		public void PercentualeLeave(object sender, System.EventArgs e) {
			...
			if (checkPercentuale(sender)) {
				...
				decimal importoassegnato = 0;
				if (percentualeresidua != 0)
					importoassegnato = CfgFn.Round(((perc / percentualeresidua) * importoresiduo), 5);
		...
		public void calcolaTotaleRiga(object sender, System.EventArgs e, int l) {
			...
			decimal imponibile =
				CfgFn.GetNoNullDecimal(HelpForm.GetObjectFromString(typeof(Decimal), TAmount.Text, "x.y.c"));
		...
		private void frmAskInfo_Closing(object sender, System.ComponentModel.CancelEventArgs e) {
			...
			for (int i = 1; i <= 10; i++) {
				...
				decimal totaleriga =
					CfgFn.GetNoNullDecimal(HelpForm.GetObjectFromString(typeof(Decimal), T2.Text, "x.y.c"));
			...
			decimal number = CfgFn.GetNoNullDecimal(Dettaglio["number"]);
			decimal discount = CfgFn.GetNoNullDecimal(Dettaglio["discount"]);
			decimal importoTotaleRiga =
				CfgFn.RoundValuta(importo * number * (1 - discount) * exchangerate) + importoIva;
		...
		private bool checkPercentuale(object sender) {
			...
			try {
				...
				show("E' necessario digitare un numero", "Avviso",
		...
		private void DividiCostoTotale(object sender) {
			...
			TextBox TSender = (TextBox) sender;
			decimal costoTotale =
				CfgFn.GetNoNullDecimal(HelpForm.GetObjectFromString(typeof(Decimal), TSender.Text, "x.y.c"));
			...
			new_taxable =
				GetImponibileNear(new_taxable, true); //imponibile unitario che quadra con l'imponibile residuo 
			...
			if (totale1 != totale2) {
				...
				while (cent < 0.1M) {
					...
					imponibiletotalescontato2 =
						CfgFn.RoundValuta(imponibile_try * number * (1 - discount) * exchangerate);
			...
			if (importoIva != 0)
				new_tax = costoTotale - CfgFn.RoundValuta(new_taxable * number * (1 - discount) * exchangerate);
