...
namespace meta_taxrateregioncitybracket
{
    public class Meta_taxrateregioncitybracket : Meta_easydata
    {
        public Meta_taxrateregioncitybracket(DataAccess Conn, MetaDataDispatcher Dispatcher)
            : base(Conn, Dispatcher, "taxrateregioncitybracket")
        {
        ...
        protected override Form GetForm(string FormName)
        {
            if (FormName == "default")
            {
                Name = "Scaglioni Imposta Regionale per Comune";
                return MetaData.GetFormByDllName("taxrateregioncitybracket_default");
            }
            return null;
        }
        ...
        public override DataRow Get_New_Row(DataRow ParentRow, DataTable T)
        {
            ...
            RowChange.SetSelector(T, "idtaxrateregioncitystart");
