...
namespace config_default
{
    ...
    "miscua, Iva Istituzionale INTRA12)";
			...
			this.txtFinIncomeGrossCSA.Tag = "fin_income_gross_csa.codefin?configview.codefinincomesurplus";
			// 
			// button38
			// 
    ...
    "l\'F24EP)";
			...
			// dlgSceltaProgramma
			// 
			this.dlgSceltaProgramma.Title = "Seleziona il programma per la trasmissione";
			// 
			// Frm_config_default
			// 
        ...
        private System.Windows.Forms.OpenFileDialog dlgSceltaProgramma;
