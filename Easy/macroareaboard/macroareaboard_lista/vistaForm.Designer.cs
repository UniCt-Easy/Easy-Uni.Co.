...
public DataTable macroareaboard{get { return this.Tables["macroareaboard"];}}
...
this.EnforceConstraints = false;
	...
	DataColumn C;
	DataColumn [] key;
	T= new DataTable("macroareaboard");
	C= new DataColumn("idmacroareaboard", typeof(System.Int32), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);

	T.Columns.Add(new DataColumn("amount_1", typeof(System.Decimal), ""));
	T.Columns.Add(new DataColumn("amount_2", typeof(System.Decimal), ""));
	C= new DataColumn("codemacroareaboard", typeof(System.String), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);
