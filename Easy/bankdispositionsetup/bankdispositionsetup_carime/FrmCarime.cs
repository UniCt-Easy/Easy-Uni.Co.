...
namespace bankdispositionsetup_carime {
	...
	public class FrmCarime : System.Windows.Forms.Form {
		...
		bool parseCarimeFile(StreamReader sr) {
            ...
            ht["023"] = "R+R";  //Regolarizzazione provvisorio entrata. Verranno Saltati non ci serve il dato della regolarizzazione della bolletta, perchË Ë un dato che non memorizziamo.
            ...
            ht["033"] = "M+R";  //Regolarizzazione provvisorio Uscita. Verranno Saltati non ci serve il dato della regolarizzazione della bolletta, perchË Ë un dato che non memorizziamo.
		...
		private void copia_Carime_IN020304() {
            //Quando viene regolarizzato un mandato, ossia in presenza del TipoMov 031 vi Ë anche il TipoMov 033. Idem per 021 e 023, per le reversali.
