...
namespace bankdispositionsetup_bpcassinate {
    public class EsportazioneDistintePagamento {
        ...
        public XmlDocument GeneraFileXML() {
            ...
            if (spexportexp == null || spexportexp == DBNull.Value) {
                MessageBox.Show("Il cassiere relativo alla distinta n." + npaymenttransmission +
                            " del " + ypaymenttransmission + " non Ë ben configurato per l'esportazione elettronica", "Errore");
                return null;
            }
            ...
            String ssheet = "type=\"text/xsl\" href=\".\\OrdinativiCS_2.0.xslt\"";
            ...
            attributeNode.Value = "../../../XSD/ORDINATIVI_CS_2.01.XSD";
            X.DocumentElement.SetAttributeNode(attributeNode);
        ...
        bool Crea_flusso_ordinativi(XmlDocument X, DataTable T) {
            ...
            XmlHelper.SortElement(Rflusso, new string[] {"identificativo_flusso","esercizio","data_ora_creazione_flusso","codice_ABI_BT","codice_ente",
                        "descrizione_ente","codice_ente_BT","riferimento_ente","mandato"});
            ...
            foreach (DataRow R in RR) {
                ...
                XmlHelper.SortElement(Rinformazioni_beneficiario, new string[]{
                    "progressivo_beneficiario","importo_beneficiario","tipo_pagamento","impignorabili","frazionabile",
                            ...
                            "numero_conto_banca_italia_ente_ricevente","tipo_contabilita_ente_ricevente","causale",   
                            "spese","bollo","classificazione","beneficiario", "sospeso","ritenute","delegato","creditore_effettivo",
                            "piazzatura","sepa_credit_transfer",     
                            "informazioni_aggiuntive"
                });
               
                XmlHelper.SortElement(Piazzatura, new string[]{"abi_beneficiario","cab_beneficiario", 
                    "numero_conto_corrente_beneficiario","caratteri_controllo","codice_paese","codice_cin",
                    "denominazione_banca_destinataria","codice_swift"
                });
            }
            return true;
        }
