...
namespace bankdispositionsetup_bsondrio {
    public class EsportazioneDistintePagamento {
        ...
        public XmlDocument GeneraFileXML() {
            ...
            attributeNode.Value = "../../../XSD/ORDINATIVI_SEPA_2.0.XSD";
            X.DocumentElement.SetAttributeNode(attributeNode);
        ...
        bool Aggiungi_mandati(XmlElement E, DataTable T, DataRow Rflusso) {
            ...
            foreach (DataRow R in RR) {
                ...
                XmlHelper.SortElement(Rmandato, new string[] {"tipo_operazione","numero_mandato","data_mandato","importo_mandato",
                            "conto_evidenza","estremi_provvedimento_autorizzativo","responsabile_provvedimento","ufficio_responsabile",
                            "funzionario_delegato","informazioni_beneficiario","dati_a_disposizione_ente_mandato"});
            }
            return true;
        }
            ...
            foreach (DataRow R in RR) {
                ...
                XmlHelper.SortElement(Rinformazioni_beneficiario, new string[]{
                    "progressivo_beneficiario","importo_beneficiario","tipo_pagamento","impignorabili","frazionabile",
                            ...
                            "piazzatura","sepa_credit_transfer","codice_versante","causale",        
                            "sospeso","ritenute","informazioni_aggiuntive","sostituzione_mandato","dati_a_disposizione_ente_beneficiario"
                });
               
                XmlHelper.SortElement(Piazzatura, new string[]{"abi_beneficiario","cab_beneficiario", 
                    "numero_conto_corrente_beneficiario","caratteri_controllo","codice_cin",
                    "codice_paese","denominazione_banca_destinataria"
                });
            }
            return true;
        }
