...
namespace bankdispositionsetup_importnew {
    ...
    public  class RigaDocumento {
        ...
        /// <summary>
        /// Numero bolletta, Ë memorizzata di solito in bankreference di banktransaction
        /// </summary>
    ...
    public  class ImportazioneEsitiBancari {
        ...
        /// <summary>
        /// Cerca di capire se il file in esame Ë stato gi‡ oggetto di elaborazione, nel qual caso avvisa e restituisce false
        /// </summary>
        /// <param name="Conn"></param>
        /// <param name="M"></param>
        ...
        /// <summary>
        /// Cerca di capire se il file in esame Ë stato gi‡ oggetto di elaborazione, nel qual caso avvisa e restituisce true
        /// </summary>
        ...
        private static bool doppiaImportazioneNonOpi(DataAccess Conn, DatiImportati M, object idbank) {
            ...
            if (Conn.RUN_SELECT_COUNT("bankimport", cond, false) > 0) {
                ...
                M.error="Il file selezionato Ë stato gi‡ IN PASSATO importato nel db. Operazione non consentita.";
                M.DatiValidi = false;
                return true;
            }
            ...
            return false;   // non Ë doppia importazione
        }
        ...
        private static bool giornaleGiaImportato(DataAccess Conn, DatiImportati M, object idbank) {
            ...
            if (string.IsNullOrEmpty(identificativo_flusso_BT)) {              
                M.error=   "Il flusso non ha l'identificativo, non Ë possibile importarlo.";
                M.DatiValidi = false;
                return true;
            }
   ...
   //         string datafine = identificativo_flusso_BT.Substring(13, 8);
            ...
            if (Conn.RUN_SELECT_COUNT("bankimport", cond, false) > 0) {
                ...
                //M.error="Il file selezionato Ë stato gi‡ IN PASSATO importato nel db. Operazione non consentita(flusso_BT)." +identificativo_flusso_BT;
                M.DatiValidi = false;
                return true;
            }
        ...
        // Cerca di capire se il file in esame Ë stato gi‡ oggetto di elaborazione verificando che non esista una riga
