...
namespace bankdispositionsetup_bppugliese {
    public class XmlHelper {
        ...
        /// <param name="Rsp_data">Riga con i valori da prendere. Ogni valore è preso dalla colonna di pari nome oppure da Rsp_data[H[nome colonna]] se presente</param>
        /// <param name="H">Traslazione dei nomi di colonna ove necessario, per prendere i dati da Rsp_data</param>
        /// <returns>Elemento creato o null se i campi erano tutti vuoti e nessun elemento è stato aggiunto</returns>
        ...
        /// <summary>
        /// Crea una riga figlia di un elemento dato (x) con le colonne presenti in TSchema e i valori presenti in Rsp_Data, eventualmente con un nome di colonna diverso
        ///  in base alla Hashtable H
        /// </summary>
        /// <param name="x">Elemento parent</param>
        /// <param name="TSchema">Tabella con le colonne dell'elemento da creare</param>
        ...
        public static XmlElement CreaRigaChild(XmlElement x, DataTable TSchemaParent, DataTable TSchemaChild, DataRow Rsp_data, Hashtable H) {
            bool Nullable = IsNullable(TSchemaChild, x);
            XmlDocument xdoc = x.OwnerDocument;
            // XmlNode Nnode = xdoc.CreateNode(XmlNodeType.Element, textnode, null);
            XmlElement parent = xdoc.CreateElement(TSchemaParent.TableName); 
            XmlElement child = xdoc.CreateElement(TSchemaChild.TableName);
            XmlElement toadd = fillRigaChild(child, TSchemaChild, Rsp_data, H, Nullable);
            if (toadd != null) { 
