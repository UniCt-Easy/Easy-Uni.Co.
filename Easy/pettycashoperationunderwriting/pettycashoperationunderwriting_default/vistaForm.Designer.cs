...
//Primary Key
	...
	T.Columns.Add(new DataColumn("nlist", typeof(System.Int32), ""));
	T.Columns.Add(new DataColumn("idsor01", typeof(System.Int32), ""));
	T.Columns.Add(new DataColumn("idsor02", typeof(System.Int32), ""));
	T.Columns.Add(new DataColumn("idsor03", typeof(System.Int32), ""));
	T.Columns.Add(new DataColumn("idsor04", typeof(System.Int32), ""));
...
//Primary Key
	...
	T.Columns["noperation"], 	T.Columns["yoperation"], 	T.Columns["idpettycash"]};
	T.PrimaryKey = key;
...
Relations.Add(new DataRelation("FK_manager_pettycashoperation",CPar,CChild));

TPar= Tables["registry"];
TChild= Tables["pettycashoperation"];
CPar = new DataColumn[1]{TPar.Columns["idreg"]};
CChild = new DataColumn[1]{TChild.Columns["idreg"]};
Relations.Add(new DataRelation("FK_registry_pettycashoperation",CPar,CChild));

TPar= Tables["pettycash"];
TChild= Tables["pettycashoperation"];
CPar = new DataColumn[1]{TPar.Columns["idpettycash"]};
CChild = new DataColumn[1]{TChild.Columns["idpettycash"]};
Relations.Add(new DataRelation("FK_pettycash_pettycashoperation",CPar,CChild));

TPar= Tables["pettycashoperation"];
TChild= Tables["pettycashoperationunderwriting"];
CPar = new DataColumn[3]{TPar.Columns["noperation"], TPar.Columns["yoperation"], TPar.Columns["idpettycash"]};
CChild = new DataColumn[3]{TChild.Columns["noperation"], TChild.Columns["yoperation"], TChild.Columns["idpettycash"]};
Relations.Add(new DataRelation("FK_pettycashoperation_pettycashoperationunderwriting",CPar,CChild));
...
Relations.Add(new DataRelation("FK_underwriting_pettycashoperationunderwriting",CPar,CChild));
