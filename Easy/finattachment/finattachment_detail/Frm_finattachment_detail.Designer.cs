...
namespace finattachment_detail
{
	partial class Frm_finattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new finattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "finattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "finattachment.idattachmentkind";
			...
			this.Name = "Frm_finattachment_detail";
			this.Text = "Frm_finattachment_detail";
