...
private void initClass() {
	...
	C.AllowDBNull=false;
	tfinattachment.Columns.Add(C);
	tfinattachment.Columns.Add( new DataColumn("idfilestorage", typeof(string)));
	...
	var cChild = new []{finattachment.Columns["idattachmentkind"]};
	Relations.Add(new DataRelation("attachmentkind_finattachment",cPar,cChild,false));
