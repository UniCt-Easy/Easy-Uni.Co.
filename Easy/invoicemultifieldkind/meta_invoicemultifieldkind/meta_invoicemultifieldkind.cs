...
namespace meta_invoicemultifieldkind {
	/// <summary>
	/// Summary description for invoicemultifieldkind.
	/// </summary>
	public class Meta_invoicemultifieldkind : Meta_easydata {
		public Meta_invoicemultifieldkind(DataAccess Conn, MetaDataDispatcher Dispatcher) :
		base(Conn, Dispatcher, "invoicemultifieldkind") {
		...
		protected override Form GetForm(string FormName) {
			if (FormName == "default") {
				...
				Name = "Campi aggiuntivi per Fattura";
				ActAsList();
				SearchEnabled = true;
				return MetaData.GetFormByDllName("invoicemultifieldkind_default");
			}
			return null;
		}
		...
		public override void DescribeColumns(DataTable T, string ListingType) {
			...
			if (ListingType == "default") {
				...
				int nPos = 1;
				DescribeAColumn(T, "idmultifieldkind", ".#", nPos++);
