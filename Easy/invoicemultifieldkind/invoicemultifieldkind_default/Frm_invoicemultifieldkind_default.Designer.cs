...
namespace invoicemultifieldkind_default {
	partial class Frm_invoicemultifieldkind_default {
		/// <summary>
		...
		private void InitializeComponent() {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Frm_invoicemultifieldkind_default));
			this.DS = new invoicemultifieldkind_default.vistaForm();
			...
			this.MetaDataToolBar.Size = new System.Drawing.Size(822, 56);
			...
			this.checkBox1.Location = new System.Drawing.Point(276, 302);
			this.checkBox1.Name = "checkBox1";
			this.checkBox1.Size = new System.Drawing.Size(114, 20);
			this.checkBox1.TabIndex = 12;
			this.checkBox1.Tag = "invoicemultifieldkind.allownull:S:N";
			...
			this.textBox7.Tag = "invoicemultifieldkind.ordernumber";
			// 
			// label8
			// 
			...
			this.textBox6.Tag = "invoicemultifieldkind.tabname";
			// 
			// label7
			// 
			...
			this.textBox4.Tag = "invoicemultifieldkind.tag";
			// 
			// label5
			// 
			...
			this.textBox5.Tag = "invoicemultifieldkind.systype";
			// 
			// label6
			// 
			...
			this.textBox3.Tag = "invoicemultifieldkind.len";
			// 
			// label4
			// 
			...
			this.textBox1.Tag = "invoicemultifieldkind.fieldcode";
			// 
			// label3
			// 
			...
			this.checkBox2.Tag = "invoicemultifieldkind.allownull:S:N";
			...
			this.txtCodice.Tag = "invoicemultifieldkind.idmultifieldkind";
			// 
			// textBox2
			// 
			...
			this.textBox2.Tag = "invoicemultifieldkind.fieldname";
			// 
			// label1
			// 
			...
			this.dataGrid1.Location = new System.Drawing.Point(12, 53);
			this.dataGrid1.Name = "dataGrid1";
			this.dataGrid1.Size = new System.Drawing.Size(393, 527);
			...
			this.Name = "Frm_invoicemultifieldkind_default";
			this.Text = "Frm_invoicemultifieldkind_default";
