...
namespace foreigngroupruledetail_default {
    partial class Frm_foreigngroupruledetail_default {
        /// <summary>
        ...
        private void InitializeComponent() {
			this.DS = new foreigngroupruledetail_default.vistaForm();
			...
			this.textBox2.Tag = "foreigngroupruledetail.iddetail";
			// 
			// label3
			// 
			...
			this.comboBox1.Tag = "foreigngroupruledetail.idposition";
			...
			this.groupBox1.Text = "Classi stipendiali";
			// 
			// textBox4
			// 
			...
			this.textBox4.Tag = "foreigngroupruledetail.maxincomeclass";
			// 
			// label5
			// 
			...
			this.textBox3.Tag = "foreigngroupruledetail.minincomeclass";
			// 
			// label4
			// 
			...
			this.label6.Text = "Gruppo";
			// 
			// comboBox2
			// 
			this.comboBox2.DataSource = this.DS.foreigngroup;
			this.comboBox2.DisplayMember = "foreigngroupnumber";
			this.comboBox2.FormattingEnabled = true;
			this.comboBox2.Location = new System.Drawing.Point(53, 183);
			this.comboBox2.Name = "comboBox2";
			this.comboBox2.Size = new System.Drawing.Size(261, 21);
			this.comboBox2.TabIndex = 8;
			this.comboBox2.Tag = "foreigngroupruledetail.foreigngroupnumber";
			this.comboBox2.ValueMember = "foreigngroupnumber";
			// 
			// btnAnnulla
			// 
			this.btnAnnulla.DialogResult = System.Windows.Forms.DialogResult.Cancel;
			this.btnAnnulla.Location = new System.Drawing.Point(242, 224);
			...
			this.btnOk.Location = new System.Drawing.Point(146, 224);
			...
			// txtLivello
			// 
			this.txtLivello.Location = new System.Drawing.Point(53, 81);
			this.txtLivello.Name = "txtLivello";
			this.txtLivello.Size = new System.Drawing.Size(100, 20);
			this.txtLivello.TabIndex = 21;
			this.txtLivello.Tag = "foreigngroupruledetail.livello";
			// 
			// labelLivello
			// 
			this.labelLivello.AutoSize = true;
			this.labelLivello.Location = new System.Drawing.Point(13, 84);
			this.labelLivello.Name = "labelLivello";
			this.labelLivello.Size = new System.Drawing.Size(37, 13);
			this.labelLivello.TabIndex = 20;
			this.labelLivello.Text = "Livello";
			// 
			// Frm_foreigngroupruledetail_default
			// 
			...
			this.Name = "Frm_foreigngroupruledetail_default";
			this.Tag = "";
			this.Text = "Frm_foreigngroupruledetail_default";
