    ...
    public Meta_mandatedetail_extview(DataAccess Conn, MetaDataDispatcher Dispatcher):
        ...
        public override void DescribeColumns(DataTable T, string listtype){
			...
			if (listtype=="dettaglio") {
                ...
                DescribeAColumn(T, "notlinkedtoasset", "Q.t‡ da inventariare", nPos++);
                DescribeAColumn(T, "linkedtoasset", "Q.t‡ inventariata", nPos++);
                DescribeAColumn(T, "notlinkedtoinvoice", "Q.t‡ da fatturare", nPos++);
                DescribeAColumn(T, "linkedtoinvoice", "Q.t‡ fatturata", nPos++);
