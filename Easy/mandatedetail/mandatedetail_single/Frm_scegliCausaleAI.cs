...
namespace mandatedetail_single {
	public partial class Frm_scegliCausaleAI : MetaDataForm {
		...
		public Frm_scegliCausaleAI(MetaData Meta, string Sql) {
			...
			creaTable();
			riempiGrid();
			this.Text = "Elenco Causali EP (Filtrato AI)";
		}
		...
		void riempiGrid() {
			...
			TabCausali.Columns["codemotive"].Caption = "Cod. Causale";
            ...
            TabCausali.Columns["idsor"].Caption = "id Class";
            TabCausali.Columns["sortcode"].Caption = "Cod. Class";
            TabCausali.Columns["description"].Caption = "Classificazione";
		...
		string CustomTitle = "Selezione Causale tramite Intelligenza Artificiale\"";
        ...
        private void gridDettagliCausale_MouseUp(object sender, MouseEventArgs e)
		{
			HelpForm.HelpForm_MouseUp(sender, e);
        }

		private void gridDettagliCausale_DoubleClick(object sender, EventArgs e)
		{
			HelpForm.HelpForm_MouseUp(sender, (MouseEventArgs)e);
			ScegliDocs();
		}
	}
}
