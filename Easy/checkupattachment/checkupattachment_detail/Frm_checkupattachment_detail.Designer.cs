...
namespace checkupattachment_detail
{
	partial class Frm_checkupattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new checkupattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "checkupattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "checkupattachment.idattachmentkind";
			...
			this.Name = "Frm_checkupattachment_detail";
			this.Text = "Frm_checkupattachment_detail";
