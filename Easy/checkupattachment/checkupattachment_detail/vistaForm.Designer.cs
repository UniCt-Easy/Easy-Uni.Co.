...
private void initClass() {
	...
	C= new DataColumn("idcheckup", typeof(Int32));
	C.AllowDBNull=true;
	...
	C.AllowDBNull=false;
	tcheckupattachment.Columns.Add(C);
	tcheckupattachment.Columns.Add( new DataColumn("idfilestorage", typeof(string)));
	...
	var cChild = new []{checkupattachment.Columns["idattachmentkind"]};
	Relations.Add(new DataRelation("attachmentkind_checkupattachment",cPar,cChild,false));
