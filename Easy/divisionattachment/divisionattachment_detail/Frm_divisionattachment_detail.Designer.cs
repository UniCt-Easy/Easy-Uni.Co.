...
namespace divisionattachment_detail
{
	partial class Frm_divisionattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new divisionattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "divisionattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "divisionattachment.idattachmentkind";
			...
			this.Name = "Frm_divisionattachment_detail";
			this.Text = "Frm_divisionattachment_detail";
