...
{
    public class Meta_areadidattica : Meta_easydata 
	{
        public Meta_areadidattica(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "areadidattica") {
		...
		public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
			...
			RowChange.MarkAsAutoincrement(T.Columns["idareadidattica"], null, null, 0);
			RowChange.setMinimumTempValue(T.Columns["idareadidattica"], 9990000);
			//$Get_New_Row$
		...
		public override bool IsValid(DataRow R, out string errmess, out string errfield) {
			...
			switch (edit_type) {
				case "default": {
						...
						if (R["idareadidattica"].ToString().Trim() == "") {
							errmess = "Attenzione! Il campo 'Codice' è obbligatorio";
							errfield = "idareadidattica";
							return false;
						}
						if (R["idcorsostudiokind"].ToString().Trim() == "") {
							errmess = "Attenzione! Il campo 'Tipo di corso' è obbligatorio";
						...
						if (R["subtitle"].ToString().Trim().Length > 100) {
							errmess = "Attenzione! Il campo 'Sotto-titolo' può essere al massimo di 100 caratteri";
							errfield = "subtitle";
							return false;
						}
						...
						if (R["title"].ToString().Trim().Length > 100) {
							errmess = "Attenzione! Il campo 'Titolo' può essere al massimo di 100 caratteri";
							errfield = "title";
							return false;
						}
						break;
		...
		public override void DescribeColumns(DataTable T, string ListingType) {
			...
			switch (ListingType) {
				case "default": {
						...
						DescribeAColumn(T, "!idcorsostudiokind_corsostudiokind_title", "Tipo di corso", nPos++);
						DescribeAColumn(T, "!idcorsostudiokind_corsostudiokind_description", "Tipo di corso", nPos++);
						DescribeAColumn(T, "active", "Attivo", nPos++);
						DescribeAColumn(T, "subtitle", "Sotto-titolo", nPos++);
						break;
					}
				//$DescribeAColumn$
			}
