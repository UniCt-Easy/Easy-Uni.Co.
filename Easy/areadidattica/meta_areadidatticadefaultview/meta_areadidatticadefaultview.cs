...
namespace meta_areadidatticadefaultview
{
    public class Meta_areadidatticadefaultview : Meta_easydata 
	{
        public Meta_areadidatticadefaultview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
