...
namespace meta_accountenactment {
    /// <summary>
    /// Summary description for Class1.
    /// </summary>
    public class Meta_accountenactment :Meta_easydata {
        public Meta_accountenactment(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "accountenactment") {
        ...
        protected override Form GetForm(string FormName) {
            if (FormName == "default") {
                Name = "Atto Amministrativo di Budget";
                DefaultListType = "default";
                return MetaData.GetFormByDllName("accountenactment_default");
            }
            return null;
        }
        ...
        protected override void InsertCopyColumn(DataColumn C, DataRow Source, DataRow Dest) {
            if (C.ColumnName == "idenactmentstatus") return;
