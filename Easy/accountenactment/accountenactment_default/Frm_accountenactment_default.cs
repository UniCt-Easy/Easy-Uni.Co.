...
namespace accountenactment_default {
    public partial class Frm_accountenactment_default :Form {
        ...
        private void btnWait_Click(object sender, EventArgs e) {
            ...
            bool do_update = MetaFactory.factory.getSingleton<IMessageShower>().Show("Attenzione, l'atto sarà rimesso nello stato di 'In attesa di approvazione' " +
        ...
        private void btnAnnulla_Click(object sender, EventArgs e) {
            if (!Meta.GetFormData(false)) return;
            bool do_update = MetaFactory.factory.getSingleton<IMessageShower>().Show("Attenzione l'atto sarà annullato " +
