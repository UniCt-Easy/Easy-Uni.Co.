...
namespace accountenactmentattachment_detail
{
	partial class Frm_accountenactmentattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new accountenactmentattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "accountenactmentattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "accountenactmentattachment.idattachmentkind";
			...
			// 
			// Frm_accountenactmentattachment_detail
			// 
			...
			this.Name = "Frm_accountenactmentattachment_detail";
			this.Text = "Frm_accountenactmentattachment_detail";
