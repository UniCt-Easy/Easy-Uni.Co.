...
private void initClass() {
	...
	C.AllowDBNull=false;
	taccountenactmentattachment.Columns.Add(C);
	taccountenactmentattachment.Columns.Add( new DataColumn("idfilestorage", typeof(string)));
	...
	var cChild = new []{accountenactmentattachment.Columns["idattachmentkind"]};
	Relations.Add(new DataRelation("attachmentkind_accountenactmentattachment",cPar,cChild,false));
