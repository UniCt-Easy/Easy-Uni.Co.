...
namespace meta_dichiarisee_seganagstuview
{
    public class Meta_dichiarisee_seganagstuview : Meta_easydata 
	{
        public Meta_dichiarisee_seganagstuview(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "dichiarisee_seganagstuview") {
				Name = "Attestazione ISEE";
			EditTypes.Add("isee_seganagstu");
			ListingTypes.Add("isee_seganagstu");
			//$EditTypes$
        }
		...
		public override void DescribeColumns(DataTable T, string ListingType) {
			...
			switch (ListingType) {
				case "isee_seganagstu": {
						...
						DescribeAColumn(T, "dichiar_isee_numeroprot", "Numero protocollo", nPos++);
						break;
					}
					//$DescribeAColumn$
			}
