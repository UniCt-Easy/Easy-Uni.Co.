...
{
    public class Meta_insegn : Meta_easydata 
	{
        public Meta_insegn(DataAccess Conn, MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "insegn") {
				Name = "Insegnamenti";
		...
		public override DataRow Get_New_Row(DataRow ParentRow, DataTable T) {
			...
			RowChange.MarkAsAutoincrement(T.Columns["idinsegn"], null, null, 0);
			RowChange.setMinimumTempValue(T.Columns["idinsegn"], 9990000);
			//$Get_New_Row$
