	...
	<div style="height:10px" > </div>						
				...
				<tbody>
				 ...
				 <table class="tbFoglio" style="border-bottom-style:hidden">				
											...
											<!--Modificato da Francesco 05/11/2018-->
											<!--Aggiunta la sezione DatiGenerali/DatiContratto oltre alla sezione che già esisteva DatiGenerali/DatiOrdineAcquisto/  -->
											

				 <thead>
				 <tr>
                      <th>Identificativo ordine di acquisto</th>
					  <th>Data ordine di acquisto</th>
					 ...
					 <tr>
					  <td >
                       <xsl:if test="DatiGenerali/DatiOrdineAcquisto/IdDocumento">   					    
							<xsl:value-of select="DatiGenerali/DatiOrdineAcquisto/IdDocumento" />									
					   </xsl:if> 
                       <xsl:if test="DatiGenerali/DatiContratto/IdDocumento">   					    
							<xsl:value-of select="DatiGenerali/DatiContratto/IdDocumento" />									
					   </xsl:if> 					   
                      </td>	
                       <td class="data" >
                       
                       <xsl:if test="DatiGenerali/DatiOrdineAcquisto/Data">                        
							<xsl:call-template name="FormatDateIta">
							<xsl:with-param name="DateTime" select="DatiGenerali/DatiOrdineAcquisto/Data" />
							</xsl:call-template>
                        </xsl:if>

                       <xsl:if test="DatiGenerali/DatiContratto/Data">                        
							<xsl:call-template name="FormatDateIta">
							<xsl:with-param name="DateTime" select="DatiGenerali/DatiContratto/Data" />
							</xsl:call-template>
                        </xsl:if>
					  ...
					  <td >
                       <xsl:if test="DatiGenerali/DatiOrdineAcquisto/CodiceCommessaConvenzione">   					    
							<xsl:value-of select="DatiGenerali/DatiOrdineAcquisto/CodiceCommessaConvenzione" />									
					   </xsl:if>  
                       <xsl:if test="DatiGenerali/DatiContratto/CodiceCommessaConvenzione">   					    
							<xsl:value-of select="DatiGenerali/DatiContratto/CodiceCommessaConvenzione" />									
					   </xsl:if>  
					   </td>	
					  <td >
                       <xsl:if test="DatiGenerali/DatiOrdineAcquisto/CodiceCUP">   					    
							<xsl:value-of select="DatiGenerali/DatiOrdineAcquisto/CodiceCUP" />									
					   </xsl:if>  
                       <xsl:if test="DatiGenerali/DatiContratto/CodiceCUP">   					    
							<xsl:value-of select="DatiGenerali/DatiContratto/CodiceCUP" />									
					   </xsl:if>  
					   </td>	
					  <td >
                       <xsl:if test="DatiGenerali/DatiOrdineAcquisto/CodiceCIG">   					    
							<xsl:value-of select="DatiGenerali/DatiOrdineAcquisto/CodiceCIG" />									
					   </xsl:if>  
                       <xsl:if test="DatiGenerali/DatiContratto/CodiceCIG">   					    
							<xsl:value-of select="DatiGenerali/DatiContratto/CodiceCIG" />									
					   </xsl:if>  					   
                      </td>	
                    </tr>
				 </tbody>
											...
											<!--Modificato da Francesco 24/10/2018-->					
