		...
		public override void DescribeColumns(DataTable T, string listtype) {
			...
			switch (listtype) {
				case "default": {
                    ...
                    DescribeAColumn(T, "number", "Quantit‡ inevasa", nPos++);
                ...
                case "list": {
                    ...
                    DescribeAColumn(T, "store", "Magazzino", nPos++);
                    DescribeAColumn(T, "manager", "Responsabile", nPos++);
                    DescribeAColumn(T, "number", "Quantit‡ non evasa", nPos++);
                    HelpForm.SetFormatForColumn(T.Columns["number"], "n");
                    DescribeAColumn(T, "allocated", "Quantit‡ allocata", nPos++);
                    HelpForm.SetFormatForColumn(T.Columns["allocated"], "n");
                    DescribeAColumn(T, "booked", "Quantit‡ Richiesta", nPos++);
