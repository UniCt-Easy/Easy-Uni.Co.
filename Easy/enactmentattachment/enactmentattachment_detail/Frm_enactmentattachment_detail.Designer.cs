...
namespace enactmentattachment_detail
{
	partial class Frm_enactmentattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new enactmentattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "enactmentattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "enactmentattachment.idattachmentkind";
			...
			// 
			// Frm_enactmentattachment_detail
			// 
			...
			this.Name = "Frm_enactmentattachment_detail";
			this.Text = "Frm_enactmentattachment_detail";
