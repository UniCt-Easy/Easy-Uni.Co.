...
private void initClass() {
	...
	C.AllowDBNull=false;
	tenactmentattachment.Columns.Add(C);
	tenactmentattachment.Columns.Add( new DataColumn("idfilestorage", typeof(string)));
	...
	var cChild = new []{enactmentattachment.Columns["idattachmentkind"]};
	Relations.Add(new DataRelation("attachmentkind_enactmentattachment",cPar,cChild,false));
