...
namespace wageadditionsetup_default//perscontrattodip//
{
	/// <summary>
	/// Summary description for frmperscontrattodip.
	/// </summary>
	public class Frm_wageadditionsetup_default : System.Windows.Forms.Form
	{
		public vistaForm DS;
		...
		public Frm_wageadditionsetup_default()
		{
			InitializeComponent();
			HelpForm.SetDenyNull(DS.wageadditionsetup.Columns["flagrestart"],true);
		}
		...
		public void MetaData_AfterClear()
		{
			...
			{
				CanGoEdit=false;
				MetaData.DoMainCommand(this, "maindosearch.perscontrattodip");
			}
		}
		...
		public void MetaData_AfterLink() 
		{
			...
			int numrigheperscontratto = Meta.Conn.RUN_SELECT_COUNT("wageadditionsetup",filteresercizio,
				true);
			...
			GetData.SetStaticFilter(DS.wageadditionsetup,filteresercizio);
		}
		...
		private void InitializeComponent()
		{
			...
			this.chkAzzera.Tag = "wageadditionsetup.flagrestart:S:N";
			...
			this.rdbAutomatica.Tag = "wageadditionsetup.flagnumbering:A";
			...
			this.rdbManuale.Tag = "wageadditionsetup.flagnumbering:M";
			...
			this.Name = "frmperscontrattodip";
			this.Text = "frmperscontrattodip";
