...
namespace meta_instmkwcampiapplicativiregistry_instmuser {
public class instmkwcampiapplicativiregistry_instmuserRow: MetaRow  {
	public instmkwcampiapplicativiregistry_instmuserRow(DataRowBuilder rb) : base(rb) {} 
...
public class instmkwcampiapplicativiregistry_instmuserTable : MetaTableBase<instmkwcampiapplicativiregistry_instmuserRow> {
	public instmkwcampiapplicativiregistry_instmuserTable() : base("instmkwcampiapplicativiregistry_instmuser"){
