...
public DataTable specialcategory770{get { return Tables["specialcategory770"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
public DataTable registryspecialcategory770{get { return Tables["registryspecialcategory770"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
...
EnforceConstraints = false;
	...
	DataColumn C;
	DataColumn [] key;
	T= new DataTable("specialcategory770");
	C= new DataColumn("idspecialcategory770", typeof(System.String), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);
...
//Primary Key
	...
	T.Columns["idspecialcategory770"], 	T.Columns["ayear"]};
	T.PrimaryKey = key;

	T= new DataTable("registryspecialcategory770");
	C= new DataColumn("idregistryspecialcategory770", typeof(System.Int32), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);
...
//Primary Key
	key = new DataColumn[2]{
	T.Columns["idregistryspecialcategory770"], 	T.Columns["idreg"]};
	T.PrimaryKey = key;
...
TChild= Tables["registryspecialcategory770"];
CPar = new DataColumn[1]{TPar.Columns["idreg"]};
CChild = new DataColumn[1]{TChild.Columns["idreg"]};
Relations.Add(new DataRelation("FK_registry_registryspecialcategory770",CPar,CChild));

TPar= Tables["specialcategory770"];
TChild= Tables["registryspecialcategory770"];
CPar = new DataColumn[2]{TPar.Columns["idspecialcategory770"], TPar.Columns["ayear"]};
CChild = new DataColumn[2]{TChild.Columns["idspecialcategory770"], TChild.Columns["ayear"]};
Relations.Add(new DataRelation("FK_specialcategory770_registryspecialcategory770",CPar,CChild));
