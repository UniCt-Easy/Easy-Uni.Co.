...
namespace meta_sessionekind {
public class sessionekindRow: MetaRow  {
	public sessionekindRow(DataRowBuilder rb) : base(rb) {} 
...
///<summary>
///VOCABOLARIO modificabile da loro delle tipologie delle 2.2.6 Sessione di esami
///</summary>
public class sessionekindTable : MetaTableBase<sessionekindRow> {
	public sessionekindTable() : base("sessionekind"){
		baseColumns = new Dictionary<string, DataColumn>(){
			...
			{"idsessionekind",createColumn("idsessionekind",typeof(int),false,false)},
