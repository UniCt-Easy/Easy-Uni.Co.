...
{
	partial class Frm_maintenanceattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new maintenanceattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "maintenanceattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "maintenanceattachment.idattachmentkind";
			...
			// 
			// Frm_maintenanceattachment_detail
			// 
			...
			this.Name = "Frm_maintenanceattachment_detail";
			this.Text = "Frm_maintenanceattachment_detail";
