...
namespace registrytaxablestatusattachment_detail
{
	partial class Frm_registrytaxablestatusattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new registrytaxablestatusattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "registrytaxablestatusattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "registrytaxablestatusattachment.idattachmentkind";
			...
			// 
			// Frm_registrytaxablestatusattachment_detail
			// 
			...
			this.Name = "Frm_registrytaxablestatusattachment_detail";
			this.Text = "Frm_registrytaxablestatusattachment_detail";
