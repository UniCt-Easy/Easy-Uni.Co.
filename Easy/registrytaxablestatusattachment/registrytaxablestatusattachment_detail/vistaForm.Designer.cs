...
private void initClass() {
	...
	var cChild = new []{registrytaxablestatusattachment.Columns["idattachmentkind"]};
	Relations.Add(new DataRelation("attachmentkind_registrytaxablestatusattachment",cPar,cChild,false));
