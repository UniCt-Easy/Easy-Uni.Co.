...
{
	public partial class Frm_registrytaxablestatusattachment_detail : MetaDataForm
    {
        MetaData Meta;
        public IOpenFileDialog openFileDialog1;
        public Frm_registrytaxablestatusattachment_detail()
		{
			InitializeComponent();
        ...
        public void MetaData_AfterFill(){
            DataRow R = DS.registrytaxablestatusattachment.Rows[0];
		...
		{
            if (Meta.IsEmpty) return;
            DataRow Curr = DS.registrytaxablestatusattachment.Rows[0];
