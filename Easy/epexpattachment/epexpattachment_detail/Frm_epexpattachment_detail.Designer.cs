...
{
	partial class Frm_epexpattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new epexpattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "epexpattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "epexpattachment.idattachmentkind";
			...
			this.Name = "Frm_epexpattachment_detail";
			this.Text = "Frm_epexpattachment_detail";
