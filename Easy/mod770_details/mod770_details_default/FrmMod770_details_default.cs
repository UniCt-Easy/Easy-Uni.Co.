...
namespace mod770_details_default
{
	...
	/// </summary>
	public class FrmMod770_details_default : MetaDataForm
	{
        DataTable tMod770;
...
/*		private bool ignoraEventualiErrori() {
			...
			if (errMsg != null) {
				show(this, "Si è verificato il seguente errore nel calcolo del 770:"
            ...
            if (tResult.Rows.Count != 0)
            {
                ...
                if (tResult.Select(QHC.CmpEq("blockingerror", "S")).Length > 0)
                {
                    ...
                    if (!isAdmin)
                        ...
                        if (show(" Si desidera proseguire l''elaborazione nonostante  gli errori?", "Errore",
   ...
   if (T != null)
	{
	   VisualizzaDati(sender, e, T);
        ...
        private void generaIlModello770(bool soloRecordHI, bool salvaSuFile) {
            ...
            if (ds_RecordA == null)
            {
                show(this, "Si è verificato il seguente errore nel calcolo del Record A del modello 770:"
                    + "\n" + errMsg + "\nRiprovare o chiamare l'ASSISTENZA");
                Cursor = null;
                return;
            }
            ...
            if (ds_RecordI == null)
            {
                show(this, "Si è verificato il seguente errore nel calcolo del Record I del modello 770:"
                    + "\n" + errMsg + "\nRiprovare o chiamare l'ASSISTENZA");
                Cursor = null;
                return;
            }
            ...
            if (ds_RecordB == null)
            {
                show(this, "Si è verificato il seguente errore nel calcolo del Record B del modello 770:"
                    + "\n" + errMsg + "\nRiprovare o chiamare l'ASSISTENZA");
                Cursor = null;
                return;
            }
