...
{
	/// <summary>
	/// Summary description for Frm_apactivitykind_default.
	/// </summary>
	public class Frm_apactivitykind_default : MetaDataForm
	{
		public apactivitykind_default.vistaForm DS;
		...
		public Frm_apactivitykind_default()
		{
			//
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Frm_apactivitykind_default));
			...
			this.DS = new apactivitykind_default.vistaForm();
			...
			this.MetaDataToolBar.Size = new System.Drawing.Size(528, 106);
			this.MetaDataToolBar.TabIndex = 44;
			...
			this.dataGrid1.Size = new System.Drawing.Size(512, 219);
			this.dataGrid1.TabIndex = 45;
			this.dataGrid1.Tag = "apactivitykind.default";
			// 
			// MetaDataDetail
			// 
			...
			this.MetaDataDetail.Location = new System.Drawing.Point(8, 280);
			this.MetaDataDetail.Name = "MetaDataDetail";
			this.MetaDataDetail.Size = new System.Drawing.Size(512, 193);
			...
			// chkAttivo
			// 
			this.chkAttivo.Location = new System.Drawing.Point(448, 25);
			this.chkAttivo.Name = "chkAttivo";
			this.chkAttivo.Size = new System.Drawing.Size(56, 24);
			this.chkAttivo.TabIndex = 57;
			this.chkAttivo.Tag = "apactivitykind.active:S:N";
			...
			this.textBox1.Tag = "apactivitykind.idapactivitykind";
			// 
			// label1
			// 
			...
			this.textBox2.Tag = "apactivitykind.description";
			// 
			// label2
			// 
			...
			this.textBox3.Tag = "apactivitykind.description_consultant";
			// 
			// label3
			// 
			...
			this.textBox4.Tag = "apactivitykind.description_employee";
			// 
			// label4
			// 
			...
			this.Name = "Frm_apactivitykind_default";
			this.Text = "Frm_apactivitykind_default";
