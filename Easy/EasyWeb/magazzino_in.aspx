<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="MetaMaster.master" CodeFile="magazzino_in.aspx.cs" Inherits="magazzino_in" %>
...
var PopupWarning = {
  ...
  dothething : function ()
  {
   var childWindow;
        ...
        childWindow=window.open("magazzino_ingresso.aspx?x="+getUrlVar("dep"),"_self","status=no,titlebar=no,toolbar=no,directories=no,location=no,menubar=no,scrollbars=yes,resizable=yes,"+
        "width=1024,height=768,left="+leftval+",top="+topval);
