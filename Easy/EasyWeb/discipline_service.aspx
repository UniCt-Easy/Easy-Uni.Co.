<%@ Page Language="C#" AutoEventWireup="true" CodeFile="discipline_service.aspx.cs" Inherits="EasyWebReport.discipline_service" %>
...
<body>
    ...
    <form id="parameters" runat="server">
        <div class="datapage">
            ...
            <div class="dataform">
                <div class="dataline">
                    <asp:Label ID="Label1" runat="server" Text="Anno" AssociatedControlID="aa"></asp:Label>
