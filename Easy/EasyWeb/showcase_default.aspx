...
<HelpWeb:hwButton runat="server" id="btnElimina" tag="delete" style="position: absolute;  left:12px; top:319px; width:75px;height:23px;" TabIndex="18" Text="Elimina"/>
<HelpWeb:hwButton runat="server" id="btnModifica" tag="edit.single" style="position: absolute;  left:12px; top:290px; width:75px;height:23px;" TabIndex="17" Text="Modifica"/>
<HelpWeb:hwButton runat="server" id="btnInserisci" tag="insert.single" style="position: absolute;  left:12px; top:261px; width:75px;height:23px;" TabIndex="16" Text="Inserisci"/>
...
<HelpWeb:hwButton runat="server" id="button1" tag="choose.store.default" style="position: absolute;  left:22px; top:14px; width:75px;height:23px;" Text="Magazzino"/>
</HelpWeb:hwPanel>
