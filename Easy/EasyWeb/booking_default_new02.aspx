    ...
    <div class="row">
        <div class="col-md-12">
            <fieldset>
                ...
                <div class="row">
                    <div class="col-md-2">
                        <cc1:hwButton runat="server" ID="btnCard" Tag="choose.lcard.default" class="btn btn-primary" Text="Card" />
                    </div>
                    <div class="col-md-6">
    ...
    <div class="row">		 		
		<div class="col-md-12">	
            <fieldset>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <cc1:hwButton runat="server" ID="btndelete" Tag="delete" TabIndex="7" class="btn btn-danger" Text="Elimina" />
                        <cc1:hwButton runat="server" ID="btnedit" Tag="edit.singlenew02" TabIndex="6" class="btn btn-info" Text="Modifica" />
                        <cc1:hwButton runat="server" ID="btnvetrina" Tag="vetrina" TabIndex="8" class="btn btn-primary" Text="Vetrina" style="background-color:#ff9966;color: Black;" />
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
