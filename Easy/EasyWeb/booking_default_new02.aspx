                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            ...
                            <cc1:hwButton runat="server" ID="btnedit" Tag="edit.singlenew02" TabIndex="6" class="btn  btn-block" Text="Modifica" />
                            <cc1:hwButton runat="server" ID="btnvetrina" Tag="vetrina" TabIndex="8" class="btn  btn-block" Text="Vetrina" style="background-color:#ff9966;color: Black;" />
                        </div>
                        <div class="col-md-10">
