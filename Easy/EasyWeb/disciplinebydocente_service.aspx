<%@ Page Language="C#" AutoEventWireup="true" CodeFile="disciplinebydocente_service.aspx.cs" Inherits="EasyWebReport.disciplinebydocente_service" %>
    ...
    <form id="parameters" runat="server">
        <div class="datapage">
            ...
            <div class="dataform">
                ...
                <div class="dataline">
                    <asp:Label ID="Label4" runat="server" Text="Corso di studio" AssociatedControlID="idreg"></asp:Label>
                    <asp:TextBox ID="idreg" runat="server"></asp:TextBox>
                </div>
