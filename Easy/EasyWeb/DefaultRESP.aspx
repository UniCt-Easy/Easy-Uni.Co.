<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="MetaMasterBootstrap.master" CodeFile="DefaultRESP.aspx.cs" Inherits="DefaultRESP" %>
    ...
    <script type="text/javascript">
        function detectPopupBlocker() {
            ...
            if (testWindow) {
                ...
                window.location = "LoginRESP.aspx?popup=ok";
            }
            else {
