...
<asp:Content ID="Content4" ContentPlaceHolderID="CHP_PC" Runat="Server">
        ...
        <div class="col-md-12">
            ...
            <cc1:hwpanel GroupingText="Tipo di documento allegato(Opzionale)" CssClass="stdfieldset form-group"  runat="server" id="grpTipoallegato" >
            <cc1:hwDropDownList runat="server" CssClass="input-md form-control"  id="cmbCodiceAllegato" tag="itinerationattachment.idattachmentkind"></cc1:hwDropDownList>
            </cc1:hwpanel>
        </div>
    </div>
