<%@ Page Language="C#" AutoEventWireup="true" CodeFile="docenti_service.aspx.cs" Inherits="EasyWebReport.docenti_service" %>
...
<body>
    ...
    <form id="parameters" runat="server">
        <div class="datapage">
            ...
            <div class="dataform">
<%--                <div class="dataline">
                    <asp:Label ID="Label1" runat="server" Text="Anno" AssociatedControlID="ayear"></asp:Label>
                    <asp:TextBox ID="ayear" runat="server"></asp:TextBox>
                </div>--%>
