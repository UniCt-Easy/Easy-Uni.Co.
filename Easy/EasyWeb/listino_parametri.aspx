...
<asp:Content ID="Content4" ContentPlaceHolderID="CHP_PC" Runat="Server" >
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <cc1:hwPanel GroupingText="Class.Merceologica" CssClass="gbox stdfieldset form-group" ID="grpClassMerceologica" runat="server" Tag="AutoChoose.txtCodClassMerc.default">
                        <div class="row">
                            <div class="col-12">
                                <span>Selezionare la classificazione mercelogica e premere OK</span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-12">
                                        <cc1:hwButton ID="btnClassMerc" runat="server" Text="Classificazione" class="btn btn-primary" Tag="manage.listclass.mandatetree" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
            ...
            <div class="row">
                <div class="col-md-12 text-right">
                    <cc1:hwButton ID="btnOk" runat="server" Text="Ok" class="btn btn-success btn-80" Tag="Accetta" />
                    <cc1:hwButton ID="btnCancel" runat="server" Text="Annulla" class="btn btn-danger btn-80" Tag="Annulla" />
                </div>
            </div>
        </div>
    </div>
...
<asp:Content ID="Content9" ContentPlaceHolderID="JScriptBeforeLibs" Runat="Server"></asp:Content>

<asp:Content ID="Content10" ContentPlaceHolderID="JScriptAfterLibs" Runat="Server"></asp:Content>
