<%@ Page Language="C#" AutoEventWireup="true" CodeFile="disciplinebycorso_service.aspx.cs" Inherits="EasyWebReport.disciplinebycorso_service" %>
...
<head runat="server">
    ...
    <title>Discipline del docente</title>
</head>
<body>
    <h1>Discipline del corso</h1>
    <form id="parameters" runat="server">
        <div class="datapage">
            &nbsp;
            <div class="dataform">
                <div class="dataline">
                    <asp:Label ID="Label3" runat="server" Text="Anno" AssociatedControlID="aa"></asp:Label>
                    <asp:TextBox ID="aa" runat="server"></asp:TextBox>
                </div>
                <div class="dataline">
                    <asp:Label ID="Label4" runat="server" Text="Corso di studio" AssociatedControlID="idcorsostudio"></asp:Label>
                    <asp:TextBox ID="idcorsostudio" runat="server"></asp:TextBox>
                </div>
<%--                <asp:Label ID="Label3" runat="server" Text="Dipartimento (facoltativo)" AssociatedControlID="dep"></asp:Label>
        ...
        <asp:Button ID="Button1" runat="server" Text="Aggiorna" />
    </form>
