...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<asp:Label id="Label3" style="Z-INDEX: 118; LEFT: 56px; POSITION: absolute; TOP: 16px" runat="server"
				Width="328px">Aggiunta di un server al servizio di Web Reporting</asp:Label><INPUT id="txtPWD" style="Z-INDEX: 117; LEFT: 56px; WIDTH: 264px; POSITION: absolute; TOP: 400px; HEIGHT: 22px"
			...
			<INPUT style="Z-INDEX: 102; LEFT: 56px; WIDTH: 328px; POSITION: absolute; TOP: 72px; HEIGHT: 22px"
				type="password" size="49" name="txtPwdSystem">
			<asp:TextBox id="txtCodice" style="Z-INDEX: 107; LEFT: 56px; POSITION: absolute; TOP: 192px"
				runat="server" Width="328px"></asp:TextBox>
			<asp:Label id="Label1" style="Z-INDEX: 104; LEFT: 56px; POSITION: absolute; TOP: 112px" runat="server">Nome del Dipartimento da aggiungere</asp:Label>
			<asp:TextBox id="txtDip" style="Z-INDEX: 105; LEFT: 56px; POSITION: absolute; TOP: 136px" runat="server"
				Width="328px"></asp:TextBox>
			<asp:Label id="Label2" style="Z-INDEX: 106; LEFT: 56px; POSITION: absolute; TOP: 168px" runat="server">Codice del dipartimento (che sarà poi usato per selezionarlo)</asp:Label>
			<asp:Label id="Label5" style="Z-INDEX: 108; LEFT: 56px; POSITION: absolute; TOP: 224px" runat="server">IP del server del dipartimento</asp:Label>
