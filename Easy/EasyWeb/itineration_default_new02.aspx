                    ...
                    <div title="Generale">
                        <asp:Panel ID="Panel1" runat="server">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <cc1:hwTextBox runat="server" CssClass="input-md form-control" ID="HwTextBox1" Tag="itineration.description" TextMode="MultiLine" TabIndex="100" Rows="4"></cc1:hwTextBox>
                                </div>
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 autochoose">
                                                <cc1:hwPanel GroupingText="" CssClass="gbox scheduler-border form-group" ID="grpResponsabile" runat="server" Tag="AutoChoose.txtResponsabile.lista.(financeactive='S')">
                                                    <cc1:hwButton ID="btnResponsabile" runat="server" Text="Responsabile" class="btn btn-primary" Tag="choose.manager.lista.(financeactive='S')" />
                            ...
                            <!-- Posizione giuridica (a cura del sistema) -->
                            <div class="row">
                                <div class="panel-group col-md-12">
                                    <div class="accordion">
                                        <h3>Posizione giuridica (a cura del sistema)</h3>
                                        <div>
					        ...
					        <div class="col-md-12">	
                                ...
                                <fieldset>
                                    <legend>Spese Preventivate/Anticipo Richiesto</legend>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <cc1:hwButton runat="server" id="btnInsertSpesa" tag="insert.advancenew02" TabIndex="-1" class="btn btn-primary" Text="Inserisci"></cc1:hwButton>
                                                <cc1:hwButton runat="server"  id="btnEditSpesa" tag="edit.advancenew02" TabIndex="-1" class="btn btn-info" Text="Modifica"></cc1:hwButton>
                                                <cc1:hwButton runat="server" id="btnDelSpesa" tag="delete" TabIndex="-1" class="btn btn-danger" Text="Elimina"></cc1:hwButton>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
		        ...
		        <div id="taballegati" class="tab-pane fade">
                    <div title="Allegati">
                        <asp:Panel ID="Panel2" runat="server">
                            <div class="row">
						        <div class="col-md-12">	
                                    <cc1:hwButton id="btnInsAtt" runat="server"  Tag="insert.defaultnew02" Text="Inserisci" class="btn btn-primary" TabIndex="210"></cc1:hwButton>
                                    <cc1:hwButton id="btnEditAtt" runat="server"  Tag="edit.defaultnew02" Text="Modifica" class="btn btn-info" TabIndex="220"></cc1:hwButton>
                                    <cc1:hwButton id="btnDelAtt" runat="server"  Tag="delete" Text="Elimina" class="btn btn-danger" TabIndex="230"></cc1:hwButton>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">	
                                    ...
                                    <div class="col-md-12">
                                        <cc1:hwPanel GroupingText="U.P.B."  CssClass="pr-4 pl-4 pt-3 pb-3 gbox scheduler-border form-group grpborder pr-1" ID="PanelUpb" runat="server" Tag="AutoManage.txtCodiceUPB.tree.(active=\'S\')">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <cc1:hwTextBox runat="server" Tag="upb.title" ID="txtDescrUPB" CssClass="input-md form-control" TextMode="multiline" Rows="3" TabIndex="-1"></cc1:hwTextBox>
                                                </div>
                                            </div>
                                        </cc1:hwPanel>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <fieldset>
                                                ...
                                                <cc1:hwPanel GroupingText="Causale" CssClass="gbox stdfieldset form-group" ID="PaneCausaleEP" runat="server" Tag="AutoManage.txtCodiceCausale.tree.(in_use='S')">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <cc1:hwButton runat="server" ID="BtnCausale" Tag="manage.accmotiveapplied.tree" TabIndex="400" class="btn btn-primary" Text="Causale"></cc1:hwButton>
