                    ...
                    <asp:Panel ID="grpDataInizioFine" runat="server">
                        ...
                        <div class="row">
                            <div class="col-4 col-md-3 w-100 align-self-end">
                                <label>Valuta</label>
                                <cc1:hwButton runat="server" ID="btnValuta" Tag="choose.currency.lista" CssClass="w-100" TabIndex="-1" Text="Valuta:" />
                            </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <asp:Panel ID="grpLocalita" runat="server">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <cc1:hwButton ID="btnArea" runat="server" TabIndex="-1" CssClass="w-100" Tag="choose.foreigncountry.default" Text="Località Estera:" />
                    </div>
                    <div class="col-md-9">
