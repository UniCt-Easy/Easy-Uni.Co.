...
namespace EasyWebReport
{
    public class ldapauth
    {
        ...
        public bool getconfig()
        {
            ...
            /// <summary>
            /// Legge la configurazione dalla tabella ldapconfig utilizzando i campi seguenti:
        ...
        public bool TrustAuthenticate(string username)
        {
        ...
        public bool Authenticate(string username, string password)
        {
            ...
            ldapconn.AuthType = use_ntlm ? AuthType.Ntlm : AuthType.Basic;
