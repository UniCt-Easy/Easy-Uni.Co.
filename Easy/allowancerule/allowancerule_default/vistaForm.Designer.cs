...
public partial class vistaForm: DataSet {
	...
	public DataTable allowancerule 		=> Tables["allowancerule"];
...
private void initClass() {
	...
	DataColumn C;
	//////////////////// ALLOWANCERULE /////////////////////////////////
	var tallowancerule= new DataTable("allowancerule");
	C= new DataColumn("idallowancerule", typeof(int));
	C.AllowDBNull=false;
	tallowancerule.Columns.Add(C);
	...
	C.AllowDBNull=false;
	tallowancerule.Columns.Add(C);
	Tables.Add(tallowancerule);
	tallowancerule.PrimaryKey =  new DataColumn[]{tallowancerule.Columns["idallowancerule"]};
	...
	C.AllowDBNull=false;
	tallowanceruledetail.Columns.Add(C);
	tallowanceruledetail.Columns.Add( new DataColumn("!qualifica", typeof(string)));
	...
	cPar = new []{allowancerule.Columns["idallowancerule"]};
	cChild = new []{allowanceruledetail.Columns["idallowancerule"]};
	Relations.Add(new DataRelation("allowancerule_allowanceruledetail",cPar,cChild,false));
