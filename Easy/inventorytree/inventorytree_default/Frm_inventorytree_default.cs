...
namespace inventorytree_default//classinventario//
{
	...
	/// </summary>
	public class Frm_inventorytree_default : MetaDataForm {
		...
		private void InitializeComponent()
		{
			...
			this.dataGridAllegati.Tag = "inventorytreeattachment.lista.detail";
			// 
			// btnDelAtt
			// 
		...
		public void MetaData_AfterLink(){
            ...
            // ===============================================================================
            QueryCreator.setSkipInsertCopy(DS.inventorytreeattachment, true);
        }
