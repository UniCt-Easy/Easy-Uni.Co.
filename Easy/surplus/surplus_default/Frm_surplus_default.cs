...
namespace surplus_default {//situazioneammin//
	...
	public class Frm_surplus_default : System.Windows.Forms.Form {
		...
		private void InitializeComponent() {
			...
			this.txtDescrResiduiPassiviCorrenti.Text = "Impegni non Pagati o dei quali il pagamento non è stato ancora trasmesso";
			// 
			...
			this.txtDescrResiduiAttiviCorrenti.Text = "Accertamenti non Incassati o dei quali l\'incasso non è stato ancora trasmesso";
			// 
		...
		private void txtData_TextChanged(object sender, System.EventArgs e) {
			...
			txtDescrIncassiPresunti.Text = "Incassi Trasmessi dopo il " + ddd.Day.ToString() + "/" + ddd.Month.ToString() + "/" + ddd.Year.ToString() + " e comunque entro l'anno" 
				+ " + Incassi non inseriti in reversale + Incassi non Trasmessi + Accertamenti che scadono entro il 31/12/" + ddd.Year.ToString() + " o di cui la data di scadenza non è specificata";
			txtDescrPagamentiPresunti.Text = "Pagamenti Trasmessi dopo il " + ddd.Day.ToString() + "/" + ddd.Month.ToString() + "/" + ddd.Year.ToString() + " e comunque entro l'anno" 
				+ " + Pagamenti non inseriti in mandato + Pagamenti non Trasmessi + Impegni che scadono entro il 31/12/" + ddd.Year.ToString() + " o di cui la data di scadenza non è specificata";
		...
		private string DescrizioneConfBilancio(string entrata_spesa) {
			string descrizione;
			if (entrata_spesa == "E") {
				descrizione = "Sono considerati tutti gli incassi per i quali la reversale è ";
				...
				descrizione = "Sono considerati tutti i pagamenti per i quali il mandato è ";
				switch(flagvaliditadoc) {
					case "1" : 
