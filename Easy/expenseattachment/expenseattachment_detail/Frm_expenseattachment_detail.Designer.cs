...
{
	partial class Frm_expenseattachment_detail
	{
		/// <summary>
		...
		{
			this.DS = new expenseattachment_detail.vistaForm();
			...
			this.labAutocertFileName.Tag = "expenseattachment.filename";
			// 
			// grpTipoallegato
			// 
			...
			this.cmbCodiceAllegato.Tag = "expenseattachment.idattachmentkind";
			...
			this.Name = "Frm_expenseattachment_detail";
			this.Text = "Frm_expenseattachment_detail";
