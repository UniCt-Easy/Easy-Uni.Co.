...
namespace meta_autoexpensesortingview{//meta_autoclassspeseview//
	/// <summary>
	/// Summary description for Class1.
	/// </summary>
	public class Meta_autoexpensesortingview : Meta_easydata {
		public Meta_autoexpensesortingview(DataAccess Conn, MetaDataDispatcher Dispatcher):
			base(Conn, Dispatcher, "autoexpensesortingview") {
