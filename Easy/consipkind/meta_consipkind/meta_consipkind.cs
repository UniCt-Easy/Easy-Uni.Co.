...
namespace meta_consipkind
{
    /// <summary>
    /// Summary description for Meta_casualcontractyear.
    /// </summary>
    public class Meta_consipkind : Meta_easydata
    {
        public Meta_consipkind(DataAccess Conn, MetaDataDispatcher Dispatcher)
            :
            base(Conn, Dispatcher, "consipkind")
        {
        ...
        protected override Form GetForm(string FormName)
        {
            if (FormName == "default")
            {
                ...
                return MetaData.GetFormByDllName("consipkind_default");
            }
            return null;
        }
        ...
        public override void DescribeColumns(DataTable T, string ListingType)
        {
            ...
            if (ListingType == "default")
            {
                ...
                DescribeAColumn(T, "flagpurchaseperformed", "Acquisto effettuato");
            }
        }
