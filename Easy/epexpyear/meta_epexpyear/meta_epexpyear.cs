...
namespace meta_epexpyear//meta_imputazionespesa//
{
    /// <summary>
    /// Summary description for imputazionespesa.
    /// </summary>
    public class Meta_epexpyear : Meta_easydata {
        public Meta_epexpyear(DataAccess Conn,
            MetaDataDispatcher Dispatcher) :
            base(Conn, Dispatcher, "epexpyear") {
        }
        ...
        override public bool IsValid(DataRow R, out string errmess, out string errfield) {
            ...
            if ((usage & 4416) == 0) {
                errmess = "E' necessario selezionare un conto di COSTO o IMMOBILIZZAZIONE o FONDO ACCANTONAMENTO.";
                errfield = "idacc";
                return false;
            }
            return true;
