...
namespace assetvar_default {//VariazionePatrimonio//
	...
	/// </summary>
	public class Frm_assetvar_default : MetaDataForm {
        ...
        public void MetaData_AfterLink() {
            ...
            // ===============================================================================
            QueryCreator.setSkipInsertCopy(DS.assetvarattachment, true);
        }
		...
		private void InitializeComponent() {
			...
			this.comboBoxEnteInventario.Size = new System.Drawing.Size(444, 21);
			...
			this.textBoxDescrizione.Size = new System.Drawing.Size(444, 40);
			...
			// labelDataContabile
			// 
			this.labelDataContabile.Location = new System.Drawing.Point(8, 92);
			...
			// 
			this.textBoxDataContabile.Location = new System.Drawing.Point(96, 92);
			...
			this.dataGridAllegati.Tag = "assetvarattachment.lista.detail";
			// 
			// btnDelAtt
			// 
			...
			this.tabPage1.Controls.Add(this.labelDataContabile);
			this.tabPage1.Controls.Add(this.textBoxDataContabile);
