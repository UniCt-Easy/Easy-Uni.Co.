...
//Primary Key
	...
	T.Columns.Add(new DataColumn("!classificazione", typeof(System.String), ""));
	T.Columns.Add(new DataColumn("!nome_classificazione", typeof(System.String), ""));
...
Relations.Add(new DataRelation("inventorytreeassetvardetail",CPar,CChild));
