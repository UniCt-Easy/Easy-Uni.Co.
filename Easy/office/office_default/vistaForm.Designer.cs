...
public DataTable office{get { return Tables["office"];}}
[System.Diagnostics.DebuggerNonUserCodeAttribute()]
[System.ComponentModel.Browsable(false)]
...
EnforceConstraints = false;
	...
	DataColumn C;
	DataColumn [] key;
	T= new DataTable("office");
	C= new DataColumn("idoffice", typeof(System.Int32), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);

	C= new DataColumn("code", typeof(System.String), "");
	C.AllowDBNull=false;
	T.Columns.Add(C);
