...
namespace meta_mainivapayexpenseview{
    public class Meta_mainivapayexpenseview: Meta_easydata  {
        public Meta_mainivapayexpenseview(DataAccess Conn, MetaDataDispatcher Dispatcher):
                    base(Conn, Dispatcher, "mainivapayexpenseview")    {
