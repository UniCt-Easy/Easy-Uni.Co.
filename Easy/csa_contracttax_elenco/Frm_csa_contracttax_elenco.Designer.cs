...
namespace csa_contracttax_elenco {
    partial class Frm_csa_contracttax_elenco {
        /// <summary>
        ...
        private void InitializeComponent() {
			this.DS = new csa_contracttax_elenco.vistaForm();
			...
			this.grpRipartizioneUnica = new System.Windows.Forms.GroupBox();
			this.button4 = new System.Windows.Forms.Button();
			this.button6 = new System.Windows.Forms.Button();
			this.button7 = new System.Windows.Forms.Button();
			this.dataGrid3 = new System.Windows.Forms.DataGrid();
			this.grpImpBudget = new System.Windows.Forms.GroupBox();
			this.button1 = new System.Windows.Forms.Button();
			this.button2 = new System.Windows.Forms.Button();
			this.button3 = new System.Windows.Forms.Button();
			this.dataGrid2 = new System.Windows.Forms.DataGrid();
			this.grpFinanziaria = new System.Windows.Forms.GroupBox();
			...
			this.grpRipartizioneUnica.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.dataGrid3)).BeginInit();
			this.grpImpBudget.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.dataGrid2)).BeginInit();
			this.grpFinanziaria.SuspendLayout();
			...
			this.tabControl1.Size = new System.Drawing.Size(884, 440);
			...
			this.tabPage1.Size = new System.Drawing.Size(876, 414);
			...
			this.groupBox2.Size = new System.Drawing.Size(424, 404);
			...
			// tabPage2
			// 
			this.tabPage2.Controls.Add(this.grpRipartizioneUnica);
			this.tabPage2.Controls.Add(this.grpImpBudget);
			this.tabPage2.Controls.Add(this.grpFinanziaria);
			this.tabPage2.Location = new System.Drawing.Point(4, 22);
			this.tabPage2.Name = "tabPage2";
			this.tabPage2.Padding = new System.Windows.Forms.Padding(3);
			this.tabPage2.Size = new System.Drawing.Size(876, 414);
			this.tabPage2.TabIndex = 1;
			this.tabPage2.Text = "Ripartizioni";
			this.tabPage2.UseVisualStyleBackColor = true;
			// 
			// grpRipartizioneUnica
			// 
			this.grpRipartizioneUnica.Controls.Add(this.button4);
			this.grpRipartizioneUnica.Controls.Add(this.button6);
			this.grpRipartizioneUnica.Controls.Add(this.button7);
			this.grpRipartizioneUnica.Controls.Add(this.dataGrid3);
			this.grpRipartizioneUnica.Location = new System.Drawing.Point(10, 264);
			this.grpRipartizioneUnica.Name = "grpRipartizioneUnica";
			this.grpRipartizioneUnica.Size = new System.Drawing.Size(856, 127);
			this.grpRipartizioneUnica.TabIndex = 26;
			this.grpRipartizioneUnica.TabStop = false;
			this.grpRipartizioneUnica.Text = "Ripartizione unica";
			// 
			// button4
			// 
			...
			this.dataGrid3.Size = new System.Drawing.Size(734, 104);
			this.dataGrid3.TabIndex = 24;
			this.dataGrid3.Tag = "csa_contracttax_partition.default.detail";
			// 
			// grpImpBudget
			// 
			this.grpImpBudget.Controls.Add(this.button1);
			this.grpImpBudget.Controls.Add(this.button2);
			this.grpImpBudget.Controls.Add(this.button3);
			this.grpImpBudget.Controls.Add(this.dataGrid2);
			this.grpImpBudget.Location = new System.Drawing.Point(10, 138);
			this.grpImpBudget.Name = "grpImpBudget";
			this.grpImpBudget.Size = new System.Drawing.Size(856, 122);
			this.grpImpBudget.TabIndex = 24;
			this.grpImpBudget.TabStop = false;
			this.grpImpBudget.Text = "Impegni di Budget";
			// 
			// button1
			// 
			...
			this.dataGrid2.Size = new System.Drawing.Size(734, 99);
			this.dataGrid2.TabIndex = 24;
			this.dataGrid2.Tag = "csa_contracttaxepexp.default.detail";
			// 
			// grpFinanziaria
			// 
			this.grpFinanziaria.Controls.Add(this.btnInserisci);
			this.grpFinanziaria.Controls.Add(this.btnModifica);
			this.grpFinanziaria.Controls.Add(this.btnElimina);
			this.grpFinanziaria.Controls.Add(this.dataGrid1);
			this.grpFinanziaria.Location = new System.Drawing.Point(10, 6);
			this.grpFinanziaria.Name = "grpFinanziaria";
			this.grpFinanziaria.Size = new System.Drawing.Size(856, 126);
			this.grpFinanziaria.TabIndex = 23;
			this.grpFinanziaria.TabStop = false;
			this.grpFinanziaria.Text = "Finanziaria";
			// 
			// btnInserisci
			// 
			...
			this.dataGrid1.Size = new System.Drawing.Size(734, 101);
			this.dataGrid1.TabIndex = 24;
			this.dataGrid1.Tag = "csa_contracttaxexpense.default.detail";
			// 
			// tabPage3
			// 
			this.tabPage3.Controls.Add(this.grpBoxImpegniBudget);
			this.tabPage3.Controls.Add(this.gboxConto);
			this.tabPage3.Location = new System.Drawing.Point(4, 22);
			this.tabPage3.Name = "tabPage3";
			this.tabPage3.Padding = new System.Windows.Forms.Padding(3);
			this.tabPage3.Size = new System.Drawing.Size(876, 414);
			...
			// grpBoxImpegniBudget
			// 
			this.grpBoxImpegniBudget.Controls.Add(this.label1);
			this.grpBoxImpegniBudget.Controls.Add(this.cmbFaseImpBudget);
			this.grpBoxImpegniBudget.Controls.Add(this.label6);
			this.grpBoxImpegniBudget.Controls.Add(this.label8);
			this.grpBoxImpegniBudget.Controls.Add(this.txtNumIxBudget);
			this.grpBoxImpegniBudget.Controls.Add(this.txtEsercIxBudget);
			this.grpBoxImpegniBudget.Location = new System.Drawing.Point(23, 146);
			this.grpBoxImpegniBudget.Name = "grpBoxImpegniBudget";
			this.grpBoxImpegniBudget.Size = new System.Drawing.Size(274, 105);
			...
			this.cmbFaseImpBudget.Location = new System.Drawing.Point(72, 33);
			this.cmbFaseImpBudget.Name = "cmbFaseImpBudget";
			this.cmbFaseImpBudget.Size = new System.Drawing.Size(189, 21);
			this.cmbFaseImpBudget.TabIndex = 10;
			this.cmbFaseImpBudget.Tag = "epexp.nphase?csa_contracttaxview.epexp_nphase";
			...
			this.label8.Text = "Esercizio";
			this.label8.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// txtNumIxBudget
			// 
			this.txtNumIxBudget.Location = new System.Drawing.Point(100, 80);
			...
			this.txtNumIxBudget.Tag = "epexp.nepexp?csa_contracttaxview.nepexp";
			// 
			// txtEsercIxBudget
			// 
			this.txtEsercIxBudget.Location = new System.Drawing.Point(17, 80);
			...
			this.txtEsercIxBudget.Tag = "epexp.yepexp.year?csa_contracttaxview.yepexp.year";
			// 
			// gboxConto
			// 
			...
			this.txtEsercDoc.Location = new System.Drawing.Point(519, 28);
			this.txtEsercDoc.Name = "txtEsercDoc";
			this.txtEsercDoc.Size = new System.Drawing.Size(80, 20);
			this.txtEsercDoc.TabIndex = 15;
			...
			this.groupBox4.Controls.Add(this.txtNumOrdine);
			this.groupBox4.Controls.Add(this.label3);
			this.groupBox4.Controls.Add(this.txtEsercContratto);
			this.groupBox4.Controls.Add(this.label5);
			this.groupBox4.Location = new System.Drawing.Point(3, 11);
			this.groupBox4.Name = "groupBox4";
			this.groupBox4.Size = new System.Drawing.Size(428, 72);
			this.groupBox4.TabIndex = 18;
			this.groupBox4.TabStop = false;
			this.groupBox4.Text = "Regola specifica CSA";
			// 
			// label4
			// 
			...
			this.cmbTipoContratto.Tag = "csa_contract.idcsa_contractkind?csa_contracttaxview.idcsa_contractkind";
			...
			this.txtNumOrdine.Tag = "csa_contract.ncontract?csa_contracttaxview.ncontract";
			// 
			// label3
			// 
			...
			this.txtEsercContratto.Tag = "csa_contract.ycontract?csa_contracttaxview.ycontract";
			// 
			// label5
			// 
			...
			this.Name = "Frm_csa_contracttax_elenco";
			this.Text = "Frm_csa_contracttax_elenco";
			...
			this.grpRipartizioneUnica.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.dataGrid3)).EndInit();
			this.grpImpBudget.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.dataGrid2)).EndInit();
			this.grpFinanziaria.ResumeLayout(false);
        ...
        private System.Windows.Forms.GroupBox grpImpBudget;
        private System.Windows.Forms.Button button1;
        private System.Windows.Forms.Button button2;
        private System.Windows.Forms.Button button3;
        private System.Windows.Forms.DataGrid dataGrid2;
        private System.Windows.Forms.GroupBox grpFinanziaria;
        ...
        private System.Windows.Forms.GroupBox grpRipartizioneUnica;
