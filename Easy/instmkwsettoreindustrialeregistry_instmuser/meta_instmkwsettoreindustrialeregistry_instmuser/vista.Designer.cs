...
namespace meta_instmkwsettoreindustrialeregistry_instmuser {
public class instmkwsettoreindustrialeregistry_instmuserRow: MetaRow  {
	public instmkwsettoreindustrialeregistry_instmuserRow(DataRowBuilder rb) : base(rb) {} 
...
public class instmkwsettoreindustrialeregistry_instmuserTable : MetaTableBase<instmkwsettoreindustrialeregistry_instmuserRow> {
	public instmkwsettoreindustrialeregistry_instmuserTable() : base("instmkwsettoreindustrialeregistry_instmuser"){
