...
public class instmusercategorykindRow: MetaRow  {
	public instmusercategorykindRow(DataRowBuilder rb) : base(rb) {} 
...
public class instmusercategorykindTable : MetaTableBase<instmusercategorykindRow> {
	public instmusercategorykindTable() : base("instmusercategorykind"){
		baseColumns = new Dictionary<string, DataColumn>(){
			{"ct",createColumn("ct",typeof(DateTime),false,false)},
			{"cu",createColumn("cu",typeof(string),false,false)},
			{"description",createColumn("description",typeof(string),true,false)},
			{"idinstmusercategorykind",createColumn("idinstmusercategorykind",typeof(int),false,false)},
