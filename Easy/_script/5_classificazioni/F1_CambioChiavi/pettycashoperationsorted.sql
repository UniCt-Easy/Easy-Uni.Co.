...
﻿-- Aggiornamento tabella PETTYCASHOPERATIONSORTED e tabelle dipendenti
...
-- Passo 4.1: Chiavi
-- Tabelle interessate sono pettycashoperationsorted
...
IF exists(select * from [sysobjects] as T inner join syscolumns C on T.ID = C.ID 
		...
		and C.name ='yoperation'
		AND (T.uid = USER_ID( ) OR T.uid = USER_ID('dbo'))
	)
BEGIN
	ALTER TABLE [pettycashoperationsorted] ALTER COLUMN yoperation smallint NOT NULL
END
GO
...
IF exists(SELECT * FROM [columntypes] WHERE tablename = 'pettycashoperationsorted' AND field = 'yoperation')
UPDATE [columntypes] SET iskey = 'S',sqltype = 'smallint',col_len = '2',col_precision = null,col_scale = null,systemtype = 'System.Int16',sqldeclaration = 'smallint',allownull = 'N',defaultvalue = '',format = null,denynull = 'S',lastmodtimestamp = {ts '2007-11-30 10:05:42.577'},lastmoduser = '''NINO''',createuser = 'NINO',createtimestamp = {ts '2007-11-30 10:05:42.577'} WHERE tablename = 'pettycashoperationsorted' AND field = 'yoperation'
ELSE
