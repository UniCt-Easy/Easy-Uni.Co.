...
BEGIN
	ALTER TABLE [naturagiur] ADD active nvarchar(50) NOT NULL DEFAULT ''
	declare @vincolo varchar(100)
...
END
ELSE
	ALTER TABLE [naturagiur] ALTER COLUMN active nvarchar(50) NOT NULL
GO
...
INSERT INTO columntypes (format,allownull,tablename,sqldeclaration,createuser,field,col_len,denynull,sqltype,systemtype,defaultvalue,col_scale,lastmoduser,col_precision,iskey) VALUES('','N','naturagiur','nvarchar(50)','ASSISTENZA','active','50','S','nvarchar','System.String','','','''ASSISTENZA''','','N')
GO
...
UPDATE [tabledescr] SET description = 'VOCABOLARIO delle nature giuridiche',idapplication = null,isdbo = 'N',lt = {ts '2018-07-17 17:36:47.457'},lu = 'assistenza',title = 'VOCABOLARIO delle nature giuridiche' WHERE tablename = 'naturagiur'
ELSE
INSERT INTO [tabledescr] (tablename,description,idapplication,isdbo,lt,lu,title) VALUES ('naturagiur','VOCABOLARIO delle nature giuridiche',null,'N',{ts '2018-07-17 17:36:47.457'},'assistenza','VOCABOLARIO delle nature giuridiche')
GO
...
UPDATE [coldescr] SET col_len = '50',col_precision = null,col_scale = null,description = null,kind = 'S',lt = {ts '2018-07-17 17:36:50.227'},lu = 'assistenza',primarykey = 'N',sql_declaration = 'nvarchar(50)',sql_type = 'nvarchar',system_type = 'System.String' WHERE colname = 'active' AND tablename = 'naturagiur'
ELSE
INSERT INTO [coldescr] (colname,tablename,col_len,col_precision,col_scale,description,kind,lt,lu,primarykey,sql_declaration,sql_type,system_type) VALUES ('active','naturagiur','50',null,null,null,'S',{ts '2018-07-17 17:36:50.227'},'assistenza','N','nvarchar(50)','nvarchar','System.String')
GO
