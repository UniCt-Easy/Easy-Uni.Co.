...
UPDATE [contrattokind] SET active = 'S',assegnoaggiuntivo = null,costolordoannuo = null,costolordoannuooneri = '40000',ct = {ts '2020-04-29 18:34:23.643'},cu = 'riccardotest',description = 'Ogni contratto individuale può avere una durata minima di un anno e massima di  tre anni. La durata complessiva dei rapporti come assegnista di ricerca del singolo soggetto non può comunque essere superiore a sei anni.',elementoperequativo = null,indennitadiateneo = null,indennitadiposizione = null,indvacancacontrattuale = null,lt = {ts '2020-05-20 11:33:51.343'},lu = 'riccardotest{0001}',oremaxcompitididatempoparziale = null,oremaxcompitididatempopieno = null,oremaxdidatempoparziale = null,oremaxdidatempopieno = null,oremaxgg = null,oremaxtempoparziale = null,oremaxtempopieno = '1720',oremincompitididatempoparziale = null,oremincompitididatempopieno = null,oremindidatempoparziale = null,oremindidatempopieno = null,oremintempoparziale = null,oremintempopieno = null,orestraordinariemax = null,parttime = 'N',scatto = null,sortcode = '10',tempdef = 'N',title = 'Assegnista di ricerca',totaletredicesima = null,tredicesimaindennitaintegrativaspeciale = null WHERE idcontrattokind = '11'
ELSE
INSERT INTO [contrattokind] (idcontrattokind,active,assegnoaggiuntivo,costolordoannuo,costolordoannuooneri,ct,cu,description,elementoperequativo,indennitadiateneo,indennitadiposizione,indvacancacontrattuale,lt,lu,oremaxcompitididatempoparziale,oremaxcompitididatempopieno,oremaxdidatempoparziale,oremaxdidatempopieno,oremaxgg,oremaxtempoparziale,oremaxtempopieno,oremincompitididatempoparziale,oremincompitididatempopieno,oremindidatempoparziale,oremindidatempopieno,oremintempoparziale,oremintempopieno,orestraordinariemax,parttime,scatto,sortcode,tempdef,title,totaletredicesima,tredicesimaindennitaintegrativaspeciale) VALUES ('11','S',null,null,'40000',{ts '2020-04-29 18:34:23.643'},'riccardotest','Ogni contratto individuale può avere una durata minima di un anno e massima di  tre anni. La durata complessiva dei rapporti come assegnista di ricerca del singolo soggetto non può comunque essere superiore a sei anni.',null,null,null,null,{ts '2020-05-20 11:33:51.343'},'riccardotest{0001}',null,null,null,null,null,null,'1720',null,null,null,null,null,null,null,'N',null,'10','N','Assegnista di ricerca',null,null)
GO
...
UPDATE [tabledescr] SET description = 'Tipologie di contratto',idapplication = null,isdbo = 'N',lt = {ts '2018-11-27 12:51:42.000'},lu = 'Ferdinando',title = 'Tipologie di contratto' WHERE tablename = 'contrattokind'
ELSE
INSERT INTO [tabledescr] (tablename,description,idapplication,isdbo,lt,lu,title) VALUES ('contrattokind','Tipologie di contratto',null,'N',{ts '2018-11-27 12:51:42.000'},'Ferdinando','Tipologie di contratto')
GO
...
UPDATE [coldescr] SET col_len = '1',col_precision = null,col_scale = null,description = 'Abilita indennit? di ateneo',kind = 'S',lt = {ts '2020-07-14 15:26:20.580'},lu = 'assistenza',primarykey = 'N',sql_declaration = 'char(1)',sql_type = 'char',system_type = 'System.String' WHERE colname = 'indennitadiateneo' AND tablename = 'contrattokind'
ELSE
INSERT INTO [coldescr] (colname,tablename,col_len,col_precision,col_scale,description,kind,lt,lu,primarykey,sql_declaration,sql_type,system_type) VALUES ('indennitadiateneo','contrattokind','1',null,null,'Abilita indennit? di ateneo','S',{ts '2020-07-14 15:26:20.580'},'assistenza','N','char(1)','char','System.String')
GO

IF exists(SELECT * FROM [coldescr] WHERE colname = 'indennitadiposizione' AND tablename = 'contrattokind')
UPDATE [coldescr] SET col_len = '1',col_precision = null,col_scale = null,description = 'Abilita indennit? di posizione',kind = 'S',lt = {ts '2020-07-14 15:26:20.580'},lu = 'assistenza',primarykey = 'N',sql_declaration = 'char(1)',sql_type = 'char',system_type = 'System.String' WHERE colname = 'indennitadiposizione' AND tablename = 'contrattokind'
ELSE
INSERT INTO [coldescr] (colname,tablename,col_len,col_precision,col_scale,description,kind,lt,lu,primarykey,sql_declaration,sql_type,system_type) VALUES ('indennitadiposizione','contrattokind','1',null,null,'Abilita indennit? di posizione','S',{ts '2020-07-14 15:26:20.580'},'assistenza','N','char(1)','char','System.String')
GO
...
UPDATE [coldescr] SET col_len = '1',col_precision = null,col_scale = null,description = 'Abilita tredicesima indennit? integrativa speciale',kind = 'S',lt = {ts '2020-07-14 15:26:20.580'},lu = 'assistenza',primarykey = 'N',sql_declaration = 'char(1)',sql_type = 'char',system_type = 'System.String' WHERE colname = 'tredicesimaindennitaintegrativaspeciale' AND tablename = 'contrattokind'
ELSE
INSERT INTO [coldescr] (colname,tablename,col_len,col_precision,col_scale,description,kind,lt,lu,primarykey,sql_declaration,sql_type,system_type) VALUES ('tredicesimaindennitaintegrativaspeciale','contrattokind','1',null,null,'Abilita tredicesima indennit? integrativa speciale','S',{ts '2020-07-14 15:26:20.580'},'assistenza','N','char(1)','char','System.String')
GO
