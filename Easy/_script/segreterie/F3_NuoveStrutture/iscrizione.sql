...
UPDATE [tabledescr] SET description = '2.2.1 Iscrizione ad un corso di studi',idapplication = null,isdbo = 'N',lt = {ts '2018-07-20 16:25:47.250'},lu = 'assistenza',title = 'Iscrizione ad un corso di studi' WHERE tablename = 'iscrizione'
ELSE
INSERT INTO [tabledescr] (tablename,description,idapplication,isdbo,lt,lu,title) VALUES ('iscrizione','2.2.1 Iscrizione ad un corso di studi',null,'N',{ts '2018-07-20 16:25:47.250'},'assistenza','Iscrizione ad un corso di studi')
GO
