...
UPDATE [tabledescr] SET description = 'Valuta',idapplication = null,isdbo = 'S',lt = {ts '1900-01-01 03:00:28.760'},lu = 'nino',title = 'Valuta' WHERE tablename = 'currency'
ELSE
INSERT INTO [tabledescr] (tablename,description,idapplication,isdbo,lt,lu,title) VALUES ('currency','Valuta',null,'S',{ts '1900-01-01 03:00:28.760'},'nino','Valuta')
GO
