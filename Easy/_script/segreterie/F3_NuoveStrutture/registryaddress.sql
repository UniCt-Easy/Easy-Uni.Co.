...
UPDATE [tabledescr] SET description = 'Indirizzo di anagrafica',idapplication = null,isdbo = 'S',lt = {ts '2016-10-09 09:50:08.873'},lu = 'nino',title = 'Indirizzo' WHERE tablename = 'registryaddress'
ELSE
INSERT INTO [tabledescr] (tablename,description,idapplication,isdbo,lt,lu,title) VALUES ('registryaddress','Indirizzo di anagrafica',null,'S',{ts '2016-10-09 09:50:08.873'},'nino','Indirizzo')
GO
...
UPDATE [coldescr] SET col_len = '4',col_precision = null,col_scale = null,description = 'id citt? (tabella geo_city)',kind = 'S',lt = {ts '1900-01-01 03:00:02.250'},lu = 'nino',primarykey = 'N',sql_declaration = 'int',sql_type = 'int',system_type = 'System.Int32' WHERE colname = 'idcity' AND tablename = 'registryaddress'
ELSE
INSERT INTO [coldescr] (colname,tablename,col_len,col_precision,col_scale,description,kind,lt,lu,primarykey,sql_declaration,sql_type,system_type) VALUES ('idcity','registryaddress','4',null,null,'id citt? (tabella geo_city)','S',{ts '1900-01-01 03:00:02.250'},'nino','N','int','int','System.Int32')
GO
...
UPDATE [coldescr] SET col_len = '4',col_precision = null,col_scale = null,description = 'data inizio',kind = 'S',lt = {ts '1900-01-01 02:59:54.293'},lu = 'nino',primarykey = 'S',sql_declaration = 'smalldatetime',sql_type = 'smalldatetime',system_type = 'System.DateTime' WHERE colname = 'start' AND tablename = 'registryaddress'
ELSE
INSERT INTO [coldescr] (colname,tablename,col_len,col_precision,col_scale,description,kind,lt,lu,primarykey,sql_declaration,sql_type,system_type) VALUES ('start','registryaddress','4',null,null,'data inizio','S',{ts '1900-01-01 02:59:54.293'},'nino','S','smalldatetime','smalldatetime','System.DateTime')
GO

IF exists(SELECT * FROM [coldescr] WHERE colname = 'stop' AND tablename = 'registryaddress')
UPDATE [coldescr] SET col_len = '4',col_precision = null,col_scale = null,description = 'data fine',kind = 'S',lt = {ts '1900-01-01 02:59:54.787'},lu = 'nino',primarykey = 'N',sql_declaration = 'smalldatetime',sql_type = 'smalldatetime',system_type = 'System.DateTime' WHERE colname = 'stop' AND tablename = 'registryaddress'
ELSE
INSERT INTO [coldescr] (colname,tablename,col_len,col_precision,col_scale,description,kind,lt,lu,primarykey,sql_declaration,sql_type,system_type) VALUES ('stop','registryaddress','4',null,null,'data fine','S',{ts '1900-01-01 02:59:54.787'},'nino','N','smalldatetime','smalldatetime','System.DateTime')
GO
