...
UPDATE [tabledescr] SET description = 'VOCABOLARIO modificabile da loro delle tipologie delle 2.2.6 Sessione di esami',idapplication = null,isdbo = 'N',lt = {ts '2018-07-20 16:28:42.553'},lu = 'assistenza',title = 'Tipologie delle Sessione di esami' WHERE tablename = 'sessionekind'
ELSE
INSERT INTO [tabledescr] (tablename,description,idapplication,isdbo,lt,lu,title) VALUES ('sessionekind','VOCABOLARIO modificabile da loro delle tipologie delle 2.2.6 Sessione di esami',null,'N',{ts '2018-07-20 16:28:42.553'},'assistenza','Tipologie delle Sessione di esami')
GO
