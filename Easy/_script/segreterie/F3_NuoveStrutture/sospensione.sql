...
UPDATE [tabledescr] SET description = 'sospenione di attivit?, che sia di una carriera, didattica del docente o di utilizzabilit? di un?aula',idapplication = null,isdbo = 'N',lt = {ts '2018-11-21 18:57:19.637'},lu = 'assistenza',title = 'Sospenione delle attivit?' WHERE tablename = 'sospensione'
ELSE
INSERT INTO [tabledescr] (tablename,description,idapplication,isdbo,lt,lu,title) VALUES ('sospensione','sospenione di attivit?, che sia di una carriera, didattica del docente o di utilizzabilit? di un?aula',null,'N',{ts '2018-11-21 18:57:19.637'},'assistenza','Sospenione delle attivit?')
GO
