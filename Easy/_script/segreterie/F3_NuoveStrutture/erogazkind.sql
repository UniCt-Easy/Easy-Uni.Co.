...
UPDATE [tabledescr] SET description = 'VOCABOLARIO delle modalità di erogazione della didattica',idapplication = null,isdbo = 'N',lt = {ts '2018-07-20 16:24:33.910'},lu = 'assistenza',title = 'Modalità di erogazione della didattica' WHERE tablename = 'erogazkind'
ELSE
INSERT INTO [tabledescr] (tablename,description,idapplication,isdbo,lt,lu,title) VALUES ('erogazkind','VOCABOLARIO delle modalità di erogazione della didattica',null,'N',{ts '2018-07-20 16:24:33.910'},'assistenza','Modalità di erogazione della didattica')
GO
...
UPDATE [relation] SET childtable = 'erogazkind',description = 'didattica di cui si descrive la modalità di erogazione',lt = {ts '2018-07-19 15:49:09.747'},lu = 'assistenza',parenttable = 'didprog',title = null WHERE idrelation = '3273'
ELSE
INSERT INTO [relation] (idrelation,childtable,description,lt,lu,parenttable,title) VALUES ('3273','erogazkind','didattica di cui si descrive la modalità di erogazione',{ts '2018-07-19 15:49:09.747'},'assistenza','didprog',null)
GO

IF exists(SELECT * FROM [relation] WHERE idrelation = '3274')
UPDATE [relation] SET childtable = 'erogazkind',description = 'affidamento dell''insegnamento al docente di cui si descrive la modalità di erogazione',lt = {ts '2018-07-19 15:51:24.777'},lu = 'assistenza',parenttable = 'affidamento',title = null WHERE idrelation = '3274'
ELSE
INSERT INTO [relation] (idrelation,childtable,description,lt,lu,parenttable,title) VALUES ('3274','erogazkind','affidamento dell''insegnamento al docente di cui si descrive la modalità di erogazione',{ts '2018-07-19 15:51:24.777'},'assistenza','affidamento',null)
GO
