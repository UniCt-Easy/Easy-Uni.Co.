...
UPDATE [tabledescr] SET description = 'Tabella di specifica per gli studenti, il resto della anagrafica ? in registry',idapplication = null,isdbo = 'N',lt = {ts '2018-11-29 16:26:08.000'},lu = 'Ferdinando',title = 'Studenti' WHERE tablename = 'registry_studenti'
ELSE
INSERT INTO [tabledescr] (tablename,description,idapplication,isdbo,lt,lu,title) VALUES ('registry_studenti','Tabella di specifica per gli studenti, il resto della anagrafica ? in registry',null,'N',{ts '2018-11-29 16:26:08.000'},'Ferdinando','Studenti')
GO
