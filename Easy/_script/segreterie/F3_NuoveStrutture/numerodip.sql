...
UPDATE [tabledescr] SET description = 'VOCABOLARIO dei range di numero di dipendenti di 2.4.34 2.5.19  Enti e Aziende',idapplication = null,isdbo = 'N',lt = {ts '2018-07-20 16:26:38.583'},lu = 'assistenza',title = 'Range di numero di dipendenti di Enti e Aziende' WHERE tablename = 'numerodip'
ELSE
INSERT INTO [tabledescr] (tablename,description,idapplication,isdbo,lt,lu,title) VALUES ('numerodip','VOCABOLARIO dei range di numero di dipendenti di 2.4.34 2.5.19  Enti e Aziende',null,'N',{ts '2018-07-20 16:26:38.583'},'assistenza','Range di numero di dipendenti di Enti e Aziende')
GO
