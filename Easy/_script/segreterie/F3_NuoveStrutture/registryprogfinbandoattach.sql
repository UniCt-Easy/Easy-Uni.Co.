...
UPDATE [tabledescr] SET description = 'Allegati ai 2.7.15 bandi dei programmi di finanziamento',idapplication = null,isdbo = 'N',lt = {ts '2020-06-12 16:05:51.710'},lu = 'assistenza',title = 'Allegati' WHERE tablename = 'registryprogfinbandoattach'
ELSE
INSERT INTO [tabledescr] (tablename,description,idapplication,isdbo,lt,lu,title) VALUES ('registryprogfinbandoattach','Allegati ai 2.7.15 bandi dei programmi di finanziamento',null,'N',{ts '2020-06-12 16:05:51.710'},'assistenza','Allegati')
GO
