...
UPDATE [tabledescr] SET description = 'VOCABOLARIO modificabile dagli utenti delle tipologie di 2.4.27 pubblicazione ',idapplication = null,isdbo = 'N',lt = {ts '2018-07-20 16:28:04.777'},lu = 'assistenza',title = 'Tipologie di pubblicazione ' WHERE tablename = 'publicazkind'
ELSE
INSERT INTO [tabledescr] (tablename,description,idapplication,isdbo,lt,lu,title) VALUES ('publicazkind','VOCABOLARIO modificabile dagli utenti delle tipologie di 2.4.27 pubblicazione ',null,'N',{ts '2018-07-20 16:28:04.777'},'assistenza','Tipologie di pubblicazione ')
GO
