...
UPDATE [tabledescr] SET description = 'Causali economico patrimoniali associate alla voce di costo del modello di progetto o attivit? (modello)',idapplication = null,isdbo = 'N',lt = {ts '2020-06-18 18:20:04.257'},lu = 'assistenza',title = 'Causali economico patrimoniali associate' WHERE tablename = 'progettotipocostokindaccmotive'
ELSE
INSERT INTO [tabledescr] (tablename,description,idapplication,isdbo,lt,lu,title) VALUES ('progettotipocostokindaccmotive','Causali economico patrimoniali associate alla voce di costo del modello di progetto o attivit? (modello)',null,'N',{ts '2020-06-18 18:20:04.257'},'assistenza','Causali economico patrimoniali associate')
GO
