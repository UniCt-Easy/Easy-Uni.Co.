...
namespace asset_default //beneinventariabile//
{
    ...
    /// </summary>
    public class Frm_asset_default : MetaDataForm {
        ...
        private void InitializeComponent() {
			...
			this.dataGridAllegati.Tag = "assetattachment.lista.detail";
			// 
			// btnDelAtt
			// 
			...
			// grpAmmortamento
			// 
			this.grpAmmortamento.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
    ...
    "ncipale)";
			...
			this.tabRisconti.Text = "Gestione finanziamento";
			...
			this.groupBox2.Text = "Risconti/Riserve utilizzati";
			// 
			// button7
			// 
			...
			this.gboxRisconti.Text = "Tipo finanziamento";
			// 
			// btnInsAssetGrant
			// 
...
//			QueryCreator.SetRelationActivationFilter(DS.Relations["assetassetlocation"],"(idpiece=1)");
            ...
            // ===============================================================================
            QueryCreator.setSkipInsertCopy(DS.assetattachment, true);
        }
        ...
        void CheckResponsabileChange() {
            ...
            foreach (DataRow RL in Location) {
                ...
                if (DS.assetmanager.Select(filter).Length == 0) {
                    if (show(this, "Si vuole reimpostare il responsabile in base alla nuova ubicazione?",
                        "Conferma",
...
//carico parte
        ...
        public void ScriviEInviaMail() {
            ...
            foreach (int idasset_temp in hOld.Keys) {
                ...
                MsgBody = MsgBody + "è stato assegnato al Responsabile: " + Tnew.Rows[0]["title"] + ".\r\n\r\n";
                MsgBody = MsgBody + "Cordiali saluti.\r\n";
                if (mailto != "") {
                    SendMail SM = new SendMail();
                    SM.UseSMTPLoginAsFromField = true;
            ...
            foreach (int idasset_temp in hOldSub.Keys) {
                ...
                MsgBody = MsgBody + "è stato assegnato al Subconsegnatario: " + Tnew.Rows[0]["title"] + ".\r\n\r\n";
                MsgBody = MsgBody + "Cordiali saluti.\r\n";
                if (mailto != "") {
                    SendMail SM = new SendMail();
                    SM.UseSMTPLoginAsFromField = true;
        ...
        void FillMultifieldTab(string value, DataTable MFKind, DataRow[] Fields) {
            ...
            string[] allmf = value.Split(new char[] {'§'}); //coppie codice valore memorizzate nella riga
        ...
        string GetSearchMultifieldTab() {
            ...
            foreach (mfield mf in allfields) {
                ...
                string search = QHS.Like("'§'+multifield", "%" + coppia + "%");
        ...
        bool are_same(string mfield1, string mfield2) {
            string[] coppie1 = mfield1.Split('§');
            string[] coppie2 = mfield2.Split('§');
