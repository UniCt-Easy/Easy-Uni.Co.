...
namespace voce8000_default
{
    partial class Frm_voce8000_default
    {
        ...
        private void InitializeComponent()
        {
			...
			this.grpMissioniItaliaEstero = new System.Windows.Forms.GroupBox();
			...
			this.grpMissioniItaliaEstero.SuspendLayout();
			this.SuspendLayout();
			// 
			// modifica
			// 
			...
			this.MetaDataDetail.Controls.Add(this.grpMissioniItaliaEstero);
			...
			this.MetaDataDetail.Location = new System.Drawing.Point(8, 351);
			this.MetaDataDetail.Name = "MetaDataDetail";
			this.MetaDataDetail.Size = new System.Drawing.Size(488, 159);
			...
			this.btnChiudi.Location = new System.Drawing.Point(192, 516);
			...
			this.dataGrid1.Size = new System.Drawing.Size(488, 291);
			...
			// 
			// grpMissioniItaliaEstero
			// 
			this.grpMissioniItaliaEstero.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
			this.grpMissioniItaliaEstero.Controls.Add(this.rdoExtraUe);
			this.grpMissioniItaliaEstero.Controls.Add(this.rdoItaly);
			this.grpMissioniItaliaEstero.Location = new System.Drawing.Point(106, 91);
			this.grpMissioniItaliaEstero.Name = "grpMissioniItaliaEstero";
			this.grpMissioniItaliaEstero.Size = new System.Drawing.Size(141, 49);
			this.grpMissioniItaliaEstero.TabIndex = 22;
			this.grpMissioniItaliaEstero.TabStop = false;
			this.grpMissioniItaliaEstero.Text = "Missioni";
			// 
			// rdoExtraUe
			// 
			this.rdoExtraUe.AutoSize = true;
			this.rdoExtraUe.Location = new System.Drawing.Point(73, 19);
			this.rdoExtraUe.Name = "rdoExtraUe";
			this.rdoExtraUe.Size = new System.Drawing.Size(55, 17);
			this.rdoExtraUe.TabIndex = 2;
			this.rdoExtraUe.TabStop = true;
			this.rdoExtraUe.Tag = "voce8000.flag_geo:E";
			this.rdoExtraUe.Text = "Estero";
			this.rdoExtraUe.UseVisualStyleBackColor = true;
			// 
			// rdoItaly
			// 
			this.rdoItaly.AutoSize = true;
			this.rdoItaly.Location = new System.Drawing.Point(11, 19);
			...
			this.rdoItaly.Tag = "voce8000.flag_geo:I";
			...
			this.grpMissioniItaliaEstero.ResumeLayout(false);
			this.grpMissioniItaliaEstero.PerformLayout();
		...
		private System.Windows.Forms.GroupBox grpMissioniItaliaEstero;
